...
import { c as createExpiringMapCache, d as resolveCacheTtlMs, u as isCacheEnabled } from "./store-cache-DBCd6yKR.js";
...
import { a as isSilentReplyText } from "./tokens-CPoUE_99.js";
...
import { i as setPluginToolMeta, n as getPluginToolMeta } from "./tools-DHDhlGv0.js";
import { c as downgradeOpenAIFunctionCallReasoningPairs, g as sanitizeGoogleTurnOrdering, l as downgradeOpenAIReasoningBlocks, n as validateGeminiTurns, s as sanitizeSessionMessagesImages, t as validateAnthropicTurns, u as isGoogleModelApi } from "./pi-embedded-helpers-B8QlHRbO.js";
import { n as matchesAnyGlobPattern, t as compileGlobPatterns } from "./glob-pattern-COjJhnaB.js";
import { n as extractToolResultId, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-05zrgZyi.js";
...
import { i as collectTextContentBlocks, r as createAgentToolResultMiddlewareRunner } from "./tool-schema-runtime-DOOb8IQw.js";
import { c as mapOpenAIReasoningEffortForModel, i as createBoundaryAwareStreamFnForModel, l as resolveOpenAIStrictToolSetting, o as normalizeOpenAIStrictToolParameters, s as resolveOpenAIStrictToolFlagForInventory } from "./provider-stream-Bp1raIge.js";
import { d as resolveDebugProxySettings, n as captureWsEvent, u as createDebugProxyWebSocketAgent } from "./runtime-BCrJ0WJM.js";
import { i as normalizeOpenAIReasoningEffort } from "./openai-responses-payload-policy-pzs8ghbi.js";
import { t as log$3 } from "./logger-BGiI50uA.js";
import { y as resolveOpenAITextVerbosity } from "./proxy-stream-wrappers-7FHiy56D.js";
import { c as resolveProviderRequestPolicyConfig, i as getModelProviderRequestTransport, r as buildProviderRequestTlsClientOptions } from "./provider-request-config-BugTt51m.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-DHvpt940.js";
import { r as hasCopilotVisionInput, t as buildCopilotDynamicHeaders } from "./copilot-dynamic-headers-BH8a8LLO.js";
import { d as repairToolUseResultPairing, f as sanitizeToolCallInputs, m as stripToolResultDetails, p as sanitizeToolUseResultPairing, s as mergeTransportMetadata, u as makeMissingToolResult } from "./transport-stream-shared-DwtR4Xuz.js";
import { n as loadEnabledBundleLspConfig } from "./bundle-lsp-B-cyyl8m.js";
import { c as loadEmbeddedPiMcpConfig, d as describeStdioMcpServerLaunchConfig, f as resolveStdioMcpServerLaunchConfig } from "./pi-bundle-mcp-runtime-DdX3YJcs.js";
import { r as applyPiCompactionSettingsFromConfig } from "./pi-settings-BW3hztbs.js";
import { a as toToolDefinitions } from "./pi-tool-definition-adapter-BfvU2XER.js";
import { a as resolveGroupToolPolicy, i as resolveGroupContextFromSessionKey, o as resolveSubagentToolPolicyForSession, r as resolveEffectiveToolPolicy } from "./read-capability-BS3iiLfC.js";
import { i as resolveSubagentCapabilityStore, t as isSubagentEnvelopeSession } from "./subagent-capabilities-B5OlIhRI.js";
import { n as buildDefaultToolPolicyPipelineSteps, t as applyToolPolicyPipeline } from "./tool-policy-pipeline-Cpyb24av.js";
import { i as setRawSessionAppendMessage, n as rewriteTranscriptEntriesInSessionManager, r as getRawSessionAppendMessage } from "./transcript-rewrite-9kQvtAEn.js";
import { i as resolveSkillRuntimeConfig } from "./env-overrides-lt3-hHCv.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-9W7oRVFf.js";
import "./skills-Btkps-SF.js";
import { y as shouldPreserveThinkingBlocks } from "./provider-model-shared-CIbJhChi.js";
import { C as isAnthropicModelRef, S as isAnthropicFamilyCacheTtlEligible } from "./provider-stream-shared-C7C9MWDe.js";
import { o as isGooglePromptCacheEligible } from "./extra-params-CAesiHZT.js";
import { t as withTimeout } from "./with-timeout-DAM9u5AT.js";
import { t as extractSections } from "./post-compaction-context-oUYpjtFs.js";
import { n as retryAsync } from "./retry-DPXHP2FO.js";
import { n as isQueryStopWordToken, t as extractKeywords } from "./query-expansion-DdCxr5Wj.js";
import "./query-CEqog9Ke.js";
import { o as wrapUntrustedPromptDataBlock, t as buildAgentSystemPrompt } from "./system-prompt-B7w7bVeP.js";
import { t as estimateStringChars } from "./cjk-chars-BZs0V7gR.js";
import { t as createAnthropicVertexStreamFnForModel } from "./anthropic-vertex-stream-CcXQvG2i.js";
...
//#endregion
export { buildUsageWithNoCost as $, setCompactionSafeguardCancelReason as A, resolveLiveToolResultMaxChars as B, limitHistoryTurns as C, hasMeaningfulConversationContent as D, estimateMessagesTokens as E, readLastCacheTtlTimestamp as F, installToolResultContextGuard as G, truncateOversizedToolResultsInSession as H, resolveTranscriptPolicy as I, assessLastAssistantMessage as J, repairSessionFileIfNeeded as K, shouldAllowProviderOwnedThinkingReplay as L, compactWithSafetyTimeout as M, resolveCompactionTimeoutMs as N, isRealConversationMessage as O, isCacheTtlEligibleProvider as P, buildStreamErrorAssistantMessage as Q, guardSessionManager as R, getDmHistoryLimitFromSessionKey as S, SAFETY_MARGIN as T, truncateOversizedToolResultsInSessionManager as U, sessionLikelyHasOversizedToolResults as V, installContextEngineLoopHook as W, createBundleLspToolRuntime as X, dropThinkingBlocks as Y, releaseWsSession as Z, trackSessionManagerAccess as _, collectAllowedToolNames as a, validateReplayTurns as b, applySystemPromptOverrideToSession as c, describeEmbeddedAgentStreamStrategy as d, isReasoningTagProvider as et, resolveEmbeddedAgentApiKey as f, prewarmSessionFile as g, resolveEmbeddedRunSkillEntries as h, PI_RESERVED_TOOL_NAMES as i, applyFinalEffectiveToolPolicy as j, consumeCompactionSafeguardCancelReason as k, buildEmbeddedSystemPrompt as l, resolveEmbeddedAgentStreamFn as m, mapThinkingLevel as n, collectRegisteredToolNames as o, resolveEmbeddedAgentBaseStreamFn as p, createPreparedEmbeddedPiSettingsManager as q, splitSdkTools as r, toSessionToolAllowlist as s, flushPendingToolResultsAfterIdle as t, resolveChannelCapabilities as tt, createSystemPromptOverride as u, normalizeAssistantReplayContent as v, buildEmbeddedExtensionFactories as w, buildEmbeddedMessageActionDiscoveryInput as x, sanitizeSessionHistory as y, estimateToolResultReductionPotential as z };
