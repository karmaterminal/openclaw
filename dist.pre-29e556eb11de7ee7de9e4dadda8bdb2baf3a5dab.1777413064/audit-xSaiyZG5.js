...
import { u as isInterpreterLikeAllowlistPattern } from "./exec-approvals-allowlist-CkdrKC-y.js";
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-aM-g86tz.js";
import { l as loadExecApprovals } from "./exec-approvals-CZzmozBt.js";
import { n as collectCoreInsecureOrDangerousFlags, t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-r5JugPyp.js";
import { t as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-CcKnaRzC.js";
import path from "node:path";
import { isIP } from "node:net";
//#region src/security/audit-deep-code-safety.ts
let auditDeepModulePromise;
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-QF5p8mtv.js");
...
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-DKWHATHu.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-D88Acr9l.js");
...
async function loadPluginMetadataRegistryLoaderModule() {
	pluginMetadataRegistryLoaderModulePromise ??= import("./metadata-registry-loader-Ck3bjtGr.js");
...
async function loadChannelPluginIdsModule() {
	channelPluginIdsModulePromise ??= import("./channel-plugin-ids-DH15SRhL.js");
...
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-CLJIZU2O.js"),
		import("./probe-auth-BD5h0nw6.js"),
		import("./probe-B7pZaNgP.js")
