...
import { i as failTaskRunByRunId, o as setDetachedTaskDeliveryStatusByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-CAYAxYN7.js";
import "./subagent-announce-queue-DuxPDKjm.js";
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-CoBbMlT1.js";
import { u as withSubagentOutcomeTiming } from "./subagent-announce-output-C_z4oKky.js";
...
async function loadCleanupBrowserSessionsForLifecycleEnd$1() {
	browserCleanupPromise$1 ??= import("./browser-lifecycle-cleanup-CjlWB0u0.js");
...
async function loadSubagentAnnounceModule() {
	subagentAnnouncePromise ??= import("./subagent-announce-n_7e4O0c.js");
	return await subagentAnnouncePromise;
}
async function loadCleanupBrowserSessionsForLifecycleEnd() {
	browserCleanupPromise ??= import("./browser-lifecycle-cleanup-CjlWB0u0.js");
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-Dj95hinL.js").then(({ scheduleOrphanRecovery }) => {
