...
async function doctorCommand(runtime, options = {}) {
	...
	const { createDoctorPrompter } = await import("./doctor-prompter-Ce6IdZKw.js");
	const { printWizardHeader } = await import("./onboard-helpers-CzWYs08G.js");
	...
	const { runDoctorHealthContributions } = await import("./doctor-health-contributions-BAJR34Qb.js");
