...
import { n as formatToolSummary, r as resolveToolDisplay } from "./tool-display-WMZX2UeP.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-C8HkzMDO.js";
import { o as generateSecureUuid } from "./secure-random-Bp9Xftt_.js";
import { r as prefixSystemMessage } from "./system-message-BXyPp_dT.js";
import { t as resolveConfiguredTtsMode } from "./tts-config-CToXdqUt.js";
import { o as createBlockReplyPipeline, r as resolveEffectiveBlockStreamingConfig, t as clampPositiveInteger } from "./block-streaming-B90oLr6I.js";
import { t as hasInboundMedia } from "./inbound-media-DVzP35kT.js";
import { i as toAcpRuntimeError } from "./errors-dX3Af8G0.js";
import { o as isSessionIdentityPending, u as resolveSessionIdentityFromMeta } from "./session-identity-pRvRPJ5I.js";
import { t as formatAcpRuntimeErrorText } from "./error-text-CXPVM7sq.js";
import { a as resolveAcpDispatchPolicyError, i as resolveAcpAgentPolicyError } from "./policy-CaYuMaxZ.js";
import { a as resolveAcpThreadSessionDetailLines } from "./session-identifiers-Be1JWszw.js";
import { t as resolveStatusTtsSnapshot } from "./status-config-LC9KGZPj.js";
...
function loadDispatchAcpMediaRuntime() {
	dispatchAcpMediaRuntimePromise ??= import("./dispatch-acp-media.runtime-my5bfB-5.js");
...
function loadDispatchAcpTtsRuntime$1() {
	dispatchAcpTtsRuntimePromise$1 ??= import("./dispatch-acp-tts.runtime-kPP3gxQ3.js");
...
function loadMessageActionRuntime() {
	messageActionRuntimePromise ??= import("./message-action-runner-DFsDtooq.js");
...
function loadDispatchAcpManagerRuntime() {
	dispatchAcpManagerRuntimePromise ??= import("./dispatch-acp-manager.runtime-B49jRbTu.js");
	return dispatchAcpManagerRuntimePromise;
}
function loadDispatchAcpSessionRuntime() {
	dispatchAcpSessionRuntimePromise ??= import("./dispatch-acp-session.runtime-CiPawpSQ.js");
	return dispatchAcpSessionRuntimePromise;
}
function loadDispatchAcpTtsRuntime() {
	dispatchAcpTtsRuntimePromise ??= import("./dispatch-acp-tts.runtime-kPP3gxQ3.js");
