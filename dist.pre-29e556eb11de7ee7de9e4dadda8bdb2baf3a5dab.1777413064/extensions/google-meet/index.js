...
import { t as GatewayClient } from "../../client-BbNZvLKI.js";
...
import "../../gateway-runtime-Bv0vMgA8.js";
import { g as resolveRealtimeVoiceAgentConsultToolsAllow, h as resolveRealtimeVoiceAgentConsultTools, m as resolveRealtimeVoiceAgentConsultToolPolicy, s as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, t as resolveConfiguredRealtimeVoiceProvider } from "../../provider-resolver-D04YQ4Uj.js";
import { o as createRealtimeVoiceBridgeSession, s as consultRealtimeVoiceAgent } from "../../realtime-voice-BzykyGeN.js";
import { a as fetchGoogleMeetSpace, i as fetchGoogleMeetAttendance, o as fetchLatestGoogleMeetConferenceRecord, r as fetchGoogleMeetArtifacts, t as buildGoogleMeetPreflightReport } from "../../meet-C94cCtzE.js";
import { a as isSameMeetUrlForReuse, c as resolveChromeNode, i as callBrowserProxyOnNode, l as resolveChromeNodeInfo, n as isGoogleMeetBrowserManualActionError, o as normalizeMeetUrlForReuse, r as asBrowserTabs, s as readBrowserTab, t as createMeetWithBrowserProxyOnNode } from "../../chrome-create-KS1EVYWb.js";
...
async function createMeetFromParams(params) {
	return (await import("../../create-CFFOZnfG.js")).createMeetFromParams(params);
}
async function createAndJoinMeetFromParams(params) {
	return (await import("../../create-CFFOZnfG.js")).createAndJoinMeetFromParams(params);
}
async function resolveGoogleMeetTokenFromParams(config, raw) {
	const { resolveGoogleMeetAccessToken } = await import("../../oauth-BWCxIA9p.js");
...
var google_meet_default = definePluginEntry({
	...
	register(api) {
		...
		api.registerCli(async ({ program }) => {
			const { registerGoogleMeetCli } = await import("../../cli-6XBUGCnS.js");
