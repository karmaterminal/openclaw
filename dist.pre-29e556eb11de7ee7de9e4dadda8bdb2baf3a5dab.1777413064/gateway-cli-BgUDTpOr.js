...
import { d as waitForActiveEmbeddedRuns, r as getActiveEmbeddedRunCount, t as abortEmbeddedPiRun } from "./runs-Cc8U4QH8.js";
...
import { n as setGatewayWsLogStyle } from "./ws-logging-CIjL72rh.js";
import { t as formatHelpExamples } from "./help-format-Cw2Yb6oK.js";
import { t as readSecretFromFile } from "./secret-file-BkfVuyRo.js";
import { n as buildGatewayDiscoveryTarget } from "./gateway-discovery-targets-CcG7Xct3.js";
import { o as resolveControlUiRootSync } from "./control-ui-assets-DQ8mr5p-.js";
import { n as acquireGatewayLock, t as GatewayLockError } from "./gateway-lock-BUcYyJTU.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-Tor0-MSc.js";
import { o as handleReset } from "./onboard-helpers-Dj7Z1nGm.js";
...
async function runGatewayCommand$1(opts) {
	...
	const { startGatewayServer } = await startupTrace.measure("cli.server-import", () => withProgress({
		...
		indeterminate: true
	}, async () => import("./server-NbzweEe5.js")));
...
function loadConfigModule() {
	configModulePromise ??= import("./read-best-effort-config.runtime-DoS_Enj1.js");
	return configModulePromise;
}
function loadGatewayStatusModule() {
	gatewayStatusModulePromise ??= import("./gateway-status-DlKIzAGG.js");
	return gatewayStatusModulePromise;
}
function loadGatewayHealthModule() {
	gatewayHealthModulePromise ??= import("./health-6h-SrOpn.js");
	return gatewayHealthModulePromise;
}
function loadBonjourDiscoveryModule() {
	bonjourDiscoveryModulePromise ??= import("./bonjour-discovery-x_udkIcB.js");
	return bonjourDiscoveryModulePromise;
}
function loadWideAreaDnsModule() {
	wideAreaDnsModulePromise ??= import("./widearea-dns-C0G3A_Gd.js");
	return wideAreaDnsModulePromise;
}
function loadHealthStyleModule() {
	healthStyleModulePromise ??= import("./health-style-eFd1etv0.js");
...
function loadSupportExportModule() {
	supportExportModulePromise ??= import("./diagnostic-support-export-DiFMYAFF.js");
	return supportExportModulePromise;
}
function loadDaemonStatusGatherModule() {
	daemonStatusGatherModulePromise ??= import("./status.gather-Dyqsxn4D.js");
