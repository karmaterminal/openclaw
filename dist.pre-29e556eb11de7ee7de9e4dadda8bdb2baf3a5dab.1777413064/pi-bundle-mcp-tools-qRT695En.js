...
import { i as setPluginToolMeta } from "./tools-DHDhlGv0.js";
import { l as buildSafeToolName, u as normalizeReservedToolNames } from "./pi-bundle-mcp-runtime-DdX3YJcs.js";
...
async function createBundleMcpToolRuntime(params) {
	const runtime = (params.createRuntime ?? (await import("./pi-bundle-mcp-runtime-D4CwdKm5.js")).createSessionMcpRuntime)({
