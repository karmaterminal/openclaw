...
import { n as getBridgeAuthForPort } from "./bridge-auth-registry-Lz8rJ-rq.js";
import { t as resolveBrowserRateLimitMessage } from "./rate-limit-message-DgvtHfJO.js";
...
async function fetchBrowserJson(url, init) {
	...
	try {
		...
		const { dispatchBrowserControlRequest } = await import("./local-dispatch.runtime-YE03LI9G.js");
