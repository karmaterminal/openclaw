...
import { h as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-Cs-0dhMf.js";
import { n as formatConfigIssueLines } from "./issue-format-DpSVQL-G.js";
import { t as note } from "./note-D6Igj8ec.js";
import { n as noteIncludeConfinementWarning } from "./doctor-config-analysis-7iyggh7U.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-zb0OZrlG.js");
