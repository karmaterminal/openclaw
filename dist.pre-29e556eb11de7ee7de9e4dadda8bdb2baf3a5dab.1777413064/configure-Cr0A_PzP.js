...
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint } from "./auth-install-policy-GzFUtI2S.js";
...
import { t as resolveGatewayInstallToken } from "./gateway-install-token-PifoHIJP.js";
...
import { n as resolveProviderPluginChoice } from "./provider-wizard-Du1JtHb9.js";
import { t as applyPrimaryModel } from "./provider-model-primary-KYKpJuNX.js";
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DQ8mr5p-.js";
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-Dj7Z1nGm.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-CN7s40Bi.js";
import { n as applyAuthChoice } from "./auth-choice-Dpjqi0gX.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-CMNk0dwq.js";
import { i as setupChannels } from "./onboard-channels-BU_qURkb.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-CzBXfGrV.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-abjflVMI.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-aPEOPlME.js";
import { t as promptCustomApiConfig } from "./onboard-custom-gS-vpp-m.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-uTdrdHFM.js";
import { n as formatHealthCheckFailure } from "./health-format-B2TKlZKu.js";
import { n as healthCommand } from "./health-BEP__pBN.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-BekrhRN8.js";
import { t as setupSkills } from "./onboard-skills-B3rizGt1.js";
...
function loadSetupPluginConfigModule() {
	setupPluginConfigModulePromise ??= import("./setup.plugin-config-DjfZPy75.js");
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-BERns3Sx.js");
