...
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-C_KK-obC.js";
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-B56JkKfk.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-CDE2pIGy.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-CKc1HMZb.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-Tkd91h7K.js";
import { t as createClackPrompter } from "./clack-prompter-libuK6hd.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-4_f8folr.js";
import { n as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-B_CxLtwN.js";
import { t as parseLogLine } from "./parse-log-line-CU-X5yud.js";
import { a as describeBinding, t as applyAgentBindings } from "./agents.bindings-DTl_P4Ve.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-De0IiMo9.js";
import { c as requireValidConfig, l as shouldUseWizard, o as channelLabel, s as formatChannelAccountLabel } from "./shared-1bC9tNtO.js";
import { t as channelsListCommand } from "./list-EOGIKarg.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-tsbjVjeE.js";
...
function loadChannelSetupPluginInstall() {
	channelSetupPluginInstallPromise ??= import("./plugin-install-DT3E0swE.js");
	return channelSetupPluginInstallPromise;
}
function loadOnboardChannels() {
	onboardChannelsPromise ??= import("./onboard-channels-BC6nTOjn.js");
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	const { listChannelPluginCatalogEntries } = await import("./catalog-BC1YD96t.js");
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-DrFoSoZG.js"), loadOnboardChannels()]);
	...
	if (!channel && catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-lnwikjD6.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = !useWizard && rawChannel && (!channel || !getChannelPlugin(channel)) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-0S9-Ffd9.js");
