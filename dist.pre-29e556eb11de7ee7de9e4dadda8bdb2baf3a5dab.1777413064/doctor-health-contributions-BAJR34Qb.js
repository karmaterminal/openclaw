...
async function runGatewayConfigHealth(ctx) {
	...
	const { note } = await import("./note-DlWfIMrg.js");
...
async function runAuthProfileHealth(ctx) {
	const { maybeRepairLegacyOAuthProfileIds } = await import("./doctor-auth-legacy-oauth-kiNW5vGj.js");
	const { noteAuthProfileHealth, noteLegacyCodexProviderOverride } = await import("./doctor-auth-BK4bR05n.js");
	const { buildGatewayConnectionDetails } = await import("./call-CLJIZU2O.js");
	const { note } = await import("./note-DlWfIMrg.js");
...
async function runGatewayAuthHealth(ctx) {
	...
	const { note } = await import("./note-DlWfIMrg.js");
	const { randomToken } = await import("./onboard-helpers-CzWYs08G.js");
...
async function runClaudeCliHealth(ctx) {
	const { noteClaudeCliHealth } = await import("./doctor-claude-cli-e09UM3Hw.js");
	noteClaudeCliHealth(ctx.cfg);
}
async function runLegacyStateHealth(ctx) {
	const { detectLegacyStateMigrations, runLegacyStateMigrations } = await import("./doctor-state-migrations-zb0OZrlG.js");
	const { note } = await import("./note-DlWfIMrg.js");
...
async function runLegacyPluginManifestHealth(ctx) {
	const { maybeRepairLegacyPluginManifestContracts } = await import("./doctor-plugin-manifests-orPAdHuk.js");
...
async function runBundledPluginRuntimeDepsHealth(ctx) {
	const { maybeRepairBundledPluginRuntimeDeps } = await import("./doctor-bundled-plugin-runtime-deps-DZWsXzDl.js");
...
async function runStateIntegrityHealth(ctx) {
	const { noteStateIntegrity } = await import("./doctor-state-integrity-CBq5rRl4.js");
	await noteStateIntegrity(ctx.cfg, ctx.prompter, ctx.configPath);
}
async function runSessionLocksHealth(ctx) {
	const { noteSessionLockHealth } = await import("./doctor-session-locks-BNlB-aEW.js");
	await noteSessionLockHealth({ shouldRepair: ctx.prompter.shouldRepair });
}
async function runLegacyCronHealth(ctx) {
	const { maybeRepairLegacyCronStore } = await import("./doctor-cron-DtWYpk0-.js");
...
async function runSandboxHealth(ctx) {
	const { maybeRepairSandboxImages, noteSandboxScopeWarnings } = await import("./doctor-sandbox-C7BYqb7h.js");
...
async function runGatewayServicesHealth(ctx) {
	const { maybeRepairGatewayServiceConfig, maybeScanExtraGatewayServices } = await import("./doctor-gateway-services-Du1aldWa.js");
	const { noteMacLaunchAgentOverrides, noteMacLaunchctlGatewayEnvOverrides } = await import("./doctor-platform-notes-CgHc2JYo.js");
...
async function runStartupChannelMaintenanceHealth(ctx) {
	const { maybeRunDoctorStartupChannelMaintenance } = await import("./doctor-startup-channel-maintenance-A5wg7yyP.js");
...
async function runSecurityHealth(ctx) {
	const { noteSecurityWarnings } = await import("./doctor-security-Bppg6Fo-.js");
	await noteSecurityWarnings(ctx.cfg);
}
async function runBrowserHealth(ctx) {
	const { noteChromeMcpBrowserReadiness } = await import("./doctor-browser-CSM9nbn4.js");
	await noteChromeMcpBrowserReadiness(ctx.cfg);
}
async function runOpenAIOAuthTlsHealth(ctx) {
	const { noteOpenAIOAuthTlsPrerequisites } = await import("./oauth-tls-preflight-5Qure_UF.js");
...
async function runHooksModelHealth(ctx) {
	...
	const { loadModelCatalog } = await import("./model-catalog-B4MvMQ6m.js");
...
async function runSystemdLingerHealth(ctx) {
	...
	const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-BH3a3Mo3.js");
	const { note } = await import("./note-DlWfIMrg.js");
...
async function runWorkspaceStatusHealth(ctx) {
	const { noteWorkspaceStatus } = await import("./doctor-workspace-status-Bk79GWIu.js");
	noteWorkspaceStatus(ctx.cfg);
}
async function runBootstrapSizeHealth(ctx) {
	const { noteBootstrapFileSize } = await import("./doctor-bootstrap-size-Cs4eWzt8.js");
	await noteBootstrapFileSize(ctx.cfg);
}
async function runShellCompletionHealth(ctx) {
	const { doctorShellCompletion } = await import("./doctor-completion-BjtHlK9P.js");
...
async function runGatewayHealthChecks(ctx) {
	const { checkGatewayHealth, probeGatewayMemoryStatus } = await import("./doctor-gateway-health-3I73WpnG.js");
...
async function runMemorySearchHealthContribution(ctx) {
	const { maybeRepairMemoryRecallHealth, noteMemoryRecallHealth, noteMemorySearchHealth } = await import("./doctor-memory-search-DbrXJ57b.js");
...
async function runDevicePairingHealth(ctx) {
	const { noteDevicePairingHealth } = await import("./doctor-device-pairing-D1cL5i7V.js");
...
async function runGatewayDaemonHealth(ctx) {
	const { maybeRepairGatewayDaemon } = await import("./doctor-gateway-daemon-flow-BLRCAHWo.js");
...
async function runWriteConfigHealth(ctx) {
	const { formatCliCommand } = await import("./command-format-B-CmRDIm.js");
	const { applyWizardMetadata } = await import("./onboard-helpers-CzWYs08G.js");
	const { CONFIG_PATH, writeConfigFile } = await import("./config-FF751HCT.js");
	const { logConfigUpdated } = await import("./logging-DTfNPfuM.js");
...
async function runWorkspaceSuggestionsHealth(ctx) {
	...
	const { noteWorkspaceBackupTip } = await import("./doctor-state-integrity-CBq5rRl4.js");
	const { MEMORY_SYSTEM_PROMPT, shouldSuggestMemorySystem } = await import("./doctor-workspace-Bvr8SGBF.js");
	const { note } = await import("./note-DlWfIMrg.js");
...
async function runFinalConfigValidationHealth(_ctx) {
	const { readConfigFileSnapshot } = await import("./config-FF751HCT.js");
