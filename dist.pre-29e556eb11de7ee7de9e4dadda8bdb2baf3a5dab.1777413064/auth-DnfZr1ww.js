...
import { s as loadAuthProfileStoreForRuntime } from "./store-DQMFx95A.js";
...
import { n as clearAuthProfileCooldown } from "./usage-3PEExF-O.js";
import { i as upsertAuthProfile } from "./profiles-B2kNMwPI.js";
import { n as validateAnthropicSetupToken } from "./provider-auth-token-DcXGArFv.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-DV0kVsBi.js";
...
import { a as loadValidConfigOrThrow, u as updateConfig } from "./shared-DV-WglXT.js";
import { t as isRemoteEnvironment } from "./remote-env-B6JhXDbT.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-CwLVYex_.js";
import { i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-CCU_MsBq.js";
...
async function runProviderAuthMethod(params) {
	...
	await persistProviderAuthResult({
		result: await params.method.run({
			...
			openUrl: async (url) => {
				const { openUrl } = await import("./onboard-helpers-CzWYs08G.js");
				await openUrl(url);
			},
