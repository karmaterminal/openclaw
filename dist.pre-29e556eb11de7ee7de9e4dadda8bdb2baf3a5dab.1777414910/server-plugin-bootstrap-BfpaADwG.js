...
import { h as listSessionCompactionCheckpoints, m as getSessionCompactionCheckpoint } from "./build-t693_kVI.js";
import { a as normalizeCronJobPatch, r as normalizeCronJobCreate } from "./openclaw-tools-x0WbKigH.js";
...
import { i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry, s as dispatchChannelMessageAction } from "./message-action-runner-DFXdr6j9.js";
...
import { r as createRunningTaskRun } from "./detached-task-runtime-CIW7XipN.js";
...
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-DwyKBFJA.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-sxuJ5_OE.js";
...
import { r as agentCommandFromIngress } from "./agent-command-4goHe-7H.js";
...
import { n as invokeNativeHookRelay } from "./native-hook-relay-DXDt1xnD.js";
...
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-fLr-ttkp.js";
...
import { d as waitForTerminalGatewayDedupe, g as resolveAgentRunExpiresAtMs, h as registerChatAbortController, i as chatHandlers, l as readTerminalSnapshotFromGatewayDedupe, u as setGatewayDedupeEntry } from "./chat-cWBh6WGT.js";
...
import { t as resolveSessionKeyFromResolveParams } from "./sessions-resolve-Cs4ayJuV.js";
...
import { a as performGatewaySessionReset } from "./session-reset-service-Btyru-DO.js";
...
import "./status-DX78Qp5U.js";
import { t as getStatusSummary } from "./status.summary-CLGTZOqz.js";
...
import { t as applySessionsPatchToStore } from "./sessions-patch-SiGZ4tN-.js";
...
import "./heartbeat-runner-CSFvSmRt.js";
...
async function loadSessionSubagentReactivationRuntime() {
	return import("./session-subagent-reactivation.runtime-DjAqReSW.js");
}
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-DPxUWzdh.js");
...
function loadSessionsRuntimeModule() {
	sessionsRuntimeModulePromise ??= import("./sessions.runtime-DWQpKsoZ.js");
