...
import { C as safeTrajectorySessionFileName, S as resolveTrajectoryPointerFilePath, T as sanitizeDiagnosticPayload, b as TRAJECTORY_RUNTIME_FILE_MAX_BYTES, w as safeJsonStringify, x as resolveTrajectoryFilePath } from "./selection-CxQFT3gZ.js";
...
import { h as replyRunRegistry, i as getActiveEmbeddedRunSnapshot } from "./runs-Cc8U4QH8.js";
import "./diagnostic-CcsN5YQ7.js";
import { t as formatDurationCompact } from "./format-duration-_KqG-DQd.js";
import "./sandbox-C2v_pBwb.js";
...
import { i as installPluginFromPath, r as installPluginFromNpmSpec } from "./install-CA170QV4.js";
...
import { n as buildThreadingToolContext } from "./agent-runner-utils-DWSQOY9A.js";
import { _ as getFinishedSession, v as getSession } from "./bash-tools.exec-runtime-BuMDgTud.js";
import { t as resolveFastModeState } from "./fast-mode-CknQ9ZP6.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-z-Dmuk_b.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-Damkbqmr.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-NTdNe5Yt.js";
import { a as shouldPersistAbortCutoff, i as resolveAbortCutoffFromContext, t as applyAbortCutoffToSessionEntry } from "./abort-cutoff-BluHN62C.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-DwyKBFJA.js";
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-C8Ft1JWz.js";
import { n as resolveSessionEntryForKey, r as stopSubagentsForRequester, t as formatAbortReplyText } from "./abort-Cg_WkQT5.js";
import { t as extractBtwQuestion } from "./btw-command-BnpJjVBt.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-C_9e7BBu.js";
...
import { a as requireGatewayClientScopeForInternalChannel, i as requireCommandFlagEnabled, n as rejectNonOwnerCommand, r as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates-ypmmlgLv.js";
import { t as handleAcpCommand } from "./commands-acp-DCv4JaEf.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-BY27GjT-.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-8MPvYE81.js";
import { r as handleModelsCommand } from "./commands-models-BZR55_eZ.js";
import { n as setPluginEnabledInConfig } from "./enable-DU2_ioWu.js";
import { r as createExecTool } from "./bash-tools-BG_qIhAn.js";
import { n as listTasksForAgentIdForStatus, r as listTasksForSessionKeyForStatus } from "./status-text-DYv29NpM.js";
import { d as resolveChannelAccountId, f as resolveCommandSurfaceChannel, l as resolveSubagentsAction, o as resolveHandledPrefix, s as resolveRequesterSessionKey, u as stopWithText } from "./shared-BcRIH__i.js";
import { t as buildToolsMessage } from "./status-CKlGBPgm.js";
import { t as parseConfigValue } from "./config-value-sfbZgEb6.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-DSMngbm5.js";
...
import { t as buildStatusReply } from "./commands-status-D2B2qOn6.js";
import { i as buildNpmInstallRecordFields, n as persistPluginInstall } from "./plugins-install-persist-CSVYzJSf.js";
import { m as parseClawHubPluginSpec } from "./clawhub-CNVqAzgz.js";
import { r as installPluginFromClawHub } from "./clawhub-DI0y1bVp.js";
import { a as buildPluginDiagnosticsReport, c as formatPluginCompatibilityNotice, o as buildPluginInspectReport, s as buildPluginSnapshotReport, t as buildAllPluginInspectReports } from "./status-DjbltF7p.js";
import { a as decidePreferredClawHubFallback, i as createPluginInstallLogger, n as buildPreferredClawHubSpec, u as resolveFileNpmSpecToLocalPath } from "./plugins-command-helpers-CijYho0_.js";
import { n as loadCostUsageSummary, r as loadSessionCostSummary } from "./session-cost-usage-CZaVr2Ds.js";
...
function loadCompactRuntime() {
	compactRuntimePromise ??= import("./commands-compact.runtime-Cy0jBWwK.js");
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-BS78KcdR.js");
...
async function abortEmbeddedPiRunForSession(sessionId) {
	const { abortEmbeddedPiRun } = await import("./runs-Bc1sSBBx.js");
...
function loadAgentsAction() {
	actionAgentsPromise ??= import("./action-agents-BALgslNQ.js");
	return actionAgentsPromise;
}
function loadFocusAction() {
	actionFocusPromise ??= import("./action-focus-BZfe_m4Z.js");
	return actionFocusPromise;
}
function loadHelpAction() {
	actionHelpPromise ??= import("./action-help-CyxUv8E9.js");
	return actionHelpPromise;
}
function loadInfoAction() {
	actionInfoPromise ??= import("./action-info-CdehDm33.js");
	return actionInfoPromise;
}
function loadKillAction() {
	actionKillPromise ??= import("./action-kill-C382VjkZ.js");
	return actionKillPromise;
}
function loadListAction() {
	actionListPromise ??= import("./action-list-VCzOhee2.js");
	return actionListPromise;
}
function loadLogAction() {
	actionLogPromise ??= import("./action-log-DzMrU7u8.js");
	return actionLogPromise;
}
function loadSendAction() {
	actionSendPromise ??= import("./action-send-DzqjUpOr.js");
	return actionSendPromise;
}
function loadSpawnAction() {
	actionSpawnPromise ??= import("./action-spawn-CciYu8Vp.js");
	return actionSpawnPromise;
}
function loadUnfocusAction() {
	actionUnfocusPromise ??= import("./action-unfocus-DgdHLVMD.js");
	return actionUnfocusPromise;
}
function loadControlRuntime() {
	controlRuntimePromise ??= import("./commands-subagents-control.runtime-CsnhO0fB.js");
