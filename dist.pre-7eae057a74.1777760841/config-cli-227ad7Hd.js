...
import { n as info, o as success, t as danger } from "./globals-D40f4_2X.js";
import { a as resolveSecretRefValue } from "./resolve-B9Fdm-AL.js";
import { w as SecretProviderSchema } from "./zod-schema.core-CJHlBmEK.js";
import { C as validateConfigObjectRaw, u as readConfigFileSnapshot, x as collectUnsupportedSecretRefPolicyIssues } from "./io-5jzTw2vS.js";
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-DovSb8Th.js";
import { r as replaceConfigFile } from "./mutate-mWzXBYdf.js";
import "./config-CzLCUGML.js";
import { a as normalizeConfigIssues, n as formatConfigIssueLines } from "./issue-format-CqQPqGQv.js";
import { t as redactConfigObject } from "./redact-snapshot-DePbQBts.js";
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-D5oB07Ch.js";
import { n as setCommandJsonMode } from "./json-mode-DFaiCrPA.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-7JlVBWTA.js");
