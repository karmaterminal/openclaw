...
import { r as configureSubagentRegistrySpawnRuntime, t as emitSessionLifecycleEvent } from "./session-lifecycle-events-Dj-I9d0L.js";
import { r as callGateway } from "./call-8AIXlGCX.js";
import { c as getAgentRunContext, l as onAgentEvent } from "./agent-events-DymXOfrS.js";
import { A as subagentRuns, C as SUBAGENT_ENDED_OUTCOME_ERROR, D as SUBAGENT_ENDED_REASON_ERROR, E as SUBAGENT_ENDED_REASON_COMPLETE, O as SUBAGENT_ENDED_REASON_KILLED, S as resolveSubagentSessionStatus, T as SUBAGENT_ENDED_OUTCOME_TIMEOUT, a as countActiveRunsForSessionFromRuns, b as getSubagentSessionRuntimeMs, c as getSubagentRunByChildSessionKeyFromRuns, d as listRunsForControllerFromRuns, i as countActiveDescendantRunsFromRuns, k as SUBAGENT_TARGET_KIND_SUBAGENT, n as persistSubagentRunsToDisk, r as restoreSubagentRunsFromDisk, s as countPendingDescendantRunsFromRuns, t as getSubagentRunsSnapshotForRead, u as listDescendantRunsForRequesterFromRuns, v as isStaleUnendedSubagentRun, w as SUBAGENT_ENDED_OUTCOME_KILLED, x as getSubagentSessionStartedAt } from "./subagent-registry-state-Bs_4Z9Ws.js";
import { a as isSilentReplyText } from "./tokens-DO03xcy8.js";
import { s as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-B7kfNUUQ.js";
import "./pi-bundle-mcp-tools-3PLiXHwn.js";
import { t as registerPendingSpawnedChildrenQuery } from "./pending-spawn-query-DboIGofS.js";
import { i as failTaskRunByRunId, o as setDetachedTaskDeliveryStatusByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-BpGlai2C.js";
import "./subagent-announce-queue-BgmDxaFQ.js";
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-CiazbJDA.js";
import { d as importRuntimeModule, u as withSubagentOutcomeTiming } from "./subagent-announce-output-CCi5k5gw.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-OZJY9r6h.js";
...
async function loadCleanupBrowserSessionsForLifecycleEnd$1() {
	browserCleanupPromise$1 ??= import("./browser-lifecycle-cleanup-Bfe8icX_.js");
...
async function loadSubagentAnnounceModule() {
	subagentAnnouncePromise ??= import("./subagent-announce-D422UwX8.js");
	return await subagentAnnouncePromise;
}
async function loadCleanupBrowserSessionsForLifecycleEnd() {
	browserCleanupPromise ??= import("./browser-lifecycle-cleanup-Bfe8icX_.js");
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-B8HAYalQ.js").then(({ scheduleOrphanRecovery }) => {
