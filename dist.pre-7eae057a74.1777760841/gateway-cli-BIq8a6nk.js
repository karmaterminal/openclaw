...
import { a as loadConfig, g as recoverConfigFromLastKnownGood, h as recoverConfigFromJsonRootSuffix, l as readBestEffortConfig, r as createConfigIO, u as readConfigFileSnapshot, y as writeConfigFile } from "./io-5jzTw2vS.js";
import { b as resolveWorkspaceTemplateDir, v as resolveDefaultAgentWorkspaceDir } from "./workspace-CeVfBCfB.js";
import { t as cleanStaleGatewayProcessesSync } from "./restart-stale-pids-BwgQrR52.js";
import { a as inspectPortUsage, s as formatPortDiagnostics } from "./ports-CfLGGRA3.js";
import { r as resolveGatewayService } from "./service-CxDkQZOk.js";
import { t as parsePort } from "./parse-port-BLw7ihd9.js";
import "./config-CzLCUGML.js";
import { g as GATEWAY_CLIENT_NAMES, h as GATEWAY_CLIENT_MODES } from "./message-channel-OCXPZoKg.js";
import { d as waitForActiveEmbeddedRuns, r as getActiveEmbeddedRunCount, t as abortEmbeddedPiRun } from "./runs-CuZc3WA5.js";
import { _ as selectDiagnosticStabilitySnapshot, f as writeDiagnosticStabilityBundleForFailureSync, h as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-bundle-Qzj2N2Mw.js";
import { r as callGateway } from "./call-8AIXlGCX.js";
import { a as getActiveTaskCount, c as markGatewayDraining, d as waitForActiveTasks, l as resetAllLanes } from "./command-queue-CjIh2XS5.js";
import { d as writeRestartSentinel } from "./restart-sentinel-DV3iaqNs.js";
import { a as markGatewaySigusr1RestartHandled, i as isGatewaySigusr1RestartExternallyAllowed, l as triggerOpenClawRestart, o as scheduleGatewaySigusr1Restart, t as consumeGatewaySigusr1RestartAuthorization } from "./restart-CIa7XmMi.js";
import { n as parseTimeoutMsWithFallback } from "./parse-timeout-B90AEPHg.js";
import { n as withProgress } from "./progress-Cxgj4M_Q.js";
import { n as runCommandWithRuntime } from "./cli-utils-HcutwulW.js";
import { n as setGatewayWsLogStyle } from "./ws-logging-Cvk9yLT7.js";
import { t as formatHelpExamples } from "./help-format-C1WDUpcv.js";
import { t as readSecretFromFile } from "./secret-file-BRHwz72v.js";
import { n as buildGatewayDiscoveryTarget } from "./gateway-discovery-targets-C_Dmp-_x.js";
import { o as resolveControlUiRootSync } from "./control-ui-assets-CXfol8qy.js";
import { n as acquireGatewayLock, t as GatewayLockError } from "./gateway-lock-CJI30wNx.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-D21o4hQ6.js";
import { o as handleReset } from "./onboard-helpers-C5Dj9j_z.js";
...
async function runGatewayCommand$1(opts) {
	...
	const { startGatewayServer } = await startupTrace.measure("cli.server-import", () => withProgress({
		...
		indeterminate: true
	}, async () => import("./server-3XHPev_P.js")));
...
function loadConfigModule() {
	configModulePromise ??= import("./read-best-effort-config.runtime-iDkLH7rP.js");
	return configModulePromise;
}
function loadGatewayStatusModule() {
	gatewayStatusModulePromise ??= import("./gateway-status-_-iXSJF2.js");
	return gatewayStatusModulePromise;
}
function loadGatewayHealthModule() {
	gatewayHealthModulePromise ??= import("./health-l67cxIle.js");
	return gatewayHealthModulePromise;
}
function loadBonjourDiscoveryModule() {
	bonjourDiscoveryModulePromise ??= import("./bonjour-discovery-S92_TQt-.js");
	return bonjourDiscoveryModulePromise;
}
function loadWideAreaDnsModule() {
	wideAreaDnsModulePromise ??= import("./widearea-dns-C1_4jrzR.js");
	return wideAreaDnsModulePromise;
}
function loadHealthStyleModule() {
	healthStyleModulePromise ??= import("./health-style-D3gKzuoF.js");
	return healthStyleModulePromise;
}
function loadUsageFormatModule() {
	usageFormatModulePromise ??= import("./usage-format-Bdqzgi3t.js");
	return usageFormatModulePromise;
}
function loadStabilityBundleModule() {
	stabilityBundleModulePromise ??= import("./diagnostic-stability-bundle-Ct6ndPKm.js");
	return stabilityBundleModulePromise;
}
function loadSupportExportModule() {
	supportExportModulePromise ??= import("./diagnostic-support-export-C2XaQ_H3.js");
	return supportExportModulePromise;
}
function loadDaemonStatusGatherModule() {
	daemonStatusGatherModulePromise ??= import("./status.gather-Phwj51i2.js");
