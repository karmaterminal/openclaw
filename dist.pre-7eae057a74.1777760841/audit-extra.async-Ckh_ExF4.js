...
import { h as resolveOAuthDir } from "./paths-CrDgDBYA.js";
import { i as safeStat, n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-cv0edRTW.js";
import { n as isPathInside, t as extensionUsesSkippedScannerPath } from "./scan-paths-r5nRHkjG.js";
import { n as MANIFEST_KEY } from "./legacy-names-Bw_SUQu_.js";
import { a as normalizePluginId, o as normalizePluginsConfig } from "./config-state-Xobk7mRp.js";
import { c as normalizeAgentId } from "./session-key-Ba6CwwIP.js";
import { r as listChannelPlugins } from "./registry-Bph4dR3s.js";
import { x as resolveDefaultAgentId } from "./agent-scope-BrwtzVtf.js";
import "./plugins-DS4mgiqp.js";
import { _ as SANDBOX_BROWSER_SECURITY_HASH_EPOCH } from "./constants-CdlreaDe.js";
import { a as execDockerRaw } from "./docker-CqnGMLXE.js";
import { t as resolveSkillSource } from "./source-CN86DQ4U.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-CVselrxe.js";
import { t as inspectReadOnlyChannelAccount } from "./read-only-account-inspect-CazSE1Ud.js";
import { r as resolveNativeSkillsEnabled } from "./commands-yOzSqB-4.js";
import { n as readInstalledPackageVersion } from "./package-update-utils-CzXwMhx_.js";
import { t as collectIncludePathsRecursive } from "./includes-scan-CpROGjYv.js";
import { t as scanDirectoryWithSummary } from "./skill-scanner-CGQgWeXK.js";
...
async function loadPluginTrustPolicyDeps() {
	pluginTrustPolicyDepsPromise ??= Promise.all([
		import("./config-C_3XQ1UQ.js"),
		import("./tool-policy-D0zMjLWn.js"),
		import("./tool-policy-match-D2_ExI0a.js"),
		import("./tool-policy-Dw3B5DJ4.js"),
		import("./audit-tool-policy-VpRPHacR.js")
...
function loadSkillsModule() {
	skillsModulePromise ??= import("./skills-v3xfeU6p.js");
	return skillsModulePromise;
}
function loadConfigModule() {
	configModulePromise ??= import("./config-Bj8Cp5-n.js");
