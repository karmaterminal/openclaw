...
import { n as getBridgeAuthForPort } from "./bridge-auth-registry-DP1yyuM0.js";
import { t as resolveBrowserRateLimitMessage } from "./rate-limit-message-B5yVv3Fp.js";
...
async function fetchBrowserJson(url, init) {
	...
	try {
		...
		const { dispatchBrowserControlRequest } = await import("./local-dispatch.runtime-DCsu4l4e.js");
