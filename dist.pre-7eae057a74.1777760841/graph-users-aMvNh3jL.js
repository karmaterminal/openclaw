...
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-C17fLgR_.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-DyrMXkv4.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-CMZWY7nG.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("./jsonwebtoken-B52ROlEH.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-19jY92oT.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwt, { JwksClient }]) => ({
		jwt,
		JwksClient
	}));
