...
import { p as isFailoverErrorMessage, t as classifyFailoverReason } from "./errors-DuPNe54y.js";
import { n as buildAgentHookConversationMessages, t as loadCliSessionHistoryMessages } from "./session-history-BpmTnFZm.js";
import { i as isFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error--nSN9y3M.js";
...
async function runCliAgent(params) {
	...
	const { prepareCliRunContext } = await import("./prepare.runtime-5O4R4VXY.js");
	return runPreparedCliAgent(await prepareCliRunContext(params));
}
async function runPreparedCliAgent(context) {
	const { executePreparedCliRun } = await import("./execute.runtime-D_KQ3R1J.js");
