...
function resolveEarlyWarningBand(value) {
	if (value === null || value === 0) return 0;
	if (typeof value !== "number" || !Number.isFinite(value) || value < 0) return DEFAULT_EARLY_WARNING_BAND;
...
//#endregion
export { resolveContinuationRuntimeConfig as n, resolveMaxDelegatesPerTurn as r, clampDelayMs as t };
