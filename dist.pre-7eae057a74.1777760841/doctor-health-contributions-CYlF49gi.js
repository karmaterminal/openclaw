...
async function runGatewayConfigHealth(ctx) {
	const { formatCliCommand } = await import("./command-format-CvdT6mLW.js");
	const { hasAmbiguousGatewayAuthModeConfig } = await import("./auth-mode-policy-BsbxFKNo.js");
	const { note } = await import("./note-tS8QnxWT.js");
...
async function runAuthProfileHealth(ctx) {
	const { maybeRepairLegacyOAuthProfileIds } = await import("./doctor-auth-legacy-oauth-AsV7p37M.js");
	const { noteAuthProfileHealth, noteLegacyCodexProviderOverride } = await import("./doctor-auth-UdWc6MSy.js");
	const { buildGatewayConnectionDetails } = await import("./call-BwF5obVL.js");
	const { note } = await import("./note-tS8QnxWT.js");
...
async function runGatewayAuthHealth(ctx) {
	const { resolveSecretInputRef } = await import("./types.secrets-DTtKOjFN.js");
	const { resolveGatewayAuth } = await import("./auth-CVHY8I0i.js");
	const { note } = await import("./note-tS8QnxWT.js");
	const { randomToken } = await import("./onboard-helpers-BWguXipr.js");
...
async function runClaudeCliHealth(ctx) {
	const { noteClaudeCliHealth } = await import("./doctor-claude-cli-wFgFCfYh.js");
	noteClaudeCliHealth(ctx.cfg);
}
async function runLegacyStateHealth(ctx) {
	const { detectLegacyStateMigrations, runLegacyStateMigrations } = await import("./doctor-state-migrations-BMoNgREf.js");
	const { note } = await import("./note-tS8QnxWT.js");
...
async function runLegacyPluginManifestHealth(ctx) {
	const { maybeRepairLegacyPluginManifestContracts } = await import("./doctor-plugin-manifests-Brt-zPSW.js");
...
async function runBundledPluginRuntimeDepsHealth(ctx) {
	const { maybeRepairBundledPluginRuntimeDeps } = await import("./doctor-bundled-plugin-runtime-deps-CE3JtMLn.js");
...
async function runStateIntegrityHealth(ctx) {
	const { noteStateIntegrity } = await import("./doctor-state-integrity-DHKNbZCm.js");
	await noteStateIntegrity(ctx.cfg, ctx.prompter, ctx.configPath);
}
async function runSessionLocksHealth(ctx) {
	const { noteSessionLockHealth } = await import("./doctor-session-locks-DYNQeiXx.js");
	await noteSessionLockHealth({ shouldRepair: ctx.prompter.shouldRepair });
}
async function runLegacyCronHealth(ctx) {
	const { maybeRepairLegacyCronStore } = await import("./doctor-cron-BxEIHRz0.js");
...
async function runSandboxHealth(ctx) {
	const { maybeRepairSandboxImages, noteSandboxScopeWarnings } = await import("./doctor-sandbox-BQ_GmRj3.js");
...
async function runGatewayServicesHealth(ctx) {
	const { maybeRepairGatewayServiceConfig, maybeScanExtraGatewayServices } = await import("./doctor-gateway-services-BseKeMLY.js");
	const { noteMacLaunchAgentOverrides, noteMacLaunchctlGatewayEnvOverrides } = await import("./doctor-platform-notes-DIbZojff.js");
...
async function runStartupChannelMaintenanceHealth(ctx) {
	const { maybeRunDoctorStartupChannelMaintenance } = await import("./doctor-startup-channel-maintenance-CSnlpje1.js");
...
async function runSecurityHealth(ctx) {
	const { noteSecurityWarnings } = await import("./doctor-security-ByRDquRP.js");
	await noteSecurityWarnings(ctx.cfg);
}
async function runBrowserHealth(ctx) {
	const { noteChromeMcpBrowserReadiness } = await import("./doctor-browser-DuhoyeQu.js");
	await noteChromeMcpBrowserReadiness(ctx.cfg);
}
async function runOpenAIOAuthTlsHealth(ctx) {
	const { noteOpenAIOAuthTlsPrerequisites } = await import("./oauth-tls-preflight-Q9uNYoU0.js");
...
async function runHooksModelHealth(ctx) {
	...
	const { DEFAULT_MODEL, DEFAULT_PROVIDER } = await import("./defaults-f0hLJtM0.js");
	const { loadModelCatalog } = await import("./model-catalog-BNbXyN_f.js");
	const { getModelRefStatus, resolveConfiguredModelRef, resolveHooksGmailModel } = await import("./model-selection-BYgOLda2.js");
	const { note } = await import("./note-tS8QnxWT.js");
...
async function runSystemdLingerHealth(ctx) {
	...
	const { resolveGatewayService } = await import("./service-DD10pFhz.js");
	const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-DIkQEuOP.js");
	const { note } = await import("./note-tS8QnxWT.js");
...
async function runWorkspaceStatusHealth(ctx) {
	const { noteWorkspaceStatus } = await import("./doctor-workspace-status-Dz62frU5.js");
	noteWorkspaceStatus(ctx.cfg);
}
async function runBootstrapSizeHealth(ctx) {
	const { noteBootstrapFileSize } = await import("./doctor-bootstrap-size-C1fgbK_3.js");
	await noteBootstrapFileSize(ctx.cfg);
}
async function runShellCompletionHealth(ctx) {
	const { doctorShellCompletion } = await import("./doctor-completion-BfdNQpN9.js");
...
async function runGatewayHealthChecks(ctx) {
	const { checkGatewayHealth, probeGatewayMemoryStatus } = await import("./doctor-gateway-health-KC3VCIq5.js");
...
async function runMemorySearchHealthContribution(ctx) {
	const { maybeRepairMemoryRecallHealth, noteMemoryRecallHealth, noteMemorySearchHealth } = await import("./doctor-memory-search-oaLqkFgt.js");
...
async function runDevicePairingHealth(ctx) {
	const { noteDevicePairingHealth } = await import("./doctor-device-pairing-B1n-0AHN.js");
...
async function runGatewayDaemonHealth(ctx) {
	const { maybeRepairGatewayDaemon } = await import("./doctor-gateway-daemon-flow-B6OS5Afq.js");
...
async function runWriteConfigHealth(ctx) {
	const { formatCliCommand } = await import("./command-format-CvdT6mLW.js");
	const { applyWizardMetadata } = await import("./onboard-helpers-BWguXipr.js");
	const { CONFIG_PATH, writeConfigFile } = await import("./config-Bj8Cp5-n.js");
	const { logConfigUpdated } = await import("./logging-Bdd2pHfe.js");
...
async function runWorkspaceSuggestionsHealth(ctx) {
	...
	const { resolveAgentWorkspaceDir, resolveDefaultAgentId } = await import("./agent-scope-B2NWfkWd.js");
	const { noteWorkspaceBackupTip } = await import("./doctor-state-integrity-DHKNbZCm.js");
	const { MEMORY_SYSTEM_PROMPT, shouldSuggestMemorySystem } = await import("./doctor-workspace-BfjvFOYW.js");
	const { note } = await import("./note-tS8QnxWT.js");
...
async function runFinalConfigValidationHealth(_ctx) {
	const { readConfigFileSnapshot } = await import("./config-Bj8Cp5-n.js");
