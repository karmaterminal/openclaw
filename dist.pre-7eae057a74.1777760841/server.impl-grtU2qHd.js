...
import { n as isVitestRuntimeEnv, r as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-CcBRbhYW.js";
import { t as formatCliCommand } from "./command-format-CUuNRpiL.js";
import { _ as resolveStateDir, i as isNixMode, r as STATE_DIR } from "./paths-CrDgDBYA.js";
import { s as resolveRuntimeServiceVersion } from "./version-D108XVAk.js";
import { a as logWarn } from "./logger-DM6XyTzO.js";
import { i as runExec } from "./exec-LReuixWa.js";
import { o as getTailnetHostname } from "./tailscale-bmOXf1Ue.js";
import { t as safeEqualSecret } from "./secret-equal-DFLQtoDb.js";
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-CLjuuwrL.js";
import { _ as resolveRequestClientIp, a as isLoopbackHost, g as resolveHostName, h as resolveGatewayListenHosts, i as isLoopbackAddress, l as isTrustedProxyAddress, m as resolveGatewayBindHost, n as isContainerEnvironment, o as isPrivateOrLoopbackAddress, p as resolveClientIp, r as isLocalishHost, s as isPrivateOrLoopbackHost, t as defaultGatewayBindMode, u as isValidIPv4 } from "./net-lcLTXl0l.js";
import { a as createAuthRateLimiter, i as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, n as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, o as normalizeRateLimitClientIp, r as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH } from "./auth-rate-limit-Yc1-bruq.js";
import { a as hasForwardedRequestHeaders, i as authorizeWsControlUiGatewayConnect, o as isLocalDirectRequest, r as authorizeHttpGatewayConnect, s as checkBrowserOrigin, t as assertGatewayAuthConfigured } from "./auth-BaKak7yn.js";
import { n as resolveGatewayAuth } from "./auth-resolve-BHz5g_Dw.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-C9k8dNv6.js";
import { B as shouldAttemptLastKnownGoodRecovery, _ as registerConfigWriteListener, a as loadConfig, c as promoteConfigSnapshotToLastKnownGood, g as recoverConfigFromLastKnownGood, h as recoverConfigFromJsonRootSuffix, i as getRuntimeConfig, j as applyConfigOverrides, nt as resolveAgentMaxConcurrent, r as createConfigIO, rt as resolveSubagentMaxConcurrent, u as readConfigFileSnapshot, y as writeConfigFile } from "./io-5jzTw2vS.js";
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-CZcikA1L.js";
import { r as isCronRunSessionKey } from "./session-key-utils-8wVXCYqL.js";
import { n as normalizeAccountId, r as normalizeOptionalAccountId } from "./account-id-BgECLQdh.js";
import { c as normalizeAgentId, h as toAgentStoreSessionKey, l as normalizeMainKey, m as toAgentRequestSessionKey, u as resolveAgentIdFromSessionKey } from "./session-key-Ba6CwwIP.js";
import { n as getLoadedChannelPlugin, r as listChannelPlugins, t as getChannelPlugin } from "./registry-Bph4dR3s.js";
...
import { _ as resolveAgentConfig, b as resolveAgentWorkspaceDir, x as resolveDefaultAgentId, y as resolveAgentDir } from "./agent-scope-BrwtzVtf.js";
import { t as matchesSkillFilter } from "./filter-CQ-Gbx9h.js";
import { i as isKnownSecretTargetId } from "./target-registry-DovSb8Th.js";
...
import { n as isRestartEnabled } from "./commands.flags-SPkxudi8.js";
import "./config-CzLCUGML.js";
import { r as setSafeTimeout } from "./timer-delay-KkGrPlmi.js";
import { G as validateExecApprovalResolveParams, U as validateExecApprovalGetParams, W as validateExecApprovalRequestParams, _t as validateRequestFrame, an as errorShape, cn as getPreauthHandshakeTimeoutMsFromEnv, in as ErrorCodes, k as validateConnectParams, ln as buildDeviceAuthPayload, mt as validatePluginApprovalResolveParams, pt as validatePluginApprovalRequestParams, r as formatValidationErrors, un as buildDeviceAuthPayloadV3, vt as validateSecretsResolveParams, yt as validateSecretsResolveResult } from "./client-D12j3KRj.js";
import { o as verifyDeviceSignature, r as normalizeDevicePublicKeyBase64Url, t as deriveDeviceIdFromPublicKey } from "./device-identity-VreVW3oD.js";
import { t as rawDataToString } from "./ws-CuIqG_4Z.js";
import { a as isOperatorUiClient, h as GATEWAY_CLIENT_MODES, m as GATEWAY_CLIENT_IDS, n as isGatewayCliClient, o as isWebchatClient, s as isDeliverableMessageChannel, t as isBrowserOperatorUiClient, u as normalizeMessageChannel } from "./message-channel-OCXPZoKg.js";
import { t as normalizeDeviceMetadataForAuth } from "./device-metadata-normalization-C26_Lvp9.js";
import { i as buildPairingConnectErrorMessage, m as resolveDeviceAuthConnectErrorDetailCode, n as buildPairingConnectCloseReason, p as resolveAuthConnectErrorDetailCode, r as buildPairingConnectErrorDetails, t as ConnectErrorDetailCodes } from "./connect-error-details-D-uC5j3Z.js";
import { a as approvalDecisionLabel, n as MAX_PLUGIN_APPROVAL_TIMEOUT_MS, o as buildPluginApprovalExpiredMessage, s as buildPluginApprovalRequestMessage, t as DEFAULT_PLUGIN_APPROVAL_TIMEOUT_MS } from "./plugin-approvals-DLSAPNSa.js";
import { c as PAIRING_SCOPE, d as WRITE_SCOPE, l as READ_SCOPE, o as ADMIN_SCOPE, s as APPROVALS_SCOPE$1, t as CLI_DEFAULT_OPERATOR_SCOPES } from "./method-scopes-v6D-4Hpt.js";
import { n as formatConfigIssueLines } from "./issue-format-CqQPqGQv.js";
import { r as normalizeControlUiBasePath } from "./control-ui-shared-CHVr49Ra.js";
import { t as hasAnyAuthProfileStoreSource } from "./source-check-DyijdW2N.js";
...
import { n as resolveChannelApprovalCapability, t as resolveChannelApprovalAdapter } from "./plugins-DS4mgiqp.js";
import { o as runGlobalGatewayStopSafely } from "./hook-runner-global-D1eSoMau.js";
import { S as createEmptyPluginRegistry, a as getActivePluginRegistry, b as resolveActivePluginHttpRouteRegistry, d as pinActivePluginChannelRegistry, f as pinActivePluginHttpRouteRegistry, h as releasePinnedPluginHttpRouteRegistry, m as releasePinnedPluginChannelRegistry, x as setActivePluginRegistry } from "./runtime-KwvU2Qvz.js";
import { i as canonicalizePathVariant, n as PROTECTED_PLUGIN_ROUTE_PREFIXES, r as canonicalizePathForSecurity } from "./http-route-overlap-CZxIy5Jy.js";
import { n as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-B9VRBd7O.js";
import "./logging-B8DJdSu3.js";
import { n as sleepWithAbort, t as computeBackoff } from "./backoff-BhXSFL4k.js";
import { f as normalizeThinkLevel, h as normalizeVerboseLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel } from "./thinking-DYmORkoK.js";
import { c as normalizeModelSelection, f as resolveConfiguredModelRef, m as resolveHooksGmailModel } from "./model-selection-shared-3Ltfz4Ls.js";
import { i as resolveAllowedModelRef, r as getModelRefStatus, t as isCliProvider } from "./model-selection-cli-DFsd-GLS.js";
import { p as resolveThinkingDefault } from "./model-selection-DwvfvFe2.js";
import { r as getActiveEmbeddedRunCount } from "./runs-CuZc3WA5.js";
import { h as stopDiagnosticHeartbeat, m as startDiagnosticHeartbeat } from "./diagnostic-DLmgtjxT.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, t as canonicalizeMainSessionAlias } from "./main-session-CIzfmmGG.js";
import { t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-BVlm2TDW.js";
import { o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-aVTuLlts.js";
import { t as loadSessionStore } from "./store-load-Bm74f3zN.js";
import { u as setSessionRuntimeModel } from "./types-D3wf7T-9.js";
import { c as updateSessionStore, l as updateSessionStoreEntry, t as archiveRemovedSessionTranscripts } from "./store-DtATwbu4.js";
import { n as resolveMainSessionKeyFromConfig } from "./sessions-DH-OezqI.js";
import { n as onSessionTranscriptUpdate } from "./transcript-events-BgA3dbPs.js";
import { n as onSessionLifecycleEvent } from "./session-lifecycle-events-Dj-I9d0L.js";
import { t as loadGatewayTlsRuntime$1 } from "./gateway-Cu7EtWsz.js";
import { c as getAgentRunContext, d as sweepStaleRunContexts, l as onAgentEvent, t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-DymXOfrS.js";
import { o as startGatewayModelPricingRefresh } from "./usage-format-CuYPfQdu.js";
import { n as deriveSessionTotalTokens, r as hasNonzeroUsage } from "./usage-DDq4LR8h.js";
import { i as readSessionMessages, t as attachOpenClawTranscriptMeta } from "./session-utils.fs-BLGfvbBE.js";
import { i as stripInlineDirectiveTagsForDisplay } from "./directive-tags-BAtwMUmx.js";
import { a as resolveSessionTranscriptCandidates, i as cleanupArchivedSessionTranscripts } from "./session-transcript-files.fs-D6QqSh_y.js";
import { a as loadSessionEntry, d as resolveGatewaySessionStoreTarget, i as loadGatewaySessionRow } from "./session-utils-Yx2LsPvL.js";
...
import { i as enqueueCommandInLane, s as getTotalQueueSize, u as setCommandLaneConcurrency } from "./command-queue-CjIh2XS5.js";
import { c as stripLeadingSilentToken, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken } from "./tokens-DO03xcy8.js";
import { o as resolveFailoverReasonFromError } from "./failover-error--nSN9y3M.js";
import { r as normalizeCronJobInput } from "./openclaw-tools-DBQ6sUbd.js";
import { s as stripHeartbeatToken } from "./heartbeat-BqmSdC5f.js";
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-secret-gateway-c3CuQsc5.js";
import { i as evaluateGatewayAuthSurfaceStates, r as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-web-tools-Di-_Tqqc.js";
import { n as resolveConfiguredDeferredChannelPluginIds, r as resolveGatewayStartupPluginIds } from "./channel-plugin-ids-DWcJCb10.js";
import { t as SsrFBlockedError } from "./ssrf-BidpExjG.js";
import { t as detectMime } from "./mime-D8DgGtqn.js";
import { r as cleanOldMedia } from "./store-kajRw-Xe.js";
import { a as CANVAS_HOST_PATH, c as injectCanvasLiveReload, l as normalizeUrlPath, s as handleA2uiHttpRequest, u as resolveFileWithinRoot } from "./web-media-MW6CtKWh.js";
...
import { T as resolveExecApprovalRequestAllowedDecisions, r as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS, w as resolveExecApprovalAllowedDecisions } from "./exec-approvals-DuykPV0F.js";
import { r as registerSkillsChangeListener } from "./refresh-state-BtZfy3Z1.js";
import "./refresh-CClGHQ_G.js";
import { c as roleScopesAllow } from "./pairing-token-DeAXEiPA.js";
import { a as refreshRemoteBinsForConnectedNodes, c as setSkillsRemoteRegistry, h as updatePairedNodeMetadata, i as recordRemoteNodeInfo, m as requestNodePairing, n as primeRemoteSkillsCache, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo, u as getPairedNode } from "./skills-remote-BABQetLl.js";
import { n as resolveCronStorePath, r as saveCronStore, t as loadCronStore } from "./store-DeEzMgZs.js";
import { t as getMachineDisplayName } from "./machine-name-DPnsztiD.js";
import { o as retireSessionMcpRuntime } from "./pi-bundle-mcp-runtime-B7kfNUUQ.js";
import "./pi-bundle-mcp-tools-3PLiXHwn.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-DlqI1lwq.js";
import { n as assertSafeCronSessionTargetId, r as isInvalidCronSessionTargetIdError, t as normalizeHttpWebhookUrl } from "./webhook-url-B2Lj3UZo.js";
import { c as setPreRestartDeferralCheck, n as deferGatewayRestartUntilIdle, r as emitGatewayRestart, s as setGatewaySigusr1RestartPolicy } from "./restart-CIa7XmMi.js";
import { o as resetModelCatalogCache, r as loadModelCatalog } from "./model-catalog-4FqZyXTU.js";
import { t as deliverOutboundPayloads } from "./deliver-BFDaQjWX.js";
import { r as resetDirectoryCache } from "./target-resolver-bKQrJcr6.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-C_fY8blz.js";
import { i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-BpGlai2C.js";
import { c as initSubagentRegistry } from "./subagent-registry-CK8hKi52.js";
import { t as resolveAgentTimeoutMs } from "./timeout-DA1IgMhi.js";
import { c as resolveHookExternalContentSource, o as isExternalHookSession, s as mapHookExternalContentSource } from "./external-content-CDE8A5dv.js";
import { o as resolvePreferredSessionKeyForSessionIdMatches } from "./live-model-switch-DFUzmFux.js";
import { t as createPluginRuntime } from "./runtime-D-JrPknL.js";
import { o as getTotalPendingReplies } from "./dispatch-WwEDTSt8.js";
import { n as sanitizeInboundSystemTags } from "./inbound-text-Be_7VMM0.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-Du3R7AXo.js";
import { c as formatExecApprovalExpiresIn, f as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-reply-DN-gsrOY.js";
import { t as CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "./approval-handler-adapter-runtime-CebDNaiU.js";
import { n as sanitizeExecApprovalDisplayText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-BTgxaTZv.js";
import { n as createChannelApprovalHandlerFromCapability } from "./approval-handler-runtime-Dq3yIscw.js";
import { i as watchChannelRuntimeContexts, n as getChannelRuntimeContext, t as createTaskScopedChannelRuntime } from "./channel-runtime-context-CMx133tQ.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-BYtjAOoZ.js";
import { i as onHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-DiKGmqwT.js";
import { n as resolveAgentOutboundIdentity } from "./identity-Bc92Hjyl.js";
import { i as resolveNodeCommandAllowlist, r as normalizeDeclaredNodeCommands } from "./node-command-policy-w_d8eAWZ.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs, t as formatForLog } from "./ws-log-CHbDzB0f.js";
import { i as safeParseJson } from "./nodes.helpers-Ctgro8QD.js";
import { i as assertGatewayAuthNotKnownWeak, n as mergeGatewayAuthConfig, r as mergeGatewayTailscaleConfig, t as ensureGatewayStartupAuth } from "./startup-auth-zne6tKD2.js";
import { r as resolveBootstrapProfileScopesForRole } from "./device-bootstrap-profile-CcqEc0rL.js";
import { _ as updatePairedDeviceMetadata, a as getPairedDevice, c as listApprovedPairedDeviceRoles, l as listDevicePairing, n as approveDevicePairing, p as requestDevicePairing, r as ensureDeviceToken, s as hasEffectivePairedDeviceRole, t as approveBootstrapDevicePairing, u as listEffectivePairedDeviceRoles, v as verifyDeviceToken } from "./device-pairing-PWd2q8qn.js";
import { a as redeemDeviceBootstrapTokenProfile, n as getBoundDeviceBootstrapProfile, o as revokeDeviceBootstrapToken, r as getDeviceBootstrapTokenProfile, s as verifyDeviceBootstrapToken } from "./device-bootstrap-C60i_l48.js";
import { t as createDefaultDeps } from "./deps-BuwER1Yg.js";
import { i as buildSystemRunApprovalEnvBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-Dz1sYYvr.js";
import { n as resolveSystemRunApprovalRequestContext } from "./system-run-approval-context-CqNLDOgM.js";
import { t as closeMcpLoopbackServer } from "./mcp-http-BL_-Xca_.js";
import { A as getHookSessionKeyPrefixError, B as resolveHookIdempotencyKey, C as setDefaultSecurityHeaders, D as extractHookToken, F as normalizeHookHeaders, H as resolveHookTargetAgentId, I as normalizeWakePayload, K as logRejectedLargePayload, L as readJsonBody, M as isSessionKeyAllowedByPrefix, N as normalizeAgentPayload, O as getHookAgentPolicyError, P as normalizeHookDispatchSessionKey, R as resolveHookChannel, U as resolveHooksConfig, V as resolveHookSessionKey, W as applyHookMappings, _ as loadGatewayModelCatalog, d as resolveHttpBrowserOriginPolicy, g as __resetModelCatalogCacheForTest, h as resolveTrustedHttpOperatorScopes, j as isHookAgentAllowed, k as getHookChannelError, o as getBearerToken, r as authorizeGatewayHttpRequestOrReply, s as getHeader, y as sendGatewayAuthFailure, z as resolveHookDeliver } from "./http-utils-CpMDSdh8.js";
import { t as createOutboundSendDeps } from "./outbound-send-deps-Bx3akMBN.js";
import { C as TICK_INTERVAL_MS, S as MAX_PREAUTH_PAYLOAD_BYTES, _ as DEDUPE_MAX, b as MAX_BUFFERED_BYTES, f as isSuppressedControlReplyLeadFragment, m as abortChatRunById, p as isSuppressedControlReplyText, v as DEDUPE_TTL_MS, x as MAX_PAYLOAD_BYTES, y as HEALTH_REFRESH_INTERVAL_MS } from "./chat-Xfwr-PbV.js";
import { t as cleanupBrowserSessionsForLifecycleEnd } from "./browser-lifecycle-cleanup-BxrRse_h.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-DQoBHrF0.js";
import { a as writeWideAreaGatewayZone, i as resolveWideAreaDiscoveryDomain } from "./widearea-dns-AOu6gLUu.js";
import { a as resolveControlUiRootOverrideSync, n as isPackageProvenControlUiRootSync, o as resolveControlUiRootSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-CXfol8qy.js";
import { t as GatewayLockError } from "./gateway-lock-CJI30wNx.js";
import { t as getHealthSnapshot } from "./health-ta-rTMcJ.js";
import { t as runSetupWizard } from "./setup-B6lbJcvL.js";
import { d as startTaskRegistryMaintenance, f as stopTaskRegistryMaintenance, g as markCronJobActive, h as clearCronJobActive, n as getInspectableTaskRegistrySummary } from "./task-registry.maintenance-BaAbS9RW.js";
import { i as migrateOrphanedSessionKeys } from "./state-migrations-DcS6CEJf.js";
import { _ as resolveDeliveryTarget, a as computeJobPreviousRunAtMs, c as findJobOrThrow, d as isJobEnabled, f as nextWakeAtMs, g as resolveJobPayloadTextForMain, h as recordScheduleComputeError, i as computeJobNextRunAtMs, l as hasScheduledNextRunAtMs, m as recomputeNextRunsForMaintenance, n as applyJobPatch, o as createJob, p as recomputeNextRuns, r as assertSupportedJobSpec, s as errorBackoffMs, t as DEFAULT_ERROR_BACKOFF_SCHEDULE_MS, u as isJobDue } from "./jobs-D9cnh5ee.js";
import { t as createCronExecutionId } from "./run-id-BfSpoKPx.js";
import { a as resolveHeartbeatAckMaxChars$1, i as resolveCronPayloadOutcome, t as isHeartbeatOnlyResponse } from "./helpers-CywehsO-.js";
import { a as resolveCronChannelOutputPolicy, n as markCronSessionPreRun, r as persistCronSkillsSnapshotIfChanged, t as createPersistCronSessionEntry } from "./run-session-state-B5IivW-x.js";
import { t as runChannelPluginStartupMaintenance } from "./lifecycle-startup-HZ8fZYqd.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-Dd2bNZc_.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-Wv2saavy.js";
import { C as resolveGatewayReloadSettings, D as roleCanSkipDeviceIdentity, E as parseGatewayRole, O as pruneStaleControlPlaneBuckets, S as diffConfigPaths, T as buildGatewayReloadPlan, _ as appendCronRunLog, a as coreGatewayHandlers, b as resolveCronDeliveryPlan, c as listSystemPresence, d as CANVAS_CAPABILITY_TTL_MS, f as buildCanvasScopedHostUrl, g as loadVoiceWakeConfig, h as formatError, i as setFallbackGatewayContextResolver, l as upsertPresence, m as normalizeCanvasScopedUrl, o as handleGatewayRequest, p as mintCanvasCapabilityToken, s as broadcastPresenceSnapshot, t as loadGatewayStartupPlugins, u as clearNodeWakeState, v as resolveCronRunLogPath, w as startGatewayConfigReloader, x as resolveFailureDestination, y as resolveCronRunLogPruneOptions } from "./server-plugin-bootstrap-BiM82EVo.js";
import { i as resolveCronSession, n as runHeartbeatOnce, r as startHeartbeatRunner } from "./heartbeat-runner-Di0nDT1s.js";
import { n as stopGmailWatcher, t as startGmailWatcherWithLogs } from "./gmail-watcher-lifecycle-CS5djf7B.js";
import "./paths-4frb9esP.js";
import { t as getUpdateAvailable } from "./update-startup-C9wt4pDU.js";
import { t as hasConfiguredInternalHooks } from "./configured-D8PzXg-u.js";
...
function loadExecApprovalForwarderRuntime() {
	execApprovalForwarderRuntimePromise ??= import("./exec-approval-forwarder.runtime-CUmtZ3bo.js");
...
async function loadSkillsSnapshotRuntime() {
	skillsSnapshotRuntimePromise ??= import("./skills-snapshot.runtime-CJsO3oKy.js");
...
async function loadCliRunnerRuntime() {
	return await import("./cli-runner.runtime-D2FGHDO7.js");
}
async function loadUsageFormatRuntime() {
	return await import("./usage-format-Bdqzgi3t.js");
}
...
function recoverPendingOutboundDeliveries(params) {
	(async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-CsOKuvim.js");
		const { deliverOutboundPayloads } = await import("./deliver-BGuNnNT3.js");
...
function recoverPendingSessionDeliveries(params) {
	setTimeout(() => {
		(async () => {
			const { recoverPendingRestartContinuationDeliveries } = await import("./server-restart-sentinel-CXWrq4zj.js");
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-DouCW2t2.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-D-J10hQH.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-rXN0A1JM.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-Bq-EAfPU.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-Noyb0xL5.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-Cbn7lzSt.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-DhNHZYmj.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-G05Tvkrj.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-BKAoDa7e.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-BHPMTJzB.js");
	return toolsInvokeHttpModulePromise;
}
function getVoiceClawRealtimeUpgradeModule() {
	voiceClawRealtimeUpgradeModulePromise ??= import("./upgrade-Fj2G_7NE.js");
...
async function hasGatewayStartupInternalHookListeners() {
	const { hasInternalHookListeners } = await import("./internal-hooks-C04JhEqj.js");
	return hasInternalHookListeners("gateway", "startup");
}
async function prewarmConfiguredPrimaryModel(params) {
	const { resolveAgentModelPrimaryValue } = await import("./model-input-D27dOP-4.js");
	const explicitPrimary = resolveAgentModelPrimaryValue(params.cfg.agents?.defaults?.model)?.trim();
	if (!explicitPrimary) return;
	const { normalizeProviderId } = await import("./provider-id-C-I1YQzv.js");
	...
	const [{ resolveOpenClawAgentDir }, { DEFAULT_MODEL, DEFAULT_PROVIDER }, { selectAgentHarness }, { isCliProvider, resolveConfiguredModelRef }, { ensureOpenClawModelsJson }, { resolveModel, resolveModelAsync }, { resolveEmbeddedAgentRuntime }] = await Promise.all([
		import("./agent-paths-C3deHpBL.js"),
		import("./defaults-f0hLJtM0.js"),
		import("./selection-CjIzvOts.js"),
		import("./model-selection-BYgOLda2.js"),
		import("./models-config-CO-JSayU.js"),
		import("./model-BGlQwDTj.js"),
		import("./runtime-i0Wfb4OR.js")
	]);
...
async function startGatewaySidecars(params) {
	await measureStartup(params.startupTrace, "sidecars.session-locks", async () => {
		try {
			const [{ resolveStateDir }, { resolveAgentSessionDirs }, { cleanStaleLockFiles }] = await Promise.all([
				import("./paths-wh9cFz0f.js"),
				import("./session-dirs-DuAiKlg9.js"),
				import("./session-write-lock-CiTTIq-F.js")
			]);
			...
			for (const sessionsDir of sessionDirs) {
				...
				if (result.cleaned.length > 0) {
					const { markRestartAbortedMainSessionsFromLocks } = await import("./main-session-restart-recovery--ChnZLOB.js");
	...
	await measureStartup(params.startupTrace, "sidecars.gmail-watch", async () => {
		if (params.cfg.hooks?.enabled && params.cfg.hooks.gmail?.account) {
			const { startGmailWatcherWithLogs } = await import("./gmail-watcher-lifecycle-lRFoPJy5.js");
			await startGmailWatcherWithLogs({
				cfg: params.cfg,
				log: params.logHooks
			});
	...
	await measureStartup(params.startupTrace, "sidecars.gmail-model", async () => {
		if (params.cfg.hooks?.gmail?.model) {
			const [{ DEFAULT_MODEL, DEFAULT_PROVIDER }, { loadModelCatalog }, { getModelRefStatus, resolveConfiguredModelRef, resolveHooksGmailModel }] = await Promise.all([
				import("./defaults-f0hLJtM0.js"),
				import("./model-catalog-BNbXyN_f.js"),
				import("./model-selection-BYgOLda2.js")
			]);
	...
	await measureStartup(params.startupTrace, "sidecars.internal-hooks", async () => {
		try {
			if (internalHooksConfigured) {
				const [{ setInternalHooksEnabled }, { loadInternalHooks }] = await Promise.all([import("./internal-hooks-C04JhEqj.js"), import("./loader-BmgaQOYb.js")]);
	...
	if (internalHooksConfigured || await hasGatewayStartupInternalHookListeners()) setTimeout(() => {
		import("./internal-hooks-C04JhEqj.js").then(({ createInternalHookEvent, triggerInternalHook }) => {
	...
	await measureStartup(params.startupTrace, "sidecars.plugin-services", async () => {
		try {
			const { startPluginServices } = await import("./services-DrcMQSFh.js");
	...
	if (params.cfg.acp?.enabled) {
		const [{ getAcpSessionManager }, { ACP_SESSION_IDENTITY_RENDERER_VERSION }] = await Promise.all([import("./manager-gAZEKsqo.js"), import("./session-identifiers-BLqkqOY6.js")]);
	...
	await measureStartup(params.startupTrace, "sidecars.memory", async () => {
		...
		setImmediate(() => {
			import("./server-startup-memory-DugAm36H.js").then(({ startGatewayMemoryBackend }) => startGatewayMemoryBackend({
				cfg: params.cfg,
				log: params.log
			})).catch((err) => {
	...
	await measureStartup(params.startupTrace, "sidecars.restart-sentinel", async () => {
		...
		const { hasRestartSentinel } = await import("./restart-sentinel-Cb9_evnq.js");
		if (!await hasRestartSentinel()) return;
		setTimeout(() => {
			import("./server-restart-sentinel-CXWrq4zj.js").then(({ scheduleRestartSentinelWake }) => scheduleRestartSentinelWake({ deps: params.deps })).catch((err) => {
	...
	await measureStartup(params.startupTrace, "sidecars.subagent-recovery", async () => {
		const { scheduleSubagentOrphanRecovery } = await import("./subagent-registry-CeBhbXq-.js");
		scheduleSubagentOrphanRecovery();
	});
	await measureStartup(params.startupTrace, "sidecars.main-session-recovery", async () => {
		const { scheduleRestartAbortedMainSessionRecovery } = await import("./main-session-restart-recovery--ChnZLOB.js");
		scheduleRestartAbortedMainSessionRecovery();
	});
	return { pluginServices };
}
const defaultGatewayPostAttachRuntimeDeps = {
	getGlobalHookRunner: async () => (await import("./hook-runner-global-DIBJRz12.js")).getGlobalHookRunner(),
	logGatewayStartup: async (params) => (await import("./server-startup-log-Cb-WCzhM.js")).logGatewayStartup(params),
	scheduleGatewayUpdateCheck: async (...args) => (await import("./update-startup-BlfsUPWC.js")).scheduleGatewayUpdateCheck(...args),
	startGatewaySidecars,
	startGatewayTailscaleExposure: async (...args) => (await import("./server-tailscale-BETt0t4k.js")).startGatewayTailscaleExposure(...args)
};
	...
	try {
		...
		if (!minimalTestGateway) {
			if (deferredConfiguredChannelPluginIds.length > 0) {
				const { reloadDeferredGatewayPlugins } = await import("./server-plugin-bootstrap-DpzVaTTF.js");
