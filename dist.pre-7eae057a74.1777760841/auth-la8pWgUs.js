...
import { s as loadAuthProfileStoreForRuntime } from "./store-DWcsUxbV.js";
import { n as resolvePluginProviders } from "./providers.runtime-DtwAQFwU.js";
import "./model-selection-shared-3Ltfz4Ls.js";
import { n as listProfilesForProvider } from "./profile-list-Bg_34ywG.js";
import { n as clearAuthProfileCooldown } from "./usage-Dj8w89gg.js";
import { i as upsertAuthProfile } from "./profiles-Db2kwt2_.js";
import { n as validateAnthropicSetupToken } from "./provider-auth-token-D0d3Bmgu.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-CJDjj5VL.js";
import { n as stylePromptMessage, t as stylePromptHint } from "./prompt-style-Dlnkjxdz.js";
import { t as createClackPrompter } from "./clack-prompter-DAZE7faE.js";
import { n as logConfigUpdated } from "./logging-CmYcTuvL.js";
import { a as loadValidConfigOrThrow, u as updateConfig } from "./shared-DdrO4GAQ.js";
import { t as isRemoteEnvironment } from "./remote-env-SC0CzUH7.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-Dl-ecfSM.js";
import { i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-CDOSNz2b.js";
...
async function runProviderAuthMethod(params) {
	...
	await persistProviderAuthResult({
		result: await params.method.run({
			...
			openUrl: async (url) => {
				const { openUrl } = await import("./onboard-helpers-BWguXipr.js");
				await openUrl(url);
			},
