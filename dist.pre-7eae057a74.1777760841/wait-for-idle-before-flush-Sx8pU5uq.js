...
import { a as logWarn, t as logDebug } from "./logger-DM6XyTzO.js";
import { i as openBoundaryFileSync, r as openBoundaryFile } from "./boundary-file-read-dPwN6pjH.js";
import { t as loadPluginManifestRegistry } from "./manifest-registry-D3girPWo.js";
import { c as resolveEffectivePluginActivationState, o as normalizePluginsConfig } from "./config-state-Xobk7mRp.js";
...
import { r as resolveProviderEndpoint } from "./provider-attribution-DCegKE6D.js";
import { i as applyMergePatch } from "./schema-validator-CW9intW8.js";
import { v as resolveAgentContextLimits } from "./agent-scope-BrwtzVtf.js";
...
import { a as normalizeInputProvenance, n as applyInputProvenanceToUserMessage, r as hasInterSessionUserProvenance } from "./input-provenance-B72DIE3s.js";
import { s as getCompactionProvider } from "./loader-B4BgeLlc.js";
import "./plugins-DS4mgiqp.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-D1eSoMau.js";
import { t as listAgentToolResultMiddlewares } from "./agent-tool-result-middleware-BDPrFIDf.js";
import { D as resolveProviderCacheTtlEligibility, J as validateProviderReplayTurnsWithPlugin, R as resolveProviderTransportTurnStateWithPlugin, V as resolveProviderWebSocketSessionPolicyWithPlugin, W as sanitizeProviderReplayHistoryWithPlugin, j as resolveProviderReasoningOutputModeWithPlugin, nt as resolveProviderRuntimePlugin } from "./provider-runtime-BwXob-b1.js";
import "./model-selection-DwvfvFe2.js";
import { c as createExpiringMapCache, d as resolveCacheTtlMs, u as isCacheEnabled } from "./store-cache-BlX9FKkX.js";
...
import { a as normalizeUsage, i as makeZeroUsageSnapshot } from "./usage-DDq4LR8h.js";
import { a as normalizeAssistantPhase, o as parseAssistantTextSignature, t as encodeAssistantTextSignature } from "./chat-message-content-BrcR_eKj.js";
import { n as matchesAnyGlobPattern, t as compileGlobPatterns } from "./glob-pattern-JMMTGDX1.js";
import { c as mergeAlsoAllowPolicy, m as resolveToolProfilePolicy, n as applyOwnerOnlyToolPolicy } from "./tool-policy-Bcyf1aOU.js";
import { a as isSilentReplyText } from "./tokens-DO03xcy8.js";
import { c as downgradeOpenAIFunctionCallReasoningPairs, g as sanitizeGoogleTurnOrdering, l as downgradeOpenAIReasoningBlocks, n as validateGeminiTurns, s as sanitizeSessionMessagesImages, t as validateAnthropicTurns, u as isGoogleModelApi } from "./pi-embedded-helpers-oR_ICWVj.js";
import { n as extractToolResultId, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-B-IQdFlf.js";
...
import { o as isGooglePromptCacheEligible } from "./extra-params-BkbfNWhf.js";
import { c as resolveProviderRequestPolicyConfig, i as getModelProviderRequestTransport, r as buildProviderRequestTlsClientOptions } from "./provider-request-config-ANCq-WpR.js";
import { S as isAnthropicModelRef, x as isAnthropicFamilyCacheTtlEligible } from "./provider-stream-shared-CN0eenMj.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-C0cVBguu.js";
import { n as buildCopilotIdeHeaders, r as hasCopilotVisionInput, t as buildCopilotDynamicHeaders } from "./copilot-dynamic-headers-CLiEKoOT.js";
import { _ as resolveOpenAITextVerbosity } from "./proxy-stream-wrappers-ztu01JQX.js";
import { r as normalizeOpenAIReasoningEffort } from "./openai-responses-payload-policy-vjobDzuT.js";
import { y as shouldPreserveThinkingBlocks } from "./provider-model-shared-COpehvpA.js";
import { n as collectTextContentBlocks, t as createAgentToolResultMiddlewareRunner } from "./tool-result-middleware-BA_E8fAr.js";
import { s as stripHeartbeatToken } from "./heartbeat-BqmSdC5f.js";
import { a as resolveEffectiveToolPolicy, c as resolveSubagentToolPolicyForSession, o as resolveGroupContextFromSessionKey, s as resolveGroupToolPolicy } from "./read-capability-gpfmsMgv.js";
import { d as resolveDebugProxySettings, n as captureWsEvent, u as createDebugProxyWebSocketAgent } from "./runtime-A0C_9pqU.js";
import { n as retryAsync } from "./retry-BZqyJPWH.js";
import { d as makeMissingToolResult, f as repairToolUseResultPairing, h as stripToolResultDetails, m as sanitizeToolUseResultPairing, p as sanitizeToolCallInputs, s as mergeTransportMetadata } from "./transport-stream-shared-0ojDAcd-.js";
import { t as extractSections } from "./post-compaction-context-C09KSmPm.js";
import { i as resolveSkillRuntimeConfig } from "./env-overrides-B_P_Upvk.js";
...
import { i as setPluginToolMeta, n as getPluginToolMeta } from "./tools-BKtbhZm1.js";
import { c as mapOpenAIReasoningEffortForModel, i as createBoundaryAwareStreamFnForModel, l as resolveOpenAIStrictToolSetting, o as normalizeOpenAIStrictToolParameters, s as resolveOpenAIStrictToolFlagForInventory } from "./provider-stream-BxtRjkaN.js";
import { n as loadEnabledBundleLspConfig } from "./bundle-lsp-BauS8b88.js";
import { c as loadEmbeddedPiMcpConfig, d as describeStdioMcpServerLaunchConfig, f as resolveStdioMcpServerLaunchConfig } from "./pi-bundle-mcp-runtime-B7kfNUUQ.js";
import { r as applyPiCompactionSettingsFromConfig } from "./pi-settings-CTmqRsoC.js";
import { a as toToolDefinitions } from "./pi-tool-definition-adapter-DMyIuk6q.js";
import { n as buildDefaultToolPolicyPipelineSteps, t as applyToolPolicyPipeline } from "./tool-policy-pipeline-J51sAlFa.js";
import { i as setRawSessionAppendMessage, n as rewriteTranscriptEntriesInSessionManager, r as getRawSessionAppendMessage } from "./transcript-rewrite-QGuh3u_S.js";
import { t as withTimeout } from "./with-timeout-BD6rQYxG.js";
import { n as isQueryStopWordToken, t as extractKeywords } from "./query-expansion-CLatEfb1.js";
import "./query-BrWoJ1e6.js";
import { o as wrapUntrustedPromptDataBlock, t as buildAgentSystemPrompt } from "./system-prompt-DW-qZ_-O.js";
import { t as estimateStringChars } from "./cjk-chars-0tWMq8aE.js";
import { t as createAnthropicVertexStreamFnForModel } from "./anthropic-vertex-stream-CHbutf0O.js";
...
const log$2 = createSubsystemLogger("compaction");
...
async function summarizeWithFallback(params) {
	...
	try {
		...
		log$2.warn(`Full summarization failed: ${formatErrorMessage(fullError)}`);
	}
	const smallMessages = [];
	...
	if (smallMessages.length > 0 && smallMessages.length !== messages.length) try {
		...
		log$2.warn(`Partial summarization also failed: ${formatErrorMessage(partialError)}`);
	}
...
//#endregion
export { shouldAllowProviderOwnedThinkingReplay as $, compactWithSafetyTimeout as A, installContextEngineLoopHook as B, limitHistoryTurns as C, consumeCompactionSafeguardCancelReason as D, isRealConversationMessage as E, estimateToolResultReductionPotential as F, releaseWsSession as G, repairSessionFileIfNeeded as H, resolveLiveToolResultMaxChars as I, resolveChannelCapabilities as J, buildStreamErrorAssistantMessage as K, sessionLikelyHasOversizedToolResults as L, isCacheTtlEligibleProvider as M, readLastCacheTtlTimestamp as N, setCompactionSafeguardCancelReason as O, guardSessionManager as P, resolveTranscriptPolicy as Q, truncateOversizedToolResultsInSession as R, getDmHistoryLimitFromSessionKey as S, hasMeaningfulConversationContent as T, createPreparedEmbeddedPiSettingsManager as U, installToolResultContextGuard as V, createBundleLspToolRuntime as W, estimateMessagesTokens as X, SAFETY_MARGIN as Y, isReasoningTagProvider as Z, trackSessionManagerAccess as _, collectAllowedToolNames as a, validateReplayTurns as b, applySystemPromptOverrideToSession as c, describeEmbeddedAgentStreamStrategy as d, assessLastAssistantMessage as et, resolveEmbeddedAgentApiKey as f, prewarmSessionFile as g, resolveEmbeddedRunSkillEntries as h, PI_RESERVED_TOOL_NAMES as i, resolveCompactionTimeoutMs as j, applyFinalEffectiveToolPolicy as k, buildEmbeddedSystemPrompt as l, resolveEmbeddedAgentStreamFn as m, mapThinkingLevel as n, collectRegisteredToolNames as o, resolveEmbeddedAgentBaseStreamFn as p, buildUsageWithNoCost as q, splitSdkTools as r, toSessionToolAllowlist as s, flushPendingToolResultsAfterIdle as t, dropThinkingBlocks as tt, createSystemPromptOverride as u, normalizeAssistantReplayContent as v, buildEmbeddedExtensionFactories as w, buildEmbeddedMessageActionDiscoveryInput as x, sanitizeSessionHistory as y, truncateOversizedToolResultsInSessionManager as z };
