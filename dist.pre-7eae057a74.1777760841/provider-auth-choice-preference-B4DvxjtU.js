import { n as resolveManifestProviderAuthChoice } from "./provider-auth-choices-BWGFgXUB.js";
import { r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-BgbUHH5i.js";
...
async function resolvePreferredProviderForAuthChoice(params) {
	...
	const { resolveProviderPluginChoice, resolvePluginProviders } = await import("./provider-auth-choice.runtime-BuIwIqon.js");
