...
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "./webhook-request-guards-CY81CAci.js";
import "./webhook-ingress-CatMjWw6.js";
import { g as resolveRealtimeVoiceAgentConsultToolsAllow, h as resolveRealtimeVoiceAgentConsultTools, s as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME } from "./provider-resolver-DlM8V6cH.js";
import { s as consultRealtimeVoiceAgent, t as convertPcmToMulaw8k } from "./realtime-voice-Dg_BRn4u.js";
import { t as resolveConfiguredCapabilityProvider } from "./provider-selection-runtime-BTvYKggr.js";
import { t as zod_exports } from "./zod-66az193k.js";
import "./api-DZzghPHY.js";
import { a as deepMergeDefined, i as validateProviderConfig, n as normalizeVoiceCallConfig, r as resolveVoiceCallConfig } from "./config-jBBmht2I.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-D9F6lfOS.js";
import { t as resolveVoiceResponseModel } from "./response-model-C8Ns6Xab.js";
import { t as isProviderStatusTerminal } from "./call-status-JdGT8wGE.js";
import { t as getHeader } from "./http-headers-BK9CyfD1.js";
...
function loadRealtimeTranscriptionRuntime() {
	realtimeTranscriptionRuntimePromise ??= import("./realtime-transcription.runtime-BUAue59s.js");
	return realtimeTranscriptionRuntimePromise;
}
function loadResponseGeneratorModule() {
	responseGeneratorModulePromise ??= import("./response-generator-BCybn8A4.js");
...
function loadTelnyxProvider() {
	telnyxProviderPromise ??= import("./telnyx-BOZ1SSKQ.js");
	return telnyxProviderPromise;
}
function loadTwilioProvider() {
	twilioProviderPromise ??= import("./twilio-ht0wq6Ba.js");
	return twilioProviderPromise;
}
function loadPlivoProvider() {
	plivoProviderPromise ??= import("./plivo-D4iznkBw.js");
	return plivoProviderPromise;
}
function loadMockProvider() {
	mockProviderPromise ??= import("./mock-M804tbXm.js");
	return mockProviderPromise;
}
function loadRealtimeVoiceRuntime() {
	realtimeVoiceRuntimePromise ??= import("./realtime-voice.runtime-DB6RvcC4.js");
	return realtimeVoiceRuntimePromise;
}
function loadRealtimeHandler() {
	realtimeHandlerPromise ??= import("./realtime-handler-DHxcfpdR.js");
