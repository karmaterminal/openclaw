...
import { o as generateSecureUuid } from "./secure-random-UcQRcWr6.js";
import { s as hasOutboundReplyContent } from "./reply-payload-DnFwi8F_.js";
import { o as createBlockReplyPipeline, r as resolveEffectiveBlockStreamingConfig, t as clampPositiveInteger } from "./block-streaming-C5bcRERk.js";
import { n as formatToolSummary, r as resolveToolDisplay } from "./tool-display-aqjaz-jj.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-CXcMMBXQ.js";
import { r as prefixSystemMessage } from "./system-message-CDI_acmS.js";
import { t as resolveConfiguredTtsMode } from "./tts-config-C-wsOZVg.js";
import { t as hasInboundMedia } from "./inbound-media-DQeByrJG.js";
import { i as toAcpRuntimeError } from "./errors-CgvuIUco.js";
import { o as isSessionIdentityPending, u as resolveSessionIdentityFromMeta } from "./session-identity-DChbBfNL.js";
import { t as formatAcpRuntimeErrorText } from "./error-text-CFkCmyEE.js";
import { a as resolveAcpDispatchPolicyError, i as resolveAcpAgentPolicyError } from "./policy-23IR2eJ3.js";
import { a as resolveAcpThreadSessionDetailLines } from "./session-identifiers-B7zzk-41.js";
import { t as resolveStatusTtsSnapshot } from "./status-config-Z1z44vYZ.js";
...
function loadDispatchAcpMediaRuntime() {
	dispatchAcpMediaRuntimePromise ??= import("./dispatch-acp-media.runtime-Ctnut-sY.js");
...
function loadDispatchAcpTtsRuntime$1() {
	dispatchAcpTtsRuntimePromise$1 ??= import("./dispatch-acp-tts.runtime-DdXFOZUN.js");
	return dispatchAcpTtsRuntimePromise$1;
}
function loadChannelPluginRuntime() {
	channelPluginRuntimePromise ??= import("./plugins-5bqH5zhH.js");
	return channelPluginRuntimePromise;
}
function loadMessageActionRuntime() {
	messageActionRuntimePromise ??= import("./message-action-runner-BygOB4Jc.js");
...
function loadDispatchAcpManagerRuntime() {
	dispatchAcpManagerRuntimePromise ??= import("./dispatch-acp-manager.runtime-DLuZOzo9.js");
	return dispatchAcpManagerRuntimePromise;
}
function loadDispatchAcpSessionRuntime() {
	dispatchAcpSessionRuntimePromise ??= import("./dispatch-acp-session.runtime-Cx-xWCcX.js");
	return dispatchAcpSessionRuntimePromise;
}
function loadDispatchAcpTtsRuntime() {
	dispatchAcpTtsRuntimePromise ??= import("./dispatch-acp-tts.runtime-DdXFOZUN.js");
