...
import { a as shouldLogVerbose, r as logVerbose } from "./globals-D40f4_2X.js";
import { t as logDebug } from "./logger-DM6XyTzO.js";
import { n as resolveManifestContractOwnerPluginId, t as loadPluginManifestRegistry } from "./manifest-registry-D3girPWo.js";
import { c as resolveEffectivePluginActivationState, n as createPluginActivationSource, o as normalizePluginsConfig } from "./config-state-Xobk7mRp.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-C9k8dNv6.js";
import { a as loadConfig, o as parseConfigJson5, v as resolveConfigSnapshotHash } from "./io-5jzTw2vS.js";
import { c as parseThreadSessionSuffix, o as parseAgentSessionKey } from "./session-key-utils-8wVXCYqL.js";
import { n as normalizeAccountId } from "./account-id-BgECLQdh.js";
import { c as normalizeAgentId, f as sanitizeAgentId, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-Ba6CwwIP.js";
import { r as normalizeProviderId } from "./provider-id-B5Rvwwf4.js";
import { o as normalizeChannelId } from "./registry-fsTw8jzj.js";
import { i as normalizeChannelId$1, r as listChannelPlugins, t as getChannelPlugin } from "./registry-Bph4dR3s.js";
import { i as applyMergePatch } from "./schema-validator-CW9intW8.js";
import { u as selectApplicableRuntimeConfig } from "./runtime-snapshot-BIo89a-e.js";
...
import { _ as resolveAgentConfig, b as resolveAgentWorkspaceDir, m as resolveSessionAgentIds, p as resolveSessionAgentId, r as resolveAgentExecutionContract } from "./agent-scope-BrwtzVtf.js";
import { t as parseDurationMs } from "./parse-duration-DJdfoEt9.js";
import { t as isInboundPathAllowed } from "./inbound-path-policy-CeCCJ-QD.js";
import { n as isRestartEnabled } from "./commands.flags-SPkxudi8.js";
import "./config-CzLCUGML.js";
import { h as GATEWAY_CLIENT_MODES, m as GATEWAY_CLIENT_IDS, u as normalizeMessageChannel } from "./message-channel-OCXPZoKg.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-VxE9WCsM.js";
import { d as readConnectPairingRequiredMessage } from "./connect-error-details-D-uC5j3Z.js";
import { n as resolveBundledPluginCompatibleLoadValues } from "./activation-context-b4l2PJRj.js";
import "./plugins-DS4mgiqp.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-BwXob-b1.js";
import { b as normalizeModelRef, h as resolveModelRefFromString, i as buildModelAliasIndex, r as buildConfiguredModelCatalog, y as modelKey } from "./model-selection-shared-3Ltfz4Ls.js";
import { o as resolveDefaultModelForAgent, p as resolveThinkingDefault, t as buildAllowedModelSet } from "./model-selection-DwvfvFe2.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-Dn4C6ofG.js";
import { t as requireApiKey } from "./model-auth-runtime-shared-Db4eTPRf.js";
import { r as getApiKeyForModel } from "./model-auth-3Vcve2wR.js";
import { i as SUBAGENT_SPAWN_MODES, n as spawnSubagentDirect, r as SUBAGENT_SPAWN_CONTEXT_MODES } from "./subagent-spawn-DSJkAbrh.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-aVTuLlts.js";
import { i as normalizeDeliveryContext } from "./delivery-context.shared-DfK3EqOH.js";
import { t as loadSessionStore } from "./store-load-Bm74f3zN.js";
import { c as updateSessionStore } from "./store-DtATwbu4.js";
import { t as extractDeliveryInfo } from "./sessions-DH-OezqI.js";
import { n as resolveSessionConversationRef } from "./session-conversation-a3r2oc6h.js";
import { r as callGateway } from "./call-8AIXlGCX.js";
import { n as capArrayByJsonBytes, o as readSessionTitleFieldsFromTranscript, p as jsonUtf8Bytes } from "./session-utils.fs-BLGfvbBE.js";
import { f as resolveSessionModelIdentityRef, t as deriveSessionTitle } from "./session-utils-Yx2LsPvL.js";
import "./delivery-context-BPbcx5WX.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-DThpkuyk.js";
import { A as describeSessionsListTool, C as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, D as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY, E as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, M as describeSessionsSpawnTool, N as describeUpdatePlanTool, O as describeSessionStatusTool, S as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, T as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, j as describeSessionsSendTool, k as describeSessionsHistoryTool, w as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, y as CRON_TOOL_DISPLAY_SUMMARY } from "./tool-policy-Bcyf1aOU.js";
import { a as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-BV1oVuDb.js";
import { a as resolveDisplaySessionKey, c as resolveSessionReference, i as resolveSandboxedSessionToolContext, l as resolveVisibleSessionReference, n as deriveChannel, o as resolveInternalSessionKey, r as resolveSessionToolContext, s as resolveMainSessionAlias, t as classifySessionKind, u as shouldResolveSessionIdInput } from "./sessions-helpers-C97sg2IB.js";
import { c as stripReasoningTagsFromText } from "./assistant-visible-text-C5m0dtXi.js";
import { T as extractTextFromChatContent } from "./sanitize-user-facing-text-wYl4LmAL.js";
import { r as stripToolMessages } from "./chat-history-text-BBJiEyHJ.js";
import { c as getContinuationDelegateQueueDepths, f as stagePostCompactionDelegate, s as enqueuePendingDelegate } from "./delegate-store-5h4AoOZD.js";
import { r as resolveMaxDelegatesPerTurn } from "./config-Bxds66I3.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-DO03xcy8.js";
import { a as getImageMetadata } from "./image-ops-CwGvwo-H.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-Dtl5kS_Y.js";
import { n as runWithImageModelFallback } from "./model-fallback-BYYgB5UG.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-c3CuQsc5.js";
import { o as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-B6TmmDok.js";
import { n as resolveMessageSecretScope, t as CHANNEL_MESSAGE_ACTION_NAMES } from "./message-action-names-BD2-z74e.js";
import { u as parseReplyDirectives } from "./payloads-CK7K8Zj2.js";
import { t as isWindowsDrivePath } from "./archive-path-D1hDOSYl.js";
import { o as trySafeFileURLToPath, r as hasEncodedFileUrlSeparator } from "./local-file-access-Cd1Gin-_.js";
import { n as assertSandboxPath } from "./sandbox-paths-BeP-sy-I.js";
import { d as toRelativeWorkspacePath, n as normalizeWorkspaceDir, r as resolveWorkspaceRoot } from "./read-capability-gpfmsMgv.js";
import { t as SsrFBlockedError } from "./ssrf-BidpExjG.js";
import { n as resolveConfiguredMediaMaxBytes } from "./configured-max-bytes-CQdqFyLh.js";
import { i as imageMimeFromFormat, t as detectMime } from "./mime-D8DgGtqn.js";
import { g as writeFileWithinRoot, r as appendFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-DXglNiK0.js";
import { l as saveMediaBuffer } from "./store-kajRw-Xe.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-MW6CtKWh.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-DyGnzJnO.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-BKI0KmrY.js";
import { a as classifyMediaReferenceSource, o as normalizeMediaReferenceSource, r as getDefaultLocalRoots } from "./local-media-access-PEbeJ7CM.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-DzctuhN7.js";
import { r as resolvePluginTools } from "./tools-BKtbhZm1.js";
import { w as textToSpeech } from "./tts-CoMGj0QA.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-BrWV21sA.js";
import { a as listChannelSupportedActions, r as listAllChannelSupportedActions } from "./channel-tools-BZ80py8k.js";
import { t as extractAssistantText } from "./pi-embedded-utils-BuVUHUTR.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-DiYY1jHr.js";
import { _ as readStringParam$1, d as parseToolParams, h as readStringArrayParam, i as asToolParamsRecord, l as jsonResult, p as readNumberParam, r as ToolInputError, s as imageResult, x as readSnakeCaseParamRaw } from "./common-D1R9Gsy-.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-BxwSUC2w.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata } from "./runtime-DlqI1lwq.js";
import { t as sniffMimeFromBase64 } from "./sniff-mime-from-base64-CnQGoEaW.js";
import { a as parseCanvasSnapshotPayload, c as parseCameraSnapPayload, d as writeCameraPayloadToFile, i as canvasSnapshotTempPath, l as writeBase64ToFile, n as screenRecordTempPath, o as cameraTempPath, r as writeScreenRecordToFile, s as parseCameraClipPayload, t as parseScreenRecordPayload, u as writeCameraClipPayloadToFile } from "./nodes-screen-DEwTzfrL.js";
...
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-DQY9R8L7.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-3rATQ_PN.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-Dj5zoFlC.js";
import { t as inferLegacyName } from "./normalize-8DGmUYSp.js";
import { n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-B2Lj3UZo.js";
import { d as writeRestartSentinel, n as buildRestartSuccessContinuation, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile } from "./restart-sentinel-DV3iaqNs.js";
import { o as scheduleGatewaySigusr1Restart } from "./restart-CIa7XmMi.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-BkYSycFr.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-usPEwGvX.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-DM3ruWVj.js";
import { a as coerceImageModelConfig, c as resolveProviderVisionModelFromConfig, d as hasAuthForProvider, f as hasToolModelConfig, l as buildToolModelConfigFromCandidates, n as isMinimaxVlmProvider, o as decodeDataUrl, p as resolveDefaultModelRef, u as coerceToolModelConfig } from "./minimax-vlm-D_4neIR6.js";
import { n as ensureOpenClawModelsJson } from "./models-config-CGD1Ducy.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-6l12fO6_.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-BGBERoXf.js";
import { b as resolveAutoMediaKeyProviders, w as getMediaUnderstandingProvider, x as resolveDefaultMediaModel, y as providerSupportsNativePdfDocument } from "./resolve-CyzEjlKD.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-C-TBCueI.js";
import { r as loadModelCatalog } from "./model-catalog-4FqZyXTU.js";
import { t as buildProviderRegistry } from "./runner-BptJ_LIe.js";
import "./media-understanding-DiovT6GB.js";
import { a as POLL_CREATION_PARAM_DEFS, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-Bmysuk5w.js";
import { t as sendMessage } from "./message-BzfiswIz.js";
import { i as resolveMusicGenerationModeCapabilities, n as listRuntimeMusicGenerationProviders, r as listSupportedMusicGenerationModes, t as generateMusic } from "./runtime-B8RIPBur.js";
import { r as parseMusicGenerationModelRef } from "./provider-registry-CoknjSw_.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-bgW-vLk_.js";
...
import { a as recordTaskRunProgressByRunId, i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-BpGlai2C.js";
import "./task-registry-delivery-runtime-BFLK50YR.js";
import { t as formatAgentInternalEventsForPrompt } from "./internal-events-D9WQ3JFe.js";
import { i as loadSessionEntryByKey, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-YJTX79Wi.js";
import { t as parseTimeoutMs } from "./parse-timeout-B90AEPHg.js";
import { t as extractPdfContent } from "./pdf-extract-BYdwa58C.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-BDrweSNt.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-Cq7oLpZK.js";
import { n as isRequesterParentOfBackgroundAcpSession } from "./session-interaction-mode-BszvMibp.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, n as readLatestAssistantReply, r as readLatestAssistantReplySnapshot } from "./run-wait-CiazbJDA.js";
import { f as runAgentStep, g as isReplySkip, h as isAnnounceSkip, m as REPLY_SKIP_TOKEN, p as ANNOUNCE_SKIP_TOKEN } from "./subagent-announce-output-CCi5k5gw.js";
import { p as registerSubagentRun } from "./subagent-registry-CK8hKi52.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-DabweEyK.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-BOLKQWVU.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, n as listRuntimeVideoGenerationProviders, r as listSupportedVideoGenerationModes, t as generateVideo } from "./runtime-Clm_RqlQ.js";
import { r as parseVideoGenerationModelRef } from "./provider-registry-k0D4-gvF.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-CDE8A5dv.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-CmECbGoZ.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-MzPFlXQs.js";
import { a as readResponseText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds } from "./web-shared-gWYHuQDM.js";
import { a as runWebSearch, i as resolveWebSearchDefinition } from "./runtime-B-z4Epm1.js";
import "./web-search-provider-common-GBp1gC0J.js";
...
const log$6 = createSubsystemLogger("continuation/delegate-tool");
...
function createContinueDelegateTool(opts) {
	...
	return {
		...
		execute: async (_toolCallId, args) => {
			...
			const params = parseToolParams(ContinueDelegateToolSchema, args, { numericStringKeys: ["delaySeconds"] });
			const task = params.task.trim();
			if (!task) throw new ToolInputError("task must be a non-empty string describing the delegated work.");
			...
			log$6.debug(`[continue_delegate:enqueue] session=${sessionKey} mode=${mode} delayMs=${delayMs} task=${task.slice(0, 80)}`);
...
const log$5 = createSubsystemLogger("continuation/continue-work");
...
function createContinueWorkTool(opts) {
	return {
		...
		execute: async (_toolCallId, args) => {
			...
			const params = parseToolParams(ContinueWorkToolSchema, {
				...rawParams,
				...typeof rawParams.reason === "string" ? { reason: rawParams.reason.slice(0, 1024) } : {}
			}, { numericStringKeys: ["delaySeconds"] });
			const reason = params.reason.trim().slice(0, 1024);
			if (!reason) throw new ToolInputError("reason required");
			if (params.delaySeconds !== void 0 && params.delaySeconds < 0) throw new ToolInputError("delaySeconds must be a non-negative number.");
			const delaySeconds = params.delaySeconds ?? 0;
			log$5.debug(`[continue_work:request] session=${sessionKey} delaySeconds=${delaySeconds} reason=${reason.slice(0, 80)}`);
...
async function getRuntime() {
	if (!runtimeMod) runtimeMod = await import("./embedded-gateway-stub.runtime-B73SaO9r.js");
	return runtimeMod;
}
...
function loadCommandsStatusRuntime() {
	commandsStatusRuntimePromise ??= import("./session-status.runtime-B0qra9q2.js");
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-BwF5obVL.js");
...
async function loadAcpSpawnModule() {
	acpSpawnModulePromise ??= import("./acp-spawn-BjMfGuYi.js");
...
async function loadWebFetchRuntime() {
	webFetchRuntimePromise ??= import("./runtime-C6H_z_VR.js");
	return await webFetchRuntimePromise;
}
async function loadWebGuardedFetch() {
	webGuardedFetchPromise ??= import("./web-guarded-fetch-DDvIFBsQ.js");
...
//#endregion
export { setEmbeddedMode as _, createHostWorkspaceAppendTool as a, stripProviderPrefix as b, createOpenClawReadTool as c, createSandboxedWriteTool as d, wrapToolMemoryDayFileWriteGuard as f, isEmbeddedMode as g, wrapToolWorkspaceRootGuardWithOptions as h, normalizeCronJobPatch as i, createSandboxedEditTool as l, wrapToolWorkspaceRootGuard as m, normalizeCronJobCreate as n, createHostWorkspaceEditTool as o, wrapToolMemoryFlushAppendOnlyWrite as p, normalizeCronJobInput as r, createHostWorkspaceWriteTool as s, createOpenClawTools as t, createSandboxedReadTool as u, isStrictAgenticExecutionContractActive as v, isStrictAgenticSupportedProviderModel as y };
