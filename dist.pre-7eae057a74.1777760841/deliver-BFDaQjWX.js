...
import { i as resolveMirroredTranscriptText } from "./transcript-DZb_KCzQ.js";
import { C as createReplyToDeliveryPolicy } from "./reply-payload-DnFwi8F_.js";
import { a as projectOutboundPayloadPlanForDelivery, l as summarizeOutboundPayloadForTransport, t as createOutboundPayloadPlan } from "./payloads-CK7K8Zj2.js";
import { a as hasReplyPayloadContent, c as normalizeMessagePresentation, u as renderMessagePresentationFallbackText } from "./payload-C6Ibfic7.js";
import { t as resolveAgentScopedOutboundMediaAccess } from "./read-capability-gpfmsMgv.js";
import { c as resolveTextChunkLimit, i as chunkMarkdownTextWithMode, n as chunkByParagraph, s as resolveChunkMode } from "./chunk-DirOpFQW.js";
import { t as loadChannelOutboundAdapter } from "./load-BBkpvJ0T.js";
import { a as toInternalMessageSentContext, d as toPluginMessageSentEvent, l as toPluginMessageContext, t as buildCanonicalSentMessageHookContext } from "./message-hook-mappers-nttXGnHV.js";
import { c as enqueueDelivery, o as withActiveDeliveryClaim, s as ackDelivery, u as failDelivery } from "./delivery-queue-kOk4sY00.js";
...
async function loadTranscriptRuntime() {
	transcriptRuntimePromise ??= import("./transcript.runtime-B6YEFBif.js");
	return await transcriptRuntimePromise;
}
let channelBootstrapRuntimePromise;
async function loadChannelBootstrapRuntime() {
	channelBootstrapRuntimePromise ??= import("./channel-bootstrap.runtime-0zNEp-jN.js");
