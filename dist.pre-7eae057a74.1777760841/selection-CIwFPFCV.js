...
import { t as isTruthyEnvValue } from "./env-CcBRbhYW.js";
import { _ as resolveStateDir } from "./paths-CrDgDBYA.js";
import { n as VERSION } from "./version-D108XVAk.js";
import { n as resolveOwnerDisplaySetting } from "./owner-display-8505DamY.js";
import { t as loadPluginManifestRegistry } from "./manifest-registry-D3girPWo.js";
import { Z as normalizeGoogleApiBaseUrl } from "./io-5jzTw2vS.js";
import { a as isSubagentSessionKey, n as isAcpSessionKey } from "./session-key-utils-8wVXCYqL.js";
...
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-DCegKE6D.js";
import { f as isWorkspaceBootstrapPending, r as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-CeVfBCfB.js";
import { h as listAgentEntries, m as resolveSessionAgentIds } from "./agent-scope-BrwtzVtf.js";
import { u as normalizeMessageChannel } from "./message-channel-OCXPZoKg.js";
import { i as createStreamIteratorWrapper, r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-Bf3Wc1GL.js";
import { u as listRegisteredAgentHarnesses } from "./loader-B4BgeLlc.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-D1eSoMau.js";
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-KwvU2Qvz.js";
import { F as resolveProviderSystemPromptContribution, I as resolveProviderTextTransforms, q as transformProviderSystemPrompt } from "./provider-runtime-BwXob-b1.js";
...
import { t as sanitizeForConsole } from "./console-sanitize-CdmolQB-.js";
import { c as resolveModelAuthMode } from "./model-auth-3Vcve2wR.js";
import { l as setActiveEmbeddedRun, n as clearActiveEmbeddedRun, u as updateActiveEmbeddedRunSnapshot } from "./runs-CuZc3WA5.js";
import { n as acquireSessionWriteLock, o as resolveSessionLockMaxHoldFromTimeout } from "./session-write-lock-B3juxda0.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-BgA3dbPs.js";
import { i as resolveSubagentCapabilityStore, t as isSubagentEnvelopeSession } from "./subagent-capabilities-DgG25xjt.js";
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent } from "./agent-events-DymXOfrS.js";
import { a as normalizeUsage, i as makeZeroUsageSnapshot, r as hasNonzeroUsage } from "./usage-DDq4LR8h.js";
import { o as parseAssistantTextSignature, s as resolveAssistantMessagePhase } from "./chat-message-content-BrcR_eKj.js";
import { t as parseInlineDirectives } from "./directive-tags-BAtwMUmx.js";
import { p as normalizeToolName } from "./tool-policy-Bcyf1aOU.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-DxJf4_rV.js";
import { a as stripDowngradedToolCallText } from "./assistant-visible-text-C5m0dtXi.js";
import { C as parseExecApprovalResultText, b as stableStringify$1, w as coerceChatContentText } from "./sanitize-user-facing-text-wYl4LmAL.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, o as startsWithSilentToken, r as isSilentReplyPayloadText } from "./tokens-DO03xcy8.js";
...
import { a as formatAssistantErrorText, l as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-DuPNe54y.js";
import { o as hasUnredactedSessionsSpawnAttachments, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-B-IQdFlf.js";
import { n as estimateBase64DecodedBytes } from "./base64-CjnzFB4L.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-Dtl5kS_Y.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-DnFwi8F_.js";
import { a as prependBootstrapPromptWarning, i as buildBootstrapTruncationReportMeta, n as buildBootstrapInjectionStats, r as buildBootstrapPromptWarning, t as analyzeBootstrapBudget } from "./bootstrap-budget-C8lG9wSb.js";
import { a as isTimeoutError } from "./failover-error--nSN9y3M.js";
import { a as buildTextObservationFields, i as buildApiErrorObservationFields } from "./model-fallback-BYYgB5UG.js";
import { b as stripProviderPrefix, g as isEmbeddedMode, y as isStrictAgenticSupportedProviderModel } from "./openclaw-tools-DBQ6sUbd.js";
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-BV9xgLXY.js";
import { t as log$3 } from "./logger-BZ5LifbK.js";
import { $ as shouldAllowProviderOwnedThinkingReplay, B as installContextEngineLoopHook, C as limitHistoryTurns, F as estimateToolResultReductionPotential, G as releaseWsSession, H as repairSessionFileIfNeeded, I as resolveLiveToolResultMaxChars, J as resolveChannelCapabilities, K as buildStreamErrorAssistantMessage, M as isCacheTtlEligibleProvider, N as readLastCacheTtlTimestamp, P as guardSessionManager, Q as resolveTranscriptPolicy, S as getDmHistoryLimitFromSessionKey, U as createPreparedEmbeddedPiSettingsManager, V as installToolResultContextGuard, W as createBundleLspToolRuntime, X as estimateMessagesTokens, Y as SAFETY_MARGIN, Z as isReasoningTagProvider, _ as trackSessionManagerAccess, a as collectAllowedToolNames, b as validateReplayTurns, c as applySystemPromptOverrideToSession, d as describeEmbeddedAgentStreamStrategy, et as assessLastAssistantMessage, f as resolveEmbeddedAgentApiKey, g as prewarmSessionFile, h as resolveEmbeddedRunSkillEntries, i as PI_RESERVED_TOOL_NAMES, j as resolveCompactionTimeoutMs, k as applyFinalEffectiveToolPolicy, l as buildEmbeddedSystemPrompt, m as resolveEmbeddedAgentStreamFn, n as mapThinkingLevel, o as collectRegisteredToolNames, p as resolveEmbeddedAgentBaseStreamFn, r as splitSdkTools, s as toSessionToolAllowlist, t as flushPendingToolResultsAfterIdle, tt as dropThinkingBlocks, u as createSystemPromptOverride, v as normalizeAssistantReplayContent, w as buildEmbeddedExtensionFactories, x as buildEmbeddedMessageActionDiscoveryInput, y as sanitizeSessionHistory, z as truncateOversizedToolResultsInSessionManager } from "./wait-for-idle-before-flush-Sx8pU5uq.js";
import { n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-BkbfNWhf.js";
import { i as streamWithPayloadPatch } from "./moonshot-thinking-stream-wrappers-DlJYzsZB.js";
import { i as createHtmlEntityToolCallArgumentDecodingWrapper, w as visitObjectContentBlocks } from "./provider-stream-shared-CN0eenMj.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-C0cVBguu.js";
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-BhEfP6mI.js";
import { a as normalizeProviderToolSchemas, i as logProviderToolSchemaDiagnostics, r as supportsModelTools } from "./tool-result-middleware-BA_E8fAr.js";
import { n as resolveEmbeddedAgentHarnessFallback, r as resolveEmbeddedAgentRuntime, t as normalizeEmbeddedAgentRuntime } from "./runtime-D2ktg8dF.js";
import { n as setReplyPayloadMetadata } from "./reply-payload-DZIxUbte.js";
import { r as parseFenceSpans } from "./fences-Cb2oLoMK.js";
import { r as splitMediaFromOutput } from "./parse-C3gjzgKK.js";
import { u as parseReplyDirectives } from "./payloads-CK7K8Zj2.js";
import { a as resolveEffectiveToolPolicy, c as resolveSubagentToolPolicyForSession, s as resolveGroupToolPolicy } from "./read-capability-gpfmsMgv.js";
import { o as resolveSandboxContext } from "./sandbox-DY_BONXq.js";
import { f as MAX_IMAGE_BYTES } from "./mime-D8DgGtqn.js";
import { i as ensureGlobalUndiciStreamTimeouts, r as ensureGlobalUndiciEnvProxyDispatcher, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-LU0hItIA.js";
import { c as sanitizeTransportPayloadText, m as sanitizeToolUseResultPairing, o as mergeTransportHeaders, u as buildGuardedModelFetch } from "./transport-stream-shared-0ojDAcd-.js";
import { t as detectRuntimeShell } from "./shell-utils-B_-nVYnH.js";
import { t as parseBooleanValue } from "./boolean-CvHwwL4l.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-B_P_Upvk.js";
import { s as resolveSkillsPromptForRun } from "./workspace-RUH2u37h.js";
import "./skills-DzX4hEY-.js";
import { t as filterHeartbeatPairs } from "./heartbeat-filter-BFIynQKC.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-CEa7adaH.js";
import { t as getMachineDisplayName } from "./machine-name-DPnsztiD.js";
import { n as getPluginToolMeta } from "./tools-BKtbhZm1.js";
import { t as redactConfigObject } from "./redact-snapshot-DePbQBts.js";
import { n as resolveCommitHash } from "./git-commit-BGvJZ_Ot.js";
import { t as resolveOsSummary } from "./os-summary-Dg7YOkXR.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-meHS3fH_.js";
import { n as buildTtsSystemPromptHint } from "./tts-CoMGj0QA.js";
import { a as resolveContextInjectionMode, i as resolveBootstrapContextForRun, n as hasCompletedBootstrapTurn, r as makeBootstrapWarn, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-BVgmCEqA.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-plIDB3X8.js";
import { a as listChannelSupportedActions, c as resolveChannelReactionGuidance, o as resolveChannelMessageToolCapabilities, s as resolveChannelMessageToolHints } from "./channel-tools-BZ80py8k.js";
import { t as resolveOpenClawDocsPath } from "./docs-path-BsQGsFxp.js";
import { t as buildModelAliasLines } from "./model-alias-lines-qVryWtyo.js";
import { t as registerProviderStreamForModel } from "./provider-stream-BxtRjkaN.js";
import { i as getOrCreateSessionMcpRuntime } from "./pi-bundle-mcp-runtime-B7kfNUUQ.js";
import { n as materializeBundleMcpToolsForRun } from "./pi-bundle-mcp-tools-3PLiXHwn.js";
import { _ as sanitizeToolResult, b as formatToolAggregate, d as extractToolErrorMessage, f as extractToolResultMediaArtifact, g as isToolResultTimedOut, h as isToolResultError, l as runContextEngineMaintenance, m as filterToolResultMediaUrls, n as assembleHarnessContextEngine, o as finalizeHarnessContextEngineTurn, p as extractToolResultText, r as bootstrapHarnessContextEngine, t as buildEmbeddedAttemptToolRunContext, u as extractMessagingToolSend, v as isMessagingTool, y as isMessagingToolSendAction } from "./attempt.tool-run-context-rCF7Cy5w.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-CXcMMBXQ.js";
...
import { s as normalizeCompactionTrigger } from "./request-compaction-tool-DiYY1jHr.js";
import { a as MIN_PROMPT_BUDGET_TOKENS, i as MIN_PROMPT_BUDGET_RATIO, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-CTmqRsoC.js";
import { o as diagnosticErrorCategory } from "./pi-tools.before-tool-call-D-xKtpWl.js";
import { i as toClientToolDefinitions, n as findClientToolNameConflicts, t as createClientToolNameConflictError } from "./pi-tool-definition-adapter-DMyIuk6q.js";
import { n as resolveToolLoopDetectionConfig, t as createOpenClawCodingTools } from "./pi-tools-RPmF2gS6.js";
import { t as resolveAgentTimeoutMs } from "./timeout-DA1IgMhi.js";
import { n as rewriteTranscriptEntriesInSessionManager } from "./transcript-rewrite-QGuh3u_S.js";
import { t as resolveSystemPromptOverride } from "./system-prompt-override-DyKCqyv4.js";
import { t as buildSystemPromptParams } from "./system-prompt-params-uLWhwj1A.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-C7kKaCR_.js";
import "./tool-loop-detection-Cuypy8C7.js";
import { n as buildAgentUserPromptPrefix } from "./system-prompt-DW-qZ_-O.js";
import { t as parseGeminiAuth } from "./gemini-auth-XbJkKJUh.js";
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-BczHavf1.js";
import { a as shouldUseOpenAIWebSocketTransport, i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-tYeZpzc1.js";
...
import { n as extractBalancedJsonPrefix } from "./balanced-json-D2MYcfpe.js";
import { t as detectAndLoadPromptImages } from "./images-kr6JWiyI.js";
...
function emitCompactionCountReconcileFailure(params) {
	...
	ctx.log.warn(`[compaction-counter:reconcile-failed] runId=${ctx.params.runId} sessionKey=${ctx.params.sessionKey ?? ctx.params.sessionId} trigger=${trigger} observed=${compactionCountAfter} error=${message}`);
	emitAgentEvent({
		runId: ctx.params.runId,
		stream: "compaction",
		sessionKey: ctx.params.sessionKey,
	...
	Promise.resolve(ctx.params.onAgentEvent?.({
		stream: "compaction",
		data
	})).catch((eventErr) => {
		ctx.log.warn(`compaction count reconcile failure event delivery failed: ${formatCompactionError(eventErr)}`);
	});
}
...
async function reconcileSessionStoreCompactionCountAfterSuccess(params) {
	const { reconcileSessionStoreCompactionCountAfterSuccess: reconcile } = await import("./pi-embedded-subscribe.handlers.compaction.runtime-C8TKKnpY.js");
...
function loadExecApprovalReply() {
	execApprovalReplyModulePromise ??= import("./exec-approval-reply-k8DLn4VP.js");
	return execApprovalReplyModulePromise;
}
function loadHookRunnerGlobal() {
	hookRunnerGlobalModulePromise ??= import("./hook-runner-global-DIBJRz12.js");
	return hookRunnerGlobalModulePromise;
}
function loadMediaParse() {
	mediaParseModulePromise ??= import("./parse-DdItco-c.js");
	return mediaParseModulePromise;
}
function loadBeforeToolCall() {
	beforeToolCallModulePromise ??= import("./pi-tools.before-tool-call-Noe-lokv.js");
...
//#endregion
export { resolveReasoningOnlyRetryInstruction as C, resolvePlanningOnlyRetryLimit as S, resolveRunLivenessState as T, isLikelyExecutionAckPrompt as _, resolveBootstrapMode as a, resolveIncompleteTurnPayloadText as b, observeReplayMetadata as c, resolveTrajectoryPointerFilePath as d, safeTrajectorySessionFileName as f, extractPlanningOnlyPlanDetails as g, STRICT_AGENTIC_BLOCKED_TEXT as h, selectAgentHarness as i, TRAJECTORY_RUNTIME_FILE_MAX_BYTES as l, sanitizeDiagnosticPayload as m, resolveAgentHarnessPolicy as n, prepareSessionManagerForRun as o, safeJsonStringify as p, runAgentHarnessAttemptWithFallback as r, createEmbeddedRunReplayState as s, maybeCompactAgentHarnessSession as t, resolveTrajectoryFilePath as u, resolveAckExecutionFastPathInstruction as v, resolveReplayInvalidFlag as w, resolvePlanningOnlyRetryInstruction as x, resolveEmptyResponseRetryInstruction as y };
