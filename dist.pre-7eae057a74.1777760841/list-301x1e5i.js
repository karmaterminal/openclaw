...
import { W as getShellEnvAppliedKeys, q as shouldEnableShellEnvFallback, r as createConfigIO } from "./io-5jzTw2vS.js";
...
import { i as ensureAuthProfileStoreWithoutExternalProfiles } from "./store-DWcsUxbV.js";
...
import { o as resolveProfileUnusableUntilForDisplay } from "./usage-Dj8w89gg.js";
...
import { i as getCustomProviderApiKey, l as resolveUsableCustomProviderApiKey, o as hasUsableCustomProviderApiKey } from "./model-auth-3Vcve2wR.js";
import { i as discoverModels, l as resolveRuntimeSyntheticAuthProviderRefs, r as discoverAuthStorage } from "./pi-model-discovery-6l12fO6_.js";
import { r as loadModelCatalog } from "./model-catalog-4FqZyXTU.js";
import { n as shouldSuppressBuiltInModel } from "./model-suppression-0zyaqqES.js";
import { r as resolveModelWithRegistry } from "./model-Cu2ISJ0g.js";
import { f as isLocalBaseUrl, i as formatTokenK, n as ensureFlagCompatibility, s as resolveKnownAgentId } from "./shared-DdrO4GAQ.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-DyHXxZtg.js";
import { t as maskApiKey } from "./mask-api-key-CvIhqAe9.js";
import { n as loadModelsConfigWithSource, t as loadModelsConfig } from "./load-config-CZZourcT.js";
import { n as loadProviderCatalogModelsForList, t as hasProviderStaticCatalogForFilter } from "./list.runtime-DLDbJJAa.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-pZN6jki8.js";
...
async function modelsListCommand(opts, runtime) {
	...
	const { ensureAuthProfileStore, resolveOpenClawAgentDir } = await import("./list.runtime-DsDdwWA-.js");
...
function loadProviderUsageRuntime() {
	providerUsageRuntimePromise ??= import("./provider-usage-CL4j0-dX.js");
	return providerUsageRuntimePromise;
}
function loadProgressRuntime() {
	progressRuntimePromise ??= import("./progress-CCP4b55t.js");
	return progressRuntimePromise;
}
function loadTerminalTableRuntime() {
	terminalTableRuntimePromise ??= import("./table-BD9fy-dm.js");
	return terminalTableRuntimePromise;
}
function loadListProbeRuntime() {
	listProbeRuntimePromise ??= import("./list.probe-CCVhJ8Za.js");
...
async function modelsStatusCommand(opts, runtime) {
	...
	if (missingProvidersInUse.length > 0) {
		const { buildProviderAuthRecoveryHint } = await import("./provider-auth-guidance-CLZsOYfx.js");
		runtime.log("");
