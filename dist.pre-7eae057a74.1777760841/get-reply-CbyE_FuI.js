...
import { n as normalizeAtHashSlug, s as normalizeStringEntries } from "./string-normalization-Dv1B9Dxc.js";
import { a as loadConfig } from "./io-5jzTw2vS.js";
import { a as isSubagentSessionKey, n as isAcpSessionKey, o as parseAgentSessionKey } from "./session-key-utils-8wVXCYqL.js";
import { c as normalizeAgentId, l as normalizeMainKey, r as buildAgentMainSessionKey } from "./session-key-Ba6CwwIP.js";
import { a as normalizeAnyChannelId } from "./registry-fsTw8jzj.js";
import { t as getLoadedChannelPluginById } from "./registry-loaded-Csw_-ISO.js";
...
import { n as DEFAULT_AGENT_WORKSPACE_DIR, u as ensureAgentWorkspace } from "./workspace-CeVfBCfB.js";
import { _ as resolveAgentConfig, b as resolveAgentWorkspaceDir, h as listAgentEntries, l as resolveAgentSkillsFilter, p as resolveSessionAgentId, y as resolveAgentDir } from "./agent-scope-BrwtzVtf.js";
import "./config-CzLCUGML.js";
import { d as resolveGatewayMessageChannel, r as isInternalMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-OCXPZoKg.js";
import "./message-channel-core-VxE9WCsM.js";
import { i as isInterSessionInputProvenance } from "./input-provenance-B72DIE3s.js";
import { d as resetRegisteredAgentHarnessSessions } from "./loader-B4BgeLlc.js";
import "./plugins-DS4mgiqp.js";
import { n as fireAndForgetHook } from "./fire-and-forget-Dr92vR-x.js";
...
import { g as requireActivePluginChannelRegistry, n as getActivePluginChannelRegistryVersion } from "./runtime-KwvU2Qvz.js";
import { f as normalizeThinkLevel, h as normalizeVerboseLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, t as formatThinkingLevels } from "./thinking-DYmORkoK.js";
import { h as resolveModelRefFromString } from "./model-selection-shared-3Ltfz4Ls.js";
import "./model-selection-DwvfvFe2.js";
import { r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-CxdjsdkQ.js";
import { o as forkSessionFromParent, s as resolveParentForkMaxTokens } from "./subagent-spawn-DSJkAbrh.js";
import { t as canonicalizeMainSessionAlias } from "./main-session-CIzfmmGG.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-aVTuLlts.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, n as deliveryContextKey, t as deliveryContextFromSession } from "./delivery-context.shared-DfK3EqOH.js";
import { s as resolveMaintenanceConfigFromInput, t as loadSessionStore } from "./store-load-Bm74f3zN.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-D3wf7T-9.js";
import { c as updateSessionStore, f as resolveSessionStoreEntry, h as deriveSessionMetaPatch, y as resolveGroupSessionKey } from "./store-DtATwbu4.js";
...
import { a as resolveAndPersistSessionFile } from "./transcript-DZb_KCzQ.js";
import { n as parseSessionThreadInfoFast } from "./thread-info-BF4Fx9om.js";
import "./delivery-context-BPbcx5WX.js";
import { r as getSessionBindingService } from "./session-binding-service-BFKwvZlA.js";
import { n as applyOwnerOnlyToolPolicy } from "./tool-policy-Bcyf1aOU.js";
...
import { i as enqueueSystemEvent, l as removeSystemEvents } from "./system-events-Cg3E-qpj.js";
import { o as getQueueSize, r as clearCommandLane } from "./command-queue-CjIh2XS5.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-DO03xcy8.js";
import { i as resolveTypingMode, r as resolveActiveRunQueueAction, t as cancelContinuationTimer } from "./agent-runner-CuZtz4ro.js";
import { r as getCliSessionBinding } from "./cli-session-DSJp_DBI.js";
import { Z as isReasoningTagProvider } from "./wait-for-idle-before-flush-Sx8pU5uq.js";
import { n as collectTextContentBlocks } from "./tool-result-middleware-BA_E8fAr.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-C-q6tQNi.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-C5bcRERk.js";
import { n as resolveChannelGroupRequireMention } from "./group-policy-BPlpo6Sn.js";
import { n as resolveSilentReplySettings } from "./silent-reply-CEfGkTRq.js";
import { t as buildOutboundSessionContext } from "./session-context-Br4L4554.js";
import { t as resolveQueueSettings } from "./queue-C1RoXD9-.js";
import { n as buildSessionStartHookPayload, t as buildSessionEndHookPayload } from "./session-hooks-Ch4bHxo2.js";
import { r as drainFormattedSystemEvents } from "./session-updates-BQpq7wbN.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-BQxThurz.js";
import { o as retireSessionMcpRuntime } from "./pi-bundle-mcp-runtime-B7kfNUUQ.js";
import "./pi-bundle-mcp-tools-3PLiXHwn.js";
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-nttXGnHV.js";
import { t as resolveAgentTimeoutMs } from "./timeout-DA1IgMhi.js";
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-BczHavf1.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-Bmh3jilp.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-B-QHTmkU.js";
import { t as hasControlCommand } from "./command-detection-Bwbzr8Lh.js";
import "./commands-registry-8zCkzqaA.js";
import { t as resolveRunTypingPolicy } from "./typing-policy-B3vwa72z.js";
import { t as normalizeInboundTextNewlines } from "./inbound-text-Be_7VMM0.js";
import { t as finalizeInboundContext } from "./inbound-context-DmLDI8Yq.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-PslGo69k.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-CO-YKNCy.js";
import { n as createTypingKeepaliveLoop, t as createTypingStartGuard } from "./typing-start-guard-Bv2nt9aa.js";
import { t as resolveChannelModelOverride } from "./model-overrides-Cj2-b57Y.js";
import { t as normalizeGroupActivation } from "./group-activation-VI9QZXlf.js";
import { t as resolveDefaultModel } from "./directive-handling.defaults-FjY5_11G.js";
import { t as resolveFastModeState } from "./fast-mode-Cgqrl8br.js";
import { t as buildCommandContext } from "./commands-context-DupBPswz.js";
import { t as parseInlineDirectives } from "./directive-handling.parse-CRcA-J20.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-DKrbsC0x.js";
...
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-CaYuo9es.js";
import { n as parseSoftResetCommand, t as isResetAuthorizedForContext } from "./reset-authorization-BbHaCxiR.js";
...
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-tqNuvuje.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-CG_zXQpI.js";
import { t as hasInboundMedia } from "./inbound-media-DQeByrJG.js";
...
import { t as resolveResetPreservedSelection } from "./reset-preserved-selection-B4ov5782.js";
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-Ch0bpxHF.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-DVg0O2Zn.js";
...
function loadCommandsStatus() {
	commandsStatusPromise ??= import("./commands-status.runtime-C7C8Im1I.js");
	return commandsStatusPromise;
}
function loadDirectiveLevels() {
	directiveLevelsPromise ??= import("./directive-handling.levels-BqmO0Mw5.js");
	return directiveLevelsPromise;
}
function loadDirectiveImpl() {
	directiveImplPromise ??= import("./directive-handling.impl-BoCE51rn.js");
	return directiveImplPromise;
}
function loadDirectiveFastLane() {
	directiveFastLanePromise ??= import("./directive-handling.fast-lane-DYhijsZE.js");
	return directiveFastLanePromise;
}
function loadDirectivePersist() {
	directivePersistPromise ??= import("./directive-handling.persist.runtime-DUom3nwS.js");
...
function loadGroupsRuntime() {
	groupsRuntimePromise ??= import("./groups.runtime-DQQgS9ot.js");
...
function loadCommandsRegistry() {
	commandsRegistryPromise ??= import("./commands-registry.runtime-Bpm7KH7l.js");
	return commandsRegistryPromise;
}
function loadSkillCommands() {
	skillCommandsPromise ??= import("./skill-commands.runtime-ubyolg_Q.js");
...
function loadSkillCommandsRuntime() {
	skillCommandsRuntimePromise ??= import("./skill-commands.runtime-ubyolg_Q.js");
	return skillCommandsRuntimePromise;
}
function loadOpenClawToolsRuntime() {
	openClawToolsRuntimePromise ??= import("./openclaw-tools.runtime-DbNv3sFV.js");
	return openClawToolsRuntimePromise;
}
function loadAbortCutoffRuntime() {
	abortCutoffRuntimePromise ??= import("./abort-cutoff.runtime-DxpSDvJD.js");
	return abortCutoffRuntimePromise;
}
function loadCommandsRuntime() {
	commandsRuntimePromise ??= import("./commands.runtime-Bp328iYC.js");
...
function loadSessionStoreRuntime$1() {
	sessionStoreRuntimePromise$1 ??= import("./store.runtime-Bq5otV28.js");
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded.runtime-DgXlzZcj.js");
...
function loadSessionUpdatesRuntime() {
	sessionUpdatesRuntimePromise ??= import("./session-updates.runtime-Dt3YGM0p.js");
...
function loadDeliverRuntime() {
	deliverRuntimePromise ??= import("./deliver-runtime-o8ihvmPV.js");
...
function loadSessionArchiveRuntime() {
	sessionArchiveRuntimePromise ??= import("./session-archive.runtime-BV-bJhiA.js");
...
function loadSessionResetModelRuntime() {
	sessionResetModelRuntimePromise ??= import("./session-reset-model.runtime-BK53eiKl.js");
	return sessionResetModelRuntimePromise;
}
function loadStageSandboxMediaRuntime() {
	stageSandboxMediaRuntimePromise ??= import("./stage-sandbox-media.runtime-C_SeIo-7.js");
	return stageSandboxMediaRuntimePromise;
}
function loadMediaUnderstandingApplyRuntime() {
	mediaUnderstandingApplyRuntimePromise ??= import("./apply.runtime-EvoJwzJy.js");
	return mediaUnderstandingApplyRuntimePromise;
}
function loadLinkUnderstandingApplyRuntime() {
	linkUnderstandingApplyRuntimePromise ??= import("./apply.runtime-DGYUkzWE.js");
	return linkUnderstandingApplyRuntimePromise;
}
function loadCommandsCoreRuntime() {
	commandsCoreRuntimePromise ??= import("./commands-core.runtime-Cjaq_Z8y.js");
...
function loadHookRunnerGlobal() {
	hookRunnerGlobalPromise ??= import("./hook-runner-global-DIBJRz12.js");
	return hookRunnerGlobalPromise;
}
function loadOriginRouting() {
	originRoutingPromise ??= import("./origin-routing-BcgY8Cg_.js");
