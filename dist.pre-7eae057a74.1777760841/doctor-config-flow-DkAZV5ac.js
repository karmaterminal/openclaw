...
import { i as runPluginSetupConfigMigrations } from "./setup-registry-CDue02YC.js";
import { i as listRouteBindings } from "./bindings-DjDlHfc5.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-CsdztimT.js";
import { t as note } from "./note-MgaUYTr3.js";
import { a as stripUnknownConfigKeys, r as noteOpencodeProviderOverrides } from "./doctor-config-analysis-Jje1BYqT.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-DOLjGHEF.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-CKc9DOuY.js";
import { t as asObjectRecord } from "./object-C5TKAQT5.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = await (async () => {
		...
		const { collectRelevantDoctorPluginIds, listPluginDoctorLegacyConfigRules } = await import("./doctor-contract-registry-C4OiTPaZ.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-DZWRxqt4.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-DfsfJlrv.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-32c-_TW5.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-Bk4vYwBw.js");
		emitDoctorNotes({
			note,
