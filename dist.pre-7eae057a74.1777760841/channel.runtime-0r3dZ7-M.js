...
import { l as withResolvedWebhookRequestPipeline, n as registerWebhookTargetWithPluginRoute, s as resolveWebhookTargetWithAuthOrRejectSync } from "./webhook-targets-CWt7PoKD.js";
import "./webhook-ingress-CatMjWw6.js";
import "./browser-security-runtime-bL0FdNa3.js";
import "./string-coerce-runtime-BL4GPlBo.js";
import { P as resolveBlueBubblesEffectiveAllowPrivateNetwork, _ as normalizeWebhookReaction, g as normalizeWebhookMessage, o as probeBlueBubbles, t as fetchBlueBubblesServerInfo, u as asRecord } from "./probe-ClL6c7gc.js";
import { t as getBlueBubblesRuntime } from "./runtime-Bx8jC8OU.js";
import { n as resolveWebhookPathFromConfig } from "./webhook-shared-BINq-fXt.js";
import { a as resolveBlueBubblesMessageId, b as sendMessageBlueBubbles } from "./reactions-8x7wDrXV.js";
import { i as sendBlueBubblesMedia, n as processMessage, r as processReaction, t as logVerbose } from "./monitor-processing-HKhF5z2f.js";
...
async function monitorBlueBubblesProvider(options) {
	...
	return await new Promise((resolve) => {
		...
		import("./catchup-BHDMmTrz.js").then(({ runBlueBubblesCatchup }) => runBlueBubblesCatchup(target)).catch((err) => {
