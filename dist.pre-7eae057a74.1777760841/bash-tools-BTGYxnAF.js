...
import { s as sanitizeHostExecEnvWithDiagnostics } from "./host-env-security-BS88dAsz.js";
import { a as logWarn, r as logInfo } from "./logger-DM6XyTzO.js";
import { G as getShellPathFromLoginShell, K as resolveShellEnvFallbackTimeoutMs } from "./io-5jzTw2vS.js";
import { a as isSubagentSessionKey, i as isCronSessionKey, o as parseAgentSessionKey } from "./session-key-utils-8wVXCYqL.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-Ba6CwwIP.js";
import { d as resolveApprovalAuditCandidatePath } from "./exec-safe-bin-trust-BzPl2Qtb.js";
import { t as killProcessTree } from "./kill-tree-hHwyV1TP.js";
import { c as isGatewayMessageChannel, u as normalizeMessageChannel } from "./message-channel-OCXPZoKg.js";
...
import { b as EXEC_TOOL_DISPLAY_SUMMARY, x as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-policy-Bcyf1aOU.js";
import { C as parseExecApprovalResultText, S as isExecDeniedResultText, u as sanitizeUserFacingText, x as formatExecDeniedUserMessage } from "./sanitize-user-facing-text-wYl4LmAL.js";
import { a as coerceEnv, c as readEnvInt, d as sliceLogLines, f as truncateMiddle, i as clampWithDefault, l as resolveSandboxWorkdir, n as buildSandboxEnv, o as deriveSessionName, s as pad, u as resolveWorkdir } from "./bash-tools.shared-DeyQ6qke.js";
import { t as splitShellArgs } from "./shell-argv-BUrolzb7.js";
import { c as describeInterpreterInlineEval, f as analyzeShellCommand, l as detectInterpreterInlineEvalArgv, n as evaluateShellAllowlist, p as buildEnforcedShellCommand } from "./exec-approvals-allowlist-HcYgqbY3.js";
...
import { i as normalizePathPrepend, t as applyPathPrepend } from "./path-prepend-CtrYiRBU.js";
import { t as getProcessSupervisor } from "./supervisor-CvkD6nQK.js";
import { C as setJobTtlMs, S as markExited, _ as getFinishedSession, a as DEFAULT_PENDING_MAX_OUTPUT, b as listRunningSessions, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, g as drainSession, h as deleteSession, i as DEFAULT_PATH, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput, v as getSession, w as tail, x as markBackgrounded, y as listFinishedSessions } from "./bash-tools.exec-runtime-BW48NYXT.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-Dcp9TOsg.js";
import { o as failedTextResult, y as textResult } from "./common-D1R9Gsy-.js";
import { t as callGatewayTool } from "./gateway-BxwSUC2w.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-aRialh-2.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-lN33sL2U.js";
import { i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-DQY9R8L7.js";
import { t as sendMessage } from "./message-BzfiswIz.js";
import { t as resolveExternalBestEffortDeliveryTarget } from "./best-effort-delivery-BtAO8lwU.js";
import { t as formatDurationCompact } from "./format-duration-wmRyTLVn.js";
import { f as resolveExecApprovalInitiatingSurfaceState, s as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-DN-gsrOY.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-CqNLDOgM.js";
import { n as recordCommandPoll, r as resetCommandPollCount } from "./command-poll-backoff-CZyq7QQ5.js";
...
async function loadFsSafeModule() {
	fsSafeModulePromise ??= import("./fs-safe-CjPtzItK.js");
