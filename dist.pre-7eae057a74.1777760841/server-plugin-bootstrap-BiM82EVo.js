...
import { B as resolveMemoryLightDreamingConfig, F as resolveMemoryDeepDreamingConfig, I as resolveMemoryDreamingConfig, L as resolveMemoryDreamingPluginConfig, N as isSameMemoryDreamingDay, V as resolveMemoryRemDreamingConfig, z as resolveMemoryDreamingWorkspaces } from "./dreaming-BJNMZMKI.js";
import "./plugins-DS4mgiqp.js";
import { s as getPluginCommandSpecs } from "./command-registration-G3YOsHlc.js";
import { i as hasInternalHookListeners, m as triggerInternalHook } from "./internal-hooks-jNiMliAU.js";
import { S as createEmptyPluginRegistry, a as getActivePluginRegistry, d as pinActivePluginChannelRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion, x as setActivePluginRegistry } from "./runtime-KwvU2Qvz.js";
import { n as withPluginRuntimeGatewayRequestScope, t as getPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-B9VRBd7O.js";
import { r as createPluginRuntimeLoaderLogger } from "./load-context-DXHiq_8F.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-CACD-vsQ.js";
import { d as normalizeReasoningLevel, f as normalizeThinkLevel } from "./thinking-DYmORkoK.js";
import { b as normalizeModelRef, x as parseModelRef } from "./model-selection-shared-3Ltfz4Ls.js";
import { t as buildAllowedModelSet } from "./model-selection-DwvfvFe2.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-Dn4C6ofG.js";
...
import { h as normalizeDiagnosticStabilityQuery, m as getDiagnosticStabilitySnapshot } from "./diagnostic-stability-bundle-Qzj2N2Mw.js";
import { n as normalizeSpawnedRunMetadata, r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-CxdjsdkQ.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey } from "./main-session-CIzfmmGG.js";
import { n as canonicalizeSpawnedByForAgent, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-BVlm2TDW.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent } from "./paths-aVTuLlts.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, r as mergeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-DfK3EqOH.js";
import { t as loadSessionStore } from "./store-load-Bm74f3zN.js";
import { n as mergeSessionEntry } from "./types-D3wf7T-9.js";
import { c as updateSessionStore } from "./store-DtATwbu4.js";
import { n as resolveMainSessionKeyFromConfig, t as extractDeliveryInfo } from "./sessions-DH-OezqI.js";
import { n as readJsonFile, r as writeJsonAtomic, t as createAsyncLock } from "./json-files-SS0WEcbE.js";
import { l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-DymXOfrS.js";
import { n as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-CTXCVEsk.js";
import { a as readSessionPreviewItemsFromTranscript, i as readSessionMessages } from "./session-utils.fs-BLGfvbBE.js";
import { a as resolveSessionTranscriptCandidates, t as archiveFileOnDisk } from "./session-transcript-files.fs-D6QqSh_y.js";
...
import { _ as listCoreToolSections, h as PROFILE_OPTIONS, v as resolveCoreToolProfiles } from "./tool-policy-Bcyf1aOU.js";
import { i as setHeartbeatsEnabled } from "./heartbeat-wake-CnoEaPOM.js";
import { i as enqueueSystemEvent, o as isSystemEventContextChanged } from "./system-events-Cg3E-qpj.js";
import { i as normalizeCronJobPatch, n as normalizeCronJobCreate } from "./openclaw-tools-DBQ6sUbd.js";
import { o as listConfiguredAnnounceChannelIdsForConfig, r as resolveGatewayStartupPluginIds } from "./channel-plugin-ids-DWcJCb10.js";
import { s as projectOutboundPayloadPlanForMirror, t as createOutboundPayloadPlan } from "./payloads-CK7K8Zj2.js";
import { i as resolveReplyToMode } from "./reply-threading-B5ihKgUh.js";
import { g as writeFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-DXglNiK0.js";
...
import { a as clearSessionQueues } from "./queue-C1RoXD9-.js";
import { d as mergeExecApprovalsSocketDefaults, j as saveExecApprovals, o as ensureExecApprovals, p as normalizeExecApprovals, y as readExecApprovalsSnapshot } from "./exec-approvals-DuykPV0F.js";
import { t as canExecRequestNode } from "./exec-defaults-Cbbi8WxP.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-RUH2u37h.js";
import "./skills-DzX4hEY-.js";
import { t as bumpSkillsSnapshotVersion } from "./refresh-state-BtZfy3Z1.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-CVselrxe.js";
import { o as resolveMissingRequestedScope } from "./pairing-token-DeAXEiPA.js";
import { d as listNodePairing, f as rejectNodePairing, g as verifyNodeToken, l as approveNodePairing, m as requestNodePairing, p as renamePairedNode, t as getRemoteSkillEligibility } from "./skills-remote-BABQetLl.js";
import { d as listSessionCompactionCheckpoints, u as getSessionCompactionCheckpoint } from "./model-context-tokens-wij3r71a.js";
import { n as getPluginToolMeta, r as resolvePluginTools } from "./tools-BKtbhZm1.js";
import { n as redactConfigSnapshot, r as restoreRedactedValues, t as redactConfigObject } from "./redact-snapshot-DePbQBts.js";
import { C as synthesizeSpeech, S as setTtsProvider, b as setTtsEnabled, c as isTtsEnabled, f as resolveExplicitTtsOverrides, g as resolveTtsProviderOrder, h as resolveTtsPrefsPath, i as getResolvedSpeechProviderConfig, l as isTtsProviderConfigured, m as resolveTtsConfig, o as getTtsProvider, p as resolveTtsAutoMode, w as textToSpeech } from "./tts-CoMGj0QA.js";
import { a as prepareSecretsRuntimeSnapshot } from "./runtime-DlqI1lwq.js";
import { i as parseAbsoluteTimeMs } from "./stagger-Dj5zoFlC.js";
import { r as isInvalidCronSessionTargetIdError } from "./webhook-url-B2Lj3UZo.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint } from "./restart-sentinel-DV3iaqNs.js";
import { o as scheduleGatewaySigusr1Restart } from "./restart-CIa7XmMi.js";
import { i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry, s as dispatchChannelMessageAction } from "./message-action-runner-Bmysuk5w.js";
import { n as normalizePollInput } from "./polls-CAenHR_f.js";
import { t as deliverOutboundPayloads } from "./deliver-BFDaQjWX.js";
import { n as resolveOutboundChannelPlugin } from "./channel-resolution-DfvYoz6J.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-DcjDUD66.js";
import "./target-resolver-bKQrJcr6.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-DPY1UAA0.js";
...
import { t as extractToolPayload } from "./tool-payload-BYPzvabO.js";
import { r as createRunningTaskRun } from "./detached-task-runtime-BpGlai2C.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-BtAO8lwU.js";
import { t as resolveAgentTimeoutMs } from "./timeout-DA1IgMhi.js";
import { n as getActiveMemorySearchManager } from "./memory-runtime-8vJSRi1f.js";
...
import { t as primeConfiguredBindingRegistry } from "./binding-registry-B3IhZ52J.js";
import { r as listPluginCommands } from "./commands-nym73sFn.js";
import { i as setGatewaySubagentRuntime, r as setGatewayNodesRuntime } from "./gateway-bindings-BcYuXpgE.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-lex0SqTf.js";
import "./commands-registry-8zCkzqaA.js";
import { n as resolveSendPolicy } from "./send-policy-CZKPTUk3.js";
import { t as getChannelActivity } from "./channel-activity-BniT7SrW.js";
import { t as WizardCancelledError } from "./prompts-xL8I6hT8.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-4qgxjBaB.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-4QePjwTq.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-DN0Tlrl1.js";
import { r as getLastHeartbeatEvent } from "./heartbeat-visibility-DiKGmqwT.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-CD16IQnc.js";
import { r as agentCommandFromIngress } from "./agent-command-af8BLb8q.js";
import { n as getSpeechProvider, r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-Bh-_sPFI.js";
import { n as invokeNativeHookRelay } from "./native-hook-relay-C4vi2s0y.js";
import { i as resolveNodeCommandAllowlist, n as isNodeCommandAllowed } from "./node-command-policy-w_d8eAWZ.js";
import { t as formatForLog } from "./ws-log-CHbDzB0f.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-Ctgro8QD.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-DaTvHx33.js";
import { a as getPairedDevice, c as listApprovedPairedDeviceRoles, d as rejectDevicePairing, f as removePairedDevice, g as summarizeDeviceTokens, h as rotateDeviceToken, i as formatDevicePairingForbiddenMessage, l as listDevicePairing, m as revokeDeviceToken, n as approveDevicePairing, o as getPendingDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-PWd2q8qn.js";
import { o as REALTIME_VOICE_AGENT_CONSULT_TOOL, r as getRealtimeVoiceProvider, s as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, t as resolveConfiguredRealtimeVoiceProvider } from "./provider-resolver-DlM8V6cH.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-VjIa1zwy.js";
import { n as createOutboundSendDeps } from "./deps-BuwER1Yg.js";
import "./agent-EngarjfB.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-Dz1sYYvr.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-CqNLDOgM.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-D7TaUtpJ.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-BaVBsCin.js";
import { d as waitForTerminalGatewayDedupe, g as resolveAgentRunExpiresAtMs, h as registerChatAbortController, i as chatHandlers, l as readTerminalSnapshotFromGatewayDedupe, u as setGatewayDedupeEntry } from "./chat-Xfwr-PbV.js";
import { n as MediaOffloadError, r as parseMessageWithAttachments, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-DvrqCtsL.js";
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp-BfEvZ4Nc.js";
import { t as resolveSessionKeyFromResolveParams } from "./sessions-resolve-D5Q1xou7.js";
import { t as loadProviderUsageSummary } from "./provider-usage-Cv6_Mf8n.js";
import { o as fetchClawHubSkillDetail } from "./clawhub-D_5oqvWo.js";
import { a as loadSessionUsageTimeSeries, i as loadSessionLogs, n as loadCostUsageSummary, o as resolveExistingUsageSessionFile, r as loadSessionCostSummary, t as discoverAllSessions } from "./session-cost-usage-fvuthJ4e.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-DyHXxZtg.js";
import { n as movePathToTrash } from "./browser-maintenance-D2pP2RV4.js";
import { a as performGatewaySessionReset } from "./session-reset-service-CxBaBlgz.js";
import { t as buildChannelUiCatalog } from "./catalog-CoR8VNy_.js";
import { a as removeBackfillDiaryEntries, c as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeGroundedShortTermCandidates, r as previewGroundedRemMarkdown, s as repairDreamingArtifacts } from "./memory-core-bundled-runtime-5nCd89MF.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-D5oB07Ch.js";
import { t as readConfiguredLogTail } from "./log-tail-DEhkYf-1.js";
import { n as purgeAgentSessionStoreEntries } from "./agents.command-shared-DVZwLeuN.js";
import { o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-2hhteCq9.js";
import { t as installSkill } from "./skills-install-Bf5-_lit.js";
import { m as normalizeUpdateChannel } from "./update-check-4xDW6igh.js";
import "./status-Cfr4yrvs.js";
import { t as getStatusSummary } from "./status.summary-BHj-Dn94.js";
import { i as updateSkillsFromClawHub, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-BfNbLyTN.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-Dq3r-65x.js";
import { t as runGatewayUpdate } from "./update-runner-DhGhSLgb.js";
import { t as buildChannelAccountSnapshot } from "./status-Dib_5c67.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-D9cnh5ee.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-Dd2bNZc_.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-Wv2saavy.js";
import "./heartbeat-runner-Di0nDT1s.js";
...
async function loadSessionSubagentReactivationRuntime() {
	return import("./session-subagent-reactivation.runtime-Bcp9HB4v.js");
}
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-qAkT-xq3.js");
...
function loadSessionsRuntimeModule() {
	sessionsRuntimeModulePromise ??= import("./sessions.runtime-g-fsA6bv.js");
