...
import { h as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-5jzTw2vS.js";
import { n as formatConfigIssueLines } from "./issue-format-CqQPqGQv.js";
import { t as note } from "./note-MgaUYTr3.js";
import { n as noteIncludeConfinementWarning } from "./doctor-config-analysis-Jje1BYqT.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-BMoNgREf.js");
