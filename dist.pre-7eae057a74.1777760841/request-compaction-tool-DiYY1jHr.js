...
import { c as createExpiringMapCache } from "./store-cache-BlX9FKkX.js";
...
import { d as parseToolParams, i as asToolParamsRecord, l as jsonResult, r as ToolInputError } from "./common-D1R9Gsy-.js";
...
function createRequestCompactionTool(opts) {
	return {
		...
		execute: async (_toolCallId, args) => {
			...
			const reason = parseToolParams(RequestCompactionToolSchema, {
				...rawParams,
				...typeof rawParams.reason === "string" ? { reason: rawParams.reason.slice(0, 1024) } : {}
			}).reason.trim().slice(0, 1024);
...
//#endregion
export { resolveCompactionFailureReason as a, isCompactionSkipReason as i, getVolitionalCompactionCount as n, createCompactionDiagId as o, classifyCompactionReason as r, normalizeCompactionTrigger as s, createRequestCompactionTool as t };
