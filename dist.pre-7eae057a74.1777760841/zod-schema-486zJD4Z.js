...
import { C as SecretInputSchema, E as SecretsConfigSchema, L as createAllowDenyChannelRulesSchema, P as TypingModeSchema, _ as NativeCommandsSettingSchema, c as GroupChatSchema, d as HumanDelaySchema, g as ModelsConfigSchema, i as ContextVisibilityModeSchema, j as TtsConfigSchema, k as TranscribeAudioSchema, l as GroupPolicySchema, n as BlockStreamingCoalesceSchema, p as InboundDebounceSchema, r as CliBackendSchema, t as BlockStreamingChunkSchema, u as HexColorSchema, y as QueueSchema } from "./zod-schema.core-CJHlBmEK.js";
import { t as sensitive } from "./zod-schema.sensitive-DAS3PWyl.js";
import { a as collectBundledChannelConfigs, n as listBundledPluginMetadata } from "./bundled-plugin-metadata-DaheSIDy.js";
import { l as resolveLoaderPackageRoot } from "./sdk-alias-BFWKMbI9.js";
import { t as parseDurationMs } from "./parse-duration-DJdfoEt9.js";
import { a as ElevatedAllowFromSchema, i as AgentSandboxSchema, l as ToolsSchema, n as AgentEmbeddedHarnessSchema, o as HeartbeatSchema, r as AgentEntrySchema, s as MemorySearchSchema, t as AgentContextLimitsSchema, u as AgentModelSchema } from "./zod-schema.agent-runtime-DPx4Np-L.js";
import { l as ChannelHeartbeatVisibilitySchema } from "./zod-schema.providers-core-Bp3vv_ly.js";
import "./zod-schema.providers-whatsapp-BCewFver.js";
...
const AgentDefaultsSchema = z.object({
	...
	continuation: z.object({
		...
		earlyWarningBand: z.number().min(0, "earlyWarningBand must be >= 0 (0 opts out of the early-warning band)").max(1).nullable().optional().default(.3125)
	}).strict().refine((cfg) => {
