...
let appProfileRuntimeDepsForTest;
function setBedrockAppProfileRuntimeDepsForTest(deps) {
	appProfileRuntimeDepsForTest = deps;
}
async function resolveAppProfileRuntimeDeps() {
	if (appProfileRuntimeDepsForTest) return appProfileRuntimeDepsForTest;
...
//#endregion
export { registerAmazonBedrockPlugin, resetBedrockAppProfileCacheEligibilityForTest, setBedrockAppProfileRuntimeDepsForTest };
