...
import { r as theme, t as colorize } from "./theme-BrQCDDpu.js";
import { t as formatCliCommand } from "./command-format-CUuNRpiL.js";
import { c as sanitizeSystemRunEnvOverrides, o as sanitizeHostExecEnv, t as inspectHostExecEnvOverrides } from "./host-env-security-BS88dAsz.js";
import { _ as resolveNodeSystemdServiceName, g as resolveNodeLaunchAgentLabel, u as formatNodeServiceDescription, v as resolveNodeWindowsTaskName } from "./paths-DisUnE6t.js";
import { a as resolveNodeProgramArguments, n as resolveDaemonInstallRuntimeInputs, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-B3qbeyMA.js";
import { n as VERSION } from "./version-D108XVAk.js";
import { s as buildNodeServiceEnvironment } from "./runtime-paths-8bsdxNRe.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-BVJas-k1.js";
...
import { i as runServiceUninstall, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-DkKbuA6H.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS } from "./node-commands-DIltbLgP.js";
import { a as getActivePluginRegistry } from "./runtime-KwvU2Qvz.js";
import { t as splitShellArgs } from "./shell-argv-BUrolzb7.js";
import { _ as resolvePlannedSegmentArgv, c as describeInterpreterInlineEval, d as analyzeArgvCommand, l as detectInterpreterInlineEvalArgv, n as evaluateShellAllowlist, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-HcYgqbY3.js";
import { C as requiresExecApproval, E as resolveExecApprovals, M as requestJsonlSocket, a as addDurableCommandApproval, b as recordAllowlistMatchesUse, d as mergeExecApprovalsSocketDefaults, j as saveExecApprovals, o as ensureExecApprovals, p as normalizeExecApprovals, s as hasDurableExecApproval, v as persistAllowAlwaysPatterns, y as readExecApprovalsSnapshot } from "./exec-approvals-DuykPV0F.js";
import { t as getMachineDisplayName } from "./machine-name-DPnsztiD.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-aRialh-2.js";
import { t as resolveGatewayConnectionAuth } from "./connection-auth-DFTLyXeP.js";
import { t as formatHelpExamples } from "./help-format-C1WDUpcv.js";
import { n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-Dz1sYYvr.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-DQoBHrF0.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-COHXWnce.js";
import { t as resolveNodeService } from "./node-service-DXFx28-g.js";
...
async function loadSystemRunConfig(opts) {
	...
	const { loadConfig } = await import("./config-Bj8Cp5-n.js");
	return loadConfig();
}
...
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-DIohRrzO.js");
