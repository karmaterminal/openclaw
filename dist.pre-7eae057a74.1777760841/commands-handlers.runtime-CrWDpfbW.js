...
import { a as clearPluginManifestRegistryCache } from "./manifest-registry-D3girPWo.js";
import { F as unsetConfigOverride, M as getConfigOverrides, N as resetConfigOverrides, P as setConfigOverride, T as validateConfigObjectWithPlugins, u as readConfigFileSnapshot, y as writeConfigFile } from "./io-5jzTw2vS.js";
import { r as normalizeOptionalAccountId } from "./account-id-BgECLQdh.js";
...
import { i as normalizeChannelId$1, t as getChannelPlugin } from "./registry-Bph4dR3s.js";
import { i as unsetConfigValueAtPath, n as parseConfigPath, r as setConfigValueAtPath, t as getConfigValueAtPath } from "./config-paths-nfQ2GDHj.js";
import { b as resolveAgentWorkspaceDir, p as resolveSessionAgentId, y as resolveAgentDir } from "./agent-scope-BrwtzVtf.js";
import { t as parseDurationMs } from "./parse-duration-DJdfoEt9.js";
import { n as isRestartEnabled, t as isCommandFlagEnabled } from "./commands.flags-SPkxudi8.js";
import "./config-CzLCUGML.js";
import { g as GATEWAY_CLIENT_NAMES, h as GATEWAY_CLIENT_MODES, r as isInternalMessageChannel, u as normalizeMessageChannel } from "./message-channel-OCXPZoKg.js";
import { n as resolveChannelApprovalCapability } from "./plugins-DS4mgiqp.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-jNiMliAU.js";
import { x as prepareProviderRuntimeAuth } from "./provider-runtime-BwXob-b1.js";
import { g as resolveResponseUsageMode, m as normalizeUsageDisplay } from "./thinking-DYmORkoK.js";
...
import { h as replyRunRegistry, i as getActiveEmbeddedRunSnapshot } from "./runs-CuZc3WA5.js";
import "./diagnostic-DLmgtjxT.js";
import { t as diagnosticLogger } from "./diagnostic-runtime-8q5S_Bz8.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, r as resolveDefaultSessionStorePath } from "./paths-aVTuLlts.js";
...
import { i as formatUsd, r as formatTokenCount } from "./usage-format-CuYPfQdu.js";
import { n as stripInboundMetadata } from "./strip-inbound-meta-C639tqHT.js";
import { r as getSessionBindingService } from "./session-binding-service-BFKwvZlA.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-DxJf4_rV.js";
import { h as resolveBootstrapTotalMaxChars, p as resolveBootstrapMaxChars } from "./pi-embedded-helpers-oR_ICWVj.js";
import { i as resolveImageSanitizationLimits, n as sanitizeImageBlocks } from "./tool-images-Dtl5kS_Y.js";
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-C8lG9wSb.js";
import { d as resolveTrajectoryPointerFilePath, f as safeTrajectorySessionFileName, l as TRAJECTORY_RUNTIME_FILE_MAX_BYTES, m as sanitizeDiagnosticPayload, p as safeJsonStringify, u as resolveTrajectoryFilePath } from "./selection-CIwFPFCV.js";
import { i as streamWithPayloadPatch } from "./moonshot-thinking-stream-wrappers-DlJYzsZB.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-B8FxH7Hj.js";
...
import { h as stripToolResultDetails } from "./transport-stream-shared-0ojDAcd-.js";
import { _ as getFinishedSession, v as getSession } from "./bash-tools.exec-runtime-BW48NYXT.js";
import { n as formatTimeAgo } from "./format-relative-mIdp2Xtx.js";
import { n as redactSupportString } from "./diagnostic-support-redaction-meHS3fH_.js";
import { S as setTtsProvider, _ as setLastTtsAttempt, a as getTtsMaxLength, b as setTtsEnabled, c as isTtsEnabled, h as resolveTtsPrefsPath, i as getResolvedSpeechProviderConfig, l as isTtsProviderConfigured, m as resolveTtsConfig, o as getTtsProvider, r as getLastTtsAttempt, s as isSummarizationEnabled, v as setSummarizationEnabled, w as textToSpeech, x as setTtsMaxLength } from "./tts-CoMGj0QA.js";
import { t as registerProviderStreamForModel } from "./provider-stream-BxtRjkaN.js";
import { i as unsetConfiguredMcpServer, r as setConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-CLlTyEWM.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-CXcMMBXQ.js";
import { i as isCompactionSkipReason } from "./request-compaction-tool-DiYY1jHr.js";
...
import { l as triggerOpenClawRestart, o as scheduleGatewaySigusr1Restart } from "./restart-CIa7XmMi.js";
...
import { _ as authorizeConfigWriteShared, b as resolveConfigWriteTargetFromPathShared, v as canBypassConfigWritePolicyShared, y as formatConfigWriteDeniedMessageShared } from "./channel-config-helpers-DphJPnKQ.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-bgW-vLk_.js";
import { t as formatDurationCompact } from "./format-duration-wmRyTLVn.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-C7kKaCR_.js";
import { n as estimateTokensFromChars } from "./cjk-chars-0tWMq8aE.js";
import { r as resolveModelWithRegistry } from "./model-Cu2ISJ0g.js";
import { i as matchPluginCommand, n as executePluginCommand } from "./commands-nym73sFn.js";
import { t as isApprovalNotFoundError } from "./approval-errors-CTWLw04q.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-Bmh3jilp.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-B-QHTmkU.js";
import "./commands-registry-8zCkzqaA.js";
import { o as stripMentions, s as stripStructuralPrefixes } from "./mentions-CO-YKNCy.js";
import { n as setChannelConversationBindingMaxAgeBySessionKey, t as setChannelConversationBindingIdleTimeoutBySessionKey } from "./conversation-bindings-DYtYj28a.js";
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-CphFkf8Y.js";
import { i as installPluginFromPath, r as installPluginFromNpmSpec } from "./install-DgtQku4F.js";
import { l as resolveArchiveKind } from "./archive-CDhjirW1.js";
import { n as isImplicitSameChatApprovalAuthorization } from "./approval-auth-helpers-DADo5ZYn.js";
import { n as parseActivationCommand } from "./group-activation-VI9QZXlf.js";
import { t as resolveFastModeState } from "./fast-mode-Cgqrl8br.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-BGC-jvdt.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-BcSUb4WB.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-J2sKqMsY.js";
import { a as shouldPersistAbortCutoff, i as resolveAbortCutoffFromContext, t as applyAbortCutoffToSessionEntry } from "./abort-cutoff-CG_zXQpI.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-4QePjwTq.js";
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-DVg0O2Zn.js";
import { n as resolveSessionEntryForKey, r as stopSubagentsForRequester, t as formatAbortReplyText } from "./abort-D-dcmrc7.js";
import { t as extractBtwQuestion } from "./btw-command-DHYTJGZt.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-DFXq1ZGx.js";
...
import { a as requireGatewayClientScopeForInternalChannel, i as requireCommandFlagEnabled, n as rejectNonOwnerCommand, r as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates-BDYwJ3Es.js";
import { t as handleAcpCommand } from "./commands-acp-CVZhhbLf.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-CaO-9t_B.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-DaTvHx33.js";
import { r as handleModelsCommand } from "./commands-models-uwWUk3Ti.js";
import { n as setPluginEnabledInConfig } from "./enable-CfQOmd5v.js";
import { r as createExecTool } from "./bash-tools-BTGYxnAF.js";
import { n as listTasksForAgentIdForStatus, r as listTasksForSessionKeyForStatus } from "./status-text-Bn555Xsd.js";
import { d as resolveChannelAccountId, f as resolveCommandSurfaceChannel, l as resolveSubagentsAction, o as resolveHandledPrefix, s as resolveRequesterSessionKey, u as stopWithText } from "./shared-BQJVaEEP.js";
import { t as buildToolsMessage } from "./status-YLGioTrg.js";
import { t as parseConfigValue } from "./config-value-DO54oRMg.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-BOozD0OK.js";
import { a as writeSupportBundleDirectory, i as textSupportBundleFile, n as jsonlSupportBundleFile, r as supportBundleContents, t as jsonSupportBundleFile } from "./diagnostic-support-bundle-COFxcOC-.js";
import { t as buildStatusReply } from "./commands-status-DLNC3Vdd.js";
import { i as buildNpmInstallRecordFields, n as persistPluginInstall } from "./plugins-install-persist-BQ7tMtXx.js";
import { m as parseClawHubPluginSpec } from "./clawhub-D_5oqvWo.js";
import { r as installPluginFromClawHub } from "./clawhub-yEBSa_as.js";
import { a as buildPluginDiagnosticsReport, c as formatPluginCompatibilityNotice, o as buildPluginInspectReport, s as buildPluginSnapshotReport, t as buildAllPluginInspectReports } from "./status-D8ltQSsG.js";
import { a as decidePreferredClawHubFallback, i as createPluginInstallLogger, n as buildPreferredClawHubSpec, u as resolveFileNpmSpecToLocalPath } from "./plugins-command-helpers-BRngjeDu.js";
import { n as loadCostUsageSummary, r as loadSessionCostSummary } from "./session-cost-usage-fvuthJ4e.js";
...
async function handleBashChatCommand(params) {
	...
	if (request.action === "stop") {
		...
		const { killProcessTree } = await import("./kill-tree-C7hlt-f3.js");
		killProcessTree(pid);
...
function loadCompactRuntime() {
	compactRuntimePromise ??= import("./commands-compact.runtime-GjmVTs_D.js");
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-jHojnDGF.js");
...
async function abortEmbeddedPiRunForSession(sessionId) {
	const { abortEmbeddedPiRun } = await import("./runs-BFSmlJyg.js");
...
function loadAgentsAction() {
	actionAgentsPromise ??= import("./action-agents-C9r31xC7.js");
	return actionAgentsPromise;
}
function loadFocusAction() {
	actionFocusPromise ??= import("./action-focus-BgrGGSWD.js");
	return actionFocusPromise;
}
function loadHelpAction() {
	actionHelpPromise ??= import("./action-help-DLnE7roA.js");
	return actionHelpPromise;
}
function loadInfoAction() {
	actionInfoPromise ??= import("./action-info-zZGj_LRO.js");
	return actionInfoPromise;
}
function loadKillAction() {
	actionKillPromise ??= import("./action-kill-BsZe0ajP.js");
	return actionKillPromise;
}
function loadListAction() {
	actionListPromise ??= import("./action-list-zEqyv0X7.js");
	return actionListPromise;
}
function loadLogAction() {
	actionLogPromise ??= import("./action-log-CsFmVelV.js");
	return actionLogPromise;
}
function loadSendAction() {
	actionSendPromise ??= import("./action-send-jE8vaUGA.js");
	return actionSendPromise;
}
function loadSpawnAction() {
	actionSpawnPromise ??= import("./action-spawn-CeMNPHtd.js");
	return actionSpawnPromise;
}
function loadUnfocusAction() {
	actionUnfocusPromise ??= import("./action-unfocus-DVXyjxO9.js");
	return actionUnfocusPromise;
}
function loadControlRuntime() {
	controlRuntimePromise ??= import("./commands-subagents-control.runtime-CxnnkW8S.js");
