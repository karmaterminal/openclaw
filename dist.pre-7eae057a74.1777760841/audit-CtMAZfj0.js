...
import { u as isInterpreterLikeAllowlistPattern } from "./exec-approvals-allowlist-HcYgqbY3.js";
import { l as loadExecApprovals } from "./exec-approvals-DuykPV0F.js";
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-aRialh-2.js";
import { n as collectCoreInsecureOrDangerousFlags, t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-BkYSycFr.js";
import { t as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-Cl1KAgsB.js";
import path from "node:path";
import { isIP } from "node:net";
//#region src/security/audit-deep-code-safety.ts
let auditDeepModulePromise;
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-DSi2kGSR.js");
...
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-d5L_FyTZ.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-CpbFqpwF.js");
...
async function loadPluginMetadataRegistryLoaderModule() {
	pluginMetadataRegistryLoaderModulePromise ??= import("./metadata-registry-loader-CTBx7yO3.js");
...
async function loadChannelPluginIdsModule() {
	channelPluginIdsModulePromise ??= import("./channel-plugin-ids-BsYcaKB-.js");
...
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-BwF5obVL.js"),
		import("./probe-auth-1sL2xa58.js"),
