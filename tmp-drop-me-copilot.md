...
- 2026-06-19T09:10:09+00:00
  : Both legs fixed and locally green. Token bracket path schedules durable same-session work with child chain-hop budget/cache refresh; tool path no longer orphan-reaps child self-continue. Gates green: focused/broader continuation tests, tsgo core/test/extensions, lint/bundled lint, build, autoreview clean.
