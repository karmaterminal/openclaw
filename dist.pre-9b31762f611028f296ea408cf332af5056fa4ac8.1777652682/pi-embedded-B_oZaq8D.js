...
import { n as resolveProviderIdForAuth } from "./provider-auth-aliases-DNB6KLNj.js";
import { b as resolveAgentWorkspaceDir, m as resolveSessionAgentIds, r as resolveAgentExecutionContract, t as hasConfiguredModelFallbacks } from "./agent-scope-zHoqFGPE.js";
import { i as isMarkdownCapableMessageChannel } from "./message-channel-BEwkHNOF.js";
...
import { $ as resolveProviderAuthProfileId, x as prepareProviderRuntimeAuth } from "./provider-runtime-B5tHTXWf.js";
...
import { t as ensureContextEnginesInitialized } from "./init-CidcVGwV.js";
import { t as ensureRuntimePluginsLoaded } from "./runtime-plugins-CXdHobe0.js";
import { n as sleepWithAbort } from "./backoff-dzfOeBr9.js";
import { a as normalizeUsage, t as derivePromptTokens } from "./usage-DyIOjex2.js";
import { n as extractAssistantTextForPhase } from "./chat-message-content-DAezUt6n.js";
import { s as runPostCompactionSideEffects, t as readPiModelContextTokens } from "./model-context-tokens-CWNcry6N.js";
import { i as enqueueCommandInLane } from "./command-queue-B2X59ob3.js";
import { a as formatContextWindowWarningMessage, i as formatContextWindowBlockMessage, n as CONTEXT_WINDOW_WARN_BELOW_TOKENS, o as resolveContextWindowInfo, r as evaluateContextWindowGuard, t as CONTEXT_WINDOW_HARD_MIN_TOKENS } from "./context-window-guard-C9LShI3i.js";
import { r as isSilentReplyPayloadText } from "./tokens-2Eginc2V.js";
import { G as truncateOversizedToolResultsInSession, U as resolveLiveToolResultMaxChars, W as sessionLikelyHasOversizedToolResults } from "./wait-for-idle-before-flush-Qw1sNAcp.js";
import { _ as isStrictAgenticExecutionContractActive } from "./openclaw-tools-TBOZ1lbp.js";
import { _ as resolveRunLivenessState, c as extractPlanningOnlyPlanDetails, d as resolveEmptyResponseRetryInstruction, f as resolveIncompleteTurnPayloadText, g as resolveReplayInvalidFlag, h as resolveReasoningOnlyRetryInstruction, i as selectAgentHarness, m as resolvePlanningOnlyRetryLimit, p as resolvePlanningOnlyRetryInstruction, r as runAgentHarnessAttemptWithFallback, s as STRICT_AGENTIC_BLOCKED_TEXT, u as resolveAckExecutionFastPathInstruction, v as createEmbeddedRunReplayState, y as observeReplayMetadata } from "./selection-CYxxptPl.js";
import { o as normalizeTextForComparison, r as pickFallbackThinkingLevel } from "./pi-embedded-helpers-C1tu1bI5.js";
import { D as formatRawAssistantErrorForUi, l as isRawApiErrorPayload, n as formatBillingErrorMessage, o as getApiErrorPayloadFingerprint, t as BILLING_ERROR_USER_MESSAGE, x as isTimeoutErrorMessage } from "./sanitize-user-facing-text-ByUPtx4k.js";
import { a as formatAssistantErrorText, d as isFailoverAssistantError, f as isFailoverErrorMessage, i as extractObservedOverflowTokenCount, l as isCompactionFailureError, m as isRateLimitAssistantError, o as isAuthAssistantError, p as isLikelyContextOverflowError, s as isBillingAssistantError, t as classifyFailoverReason, v as parseImageDimensionError, y as parseImageSizeError } from "./errors-MpyiTt6j.js";
import { n as coerceToFailoverError, r as describeFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-Buq9wg2B.js";
import "./auth-profiles-wtgOrnJU.js";
import { a as markAuthProfileUsed, i as markAuthProfileFailure, s as resolveProfilesUnavailableReason, u as isProfileInCooldown } from "./usage-1O9qU76_.js";
import { n as resolveAuthProfileOrder, t as resolveAuthProfileEligibility } from "./order-DR2h1rns.js";
import { t as markAuthProfileGood } from "./profiles-DjXPV26S.js";
import { t as redactIdentifier } from "./redact-identifier-cgC3-sfZ.js";
import { t as sanitizeForConsole } from "./console-sanitize-b0XfAOpY.js";
import { n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel, t as applyAuthHeaderOverride, u as shouldPreferExplicitConfigApiKeyAuth } from "./model-auth-z9q2AAmi.js";
import { t as log } from "./logger-B8TPD8B9.js";
import { d as sanitizeRuntimeProviderRequestOverrides, s as resolveProviderRequestConfig } from "./provider-request-config-CVScCNkv.js";
import { a as retireSessionMcpRuntime, o as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-je5uazSo.js";
import "./pi-bundle-mcp-tools-BXRqVaUz.js";
import { u as parseReplyDirectives } from "./payloads-DEM757dI.js";
import { s as hasOutboundReplyContent } from "./reply-payload-BHlpKYDP.js";
import { b as formatToolAggregate, l as runContextEngineMaintenance } from "./attempt.tool-run-context-BR8XSqzh.js";
import { s as emitAgentPlanEvent } from "./agent-events-BRkCNXs1.js";
import { a as shouldAllowCooldownProbeForReason, i as LiveSessionModelSwitchError, o as buildApiErrorObservationFields } from "./model-fallback-BDqX_3RA.js";
import { n as isLikelyMutatingToolName } from "./tool-mutation-Dtr04Ban.js";
import { n as extractAssistantThinking, o as formatReasoningMessage, r as extractAssistantVisibleText } from "./pi-embedded-utils-BWOmuHYr.js";
...
import "./extra-params-DKKg-Eo5.js";
import { o as buildEmbeddedCompactionRuntimeContext } from "./attempt.thread-helpers-DUOFwmAA.js";
import { n as resolveModelAsync } from "./model-AV_tazi3.js";
import "./compact.queued-I2q0Byr-.js";
import { a as resolveStoredSessionKeyForSessionId, i as resolveSessionKeyForRequest, n as shouldSwitchToLiveModel, t as clearLiveModelSwitchPending } from "./live-model-switch-DGceNEoA.js";
import { i as buildAgentRuntimeAuthPlan, r as buildAgentRuntimePlan } from "./build-Cv95tp_1.js";
import { n as resolveRunWorkspaceDir, t as redactRunIdentifier } from "./workspace-run-sJxt7I-R.js";
