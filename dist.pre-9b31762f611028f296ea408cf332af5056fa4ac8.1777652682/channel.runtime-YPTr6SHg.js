...
import { l as withResolvedWebhookRequestPipeline, n as registerWebhookTargetWithPluginRoute, s as resolveWebhookTargetWithAuthOrRejectSync } from "./webhook-targets-CaOppdUF.js";
import "./webhook-ingress-OluK3LE3.js";
import "./browser-security-runtime-B2MeT7AN.js";
import "./string-coerce-runtime-Ehsk2jdv.js";
import { P as resolveBlueBubblesEffectiveAllowPrivateNetwork, _ as normalizeWebhookReaction, g as normalizeWebhookMessage, o as probeBlueBubbles, t as fetchBlueBubblesServerInfo, u as asRecord } from "./probe-C52-kY2r.js";
import { t as getBlueBubblesRuntime } from "./runtime-CZ9rQns6.js";
import { n as resolveWebhookPathFromConfig } from "./webhook-shared-BqCIXUlZ.js";
import { a as resolveBlueBubblesMessageId, b as sendMessageBlueBubbles } from "./reactions-Cuxoqu_B.js";
import { i as sendBlueBubblesMedia, n as processMessage, r as processReaction, t as logVerbose } from "./monitor-processing-EHxD9Z9T.js";
...
async function monitorBlueBubblesProvider(options) {
	...
	return await new Promise((resolve) => {
		...
		import("./catchup-C6DMHUkj.js").then(({ runBlueBubblesCatchup }) => runBlueBubblesCatchup(target)).catch((err) => {
