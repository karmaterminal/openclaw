...
import { n as formatToolSummary, r as resolveToolDisplay } from "./tool-display-Cv3xV9o7.js";
...
import { o as generateSecureUuid } from "./secure-random-aGuoGZ0m.js";
import { r as prefixSystemMessage } from "./system-message-CF3wthXn.js";
import { t as resolveConfiguredTtsMode } from "./tts-config-Vu4Ty7Il.js";
import { o as createBlockReplyPipeline, r as resolveEffectiveBlockStreamingConfig, t as clampPositiveInteger } from "./block-streaming-CBrVCs7O.js";
import { t as hasInboundMedia } from "./inbound-media-DdOEEEsB.js";
import { i as toAcpRuntimeError } from "./errors-DcOEmW7C.js";
import { o as isSessionIdentityPending, u as resolveSessionIdentityFromMeta } from "./session-identity-CsTdpTz_.js";
import { t as formatAcpRuntimeErrorText } from "./error-text-C6DpJq_9.js";
import { a as resolveAcpDispatchPolicyError, i as resolveAcpAgentPolicyError } from "./policy-yM9Bnrxx.js";
import { a as resolveAcpThreadSessionDetailLines } from "./session-identifiers-BZJWvh36.js";
import { t as resolveStatusTtsSnapshot } from "./status-config-BpjlyBSI.js";
...
function loadDispatchAcpMediaRuntime() {
	dispatchAcpMediaRuntimePromise ??= import("./dispatch-acp-media.runtime-CAYYgmTe.js");
...
function loadDispatchAcpTtsRuntime$1() {
	dispatchAcpTtsRuntimePromise$1 ??= import("./dispatch-acp-tts.runtime-DvBsL7SZ.js");
	return dispatchAcpTtsRuntimePromise$1;
}
function loadChannelPluginRuntime() {
	channelPluginRuntimePromise ??= import("./plugins-D7CE2jOT.js");
	return channelPluginRuntimePromise;
}
function loadMessageActionRuntime() {
	messageActionRuntimePromise ??= import("./message-action-runner-D_fWKwb7.js");
...
function loadDispatchAcpManagerRuntime() {
	dispatchAcpManagerRuntimePromise ??= import("./dispatch-acp-manager.runtime-BVIkhT4z.js");
	return dispatchAcpManagerRuntimePromise;
}
function loadDispatchAcpSessionRuntime() {
	dispatchAcpSessionRuntimePromise ??= import("./dispatch-acp-session.runtime-b_ak4NPX.js");
	return dispatchAcpSessionRuntimePromise;
}
function loadDispatchAcpTtsRuntime() {
	dispatchAcpTtsRuntimePromise ??= import("./dispatch-acp-tts.runtime-DvBsL7SZ.js");
