...
import { a as loadConfig, it as resolveCliRuntimeExecutionProvider } from "./io-HGX0xk55.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-EpIbK3Oz.js";
import "./defaults-DM8yIn8C.js";
import { b as resolveAgentWorkspaceDir, f as resolveRunModelFallbacksOverride, p as resolveSessionAgentId, t as hasConfiguredModelFallbacks } from "./agent-scope-zHoqFGPE.js";
import "./config-B3U8IbHS.js";
import { f as resolveMessageChannel, i as isMarkdownCapableMessageChannel, r as isInternalMessageChannel } from "./message-channel-BEwkHNOF.js";
...
import { b as resolveGroupSessionKey, c as updateSessionStore, l as updateSessionStoreEntry, p as resolveSessionStoreEntry } from "./store-BD0Vlvaq.js";
import { a as resolveContextTokensForModel } from "./context-ChYUZB6w.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-kE6rXplS.js";
import { a as normalizeUsage, n as deriveSessionTotalTokens, r as hasNonzeroUsage, t as derivePromptTokens } from "./usage-DyIOjex2.js";
import { i as readSessionMessages } from "./session-utils.fs-Dn5nQNOb.js";
import { a as resolveSessionTranscriptCandidates } from "./session-transcript-files.fs-CjL9o5JQ.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-B2X59ob3.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-2Eginc2V.js";
import { s as stripHeartbeatToken } from "./heartbeat-BqbnwaZy.js";
import { E as estimateMessagesTokens, k as readPostCompactionContext } from "./wait-for-idle-before-flush-Qw1sNAcp.js";
import { a as isAudioFileName } from "./mime-CeX1JZPE.js";
import { l as isLikelyExecutionAckPrompt } from "./selection-CYxxptPl.js";
import { o as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-CWSpa_GU.js";
import "./pi-embedded-helpers-C1tu1bI5.js";
import { D as formatRawAssistantErrorForUi, _ as isOverloadedErrorMessage, g as isBillingErrorMessage, i as formatRateLimitOrOverloadedErrorCopy, t as BILLING_ERROR_USER_MESSAGE, u as sanitizeUserFacingText, y as isRateLimitErrorMessage } from "./sanitize-user-facing-text-ByUPtx4k.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-DDSGpyy6.js";
import { g as isTransientHttpError, l as isCompactionFailureError, p as isLikelyContextOverflowError, u as isContextOverflowError } from "./errors-MpyiTt6j.js";
import { i as resolveSandboxConfigForAgent } from "./config-DbfraE-G.js";
...
import { n as setReplyPayloadMetadata, t as getReplyPayloadMetadata } from "./reply-payload-h6n18JT-.js";
...
import { i as emitAgentEvent, u as registerAgentRunContext } from "./agent-events-BRkCNXs1.js";
import { i as LiveSessionModelSwitchError, r as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-BDqX_3RA.js";
import { c as highestDelayedContinuationReservationHop, f as stagedPostCompactionDelegateCount, i as consumePendingDelegates, n as cancelPendingDelegates, p as takeDelayedContinuationReservation, r as clearDelayedContinuationReservations, t as addDelayedContinuationReservation, u as pendingDelegateCount } from "./delegate-store-BKkoivDc.js";
import { u as resolveContinuationRuntimeConfig } from "./subagent-announce-delivery-Dj-53PAi.js";
import { o as generateSecureUuid, t as generateChainId } from "./secure-random-aGuoGZ0m.js";
import { i as isRenderablePayload, n as applyReplyThreading, t as applyReplyTagsToPayload } from "./reply-payloads-CL3XEv7T.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-DKUQzq83.js";
import { n as filterMessagingToolMediaDuplicates, r as shouldSuppressMessagingToolReplies, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-_YMBXaj_.js";
...
import { n as routeReply, t as isRoutableChannel } from "./route-reply-CAAPtjTy.js";
import { o as scheduleFollowupDrain, r as enqueueFollowupRun, s as refreshQueuedFollowupSession } from "./queue-7D5vMtql.js";
import { h as replyRunRegistry, m as createReplyOperation, p as ReplyRunAlreadyActiveError, s as queueEmbeddedPiMessage } from "./runs-rRV0MELk.js";
import { n as spawnSubagentDirect } from "./subagent-spawn-DD79eBoH.js";
import "./sandbox-D2A6r4WD.js";
import { t as runEmbeddedPiAgent } from "./pi-embedded-B_oZaq8D.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-Cv95tp_1.js";
import { n as resolveCronStorePath, t as loadCronStore } from "./store-CWMFIAuz.js";
import { n as stagePostCompactionDelegate, t as consumeStagedPostCompactionDelegates } from "./continuation-delegate-store-Dx7H-XP9.js";
import { t as formatProviderModelRef } from "./model-runtime-CHufhdnY.js";
import { t as runCliAgent } from "./cli-runner-B6YefTmJ.js";
import { c as setCliSessionId, r as getCliSessionBinding, s as setCliSessionBinding } from "./cli-session-DlNIB0Bo.js";
import { a as resolveModelFallbackOptions, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyExecutionConfig, r as formatBunFetchSocketError, s as resolveQueuedReplyRuntimeConfig, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-D6xGGUen.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-CaMtxf6H.js";
import { a as createBlockReplyContentKey, i as createAudioAsVoiceBuffer, o as createBlockReplyPipeline, r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-CBrVCs7O.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-DFAiP9Vs.js";
import { n as incrementCompactionCount } from "./session-updates-CnvFvY4C.js";
import { a as currentContinuationGeneration, d as unregisterContinuationTimerHandle, i as clearTrackedContinuationTimers, l as retainContinuationTimerRef, n as clearDelegatePending, o as maybeDropContinuationGeneration, r as clearDelegatePendingIfNoDelayedReservations, s as registerContinuationTimerHandle, t as bumpContinuationGeneration, u as setDelegatePending } from "./continuation-state-DCkguq7M.js";
...
async function runEmbeddedPiAgentDefault$1(...args) {
	const { runEmbeddedPiAgent } = await import("./pi-embedded.runtime-DN2tsMgg.js");
						...
						const result = await runEmbeddedPiAgentDefault$1({
							...
							requestCompactionOpts: runtimeConfig?.agents?.defaults?.continuation?.enabled === true ? {
								...
								triggerCompaction: async () => {
									try {
										const { compactEmbeddedPiSession } = await import("./compact.queued-BmGaD9Wz.js");
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded-DrGfi9_9.js");
...
function loadReplyPayloadsDedupeRuntime() {
	replyPayloadsDedupeRuntimePromise ??= import("./reply-payloads-dedupe.runtime-t_KDtD5N.js");
		...
		try {
			...
			if (runtimeConfig?.agents?.defaults?.continuation?.enabled === true && sessionKey) {
				const [{ dispatchToolDelegates }, { resolveContinuationRuntimeConfig }, { loadContinuationChainState, persistContinuationChainState }, { updateSessionStore, resolveSessionStoreEntry }] = await Promise.all([
					import("./delegate-dispatch-DHlXyjcE.js"),
					import("./config-B2e9FoCt.js"),
					import("./state-F0zEM4lB.js"),
					import("./store-DVVZzI0s.js")
				]);
...
async function dispatchPostCompactionDelegates(params, deps = defaultPostCompactionDelegateDispatchDeps) {
	...
	const overflowDroppedDelegates = Math.max(0, allCompactionDelegates.length - releasedCompactionDelegates.length);
...
async function runReplyAgent(params) {
	...
	try {
		...
		if (cfg?.agents?.defaults?.continuation?.enabled === true && sessionKey && activeSessionEntry) {
			const { checkContextPressure } = await import("./lazy.runtime-tE9Niy75.js");
		...
		if (continuationFeatureEnabled && sessionKey) {
			const turnTokens = (usage?.input ?? 0) + (usage?.output ?? 0);
			const { dispatchToolDelegates, loadContinuationChainState } = await import("./lazy.runtime-tE9Niy75.js");
		...
		if ((effectiveContinuationSignal || hasQueuedDelegateWork) && sessionKey && activeSessionEntry) {
			const { loadContinuationChainState } = await import("./lazy.runtime-tE9Niy75.js");
			const turnTokens = (usage?.input ?? 0) + (usage?.output ?? 0);
