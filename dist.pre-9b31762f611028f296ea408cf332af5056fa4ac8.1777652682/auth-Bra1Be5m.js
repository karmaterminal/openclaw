...
import { s as loadAuthProfileStoreForRuntime } from "./store-B63eWvc7.js";
import { n as resolvePluginProviders } from "./providers.runtime-Di-PbqYx.js";
import "./model-selection-shared-BF-DQvbf.js";
import { n as listProfilesForProvider } from "./profile-list-CT3GwYKf.js";
import { n as clearAuthProfileCooldown } from "./usage-1O9qU76_.js";
import { i as upsertAuthProfile } from "./profiles-DjXPV26S.js";
import { n as validateAnthropicSetupToken } from "./provider-auth-token-Boa07xSj.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-D4xTC7qE.js";
import { n as stylePromptMessage, t as stylePromptHint } from "./prompt-style-j9WTp0zA.js";
import { t as createClackPrompter } from "./clack-prompter-C5vNWRch.js";
import { n as logConfigUpdated } from "./logging-C9JM33r1.js";
import { a as loadValidConfigOrThrow, u as updateConfig } from "./shared-RkAzCrGm.js";
import { t as isRemoteEnvironment } from "./remote-env-CyP0qgrT.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-Cu86C8ac.js";
import { i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-CByaq8ox.js";
...
async function runProviderAuthMethod(params) {
	...
	await persistProviderAuthResult({
		result: await params.method.run({
			...
			openUrl: async (url) => {
				const { openUrl } = await import("./onboard-helpers-B5gHeSv_.js");
				await openUrl(url);
			},
