...
import { a as normalizeCronJobCreate, s as normalizeCronJobPatch } from "./openclaw-tools-TBOZ1lbp.js";
...
import { i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry, s as dispatchChannelMessageAction } from "./message-action-runner-Dt9jxpEz.js";
...
import { r as createRunningTaskRun } from "./detached-task-runtime-BHJYPBD1.js";
...
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-CtgNYwyL.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-BqN1QiiW.js";
...
import { r as agentCommandFromIngress } from "./agent-command-WX9A9hdZ.js";
...
import { n as invokeNativeHookRelay } from "./native-hook-relay-DGq0qKaK.js";
...
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-BG7xnxzs.js";
...
import { d as waitForTerminalGatewayDedupe, g as resolveAgentRunExpiresAtMs, h as registerChatAbortController, i as chatHandlers, l as readTerminalSnapshotFromGatewayDedupe, u as setGatewayDedupeEntry } from "./chat-Dld85QDd.js";
...
import { t as resolveSessionKeyFromResolveParams } from "./sessions-resolve-CYhPuctL.js";
...
import { a as performGatewaySessionReset } from "./session-reset-service-CLJESgsF.js";
...
import "./status-U3sGBMBy.js";
import { t as getStatusSummary } from "./status.summary-CetBrP9p.js";
...
import { t as applySessionsPatchToStore } from "./sessions-patch-BQhzmyV7.js";
...
import "./heartbeat-runner-B3l2j--m.js";
...
async function loadSessionSubagentReactivationRuntime() {
	return import("./session-subagent-reactivation.runtime-Dd2v2rd0.js");
}
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-B4jnTeux.js");
...
function loadSessionsRuntimeModule() {
	sessionsRuntimeModulePromise ??= import("./sessions.runtime-DUkD7-kZ.js");
