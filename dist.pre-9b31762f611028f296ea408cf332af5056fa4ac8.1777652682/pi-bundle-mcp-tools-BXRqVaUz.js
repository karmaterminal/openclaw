...
import { i as setPluginToolMeta } from "./tools-Cf6EfoW-.js";
import { c as buildSafeToolName, l as normalizeReservedToolNames } from "./pi-bundle-mcp-runtime-je5uazSo.js";
...
async function createBundleMcpToolRuntime(params) {
	const runtime = (params.createRuntime ?? (await import("./pi-bundle-mcp-runtime-BRgcYvi0.js")).createSessionMcpRuntime)({
