...
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-BiJoF0nv.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-BkX0XZoL.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-DvdEkqQH.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("./jsonwebtoken-DhaaIUHK.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-CKGrpzPf.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwt, { JwksClient }]) => ({
		jwt,
		JwksClient
	}));
