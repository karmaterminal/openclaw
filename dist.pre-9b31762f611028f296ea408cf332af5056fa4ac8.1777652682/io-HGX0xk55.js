...
import { o as sanitizeHostExecEnv } from "./host-env-security-BS88dAsz.js";
import { n as containsEnvVarReference, r as resolveConfigEnvVars } from "./env-substitution-DOwCXCFT.js";
import { r as applyConfigEnvVars } from "./state-dir-dotenv-mYkoBPQn.js";
import { _ as resolveStateDir, n as DEFAULT_GATEWAY_PORT, o as resolveConfigPath } from "./paths-CrDgDBYA.js";
import { n as VERSION } from "./version-D108XVAk.js";
import { a as coerceSecretRef, f as parseLegacySecretRefEnvMarker } from "./types.secrets-D9j6Z-gp.js";
import { i as isCanonicalDottedDecimalIPv4, u as isLoopbackIpAddress } from "./ip-5c0RYlS_.js";
import { t as ensureOwnerDisplaySecret } from "./owner-display-8505DamY.js";
import { t as getBootstrapChannelPlugin } from "./bootstrap-registry-B6Be2iA6.js";
import { t as isSafeExecutableValue } from "./exec-safety-DmOD5trD.js";
import { n as resolveManifestContractOwnerPluginId, r as resolveManifestContractPluginIds, t as loadPluginManifestRegistry } from "./manifest-registry-B3DZmlKC.js";
import { r as hasKind } from "./slots-ClU32VIo.js";
import { c as resolveEffectivePluginActivationState, o as normalizePluginsConfig, u as resolveMemorySlotDecision } from "./config-state-xYE_uUf9.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-Cx3e2QRz.js";
import { i as listPluginDoctorLegacyConfigRules, n as collectRelevantDoctorPluginIds, r as collectRelevantDoctorPluginIdsForTouchedPaths, t as applyPluginDoctorCompatibilityMigrations } from "./doctor-contract-registry-DQxJkzxq.js";
import { a as resolveGatewayPortWithDefault, i as isGatewayNonLoopbackBindMode, r as hasConfiguredControlUiAllowedOrigins, t as buildDefaultControlUiAllowedOrigins } from "./gateway-control-ui-origins-Bpadcn3w.js";
...
import { t as resolveSingleAccountKeysToMove } from "./setup-promotion-helpers-DnM2KqQy.js";
...
import { t as loadDotEnv } from "./dotenv-D-YdXLHu.js";
import { t as sanitizeTerminalText } from "./safe-text-VurrDCJv.js";
import { a as resolveConfigIncludes, i as readConfigIncludeFileWithGuards, n as ConfigIncludeError } from "./includes-BIuEY7wv.js";
import { i as applyMergePatch, n as appendAllowedValuesHint, r as summarizeAllowedValues, t as validateJsonSchemaValue } from "./schema-validator-Cv-2mzzf.js";
import { V as normalizeSafeBinProfileFixtures, i as normalizeTrustedSafeBinDirs } from "./exec-safe-bin-trust-BmnwS9pR.js";
...
import { t as listKnownChannelEnvVarNames } from "./channel-env-vars-ngoxWpi6.js";
import { n as listKnownProviderAuthEnvVarNames } from "./provider-env-vars-Cva53EUa.js";
import { b as resolveAgentWorkspaceDir, x as resolveDefaultAgentId } from "./agent-scope-zHoqFGPE.js";
import { t as withBundledPluginAllowlistCompat } from "./bundled-compat-BNZc6zPJ.js";
import { t as resolveManifestCommandAliasOwner } from "./manifest-command-aliases.runtime-BDu7GJQC.js";
import "./path-utils-Cj1VSYbL.js";
import { n as discoverConfigSecretTargets } from "./target-registry-DwxRH33G.js";
import { c as isWindowsAbsolutePath, i as isAvatarHttpUrl, n as hasAvatarUriScheme, o as isPathWithinRoot, r as isAvatarDataUrl } from "./avatar-policy-Cr4jJlbw.js";
import { t as OpenClawSchema } from "./zod-schema-ZcRmdVgp.js";
import { n as comparePrereleaseIdentifiers, r as normalizeLegacyDotBetaVersion } from "./semver-compare-XEutLaSN.js";
...
//#endregion
export { resolveAgentMaxConcurrent as $, applyConfigOverrides as A, maintainConfigBackups as B, validateConfigObjectRaw as C, collectPluginSchemaMetadata as D, collectChannelSchemaMetadata as E, asResolvedSourceConfig as F, normalizeBaseCompatibilityConfigValues as G, getShellPathFromLoginShell as H, asRuntimeConfig as I, normalizeGoogleApiBaseUrl as J, normalizeLegacyCommandsConfig as K, findLegacyConfigIssues as L, resetConfigOverrides as M, setConfigOverride as N, GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA as O, unsetConfigOverride as P, resolveBundledProviderPolicySurface as Q, createInvalidConfigError as R, validateConfigObject as S, validateConfigObjectWithPlugins as T, resolveShellEnvFallbackTimeoutMs as U, getShellEnvAppliedKeys as V, shouldEnableShellEnvFallback as W, normalizeTalkSection as X, buildTalkConfigResponse as Y, resolveActiveTalkProviderConfig as Z, registerConfigWriteListener as _, loadConfig as a, applyLegacyDoctorMigrations as at, normalizeOpenClawVersionBase as b, promoteConfigSnapshotToLastKnownGood as c, readConfigFileSnapshotForWrite as d, resolveSubagentMaxConcurrent as et, readSourceConfigBestEffort as f, recoverConfigFromLastKnownGood as g, recoverConfigFromJsonRootSuffix as h, getRuntimeConfig as i, resolveCliRuntimeExecutionProvider as it, getConfigOverrides as j, resolveShellEnvExpectedKeys as k, readBestEffortConfig as l, readSourceConfigSnapshotForWrite as m, clearConfigCache as n, isLegacyRuntimeModelProvider as nt, parseConfigJson5 as o, applyChannelDoctorCompatibilityMigrations as ot, readSourceConfigSnapshot as p, normalizeLegacyOpenAICodexModelsAddMetadata as q, createConfigIO as r, listLegacyRuntimeModelProviderAliases as rt, projectConfigOntoRuntimeSourceSnapshot as s, ConfigRuntimeRefreshError as t, isLegacyModelsAddCodexMetadataModel as tt, readConfigFileSnapshot as u, resolveConfigSnapshotHash as v, validateConfigObjectRawWithPlugins as w, collectUnsupportedSecretRefPolicyIssues as x, writeConfigFile as y, formatInvalidConfigDetails as z };
