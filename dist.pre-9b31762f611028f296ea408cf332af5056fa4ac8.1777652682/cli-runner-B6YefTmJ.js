...
import { f as isFailoverErrorMessage, t as classifyFailoverReason } from "./errors-MpyiTt6j.js";
import { i as isFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-Buq9wg2B.js";
import { n as buildAgentHookConversationMessages, t as loadCliSessionHistoryMessages } from "./session-history-BjZv2OUL.js";
...
async function runCliAgent(params) {
	...
	const { prepareCliRunContext } = await import("./prepare.runtime-DAOohAM8.js");
	return runPreparedCliAgent(await prepareCliRunContext(params));
}
async function runPreparedCliAgent(context) {
	const { executePreparedCliRun } = await import("./execute.runtime-BohVIHr9.js");
