...
import "./accounts-Dmj3D1-J.js";
import "./runtime-api-mWV-scAA.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-Ds5ZxgWI.js";
import { t as sendMessageZalo } from "./send-B-noOCbB.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-CW8ZLoiz.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-C3s9efJk.js");
