...
import "./thread-bindings-BzAlWNf8.js";
import { d as resolveDiscordChannelInfoSafe, f as resolveDiscordChannelNameSafe, o as resolveDiscordMessageChannelId, r as resolveDiscordChannelInfo, s as resolveDiscordMessageText } from "./message-utils-DG6_TpwK.js";
import { a as handleDiscordDmCommandDecision, i as resolveDiscordEffectiveRoute, o as resolveDiscordDmCommandAccess, r as resolveDiscordConversationRoute, t as buildDiscordRoutePeer } from "./route-resolution-D6_RJx8f.js";
import { n as resolveDiscordWebhookId, t as resolveDiscordSenderIdentity } from "./sender-identity-CE3zxQfG.js";
...
async function loadPluralKitRuntime() {
	pluralkitRuntimePromise ??= import("./pluralkit-D4L6Fmr1.js").then((n) => n.n);
	return await pluralkitRuntimePromise;
}
async function loadDiscordSendRuntime() {
	discordSendRuntimePromise ??= import("./send-CTw2NH1Y.js").then((n) => n.t);
	return await discordSendRuntimePromise;
}
async function loadPreflightAudioRuntime() {
	preflightAudioRuntimePromise ??= import("./preflight-audio-DbmjevRV.js");
	return await preflightAudioRuntimePromise;
}
async function loadSystemEventsRuntime() {
	systemEventsRuntimePromise ??= import("./system-events-BFqDIsqu.js");
	return await systemEventsRuntimePromise;
}
async function loadDiscordThreadingRuntime() {
	discordThreadingRuntimePromise ??= import("./threading-CjLDXLrR.js").then((n) => n.s);
