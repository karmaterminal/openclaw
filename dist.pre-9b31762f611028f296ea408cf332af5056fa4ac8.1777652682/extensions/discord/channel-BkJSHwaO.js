...
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-DpWGhPJx.js";
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-1FPBNIqk.js";
import { t as getDiscordApprovalCapability } from "./approval-native-Cgc7oj4V.js";
import { t as discordMessageActions$1 } from "./channel-actions-C_6Hh0bq.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-C_-XeNMF.js";
...
import { n as normalizeDiscordMessagingTarget, r as normalizeDiscordOutboundTarget, t as looksLikeDiscordTargetId } from "./normalize-BQWlVVjB.js";
import { t as getDiscordRuntime } from "./runtime-Cn1X4Wff.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-0TtxEn_Y.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-Dl2z38m4.js").then((n) => n.t));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-DSb2tmfe.js").then((n) => n.n));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-qDtOhwzQ.js").then((n) => n.n));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-C_3IEKid.js").then((n) => n.a));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime-Da7vMlN8.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-Bbme6y4I.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-CrEh_G8b.js").then((n) => n.n);
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-CTw2NH1Y.js").then((n) => n.t);
