...
import { n as normalizeAtHashSlug, s as normalizeStringEntries } from "./string-normalization-CEOVTwLJ.js";
...
import { n as DEFAULT_AGENT_WORKSPACE_DIR, u as ensureAgentWorkspace } from "./workspace-ibYRWzQC.js";
import { _ as resolveAgentConfig, b as resolveAgentWorkspaceDir, h as listAgentEntries, l as resolveAgentSkillsFilter, p as resolveSessionAgentId, y as resolveAgentDir } from "./agent-scope-zHoqFGPE.js";
import "./config-B3U8IbHS.js";
import { d as resolveGatewayMessageChannel, r as isInternalMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-BEwkHNOF.js";
import "./message-channel-core-xs8kGtaw.js";
import { i as isInterSessionInputProvenance } from "./input-provenance-B72DIE3s.js";
import { d as resetRegisteredAgentHarnessSessions } from "./loader-Dbq7I8n7.js";
...
import { g as requireActivePluginChannelRegistry, n as getActivePluginChannelRegistryVersion } from "./runtime-BLsgx2-v.js";
...
import { h as resolveModelRefFromString } from "./model-selection-shared-BF-DQvbf.js";
import "./model-selection-CZhXg7nY.js";
import { t as canonicalizeMainSessionAlias } from "./main-session-BzfGEj6I.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-DOSS0HMP.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, n as deliveryContextKey, t as deliveryContextFromSession } from "./delivery-context.shared-DBWNAPgn.js";
import { o as resolveMaintenanceConfigFromInput, t as loadSessionStore } from "./store-load-BLzdjzCX.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types--vJusqfs.js";
import { b as resolveGroupSessionKey, c as updateSessionStore, g as deriveSessionMetaPatch, p as resolveSessionStoreEntry } from "./store-BD0Vlvaq.js";
...
import { a as resolveAndPersistSessionFile } from "./transcript-pszwLYmd.js";
import { n as parseSessionThreadInfoFast } from "./thread-info-BDRE91Wf.js";
import { o as getQueueSize, r as clearCommandLane } from "./command-queue-B2X59ob3.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-2Eginc2V.js";
import { rt as isReasoningTagProvider } from "./wait-for-idle-before-flush-Qw1sNAcp.js";
import { n as applyOwnerOnlyToolPolicy } from "./tool-policy-BEJUsLxm.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-D0Uir1Iz.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-CiIhWcfX.js";
import { i as collectTextContentBlocks } from "./tool-schema-runtime-Cd1hNlJv.js";
...
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-BRERP-u8.js";
import { a as generateSecureToken } from "./secure-random-aGuoGZ0m.js";
import { n as resolveSilentReplySettings } from "./silent-reply-C-B4i2Rj.js";
import { t as buildOutboundSessionContext } from "./session-context-Bq9RD39Z.js";
import { i as enqueueSystemEvent, l as removeSystemEvents } from "./system-events-DV5kbtQJ.js";
import { t as resolveQueueSettings } from "./queue-7D5vMtql.js";
...
import { r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-BROB-vtw.js";
import { o as forkSessionFromParent, s as resolveParentForkMaxTokens } from "./subagent-spawn-DD79eBoH.js";
...
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-BrvxHvcG.js";
import { t as hasControlCommand } from "./command-detection-BGns1hGQ.js";
import "./commands-registry-CB2k7iyG.js";
import { t as resolveRunTypingPolicy } from "./typing-policy-BaCLRf5b.js";
...
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-CZaqnWho.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-BHH2Bzns.js";
...
import { t as normalizeGroupActivation } from "./group-activation-BHa_9KY1.js";
import { i as resolveTypingMode, r as resolveActiveRunQueueAction, t as cancelContinuationTimer } from "./agent-runner-BWDehmxA.js";
import { r as getCliSessionBinding } from "./cli-session-DlNIB0Bo.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-CaMtxf6H.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-CBrVCs7O.js";
import { n as buildSessionStartHookPayload, t as buildSessionEndHookPayload } from "./session-hooks-C5upf-pp.js";
import { r as drainFormattedSystemEvents } from "./session-updates-CnvFvY4C.js";
import { t as resolveDefaultModel } from "./directive-handling.defaults-CfnfhzQc.js";
import { t as resolveFastModeState } from "./fast-mode-KIPO31Qm.js";
import { t as buildCommandContext } from "./commands-context-D2pCDgVP.js";
import { t as parseInlineDirectives } from "./directive-handling.parse-DDbLM3vJ.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-BnfZZLHn.js";
import { t as resolveModelSelectionFromDirective } from "./directive-handling.model-selection-Jnt4TJkh.js";
...
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-DjRA4ozz.js";
import { n as parseSoftResetCommand, t as isResetAuthorizedForContext } from "./reset-authorization-BoAkgoo5.js";
...
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-CdYoqEXD.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-BKJVuabM.js";
import { t as hasInboundMedia } from "./inbound-media-DdOEEEsB.js";
...
import { t as resolveResetPreservedSelection } from "./reset-preserved-selection-MLptZkx5.js";
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-C3E31mBW.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-CdynfTOl.js";
...
function loadCommandsStatus() {
	commandsStatusPromise ??= import("./commands-status.runtime-BIf6B4P2.js");
	return commandsStatusPromise;
}
function loadDirectiveLevels() {
	directiveLevelsPromise ??= import("./directive-handling.levels-BkEH3rNl.js");
	return directiveLevelsPromise;
}
function loadDirectiveImpl() {
	directiveImplPromise ??= import("./directive-handling.impl-BdLwLy03.js");
	return directiveImplPromise;
}
function loadDirectiveFastLane() {
	directiveFastLanePromise ??= import("./directive-handling.fast-lane-6piPWHWo.js");
	return directiveFastLanePromise;
}
function loadDirectivePersist() {
	directivePersistPromise ??= import("./directive-handling.persist.runtime-D4wlQtbW.js");
...
function loadGroupsRuntime() {
	groupsRuntimePromise ??= import("./groups.runtime-DKVoCSSF.js");
...
function loadCommandsRegistry() {
	commandsRegistryPromise ??= import("./commands-registry.runtime-CReqyCfx.js");
	return commandsRegistryPromise;
}
function loadSkillCommands() {
	skillCommandsPromise ??= import("./skill-commands.runtime-BL5-iMqY.js");
...
function loadSkillCommandsRuntime() {
	skillCommandsRuntimePromise ??= import("./skill-commands.runtime-BL5-iMqY.js");
	return skillCommandsRuntimePromise;
}
function loadOpenClawToolsRuntime() {
	openClawToolsRuntimePromise ??= import("./openclaw-tools.runtime-CrumAWAL.js");
	return openClawToolsRuntimePromise;
}
function loadAbortCutoffRuntime() {
	abortCutoffRuntimePromise ??= import("./abort-cutoff.runtime-Cy316Spd.js");
	return abortCutoffRuntimePromise;
}
function loadCommandsRuntime() {
	commandsRuntimePromise ??= import("./commands.runtime-VTYHZGMU.js");
...
function loadSessionStoreRuntime$1() {
	sessionStoreRuntimePromise$1 ??= import("./store.runtime-DXmF2I07.js");
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded.runtime-DN2tsMgg.js");
	return piEmbeddedRuntimePromise;
}
function loadAgentRunnerRuntime() {
	agentRunnerRuntimePromise ??= import("./agent-runner.runtime-aRgScy09.js");
	return agentRunnerRuntimePromise;
}
function loadSessionUpdatesRuntime() {
	sessionUpdatesRuntimePromise ??= import("./session-updates.runtime-D5usdvZ2.js");
...
function loadDeliverRuntime() {
	deliverRuntimePromise ??= import("./deliver-runtime-lZk7LYvD.js");
...
function loadSessionArchiveRuntime() {
	sessionArchiveRuntimePromise ??= import("./session-archive.runtime-C3UP_DSA.js");
...
function loadSessionResetModelRuntime() {
	sessionResetModelRuntimePromise ??= import("./session-reset-model.runtime-DsHLVQAB.js");
	return sessionResetModelRuntimePromise;
}
function loadStageSandboxMediaRuntime() {
	stageSandboxMediaRuntimePromise ??= import("./stage-sandbox-media.runtime-0UniZRGK.js");
	return stageSandboxMediaRuntimePromise;
}
function loadMediaUnderstandingApplyRuntime() {
	mediaUnderstandingApplyRuntimePromise ??= import("./apply.runtime-BrmSkd84.js");
	return mediaUnderstandingApplyRuntimePromise;
}
function loadLinkUnderstandingApplyRuntime() {
	linkUnderstandingApplyRuntimePromise ??= import("./apply.runtime-Lh2MMdh8.js");
	return linkUnderstandingApplyRuntimePromise;
}
function loadCommandsCoreRuntime() {
	commandsCoreRuntimePromise ??= import("./commands-core.runtime-BHBBVAuj.js");
...
function loadHookRunnerGlobal() {
	hookRunnerGlobalPromise ??= import("./hook-runner-global-CunX-XX4.js");
	return hookRunnerGlobalPromise;
}
function loadOriginRouting() {
	originRoutingPromise ??= import("./origin-routing-B_QgLyW_.js");
