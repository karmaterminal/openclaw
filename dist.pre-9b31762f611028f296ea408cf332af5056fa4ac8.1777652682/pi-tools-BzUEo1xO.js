...
import { _ as resolveAgentConfig } from "./agent-scope-zHoqFGPE.js";
import { d as resolveGatewayMessageChannel } from "./message-channel-BEwkHNOF.js";
import { c as createHostWorkspaceEditTool, d as createSandboxedEditTool, f as createSandboxedReadTool, g as wrapToolWorkspaceRootGuardWithOptions, h as wrapToolWorkspaceRootGuard, l as createHostWorkspaceWriteTool, m as wrapToolMemoryFlushAppendOnlyWrite, p as createSandboxedWriteTool, t as createOpenClawTools, u as createOpenClawReadTool } from "./openclaw-tools-TBOZ1lbp.js";
import { b as EXEC_TOOL_DISPLAY_SUMMARY, c as mergeAlsoAllowPolicy, i as collectExplicitAllowlist, m as resolveToolProfilePolicy, n as applyOwnerOnlyToolPolicy, x as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-policy-BEJUsLxm.js";
import { n as getPluginToolMeta, t as copyPluginToolMeta } from "./tools-Cf6EfoW-.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-D2JNL9xJ.js";
import { i as listChannelAgentTools, t as copyChannelAgentToolMeta } from "./channel-tools-C-5d8QZ3.js";
import { t as normalizeToolParameterSchema } from "./pi-tools-parameter-schema-CBjbFcQH.js";
import { t as bindAbortRelay } from "./fetch-timeout-cyiaRbuu.js";
import { a as wrapToolWithBeforeToolCallHook } from "./pi-tools.before-tool-call-DR0s6bRU.js";
import { i as resolveMergedSafeBinProfileFixtures } from "./exec-safe-bin-runtime-policy-wQQ5JMsc.js";
import { g as writeFileWithinRoot, o as mkdirPathWithinRoot, p as removePathWithinRoot } from "./fs-safe-C6LQEdgq.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-DmKlJUgM.js";
import { n as assertSandboxPath } from "./sandbox-paths-C2p6bbXT.js";
import { a as resolveGroupToolPolicy, c as resolveWorkspaceRoot, l as resolvePathFromInput, o as resolveSubagentToolPolicyForSession, r as resolveEffectiveToolPolicy, u as toRelativeSandboxPath } from "./read-capability-B7n1jIO2.js";
...
import { c as shouldSuppressManagedWebSearchTool } from "./codex-native-web-search-BiLsp7pu.js";
import { t as isToolAllowedByPolicies } from "./tool-policy-match-w3kgKWhb.js";
import { i as resolveToolFsConfig, t as createToolFsPolicy } from "./tool-fs-policy-Bo7jDjdG.js";
...
function loadBashToolsModule() {
	bashToolsModulePromise ??= import("./bash-tools-BEkXcVOQ.js");
