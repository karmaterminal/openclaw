...
async function runAuthProfileHealth(ctx) {
	...
	const { buildGatewayConnectionDetails } = await import("./call-rbJR1ojc.js");
	const { note } = await import("./note-DU-nPtVb.js");
...
async function runGatewayAuthHealth(ctx) {
	...
	const { note } = await import("./note-DU-nPtVb.js");
	const { randomToken } = await import("./onboard-helpers-B5gHeSv_.js");
...
async function runWorkspaceStatusHealth(ctx) {
	const { noteWorkspaceStatus } = await import("./doctor-workspace-status-C7g25jPz.js");
...
async function runGatewayHealthChecks(ctx) {
	const { checkGatewayHealth, probeGatewayMemoryStatus } = await import("./doctor-gateway-health-Crlw3oft.js");
...
async function runDevicePairingHealth(ctx) {
	const { noteDevicePairingHealth } = await import("./doctor-device-pairing-BNMCLm4J.js");
...
async function runGatewayDaemonHealth(ctx) {
	const { maybeRepairGatewayDaemon } = await import("./doctor-gateway-daemon-flow-DZIN1S8Z.js");
...
async function runWriteConfigHealth(ctx) {
	const { formatCliCommand } = await import("./command-format-CvdT6mLW.js");
	const { applyWizardMetadata } = await import("./onboard-helpers-B5gHeSv_.js");
