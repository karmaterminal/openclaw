import { n as resolveManifestProviderAuthChoice } from "./provider-auth-choices-Dc8Hv8h1.js";
import { r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-3xACND9q.js";
...
async function resolvePreferredProviderForAuthChoice(params) {
	...
	const { resolveProviderPluginChoice, resolvePluginProviders } = await import("./provider-auth-choice.runtime-leSEzfKA.js");
