...
import { i as runPluginSetupConfigMigrations } from "./setup-registry-D7NxCAPn.js";
import { i as listRouteBindings } from "./bindings-DL6V-u6m.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-BC62O2HS.js";
import { t as note } from "./note-CSFP_p8c.js";
import { a as stripUnknownConfigKeys, r as noteOpencodeProviderOverrides } from "./doctor-config-analysis-DQOSJaP7.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-CSj92q-d.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-BzRSrW6Y.js";
import { t as asObjectRecord } from "./object-wvd6RAp3.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = await (async () => {
		...
		const { collectRelevantDoctorPluginIds, listPluginDoctorLegacyConfigRules } = await import("./doctor-contract-registry-DXNvVv3f.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-D1SjeESy.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-B0YJjhU5.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-gqvItnPl.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-75GN5sKY.js");
		emitDoctorNotes({
			note,
