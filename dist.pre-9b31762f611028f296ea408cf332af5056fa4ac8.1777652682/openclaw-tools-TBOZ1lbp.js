...
import { a as shouldLogVerbose, r as logVerbose } from "./globals-BMZFdRyi.js";
import { t as logDebug } from "./logger-3yj7caI3.js";
import { n as resolveManifestContractOwnerPluginId, t as loadPluginManifestRegistry } from "./manifest-registry-B3DZmlKC.js";
import { c as resolveEffectivePluginActivationState, n as createPluginActivationSource, o as normalizePluginsConfig } from "./config-state-xYE_uUf9.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-Cx3e2QRz.js";
import { a as loadConfig, o as parseConfigJson5, v as resolveConfigSnapshotHash } from "./io-HGX0xk55.js";
...
import { i as normalizeChannelId$1, r as listChannelPlugins, t as getChannelPlugin } from "./registry-DPUPp9Ly.js";
...
import { _ as resolveAgentConfig, b as resolveAgentWorkspaceDir, m as resolveSessionAgentIds, p as resolveSessionAgentId, r as resolveAgentExecutionContract } from "./agent-scope-zHoqFGPE.js";
import { t as parseDurationMs } from "./parse-duration-DJdfoEt9.js";
import { t as isInboundPathAllowed } from "./inbound-path-policy-D6PFsYGw.js";
import { n as isRestartEnabled } from "./commands.flags-B6cEn_y9.js";
import "./config-B3U8IbHS.js";
import { h as GATEWAY_CLIENT_MODES, m as GATEWAY_CLIENT_IDS, u as normalizeMessageChannel } from "./message-channel-BEwkHNOF.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-xs8kGtaw.js";
import { d as readConnectPairingRequiredMessage } from "./connect-error-details-D-uC5j3Z.js";
import { n as resolveBundledPluginCompatibleLoadValues } from "./activation-context-DOKW08tr.js";
import "./plugins-Bk33nzKG.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-B5tHTXWf.js";
import { n as ensureOpenClawModelsJson } from "./models-config-BsceLwxR.js";
import { b as normalizeModelRef, h as resolveModelRefFromString, i as buildModelAliasIndex, r as buildConfiguredModelCatalog, y as modelKey } from "./model-selection-shared-BF-DQvbf.js";
import { o as resolveDefaultModelForAgent, p as resolveThinkingDefault, t as buildAllowedModelSet } from "./model-selection-CZhXg7nY.js";
...
import { r as loadModelCatalog } from "./model-catalog-CcWDLdw8.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-CXV6bky5.js";
import { t as extractDeliveryInfo } from "./sessions-CQdlpJUR.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-DOSS0HMP.js";
import { i as normalizeDeliveryContext } from "./delivery-context.shared-DBWNAPgn.js";
import { c as createExpiringMapCache } from "./store-cache-Bw52opAV.js";
import { t as loadSessionStore } from "./store-load-BLzdjzCX.js";
import { c as updateSessionStore } from "./store-BD0Vlvaq.js";
import { n as resolveSessionConversationRef } from "./session-conversation-CKuYV0vT.js";
import { n as capArrayByJsonBytes, o as readSessionTitleFieldsFromTranscript, p as jsonUtf8Bytes } from "./session-utils.fs-Dn5nQNOb.js";
import { p as resolveSessionModelIdentityRef, t as deriveSessionTitle } from "./session-utils-BWJpwoCp.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-2Eginc2V.js";
import { i as imageMimeFromFormat, t as detectMime } from "./mime-CeX1JZPE.js";
import { A as describeSessionsListTool, C as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, D as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY, E as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, M as describeSessionsSpawnTool, N as describeUpdatePlanTool, O as describeSessionStatusTool, S as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, T as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, j as describeSessionsSendTool, k as describeSessionsHistoryTool, w as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, y as CRON_TOOL_DISPLAY_SUMMARY } from "./tool-policy-BEJUsLxm.js";
import { r as resolvePluginTools } from "./tools-Cf6EfoW-.js";
import { w as textToSpeech } from "./tts-CepJD85f.js";
import { p as extractTextFromChatContent } from "./sanitize-user-facing-text-ByUPtx4k.js";
import { a as getImageMetadata } from "./image-ops-PvE34fj_.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-D2JNL9xJ.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-CVG-UkbI.js";
import { a as listChannelSupportedActions, r as listAllChannelSupportedActions } from "./channel-tools-C-5d8QZ3.js";
import { r as getApiKeyForModel } from "./model-auth-z9q2AAmi.js";
import { t as SsrFBlockedError } from "./ssrf-Bg0Ww888.js";
import { u as parseReplyDirectives } from "./payloads-DEM757dI.js";
import { n as runWithImageModelFallback } from "./model-fallback-BDqX_3RA.js";
import { c as stripReasoningTagsFromText } from "./assistant-visible-text-Bln76yKO.js";
import { t as extractAssistantText } from "./pi-embedded-utils-BWOmuHYr.js";
import { r as callGateway } from "./call-DzkfJoJS.js";
import { b as readSnakeCaseParamRaw, f as readNumberParam, g as readStringParam$1, i as asToolParamsRecord, l as jsonResult, m as readStringArrayParam, r as ToolInputError, s as imageResult } from "./common-B-ADznUd.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-DIlevtsy.js";
import { g as writeFileWithinRoot, r as appendFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-C6LQEdgq.js";
import { t as isWindowsDrivePath } from "./archive-path-DS1ApGmV.js";
import { o as trySafeFileURLToPath, r as hasEncodedFileUrlSeparator } from "./local-file-access-CATmQTDG.js";
import { n as assertSandboxPath } from "./sandbox-paths-C2p6bbXT.js";
import { c as resolveWorkspaceRoot, d as toRelativeWorkspacePath, s as normalizeWorkspaceDir } from "./read-capability-B7n1jIO2.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata } from "./runtime-B0T7UY8N.js";
import "./delivery-context-D9Edfyha.js";
import { t as sniffMimeFromBase64 } from "./sniff-mime-from-base64-BjJZvX24.js";
import { a as createSessionVisibilityGuard, c as resolveDisplaySessionKey, d as resolveSessionReference, f as resolveVisibleSessionReference, i as createAgentToAgentPolicy, l as resolveInternalSessionKey, n as deriveChannel, o as resolveEffectiveSessionToolsVisibility, p as shouldResolveSessionIdInput, r as resolveSessionToolContext, s as resolveSandboxedSessionToolContext, t as classifySessionKind, u as resolveMainSessionAlias } from "./sessions-helpers-Dtqiy-3Y.js";
import { r as stripToolMessages } from "./chat-history-text-DU530Av5.js";
import { a as parseCanvasSnapshotPayload, c as parseCameraSnapPayload, d as writeCameraPayloadToFile, i as canvasSnapshotTempPath, l as writeBase64ToFile, n as screenRecordTempPath, o as cameraTempPath, r as writeScreenRecordToFile, s as parseCameraClipPayload, t as parseScreenRecordPayload, u as writeCameraClipPayloadToFile } from "./nodes-screen-D2NFJSNI.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-CRJ68cz-.js";
...
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-BvGc-Zf9.js";
import { d as stagePostCompactionDelegate, f as stagedPostCompactionDelegateCount, s as enqueuePendingDelegate, u as pendingDelegateCount } from "./delegate-store-BKkoivDc.js";
import { d as resolveMaxDelegatesPerTurn, r as loadSessionEntryByKey, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-Dj-53PAi.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-D28xj_rW.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-DLl9hEHh.js";
import { t as inferLegacyName } from "./normalize-ChC6vdpT.js";
import { n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-BRiFBp0U.js";
import { c as removeRestartSentinelFile, f as writeRestartSentinel, i as formatDoctorNonInteractiveHint, n as buildRestartSuccessContinuation } from "./restart-sentinel-yOW_EH6f.js";
import { o as scheduleGatewaySigusr1Restart } from "./restart-CKZ_MmAj.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-DICP9E6P.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-DRcmI3by.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-sG4rkq9S.js";
import { n as resolveConfiguredMediaMaxBytes } from "./configured-max-bytes-Xd0P7VKZ.js";
import { l as saveMediaBuffer } from "./store-vYYFxkgL.js";
import { a as classifyMediaReferenceSource, o as normalizeMediaReferenceSource, r as getDefaultLocalRoots } from "./local-media-access-aGBPWcTZ.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-BbckQqQN.js";
import { a as coerceImageModelConfig, c as resolveProviderVisionModelFromConfig, d as hasAuthForProvider, f as hasToolModelConfig, l as buildToolModelConfigFromCandidates, n as isMinimaxVlmProvider, o as decodeDataUrl, p as resolveDefaultModelRef, u as coerceToolModelConfig } from "./minimax-vlm-CTLr2vL0.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-wmPwBi4H.js";
import { b as resolveAutoMediaKeyProviders, w as getMediaUnderstandingProvider, x as resolveDefaultMediaModel, y as providerSupportsNativePdfDocument } from "./resolve-BG1Pclos.js";
import { n as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-Ce5F0IOS.js";
import { t as buildProviderRegistry } from "./runner-DiCTrRr8.js";
import "./media-understanding-Bs05_f-d.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-BJ_8ZLAE.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-97fwLHul.js";
import { o as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-1hzwAQqR.js";
import { a as POLL_CREATION_PARAM_DEFS, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-Dt9jxpEz.js";
import { t as sendMessage } from "./message-BHMj-N30.js";
import { i as resolveMusicGenerationModeCapabilities, n as listRuntimeMusicGenerationProviders, r as listSupportedMusicGenerationModes, t as generateMusic } from "./runtime-BtmO38Zp.js";
import { r as parseMusicGenerationModelRef } from "./provider-registry-D-vCWzh3.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-fEf4DJ0a.js";
...
import { a as recordTaskRunProgressByRunId, i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-BHJYPBD1.js";
import "./task-registry-delivery-runtime-7c-LREbj.js";
import { t as formatAgentInternalEventsForPrompt } from "./internal-events-DZStiG-Y.js";
import { f as runAgentStep, g as isReplySkip, h as isAnnounceSkip, m as REPLY_SKIP_TOKEN, p as ANNOUNCE_SKIP_TOKEN } from "./subagent-announce-output-DRoW2q5R.js";
...
import { t as extractPdfContent } from "./pdf-extract-BdapH_gF.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-DIP-LQp_.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-BFdhvi3p.js";
...
import { i as waitForAgentRunAndReadUpdatedAssistantReply, n as readLatestAssistantReplySnapshot, r as waitForAgentRun, t as readLatestAssistantReply } from "./run-wait-CBf4rFJW.js";
import { f as registerSubagentRun } from "./subagent-registry-C6txYfiZ.js";
import { i as SUBAGENT_SPAWN_MODES, n as spawnSubagentDirect, r as SUBAGENT_SPAWN_CONTEXT_MODES } from "./subagent-spawn-DD79eBoH.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-CweJzFEf.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-BjRojYTl.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, n as listRuntimeVideoGenerationProviders, r as listSupportedVideoGenerationModes, t as generateVideo } from "./runtime-uPhtViLo.js";
import { r as parseVideoGenerationModelRef } from "./provider-registry-C8CjoT3P.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-BMsxhGqS.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-CbKNCJQ8.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-Bu-4nUVh.js";
import { a as readResponseText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds } from "./web-shared-BYBEmZ9r.js";
import { a as runWebSearch, i as resolveWebSearchDefinition } from "./runtime-B_0nj8Rb.js";
import "./web-search-provider-common-CKVzZ5XY.js";
...
function createContinueDelegateTool(opts) {
	return {
		...
		execute: async (_toolCallId, args) => {
			...
			log$7.debug(`[continue_delegate:enqueue] session=${sessionKey} mode=${mode} delayMs=${delayMs} task=${task.slice(0, 80)}`);
...
async function getRuntime() {
	if (!runtimeMod) runtimeMod = await import("./embedded-gateway-stub.runtime-CEd7bjR4.js");
	return runtimeMod;
}
		...
		execute: async (_toolCallId, args) => {
			...
			opts.triggerCompaction().then((result) => {
				...
				if (result.ok && isCompactionSkipCode(code)) {
					log$2.info(`[request_compaction:resolved-skip] session=${sessionKey} code=${code} reason=${reason}`);
					return;
				}
				log$2.warn(`[request_compaction:resolved-failure] session=${sessionKey} code=${code} ok=${result.ok} compacted=${result.compacted} reason=${reason}`);
			}, (err) => {
				const message = err instanceof Error ? err.message : String(err);
				const code = classifyCompactionReason(message);
				log$2.error(`[request_compaction:background-error] session=${sessionKey} code=${code} error=${message}`);
			}).finally(() => {
...
function loadCommandsStatusRuntime() {
	commandsStatusRuntimePromise ??= import("./session-status.runtime-C8-R5f04.js");
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-rbJR1ojc.js");
...
async function loadAcpSpawnModule() {
	acpSpawnModulePromise ??= import("./acp-spawn-sU7707of.js");
...
async function loadWebFetchRuntime() {
	webFetchRuntimePromise ??= import("./runtime-HdM9Bund.js");
	return await webFetchRuntimePromise;
}
async function loadWebGuardedFetch() {
	webGuardedFetchPromise ??= import("./web-guarded-fetch-BJasUnUn.js");
...
//#endregion
export { isStrictAgenticExecutionContractActive as _, normalizeCronJobCreate as a, isEmbeddedMode as b, createHostWorkspaceEditTool as c, createSandboxedEditTool as d, createSandboxedReadTool as f, wrapToolWorkspaceRootGuardWithOptions as g, wrapToolWorkspaceRootGuard as h, resolveCompactionFailureReason as i, createHostWorkspaceWriteTool as l, wrapToolMemoryFlushAppendOnlyWrite as m, getVolitionalCompactionCount as n, normalizeCronJobInput as o, createSandboxedWriteTool as p, classifyCompactionReason as r, normalizeCronJobPatch as s, createOpenClawTools as t, createOpenClawReadTool as u, isStrictAgenticSupportedProviderModel as v, setEmbeddedMode as x, stripProviderPrefix as y };
