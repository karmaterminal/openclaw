...
import { n as resolveBrowserControlAuth } from "./control-auth-WFQQ0ZO4.js";
...
async function fetchBrowserJson(url, init) {
	...
	try {
		...
		const { dispatchBrowserControlRequest } = await import("./local-dispatch.runtime-B0n4FtAA.js");
