...
import { a as clearPluginManifestRegistryCache } from "./manifest-registry-B3DZmlKC.js";
import { M as resetConfigOverrides, N as setConfigOverride, P as unsetConfigOverride, T as validateConfigObjectWithPlugins, j as getConfigOverrides, u as readConfigFileSnapshot, y as writeConfigFile } from "./io-HGX0xk55.js";
...
import { i as normalizeChannelId$1, t as getChannelPlugin } from "./registry-DPUPp9Ly.js";
...
import { n as isRestartEnabled, t as isCommandFlagEnabled } from "./commands.flags-B6cEn_y9.js";
import "./config-B3U8IbHS.js";
import { g as GATEWAY_CLIENT_NAMES, h as GATEWAY_CLIENT_MODES, r as isInternalMessageChannel, u as normalizeMessageChannel } from "./message-channel-BEwkHNOF.js";
import { n as resolveChannelApprovalCapability } from "./plugins-Bk33nzKG.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-DUx3ffaZ.js";
import { x as prepareProviderRuntimeAuth } from "./provider-runtime-B5tHTXWf.js";
...
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, r as resolveDefaultSessionStorePath } from "./paths-DOSS0HMP.js";
...
import { i as formatUsd, r as formatTokenCount } from "./usage-format-kE6rXplS.js";
import { n as stripInboundMetadata } from "./strip-inbound-meta-Bns04ecN.js";
import { t as diagnosticLogger } from "./diagnostic-runtime-CCI4jhWU.js";
import { V as stripToolResultDetails } from "./wait-for-idle-before-flush-Qw1sNAcp.js";
import { n as redactSupportString } from "./diagnostic-support-redaction-23Q3Zswq.js";
import { C as safeTrajectorySessionFileName, S as resolveTrajectoryPointerFilePath, T as sanitizeDiagnosticPayload, b as TRAJECTORY_RUNTIME_FILE_MAX_BYTES, w as safeJsonStringify, x as resolveTrajectoryFilePath } from "./selection-CYxxptPl.js";
import { S as setTtsProvider, _ as setLastTtsAttempt, a as getTtsMaxLength, b as setTtsEnabled, c as isTtsEnabled, h as resolveTtsPrefsPath, i as getResolvedSpeechProviderConfig, l as isTtsProviderConfigured, m as resolveTtsConfig, o as getTtsProvider, r as getLastTtsAttempt, s as isSummarizationEnabled, v as setSummarizationEnabled, w as textToSpeech, x as setTtsMaxLength } from "./tts-CepJD85f.js";
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-CWSpa_GU.js";
import { S as resolveBootstrapMaxChars, w as resolveBootstrapTotalMaxChars } from "./pi-embedded-helpers-C1tu1bI5.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-CiIhWcfX.js";
import { i as resolveImageSanitizationLimits, n as sanitizeImageBlocks } from "./tool-images-D2JNL9xJ.js";
...
import { i as unsetConfiguredMcpServer, r as setConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-CajS3Zv7.js";
...
import { l as triggerOpenClawRestart, o as scheduleGatewaySigusr1Restart } from "./restart-CKZ_MmAj.js";
import { i as resolveReplyToMode } from "./reply-threading-DKUQzq83.js";
import { _ as authorizeConfigWriteShared, b as resolveConfigWriteTargetFromPathShared, v as canBypassConfigWritePolicyShared, y as formatConfigWriteDeniedMessageShared } from "./channel-config-helpers-YfAsHuaY.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-fEf4DJ0a.js";
import { a as clearSessionQueues } from "./queue-7D5vMtql.js";
import { r as getSessionBindingService } from "./session-binding-service-_uxH6cqw.js";
import { h as replyRunRegistry, i as getActiveEmbeddedRunSnapshot } from "./runs-rRV0MELk.js";
import "./diagnostic-4pDCeq7X.js";
import { t as formatDurationCompact } from "./format-duration-DM2_ICnQ.js";
import "./sandbox-D2A6r4WD.js";
...
import { r as resolveModelWithRegistry } from "./model-AV_tazi3.js";
import { i as matchPluginCommand, n as executePluginCommand } from "./commands-xJCxCfof.js";
import { t as isApprovalNotFoundError } from "./approval-errors-Cp6xrD42.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-Ce_G3b1Q.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-BrvxHvcG.js";
import "./commands-registry-CB2k7iyG.js";
import { n as formatTimeAgo } from "./format-relative-uQtNNoGl.js";
import { o as stripMentions, s as stripStructuralPrefixes } from "./mentions-BHH2Bzns.js";
import { n as setChannelConversationBindingMaxAgeBySessionKey, t as setChannelConversationBindingIdleTimeoutBySessionKey } from "./conversation-bindings-XhJx51nq.js";
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-BOyTiyUY.js";
import { i as installPluginFromPath, r as installPluginFromNpmSpec } from "./install-PnHdluvH.js";
import { l as resolveArchiveKind } from "./archive-C8E_wWRx.js";
import { n as isImplicitSameChatApprovalAuthorization } from "./approval-auth-helpers-Dxtse1l6.js";
import { n as parseActivationCommand } from "./group-activation-BHa_9KY1.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-D6xGGUen.js";
import { _ as getFinishedSession, v as getSession } from "./bash-tools.exec-runtime-BvuLJsMq.js";
import { t as resolveFastModeState } from "./fast-mode-KIPO31Qm.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-DSMkvUGV.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-DH01zZlf.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-5Mlin_6d.js";
import { a as shouldPersistAbortCutoff, i as resolveAbortCutoffFromContext, t as applyAbortCutoffToSessionEntry } from "./abort-cutoff-BKJVuabM.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-CtgNYwyL.js";
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-CdynfTOl.js";
import { n as resolveSessionEntryForKey, r as stopSubagentsForRequester, t as formatAbortReplyText } from "./abort-C24kVYca.js";
import { t as extractBtwQuestion } from "./btw-command-RwG9Kl_R.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-B086Rr2X.js";
...
import { a as requireGatewayClientScopeForInternalChannel, i as requireCommandFlagEnabled, n as rejectNonOwnerCommand, r as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates-C1BSRndw.js";
import { t as handleAcpCommand } from "./commands-acp-CVJ6yzbl.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-BYye8XxG.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-Hic6pJ3V.js";
import { r as handleModelsCommand } from "./commands-models-D2iE2rIg.js";
import { n as setPluginEnabledInConfig } from "./enable-CQxIFw9P.js";
import { r as createExecTool } from "./bash-tools-DWYfP07A.js";
import { n as listTasksForAgentIdForStatus, r as listTasksForSessionKeyForStatus } from "./status-text-B4dQScQm.js";
import { d as resolveChannelAccountId, f as resolveCommandSurfaceChannel, l as resolveSubagentsAction, o as resolveHandledPrefix, s as resolveRequesterSessionKey, u as stopWithText } from "./shared-Bbk1yi0N.js";
import { t as buildToolsMessage } from "./status-BxsK7EyU.js";
import { t as parseConfigValue } from "./config-value-Dpajjzze.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-B5rfuZFP.js";
import { a as writeSupportBundleDirectory, i as textSupportBundleFile, n as jsonlSupportBundleFile, r as supportBundleContents, t as jsonSupportBundleFile } from "./diagnostic-support-bundle-wrFdIRO_.js";
import { t as buildStatusReply } from "./commands-status-MIPe19zn.js";
import { i as buildNpmInstallRecordFields, n as persistPluginInstall } from "./plugins-install-persist-j9X7RqiP.js";
import { m as parseClawHubPluginSpec } from "./clawhub-DXlk8uBv.js";
import { r as installPluginFromClawHub } from "./clawhub-ChEVun11.js";
import { a as buildPluginDiagnosticsReport, c as formatPluginCompatibilityNotice, o as buildPluginInspectReport, s as buildPluginSnapshotReport, t as buildAllPluginInspectReports } from "./status-gVfxscoc.js";
import { a as decidePreferredClawHubFallback, i as createPluginInstallLogger, n as buildPreferredClawHubSpec, u as resolveFileNpmSpecToLocalPath } from "./plugins-command-helpers-oXkZcxQj.js";
import { n as loadCostUsageSummary, r as loadSessionCostSummary } from "./session-cost-usage-DUFgyo4M.js";
...
async function handleBashChatCommand(params) {
	...
	if (request.action === "stop") {
		...
		const { killProcessTree } = await import("./kill-tree-B4dn0D_W.js");
		killProcessTree(pid);
...
function loadCompactRuntime() {
	compactRuntimePromise ??= import("./commands-compact.runtime-DXhV48Ph.js");
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-BU5d3c6F.js");
...
async function abortEmbeddedPiRunForSession(sessionId) {
	const { abortEmbeddedPiRun } = await import("./runs-CHP82dsd.js");
...
function loadAgentsAction() {
	actionAgentsPromise ??= import("./action-agents-D3XYatCF.js");
	return actionAgentsPromise;
}
function loadFocusAction() {
	actionFocusPromise ??= import("./action-focus--TS5QTjJ.js");
	return actionFocusPromise;
}
function loadHelpAction() {
	actionHelpPromise ??= import("./action-help-BwAlJcFo.js");
	return actionHelpPromise;
}
function loadInfoAction() {
	actionInfoPromise ??= import("./action-info-1lQ3ctsU.js");
	return actionInfoPromise;
}
function loadKillAction() {
	actionKillPromise ??= import("./action-kill-HE2IuSVC.js");
	return actionKillPromise;
}
function loadListAction() {
	actionListPromise ??= import("./action-list-BJircOws.js");
	return actionListPromise;
}
function loadLogAction() {
	actionLogPromise ??= import("./action-log-C7jjQNCf.js");
	return actionLogPromise;
}
function loadSendAction() {
	actionSendPromise ??= import("./action-send-CsYZONrz.js");
	return actionSendPromise;
}
function loadSpawnAction() {
	actionSpawnPromise ??= import("./action-spawn-BPLcobqh.js");
	return actionSpawnPromise;
}
function loadUnfocusAction() {
	actionUnfocusPromise ??= import("./action-unfocus-D7PbnGsP.js");
	return actionUnfocusPromise;
}
function loadControlRuntime() {
	controlRuntimePromise ??= import("./commands-subagents-control.runtime-D4zBsaPu.js");
