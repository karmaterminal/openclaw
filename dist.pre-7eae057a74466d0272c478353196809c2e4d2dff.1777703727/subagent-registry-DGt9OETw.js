...
import { r as configureSubagentRegistrySpawnRuntime, t as emitSessionLifecycleEvent } from "./session-lifecycle-events-DaImppva.js";
...
import { s as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-o85lhn9f.js";
import "./pi-bundle-mcp-tools-RhsiRr77.js";
import { t as registerPendingSpawnedChildrenQuery } from "./pending-spawn-query-BcQADMA4.js";
import { i as failTaskRunByRunId, o as setDetachedTaskDeliveryStatusByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-mrp6EQ7I.js";
import "./subagent-announce-queue-C23seHXh.js";
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-Cnj_M8CW.js";
import { d as importRuntimeModule, u as withSubagentOutcomeTiming } from "./subagent-announce-output-mp_1UIg1.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-BNoOwIw9.js";
...
async function loadCleanupBrowserSessionsForLifecycleEnd$1() {
	browserCleanupPromise$1 ??= import("./browser-lifecycle-cleanup-0jmqbTPu.js");
...
async function loadSubagentAnnounceModule() {
	subagentAnnouncePromise ??= import("./subagent-announce-CYzALOv4.js");
	return await subagentAnnouncePromise;
}
async function loadCleanupBrowserSessionsForLifecycleEnd() {
	browserCleanupPromise ??= import("./browser-lifecycle-cleanup-0jmqbTPu.js");
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-B5D-r7PE.js").then(({ scheduleOrphanRecovery }) => {
