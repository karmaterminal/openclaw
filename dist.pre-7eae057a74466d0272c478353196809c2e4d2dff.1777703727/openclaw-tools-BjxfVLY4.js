...
import { a as loadConfig, o as parseConfigJson5, v as resolveConfigSnapshotHash } from "./io-BAiFlY00.js";
...
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-BVaRkoOn.js";
...
import { r as getApiKeyForModel } from "./model-auth-6BQTKjsb.js";
import { i as SUBAGENT_SPAWN_MODES, n as spawnSubagentDirect, r as SUBAGENT_SPAWN_CONTEXT_MODES } from "./subagent-spawn-CJ8BwCNd.js";
...
import { t as extractDeliveryInfo } from "./sessions-CTeI8wwA.js";
...
import { f as resolveSessionModelIdentityRef, t as deriveSessionTitle } from "./session-utils-NaS57IP6.js";
...
import { a as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-GL_aAlUQ.js";
import { a as resolveDisplaySessionKey, c as resolveSessionReference, i as resolveSandboxedSessionToolContext, l as resolveVisibleSessionReference, n as deriveChannel, o as resolveInternalSessionKey, r as resolveSessionToolContext, s as resolveMainSessionAlias, t as classifySessionKind, u as shouldResolveSessionIdInput } from "./sessions-helpers-Bc97mVpR.js";
...
import { c as getContinuationDelegateQueueDepths, f as stagePostCompactionDelegate, s as enqueuePendingDelegate } from "./delegate-store-BnKsJikL.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-DXgGSqoY.js";
import { a as getImageMetadata } from "./image-ops-CjmrAGwl.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-CzabR0Gx.js";
import { n as runWithImageModelFallback } from "./model-fallback-CknAicbZ.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-CCGGrDEa.js";
import { o as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-BZUQ_E37.js";
import { n as resolveMessageSecretScope, t as CHANNEL_MESSAGE_ACTION_NAMES } from "./message-action-names-QXmR4GOd.js";
import { u as parseReplyDirectives } from "./payloads-CGZJpmQV.js";
import { t as isWindowsDrivePath } from "./archive-path-x7DOeeCi.js";
import { o as trySafeFileURLToPath, r as hasEncodedFileUrlSeparator } from "./local-file-access-DTMBM8Rh.js";
import { n as assertSandboxPath } from "./sandbox-paths-BpajpJAG.js";
import { d as toRelativeWorkspacePath, n as normalizeWorkspaceDir, r as resolveWorkspaceRoot } from "./read-capability-BgE7n8NS.js";
import { t as SsrFBlockedError } from "./ssrf-8eMK8Dvc.js";
import { n as resolveConfiguredMediaMaxBytes } from "./configured-max-bytes-DdAY77sG.js";
import { i as imageMimeFromFormat, t as detectMime } from "./mime-i5lfz-pp.js";
import { g as writeFileWithinRoot, r as appendFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-BR8l9k2p.js";
import { l as saveMediaBuffer } from "./store-B7x3wVnO.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-BSRbIzTp.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-CCxOKrs9.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-MFM1h2lC.js";
import { a as classifyMediaReferenceSource, o as normalizeMediaReferenceSource, r as getDefaultLocalRoots } from "./local-media-access-CfwnD9DI.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-XC7rwxP5.js";
import { n as resolveMaxDelegatesPerTurn } from "./continuation-runtime-CtkVRoaB.js";
import { r as resolvePluginTools } from "./tools-5oczbLtB.js";
import { w as textToSpeech } from "./tts-nCfMFeY2.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-b9yAoI82.js";
import { a as listChannelSupportedActions, r as listAllChannelSupportedActions } from "./channel-tools-BEdGZZns.js";
import { t as extractAssistantText } from "./pi-embedded-utils-CATAbDkw.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-CDi34luh.js";
import { b as readSnakeCaseParamRaw, f as readNumberParam, g as readStringParam$1, i as asToolParamsRecord, l as jsonResult, m as readStringArrayParam, r as ToolInputError, s as imageResult } from "./common-B4GKOdcO.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-BSeL5XhD.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata } from "./runtime-C4vkhKvV.js";
import { t as sniffMimeFromBase64 } from "./sniff-mime-from-base64-zO_IxzpB.js";
import { a as parseCanvasSnapshotPayload, c as parseCameraSnapPayload, d as writeCameraPayloadToFile, i as canvasSnapshotTempPath, l as writeBase64ToFile, n as screenRecordTempPath, o as cameraTempPath, r as writeScreenRecordToFile, s as parseCameraClipPayload, t as parseScreenRecordPayload, u as writeCameraClipPayloadToFile } from "./nodes-screen-DKlE_t9E.js";
...
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-mYti4IO1.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-BRHwCzgQ.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-UZ3BW892.js";
import { t as inferLegacyName } from "./normalize-DastmiYB.js";
import { n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-DiOci2D9.js";
import { d as writeRestartSentinel, n as buildRestartSuccessContinuation, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile } from "./restart-sentinel-CJmHj7Jw.js";
import { o as scheduleGatewaySigusr1Restart } from "./restart-Wajcfj3K.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-sxIDnCGb.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-_6-uFcUc.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-pKgQCfGj.js";
import { a as coerceImageModelConfig, c as resolveProviderVisionModelFromConfig, d as hasAuthForProvider, f as hasToolModelConfig, l as buildToolModelConfigFromCandidates, n as isMinimaxVlmProvider, o as decodeDataUrl, p as resolveDefaultModelRef, u as coerceToolModelConfig } from "./minimax-vlm-gLojrS3f.js";
import { n as ensureOpenClawModelsJson } from "./models-config-CE7EGiDg.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-BbIe5g41.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-xK89ubws.js";
import { b as resolveAutoMediaKeyProviders, w as getMediaUnderstandingProvider, x as resolveDefaultMediaModel, y as providerSupportsNativePdfDocument } from "./resolve-CM1W7Xsj.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-Din6EH5G.js";
import { r as loadModelCatalog } from "./model-catalog-BjzZ5DNU.js";
import { t as buildProviderRegistry } from "./runner-C2o5qph9.js";
import "./media-understanding-BH80K4kr.js";
import { a as POLL_CREATION_PARAM_DEFS, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-BRf_L4-R.js";
import { t as sendMessage } from "./message-B4xH63Kz.js";
import { i as resolveMusicGenerationModeCapabilities, n as listRuntimeMusicGenerationProviders, r as listSupportedMusicGenerationModes, t as generateMusic } from "./runtime-C3TKu9pj.js";
import { r as parseMusicGenerationModelRef } from "./provider-registry-BlIm5I7C.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-B0apzKML.js";
...
import { a as recordTaskRunProgressByRunId, i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-mrp6EQ7I.js";
import "./task-registry-delivery-runtime-BMRRcX0h.js";
import { t as formatAgentInternalEventsForPrompt } from "./internal-events-BGn939jq.js";
import { i as loadSessionEntryByKey, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-BH0EnnFT.js";
import { t as parseTimeoutMs } from "./parse-timeout-BzW2Wiix.js";
import { t as extractPdfContent } from "./pdf-extract-LMuBUtNk.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-Cb1Aup79.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-BRh1En0U.js";
import { n as isRequesterParentOfBackgroundAcpSession } from "./session-interaction-mode-Dq9UF658.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, n as readLatestAssistantReply, r as readLatestAssistantReplySnapshot } from "./run-wait-Cnj_M8CW.js";
import { f as runAgentStep, g as isReplySkip, h as isAnnounceSkip, m as REPLY_SKIP_TOKEN, p as ANNOUNCE_SKIP_TOKEN } from "./subagent-announce-output-mp_1UIg1.js";
import { p as registerSubagentRun } from "./subagent-registry-DGt9OETw.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-ByI6yE1T.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-BPwUhl7N.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, n as listRuntimeVideoGenerationProviders, r as listSupportedVideoGenerationModes, t as generateVideo } from "./runtime-DXHQqizM.js";
import { r as parseVideoGenerationModelRef } from "./provider-registry-CVWPxiHp.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-C0cs5IcE.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-IXW59l1K.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-5KBQ-tqG.js";
import { a as readResponseText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds } from "./web-shared-D73IvgUC.js";
import { a as runWebSearch, i as resolveWebSearchDefinition } from "./runtime-CUERrZ4p.js";
import "./web-search-provider-common-CHbcBe3G.js";
...
async function getRuntime() {
	if (!runtimeMod) runtimeMod = await import("./embedded-gateway-stub.runtime-BqITiDjf.js");
	return runtimeMod;
}
...
function loadCommandsStatusRuntime() {
	commandsStatusRuntimePromise ??= import("./session-status.runtime-BIjPkjCi.js");
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-XQrl2gCH.js");
...
async function loadAcpSpawnModule() {
	acpSpawnModulePromise ??= import("./acp-spawn-Dk4f7P2t.js");
...
async function loadWebFetchRuntime() {
	webFetchRuntimePromise ??= import("./runtime-Cw2mWlL_.js");
	return await webFetchRuntimePromise;
}
async function loadWebGuardedFetch() {
	webGuardedFetchPromise ??= import("./web-guarded-fetch-XblXzQtj.js");
