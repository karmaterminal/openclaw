import { n as resolveManifestProviderAuthChoice } from "./provider-auth-choices-Cdgt8njK.js";
import { r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-BwVBQeMH.js";
...
async function resolvePreferredProviderForAuthChoice(params) {
	...
	const { resolveProviderPluginChoice, resolvePluginProviders } = await import("./provider-auth-choice.runtime-BfsQkRPp.js");
