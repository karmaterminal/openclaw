...
import { Z as normalizeGoogleApiBaseUrl } from "./io-BAiFlY00.js";
...
import { F as resolveProviderSystemPromptContribution, I as resolveProviderTextTransforms, q as transformProviderSystemPrompt } from "./provider-runtime-BVaRkoOn.js";
...
import { l as setActiveEmbeddedRun, n as clearActiveEmbeddedRun, u as updateActiveEmbeddedRunSnapshot } from "./runs-C4UxZOv1.js";
...
import { i as resolveSubagentCapabilityStore, t as isSubagentEnvelopeSession } from "./subagent-capabilities-D0iLDveh.js";
...
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, o as startsWithSilentToken, r as isSilentReplyPayloadText } from "./tokens-DXgGSqoY.js";
...
import { a as formatAssistantErrorText, l as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-C0ssrY7m.js";
import { o as hasUnredactedSessionsSpawnAttachments, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-COB2lSpo.js";
import { n as estimateBase64DecodedBytes } from "./base64-CdC51wYd.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-CzabR0Gx.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-_j2fgAcF.js";
import { a as prependBootstrapPromptWarning, i as buildBootstrapTruncationReportMeta, n as buildBootstrapInjectionStats, r as buildBootstrapPromptWarning, t as analyzeBootstrapBudget } from "./bootstrap-budget-B7lV1URg.js";
import { a as isTimeoutError } from "./failover-error-CHWaro0P.js";
import { a as buildTextObservationFields, i as buildApiErrorObservationFields } from "./model-fallback-CknAicbZ.js";
import { b as stripProviderPrefix, g as isEmbeddedMode, y as isStrictAgenticSupportedProviderModel } from "./openclaw-tools-BjxfVLY4.js";
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-Tb6vPQBF.js";
import { t as log$3 } from "./logger-5f-IgypH.js";
import { $ as shouldAllowProviderOwnedThinkingReplay, B as installContextEngineLoopHook, C as limitHistoryTurns, F as estimateToolResultReductionPotential, G as releaseWsSession, H as repairSessionFileIfNeeded, I as resolveLiveToolResultMaxChars, J as resolveChannelCapabilities, K as buildStreamErrorAssistantMessage, M as isCacheTtlEligibleProvider, N as readLastCacheTtlTimestamp, P as guardSessionManager, Q as resolveTranscriptPolicy, S as getDmHistoryLimitFromSessionKey, U as createPreparedEmbeddedPiSettingsManager, V as installToolResultContextGuard, W as createBundleLspToolRuntime, X as estimateMessagesTokens, Y as SAFETY_MARGIN, Z as isReasoningTagProvider, _ as trackSessionManagerAccess, a as collectAllowedToolNames, b as validateReplayTurns, c as applySystemPromptOverrideToSession, d as describeEmbeddedAgentStreamStrategy, et as assessLastAssistantMessage, f as resolveEmbeddedAgentApiKey, g as prewarmSessionFile, h as resolveEmbeddedRunSkillEntries, i as PI_RESERVED_TOOL_NAMES, j as resolveCompactionTimeoutMs, k as applyFinalEffectiveToolPolicy, l as buildEmbeddedSystemPrompt, m as resolveEmbeddedAgentStreamFn, n as mapThinkingLevel, o as collectRegisteredToolNames, p as resolveEmbeddedAgentBaseStreamFn, r as splitSdkTools, s as toSessionToolAllowlist, t as flushPendingToolResultsAfterIdle, tt as dropThinkingBlocks, u as createSystemPromptOverride, v as normalizeAssistantReplayContent, w as buildEmbeddedExtensionFactories, x as buildEmbeddedMessageActionDiscoveryInput, y as sanitizeSessionHistory, z as truncateOversizedToolResultsInSessionManager } from "./wait-for-idle-before-flush-8iXyw6Ad.js";
import { n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-BlukwC0u.js";
import { i as streamWithPayloadPatch } from "./moonshot-thinking-stream-wrappers-B0dhsLPW.js";
import { i as createHtmlEntityToolCallArgumentDecodingWrapper, w as visitObjectContentBlocks } from "./provider-stream-shared-QNOZre-8.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-C5bEZt9I.js";
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-D1kThBp3.js";
import { a as normalizeProviderToolSchemas, i as logProviderToolSchemaDiagnostics, r as supportsModelTools } from "./tool-result-middleware-BZOBZBUt.js";
import { n as resolveEmbeddedAgentHarnessFallback, r as resolveEmbeddedAgentRuntime, t as normalizeEmbeddedAgentRuntime } from "./runtime-DHTCGWHs.js";
import { n as setReplyPayloadMetadata } from "./reply-payload-C8ZluYKU.js";
import { r as parseFenceSpans } from "./fences-BUmB_Lz2.js";
import { r as splitMediaFromOutput } from "./parse-DI49duQO.js";
import { u as parseReplyDirectives } from "./payloads-CGZJpmQV.js";
import { a as resolveEffectiveToolPolicy, c as resolveSubagentToolPolicyForSession, s as resolveGroupToolPolicy } from "./read-capability-BgE7n8NS.js";
import { o as resolveSandboxContext } from "./sandbox-BuXCd85V.js";
import { f as MAX_IMAGE_BYTES } from "./mime-i5lfz-pp.js";
import { i as ensureGlobalUndiciStreamTimeouts, r as ensureGlobalUndiciEnvProxyDispatcher, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-D8hGe3AM.js";
import { c as sanitizeTransportPayloadText, m as sanitizeToolUseResultPairing, o as mergeTransportHeaders, u as buildGuardedModelFetch } from "./transport-stream-shared-DHRVDBOp.js";
import { t as detectRuntimeShell } from "./shell-utils-DkNauUYg.js";
import { t as parseBooleanValue } from "./boolean-wZWe-bGu.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-CFyB-3Fg.js";
import { s as resolveSkillsPromptForRun } from "./workspace-Dj_e-cAT.js";
import "./skills-CN68vLCM.js";
import { t as filterHeartbeatPairs } from "./heartbeat-filter-DFHGVLVy.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-C5hALghw.js";
import { t as getMachineDisplayName } from "./machine-name-Ix10ScUP.js";
import { n as getPluginToolMeta } from "./tools-5oczbLtB.js";
import { t as redactConfigObject } from "./redact-snapshot-pNa7H3Sa.js";
import { n as resolveCommitHash } from "./git-commit-CTL8tmSE.js";
import { t as resolveOsSummary } from "./os-summary-BEJl6yhe.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-B_njP25O.js";
import { n as buildTtsSystemPromptHint } from "./tts-nCfMFeY2.js";
import { a as resolveContextInjectionMode, i as resolveBootstrapContextForRun, n as hasCompletedBootstrapTurn, r as makeBootstrapWarn, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-C2U-aeST.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-Bd3HWHx4.js";
import { a as listChannelSupportedActions, c as resolveChannelReactionGuidance, o as resolveChannelMessageToolCapabilities, s as resolveChannelMessageToolHints } from "./channel-tools-BEdGZZns.js";
import { t as resolveOpenClawDocsPath } from "./docs-path-FPFmtFFZ.js";
import { t as buildModelAliasLines } from "./model-alias-lines-1w5ZuhYy.js";
import { t as registerProviderStreamForModel } from "./provider-stream-0KcK4gZo.js";
import { i as getOrCreateSessionMcpRuntime } from "./pi-bundle-mcp-runtime-o85lhn9f.js";
import { n as materializeBundleMcpToolsForRun } from "./pi-bundle-mcp-tools-RhsiRr77.js";
import { _ as sanitizeToolResult, b as formatToolAggregate, d as extractToolErrorMessage, f as extractToolResultMediaArtifact, g as isToolResultTimedOut, h as isToolResultError, l as runContextEngineMaintenance, m as filterToolResultMediaUrls, n as assembleHarnessContextEngine, o as finalizeHarnessContextEngineTurn, p as extractToolResultText, r as bootstrapHarnessContextEngine, t as buildEmbeddedAttemptToolRunContext, u as extractMessagingToolSend, v as isMessagingTool, y as isMessagingToolSendAction } from "./attempt.tool-run-context-DZzM33x3.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-Bd_76oj5.js";
...
import { s as normalizeCompactionTrigger } from "./request-compaction-tool-CDi34luh.js";
import { a as MIN_PROMPT_BUDGET_TOKENS, i as MIN_PROMPT_BUDGET_RATIO, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-JxRkapBj.js";
import { o as diagnosticErrorCategory } from "./pi-tools.before-tool-call-DMQQkXto.js";
import { i as toClientToolDefinitions, n as findClientToolNameConflicts, t as createClientToolNameConflictError } from "./pi-tool-definition-adapter-CDtqGv1f.js";
import { n as resolveToolLoopDetectionConfig, t as createOpenClawCodingTools } from "./pi-tools-B-mlPPa_.js";
import { t as resolveAgentTimeoutMs } from "./timeout-CN1Egm-P.js";
import { n as rewriteTranscriptEntriesInSessionManager } from "./transcript-rewrite-wLBf58sg.js";
import { t as resolveSystemPromptOverride } from "./system-prompt-override-DehFyFd7.js";
import { t as buildSystemPromptParams } from "./system-prompt-params-CoLQzh87.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-DJ07xb3c.js";
import "./tool-loop-detection-q3gq5z2n.js";
import { n as buildAgentUserPromptPrefix } from "./system-prompt-Ca0kOCQR.js";
import { t as parseGeminiAuth } from "./gemini-auth-6y_qnP6f.js";
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-B7EJu-Qx.js";
import { a as shouldUseOpenAIWebSocketTransport, i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-BiNnoJQr.js";
...
import { n as extractBalancedJsonPrefix } from "./balanced-json-wg2bcAKL.js";
import { t as detectAndLoadPromptImages } from "./images-D-k0R-ZJ.js";
...
async function reconcileSessionStoreCompactionCountAfterSuccess(params) {
	const { reconcileSessionStoreCompactionCountAfterSuccess: reconcile } = await import("./pi-embedded-subscribe.handlers.compaction.runtime-DLYg2ln-.js");
...
function loadExecApprovalReply() {
	execApprovalReplyModulePromise ??= import("./exec-approval-reply-CAA259Hp.js");
...
function loadMediaParse() {
	mediaParseModulePromise ??= import("./parse-BFe3lBJ_.js");
	return mediaParseModulePromise;
}
function loadBeforeToolCall() {
	beforeToolCallModulePromise ??= import("./pi-tools.before-tool-call-C4b0HFvT.js");
