...
import { _ as resolveStateDir, o as resolveConfigPath } from "./paths-CrDgDBYA.js";
import { o as hasConfiguredSecretInput } from "./types.secrets-D9j6Z-gp.js";
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-cv0edRTW.js";
import { n as resolveGatewayAuth } from "./auth-resolve-BHz5g_Dw.js";
import { n as asNullableRecord } from "./record-coerce-DG6wlQcy.js";
import { t as DEFAULT_AGENT_ID } from "./session-key-Ba6CwwIP.js";
import { i as normalizeTrustedSafeBinDirs, o as listRiskyConfiguredSafeBins } from "./exec-safe-bin-trust-BzPl2Qtb.js";
...
import { u as isInterpreterLikeAllowlistPattern } from "./exec-approvals-allowlist-BqUmf3Bi.js";
import { l as loadExecApprovals } from "./exec-approvals-CGvrumYQ.js";
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-jV5XiXMj.js";
import { n as collectCoreInsecureOrDangerousFlags, t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-sxIDnCGb.js";
import { t as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-BUiZWXi5.js";
import path from "node:path";
import { isIP } from "node:net";
//#region src/security/audit-deep-code-safety.ts
let auditDeepModulePromise;
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-B9HWCULn.js");
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-5bqH5zhH.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-CsrjKc5l.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-B8UN1Xk8.js");
