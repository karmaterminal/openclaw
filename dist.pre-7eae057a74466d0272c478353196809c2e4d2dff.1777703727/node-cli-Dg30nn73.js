...
import { i as runServiceUninstall, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-BH_7fEgS.js";
...
import { _ as resolvePlannedSegmentArgv, c as describeInterpreterInlineEval, d as analyzeArgvCommand, l as detectInterpreterInlineEvalArgv, n as evaluateShellAllowlist, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-BqUmf3Bi.js";
import { C as requiresExecApproval, E as resolveExecApprovals, M as requestJsonlSocket, a as addDurableCommandApproval, b as recordAllowlistMatchesUse, d as mergeExecApprovalsSocketDefaults, j as saveExecApprovals, o as ensureExecApprovals, p as normalizeExecApprovals, s as hasDurableExecApproval, v as persistAllowAlwaysPatterns, y as readExecApprovalsSnapshot } from "./exec-approvals-CGvrumYQ.js";
import { t as getMachineDisplayName } from "./machine-name-Ix10ScUP.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-jV5XiXMj.js";
import { t as resolveGatewayConnectionAuth } from "./connection-auth-IRoJHSgJ.js";
import { t as formatHelpExamples } from "./help-format-CEZin8dE.js";
import { n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-BT8tvSw8.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-DtTseL_y.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-D40sTwMj.js";
import { t as resolveNodeService } from "./node-service-BonzTj9Z.js";
...
async function loadSystemRunConfig(opts) {
	...
	const { loadConfig } = await import("./config-B_igeLZT.js");
	return loadConfig();
}
...
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-DXZ5dNuO.js");
