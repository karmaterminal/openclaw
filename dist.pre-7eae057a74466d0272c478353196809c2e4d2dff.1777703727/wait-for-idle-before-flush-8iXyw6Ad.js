...
import { a as isSilentReplyText } from "./tokens-DXgGSqoY.js";
import { c as downgradeOpenAIFunctionCallReasoningPairs, g as sanitizeGoogleTurnOrdering, l as downgradeOpenAIReasoningBlocks, n as validateGeminiTurns, s as sanitizeSessionMessagesImages, t as validateAnthropicTurns, u as isGoogleModelApi } from "./pi-embedded-helpers-BnioB261.js";
import { n as extractToolResultId, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-COB2lSpo.js";
...
import { o as isGooglePromptCacheEligible } from "./extra-params-BlukwC0u.js";
import { c as resolveProviderRequestPolicyConfig, i as getModelProviderRequestTransport, r as buildProviderRequestTlsClientOptions } from "./provider-request-config-D4c_bkEq.js";
import { S as isAnthropicModelRef, x as isAnthropicFamilyCacheTtlEligible } from "./provider-stream-shared-QNOZre-8.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-C5bEZt9I.js";
import { n as buildCopilotIdeHeaders, r as hasCopilotVisionInput, t as buildCopilotDynamicHeaders } from "./copilot-dynamic-headers-C_YDKOlL.js";
import { _ as resolveOpenAITextVerbosity } from "./proxy-stream-wrappers-fYTp5u-I.js";
import { r as normalizeOpenAIReasoningEffort } from "./openai-responses-payload-policy-CCH3UqRa.js";
import { y as shouldPreserveThinkingBlocks } from "./provider-model-shared-Y7Lo2Cbo.js";
import { n as collectTextContentBlocks, t as createAgentToolResultMiddlewareRunner } from "./tool-result-middleware-BZOBZBUt.js";
import { s as stripHeartbeatToken } from "./heartbeat-DI1BMPex.js";
import { a as resolveEffectiveToolPolicy, c as resolveSubagentToolPolicyForSession, o as resolveGroupContextFromSessionKey, s as resolveGroupToolPolicy } from "./read-capability-BgE7n8NS.js";
import { d as resolveDebugProxySettings, n as captureWsEvent, u as createDebugProxyWebSocketAgent } from "./runtime-CJL7wS_R.js";
import { n as retryAsync } from "./retry-BLYeyYK_.js";
import { d as makeMissingToolResult, f as repairToolUseResultPairing, h as stripToolResultDetails, m as sanitizeToolUseResultPairing, p as sanitizeToolCallInputs, s as mergeTransportMetadata } from "./transport-stream-shared-DHRVDBOp.js";
import { t as extractSections } from "./post-compaction-context-DFqc1QwL.js";
import { i as resolveSkillRuntimeConfig } from "./env-overrides-CFyB-3Fg.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-Dj_e-cAT.js";
import "./skills-CN68vLCM.js";
import { o as resolveContextWindowInfo } from "./context-window-guard-CZxwuuX0.js";
import { i as setPluginToolMeta, n as getPluginToolMeta } from "./tools-5oczbLtB.js";
import { c as mapOpenAIReasoningEffortForModel, i as createBoundaryAwareStreamFnForModel, l as resolveOpenAIStrictToolSetting, o as normalizeOpenAIStrictToolParameters, s as resolveOpenAIStrictToolFlagForInventory } from "./provider-stream-0KcK4gZo.js";
import { n as loadEnabledBundleLspConfig } from "./bundle-lsp-DfQKCc8i.js";
import { c as loadEmbeddedPiMcpConfig, d as describeStdioMcpServerLaunchConfig, f as resolveStdioMcpServerLaunchConfig } from "./pi-bundle-mcp-runtime-o85lhn9f.js";
import { r as applyPiCompactionSettingsFromConfig } from "./pi-settings-JxRkapBj.js";
import { a as toToolDefinitions } from "./pi-tool-definition-adapter-CDtqGv1f.js";
import { n as buildDefaultToolPolicyPipelineSteps, t as applyToolPolicyPipeline } from "./tool-policy-pipeline-CoEoZ6Uo.js";
import { i as setRawSessionAppendMessage, n as rewriteTranscriptEntriesInSessionManager, r as getRawSessionAppendMessage } from "./transcript-rewrite-wLBf58sg.js";
import { t as withTimeout } from "./with-timeout-Du-ozjxn.js";
import { n as isQueryStopWordToken, t as extractKeywords } from "./query-expansion-DQJkZeew.js";
import "./query-Ca19mTrv.js";
import { o as wrapUntrustedPromptDataBlock, t as buildAgentSystemPrompt } from "./system-prompt-Ca0kOCQR.js";
import { t as estimateStringChars } from "./cjk-chars-Ca6yrxci.js";
import { t as createAnthropicVertexStreamFnForModel } from "./anthropic-vertex-stream-ChE5gMyK.js";
