...
import { l as readBestEffortConfig } from "./io-BAiFlY00.js";
import "./config-DWasLg9V.js";
import { a as probeGateway } from "./probe-CttofCy2.js";
import { t as inspectBestEffortPrimaryTailnetIPv4 } from "./network-discovery-display-CL046LCQ.js";
import { n as parseTimeoutMsWithFallback } from "./parse-timeout-BzW2Wiix.js";
import { n as withProgress } from "./progress-sMfglU5X.js";
import { i as resolveWideAreaDiscoveryDomain } from "./widearea-dns-CzkUh5Va.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-Diji1XS_.js";
import { n as buildGatewayDiscoveryTarget, r as serializeGatewayDiscoveryBeacon } from "./gateway-discovery-targets-CMNCsn-u.js";
import { n as resolveGatewayProbeSurfaceAuth } from "./auth-surface-resolution-DPkk4eG0.js";
...
function loadSshConfigModule() {
	sshConfigModulePromise ??= import("./ssh-config-BI6s-2Jq.js");
	return sshConfigModulePromise;
}
function loadSshTunnelModule() {
	sshTunnelModulePromise ??= import("./ssh-tunnel-Bv943uXb.js");
	return sshTunnelModulePromise;
}
function loadGatewayTlsModule() {
	gatewayTlsModulePromise ??= import("./gateway-D49GN7NF.js");
