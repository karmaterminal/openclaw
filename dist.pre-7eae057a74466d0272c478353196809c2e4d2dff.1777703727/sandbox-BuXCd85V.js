...
import { a as DEFAULT_IDENTITY_FILENAME, c as DEFAULT_TOOLS_FILENAME, i as DEFAULT_HEARTBEAT_FILENAME, l as DEFAULT_USER_FILENAME, n as DEFAULT_AGENT_WORKSPACE_DIR, r as DEFAULT_BOOTSTRAP_FILENAME, s as DEFAULT_SOUL_FILENAME, t as DEFAULT_AGENTS_FILENAME, u as ensureAgentWorkspace } from "./workspace-CeVfBCfB.js";
import "./config-DWasLg9V.js";
import { _ as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, h as SANDBOX_AGENT_WORKSPACE_MOUNT } from "./constants-CdlreaDe.js";
import { n as isToolAllowed } from "./tool-policy-lQ_tqspW.js";
import { i as resolveSandboxConfigForAgent, r as resolveSandboxBrowserDockerCreateConfig } from "./config-CaHJZCeZ.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-DxJf4_rV.js";
import { a as resolveSandboxPath, i as resolveSandboxInputPath } from "./sandbox-paths-BpajpJAG.js";
import { n as resolveBrowserControlAuth, t as ensureBrowserControlAuth } from "./browser-control-auth-BsBQiRRw.js";
import { a as DEFAULT_OPENCLAW_BROWSER_COLOR, l as resolveBrowserConfig, n as DEFAULT_BROWSER_ACTION_TIMEOUT_MS, s as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as resolveProfile } from "./browser-profiles-Dsm6q5b4.js";
import { C as removeRegistryEntry, E as computeSandboxBrowserConfigHash, S as removeBrowserRegistryEntry, T as updateRegistry, _ as resolveSandboxScopeKey, b as readBrowserRegistry, c as readDockerNetworkDriver, d as appendWorkspaceMountArgs, g as resolveSandboxAgentId, h as splitSandboxBindSpec, i as execDocker, l as readDockerNetworkGateway, m as resolveSandboxHostPathViaExistingAncestor, n as dockerContainerState, o as readDockerContainerEnvVar, p as validateNetworkMode, s as readDockerContainerLabel, t as buildSandboxCreateArgs, u as readDockerPort, v as resolveSandboxWorkspaceDir, w as updateBrowserRegistry, x as readRegistry, y as slugifySessionKey } from "./docker-CLZT0WHZ.js";
import { C as buildPinnedAppendPlan, D as buildPinnedWritePlan, E as buildPinnedRenamePlan, O as dockerSandboxBackendManager, T as buildPinnedRemovePlan, a as getSandboxBackendManager, k as runDockerSandboxShellCommand, n as startBrowserBridgeServer, r as stopBrowserBridgeServer, s as requireSandboxBackendFactory, t as BROWSER_BRIDGES, v as isPathInsideContainerRoot, w as buildPinnedMkdirpPlan, y as normalizeContainerPath } from "./browser-bridges-BK3rt_Jb.js";
import { n as deriveDefaultBrowserCdpPortRange } from "./port-defaults-DIcrt6gQ.js";
import { f as isSameSsrFPolicy } from "./ssrf-8eMK8Dvc.js";
	...
	if (workspaceDir === sandboxWorkspaceDir) {
		...
		if (cfg.workspaceAccess !== "rw") try {
			const [{ getRemoteSkillEligibility }, { canExecRequestNode }, { syncSkillsToWorkspace }] = await Promise.all([
				import("./skills-remote-DpNcRDAm.js"),
				import("./exec-defaults-UDrfHrhQ.js"),
				import("./skills-BYFm9rPw.js")
			]);
...
async function resolveSandboxContext(params) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune-BJR8OxxH.js")).maybePruneSandboxes(cfg);
	...
	const bridgeAuth = cfg.browser.enabled ? await (async () => {
		const cfgForAuth = params.config ?? (await import("./config-B_igeLZT.js")).loadConfig();
