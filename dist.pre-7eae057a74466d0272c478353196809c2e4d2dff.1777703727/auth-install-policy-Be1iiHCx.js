...
import { t as collectDurableServiceEnvVars } from "./state-dir-dotenv-mYkoBPQn.js";
import { d as resolveGatewayLaunchAgentLabel } from "./paths-DisUnE6t.js";
import { i as resolveGatewayProgramArguments, n as resolveDaemonInstallRuntimeInputs, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-B3qbeyMA.js";
import { c as buildServiceEnvironment } from "./runtime-paths-8bsdxNRe.js";
...
function loadDaemonInstallAuthProfileSourceRuntime() {
	daemonInstallAuthProfileSourceRuntimePromise ??= import("./daemon-install-auth-profiles-source.runtime-Dboze_Oy.js");
	return daemonInstallAuthProfileSourceRuntimePromise;
}
function loadDaemonInstallAuthProfileStoreRuntime() {
	daemonInstallAuthProfileStoreRuntimePromise ??= import("./daemon-install-auth-profiles-store.runtime-CmJY83iQ.js");
