...
import { h as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-BAiFlY00.js";
import { n as formatConfigIssueLines } from "./issue-format-CqQPqGQv.js";
import { t as note } from "./note-DNReek-A.js";
import { n as noteIncludeConfinementWarning } from "./doctor-config-analysis-CFPnqyx-.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-BayMzjBk.js");
