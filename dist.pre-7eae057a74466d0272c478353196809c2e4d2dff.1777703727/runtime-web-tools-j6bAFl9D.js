...
import { p as resolveSecretInputRef } from "./types.secrets-D9j6Z-gp.js";
import { t as createGatewayCredentialPlan } from "./credential-planner-BIsqqWx9.js";
import { u as secretRefKey } from "./ref-contract-CmDf3_tu.js";
import "./shared-CPpYZu82.js";
import { o as resolveSecretRefValues } from "./resolve-B9Fdm-AL.js";
import { n as getBootstrapChannelSecrets } from "./bootstrap-registry-p4IyWLsV.js";
import { l as resolveEnableState, o as normalizePluginsConfig } from "./config-state-Xobk7mRp.js";
import { b as resolveAgentWorkspaceDir, x as resolveDefaultAgentId } from "./agent-scope-BrwtzVtf.js";
import { t as loadBundledChannelSecretContractApi } from "./channel-contract-api-CTZaMaO2.js";
import { n as resolvePluginConfigContractsById, t as collectPluginConfigContractMatches } from "./config-contracts-_CXp3oVr.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-Dn4C6ofG.js";
import { i as normalizeMediaProviderId, n as resolveConfiguredMediaEntryCapabilities, r as resolveEffectiveMediaEntryCapabilities, t as resolveImageCapableConfigProviderIds } from "./config-provider-models-BJLwOZBZ.js";
import { n as resolvePluginCapabilityProviders } from "./capability-provider-runtime-DYJJZ_Ux.js";
import { c as pushInactiveSurfaceWarning, l as pushWarning, n as collectSecretInputAssignment } from "./runtime-shared-DLiSJSwx.js";
import { t as collectTtsApiKeyAssignments } from "./runtime-config-collectors-tts-P-_xSICA.js";
import { o as sortWebFetchProvidersForAutoDetect, r as sortWebSearchProvidersForAutoDetect } from "./web-search-providers.shared-U_cVmXQ3.js";
import { i as resolveBundledExplicitWebSearchProvidersFromPublicArtifacts, r as resolveBundledExplicitWebFetchProvidersFromPublicArtifacts } from "./web-provider-public-artifacts.explicit-VhYYNWqa.js";
import { a as createLazyRuntimeSurface, i as createLazyRuntimeNamedExport } from "./lazy-runtime-BZto2g8w.js";
...
const loadResolveManifestContractOwnerPluginId = createLazyRuntimeNamedExport(() => import("./runtime-web-tools-manifest.runtime-B8PYTlQj.js"), "resolveManifestContractOwnerPluginId");
...
const loadRuntimeWebToolsFallbackProviders = createLazyRuntimeSurface(() => import("./runtime-web-tools-fallback.runtime-f539670M.js"), ({ runtimeWebToolsFallbackProviders }) => runtimeWebToolsFallbackProviders);
const loadRuntimeWebToolsPublicArtifacts = createLazyRuntimeSurface(() => import("./runtime-web-tools-public-artifacts.runtime-SrIK39sJ.js"), (mod) => mod);
const loadRuntimeWebToolsManifest = createLazyRuntimeSurface(() => import("./runtime-web-tools-manifest.runtime-B8PYTlQj.js"), (mod) => mod);
