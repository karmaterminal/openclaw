...
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "./webhook-request-guards-BCuEm3up.js";
import "./webhook-ingress-Bk8ReztY.js";
import { g as resolveRealtimeVoiceAgentConsultToolsAllow, h as resolveRealtimeVoiceAgentConsultTools, s as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME } from "./provider-resolver-CnP3dLEJ.js";
import { s as consultRealtimeVoiceAgent, t as convertPcmToMulaw8k } from "./realtime-voice-B3EZsSeo.js";
import { t as resolveConfiguredCapabilityProvider } from "./provider-selection-runtime-DMYI6-eT.js";
import { t as zod_exports } from "./zod-BbFbbh_R.js";
import "./api-C58W4Di6.js";
import { a as deepMergeDefined, i as validateProviderConfig, n as normalizeVoiceCallConfig, r as resolveVoiceCallConfig } from "./config-BeN2uTPt.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-MsYO0tmQ.js";
import { t as resolveVoiceResponseModel } from "./response-model-BnXsjveN.js";
import { t as isProviderStatusTerminal } from "./call-status-DLmbkR0z.js";
import { t as getHeader } from "./http-headers-CCvttUVt.js";
...
function loadRealtimeTranscriptionRuntime() {
	realtimeTranscriptionRuntimePromise ??= import("./realtime-transcription.runtime-CBzezIrp.js");
	return realtimeTranscriptionRuntimePromise;
}
function loadResponseGeneratorModule() {
	responseGeneratorModulePromise ??= import("./response-generator-DETIbfZH.js");
...
function loadTelnyxProvider() {
	telnyxProviderPromise ??= import("./telnyx-DoezgPiT.js");
	return telnyxProviderPromise;
}
function loadTwilioProvider() {
	twilioProviderPromise ??= import("./twilio-D7bLSzXi.js");
	return twilioProviderPromise;
}
function loadPlivoProvider() {
	plivoProviderPromise ??= import("./plivo-DPfiFZGl.js");
	return plivoProviderPromise;
}
function loadMockProvider() {
	mockProviderPromise ??= import("./mock-i3MW9hzn.js");
	return mockProviderPromise;
}
function loadRealtimeVoiceRuntime() {
	realtimeVoiceRuntimePromise ??= import("./realtime-voice.runtime-D-M7raGs.js");
	return realtimeVoiceRuntimePromise;
}
function loadRealtimeHandler() {
	realtimeHandlerPromise ??= import("./realtime-handler-XqB7aRnA.js");
