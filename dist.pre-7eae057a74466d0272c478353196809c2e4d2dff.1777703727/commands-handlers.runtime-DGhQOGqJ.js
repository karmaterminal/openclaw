...
import { F as unsetConfigOverride, M as getConfigOverrides, N as resetConfigOverrides, P as setConfigOverride, T as validateConfigObjectWithPlugins, u as readConfigFileSnapshot, y as writeConfigFile } from "./io-BAiFlY00.js";
...
import { x as prepareProviderRuntimeAuth } from "./provider-runtime-BVaRkoOn.js";
...
import { h as replyRunRegistry, i as getActiveEmbeddedRunSnapshot } from "./runs-C4UxZOv1.js";
import "./diagnostic-BTg369xh.js";
...
import { i as formatUsd, r as formatTokenCount } from "./usage-format-BI0sSL8Q.js";
...
import { h as resolveBootstrapTotalMaxChars, p as resolveBootstrapMaxChars } from "./pi-embedded-helpers-BnioB261.js";
import { i as resolveImageSanitizationLimits, n as sanitizeImageBlocks } from "./tool-images-CzabR0Gx.js";
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-B7lV1URg.js";
import { d as resolveTrajectoryPointerFilePath, f as safeTrajectorySessionFileName, l as TRAJECTORY_RUNTIME_FILE_MAX_BYTES, m as sanitizeDiagnosticPayload, p as safeJsonStringify, u as resolveTrajectoryFilePath } from "./selection-DssBNpKz.js";
import { i as streamWithPayloadPatch } from "./moonshot-thinking-stream-wrappers-B0dhsLPW.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-DpUbTJuv.js";
...
import { h as stripToolResultDetails } from "./transport-stream-shared-DHRVDBOp.js";
import { _ as getFinishedSession, v as getSession } from "./bash-tools.exec-runtime-BfjPQXWe.js";
import { n as formatTimeAgo } from "./format-relative-LOLFOe8o.js";
import { n as redactSupportString } from "./diagnostic-support-redaction-B_njP25O.js";
import { S as setTtsProvider, _ as setLastTtsAttempt, a as getTtsMaxLength, b as setTtsEnabled, c as isTtsEnabled, h as resolveTtsPrefsPath, i as getResolvedSpeechProviderConfig, l as isTtsProviderConfigured, m as resolveTtsConfig, o as getTtsProvider, r as getLastTtsAttempt, s as isSummarizationEnabled, v as setSummarizationEnabled, w as textToSpeech, x as setTtsMaxLength } from "./tts-nCfMFeY2.js";
import { t as registerProviderStreamForModel } from "./provider-stream-0KcK4gZo.js";
import { i as unsetConfiguredMcpServer, r as setConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-Dy1ZdCAc.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-Bd_76oj5.js";
import { i as isCompactionSkipReason } from "./request-compaction-tool-CDi34luh.js";
...
import { l as triggerOpenClawRestart, o as scheduleGatewaySigusr1Restart } from "./restart-Wajcfj3K.js";
...
import { _ as authorizeConfigWriteShared, b as resolveConfigWriteTargetFromPathShared, v as canBypassConfigWritePolicyShared, y as formatConfigWriteDeniedMessageShared } from "./channel-config-helpers-B2n48QFs.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-B0apzKML.js";
...
import { n as estimateTokensFromChars } from "./cjk-chars-Ca6yrxci.js";
import { r as resolveModelWithRegistry } from "./model-CVPGcIht.js";
import { i as matchPluginCommand, n as executePluginCommand } from "./commands-BY6wwqF7.js";
import { t as isApprovalNotFoundError } from "./approval-errors-KxxGGi_E.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-BaFoFABI.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-BRUMFnQi.js";
import "./commands-registry-Zgc_jF4C.js";
import { o as stripMentions, s as stripStructuralPrefixes } from "./mentions-C-WI6eXv.js";
import { n as setChannelConversationBindingMaxAgeBySessionKey, t as setChannelConversationBindingIdleTimeoutBySessionKey } from "./conversation-bindings-kc1Q7TH9.js";
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-clcQq7Sw.js";
import { i as installPluginFromPath, r as installPluginFromNpmSpec } from "./install-D7dbwuft.js";
import { l as resolveArchiveKind } from "./archive-C6ZWLEzw.js";
import { n as isImplicitSameChatApprovalAuthorization } from "./approval-auth-helpers-D5pd3sL1.js";
import { n as parseActivationCommand } from "./group-activation-Cr139O9I.js";
import { t as resolveFastModeState } from "./fast-mode-CSonR406.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-BN0xMdg6.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-CmOm-AT8.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-C3_xLKdx.js";
import { a as shouldPersistAbortCutoff, i as resolveAbortCutoffFromContext, t as applyAbortCutoffToSessionEntry } from "./abort-cutoff-BsytF-LY.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-CHJTzD9j.js";
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-CbWjS4B9.js";
import { n as resolveSessionEntryForKey, r as stopSubagentsForRequester, t as formatAbortReplyText } from "./abort-tH8quaAo.js";
import { t as extractBtwQuestion } from "./btw-command-DvFdvniv.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-Bdlmc1Y4.js";
...
import { a as requireGatewayClientScopeForInternalChannel, i as requireCommandFlagEnabled, n as rejectNonOwnerCommand, r as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates--DMkJCYe.js";
import { t as handleAcpCommand } from "./commands-acp-B6DgrYTT.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-Bn8DtiXv.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-DKPVi0gd.js";
import { r as handleModelsCommand } from "./commands-models-IBDEAUy3.js";
import { n as setPluginEnabledInConfig } from "./enable-Sk0bPd49.js";
import { r as createExecTool } from "./bash-tools-Qf5zF-JW.js";
import { n as listTasksForAgentIdForStatus, r as listTasksForSessionKeyForStatus } from "./status-text-Du3UIVYM.js";
import { d as resolveChannelAccountId, f as resolveCommandSurfaceChannel, l as resolveSubagentsAction, o as resolveHandledPrefix, s as resolveRequesterSessionKey, u as stopWithText } from "./shared-BznLHYiv.js";
import { t as buildToolsMessage } from "./status-C6i0hARA.js";
import { t as parseConfigValue } from "./config-value-B1DA_PAw.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-C3zZbAaU.js";
import { a as writeSupportBundleDirectory, i as textSupportBundleFile, n as jsonlSupportBundleFile, r as supportBundleContents, t as jsonSupportBundleFile } from "./diagnostic-support-bundle-GIHOURVU.js";
import { t as buildStatusReply } from "./commands-status-MACPnYCv.js";
import { i as buildNpmInstallRecordFields, n as persistPluginInstall } from "./plugins-install-persist-D-KD_iQq.js";
import { m as parseClawHubPluginSpec } from "./clawhub-B_ef9S_r.js";
import { r as installPluginFromClawHub } from "./clawhub-DsrErK19.js";
import { a as buildPluginDiagnosticsReport, c as formatPluginCompatibilityNotice, o as buildPluginInspectReport, s as buildPluginSnapshotReport, t as buildAllPluginInspectReports } from "./status-BZAs2kb1.js";
import { a as decidePreferredClawHubFallback, i as createPluginInstallLogger, n as buildPreferredClawHubSpec, u as resolveFileNpmSpecToLocalPath } from "./plugins-command-helpers-Cs77JJos.js";
import { n as loadCostUsageSummary, r as loadSessionCostSummary } from "./session-cost-usage-BY0xDUex.js";
...
function loadCompactRuntime() {
	compactRuntimePromise ??= import("./commands-compact.runtime-DuXok768.js");
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-BQo06BET.js");
...
async function abortEmbeddedPiRunForSession(sessionId) {
	const { abortEmbeddedPiRun } = await import("./runs-DPZqJWp2.js");
...
function loadAgentsAction() {
	actionAgentsPromise ??= import("./action-agents-CmPjg3Xz.js");
	return actionAgentsPromise;
}
function loadFocusAction() {
	actionFocusPromise ??= import("./action-focus-DzwfHkXZ.js");
	return actionFocusPromise;
}
function loadHelpAction() {
	actionHelpPromise ??= import("./action-help-DOSKAudz.js");
	return actionHelpPromise;
}
function loadInfoAction() {
	actionInfoPromise ??= import("./action-info-BJiI_SqA.js");
	return actionInfoPromise;
}
function loadKillAction() {
	actionKillPromise ??= import("./action-kill-CpQW7hoz.js");
	return actionKillPromise;
}
function loadListAction() {
	actionListPromise ??= import("./action-list-BPoQ29iJ.js");
	return actionListPromise;
}
function loadLogAction() {
	actionLogPromise ??= import("./action-log-Bs36sipd.js");
	return actionLogPromise;
}
function loadSendAction() {
	actionSendPromise ??= import("./action-send-3xMI48Wv.js");
	return actionSendPromise;
}
function loadSpawnAction() {
	actionSpawnPromise ??= import("./action-spawn-Dy-8DBuP.js");
	return actionSpawnPromise;
}
function loadUnfocusAction() {
	actionUnfocusPromise ??= import("./action-unfocus-tNvET2Nz.js");
	return actionUnfocusPromise;
}
function loadControlRuntime() {
	controlRuntimePromise ??= import("./commands-subagents-control.runtime-ksfOHsEh.js");
