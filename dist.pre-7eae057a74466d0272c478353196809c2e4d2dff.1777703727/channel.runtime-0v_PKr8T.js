...
import { l as withResolvedWebhookRequestPipeline, n as registerWebhookTargetWithPluginRoute, s as resolveWebhookTargetWithAuthOrRejectSync } from "./webhook-targets-BWFPxkiw.js";
import "./webhook-ingress-Bk8ReztY.js";
import "./browser-security-runtime-CfxeKXH4.js";
import "./string-coerce-runtime-vnmjj1QZ.js";
import { P as resolveBlueBubblesEffectiveAllowPrivateNetwork, _ as normalizeWebhookReaction, g as normalizeWebhookMessage, o as probeBlueBubbles, t as fetchBlueBubblesServerInfo, u as asRecord } from "./probe-DQGJI4uO.js";
import { t as getBlueBubblesRuntime } from "./runtime-CuJjWB-V.js";
import { n as resolveWebhookPathFromConfig } from "./webhook-shared-BF0E9h9K.js";
import { a as resolveBlueBubblesMessageId, b as sendMessageBlueBubbles } from "./reactions-CaQLf8It.js";
import { i as sendBlueBubblesMedia, n as processMessage, r as processReaction, t as logVerbose } from "./monitor-processing-GDdgGYJL.js";
...
async function monitorBlueBubblesProvider(options) {
	...
	return await new Promise((resolve) => {
		...
		import("./catchup-Bo0HohE_.js").then(({ runBlueBubblesCatchup }) => runBlueBubblesCatchup(target)).catch((err) => {
