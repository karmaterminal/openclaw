...
import { t as setupWizardCommand } from "./onboard-Uy81ta-H.js";
...
function loadAgentWorkspaceModule() {
	agentWorkspaceModulePromise ??= import("./workspace-BQWV_GdG.js");
...
async function resolveDefaultSessionTranscriptsDir() {
	const { resolveSessionTranscriptsDir } = await import("./sessions-CqdvEr5H.js");
