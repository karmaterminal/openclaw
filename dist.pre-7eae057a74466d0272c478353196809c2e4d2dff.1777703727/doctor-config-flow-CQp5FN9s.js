...
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-C-N8O3iv.js";
import { t as note } from "./note-DNReek-A.js";
import { a as stripUnknownConfigKeys, r as noteOpencodeProviderOverrides } from "./doctor-config-analysis-CFPnqyx-.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-CKtT5nsJ.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-DwyxSLAf.js";
import { t as asObjectRecord } from "./object-BBd-QUG9.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-CeYgyDoI.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-DG25cdLE.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-D3h8LJ0z.js");
		emitDoctorNotes({
			note,
