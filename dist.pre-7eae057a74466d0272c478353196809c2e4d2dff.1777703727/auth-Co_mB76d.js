...
import { s as loadAuthProfileStoreForRuntime } from "./store-DEFH3_of.js";
...
import { n as clearAuthProfileCooldown } from "./usage-D5NDUsYU.js";
import { i as upsertAuthProfile } from "./profiles-Bb22d7wV.js";
import { n as validateAnthropicSetupToken } from "./provider-auth-token-BUWcQyXA.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-BqOGNOgm.js";
import { n as stylePromptMessage, t as stylePromptHint } from "./prompt-style-BDA6sh8C.js";
import { t as createClackPrompter } from "./clack-prompter-D4H9yj2P.js";
import { n as logConfigUpdated } from "./logging-DemxZNeo.js";
import { a as loadValidConfigOrThrow, u as updateConfig } from "./shared-CunA93Iy.js";
import { t as isRemoteEnvironment } from "./remote-env-HPA3fSub.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-kaxg9wps.js";
import { i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-B3PWgALf.js";
...
async function runProviderAuthMethod(params) {
	...
	await persistProviderAuthResult({
		result: await params.method.run({
			...
			openUrl: async (url) => {
				const { openUrl } = await import("./onboard-helpers-Cilp19Dd.js");
				await openUrl(url);
			},
