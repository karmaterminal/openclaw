...
import { r as getActiveEmbeddedRunCount } from "./runs-C4UxZOv1.js";
import { h as stopDiagnosticHeartbeat, m as startDiagnosticHeartbeat } from "./diagnostic-BTg369xh.js";
...
import { t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-CkkdsQIa.js";
...
import { c as updateSessionStore, l as updateSessionStoreEntry, t as archiveRemovedSessionTranscripts } from "./store-Cf_mjUkP.js";
import { n as resolveMainSessionKeyFromConfig } from "./sessions-CTeI8wwA.js";
import { n as onSessionTranscriptUpdate } from "./transcript-events-BgA3dbPs.js";
import { n as onSessionLifecycleEvent } from "./session-lifecycle-events-DaImppva.js";
...
import { o as startGatewayModelPricingRefresh } from "./usage-format-BI0sSL8Q.js";
...
import { a as loadSessionEntry, d as resolveGatewaySessionStoreTarget, i as loadGatewaySessionRow } from "./session-utils-NaS57IP6.js";
...
import { c as stripLeadingSilentToken, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken } from "./tokens-DXgGSqoY.js";
import { o as resolveFailoverReasonFromError } from "./failover-error-CHWaro0P.js";
import { r as normalizeCronJobInput } from "./openclaw-tools-BjxfVLY4.js";
import { s as stripHeartbeatToken } from "./heartbeat-DI1BMPex.js";
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-secret-gateway-CCGGrDEa.js";
import { i as evaluateGatewayAuthSurfaceStates, r as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-web-tools-j6bAFl9D.js";
import { n as resolveConfiguredDeferredChannelPluginIds, r as resolveGatewayStartupPluginIds } from "./channel-plugin-ids-Iry5_tdu.js";
import { t as SsrFBlockedError } from "./ssrf-8eMK8Dvc.js";
import { t as detectMime } from "./mime-i5lfz-pp.js";
import { r as cleanOldMedia } from "./store-B7x3wVnO.js";
import { a as CANVAS_HOST_PATH, c as injectCanvasLiveReload, l as normalizeUrlPath, s as handleA2uiHttpRequest, u as resolveFileWithinRoot } from "./web-media-BSRbIzTp.js";
...
import { T as resolveExecApprovalRequestAllowedDecisions, r as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS, w as resolveExecApprovalAllowedDecisions } from "./exec-approvals-CGvrumYQ.js";
import { r as registerSkillsChangeListener } from "./refresh-state-Dod8b2gG.js";
import "./refresh-DYS4OasM.js";
import { c as roleScopesAllow } from "./pairing-token-CHQ1Kw__.js";
import { a as refreshRemoteBinsForConnectedNodes, c as setSkillsRemoteRegistry, h as updatePairedNodeMetadata, i as recordRemoteNodeInfo, m as requestNodePairing, n as primeRemoteSkillsCache, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo, u as getPairedNode } from "./skills-remote-Cqqtr2Gi.js";
import { n as resolveCronStorePath, r as saveCronStore, t as loadCronStore } from "./store-BTeu1CsQ.js";
import { t as getMachineDisplayName } from "./machine-name-Ix10ScUP.js";
import { o as retireSessionMcpRuntime } from "./pi-bundle-mcp-runtime-o85lhn9f.js";
import "./pi-bundle-mcp-tools-RhsiRr77.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-C4vkhKvV.js";
import { n as assertSafeCronSessionTargetId, r as isInvalidCronSessionTargetIdError, t as normalizeHttpWebhookUrl } from "./webhook-url-DiOci2D9.js";
import { c as setPreRestartDeferralCheck, n as deferGatewayRestartUntilIdle, r as emitGatewayRestart, s as setGatewaySigusr1RestartPolicy } from "./restart-Wajcfj3K.js";
import { o as resetModelCatalogCache, r as loadModelCatalog } from "./model-catalog-BjzZ5DNU.js";
import { t as deliverOutboundPayloads } from "./deliver-BXOkBZn2.js";
import { r as resetDirectoryCache } from "./target-resolver-DAuVAuaB.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-nSennZYu.js";
import { i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-mrp6EQ7I.js";
import { c as initSubagentRegistry } from "./subagent-registry-DGt9OETw.js";
import { t as resolveAgentTimeoutMs } from "./timeout-CN1Egm-P.js";
import { c as resolveHookExternalContentSource, o as isExternalHookSession, s as mapHookExternalContentSource } from "./external-content-C0cs5IcE.js";
import { o as resolvePreferredSessionKeyForSessionIdMatches } from "./live-model-switch-CC_kcHTZ.js";
import { t as createPluginRuntime } from "./runtime-9iM4pnsv.js";
import { o as getTotalPendingReplies } from "./dispatch-25zPU5ak.js";
import { n as sanitizeInboundSystemTags } from "./inbound-text-DGLjap1J.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-Cx8_q7G8.js";
import { c as formatExecApprovalExpiresIn, f as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-reply-CLbnGT1U.js";
import { t as CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "./approval-handler-adapter-runtime-CLZC9mlJ.js";
import { n as sanitizeExecApprovalDisplayText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-D4Jabxn2.js";
import { n as createChannelApprovalHandlerFromCapability } from "./approval-handler-runtime-C48ORDxc.js";
import { i as watchChannelRuntimeContexts, n as getChannelRuntimeContext, t as createTaskScopedChannelRuntime } from "./channel-runtime-context-DxtqyH-R.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-Boww7q_4.js";
import { i as onHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-BTTpip5y.js";
import { n as resolveAgentOutboundIdentity } from "./identity-wCzoCfVG.js";
import { i as resolveNodeCommandAllowlist, r as normalizeDeclaredNodeCommands } from "./node-command-policy-XOP16m2X.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs, t as formatForLog } from "./ws-log-C54_2PIN.js";
import { i as safeParseJson } from "./nodes.helpers-CtbBHKkm.js";
import { i as assertGatewayAuthNotKnownWeak, n as mergeGatewayAuthConfig, r as mergeGatewayTailscaleConfig, t as ensureGatewayStartupAuth } from "./startup-auth-MgsmFHZo.js";
import { r as resolveBootstrapProfileScopesForRole } from "./device-bootstrap-profile-BrWJEq0W.js";
import { _ as updatePairedDeviceMetadata, a as getPairedDevice, c as listApprovedPairedDeviceRoles, l as listDevicePairing, n as approveDevicePairing, p as requestDevicePairing, r as ensureDeviceToken, s as hasEffectivePairedDeviceRole, t as approveBootstrapDevicePairing, u as listEffectivePairedDeviceRoles, v as verifyDeviceToken } from "./device-pairing-wRk6r8tR.js";
import { a as redeemDeviceBootstrapTokenProfile, n as getBoundDeviceBootstrapProfile, o as revokeDeviceBootstrapToken, r as getDeviceBootstrapTokenProfile, s as verifyDeviceBootstrapToken } from "./device-bootstrap-geO0hLjy.js";
import { t as createDefaultDeps } from "./deps-By4loUkO.js";
import { i as buildSystemRunApprovalEnvBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-BT8tvSw8.js";
import { n as resolveSystemRunApprovalRequestContext } from "./system-run-approval-context-MG54PMdA.js";
import { t as closeMcpLoopbackServer } from "./mcp-http-BxU7u50l.js";
...
import { t as createOutboundSendDeps } from "./outbound-send-deps-Ce3xMjLb.js";
import { C as TICK_INTERVAL_MS, S as MAX_PREAUTH_PAYLOAD_BYTES, _ as DEDUPE_MAX, b as MAX_BUFFERED_BYTES, f as isSuppressedControlReplyLeadFragment, m as abortChatRunById, p as isSuppressedControlReplyText, v as DEDUPE_TTL_MS, x as MAX_PAYLOAD_BYTES, y as HEALTH_REFRESH_INTERVAL_MS } from "./chat-BjGzCNek.js";
import { t as cleanupBrowserSessionsForLifecycleEnd } from "./browser-lifecycle-cleanup--iHgoeOi.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-DtTseL_y.js";
import { a as writeWideAreaGatewayZone, i as resolveWideAreaDiscoveryDomain } from "./widearea-dns-CzkUh5Va.js";
import { a as resolveControlUiRootOverrideSync, n as isPackageProvenControlUiRootSync, o as resolveControlUiRootSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-C6Yt34ga.js";
import { t as GatewayLockError } from "./gateway-lock-CtY9bfMS.js";
import { t as getHealthSnapshot } from "./health-BCzRYE23.js";
import { t as runSetupWizard } from "./setup-DqyGW8iF.js";
import { d as startTaskRegistryMaintenance, f as stopTaskRegistryMaintenance, g as markCronJobActive, h as clearCronJobActive, n as getInspectableTaskRegistrySummary } from "./task-registry.maintenance-DxBQkSPI.js";
import { i as migrateOrphanedSessionKeys } from "./state-migrations-B7s7N0-v.js";
import { _ as resolveDeliveryTarget, a as computeJobPreviousRunAtMs, c as findJobOrThrow, d as isJobEnabled, f as nextWakeAtMs, g as resolveJobPayloadTextForMain, h as recordScheduleComputeError, i as computeJobNextRunAtMs, l as hasScheduledNextRunAtMs, m as recomputeNextRunsForMaintenance, n as applyJobPatch, o as createJob, p as recomputeNextRuns, r as assertSupportedJobSpec, s as errorBackoffMs, t as DEFAULT_ERROR_BACKOFF_SCHEDULE_MS, u as isJobDue } from "./jobs-bginVYSE.js";
import { t as createCronExecutionId } from "./run-id-Cs0nCvzo.js";
import { a as resolveHeartbeatAckMaxChars$1, i as resolveCronPayloadOutcome, t as isHeartbeatOnlyResponse } from "./helpers-vDXsy7RK.js";
import { a as resolveCronChannelOutputPolicy, n as markCronSessionPreRun, r as persistCronSkillsSnapshotIfChanged, t as createPersistCronSessionEntry } from "./run-session-state-BFr91Qmd.js";
import { t as runChannelPluginStartupMaintenance } from "./lifecycle-startup-B4ZYpO4-.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-mg1j6VKu.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-EAer7DGX.js";
import { C as resolveGatewayReloadSettings, D as roleCanSkipDeviceIdentity, E as parseGatewayRole, O as pruneStaleControlPlaneBuckets, S as diffConfigPaths, T as buildGatewayReloadPlan, _ as appendCronRunLog, a as coreGatewayHandlers, b as resolveCronDeliveryPlan, c as listSystemPresence, d as CANVAS_CAPABILITY_TTL_MS, f as buildCanvasScopedHostUrl, g as loadVoiceWakeConfig, h as formatError, i as setFallbackGatewayContextResolver, l as upsertPresence, m as normalizeCanvasScopedUrl, o as handleGatewayRequest, p as mintCanvasCapabilityToken, s as broadcastPresenceSnapshot, t as loadGatewayStartupPlugins, u as clearNodeWakeState, v as resolveCronRunLogPath, w as startGatewayConfigReloader, x as resolveFailureDestination, y as resolveCronRunLogPruneOptions } from "./server-plugin-bootstrap-Gmtdjcty.js";
import { i as resolveCronSession, n as runHeartbeatOnce, r as startHeartbeatRunner } from "./heartbeat-runner-y36gml7C.js";
import { n as stopGmailWatcher, t as startGmailWatcherWithLogs } from "./gmail-watcher-lifecycle-DRje3og-.js";
import "./paths-Hzqw512D.js";
import { t as getUpdateAvailable } from "./update-startup-B1N6iCcl.js";
import { t as hasConfiguredInternalHooks } from "./configured-Dh9cLowq.js";
...
function loadExecApprovalForwarderRuntime() {
	execApprovalForwarderRuntimePromise ??= import("./exec-approval-forwarder.runtime-BsOvxixK.js");
...
async function loadSkillsSnapshotRuntime() {
	skillsSnapshotRuntimePromise ??= import("./skills-snapshot.runtime-Dgm3I-0C.js");
...
async function loadCliRunnerRuntime() {
	return await import("./cli-runner.runtime-CKGyHIh8.js");
}
async function loadUsageFormatRuntime() {
	return await import("./usage-format-D5-ENZ2H.js");
}
...
function recoverPendingOutboundDeliveries(params) {
	(async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-BuTNFkPP.js");
		const { deliverOutboundPayloads } = await import("./deliver-B-DOOUeO.js");
...
function recoverPendingSessionDeliveries(params) {
	setTimeout(() => {
		(async () => {
			const { recoverPendingRestartContinuationDeliveries } = await import("./server-restart-sentinel-7k1XaRSl.js");
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-uaQ4TUSr.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-DlO_4GTK.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-Cx4UwPKO.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-D8vaiIZN.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-CrICo8if.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-CQxjokSa.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-CL4VnMoi.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-Cg1UkV8E.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-B70KJ3HS.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-CgB-m4Oa.js");
	return toolsInvokeHttpModulePromise;
}
function getVoiceClawRealtimeUpgradeModule() {
	voiceClawRealtimeUpgradeModulePromise ??= import("./upgrade-BDbpLI6v.js");
...
async function prewarmConfiguredPrimaryModel(params) {
	...
	const [{ resolveOpenClawAgentDir }, { DEFAULT_MODEL, DEFAULT_PROVIDER }, { selectAgentHarness }, { isCliProvider, resolveConfiguredModelRef }, { ensureOpenClawModelsJson }, { resolveModel, resolveModelAsync }, { resolveEmbeddedAgentRuntime }] = await Promise.all([
		...
		import("./selection-BroF0I7s.js"),
		import("./model-selection-BYgOLda2.js"),
		import("./models-config-CN5Bferm.js"),
		import("./model-gma0VWec.js"),
		import("./runtime-CjxPF49G.js")
	]);
...
async function startGatewaySidecars(params) {
		...
		try {
			...
			for (const sessionsDir of sessionDirs) {
				...
				if (result.cleaned.length > 0) {
					const { markRestartAbortedMainSessionsFromLocks } = await import("./main-session-restart-recovery-CFxOrvJS.js");
	...
	await measureStartup(params.startupTrace, "sidecars.gmail-watch", async () => {
		if (params.cfg.hooks?.enabled && params.cfg.hooks.gmail?.account) {
			const { startGmailWatcherWithLogs } = await import("./gmail-watcher-lifecycle-CtDJIugF.js");
			await startGmailWatcherWithLogs({
				cfg: params.cfg,
				log: params.logHooks
			});
	...
	await measureStartup(params.startupTrace, "sidecars.gmail-model", async () => {
		if (params.cfg.hooks?.gmail?.model) {
			const [{ DEFAULT_MODEL, DEFAULT_PROVIDER }, { loadModelCatalog }, { getModelRefStatus, resolveConfiguredModelRef, resolveHooksGmailModel }] = await Promise.all([
				import("./defaults-f0hLJtM0.js"),
				import("./model-catalog-Dtu2SNkr.js"),
				import("./model-selection-BYgOLda2.js")
			]);
	...
	await measureStartup(params.startupTrace, "sidecars.internal-hooks", async () => {
		try {
			if (internalHooksConfigured) {
				const [{ setInternalHooksEnabled }, { loadInternalHooks }] = await Promise.all([import("./internal-hooks-C04JhEqj.js"), import("./loader-BzwHYMV0.js")]);
	...
	await measureStartup(params.startupTrace, "sidecars.plugin-services", async () => {
		try {
			const { startPluginServices } = await import("./services-BwSfMRkX.js");
	...
	if (params.cfg.acp?.enabled) {
		const [{ getAcpSessionManager }, { ACP_SESSION_IDENTITY_RENDERER_VERSION }] = await Promise.all([import("./manager-DDaQK2qd.js"), import("./session-identifiers-DZ5I25Qj.js")]);
	...
	await measureStartup(params.startupTrace, "sidecars.memory", async () => {
		...
		setImmediate(() => {
			import("./server-startup-memory-BLa8ZKVl.js").then(({ startGatewayMemoryBackend }) => startGatewayMemoryBackend({
				cfg: params.cfg,
				log: params.log
			})).catch((err) => {
	...
	await measureStartup(params.startupTrace, "sidecars.restart-sentinel", async () => {
		...
		const { hasRestartSentinel } = await import("./restart-sentinel-BNrzPYNC.js");
		if (!await hasRestartSentinel()) return;
		setTimeout(() => {
			import("./server-restart-sentinel-7k1XaRSl.js").then(({ scheduleRestartSentinelWake }) => scheduleRestartSentinelWake({ deps: params.deps })).catch((err) => {
	...
	await measureStartup(params.startupTrace, "sidecars.subagent-recovery", async () => {
		const { scheduleSubagentOrphanRecovery } = await import("./subagent-registry-CUxb6MEK.js");
		scheduleSubagentOrphanRecovery();
	});
	await measureStartup(params.startupTrace, "sidecars.main-session-recovery", async () => {
		const { scheduleRestartAbortedMainSessionRecovery } = await import("./main-session-restart-recovery-CFxOrvJS.js");
...
const defaultGatewayPostAttachRuntimeDeps = {
	...
	logGatewayStartup: async (params) => (await import("./server-startup-log-BzrceSy1.js")).logGatewayStartup(params),
	scheduleGatewayUpdateCheck: async (...args) => (await import("./update-startup-C5vZ1vp0.js")).scheduleGatewayUpdateCheck(...args),
	startGatewaySidecars,
	startGatewayTailscaleExposure: async (...args) => (await import("./server-tailscale-B3yQN80h.js")).startGatewayTailscaleExposure(...args)
};
	...
	try {
		...
		if (!minimalTestGateway) {
			if (deferredConfiguredChannelPluginIds.length > 0) {
				const { reloadDeferredGatewayPlugins } = await import("./server-plugin-bootstrap-o45FC-5f.js");
