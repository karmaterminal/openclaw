...
import { a as loadConfig, g as recoverConfigFromLastKnownGood, h as recoverConfigFromJsonRootSuffix, l as readBestEffortConfig, r as createConfigIO, u as readConfigFileSnapshot, y as writeConfigFile } from "./io-BAiFlY00.js";
...
import { d as waitForActiveEmbeddedRuns, r as getActiveEmbeddedRunCount, t as abortEmbeddedPiRun } from "./runs-C4UxZOv1.js";
...
import { d as writeRestartSentinel } from "./restart-sentinel-CJmHj7Jw.js";
import { a as markGatewaySigusr1RestartHandled, i as isGatewaySigusr1RestartExternallyAllowed, l as triggerOpenClawRestart, o as scheduleGatewaySigusr1Restart, t as consumeGatewaySigusr1RestartAuthorization } from "./restart-Wajcfj3K.js";
import { n as parseTimeoutMsWithFallback } from "./parse-timeout-BzW2Wiix.js";
import { n as withProgress } from "./progress-sMfglU5X.js";
import { n as runCommandWithRuntime } from "./cli-utils-0Jmqj3wd.js";
import { n as setGatewayWsLogStyle } from "./ws-logging-CH6Dqymh.js";
import { t as formatHelpExamples } from "./help-format-CEZin8dE.js";
import { t as readSecretFromFile } from "./secret-file-v4kJGhYY.js";
import { n as buildGatewayDiscoveryTarget } from "./gateway-discovery-targets-CMNCsn-u.js";
import { o as resolveControlUiRootSync } from "./control-ui-assets-C6Yt34ga.js";
import { n as acquireGatewayLock, t as GatewayLockError } from "./gateway-lock-CtY9bfMS.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-CMnuH5W0.js";
import { o as handleReset } from "./onboard-helpers-DLG9bCi5.js";
...
async function runGatewayCommand$1(opts) {
	...
	const { startGatewayServer } = await startupTrace.measure("cli.server-import", () => withProgress({
		...
		indeterminate: true
	}, async () => import("./server-BF7FOzs7.js")));
...
function loadConfigModule() {
	configModulePromise ??= import("./read-best-effort-config.runtime-DlagcGFu.js");
	return configModulePromise;
}
function loadGatewayStatusModule() {
	gatewayStatusModulePromise ??= import("./gateway-status-CLht6O9M.js");
	return gatewayStatusModulePromise;
}
function loadGatewayHealthModule() {
	gatewayHealthModulePromise ??= import("./health-Btq0JRBp.js");
	return gatewayHealthModulePromise;
}
function loadBonjourDiscoveryModule() {
	bonjourDiscoveryModulePromise ??= import("./bonjour-discovery-xTGMgc7o.js");
	return bonjourDiscoveryModulePromise;
}
function loadWideAreaDnsModule() {
	wideAreaDnsModulePromise ??= import("./widearea-dns--a_aUAAb.js");
	return wideAreaDnsModulePromise;
}
function loadHealthStyleModule() {
	healthStyleModulePromise ??= import("./health-style-yYbB9a_U.js");
...
function loadSupportExportModule() {
	supportExportModulePromise ??= import("./diagnostic-support-export-cEGwtCGk.js");
	return supportExportModulePromise;
}
function loadDaemonStatusGatherModule() {
	daemonStatusGatherModulePromise ??= import("./status.gather-sCe00iOp.js");
