...
import { $ as normalizeTalkSection, B as shouldAttemptLastKnownGoodRecovery, Q as buildTalkConfigResponse, T as validateConfigObjectWithPlugins, a as loadConfig, d as readConfigFileSnapshotForWrite, et as resolveActiveTalkProviderConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, v as resolveConfigSnapshotHash, y as writeConfigFile } from "./io-BAiFlY00.js";
...
import { r as parseByteSize } from "./zod-schema-CDve8jgB.js";
...
import { r as createPluginRuntimeLoaderLogger } from "./load-context-BcZRhpPd.js";
...
import { n as canonicalizeSpawnedByForAgent, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-CkkdsQIa.js";
...
import { c as updateSessionStore } from "./store-Cf_mjUkP.js";
import { n as resolveMainSessionKeyFromConfig, t as extractDeliveryInfo } from "./sessions-CTeI8wwA.js";
...
import { i as normalizeCronJobPatch, n as normalizeCronJobCreate } from "./openclaw-tools-BjxfVLY4.js";
import { o as listConfiguredAnnounceChannelIdsForConfig, r as resolveGatewayStartupPluginIds } from "./channel-plugin-ids-Iry5_tdu.js";
import { s as projectOutboundPayloadPlanForMirror, t as createOutboundPayloadPlan } from "./payloads-CGZJpmQV.js";
import { i as resolveReplyToMode } from "./reply-threading-eQQAvNDj.js";
import { g as writeFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-BR8l9k2p.js";
...
import { a as clearSessionQueues } from "./queue-DKT86w7N.js";
import { d as mergeExecApprovalsSocketDefaults, j as saveExecApprovals, o as ensureExecApprovals, p as normalizeExecApprovals, y as readExecApprovalsSnapshot } from "./exec-approvals-CGvrumYQ.js";
import { t as canExecRequestNode } from "./exec-defaults-BJc65LUE.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-Dj_e-cAT.js";
import "./skills-CN68vLCM.js";
import { t as bumpSkillsSnapshotVersion } from "./refresh-state-Dod8b2gG.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-CY5chfwj.js";
import { o as resolveMissingRequestedScope } from "./pairing-token-CHQ1Kw__.js";
import { d as listNodePairing, f as rejectNodePairing, g as verifyNodeToken, l as approveNodePairing, m as requestNodePairing, p as renamePairedNode, t as getRemoteSkillEligibility } from "./skills-remote-Cqqtr2Gi.js";
import { d as listSessionCompactionCheckpoints, u as getSessionCompactionCheckpoint } from "./model-context-tokens-DBT4r-BD.js";
import { n as getPluginToolMeta, r as resolvePluginTools } from "./tools-5oczbLtB.js";
import { n as redactConfigSnapshot, r as restoreRedactedValues, t as redactConfigObject } from "./redact-snapshot-pNa7H3Sa.js";
import { C as synthesizeSpeech, S as setTtsProvider, b as setTtsEnabled, c as isTtsEnabled, f as resolveExplicitTtsOverrides, g as resolveTtsProviderOrder, h as resolveTtsPrefsPath, i as getResolvedSpeechProviderConfig, l as isTtsProviderConfigured, m as resolveTtsConfig, o as getTtsProvider, p as resolveTtsAutoMode, w as textToSpeech } from "./tts-nCfMFeY2.js";
import { a as prepareSecretsRuntimeSnapshot } from "./runtime-C4vkhKvV.js";
import { i as parseAbsoluteTimeMs } from "./stagger-UZ3BW892.js";
import { r as isInvalidCronSessionTargetIdError } from "./webhook-url-DiOci2D9.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint } from "./restart-sentinel-CJmHj7Jw.js";
import { o as scheduleGatewaySigusr1Restart } from "./restart-Wajcfj3K.js";
import { i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry, s as dispatchChannelMessageAction } from "./message-action-runner-BRf_L4-R.js";
import { n as normalizePollInput } from "./polls-D15J-0bJ.js";
import { t as deliverOutboundPayloads } from "./deliver-BXOkBZn2.js";
import { n as resolveOutboundChannelPlugin } from "./channel-resolution-DpuU-gKz.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-Br1-uw0d.js";
import "./target-resolver-DAuVAuaB.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-ewTLJ_KP.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-nSennZYu.js";
import { r as resolveOutboundTarget } from "./targets-pR4VDxk7.js";
import { t as extractToolPayload } from "./tool-payload-DegFjq5X.js";
import { r as createRunningTaskRun } from "./detached-task-runtime-mrp6EQ7I.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-DHcXQtyK.js";
import { t as resolveAgentTimeoutMs } from "./timeout-CN1Egm-P.js";
import { n as getActiveMemorySearchManager } from "./memory-runtime-z_a5pRXW.js";
...
import { t as primeConfiguredBindingRegistry } from "./binding-registry-DmLbMKFG.js";
import { r as listPluginCommands } from "./commands-BY6wwqF7.js";
import { i as setGatewaySubagentRuntime, r as setGatewayNodesRuntime } from "./gateway-bindings-B37Z2qKZ.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-DK86PPF6.js";
import "./commands-registry-Zgc_jF4C.js";
import { n as resolveSendPolicy } from "./send-policy-Dvl_5qWE.js";
import { t as getChannelActivity } from "./channel-activity-kNj66xKt.js";
import { t as WizardCancelledError } from "./prompts-uTwx-Krz.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-C8j6O3y3.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-CHJTzD9j.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-BuadWisf.js";
import { r as getLastHeartbeatEvent } from "./heartbeat-visibility-BTTpip5y.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-B_hUcY8s.js";
import { r as agentCommandFromIngress } from "./agent-command-CQBL4voS.js";
import { n as getSpeechProvider, r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-Cs6DsHcT.js";
import { n as invokeNativeHookRelay } from "./native-hook-relay-GwV1d0_b.js";
import { i as resolveNodeCommandAllowlist, n as isNodeCommandAllowed } from "./node-command-policy-XOP16m2X.js";
import { t as formatForLog } from "./ws-log-C54_2PIN.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-CtbBHKkm.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-DKPVi0gd.js";
import { a as getPairedDevice, c as listApprovedPairedDeviceRoles, d as rejectDevicePairing, f as removePairedDevice, g as summarizeDeviceTokens, h as rotateDeviceToken, i as formatDevicePairingForbiddenMessage, l as listDevicePairing, m as revokeDeviceToken, n as approveDevicePairing, o as getPendingDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-wRk6r8tR.js";
import { o as REALTIME_VOICE_AGENT_CONSULT_TOOL, r as getRealtimeVoiceProvider, s as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, t as resolveConfiguredRealtimeVoiceProvider } from "./provider-resolver-CnP3dLEJ.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-CUnFqH6U.js";
import { n as createOutboundSendDeps } from "./deps-By4loUkO.js";
import "./agent-EeD5JH6k.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-BT8tvSw8.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-MG54PMdA.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-Bigpz_ff.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-5wKm04Bx.js";
import { d as waitForTerminalGatewayDedupe, g as resolveAgentRunExpiresAtMs, h as registerChatAbortController, i as chatHandlers, l as readTerminalSnapshotFromGatewayDedupe, u as setGatewayDedupeEntry } from "./chat-BjGzCNek.js";
import { n as MediaOffloadError, r as parseMessageWithAttachments, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-B3npQoSQ.js";
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp-CzsKNYvN.js";
import { t as resolveSessionKeyFromResolveParams } from "./sessions-resolve-C2Qk4wPR.js";
import { t as loadProviderUsageSummary } from "./provider-usage-_BRgv_BH.js";
import { o as fetchClawHubSkillDetail } from "./clawhub-B_ef9S_r.js";
import { a as loadSessionUsageTimeSeries, i as loadSessionLogs, n as loadCostUsageSummary, o as resolveExistingUsageSessionFile, r as loadSessionCostSummary, t as discoverAllSessions } from "./session-cost-usage-BY0xDUex.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-C3ltTtez.js";
import { n as movePathToTrash } from "./browser-maintenance-BTPHKCHM.js";
import { a as performGatewaySessionReset } from "./session-reset-service-xweNhVRX.js";
import { t as buildChannelUiCatalog } from "./catalog-B_qbmYFA.js";
import { a as removeBackfillDiaryEntries, c as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeGroundedShortTermCandidates, r as previewGroundedRemMarkdown, s as repairDreamingArtifacts } from "./memory-core-bundled-runtime-BzUk6w5_.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-Db5x_zlc.js";
import { t as readConfiguredLogTail } from "./log-tail-D35kUFb7.js";
import { n as purgeAgentSessionStoreEntries } from "./agents.command-shared-VO_i8aWr.js";
import { o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-BB17Inhm.js";
import { t as installSkill } from "./skills-install-Dn__3QMh.js";
import { m as normalizeUpdateChannel } from "./update-check-Bt-beuA9.js";
import "./status-CDfV-lnc.js";
import { t as getStatusSummary } from "./status.summary-BWBeYaaP.js";
import { i as updateSkillsFromClawHub, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-BgDIojaG.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-CkXAAgvY.js";
import { t as runGatewayUpdate } from "./update-runner-DjlKH2NK.js";
import { t as buildChannelAccountSnapshot } from "./status-WBAaPG4I.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-bginVYSE.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-mg1j6VKu.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-EAer7DGX.js";
import "./heartbeat-runner-y36gml7C.js";
...
async function loadSessionSubagentReactivationRuntime() {
	return import("./session-subagent-reactivation.runtime-Bj_O30un.js");
}
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-Cnd5IaK_.js");
...
function loadSessionsRuntimeModule() {
	sessionsRuntimeModulePromise ??= import("./sessions.runtime-DYmG42l8.js");
