...
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-cH_wmfzQ.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-C0mWRtYD.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-CUr6XeRo.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("./jsonwebtoken-Akb5Z8hu.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-WZ2ihULn.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwt, { JwksClient }]) => ({
		jwt,
		JwksClient
	}));
