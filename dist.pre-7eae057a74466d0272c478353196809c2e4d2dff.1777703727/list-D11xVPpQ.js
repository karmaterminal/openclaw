...
import { W as getShellEnvAppliedKeys, q as shouldEnableShellEnvFallback, r as createConfigIO } from "./io-BAiFlY00.js";
...
import { i as resolveAgentExplicitModelPrimary, s as resolveAgentModelFallbacksOverride, y as resolveAgentDir } from "./agent-scope-BrwtzVtf.js";
import "./config-DWasLg9V.js";
import { u as resolveAuthStorePathForDisplay } from "./source-check-DyijdW2N.js";
import { i as ensureAuthProfileStoreWithoutExternalProfiles } from "./store-DEFH3_of.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-CACD-vsQ.js";
import { t as modelKey } from "./model-ref-shared-PgbBrl_x.js";
import { f as resolveConfiguredModelRef, h as resolveModelRefFromString, i as buildModelAliasIndex, x as parseModelRef, y as modelKey$1 } from "./model-selection-shared-3Ltfz4Ls.js";
import { t as isCliProvider } from "./model-selection-cli-DFsd-GLS.js";
import "./model-selection-DwvfvFe2.js";
import { i as resolveAuthProfileDisplayLabel } from "./auth-profiles-DF1yYahd.js";
import { n as listProfilesForProvider } from "./profile-list-Bg_34ywG.js";
import { o as resolveProfileUnusableUntilForDisplay } from "./usage-D5NDUsYU.js";
import "./profiles-Bb22d7wV.js";
import { u as isNonSecretApiKeyMarker, v as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-bqtxN13W.js";
import { t as resolveEnvApiKey } from "./model-auth-env-CEuHMAX0.js";
import { n as resolveAwsSdkEnvVarName } from "./model-auth-runtime-shared-Db4eTPRf.js";
import { i as getCustomProviderApiKey, l as resolveUsableCustomProviderApiKey, o as hasUsableCustomProviderApiKey } from "./model-auth-6BQTKjsb.js";
import { i as discoverModels, l as resolveRuntimeSyntheticAuthProviderRefs, r as discoverAuthStorage } from "./pi-model-discovery-BbIe5g41.js";
import { r as loadModelCatalog } from "./model-catalog-BjzZ5DNU.js";
import { n as shouldSuppressBuiltInModel } from "./model-suppression-nXyz1riY.js";
import { r as resolveModelWithRegistry } from "./model-CVPGcIht.js";
import { f as isLocalBaseUrl, i as formatTokenK, n as ensureFlagCompatibility, s as resolveKnownAgentId } from "./shared-CunA93Iy.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-C3ltTtez.js";
import { t as maskApiKey } from "./mask-api-key-DazuG1od.js";
import { n as loadModelsConfigWithSource, t as loadModelsConfig } from "./load-config-DqguTPXH.js";
import { n as loadProviderCatalogModelsForList, t as hasProviderStaticCatalogForFilter } from "./list.runtime-ajn_AlyH.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-CsdDM6ma.js";
...
async function modelsListCommand(opts, runtime) {
	...
	const { ensureAuthProfileStore, resolveOpenClawAgentDir } = await import("./list.runtime-D83cgYqP.js");
...
function loadProviderUsageRuntime() {
	providerUsageRuntimePromise ??= import("./provider-usage-DqICngRP.js");
	return providerUsageRuntimePromise;
}
function loadProgressRuntime() {
	progressRuntimePromise ??= import("./progress-D9723af3.js");
	return progressRuntimePromise;
}
function loadTerminalTableRuntime() {
	terminalTableRuntimePromise ??= import("./table-Dlojx3bG.js");
	return terminalTableRuntimePromise;
}
function loadListProbeRuntime() {
	listProbeRuntimePromise ??= import("./list.probe-Ch0TVY-R.js");
...
async function modelsStatusCommand(opts, runtime) {
	...
	if (missingProvidersInUse.length > 0) {
		const { buildProviderAuthRecoveryHint } = await import("./provider-auth-guidance-D_xq98rX.js");
		runtime.log("");
