...
import "./message-channel-OCXPZoKg.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-VxE9WCsM.js";
import { a as isEmbeddedPiRunActive, f as waitForEmbeddedPiRunEnd } from "./runs-C4UxZOv1.js";
...
import { a as getSubagentDepthFromSessionStore } from "./subagent-capabilities-D0iLDveh.js";
import { r as callGateway } from "./call-B1tHywBQ.js";
import "./delivery-context-BPbcx5WX.js";
import { t as buildSubagentSystemPrompt } from "./subagent-system-prompt-BHGb1lDa.js";
import { i as consumePendingDelegates } from "./delegate-store-BnKsJikL.js";
import "./continuation-delegate-store-BjJWol5H.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, l as stripSilentToken, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-DXgGSqoY.js";
...
function loadSubagentRegistryRuntime() {
	subagentRegistryRuntimePromise ??= import("./subagent-announce.registry.runtime-Bofs7t7R.js");
	return subagentRegistryRuntimePromise;
}
function loadContinuationStateRuntime() {
	continuationStateRuntimePromise ??= import("./continuation-state.runtime-DPMGcmUp.js");
	return continuationStateRuntimePromise;
}
function loadSubagentSpawnRuntime() {
	subagentSpawnRuntimePromise ??= import("./subagent-spawn-FW-Xi0yK.js");
...
async function runSubagentAnnounceFlow(params) {
	...
	try {
		...
		if (params.silentAnnounce) {
			const { enqueueSystemEvent } = await import("./system-events-CR7Oskkl.js");
			const { createSubsystemLogger } = await import("./subsystem-CAx_JowN.js");
			...
			if (params.wakeOnReturn) {
				const { requestHeartbeatNow } = await import("./heartbeat-wake-B0x4KZAW.js");
				requestHeartbeatNow({
