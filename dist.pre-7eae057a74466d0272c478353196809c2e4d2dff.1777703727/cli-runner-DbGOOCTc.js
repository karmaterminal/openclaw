...
import { p as isFailoverErrorMessage, t as classifyFailoverReason } from "./errors-C0ssrY7m.js";
import { n as buildAgentHookConversationMessages, t as loadCliSessionHistoryMessages } from "./session-history-B-UL-fVy.js";
import { i as isFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-CHWaro0P.js";
...
async function runCliAgent(params) {
	...
	const { prepareCliRunContext } = await import("./prepare.runtime-BMzPlowY.js");
	return runPreparedCliAgent(await prepareCliRunContext(params));
}
async function runPreparedCliAgent(context) {
	const { executePreparedCliRun } = await import("./execute.runtime-C1ObYHSN.js");
