...
import { n as getBridgeAuthForPort } from "./bridge-auth-registry-Dlid5jsl.js";
import { t as resolveBrowserRateLimitMessage } from "./rate-limit-message-bqV89iuk.js";
...
async function fetchBrowserJson(url, init) {
	...
	try {
		...
		const { dispatchBrowserControlRequest } = await import("./local-dispatch.runtime-BOqO8lis.js");
