...
async function runGatewayConfigHealth(ctx) {
	...
	const { note } = await import("./note-DVaDQngM.js");
...
async function runAuthProfileHealth(ctx) {
	const { maybeRepairLegacyOAuthProfileIds } = await import("./doctor-auth-legacy-oauth-BEQ-sK4f.js");
	const { noteAuthProfileHealth, noteLegacyCodexProviderOverride } = await import("./doctor-auth-G4XAmuVb.js");
	const { buildGatewayConnectionDetails } = await import("./call-XQrl2gCH.js");
	const { note } = await import("./note-DVaDQngM.js");
...
async function runGatewayAuthHealth(ctx) {
	...
	const { note } = await import("./note-DVaDQngM.js");
	const { randomToken } = await import("./onboard-helpers-Cilp19Dd.js");
...
async function runClaudeCliHealth(ctx) {
	const { noteClaudeCliHealth } = await import("./doctor-claude-cli-Bv2Tw1HN.js");
	noteClaudeCliHealth(ctx.cfg);
}
async function runLegacyStateHealth(ctx) {
	const { detectLegacyStateMigrations, runLegacyStateMigrations } = await import("./doctor-state-migrations-BayMzjBk.js");
	const { note } = await import("./note-DVaDQngM.js");
...
async function runLegacyPluginManifestHealth(ctx) {
	const { maybeRepairLegacyPluginManifestContracts } = await import("./doctor-plugin-manifests-DChwn2YI.js");
...
async function runBundledPluginRuntimeDepsHealth(ctx) {
	const { maybeRepairBundledPluginRuntimeDeps } = await import("./doctor-bundled-plugin-runtime-deps-Dn6VyTFk.js");
...
async function runStateIntegrityHealth(ctx) {
	const { noteStateIntegrity } = await import("./doctor-state-integrity-DR1ln_SW.js");
	await noteStateIntegrity(ctx.cfg, ctx.prompter, ctx.configPath);
}
async function runSessionLocksHealth(ctx) {
	const { noteSessionLockHealth } = await import("./doctor-session-locks-kydVsBib.js");
	await noteSessionLockHealth({ shouldRepair: ctx.prompter.shouldRepair });
}
async function runLegacyCronHealth(ctx) {
	const { maybeRepairLegacyCronStore } = await import("./doctor-cron-B87TBMP0.js");
...
async function runSandboxHealth(ctx) {
	const { maybeRepairSandboxImages, noteSandboxScopeWarnings } = await import("./doctor-sandbox-B_AvRBLE.js");
...
async function runGatewayServicesHealth(ctx) {
	const { maybeRepairGatewayServiceConfig, maybeScanExtraGatewayServices } = await import("./doctor-gateway-services-KlPBGSoX.js");
	const { noteMacLaunchAgentOverrides, noteMacLaunchctlGatewayEnvOverrides } = await import("./doctor-platform-notes-CCxQPS_B.js");
...
async function runStartupChannelMaintenanceHealth(ctx) {
	const { maybeRunDoctorStartupChannelMaintenance } = await import("./doctor-startup-channel-maintenance-CXoDAlcr.js");
...
async function runSecurityHealth(ctx) {
	const { noteSecurityWarnings } = await import("./doctor-security-DERXZnQG.js");
	await noteSecurityWarnings(ctx.cfg);
}
async function runBrowserHealth(ctx) {
	const { noteChromeMcpBrowserReadiness } = await import("./doctor-browser-DLMBJFut.js");
	await noteChromeMcpBrowserReadiness(ctx.cfg);
}
async function runOpenAIOAuthTlsHealth(ctx) {
	const { noteOpenAIOAuthTlsPrerequisites } = await import("./oauth-tls-preflight-D4h21B8D.js");
...
async function runSystemdLingerHealth(ctx) {
	...
	const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-By8w46GN.js");
	const { note } = await import("./note-DVaDQngM.js");
...
async function runWorkspaceStatusHealth(ctx) {
	const { noteWorkspaceStatus } = await import("./doctor-workspace-status-BmTxi9Xd.js");
	noteWorkspaceStatus(ctx.cfg);
}
async function runBootstrapSizeHealth(ctx) {
	const { noteBootstrapFileSize } = await import("./doctor-bootstrap-size-DlUJH16D.js");
	await noteBootstrapFileSize(ctx.cfg);
}
async function runShellCompletionHealth(ctx) {
	const { doctorShellCompletion } = await import("./doctor-completion-W-v5lTi7.js");
...
async function runGatewayHealthChecks(ctx) {
	const { checkGatewayHealth, probeGatewayMemoryStatus } = await import("./doctor-gateway-health-RGBnp3VV.js");
...
async function runMemorySearchHealthContribution(ctx) {
	const { maybeRepairMemoryRecallHealth, noteMemoryRecallHealth, noteMemorySearchHealth } = await import("./doctor-memory-search-DniAstvV.js");
...
async function runDevicePairingHealth(ctx) {
	const { noteDevicePairingHealth } = await import("./doctor-device-pairing-cgKm2v9A.js");
...
async function runGatewayDaemonHealth(ctx) {
	const { maybeRepairGatewayDaemon } = await import("./doctor-gateway-daemon-flow-ysJn1m3i.js");
...
async function runWriteConfigHealth(ctx) {
	const { formatCliCommand } = await import("./command-format-CvdT6mLW.js");
	const { applyWizardMetadata } = await import("./onboard-helpers-Cilp19Dd.js");
	const { CONFIG_PATH, writeConfigFile } = await import("./config-B_igeLZT.js");
	const { logConfigUpdated } = await import("./logging-ARCsltuc.js");
...
async function runWorkspaceSuggestionsHealth(ctx) {
	...
	const { noteWorkspaceBackupTip } = await import("./doctor-state-integrity-DR1ln_SW.js");
	const { MEMORY_SYSTEM_PROMPT, shouldSuggestMemorySystem } = await import("./doctor-workspace-CABLVHjx.js");
	const { note } = await import("./note-DVaDQngM.js");
...
async function runFinalConfigValidationHealth(_ctx) {
	const { readConfigFileSnapshot } = await import("./config-B_igeLZT.js");
