...
import { i as hasConfiguredChannelsForReadOnlyScope } from "./channel-plugin-ids-if36pfk7.js";
import { t as createEmptyTaskRegistrySummary } from "./task-registry.summary-CR-OfUZp.js";
import { n as createEmptyTaskAuditSummary } from "./task-registry.audit.shared-B9InRDQ7.js";
import { t as pickGatewaySelfPresence } from "./gateway-presence-D3nFHxB3.js";
import { t as resolveGatewayProbeTarget } from "./probe-target-CfLZdBpC.js";
...
function loadGatewayProbeModule() {
	gatewayProbeModulePromise ??= import("./status.gateway-probe-Ct-iWMyy.js");
	return gatewayProbeModulePromise;
}
function loadProbeGatewayModule() {
	probeGatewayModulePromise ??= import("./probe-BdpuOO5a.js");
...
function loadStatusScanDepsRuntimeModule() {
	statusScanDepsRuntimeModulePromise ??= import("./status.scan.deps.runtime-NxZJiRH-.js");
	return statusScanDepsRuntimeModulePromise;
}
function loadStatusAgentLocalModule() {
	statusAgentLocalModulePromise ??= import("./status.agent-local-0aDCajem.js");
	return statusAgentLocalModulePromise;
}
function loadStatusUpdateModule() {
	statusUpdateModulePromise ??= import("./status.update-CcUNDhG7.js");
	return statusUpdateModulePromise;
}
function loadStatusScanRuntimeModule() {
	statusScanRuntimeModulePromise ??= import("./status.scan.runtime-D_nXUCWn.js");
	return statusScanRuntimeModulePromise;
}
function loadGatewayCallModule() {
	gatewayCallModulePromise ??= import("./call-Dx52RI4r.js");
	return gatewayCallModulePromise;
}
function loadStatusSummaryModule() {
	statusSummaryModulePromise ??= import("./status.summary-hrhEw0NL.js");
	return statusSummaryModulePromise;
}
function loadConfigModule() {
	configModulePromise ??= import("./config-FF751HCT.js");
	return configModulePromise;
}
function loadCommandConfigResolutionModule() {
	commandConfigResolutionModulePromise ??= import("./command-config-resolution-jHi-rtVT.js");
	return commandConfigResolutionModulePromise;
}
function loadCommandSecretTargetsModule() {
	commandSecretTargetsModulePromise ??= import("./command-secret-targets-D_ROkX6a.js");
