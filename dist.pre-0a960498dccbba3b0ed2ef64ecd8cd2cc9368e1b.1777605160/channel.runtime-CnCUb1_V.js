...
import { l as withResolvedWebhookRequestPipeline, n as registerWebhookTargetWithPluginRoute, s as resolveWebhookTargetWithAuthOrRejectSync } from "./webhook-targets-BiLVyyrM.js";
import "./webhook-ingress-BHSvugPC.js";
import "./browser-security-runtime-B36sav9l.js";
import "./string-coerce-runtime-Dazie0fz.js";
import { P as resolveBlueBubblesEffectiveAllowPrivateNetwork, _ as normalizeWebhookReaction, g as normalizeWebhookMessage, o as probeBlueBubbles, t as fetchBlueBubblesServerInfo, u as asRecord } from "./probe-CFcOHNmu.js";
import { t as getBlueBubblesRuntime } from "./runtime-Cm-v_9VT.js";
import { n as resolveWebhookPathFromConfig } from "./webhook-shared-CiUTWZhW.js";
import { a as resolveBlueBubblesMessageId, b as sendMessageBlueBubbles } from "./reactions-BmMuqZfA.js";
import { i as sendBlueBubblesMedia, n as processMessage, r as processReaction, t as logVerbose } from "./monitor-processing-BoiFCw9W.js";
...
async function monitorBlueBubblesProvider(options) {
	...
	return await new Promise((resolve) => {
		...
		import("./catchup-Bz4LZ8uP.js").then(({ runBlueBubblesCatchup }) => runBlueBubblesCatchup(target)).catch((err) => {
