...
import { a as loadConfig, st as resolveCliRuntimeExecutionProvider } from "./io-Cs-0dhMf.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-EpIbK3Oz.js";
import "./defaults-DM8yIn8C.js";
import { f as resolveRunModelFallbacksOverride, t as hasConfiguredModelFallbacks } from "./agent-scope-_6dFncNS.js";
...
import { g as resolveGroupSessionKey, l as resolveSessionStoreEntry, o as updateSessionStore, s as updateSessionStoreEntry } from "./store-Ci-m4oZ1.js";
import "./sessions-BL1W8Rqf.js";
import { a as resolveContextTokensForModel } from "./context-DMWYZXlM.js";
import { i as emitAgentEvent, u as registerAgentRunContext } from "./agent-events-DMk-SEBA.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-BqSt4EQw.js";
...
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-BkZjNPT-.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-B716cKY1.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-CPoUE_99.js";
import { s as stripHeartbeatToken } from "./heartbeat-O3b-eLDX.js";
import { E as estimateMessagesTokens } from "./wait-for-idle-before-flush-DqCoPiLw.js";
import { a as isAudioFileName } from "./mime-Zn7U6BSf.js";
import { l as isLikelyExecutionAckPrompt } from "./selection-9GHZrR2e.js";
import { o as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-COeZk8QH.js";
import "./pi-embedded-helpers-B8QlHRbO.js";
import { D as formatRawAssistantErrorForUi, _ as isOverloadedErrorMessage, g as isBillingErrorMessage, i as formatRateLimitOrOverloadedErrorCopy, t as BILLING_ERROR_USER_MESSAGE, u as sanitizeUserFacingText, y as isRateLimitErrorMessage } from "./sanitize-user-facing-text-DhtkBIxZ.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-Z2rrAzsp.js";
import { _ as isTransientHttpError, d as isContextOverflowError, m as isLikelyContextOverflowError, u as isCompactionFailureError } from "./errors-Do7ZlTNo.js";
import { i as resolveSandboxConfigForAgent } from "./config-BFMgmHaM.js";
...
import { n as setReplyPayloadMetadata, t as getReplyPayloadMetadata } from "./reply-payload-DSDhOmpq.js";
...
import { i as LiveSessionModelSwitchError, r as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-nJufkDD5.js";
import { a as consumeStagedPostCompactionDelegates, c as highestDelayedContinuationReservationHop, d as stagePostCompactionDelegate, f as stagedPostCompactionDelegateCount, i as consumePendingDelegates, l as pendingDelegateCount, n as cancelPendingDelegates, p as takeDelayedContinuationReservation, r as clearDelayedContinuationReservations, t as addDelayedContinuationReservation, u as setTaskFlowDelegatesEnabled } from "./continuation-delegate-store-CFkbS5BT.js";
import { t as resolveContinuationRuntimeConfig } from "./continuation-runtime-T5jKm_4s.js";
import { o as generateSecureUuid, t as generateChainId } from "./secure-random-Bp9Xftt_.js";
import { i as isRenderablePayload, n as applyReplyThreading, t as applyReplyTagsToPayload } from "./reply-payloads-XLhnEeuf.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-CJ71KlrN.js";
import { n as filterMessagingToolMediaDuplicates, r as shouldSuppressMessagingToolReplies, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-Df0uTcsm.js";
...
import { n as routeReply, t as isRoutableChannel } from "./route-reply-DYuUpkSG.js";
import { o as scheduleFollowupDrain, r as enqueueFollowupRun, s as refreshQueuedFollowupSession } from "./queue-BZMzpG6G.js";
import { h as replyRunRegistry, m as createReplyOperation, p as ReplyRunAlreadyActiveError, s as queueEmbeddedPiMessage } from "./runs-D5h4YOhz.js";
import { n as spawnSubagentDirect } from "./subagent-spawn-aB8Sp5NK.js";
import "./sandbox-mpsArbFr.js";
import { n as readPostCompactionContext } from "./post-compaction-context-oUYpjtFs.js";
import { n as compactEmbeddedPiSession, t as runEmbeddedPiAgent } from "./pi-embedded-Dwxo8eTW.js";
import { n as resolveCronStorePath, t as loadCronStore } from "./store-DPV8Uh7u.js";
import { i as emitContinuationDisabledSpan, n as emitContinuationDelegateFireSpan, o as emitContinuationWorkFireSpan, r as emitContinuationDelegateSpan, s as emitContinuationWorkSpan, t as emitContinuationCompactionReleasedSpan } from "./continuation-tracer-DwPZKu0Q.js";
import { t as formatProviderModelRef } from "./model-runtime-DD9ssgqS.js";
import { t as runCliAgent } from "./cli-runner-DZcuVyst.js";
import { c as setCliSessionId, r as getCliSessionBinding, s as setCliSessionBinding } from "./cli-session-CdRqZZqa.js";
import { a as resolveModelFallbackOptions, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyExecutionConfig, r as formatBunFetchSocketError, s as resolveQueuedReplyRuntimeConfig, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-BoB7P9lK.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-DX9bWWqs.js";
import { a as createBlockReplyContentKey, i as createAudioAsVoiceBuffer, o as createBlockReplyPipeline, r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-B90oLr6I.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-CAgrKGKf.js";
import { n as incrementCompactionCount } from "./session-updates-QZHXOO0r.js";
import { a as currentContinuationGeneration, d as unregisterContinuationTimerHandle, i as clearTrackedContinuationTimers, l as retainContinuationTimerRef, n as clearDelegatePending, o as maybeDropContinuationGeneration, r as clearDelegatePendingIfNoDelayedReservations, s as registerContinuationTimerHandle, t as bumpContinuationGeneration, u as setDelegatePending } from "./continuation-state-nAx6u0Yn.js";
import { n as dispatchPostCompactionDelegates, r as persistPendingPostCompactionDelegates } from "./post-compaction-delegate-dispatch-BSLb9j6n.js";
...
async function runEmbeddedPiAgentDefault$1(...args) {
	const { runEmbeddedPiAgent } = await import("./pi-embedded.runtime-r-oIoy19.js");
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded-fTPbvysa.js");
...
function loadReplyPayloadsDedupeRuntime() {
	replyPayloadsDedupeRuntimePromise ??= import("./reply-payloads-dedupe.runtime-DznoFi97.js");
		...
		if (continuationFeatureEnabled && sessionKey) {
			...
			if (toolDelegates.length > 0) {
				...
				for (const droppedDelegate of delegatesOverLimit) {
					...
					{
						const delegateMode = droppedDelegate.silentWake ? "silent-wake" : droppedDelegate.silent ? "silent" : "normal";
				...
				for (const delegate of delegatesWithinLimit) {
					...
					if (allocatedChainHop >= maxChainLength) {
						...
						{
							const delegateMode = delegate.silentWake ? "silent-wake" : delegate.silent ? "silent" : "normal";
					...
					if (delegate.delayMs && delegate.delayMs > 0) {
						...
						const fireDelegateMode = delegate.silentWake ? "silent-wake" : delegate.silent ? "silent" : "normal";
						const chainStepRemainingAtDispatch = maxChainLength - nextChainCount;
						retainContinuationTimerRef(sessionKey);
						const armedAt = Date.now();
						const timerHandle = setTimeout(() => {
