...
import { s as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-DdX3YJcs.js";
import "./pi-bundle-mcp-tools-qRT695En.js";
import { r as callGateway } from "./call-DQ5vtuUC.js";
import { t as registerPendingSpawnedChildrenQuery } from "./pending-spawn-query-CUurA_mA.js";
import { i as failTaskRunByRunId, o as setDetachedTaskDeliveryStatusByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-Bi2QiaeH.js";
import "./subagent-announce-queue-DuxPDKjm.js";
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-BLnhZQsJ.js";
import { u as withSubagentOutcomeTiming } from "./subagent-announce-output-Bmr3vC7l.js";
import { i as emitSessionLifecycleEvent, t as configureSubagentRegistrySpawnRuntime } from "./subagent-registry-spawn-runtime-Chr1AuJE.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-CnBwvSHe.js";
...
async function loadCleanupBrowserSessionsForLifecycleEnd$1() {
	browserCleanupPromise$1 ??= import("./browser-lifecycle-cleanup-BsgOIKmD.js");
...
async function loadSubagentAnnounceModule() {
	subagentAnnouncePromise ??= import("./subagent-announce-ClziadPM.js");
	return await subagentAnnouncePromise;
}
async function loadCleanupBrowserSessionsForLifecycleEnd() {
	browserCleanupPromise ??= import("./browser-lifecycle-cleanup-BsgOIKmD.js");
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-DSOw-M3n.js").then(({ scheduleOrphanRecovery }) => {
