...
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "./webhook-request-guards-oih9yid4.js";
import "./webhook-ingress-BHSvugPC.js";
import { g as resolveRealtimeVoiceAgentConsultToolsAllow, h as resolveRealtimeVoiceAgentConsultTools, s as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME } from "./provider-resolver-L8rr-So-.js";
import { s as consultRealtimeVoiceAgent, t as convertPcmToMulaw8k } from "./realtime-voice-DutV07dY.js";
import { t as resolveConfiguredCapabilityProvider } from "./provider-selection-runtime-x9FkT1AI.js";
import { t as zod_exports } from "./zod-Br0TjKcK.js";
import "./api-BQjlZpdF.js";
import { a as deepMergeDefined, i as validateProviderConfig, n as normalizeVoiceCallConfig, r as resolveVoiceCallConfig } from "./config-RjVp8RxR.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-DC6B9B9o.js";
import { t as resolveVoiceResponseModel } from "./response-model-caFZ6i7G.js";
import { t as isProviderStatusTerminal } from "./call-status-wKmxFyTS.js";
import { t as getHeader } from "./http-headers-D6V8P2Fy.js";
...
function loadRealtimeTranscriptionRuntime() {
	realtimeTranscriptionRuntimePromise ??= import("./realtime-transcription.runtime-BRSSa8nP.js");
	return realtimeTranscriptionRuntimePromise;
}
function loadResponseGeneratorModule() {
	responseGeneratorModulePromise ??= import("./response-generator-BRiKyqFY.js");
...
function loadTelnyxProvider() {
	telnyxProviderPromise ??= import("./telnyx-DsqaL8n1.js");
	return telnyxProviderPromise;
}
function loadTwilioProvider() {
	twilioProviderPromise ??= import("./twilio-k8rEW5Yi.js");
	return twilioProviderPromise;
}
function loadPlivoProvider() {
	plivoProviderPromise ??= import("./plivo-BPLeFsyQ.js");
	return plivoProviderPromise;
}
function loadMockProvider() {
	mockProviderPromise ??= import("./mock-9HcmGy0B.js");
	return mockProviderPromise;
}
function loadRealtimeVoiceRuntime() {
	realtimeVoiceRuntimePromise ??= import("./realtime-voice.runtime-AIOU7JbK.js");
	return realtimeVoiceRuntimePromise;
}
function loadRealtimeHandler() {
	realtimeHandlerPromise ??= import("./realtime-handler-DyCD9qir.js");
