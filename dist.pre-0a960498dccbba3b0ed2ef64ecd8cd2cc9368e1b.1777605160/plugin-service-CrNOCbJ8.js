...
import { a as selectDefaultNodeFromList, i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-5z3YTeFr.js";
...
import "./browser-config-runtime-oMLGrWGo.js";
...
import "./browser-setup-tools-C668xHiF.js";
import "./channel-actions-DDS2_Lh_.js";
import { _ as browserStop, a as untrackSessionBrowserTab, d as browserOpenTab, f as browserProfiles, g as browserStatus, h as browserStart, i as trackSessionBrowserTab, l as browserDoctor, m as browserSnapshot, o as browserCloseTab, r as touchSessionBrowserTab, u as browserFocusTab, y as browserTabs } from "./session-tab-registry-RS_PIcXT.js";
import { c as DEFAULT_AI_SNAPSHOT_MAX_CHARS, i as resolveExistingPathsWithinRoot, r as DEFAULT_UPLOAD_DIR } from "./paths-OewqgaMG.js";
import { a as applyBrowserProxyPaths, c as browserPdfSave, d as browserArmFileChooser, f as browserNavigate, i as resolveRequestedBrowserProfile, l as browserAct, n as isPersistentBrowserProfileMutation, o as persistBrowserProxyFiles, p as browserScreenshotAction, s as browserConsoleMessages, u as browserArmDialog } from "./browser-runtime-DEDZoWKp.js";
import { n as resolveProfile, t as resolveBrowserConfig } from "./config-Cm7sIopm.js";
import { f as redactCdpUrl } from "./cdp.helpers-CS2qpufG.js";
import { r as getBrowserProfileCapabilities } from "./target-id-C4EIuOUU.js";
import { l as normalizeBrowserFormField, u as normalizeBrowserFormFieldValue } from "./pw-role-snapshot-DTdgGg_W.js";
import { a as createBrowserRouteDispatcher, r as startBrowserControlServiceFromConfig, t as createBrowserControlContext } from "./control-service-BK1uxx4N.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-Di0_v6ZT.js"),
