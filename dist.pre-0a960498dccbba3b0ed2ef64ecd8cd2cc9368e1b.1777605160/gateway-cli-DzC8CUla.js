...
import { t as addGatewayServiceCommands } from "./register-service-commands-CuXqr7oq.js";
...
import { a as loadConfig, g as recoverConfigFromLastKnownGood, h as recoverConfigFromJsonRootSuffix, l as readBestEffortConfig, r as createConfigIO, u as readConfigFileSnapshot, y as writeConfigFile } from "./io-Cs-0dhMf.js";
...
import { d as writeRestartSentinel } from "./restart-sentinel-klpP7uhM.js";
import { a as markGatewaySigusr1RestartHandled, i as isGatewaySigusr1RestartExternallyAllowed, l as triggerOpenClawRestart, o as scheduleGatewaySigusr1Restart, t as consumeGatewaySigusr1RestartAuthorization } from "./restart-FpYKICur.js";
import { d as waitForActiveEmbeddedRuns, r as getActiveEmbeddedRunCount, t as abortEmbeddedPiRun } from "./runs-D5h4YOhz.js";
import { _ as selectDiagnosticStabilitySnapshot, f as writeDiagnosticStabilityBundleForFailureSync, h as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-bundle-Cg-cKnJ1.js";
import { n as parseTimeoutMsWithFallback } from "./parse-timeout-DF24GSy6.js";
import { n as withProgress } from "./progress-BhsLXO7a.js";
import { n as runCommandWithRuntime } from "./cli-utils-CbmVmCfU.js";
import { n as setGatewayWsLogStyle } from "./ws-logging-Cdb31_nJ.js";
import { t as formatHelpExamples } from "./help-format-BmLb5LMT.js";
import { t as readSecretFromFile } from "./secret-file-B2ms-gf2.js";
import { n as buildGatewayDiscoveryTarget } from "./gateway-discovery-targets-5Wfl8bDR.js";
import { o as resolveControlUiRootSync } from "./control-ui-assets-BsbKO338.js";
import { n as acquireGatewayLock, t as GatewayLockError } from "./gateway-lock-BqsbJC1r.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-D2V1Vc23.js";
import { o as handleReset } from "./onboard-helpers-kWtX-W4f.js";
...
async function runGatewayCommand$1(opts) {
	...
	const { startGatewayServer } = await startupTrace.measure("cli.server-import", () => withProgress({
		...
		indeterminate: true
	}, async () => import("./server-DpxBq_Am.js")));
...
function loadConfigModule() {
	configModulePromise ??= import("./read-best-effort-config.runtime-CPsX9Kmg.js");
	return configModulePromise;
}
function loadGatewayStatusModule() {
	gatewayStatusModulePromise ??= import("./gateway-status-DMsVfVHz.js");
	return gatewayStatusModulePromise;
}
function loadGatewayHealthModule() {
	gatewayHealthModulePromise ??= import("./health-hE0p50zn.js");
	return gatewayHealthModulePromise;
}
function loadBonjourDiscoveryModule() {
	bonjourDiscoveryModulePromise ??= import("./bonjour-discovery-Bap0Jh_K.js");
	return bonjourDiscoveryModulePromise;
}
function loadWideAreaDnsModule() {
	wideAreaDnsModulePromise ??= import("./widearea-dns-B2Wh9mfi.js");
	return wideAreaDnsModulePromise;
}
function loadHealthStyleModule() {
	healthStyleModulePromise ??= import("./health-style-BpmhVr6t.js");
	return healthStyleModulePromise;
}
function loadUsageFormatModule() {
	usageFormatModulePromise ??= import("./usage-format-Ctu393VF.js");
	return usageFormatModulePromise;
}
function loadStabilityBundleModule() {
	stabilityBundleModulePromise ??= import("./diagnostic-stability-bundle-C_08bBKx.js");
	return stabilityBundleModulePromise;
}
function loadSupportExportModule() {
	supportExportModulePromise ??= import("./diagnostic-support-export-CFl2ujJm.js");
	return supportExportModulePromise;
}
function loadDaemonStatusGatherModule() {
	daemonStatusGatherModulePromise ??= import("./status.gather-Dc82o7aR.js");
