...
import "./net-kxRrP1gq.js";
import { n as getBridgeAuthForPort } from "./bridge-auth-registry-CEMWXL7T.js";
import { t as resolveBrowserRateLimitMessage } from "./rate-limit-message-F4J6PJzL.js";
...
async function fetchBrowserJson(url, init) {
	...
	try {
		...
		const { dispatchBrowserControlRequest } = await import("./local-dispatch.runtime-C-6Lsp_Z.js");
