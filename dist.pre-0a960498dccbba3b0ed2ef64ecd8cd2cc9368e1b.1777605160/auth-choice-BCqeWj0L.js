...
import { o as hasUsableCustomProviderApiKey } from "./model-auth-CMq_TSIy.js";
import { t as applyAuthChoiceLoadedPluginProvider } from "./provider-auth-choice-NvK_K0FO.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-C5LtKHk7.js";
import "./provider-auth-choice-preference-BtpeOsCB.js";
...
async function normalizeLegacyChoice(authChoice, params) {
	...
	const { normalizeLegacyOnboardAuthChoice } = await import("./auth-choice-legacy-XWrTfmdn.js");
...
async function normalizeTokenProviderChoice(params) {
	...
	const { normalizeApiKeyTokenProviderAuthChoice } = await import("./auth-choice.apply.api-providers-C4SBbr4m.js");
...
async function formatDeprecatedProviderChoiceError(authChoice, params) {
	...
	const { resolveManifestDeprecatedProviderAuthChoice } = await import("./provider-auth-choices-eH_vpsFI.js");
