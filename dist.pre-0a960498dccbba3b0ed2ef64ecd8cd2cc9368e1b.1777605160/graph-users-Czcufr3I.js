...
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, l as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-DqC2suTV.js";
import "./ssrf-runtime-BMO6XEyq.js";
import { t as getMSTeamsRuntime } from "./runtime-api-CZyua8XN.js";
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-MgmDK-ey.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-D6wxzJMU.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-BwhNY6PJ.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("./jsonwebtoken-CxmPc7SD.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-KSGLAuw8.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwt, { JwksClient }]) => ({
		jwt,
		JwksClient
	}));
