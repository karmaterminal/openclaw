...
import { i as resolveMirroredTranscriptText } from "./transcript-CN7xoU1S.js";
import { a as projectOutboundPayloadPlanForDelivery, l as summarizeOutboundPayloadForTransport, t as createOutboundPayloadPlan } from "./payloads-mE51ebOD.js";
import { C as createReplyToDeliveryPolicy } from "./reply-payload-CTjR9c6j.js";
import { t as resolveAgentScopedOutboundMediaAccess } from "./read-capability-ptQ39rrt.js";
import { a as hasReplyPayloadContent, c as normalizeMessagePresentation, u as renderMessagePresentationFallbackText } from "./payload-mAeXZgVh.js";
import { c as resolveTextChunkLimit, i as chunkMarkdownTextWithMode, n as chunkByParagraph, s as resolveChunkMode } from "./chunk-Bv_ioeL6.js";
import { t as loadChannelOutboundAdapter } from "./load-CifVyZf1.js";
import { a as toInternalMessageSentContext, d as toPluginMessageSentEvent, l as toPluginMessageContext, t as buildCanonicalSentMessageHookContext } from "./message-hook-mappers-BnVn4KM0.js";
import { c as enqueueDelivery, o as withActiveDeliveryClaim, s as ackDelivery, u as failDelivery } from "./delivery-queue-3eRFHUJ0.js";
...
async function loadTranscriptRuntime() {
	transcriptRuntimePromise ??= import("./transcript.runtime-wFcB60d5.js");
	return await transcriptRuntimePromise;
}
let channelBootstrapRuntimePromise;
async function loadChannelBootstrapRuntime() {
	channelBootstrapRuntimePromise ??= import("./channel-bootstrap.runtime-D89KwGH1.js");
