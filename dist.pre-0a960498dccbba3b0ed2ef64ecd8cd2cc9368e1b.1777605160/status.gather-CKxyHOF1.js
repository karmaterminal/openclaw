...
function loadGatewayProbeAuthModule() {
	gatewayProbeAuthModulePromise ??= import("./probe-auth-D258ZYSf.js");
...
function loadDaemonProbeModule() {
	daemonProbeModulePromise ??= import("./probe-DW0xTco0.js");
	return daemonProbeModulePromise;
}
function loadRestartHealthModule() {
	restartHealthModulePromise ??= import("./restart-health-DI1DhVKp.js");
