...
import { a as stripUnknownConfigKeys, r as noteOpencodeProviderOverrides } from "./doctor-config-analysis-By0iVUUv.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-CT0e9dD3.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-ByTF-xHA.js";
import { t as asObjectRecord } from "./object-DAlKFsgY.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-DUNBGS_R.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-1X-Fl4Tr.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-CzyTTT7d.js");
		emitDoctorNotes({
			note,
