...
import { W as getShellEnvAppliedKeys, q as shouldEnableShellEnvFallback, r as createConfigIO } from "./io-Cs-0dhMf.js";
...
import { i as ensureAuthProfileStoreWithoutExternalProfiles } from "./store-DQMFx95A.js";
...
import { i as discoverModels, l as resolveRuntimeSyntheticAuthProviderRefs, r as discoverAuthStorage } from "./pi-model-discovery-BCjdY3CQ.js";
...
import { o as resolveProfileUnusableUntilForDisplay } from "./usage-3PEExF-O.js";
import "./profiles-B2kNMwPI.js";
import { i as getCustomProviderApiKey, l as resolveUsableCustomProviderApiKey, o as hasUsableCustomProviderApiKey } from "./model-auth-CMq_TSIy.js";
import { n as shouldSuppressBuiltInModel } from "./model-suppression-CjSpp6Yq.js";
import { r as resolveModelWithRegistry } from "./model-BtcIsxoB.js";
import { f as isLocalBaseUrl, i as formatTokenK, n as ensureFlagCompatibility, s as resolveKnownAgentId } from "./shared-DV-WglXT.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-BZzkVt5p.js";
import { t as maskApiKey } from "./mask-api-key-DJJ2J0jV.js";
import { n as loadModelsConfigWithSource, t as loadModelsConfig } from "./load-config-FqVkL4hK.js";
import { n as loadProviderCatalogModelsForList, t as hasProviderStaticCatalogForFilter } from "./list.runtime-DAUWw2EY.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-DvfYsuPO.js";
...
async function modelsListCommand(opts, runtime) {
	...
	const { ensureAuthProfileStore, resolveOpenClawAgentDir } = await import("./list.runtime-Cb1XSwMx.js");
...
function loadProviderUsageRuntime() {
	providerUsageRuntimePromise ??= import("./provider-usage-BFi1KwhI.js");
	return providerUsageRuntimePromise;
}
function loadProgressRuntime() {
	progressRuntimePromise ??= import("./progress-Ml2qkfIo.js");
	return progressRuntimePromise;
}
function loadTerminalTableRuntime() {
	terminalTableRuntimePromise ??= import("./table-B_Kakn38.js");
	return terminalTableRuntimePromise;
}
function loadListProbeRuntime() {
	listProbeRuntimePromise ??= import("./list.probe-C2F1XhqB.js");
...
async function modelsStatusCommand(opts, runtime) {
	...
	if (missingProvidersInUse.length > 0) {
		const { buildProviderAuthRecoveryHint } = await import("./provider-auth-guidance-CI2-kxRZ.js");
		runtime.log("");
