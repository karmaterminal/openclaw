...
import { F as unsetConfigOverride, M as getConfigOverrides, N as resetConfigOverrides, P as setConfigOverride, T as validateConfigObjectWithPlugins, u as readConfigFileSnapshot, y as writeConfigFile } from "./io-Cs-0dhMf.js";
...
import { x as prepareProviderRuntimeAuth } from "./provider-runtime-DfaoEnkb.js";
...
import { i as formatUsd, r as formatTokenCount } from "./usage-format-BqSt4EQw.js";
...
import { C as safeTrajectorySessionFileName, S as resolveTrajectoryPointerFilePath, T as sanitizeDiagnosticPayload, b as TRAJECTORY_RUNTIME_FILE_MAX_BYTES, w as safeJsonStringify, x as resolveTrajectoryFilePath } from "./selection-9GHZrR2e.js";
...
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-COeZk8QH.js";
import { h as resolveBootstrapTotalMaxChars, p as resolveBootstrapMaxChars } from "./pi-embedded-helpers-B8QlHRbO.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-D6h4jsAt.js";
import { i as resolveImageSanitizationLimits, n as sanitizeImageBlocks } from "./tool-images-BSIcuxrK.js";
...
import { m as stripToolResultDetails } from "./transport-stream-shared-DwtR4Xuz.js";
import { i as unsetConfiguredMcpServer, r as setConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-Gt3b6OQQ.js";
...
import { l as triggerOpenClawRestart, o as scheduleGatewaySigusr1Restart } from "./restart-FpYKICur.js";
import { i as resolveReplyToMode } from "./reply-threading-CJ71KlrN.js";
import { _ as authorizeConfigWriteShared, b as resolveConfigWriteTargetFromPathShared, v as canBypassConfigWritePolicyShared, y as formatConfigWriteDeniedMessageShared } from "./channel-config-helpers-BNx8Xp72.js";
...
import { r as getSessionBindingService } from "./session-binding-service-DFVUkX4d.js";
import { h as replyRunRegistry, i as getActiveEmbeddedRunSnapshot } from "./runs-D5h4YOhz.js";
import "./diagnostic-BTZAq-3K.js";
import { t as formatDurationCompact } from "./format-duration-_KqG-DQd.js";
import "./sandbox-mpsArbFr.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-DRzFmFgd.js";
import { n as estimateTokensFromChars } from "./cjk-chars-BZs0V7gR.js";
import { i as streamWithPayloadPatch } from "./moonshot-thinking-stream-wrappers-DbZ_E7pR.js";
import { r as resolveModelWithRegistry } from "./model-BtcIsxoB.js";
import { i as matchPluginCommand, n as executePluginCommand } from "./commands-Bgq7l_uI.js";
import { t as isApprovalNotFoundError } from "./approval-errors-Du3BnN_m.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-7Rm4MjdQ.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-BGasdcPh.js";
import "./commands-registry-D4AACI9g.js";
import { n as formatTimeAgo } from "./format-relative-B39tx_LC.js";
import { o as stripMentions, s as stripStructuralPrefixes } from "./mentions-uwZ9eLDX.js";
import { n as setChannelConversationBindingMaxAgeBySessionKey, t as setChannelConversationBindingIdleTimeoutBySessionKey } from "./conversation-bindings-C88tc04Z.js";
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-BySps0XL.js";
import { i as installPluginFromPath, r as installPluginFromNpmSpec } from "./install-B-5gFnML.js";
import { l as resolveArchiveKind } from "./archive-DtEYW_wZ.js";
import { n as isImplicitSameChatApprovalAuthorization } from "./approval-auth-helpers-BHraAnqU.js";
import { n as parseActivationCommand } from "./group-activation-Czca6lUE.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-BoB7P9lK.js";
import { _ as getFinishedSession, v as getSession } from "./bash-tools.exec-runtime-BYqHr4g8.js";
import { t as resolveFastModeState } from "./fast-mode-CSpLc0QA.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-B-ch3yfS.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-DjkSd0EU.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-C4CPA59r.js";
import { a as shouldPersistAbortCutoff, i as resolveAbortCutoffFromContext, t as applyAbortCutoffToSessionEntry } from "./abort-cutoff-CbSQHsYx.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-BYGunQXf.js";
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-BAQQ6ttS.js";
import { n as resolveSessionEntryForKey, r as stopSubagentsForRequester, t as formatAbortReplyText } from "./abort-BM9-2n9G.js";
import { t as extractBtwQuestion } from "./btw-command-BJUhzqGJ.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-BCXChl_o.js";
...
import { a as requireGatewayClientScopeForInternalChannel, i as requireCommandFlagEnabled, n as rejectNonOwnerCommand, r as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates-CbzltRLm.js";
import { t as handleAcpCommand } from "./commands-acp-BgGaFQr-.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-D0VGs2BJ.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-D3iT2iWf.js";
import { r as handleModelsCommand } from "./commands-models-v82TyHzB.js";
import { n as setPluginEnabledInConfig } from "./enable-C5mUk-Fm.js";
import { r as createExecTool } from "./bash-tools-_CECCBWM.js";
import { n as listTasksForAgentIdForStatus, r as listTasksForSessionKeyForStatus } from "./status-text-BeseNb9L.js";
import { d as resolveChannelAccountId, f as resolveCommandSurfaceChannel, l as resolveSubagentsAction, o as resolveHandledPrefix, s as resolveRequesterSessionKey, u as stopWithText } from "./shared-YID8GUZz.js";
import { t as buildToolsMessage } from "./status-CgqymaYA.js";
import { t as parseConfigValue } from "./config-value-Dxdhk_Sl.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-B5rhpcd8.js";
import { a as writeSupportBundleDirectory, i as textSupportBundleFile, n as jsonlSupportBundleFile, r as supportBundleContents, t as jsonSupportBundleFile } from "./diagnostic-support-bundle-Bog2h1fs.js";
import { t as buildStatusReply } from "./commands-status-BQtAY_D7.js";
import { i as buildNpmInstallRecordFields, n as persistPluginInstall } from "./plugins-install-persist-2GSOC_C8.js";
import { m as parseClawHubPluginSpec } from "./clawhub-GcvbkKj1.js";
import { r as installPluginFromClawHub } from "./clawhub-SxQsNxYY.js";
import { a as buildPluginDiagnosticsReport, c as formatPluginCompatibilityNotice, o as buildPluginInspectReport, s as buildPluginSnapshotReport, t as buildAllPluginInspectReports } from "./status-DSJx1_6g.js";
import { a as decidePreferredClawHubFallback, i as createPluginInstallLogger, n as buildPreferredClawHubSpec, u as resolveFileNpmSpecToLocalPath } from "./plugins-command-helpers-C1j_j1DM.js";
import { n as loadCostUsageSummary, r as loadSessionCostSummary } from "./session-cost-usage-BerRvLoj.js";
...
function loadCompactRuntime() {
	compactRuntimePromise ??= import("./commands-compact.runtime-DN9yjDkN.js");
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-CRKxPF_A.js");
...
async function abortEmbeddedPiRunForSession(sessionId) {
	const { abortEmbeddedPiRun } = await import("./runs-LS7DZi1a.js");
...
function loadAgentsAction() {
	actionAgentsPromise ??= import("./action-agents-18Kls_pr.js");
	return actionAgentsPromise;
}
function loadFocusAction() {
	actionFocusPromise ??= import("./action-focus-6EOoMfnx.js");
	return actionFocusPromise;
}
function loadHelpAction() {
	actionHelpPromise ??= import("./action-help-Dt5gpbK8.js");
	return actionHelpPromise;
}
function loadInfoAction() {
	actionInfoPromise ??= import("./action-info-Cdiyb4IA.js");
	return actionInfoPromise;
}
function loadKillAction() {
	actionKillPromise ??= import("./action-kill-D9HJ6YUp.js");
	return actionKillPromise;
}
function loadListAction() {
	actionListPromise ??= import("./action-list-CILLuiL1.js");
	return actionListPromise;
}
function loadLogAction() {
	actionLogPromise ??= import("./action-log-BuHcjg6J.js");
	return actionLogPromise;
}
function loadSendAction() {
	actionSendPromise ??= import("./action-send-D9_WfvtJ.js");
	return actionSendPromise;
}
function loadSpawnAction() {
	actionSpawnPromise ??= import("./action-spawn-yv3TXGYg.js");
	return actionSpawnPromise;
}
function loadUnfocusAction() {
	actionUnfocusPromise ??= import("./action-unfocus-Cgtdy7MY.js");
	return actionUnfocusPromise;
}
function loadControlRuntime() {
	controlRuntimePromise ??= import("./commands-subagents-control.runtime-XulbckvC.js");
