...
import { $ as normalizeTalkSection, B as shouldAttemptLastKnownGoodRecovery, Q as buildTalkConfigResponse, T as validateConfigObjectWithPlugins, a as loadConfig, d as readConfigFileSnapshotForWrite, et as resolveActiveTalkProviderConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, v as resolveConfigSnapshotHash, y as writeConfigFile } from "./io-Cs-0dhMf.js";
...
import { r as parseByteSize } from "./zod-schema-DW34AVGd.js";
...
import { r as createPluginRuntimeLoaderLogger } from "./load-context-BB47lQng.js";
...
import { n as canonicalizeSpawnedByForAgent, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-DauKCWX4.js";
...
import { n as resolveMainSessionKeyFromConfig, t as extractDeliveryInfo } from "./sessions-BL1W8Rqf.js";
...
import { h as listSessionCompactionCheckpoints, m as getSessionCompactionCheckpoint } from "./build-BkZjNPT-.js";
import { a as normalizeCronJobPatch, r as normalizeCronJobCreate } from "./openclaw-tools-ijusjTUt.js";
import { _ as listCoreToolSections, h as PROFILE_OPTIONS, v as resolveCoreToolProfiles } from "./tool-policy-DArLXMH2.js";
import { n as getPluginToolMeta, r as resolvePluginTools } from "./tools-DHDhlGv0.js";
...
import { s as projectOutboundPayloadPlanForMirror, t as createOutboundPayloadPlan } from "./payloads-mE51ebOD.js";
import { g as writeFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-oiDsgdG5.js";
import { d as mergeExecApprovalsSocketDefaults, j as saveExecApprovals, o as ensureExecApprovals, p as normalizeExecApprovals, y as readExecApprovalsSnapshot } from "./exec-approvals-CZzmozBt.js";
import { a as prepareSecretsRuntimeSnapshot } from "./runtime-1uIT6Nh9.js";
import { i as parseAbsoluteTimeMs } from "./stagger-CN4nJJfi.js";
import { r as isInvalidCronSessionTargetIdError } from "./webhook-url-CEZJq98V.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint } from "./restart-sentinel-klpP7uhM.js";
import { o as scheduleGatewaySigusr1Restart } from "./restart-FpYKICur.js";
import { o as listConfiguredAnnounceChannelIdsForConfig, r as resolveGatewayStartupPluginIds } from "./channel-plugin-ids-if36pfk7.js";
import { i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry, s as dispatchChannelMessageAction } from "./message-action-runner-Bq1aB5aR.js";
import { n as normalizePollInput } from "./polls-DelONDPY.js";
import { t as deliverOutboundPayloads } from "./deliver-CZ41aYzI.js";
import { n as resolveOutboundChannelPlugin } from "./channel-resolution-Bs_uhnQ6.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-CDE2pIGy.js";
import "./target-resolver-CMJZjpqI.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-Bq2dfAK4.js";
import { i as resolveReplyToMode } from "./reply-threading-CJ71KlrN.js";
...
import { t as extractToolPayload } from "./tool-payload-BoE6SrU6.js";
import { i as setHeartbeatsEnabled } from "./heartbeat-wake-Dm7bh0gq.js";
import { i as enqueueSystemEvent, o as isSystemEventContextChanged } from "./system-events-BjB5IdNm.js";
import { r as createRunningTaskRun } from "./detached-task-runtime-Bi2QiaeH.js";
import { a as clearSessionQueues } from "./queue-BZMzpG6G.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-CsqWsIVB.js";
import { a as isEmbeddedPiRunActive, f as waitForEmbeddedPiRunEnd, t as abortEmbeddedPiRun } from "./runs-D5h4YOhz.js";
import { h as normalizeDiagnosticStabilityQuery, m as getDiagnosticStabilitySnapshot } from "./diagnostic-stability-bundle-Cg-cKnJ1.js";
import { t as resolveAgentTimeoutMs } from "./timeout-BSZPJ2oJ.js";
import { n as normalizeSpawnedRunMetadata, r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-DogLjeHx.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-9W7oRVFf.js";
import "./skills-Btkps-SF.js";
import { n as getActiveMemorySearchManager } from "./memory-runtime-DTgDT7rc.js";
...
import { t as primeConfiguredBindingRegistry } from "./binding-registry-Dn2B9G2h.js";
import { r as listPluginCommands } from "./commands-Bgq7l_uI.js";
import { i as setGatewaySubagentRuntime, r as setGatewayNodesRuntime } from "./gateway-bindings-CMuu0Tg0.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-jNJkwNLT.js";
import "./commands-registry-D4AACI9g.js";
import { n as resolveSendPolicy } from "./send-policy-BCC93Y8r.js";
import { t as getChannelActivity } from "./channel-activity-FZ93teQL.js";
import { t as WizardCancelledError } from "./prompts-Ck2Wx8_A.js";
import { t as canExecRequestNode } from "./exec-defaults-BQ7skj0T.js";
import { t as bumpSkillsSnapshotVersion } from "./refresh-state-D0ogm_8K.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-vPOLvEM2.js";
import { o as resolveMissingRequestedScope } from "./pairing-token-DByFqE8R.js";
import { d as listNodePairing, f as rejectNodePairing, g as verifyNodeToken, l as approveNodePairing, m as requestNodePairing, p as renamePairedNode, t as getRemoteSkillEligibility } from "./skills-remote-CjhhXACg.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-Duph_1Xu.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-BYGunQXf.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-zr_buL6o.js";
import { r as getLastHeartbeatEvent } from "./heartbeat-visibility-BDmj580Q.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-ChcOhUj7.js";
import { r as agentCommandFromIngress } from "./agent-command-uRL9jfpA.js";
import { n as getSpeechProvider, r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-DXdtWOGx.js";
import { n as invokeNativeHookRelay } from "./native-hook-relay-zB9Yio9X.js";
import { i as resolveNodeCommandAllowlist, n as isNodeCommandAllowed } from "./node-command-policy-yBidsnFj.js";
import { t as formatForLog } from "./ws-log-BYZ35pF9.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-REkZ2K6A.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-D3iT2iWf.js";
import { a as getPairedDevice, c as listApprovedPairedDeviceRoles, d as rejectDevicePairing, f as removePairedDevice, g as summarizeDeviceTokens, h as rotateDeviceToken, i as formatDevicePairingForbiddenMessage, l as listDevicePairing, m as revokeDeviceToken, n as approveDevicePairing, o as getPendingDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-gyUHV37b.js";
import { o as REALTIME_VOICE_AGENT_CONSULT_TOOL, r as getRealtimeVoiceProvider, s as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, t as resolveConfiguredRealtimeVoiceProvider } from "./provider-resolver-L8rr-So-.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-Bf_HeWci.js";
import { n as createOutboundSendDeps } from "./deps-Cq4bhoB8.js";
import "./agent-DsPVFS2Y.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-BB7p0hMF.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-B05_cooe.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-D51J2kqR.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-a22uZq3W.js";
import { d as waitForTerminalGatewayDedupe, g as resolveAgentRunExpiresAtMs, h as registerChatAbortController, i as chatHandlers, l as readTerminalSnapshotFromGatewayDedupe, u as setGatewayDedupeEntry } from "./chat-DXh8ruG3.js";
import { n as MediaOffloadError, r as parseMessageWithAttachments, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-4Op7uJYb.js";
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp-BBbE9JsC.js";
import { t as resolveSessionKeyFromResolveParams } from "./sessions-resolve-3tZqydpd.js";
import { t as loadProviderUsageSummary } from "./provider-usage-B5lpk80z.js";
import { o as fetchClawHubSkillDetail } from "./clawhub-GcvbkKj1.js";
import { a as loadSessionUsageTimeSeries, i as loadSessionLogs, n as loadCostUsageSummary, o as resolveExistingUsageSessionFile, r as loadSessionCostSummary, t as discoverAllSessions } from "./session-cost-usage-BerRvLoj.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-BZzkVt5p.js";
import { n as movePathToTrash } from "./browser-maintenance-8a66EGsf.js";
import { a as performGatewaySessionReset } from "./session-reset-service-DKY4LN_V.js";
import { t as buildChannelUiCatalog } from "./catalog-BtogljO3.js";
import { a as removeBackfillDiaryEntries, c as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeGroundedShortTermCandidates, r as previewGroundedRemMarkdown, s as repairDreamingArtifacts } from "./memory-core-bundled-runtime-DX3vua3J.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-C_YIR7hB.js";
import { t as readConfiguredLogTail } from "./log-tail-CKzcblRx.js";
import { n as purgeAgentSessionStoreEntries } from "./agents.command-shared-BL0iNor8.js";
import { o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-DpoUQw0S.js";
import { t as installSkill } from "./skills-install-mWntl3zR.js";
import { m as normalizeUpdateChannel } from "./update-check-B5ItF2u5.js";
import "./status-C0KsmEhC.js";
import { t as getStatusSummary } from "./status.summary-DbSLje_d.js";
import { i as updateSkillsFromClawHub, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-Hqj2ZO-B.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-QgWpRb8f.js";
import { t as runGatewayUpdate } from "./update-runner-gtIWEPRP.js";
import { t as buildChannelAccountSnapshot } from "./status-CRuGoYfA.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-CwzqviJP.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-YTulagib.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-Dzl4PKOQ.js";
import "./heartbeat-runner-DARPD6S2.js";
...
async function loadSessionSubagentReactivationRuntime() {
	return import("./session-subagent-reactivation.runtime-CLz2M_9y.js");
}
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-D9HxZnAm.js");
...
function loadSessionsRuntimeModule() {
	sessionsRuntimeModulePromise ??= import("./sessions.runtime-D4MjwOFe.js");
