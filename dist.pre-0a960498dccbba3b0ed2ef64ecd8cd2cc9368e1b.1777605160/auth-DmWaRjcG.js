...
import { t as isRemoteEnvironment } from "./remote-env-Dr6tGY0_.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-BXC35zD8.js";
import { i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-fFxQnpez.js";
...
async function runProviderAuthMethod(params) {
	...
	await persistProviderAuthResult({
		result: await params.method.run({
			...
			openUrl: async (url) => {
				const { openUrl } = await import("./onboard-helpers-DNk55ZfM.js");
				await openUrl(url);
			},
