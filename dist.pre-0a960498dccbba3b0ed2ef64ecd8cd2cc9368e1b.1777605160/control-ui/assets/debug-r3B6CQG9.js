import{h as e,o as t,p as n}from"./string-coerce-B9QFF8sN.js";import{i as r}from"./index-CgWik_cm.js";function i(i){let a=(i.status&&typeof i.status==`object`?i.status.securityAudit:null)?.summary??null,o=a?.critical??0,s=a?.warn??0,c=a?.info??0,l=o>0?`danger`:s>0?`warn`:`success`,u=o>0?`${o} critical`:s>0?`${s} warnings`:`No critical issues`;return e`
    <section class="grid">
      <div class="card">
...
//# sourceMappingURL=debug-r3B6CQG9.js.map