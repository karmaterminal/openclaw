...
import { G as getShellPathFromLoginShell, K as resolveShellEnvFallbackTimeoutMs } from "./io-Cs-0dhMf.js";
...
import { C as formatExecDeniedUserMessage, T as parseExecApprovalResultText, u as sanitizeUserFacingText, w as isExecDeniedResultText } from "./sanitize-user-facing-text-DhtkBIxZ.js";
import { o as failedTextResult, v as textResult } from "./common-CKql4nPs.js";
import { t as callGatewayTool } from "./gateway-Be16iQej.js";
import { t as splitShellArgs } from "./shell-argv-BcjEUjJp.js";
import { c as describeInterpreterInlineEval, f as analyzeShellCommand, l as detectInterpreterInlineEvalArgv, n as evaluateShellAllowlist, p as buildEnforcedShellCommand } from "./exec-approvals-allowlist-CkdrKC-y.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-aM-g86tz.js";
import { C as requiresExecApproval, D as resolveExecApprovalsFromFile, E as resolveExecApprovals, _ as normalizeExecTarget, a as addDurableCommandApproval, b as recordAllowlistMatchesUse, f as minSecurity, g as normalizeExecSecurity, l as loadExecApprovals, m as normalizeExecAsk, s as hasDurableExecApproval, u as maxAsk, v as persistAllowAlwaysPatterns, w as resolveExecApprovalAllowedDecisions } from "./exec-approvals-CZzmozBt.js";
...
import { i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-5z3YTeFr.js";
import { t as sendMessage } from "./message-Cw41Ckus.js";
import { t as resolveExternalBestEffortDeliveryTarget } from "./best-effort-delivery-CsqWsIVB.js";
...
import { a as coerceEnv, c as readEnvInt, d as sliceLogLines, f as truncateMiddle, i as clampWithDefault, l as resolveSandboxWorkdir, n as buildSandboxEnv, o as deriveSessionName, s as pad, u as resolveWorkdir } from "./bash-tools.shared-CyhHbbRp.js";
import { f as resolveExecApprovalInitiatingSurfaceState, s as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-ebp3Wua1.js";
import { i as normalizePathPrepend, t as applyPathPrepend } from "./path-prepend-DL2DydGO.js";
import { t as getProcessSupervisor } from "./supervisor-Dp38qxda.js";
import { C as setJobTtlMs, S as markExited, _ as getFinishedSession, a as DEFAULT_PENDING_MAX_OUTPUT, b as listRunningSessions, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, g as drainSession, h as deleteSession, i as DEFAULT_PATH, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput, v as getSession, w as tail, x as markBackgrounded, y as listFinishedSessions } from "./bash-tools.exec-runtime-BYqHr4g8.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-B05_cooe.js";
import { n as recordCommandPoll, r as resetCommandPollCount } from "./command-poll-backoff-CcQtkLmP.js";
...
async function loadFsSafeModule() {
	fsSafeModulePromise ??= import("./fs-safe-CYOJ2ntB.js");
