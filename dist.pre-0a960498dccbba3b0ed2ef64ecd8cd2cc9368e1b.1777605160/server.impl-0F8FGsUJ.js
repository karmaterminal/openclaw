...
import { G as validateExecApprovalResolveParams, U as validateExecApprovalGetParams, W as validateExecApprovalRequestParams, _t as validateRequestFrame, an as errorShape, cn as getPreauthHandshakeTimeoutMsFromEnv, in as ErrorCodes, k as validateConnectParams, ln as buildDeviceAuthPayload, mt as validatePluginApprovalResolveParams, pt as validatePluginApprovalRequestParams, r as formatValidationErrors, un as buildDeviceAuthPayloadV3, vt as validateSecretsResolveParams, yt as validateSecretsResolveResult } from "./client-DZasTKpK.js";
...
import { o as resetModelCatalogCache, r as loadModelCatalog } from "./model-catalog-CnUqgj64.js";
...
import { t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-DauKCWX4.js";
...
import { o as updateSessionStore, s as updateSessionStoreEntry, t as archiveRemovedSessionTranscripts } from "./store-Ci-m4oZ1.js";
import { n as resolveMainSessionKeyFromConfig } from "./sessions-BL1W8Rqf.js";
...
import { o as startGatewayModelPricingRefresh } from "./usage-format-BqSt4EQw.js";
...
import { a as loadSessionEntry, d as resolveGatewaySessionStoreTarget, i as loadGatewaySessionRow } from "./session-utils-IrNZpZWa.js";
import { i as enqueueCommandInLane, s as getTotalQueueSize, u as setCommandLaneConcurrency } from "./command-queue-B716cKY1.js";
import { c as stripLeadingSilentToken, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken } from "./tokens-CPoUE_99.js";
import { s as stripHeartbeatToken } from "./heartbeat-O3b-eLDX.js";
import { i as normalizeCronJobInput } from "./openclaw-tools-ijusjTUt.js";
import { t as getMachineDisplayName } from "./machine-name-DCMjedLv.js";
import { t as detectMime } from "./mime-Zn7U6BSf.js";
import { o as resolveFailoverReasonFromError } from "./failover-error-DLvpkqiP.js";
import { t as SsrFBlockedError } from "./ssrf-CD_2fLNF.js";
import { n as fetchWithSsrFGuard } from "./fetch-guard-CXs9BnMd.js";
import { o as retireSessionMcpRuntime } from "./pi-bundle-mcp-runtime-DdX3YJcs.js";
import "./pi-bundle-mcp-tools-qRT695En.js";
import { t as loadGatewayTlsRuntime$1 } from "./gateway-CiYZBvtd.js";
import { T as resolveExecApprovalRequestAllowedDecisions, r as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS, w as resolveExecApprovalAllowedDecisions } from "./exec-approvals-CZzmozBt.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-1uIT6Nh9.js";
import { n as assertSafeCronSessionTargetId, r as isInvalidCronSessionTargetIdError, t as normalizeHttpWebhookUrl } from "./webhook-url-CEZJq98V.js";
import { c as setPreRestartDeferralCheck, n as deferGatewayRestartUntilIdle, r as emitGatewayRestart, s as setGatewaySigusr1RestartPolicy } from "./restart-FpYKICur.js";
import { r as cleanOldMedia } from "./store-D9jVYsha.js";
import { a as CANVAS_HOST_PATH, c as injectCanvasLiveReload, l as normalizeUrlPath, s as handleA2uiHttpRequest, u as resolveFileWithinRoot } from "./web-media-1yKSIgEY.js";
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-secret-gateway-gnyonUjN.js";
import { i as evaluateGatewayAuthSurfaceStates, r as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-web-tools-9oJlXbTn.js";
import { n as resolveConfiguredDeferredChannelPluginIds, r as resolveGatewayStartupPluginIds } from "./channel-plugin-ids-if36pfk7.js";
import { t as deliverOutboundPayloads } from "./deliver-CZ41aYzI.js";
import { r as resetDirectoryCache } from "./target-resolver-CMJZjpqI.js";
import { t as buildOutboundSessionContext } from "./session-context-D5z_EMAT.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-CKc1HMZb.js";
...
import { i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-Bi2QiaeH.js";
import { r as getActiveEmbeddedRunCount } from "./runs-D5h4YOhz.js";
import { h as stopDiagnosticHeartbeat, m as startDiagnosticHeartbeat } from "./diagnostic-BTZAq-3K.js";
import { c as initSubagentRegistry } from "./subagent-registry-Dz8Ktmwf.js";
import { a as onSessionLifecycleEvent } from "./subagent-registry-spawn-runtime-Chr1AuJE.js";
import { t as resolveAgentTimeoutMs } from "./timeout-BSZPJ2oJ.js";
import { c as resolveHookExternalContentSource, o as isExternalHookSession, s as mapHookExternalContentSource } from "./external-content-BsJ8m57k.js";
import { n as resolveCronStyleNow } from "./current-time-DC5rNLmC.js";
import { o as resolvePreferredSessionKeyForSessionIdMatches } from "./live-model-switch-Mg1_Yblo.js";
import { t as createPluginRuntime } from "./runtime-DJWyYpTM.js";
import { o as getTotalPendingReplies } from "./dispatch-Dr6l7gT6.js";
import { n as sanitizeInboundSystemTags } from "./inbound-text-CVGVk2Sz.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-OnD4-e3x.js";
import { c as formatExecApprovalExpiresIn, f as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-reply-ebp3Wua1.js";
import { t as CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "./approval-handler-adapter-runtime-BYAXvN_8.js";
import { n as sanitizeExecApprovalDisplayText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-DbllZxHW.js";
import { n as createChannelApprovalHandlerFromCapability } from "./approval-handler-runtime-VCPyXZ3s.js";
import { i as watchChannelRuntimeContexts, n as getChannelRuntimeContext, t as createTaskScopedChannelRuntime } from "./channel-runtime-context-Dt1vi_mi.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-krmR5cS3.js";
import { n as resolveCronStorePath, r as saveCronStore, t as loadCronStore } from "./store-DPV8Uh7u.js";
import { r as registerSkillsChangeListener } from "./refresh-state-D0ogm_8K.js";
import "./refresh-8NGaz0fL.js";
import { c as roleScopesAllow } from "./pairing-token-DByFqE8R.js";
import { a as refreshRemoteBinsForConnectedNodes, c as setSkillsRemoteRegistry, h as updatePairedNodeMetadata, i as recordRemoteNodeInfo, m as requestNodePairing, n as primeRemoteSkillsCache, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo, u as getPairedNode } from "./skills-remote-CjhhXACg.js";
import { i as onHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-BDmj580Q.js";
import { n as resolveAgentOutboundIdentity } from "./identity-BkxLWZSJ.js";
import { i as resolveNodeCommandAllowlist, r as normalizeDeclaredNodeCommands } from "./node-command-policy-yBidsnFj.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs, t as formatForLog } from "./ws-log-BYZ35pF9.js";
import { i as safeParseJson } from "./nodes.helpers-REkZ2K6A.js";
import { i as assertGatewayAuthNotKnownWeak, n as mergeGatewayAuthConfig, r as mergeGatewayTailscaleConfig, t as ensureGatewayStartupAuth } from "./startup-auth-CMBPJIDc.js";
import { r as resolveBootstrapProfileScopesForRole } from "./device-bootstrap-profile-Bx8TBe2r.js";
import { _ as updatePairedDeviceMetadata, a as getPairedDevice, c as listApprovedPairedDeviceRoles, l as listDevicePairing, n as approveDevicePairing, p as requestDevicePairing, r as ensureDeviceToken, s as hasEffectivePairedDeviceRole, t as approveBootstrapDevicePairing, u as listEffectivePairedDeviceRoles, v as verifyDeviceToken } from "./device-pairing-gyUHV37b.js";
import { a as redeemDeviceBootstrapTokenProfile, n as getBoundDeviceBootstrapProfile, o as revokeDeviceBootstrapToken, r as getDeviceBootstrapTokenProfile, s as verifyDeviceBootstrapToken } from "./device-bootstrap-DJDZCVc1.js";
import { t as createDefaultDeps } from "./deps-Cq4bhoB8.js";
import { i as buildSystemRunApprovalEnvBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-BB7p0hMF.js";
import { n as resolveSystemRunApprovalRequestContext } from "./system-run-approval-context-B05_cooe.js";
import { t as closeMcpLoopbackServer } from "./mcp-http-C4A1bKJi.js";
import { A as getHookSessionKeyPrefixError, B as resolveHookIdempotencyKey, C as setDefaultSecurityHeaders, D as extractHookToken, F as normalizeHookHeaders, H as resolveHookTargetAgentId, I as normalizeWakePayload, K as logRejectedLargePayload, L as readJsonBody, M as isSessionKeyAllowedByPrefix, N as normalizeAgentPayload, O as getHookAgentPolicyError, P as normalizeHookDispatchSessionKey, R as resolveHookChannel, U as resolveHooksConfig, V as resolveHookSessionKey, W as applyHookMappings, _ as loadGatewayModelCatalog, d as resolveHttpBrowserOriginPolicy, g as __resetModelCatalogCacheForTest, h as resolveTrustedHttpOperatorScopes, j as isHookAgentAllowed, k as getHookChannelError, o as getBearerToken, r as authorizeGatewayHttpRequestOrReply, s as getHeader, y as sendGatewayAuthFailure, z as resolveHookDeliver } from "./http-utils-4n--yoi7.js";
import { t as createOutboundSendDeps } from "./outbound-send-deps-DjgZLnXD.js";
import { C as TICK_INTERVAL_MS, S as MAX_PREAUTH_PAYLOAD_BYTES, _ as DEDUPE_MAX, b as MAX_BUFFERED_BYTES, f as isSuppressedControlReplyLeadFragment, m as abortChatRunById, p as isSuppressedControlReplyText, v as DEDUPE_TTL_MS, x as MAX_PAYLOAD_BYTES, y as HEALTH_REFRESH_INTERVAL_MS } from "./chat-DXh8ruG3.js";
import { t as cleanupBrowserSessionsForLifecycleEnd } from "./browser-lifecycle-cleanup-Dl8yN2wa.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-Dic3jon_.js";
import { a as writeWideAreaGatewayZone, i as resolveWideAreaDiscoveryDomain } from "./widearea-dns-Cm887aCG.js";
import { a as resolveControlUiRootOverrideSync, n as isPackageProvenControlUiRootSync, o as resolveControlUiRootSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-BsbKO338.js";
import { t as GatewayLockError } from "./gateway-lock-BqsbJC1r.js";
import { t as getHealthSnapshot } from "./health-Cb-lnkfM.js";
import { t as runSetupWizard } from "./setup-CqtRwqhL.js";
import { d as startTaskRegistryMaintenance, f as stopTaskRegistryMaintenance, g as markCronJobActive, h as clearCronJobActive, n as getInspectableTaskRegistrySummary } from "./task-registry.maintenance-Cvz-ubQt.js";
import { i as migrateOrphanedSessionKeys } from "./state-migrations-DVwjWdYZ.js";
import { _ as resolveDeliveryTarget, a as computeJobPreviousRunAtMs, c as findJobOrThrow, d as isJobEnabled, f as nextWakeAtMs, g as resolveJobPayloadTextForMain, h as recordScheduleComputeError, i as computeJobNextRunAtMs, l as hasScheduledNextRunAtMs, m as recomputeNextRunsForMaintenance, n as applyJobPatch, o as createJob, p as recomputeNextRuns, r as assertSupportedJobSpec, s as errorBackoffMs, t as DEFAULT_ERROR_BACKOFF_SCHEDULE_MS, u as isJobDue } from "./jobs-CwzqviJP.js";
import { t as createCronExecutionId } from "./run-id-BpBLKEkQ.js";
import { a as resolveHeartbeatAckMaxChars$1, i as resolveCronPayloadOutcome, t as isHeartbeatOnlyResponse } from "./helpers-B4UhPrQV.js";
import { a as resolveCronChannelOutputPolicy, n as markCronSessionPreRun, r as persistCronSkillsSnapshotIfChanged, t as createPersistCronSessionEntry } from "./run-session-state-BI5MHe6q.js";
import { t as runChannelPluginStartupMaintenance } from "./lifecycle-startup-6x7Mrwns.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-YTulagib.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-Dzl4PKOQ.js";
import { C as resolveGatewayReloadSettings, D as roleCanSkipDeviceIdentity, E as parseGatewayRole, O as pruneStaleControlPlaneBuckets, S as diffConfigPaths, T as buildGatewayReloadPlan, _ as appendCronRunLog, a as coreGatewayHandlers, b as resolveCronDeliveryPlan, c as listSystemPresence, d as CANVAS_CAPABILITY_TTL_MS, f as buildCanvasScopedHostUrl, g as loadVoiceWakeConfig, h as formatError, i as setFallbackGatewayContextResolver, l as upsertPresence, m as normalizeCanvasScopedUrl, o as handleGatewayRequest, p as mintCanvasCapabilityToken, s as broadcastPresenceSnapshot, t as loadGatewayStartupPlugins, u as clearNodeWakeState, v as resolveCronRunLogPath, w as startGatewayConfigReloader, x as resolveFailureDestination, y as resolveCronRunLogPruneOptions } from "./server-plugin-bootstrap-Bb1AGla7.js";
import { i as resolveCronSession, n as runHeartbeatOnce, r as startHeartbeatRunner } from "./heartbeat-runner-DARPD6S2.js";
import { n as stopGmailWatcher, t as startGmailWatcherWithLogs } from "./gmail-watcher-lifecycle-tNaPLCNh.js";
import "./paths-CYGOBNw2.js";
import { t as getUpdateAvailable } from "./update-startup-CJRFhHEp.js";
import { t as hasConfiguredInternalHooks } from "./configured-CDq3jz4M.js";
...
function loadExecApprovalForwarderRuntime() {
	execApprovalForwarderRuntimePromise ??= import("./exec-approval-forwarder.runtime-BiZyaFg4.js");
...
async function loadSkillsSnapshotRuntime() {
	skillsSnapshotRuntimePromise ??= import("./skills-snapshot.runtime-CpyiWvt4.js");
...
async function loadCliRunnerRuntime() {
	return await import("./cli-runner.runtime-BAqEdD2h.js");
}
async function loadUsageFormatRuntime() {
	return await import("./usage-format-Ctu393VF.js");
}
...
function recoverPendingOutboundDeliveries(params) {
	(async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-H1qxiKID.js");
		const { deliverOutboundPayloads } = await import("./deliver-Csc48hmD.js");
...
function recoverPendingSessionDeliveries(params) {
	setTimeout(() => {
		(async () => {
			const { recoverPendingRestartContinuationDeliveries } = await import("./server-restart-sentinel-CqPb1RIT.js");
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-fIrphrpp.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-CXnJJFIP.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-BFGUoIhQ.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-WuuafwnK.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-i7ZMmc8w.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-BxaZhYRH.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-K8rq7SUX.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-CWb33yZ2.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-BbayLkfn.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-DfdNlajH.js");
	return toolsInvokeHttpModulePromise;
}
function getVoiceClawRealtimeUpgradeModule() {
	voiceClawRealtimeUpgradeModulePromise ??= import("./upgrade-CG7WKKX3.js");
...
async function prewarmConfiguredPrimaryModel(params) {
	...
	const [{ resolveOpenClawAgentDir }, { DEFAULT_MODEL, DEFAULT_PROVIDER }, { selectAgentHarness }, { isCliProvider, resolveConfiguredModelRef }, { ensureOpenClawModelsJson }, { resolveModel, resolveModelAsync }, { resolveEmbeddedAgentRuntime }] = await Promise.all([
		...
		import("./selection-_Odvaz7h.js"),
		import("./model-selection-C5fefleX.js"),
		import("./models-config-ge66v_x-.js"),
		import("./model-j-Rx-vWA.js"),
...
async function startGatewaySidecars(params) {
		...
		try {
			...
			for (const sessionsDir of sessionDirs) {
				...
				if (result.cleaned.length > 0) {
					const { markRestartAbortedMainSessionsFromLocks } = await import("./main-session-restart-recovery-Bicg-nTe.js");
	...
	await measureStartup(params.startupTrace, "sidecars.gmail-watch", async () => {
		if (params.cfg.hooks?.enabled && params.cfg.hooks.gmail?.account) {
			const { startGmailWatcherWithLogs } = await import("./gmail-watcher-lifecycle-3sytZ1DB.js");
			await startGmailWatcherWithLogs({
				cfg: params.cfg,
				log: params.logHooks
			});
	...
	await measureStartup(params.startupTrace, "sidecars.gmail-model", async () => {
		if (params.cfg.hooks?.gmail?.model) {
			const [{ DEFAULT_MODEL, DEFAULT_PROVIDER }, { loadModelCatalog }, { getModelRefStatus, resolveConfiguredModelRef, resolveHooksGmailModel }] = await Promise.all([
				import("./defaults-Bg4-Ke4I.js"),
				import("./model-catalog-Coigqpaf.js"),
				import("./model-selection-C5fefleX.js")
			]);
	...
	await measureStartup(params.startupTrace, "sidecars.internal-hooks", async () => {
		try {
			if (internalHooksConfigured) {
				const [{ setInternalHooksEnabled }, { loadInternalHooks }] = await Promise.all([import("./internal-hooks-CVZWEVD3.js"), import("./loader-t0hwiFrK.js")]);
	...
	await measureStartup(params.startupTrace, "sidecars.plugin-services", async () => {
		try {
			const { startPluginServices } = await import("./services-SRV8KFyt.js");
	...
	if (params.cfg.acp?.enabled) {
		const [{ getAcpSessionManager }, { ACP_SESSION_IDENTITY_RENDERER_VERSION }] = await Promise.all([import("./manager-Dn0eh3FN.js"), import("./session-identifiers-GnjWclF4.js")]);
	...
	await measureStartup(params.startupTrace, "sidecars.memory", async () => {
		...
		setImmediate(() => {
			import("./server-startup-memory-CsJY0Lxn.js").then(({ startGatewayMemoryBackend }) => startGatewayMemoryBackend({
				cfg: params.cfg,
				log: params.log
			})).catch((err) => {
	...
	await measureStartup(params.startupTrace, "sidecars.restart-sentinel", async () => {
		...
		const { hasRestartSentinel } = await import("./restart-sentinel-BTuncPLG.js");
		if (!await hasRestartSentinel()) return;
		setTimeout(() => {
			import("./server-restart-sentinel-CqPb1RIT.js").then(({ scheduleRestartSentinelWake }) => scheduleRestartSentinelWake({ deps: params.deps })).catch((err) => {
	...
	await measureStartup(params.startupTrace, "sidecars.subagent-recovery", async () => {
		const { scheduleSubagentOrphanRecovery } = await import("./subagent-registry-CoY4nWLh.js");
		scheduleSubagentOrphanRecovery();
	});
	await measureStartup(params.startupTrace, "sidecars.main-session-recovery", async () => {
		const { scheduleRestartAbortedMainSessionRecovery } = await import("./main-session-restart-recovery-Bicg-nTe.js");
...
const defaultGatewayPostAttachRuntimeDeps = {
	...
	logGatewayStartup: async (params) => (await import("./server-startup-log-B6Xf4oJw.js")).logGatewayStartup(params),
	scheduleGatewayUpdateCheck: async (...args) => (await import("./update-startup-C8HQKnlS.js")).scheduleGatewayUpdateCheck(...args),
	startGatewaySidecars,
	startGatewayTailscaleExposure: async (...args) => (await import("./server-tailscale-D2RaADNj.js")).startGatewayTailscaleExposure(...args)
};
	...
	try {
		...
		if (!minimalTestGateway) {
			if (deferredConfiguredChannelPluginIds.length > 0) {
				const { reloadDeferredGatewayPlugins } = await import("./server-plugin-bootstrap-DE_HrNVM.js");
