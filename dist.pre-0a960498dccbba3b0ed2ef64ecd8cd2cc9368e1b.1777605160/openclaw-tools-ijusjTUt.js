...
import { a as loadConfig, o as parseConfigJson5, v as resolveConfigSnapshotHash } from "./io-Cs-0dhMf.js";
...
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-DfaoEnkb.js";
import { n as ensureOpenClawModelsJson } from "./models-config-tjpufxQ-.js";
...
import { r as loadModelCatalog } from "./model-catalog-CnUqgj64.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-BCjdY3CQ.js";
...
import { c as createExpiringMapCache } from "./store-cache-DBCd6yKR.js";
import { t as loadSessionStore } from "./store-load-DYALOLpQ.js";
import { o as updateSessionStore } from "./store-Ci-m4oZ1.js";
import { t as extractDeliveryInfo } from "./sessions-BL1W8Rqf.js";
...
import { f as resolveSessionModelIdentityRef, t as deriveSessionTitle } from "./session-utils-IrNZpZWa.js";
...
import { r as resolvePluginTools } from "./tools-DHDhlGv0.js";
import { w as textToSpeech } from "./tts-VTd__uez.js";
import { p as extractTextFromChatContent } from "./sanitize-user-facing-text-DhtkBIxZ.js";
import { a as getImageMetadata } from "./image-ops-CDj1vqKD.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-BSIcuxrK.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-C_KK-obC.js";
import { a as listChannelSupportedActions, r as listAllChannelSupportedActions } from "./channel-tools-C-dcr0JU.js";
import { r as getApiKeyForModel } from "./model-auth-CMq_TSIy.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-BrHDt1pi.js";
import { t as SsrFBlockedError } from "./ssrf-CD_2fLNF.js";
import { u as parseReplyDirectives } from "./payloads-mE51ebOD.js";
import { n as runWithImageModelFallback } from "./model-fallback-nJufkDD5.js";
import { c as stripReasoningTagsFromText } from "./assistant-visible-text-OS6-0xmV.js";
import { t as extractAssistantText } from "./pi-embedded-utils-BBDougGx.js";
import { r as callGateway } from "./call-DQ5vtuUC.js";
import { b as readSnakeCaseParamRaw, f as readNumberParam, g as readStringParam$1, i as asToolParamsRecord, l as jsonResult, m as readStringArrayParam, r as ToolInputError, s as imageResult } from "./common-CKql4nPs.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-Be16iQej.js";
import { g as writeFileWithinRoot, r as appendFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-oiDsgdG5.js";
import { t as isWindowsDrivePath } from "./archive-path-xg5iXurz.js";
import { o as trySafeFileURLToPath, r as hasEncodedFileUrlSeparator } from "./local-file-access-D6mUOX8N.js";
import { n as assertSandboxPath } from "./sandbox-paths-Bsb2_AET.js";
import { c as resolveWorkspaceRoot, d as toRelativeWorkspacePath, s as normalizeWorkspaceDir } from "./read-capability-ptQ39rrt.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata } from "./runtime-1uIT6Nh9.js";
import "./delivery-context-BXPu6smX.js";
import { t as sniffMimeFromBase64 } from "./sniff-mime-from-base64-uamFaAAs.js";
import { a as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-BpuRThxu.js";
import { a as resolveDisplaySessionKey, c as resolveSessionReference, i as resolveSandboxedSessionToolContext, l as resolveVisibleSessionReference, n as deriveChannel, o as resolveInternalSessionKey, r as resolveSessionToolContext, s as resolveMainSessionAlias, t as classifySessionKind, u as shouldResolveSessionIdInput } from "./sessions-helpers-CMPtnDF6.js";
import { r as stripToolMessages } from "./chat-history-text-CpRteoLZ.js";
import { a as parseCanvasSnapshotPayload, c as parseCameraSnapPayload, d as writeCameraPayloadToFile, i as canvasSnapshotTempPath, l as writeBase64ToFile, n as screenRecordTempPath, o as cameraTempPath, r as writeScreenRecordToFile, s as parseCameraClipPayload, t as parseScreenRecordPayload, u as writeCameraClipPayloadToFile } from "./nodes-screen-Dr3cj0JX.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-Bfu5kCgH.js";
...
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-5z3YTeFr.js";
import { d as stagePostCompactionDelegate, f as stagedPostCompactionDelegateCount, l as pendingDelegateCount, s as enqueuePendingDelegate } from "./continuation-delegate-store-CFkbS5BT.js";
import { n as resolveMaxDelegatesPerTurn } from "./continuation-runtime-T5jKm_4s.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-BNhuzVNN.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-CN4nJJfi.js";
import { t as inferLegacyName } from "./normalize-9foJwWMu.js";
import { n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-CEZJq98V.js";
import { d as writeRestartSentinel, n as buildRestartSuccessContinuation, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile } from "./restart-sentinel-klpP7uhM.js";
import { o as scheduleGatewaySigusr1Restart } from "./restart-FpYKICur.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-r5JugPyp.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-BFSQb8qK.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-BNafTxMq.js";
import { n as resolveConfiguredMediaMaxBytes } from "./configured-max-bytes-CLyLA9eU.js";
import { l as saveMediaBuffer } from "./store-D9jVYsha.js";
import { a as classifyMediaReferenceSource, o as normalizeMediaReferenceSource, r as getDefaultLocalRoots } from "./local-media-access-CIZC6WMJ.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-1yKSIgEY.js";
import { a as coerceImageModelConfig, c as resolveProviderVisionModelFromConfig, d as hasAuthForProvider, f as hasToolModelConfig, l as buildToolModelConfigFromCandidates, n as isMinimaxVlmProvider, o as decodeDataUrl, p as resolveDefaultModelRef, u as coerceToolModelConfig } from "./minimax-vlm-D7cyQ89N.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-CMPa8moF.js";
import { b as resolveAutoMediaKeyProviders, w as getMediaUnderstandingProvider, x as resolveDefaultMediaModel, y as providerSupportsNativePdfDocument } from "./resolve-DJVq8sx8.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-CoR4UWjz.js";
import { t as buildProviderRegistry } from "./runner-DUgv3CTa.js";
import "./media-understanding-kSoNnKVt.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-Bc8RjNwJ.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-gnyonUjN.js";
import { o as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-B56JkKfk.js";
import { a as POLL_CREATION_PARAM_DEFS, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-Bq1aB5aR.js";
import { t as sendMessage } from "./message-Cw41Ckus.js";
import { i as resolveMusicGenerationModeCapabilities, n as listRuntimeMusicGenerationProviders, r as listSupportedMusicGenerationModes, t as generateMusic } from "./runtime-Brhhzvsh.js";
import { r as parseMusicGenerationModelRef } from "./provider-registry-6fpJlPUS.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-Z1kIfHEm.js";
...
import { a as recordTaskRunProgressByRunId, i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-Bi2QiaeH.js";
import "./task-registry-delivery-runtime-PV_cIKR4.js";
import { t as formatAgentInternalEventsForPrompt } from "./internal-events-D0NLXxs6.js";
import { i as loadSessionEntryByKey, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-C6DttM-o.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-D2c3vpJI.js";
import { t as parseTimeoutMs } from "./parse-timeout-DF24GSy6.js";
import { t as extractPdfContent } from "./pdf-extract-cIJx56w2.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-BuOWq2OH.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-Bvn4ivRV.js";
import { n as isRequesterParentOfBackgroundAcpSession } from "./session-interaction-mode-BPjkC62c.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-KPBIOlU6.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, n as readLatestAssistantReply, r as readLatestAssistantReplySnapshot } from "./run-wait-BLnhZQsJ.js";
import { d as runAgentStep, f as ANNOUNCE_SKIP_TOKEN, h as isReplySkip, m as isAnnounceSkip, p as REPLY_SKIP_TOKEN } from "./subagent-announce-output-Bmr3vC7l.js";
import { p as registerSubagentRun } from "./subagent-registry-Dz8Ktmwf.js";
import { i as SUBAGENT_SPAWN_MODES, n as spawnSubagentDirect, r as SUBAGENT_SPAWN_CONTEXT_MODES } from "./subagent-spawn-aB8Sp5NK.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-SVcJ3Au7.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-DPG9-EiE.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, n as listRuntimeVideoGenerationProviders, r as listSupportedVideoGenerationModes, t as generateVideo } from "./runtime-BggtU-oq.js";
import { r as parseVideoGenerationModelRef } from "./provider-registry-V0_pAMxe.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-BsJ8m57k.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-C533CI5P.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-Ba4UhMAv.js";
import { a as readResponseText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds } from "./web-shared-Birun0-Q.js";
import { a as runWebSearch, i as resolveWebSearchDefinition } from "./runtime-CxT580bY.js";
import "./web-search-provider-common-B4rcaTdU.js";
...
async function getRuntime() {
	if (!runtimeMod) runtimeMod = await import("./embedded-gateway-stub.runtime-CjwkamwM.js");
	return runtimeMod;
}
...
function loadCommandsStatusRuntime() {
	commandsStatusRuntimePromise ??= import("./session-status.runtime-DMK11_Zq.js");
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-Dx52RI4r.js");
...
async function loadAcpSpawnModule() {
	acpSpawnModulePromise ??= import("./acp-spawn-CPE_0X4z.js");
...
async function loadWebFetchRuntime() {
	webFetchRuntimePromise ??= import("./runtime-pBR3mlcR.js");
	return await webFetchRuntimePromise;
}
async function loadWebGuardedFetch() {
	webGuardedFetchPromise ??= import("./web-guarded-fetch-Bc0tEa8Q.js");
...
//#endregion
export { stripProviderPrefix as _, normalizeCronJobPatch as a, createOpenClawReadTool as c, createSandboxedWriteTool as d, wrapToolMemoryFlushAppendOnlyWrite as f, isStrictAgenticSupportedProviderModel as g, isStrictAgenticExecutionContractActive as h, normalizeCronJobInput as i, createSandboxedEditTool as l, wrapToolWorkspaceRootGuardWithOptions as m, getVolitionalCompactionCount as n, createHostWorkspaceEditTool as o, wrapToolWorkspaceRootGuard as p, normalizeCronJobCreate as r, createHostWorkspaceWriteTool as s, createOpenClawTools as t, createSandboxedReadTool as u, isEmbeddedMode as v, setEmbeddedMode as y };
