 ...
 * timeout) rather than a provider/model failure. The model fallback chain must
 * abort on these instead of consuming candidate slots — retrying any model
 * would hit the same local condition. See #83510.
 */
