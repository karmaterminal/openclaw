...
export function buildAgentSystemPrompt(params: {
  ...
  if (!isMinimal && params.continuationEnabled) {
    lines.push(
      ...
      "delegates. Unlike CONTINUE_WORK, this aborts any queued tool calls — the session parks",
      "until an external event (subagent result, user message) arrives. Use it when you should",
      "stop talking and wait for results, not when you want another turn on a timer.",
      "",
      "### Context pressure",
