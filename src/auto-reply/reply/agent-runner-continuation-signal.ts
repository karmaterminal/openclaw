...
export async function handleContinuationSignal(context: {
  ...
  const telemetryBase: Omit<ContinuationTelemetryContext, "kind"> = {
    origin: signalOrigin,
    runId,
  ...
  if (
    ...
    if (allocatedChainHop >= maxChainLength) {
      ...
      emitBracketContinuationRejected({
        ...
        telemetry: { ...telemetryBase, kind: effectiveContinuationSignal.kind },
        ...
        if (effectiveContinuationSignal.kind === "delegate") {
          ...
          const rejectCrossSessionTargeting = (
            ...
            emitContinuationDisabledSpan({
              ...
              signalKind: signalOrigin === "bracket" ? "bracket-delegate" : "tool-delegate",
              ...
              delegateMode: details.silentWake
                ...
                : details.silent
                  ...
                  : "normal",
              reason: details.task,
              telemetry: { ...telemetryBase, kind: "delegate" },
