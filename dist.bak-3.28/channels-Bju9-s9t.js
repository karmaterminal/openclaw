...
import { CA as resolveMessageActionDiscoveryForPlugin, Ds as applyPluginAutoEnable, Om as loadProviderUsageSummary, PO as callGateway, SA as createMessageActionDiscoveryContext, f as loadConfig, fw as resolveCommandSecretRefsViaGateway, g as readConfigFileSnapshot, km as formatUsageReportLines, lw as resolveMessageChannelSelection, x as writeConfigFile } from "./auth-profiles-D5vQ2NEm.js";
import { r as loadAuthProfileStore } from "./store-BpAvd-ka.js";
import { _ as normalizeAccountId } from "./session-key-BhxcMJEE.js";
import { t as danger } from "./globals-0H99T-Tx.js";
...
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-GKJz5Xrd.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-D9SEfBub.js";
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-BQ9CTy5q.js";
import { n as hasResolvedCredentialValue, t as hasConfiguredUnavailableCredentialStatus } from "./account-snapshot-fields-agcLjuW6.js";
...
import { r as listChannelPluginCatalogEntries } from "./catalog-D_MEfGgd.js";
import { t as createClackPrompter } from "./clack-prompter-DSg64rDt.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-KHNQgF3c.js";
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-BBlhP_Pf.js";
import { t as parseLogLine } from "./parse-log-line-CA1JFjU9.js";
import { i as describeBinding, n as applyAgentBindings, t as requireValidConfigSnapshot } from "./config-validation-wv0UJFYJ.js";
import { a as isCatalogChannelInstalled, n as runCollectedChannelOnboardingPostWriteHooks, t as createChannelOnboardingPostWriteHookCollector } from "./onboard-channels-BqeuBz_I.js";
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, { setupChannels }] = await Promise.all([import("./agents.config-_Osg0mVS.js"), import("./onboard-channels-0PE2x5nd.js")]);
	...
	const loadScopedPlugin = async (channelId, pluginId) => {
		...
		const { loadChannelSetupPluginRegistrySnapshotForChannel } = await import("./plugin-install-DHgMxNtr.js");
	...
	if (!channel && catalogEntry) {
		...
		if (!isCatalogChannelInstalled({
			...
			const { ensureChannelSetupPluginInstalled } = await import("./plugin-install-DHgMxNtr.js");
			const prompter = createClackPrompter();
