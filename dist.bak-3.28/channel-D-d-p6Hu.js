import { BE as normalizeMatrixMessagingTarget, FE as resolveDefaultMatrixAccountId, HE as resolveMatrixDirectUserId, IE as resolveMatrixAccount, LE as resolveMatrixAccountConfig, NE as listMatrixAccountIds, UE as resolveMatrixTargetIdentity, VE as normalizeMatrixResolvableTarget, cD as matrixSetupAdapter } from "./auth-profiles-D5vQ2NEm.js";
import { g as DEFAULT_ACCOUNT_ID } from "./session-key-BhxcMJEE.js";
import { m as createScopedAccountReplyToModeResolver, o as stripChannelTargetPrefix, r as createChatChannelPlugin, s as stripTargetKindPrefix, t as buildChannelOutboundSessionRoute } from "./core-Dj4AGPqv.js";
...
import { t as createChannelDirectoryAdapter } from "./directory-runtime-C0nkSb_m.js";
...
import "./channel-status-D9BzCyDQ.js";
import { r as buildTrafficStatusSummary } from "./extension-shared-CssxQFGc.js";
import { i as resolveMatrixRoomConfig, n as normalizeMatrixUserId, t as normalizeMatrixAllowList } from "./allowlist-sPWuvCrJ.js";
...
const matrixMessageActions = {
	...
	handleAction: async (ctx) => {
		const { handleMatrixAction } = await import("./tool-actions.runtime-CEXUcCOy.js");
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-BQ6jpgF5.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-BoaKQxFG2.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
