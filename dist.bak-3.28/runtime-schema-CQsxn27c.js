...
import { B as collectPluginSchemaMetadata, f as loadConfig, g as readConfigFileSnapshot, z as collectChannelSchemaMetadata } from "./auth-profiles-D5vQ2NEm.js";
...
import "./zod-schema.sensitive-DKxefNcr.js";
import { s as stripUrlUserInfo } from "./account-snapshot-fields-agcLjuW6.js";
...
function buildBaseConfigSchema() {
	...
	const next = GENERATED_BASE_CONFIG_SCHEMA;
	cachedBase = next;
	return next;
}
