...
export declare const ProtocolSchemas: {
    ConnectParams: import("@sinclair/typebox").TObject<{
        ...
        client: import("@sinclair/typebox").TObject<{
            ...
            mode: import("@sinclair/typebox").TUnion<import("@sinclair/typebox").TLiteral<"node" | "cli" | "probe" | "webchat" | "backend" | "ui" | "test">[]>;
    ...
    AgentParams: import("@sinclair/typebox").TObject<{
        ...
        continuationTrigger: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TString>;
        ...
        drainsContinuationDelegateQueue: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TBoolean>;
    }>;
