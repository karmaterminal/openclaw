...
export declare function buildPluginLoaderAliasMap(modulePath: string, argv1?: string  , moduleUrl?: string, pluginSdkResolution?: PluginSdkResolutionPreference): Record<string, string>;
