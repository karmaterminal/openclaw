...
import { $w as normalizeOptionalText, Hw as trimLogTail, Xw as inferLegacyName, YO as applyPathPrepend, Yw as resolveDefaultCronStaggerMs, gD as autoMigrateLegacyMatrixState, hD as maybeCreateMatrixMigrationSnapshot, iT as normalizeLegacyDeliveryInput, mD as hasPendingMatrixMigration, nT as migrateLegacyCronPayload, pD as hasActionableMatrixMigration, qw as normalizeCronStaggerMs, rT as parseAbsoluteTimeMs, vD as autoPrepareLegacyMatrixCrypto } from "./auth-profiles-D5vQ2NEm.js";
import { n as runCommandWithTimeout } from "./exec-CLVZ7JOg.js";
import { s as BUNDLED_PLUGIN_METADATA } from "./bundled-capability-metadata-CsnlKsfe.js";
import { s as resolveStableNodePath } from "./runtime-paths-RaKpVytx.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-C9ozoHA7.js";
import { a as isBetaTag, n as DEV_BRANCH, o as isStableTag, r as channelToNpmTag } from "./update-channels-4XPhd4aG.js";
import { n as compareSemverStrings, s as detectPackageManager$1 } from "./update-check-cCN4G58b.js";
...
const BUNDLED_RUNTIME_SIDECAR_PATHS = assertUniqueValues(BUNDLED_PLUGIN_METADATA.flatMap((entry) => (entry.runtimeSidecarArtifacts ?? []).map((artifact) => `dist/extensions/${entry.dirName}/${artifact}`)).toSorted((left, right) => left.localeCompare(right)), "bundled runtime sidecar path");
