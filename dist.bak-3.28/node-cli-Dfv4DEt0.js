...
import { Bk as analyzeArgvCommand, Dk as isInterpreterLikeSafeBin, Ek as requestJsonlSocket, Fk as resolveAllowAlwaysPatterns, JA as NODE_SYSTEM_RUN_COMMANDS, KA as NODE_BROWSER_PROXY_COMMAND, Kk as resolvePlannedSegmentArgv, Lb as resolveGatewayConnectionAuth, Mk as evaluateShellAllowlist, RC as getMachineDisplayName, Ry as formatHelpExamples, Tk as saveExecApprovals, _k as readExecApprovalsSnapshot, bk as requiresExecApproval, cA as resolveExecutableFromPathEnv, ck as ensureExecApprovals, dA as POSIX_INLINE_COMMAND_FLAGS, dk as mergeExecApprovalsSocketDefaults, eA as resolveApprovalAuditCandidatePath, ey as resolveBrowserConfig, f as loadConfig, fA as resolveInlineCommandMatch, jk as evaluateExecAllowlist, kk as resolveExecSafeBinRuntimePolicy, lA as POSIX_SHELL_WRAPPERS, mA as normalizeExecutableToken, nA as resolveCommandResolutionFromArgv, nk as detectInterpreterInlineEvalArgv, pA as unwrapKnownDispatchWrapperInvocation, pk as normalizeExecApprovals, qA as NODE_EXEC_APPROVALS_COMMANDS, sk as addAllowlistEntry, tk as describeInterpreterInlineEval, tv as runBrowserProxyCommand, uA as unwrapKnownShellMultiplexerInvocation, vO as formatExecCommand, vk as recordAllowlistUse, wO as normalizeSystemRunApprovalPlan, xk as resolveExecApprovals, yO as resolveSystemRunCommandRequest } from "./auth-profiles-D5vQ2NEm.js";
import { _ as resolveStateDir } from "./paths-Y4UT24Of.js";
import { i as resolveAgentConfig } from "./agent-scope-BSOSJbA_.js";
import { t as sameFileIdentity } from "./file-identity-DeV9Olqn.js";
import { a as logWarn } from "./logger-Bps9nlrB.js";
import { a as sanitizeHostExecEnv, s as sanitizeSystemRunEnvOverrides, t as inspectHostExecEnvOverrides } from "./host-env-security-C13NAkuJ.js";
...
import { u as GatewayClient } from "./method-scopes-BuyxZAiO.js";
import { _ as resolveNodeWindowsTaskName, c as formatNodeServiceDescription, g as resolveNodeSystemdServiceName, h as resolveNodeLaunchAgentLabel } from "./constants-yobxBGxY.js";
import { a as resolveNodeProgramArguments, n as resolveDaemonInstallRuntimeInputs, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-DZAWm7J7.js";
import { c as buildNodeServiceEnvironment } from "./runtime-paths-RaKpVytx.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DzDNmci2.js";
import { d as resolveRuntimeStatusColor, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles } from "./shared-xWhXqVh0.js";
import { c as buildPlatformRuntimeLogHints, l as buildPlatformServiceStartHints, u as formatRuntimeStatus } from "./systemd-hints-Bb-BVEWC.js";
import { t as parsePort } from "./parse-port-dVVz5Hz7.js";
import { i as runServiceUninstall, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-BcxVEFsZ.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-DFVT64i8.js";
