...
import { GI as logConfigUpdated, g as readConfigFileSnapshot, x as writeConfigFile } from "./auth-profiles-D5vQ2NEm.js";
import { u as resolveGatewayPort } from "./paths-Y4UT24Of.js";
import { s as isValidEnvSecretRefId } from "./types.secrets-Rqz2qv-w.js";
...
import "./daemon-runtime-DzDNmci2.js";
import { c as normalizeGatewayTokenInput, d as randomToken, f as resolveControlUiLinks, g as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-DKerP5bm.js";
import { t as createClackPrompter } from "./clack-prompter-DSg64rDt.js";
import { t as runSetupWizard } from "./setup-dPd5XgcV.js";
import { a as resolveManifestProviderOnboardAuthFlags } from "./provider-auth-choices-CdUeeYNr.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-Cwply8WV.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	const diagnostics = {};
	try {
		const { resolveGatewayService } = await import("./service-CAS3j-Rz.js");
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-Csv7FnZw.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-J719hoEx.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-vo-nbM3E.js");
