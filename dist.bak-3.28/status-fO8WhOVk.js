...
import { S as sleep, x as shortenHomePath } from "./utils-BfvDpbwh.js";
import { n as isRich, r as theme, t as colorize } from "./theme-D-TumEpz.js";
import { HO as isGatewaySecretRefUnavailableError, JO as loadGatewayTlsRuntime, l as createConfigIO, qO as trimToUndefined } from "./auth-profiles-D5vQ2NEm.js";
import { _ as resolveStateDir, o as resolveConfigPath, u as resolveGatewayPort } from "./paths-Y4UT24Of.js";
import { t as formatConfigIssueLine } from "./issue-format-CfhA-_wV.js";
...
import { s as isWSLEnv } from "./runtime-env-5bDkE44b.js";
import { t as killProcessTree } from "./kill-tree-D9SG3mzb.js";
import { f as resolveGatewaySystemdServiceName, l as resolveGatewayLaunchAgentLabel } from "./constants-yobxBGxY.js";
import { n as withProgress } from "./progress-BWNzIjJW.js";
import { a as inspectPortUsage, c as formatPortDiagnostics, s as classifyPortListener } from "./ports-DaedVTZA.js";
import { _ as inspectBestEffortPrimaryTailnetIPv4, f as resolveControlUiLinks, y as resolveBestEffortGatewayBindHostForDisplay } from "./onboard-helpers-DKerP5bm.js";
import { c as resolveGatewayLogPaths } from "./launchd-BdxtrFXa.js";
import { r as resolveGatewayService } from "./service-6gftUGdu.js";
import { p as classifySystemdUnavailableDetail } from "./systemd-DgFX5bKr.js";
import { a as filterDaemonEnv, c as pickProbeHostForBind, d as resolveRuntimeStatusColor, f as safeDaemonEnv, o as normalizeListenerAddress, s as parsePortFromArgs, t as createCliStatusTextStyles, u as renderRuntimeHints } from "./shared-xWhXqVh0.js";
import { d as resolveDaemonContainerContext, i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-Bb-BVEWC.js";
import { i as probeGateway } from "./probe-BE0dp0Y8.js";
...
import { i as resolveGatewayProbeAuthWithSecretInputs } from "./probe-auth-0sy6a7v7.js";
...
async function probeGatewayStatus(opts) {
	try {
		const result = await withProgress({
			...
			if (opts.requireRpc) {
				const { callGateway } = await import("./call-B42mw9EK.js");
				await callGateway({
					url: opts.url,
					token: opts.token,
			...
			const { probeGateway } = await import("./probe-BOL9dB-6.js");
