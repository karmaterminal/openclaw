...
import { AF as markdownToWhatsApp, f as loadConfig, jF as convertMarkdownTables, kI as resolveMarkdownTableMode } from "./auth-profiles-D5vQ2NEm.js";
...
async function sendMessageWhatsApp(to, body, options) {
	...
	try {
		...
		const accountId = options.accountId?.trim() ? resolvedAccountId : void 0;
