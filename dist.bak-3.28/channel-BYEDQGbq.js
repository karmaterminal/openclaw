...
import { o as stripChannelTargetPrefix, r as createChatChannelPlugin, s as stripTargetKindPrefix, t as buildChannelOutboundSessionRoute } from "./core-Dj4AGPqv.js";
...
import { r as resolveMSTeamsGroupToolPolicy } from "./policy-BpAqkj1o.js";
import { f as resolveMSTeamsCredentials } from "./graph-users-xiTzgdZR.js";
import { i as parseMSTeamsTeamChannelInput, n as normalizeMSTeamsUserInput, o as resolveMSTeamsChannelAllowlist, r as parseMSTeamsConversationId, s as resolveMSTeamsUserAllowlist, t as normalizeMSTeamsMessagingTarget } from "./resolve-allowlist-Csr9lfvM.js";
import { n as msteamsSetupAdapter, t as msteamsSetupWizard } from "./setup-surface-Bbb10xWx.js";
...
const loadMSTeamsChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-MmODlNXC.js"), "msTeamsChannelRuntime");
...
const msteamsPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorMSTeamsProvider } = await import("./src-6_rod-z4.js");
