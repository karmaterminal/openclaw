...
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-fSmD8bOm.js";
import { t as require_src } from "./src-DjQPu5JV.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-DmhoEH8i.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, n as CouldNotDetermineFileTypeError } from "./BasicParser-BXS2yOsU.js";
import { l as toRatio, n as decodeString } from "./Util-CBn3Cuzs.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-B8abdQAj.js";
import { a as textDecode, t as APEv2Parser } from "./APEv2Parser-CnNzeL5d.js";
import { r as hasID3v1Header } from "./ID3v1Parser-8EXKcE-N.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-NCmi7qoB.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-Bl69w57o.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-kmJMbYVI.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-DT9QbbMz.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-D-qlIDwF.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-CDZ9XI7W.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-BqxeY0UC.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-Y0xhjR8s.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-CLPg65Zu.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-DBXxJOam.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-kywFLZCh.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-B71WZwFI.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-Co6tRAsJ.js")).WaveParser;
	}
};
//#endregion
