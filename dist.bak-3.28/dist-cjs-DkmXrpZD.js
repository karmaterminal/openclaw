...
var require_dist_cjs$20 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const getCanonicalHeaders = ({ headers }, unsignableHeaders, signableHeaders) => {
		const canonical = {};
		for (const headerName of Object.keys(headers).toSorted()) {
	...
	const getCanonicalQuery = ({ query = {} }) => {
		...
		return keys.toSorted().map((key) => serialized[key]).filter((serialized) => serialized).join("&");
	};
	...
	var SignatureV4Base = class {
		...
		createCanonicalRequest(request, canonicalHeaders, payloadHash) {
			const sortedHeaders = Object.keys(canonicalHeaders).toSorted();
...
${utilHexEncoding.toHex(hashedRequest)}`;
		...
		getCanonicalHeaderList(headers) {
			return Object.keys(headers).toSorted().join(";");
		}
	};
...
var require_dist_cjs$13 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const parseArn = (value) => {
		...
		return {
			...
			region,
			accountId,
			resourceId: resourcePath.flatMap((resource) => resource.split(RESOURCE_DELIMITER))
		};
	};
	var partitionsInfo = {
		partitions: [
...
var require_dist_cjs$12 = /* @__PURE__ */ __commonJSMin(((exports) => {
	const CLOCK_SKEW_ERROR_CODES = new Set([
		"AuthFailure",
	...
	const isClockSkewError = (error) => CLOCK_SKEW_ERROR_CODES.has(error.name);
...
var require_dist_cjs$4 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const ALLOWED_DIST_TAGS = new Set([
		"latest",
		"beta",
		"dev",
		"rc",
	...
	const getSanitizedDevTypeScriptVersion = (version = "") => {
		if (ALLOWED_DIST_TAGS.has(version)) {return version;}
