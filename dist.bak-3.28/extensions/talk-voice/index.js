import { kL as resolveActiveTalkProviderConfig } from "../../auth-profiles-D5vQ2NEm.js";
...
- provider: ${providerId}\n- talk.voiceId: ${currentVoiceId ? currentVoiceId : "(unset)"}\n- ${providerId}.apiKey: ${apiKey ? mask(apiKey) : "(unset)"}` };
				...
				if (action === "set") {
					if (ctx.channel === "webchat" && !ctx.gatewayClientScopes?.includes("operator.admin")) return { text: `⚠️ ${commandLabel} set requires operator.admin.` };
