...
import { QI as resolveWhatsAppHeartbeatRecipients, QM as loadSessionStore, Td as resolveHeartbeatReplyPayload, cI as evaluateSessionFreshness, dI as resolveSessionResetType, f as loadConfig, fI as resolveThreadFlag, fd as getReplyFromConfig, gc as resolveSessionKey, iL as DEFAULT_WEB_MEDIA_BYTES, iN as updateSessionStore, lI as resolveChannelResetConfig, lM as resolveHeartbeatVisibility, mM as resolveIndicatorType, sL as appendCronStyleCurrentTimeLine, uI as resolveSessionResetPolicy, uM as emitHeartbeatEvent } from "../../auth-profiles-D5vQ2NEm.js";
...
import { _ as SILENT_REPLY_TOKEN, f as HEARTBEAT_PROMPT, g as HEARTBEAT_TOKEN, h as stripHeartbeatToken, m as resolveHeartbeatPrompt } from "../../system-events-CNx_jtrt.js";
import { s as redactIdentifier } from "../../account-summary-BVeyEc9I.js";
import { i as LocalMediaAccessError, n as loadWebMediaRaw, o as getDefaultLocalRoots, r as optimizeImageToJpeg, t as loadWebMedia } from "../../web-media-BGv6FW5m.js";
...
import { t as createWhatsAppLoginTool } from "../../agent-tools-login-B20Cl9bF.js";
import { a as maybeRestoreCredsFromBackup, c as readWebSelfId, d as webAuthExists, i as logoutWeb, l as readWebSelfIdentity, n as getWebAuthAgeMs, o as pickWebChannel, r as logWebSelfId, s as readCredsJsonRaw, t as WA_WEB_AUTH_DIR, u as resolveDefaultWebAuthDir } from "../../auth-store-Bwalh7-1.js";
import { n as whatsAppActionRuntime, t as handleWhatsAppAction } from "../../action-runtime-BGzMAfrP.js";
...
import { n as sendPollWhatsApp, r as sendReactionWhatsApp, t as sendMessageWhatsApp } from "../../send-BuHs9IUO.js";
import { n as getStatusCode, t as formatError } from "../../session-errors-C0GNlAbI.js";
import { o as whatsappHeartbeatLog, u as newConnectionId$1 } from "../../deliver-reply-ehUeWHS3.js";
import { a as waitForWaConnection, i as waitForCredsSaveQueueWithTimeout, n as newConnectionId, r as waitForCredsSaveQueue, t as createWaSocket } from "../../session-kjccRE5M.js";
import { a as extractMediaPlaceholder, i as extractLocationData, n as monitorWebChannel, o as extractText, r as monitorWebInbox, s as resetWebInboundDedupe, t as loginWeb } from "../../login-Xjgjo2_d.js";
...
function loadLoginQrModule() {
	loginQrModulePromise ??= import("../../login-qr-Cg5MVbnQ.js");
