import { fw as resolveCommandSecretRefsViaGateway, h as readBestEffortConfig } from "./auth-profiles-D5vQ2NEm.js";
...
import { n as buildPluginCompatibilityNotices } from "./status-DtTwgEYC.js";
...
import { a as resolveMemoryPluginStatus, i as resolveGatewayProbeSnapshot, n as scanStatusJsonCore, o as resolveSharedMemoryStatusSnapshot, r as buildTailscaleHttpsUrl, t as buildColdStartUpdateResult } from "./status.scan.json-core-BTx5TGmb.js";
...
const loadStatusScanRuntimeModule = createLazyRuntimeSurface(() => import("./status.scan.runtime-dLfut4Ja.js"), ({ statusScanRuntime }) => statusScanRuntime);
function loadStatusScanDepsRuntimeModule() {
	statusScanDepsRuntimeModulePromise ??= import("./status.scan.deps.runtime-CJla0Mha.js");
	return statusScanDepsRuntimeModulePromise;
}
function loadStatusAgentLocalModule() {
	statusAgentLocalModulePromise ??= import("./status.agent-local-BAgKaDtQ.js");
	return statusAgentLocalModulePromise;
}
function loadStatusSummaryModule() {
	statusSummaryModulePromise ??= import("./status.summary-2zDxnHLg.js");
	return statusSummaryModulePromise;
}
function loadStatusUpdateModule() {
	statusUpdateModulePromise ??= import("./status.update-MaRfRyXM.js");
	return statusUpdateModulePromise;
}
function loadGatewayCallModule() {
	gatewayCallModulePromise ??= import("./call-B42mw9EK.js");
