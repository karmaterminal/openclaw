...
import { m as statRegularFile, p as isFileMissingError } from "./internal-CYUgkW0e.js";
import { a as isQmdScopeAllowed, c as listSessionFilesForAgent, i as deriveQmdScopeChatType, n as runCliCommand, o as parseQmdQueryJson, r as deriveQmdScopeChannel, s as buildSessionEntry, t as resolveCliSpawnInvocation } from "./memory-core-host-engine-qmd-DXYg5XeY.js";
import { t as requireNodeSqlite } from "./memory-core-host-engine-storage-DF_MXz1I.js";
...
var QmdMemoryManager = class QmdMemoryManager {
	...
	async initialize(mode) {
		...
		if (this.shouldScheduleEmbedTimer()) {this.embedTimer = setInterval(() => {
