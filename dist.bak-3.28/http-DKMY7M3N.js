...
import { t as require_form_data } from "./form_data-2j7HBoqk.js";
import { n as require_proxy_from_env, t as require_follow_redirects } from "./follow-redirects-Bj3RDnFE.js";
//#region node_modules/@microsoft/teams.common/node_modules/axios/dist/node/axios.cjs
		...
		if (utils$1.isFormData(data)) {
			if (platform.hasStandardBrowserEnv || platform.hasStandardBrowserWebWorkerEnv) {headers.setContentType(void 0);}
				...
				Object.entries(formHeaders).forEach(([key, val]) => {
					if (allowedHeaders.has(key.toLowerCase())) {headers.set(key, val);}
				});
			}
		}
