import { $y as resolveGatewayAuth, Ak as resolveMergedSafeBinProfileFixtures, Lv as redactCdpUrl, Ok as listInterpreterLikeSafeBins, Yk as listRiskyConfiguredSafeBins, ey as resolveBrowserConfig, lk as loadExecApprovals, rk as isInterpreterLikeAllowlistPattern, sy as resolveBrowserControlAuth, ty as resolveProfile, zk as normalizeTrustedSafeBinDirs } from "./auth-profiles-D5vQ2NEm.js";
import { _ as resolveStateDir, o as resolveConfigPath } from "./paths-Y4UT24Of.js";
...
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-BkgvGSFt.js";
import { l as isPrivateNetworkAllowedByPolicy, s as isBlockedHostnameOrIp } from "./ssrf-BkIVE4hp.js";
import { n as resolveSandboxConfigForAgent } from "./config-BSQFYjVD.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-B2Ih80tT.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-9v49ugF3.js";
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-Du9ips4j.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-ByqZc0Vm.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-BogmQiwd.js");
	return await auditDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-B6DlsJfk.js");
	return await auditChannelModulePromise;
}
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-B42mw9EK.js"),
		import("./probe-auth-qeKdvfZr.js"),
		import("./probe-BOL9dB-6.js")
