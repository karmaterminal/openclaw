...
import { h as resolveConfiguredModelRef } from "./model-selection-CMtvxDDg.js";
import { r as getActivePluginRegistry } from "./runtime-DgxFwo8V.js";
import { n as listChannelPlugins } from "./plugins-BQ9CTy5q.js";
import { t as isCommandFlagEnabled } from "./commands-CJ4QoOAd.js";
...
function buildChatCommands() {
	const commands = [...buildBuiltinChatCommands(), ...listChannelPlugins().filter((plugin) => plugin.capabilities.nativeCommands).map((plugin) => defineDockCommand(plugin))];
	assertCommandRegistry(commands);
	return commands;
}
