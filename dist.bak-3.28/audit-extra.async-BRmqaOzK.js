...
import { n as isPathInside, t as extensionUsesSkippedScannerPath } from "./scan-paths-hOTASUCw.js";
import { T as listAgentWorkspaceDirs, a as execDockerRaw } from "./docker-ChQrdPd7.js";
...
import { a as resolveNativeSkillsEnabled } from "./commands-CJ4QoOAd.js";
import { i as safeStat, n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-BkgvGSFt.js";
import { r as pickSandboxToolPolicy, t as isToolAllowedByPolicies } from "./tool-policy-match-CcXqdHAx.js";
import { l as resolveToolProfilePolicy } from "./tool-policy-B6bYv49c.js";
import { f as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, n as resolveSandboxConfigForAgent, o as resolveSandboxToolPolicyForAgent } from "./config-BSQFYjVD.js";
import { t as scanDirectoryWithSummary } from "./skill-scanner-xqesRQSG.js";
import { t as collectIncludePathsRecursive } from "./includes-scan-8-KnnhVj.js";
...
function loadSkillsModule() {
	skillsModulePromise ??= import("./skills-pV3t4kZV.js");
	return skillsModulePromise;
}
function loadConfigModule() {
	configModulePromise ??= import("./config-BExS7GZz.js");
...
async function collectInstalledSkillsCodeSafetyFindings(params) {
	...
	for (const workspaceDir of workspaceDirs) {
		...
		for (const entry of entries) {
			if (entry.skill.sourceInfo?.source === "openclaw-bundled") {continue;}
