import { Lj as dispatchReplyFromConfigWithSettledDispatcher, gj as resolveInboundSessionEnvelopeContext } from "./auth-profiles-D5vQ2NEm.js";
import { g as DEFAULT_ACCOUNT_ID } from "./session-key-BhxcMJEE.js";
import { f as createDraftStreamLoop, n as keepHttpServerTaskAlive } from "./channel-lifecycle-CSsB8ys6.js";
import { n as createChannelPairingController } from "./channel-pairing-cpi9_8zd.js";
import { r as resolveDefaultGroupPolicy } from "./runtime-group-policy-Bde7-o8k.js";
import { a as resolveSenderScopedGroupPolicy, i as evaluateSenderGroupAccessForPolicy } from "./group-access-CyGNdCph.js";
import { d as resolveDualTextControlCommandGate, n as readStoreAllowFromForDmPolicy, o as resolveDmGroupAccessWithLists, s as resolveEffectiveAllowFromLists } from "./dm-policy-shared-C8YuyjhK.js";
...
import { a as resolveChannelMediaMaxBytes, n as resolveMentionGating } from "./text-chunking-DzwxNDbL.js";
...
import { x as buildMediaPayload } from "./reply-payload-CJqP_sJ6.js";
...
import { n as isDangerousNameMatchingEnabled } from "./dangerous-name-matching-PuaUWcr7.js";
import "./runtime-api-BtYP0Y3_.js";
import { a as resolveMSTeamsRouteConfig, i as resolveMSTeamsReplyPolicy, n as resolveMSTeamsAllowlistMatch, t as isMSTeamsGroupAllowed } from "./policy-BpAqkj1o.js";
import { A as isRecord, C as IMG_SRC_RE, D as inferPlaceholder, E as extractInlineImageCandidates, F as resolveRequestUrl, I as safeFetchWithPolicy, L as safeHostForUrl, M as normalizeContentType, N as resolveAttachmentFetchPolicy, O as isDownloadableAttachment, P as resolveMediaSsrfPolicy, S as GRAPH_ROOT, T as extractHtmlFromAttachment, _ as loadMSTeamsSdkWithAuth, f as resolveMSTeamsCredentials, g as createMSTeamsTokenProvider, h as createMSTeamsAdapter, i as fetchGraphJson, j as isUrlAllowed, k as isLikelyImageAttachment, m as createBotFrameworkJwtValidator, w as applyAuthorizationHeaderForUrl, x as ATTACHMENT_TAG_RE, y as getMSTeamsRuntime } from "./graph-users-xiTzgdZR.js";
import { o as resolveMSTeamsChannelAllowlist, s as resolveMSTeamsUserAllowlist } from "./resolve-allowlist-Csr9lfvM.js";
import { S as createMSTeamsConversationStoreFs, _ as classifyMSTeamsSendError, b as createMSTeamsPollStoreFs, c as renderReplyPayloadsToMessages, d as withRevokedProxyFallback, f as getPendingUpload, g as uploadToConsentUrl, h as parseFileConsentInvoke, l as sendMSTeamsMessages, m as buildFileInfoCard, p as removePendingUpload, s as buildConversationReference, u as AI_GENERATED_ENTITY, v as formatMSTeamsSendErrorHint, x as extractMSTeamsPollVote, y as formatUnknownError } from "./probe-AeACvu8n.js";
...
function createMSTeamsMessageHandler(deps) {
	...
	const handleTeamsMessageNow = async (params) => {
		...
		if (activity.replyToId && isChannel && teamId) {try {
			...
			const formatted = formatThreadContext(parentMsg ? [parentMsg, ...replies] : replies, activity.id);
