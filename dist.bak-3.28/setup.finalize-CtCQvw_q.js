...
import { m as pathExists, v as resolveUserPath } from "./utils-BfvDpbwh.js";
import { Tp as listConfiguredWebSearchProviders } from "./auth-profiles-D5vQ2NEm.js";
import { r as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-CFIQ0-q3.js";
import { r as resolveCliName, t as formatCliCommand } from "./command-format-CR4nOXgc.js";
...
import { n as openUrl, t as detectBrowserOpenSupport } from "./browser-open-C4i2gCRs.js";
import { f as resolveControlUiLinks, g as waitForGatewayReachable, i as formatControlUiSshHint, u as probeGatewayReachable } from "./onboard-helpers-DKerP5bm.js";
import { r as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-6gftUGdu.js";
import { i as isSystemdUserServiceAvailable } from "./systemd-DgFX5bKr.js";
...
import { t as runTui } from "./tui-DG-2WDy2.js";
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger--ePzlpGf.js");
	...
	if (webSearchProvider) {
		const { resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-10YDKOcj.js");
		...
		const { hasExistingKey, hasKeyInEnv } = await import("./onboard-search-10YDKOcj.js");
