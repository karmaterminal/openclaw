...
import { P as validateConfigObjectRaw, g as readConfigFileSnapshot, x as writeConfigFile } from "./auth-profiles-D5vQ2NEm.js";
import { t as CONFIG_PATH } from "./paths-Y4UT24Of.js";
import { t as isBlockedObjectKey } from "./prototype-keys-DECjSrxt.js";
import { n as info, o as success, t as danger } from "./globals-0H99T-Tx.js";
import { a as normalizeConfigIssues, n as formatConfigIssueLines } from "./issue-format-CfhA-_wV.js";
import { d as resolveSecretInputRef, i as coerceSecretRef, s as isValidEnvSecretRefId } from "./types.secrets-Rqz2qv-w.js";
import { t as formatCliCommand } from "./command-format-CR4nOXgc.js";
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-DQ4e7rf7.js";
...
import { i as redactConfigObject, n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-CQsxn27c.js";
import { n as setCommandJsonMode } from "./json-mode-DkhfA36Z.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-B4MX4yex.js");
