...
import { d as normalizeShip, f as parseChannelNest, l as resolveTlonAccount, m as resolveTlonOutboundTarget, p as parseTlonTarget, s as validateUrbitBaseUrl, u as formatTargetHint } from "./setup-core-hAW93Ucc.js";
import { t as getTlonRuntime } from "./runtime-CIsy7EFM.js";
import "./runtime-api-C-SMTEM4.js";
import "./api-dxewEzjA.js";
import { t as tlonSetupWizard } from "./setup-surface-CUJsB7i_.js";
					...
					if (bucketRegionHeader) {
						if (statusCode === 301 || statusCode === 400 && (err?.name === "IllegalLocationConstraintException" || isHeadBucket)) {
							try {
								...
								throw new Error("Region redirect failed: " + e, { cause: e });
							}
							return next(args);
						}
					}
...
var require_dist_cjs$10 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const validateMrapAlias = (name) => {
		try {
			...
			throw new Error(`"${name}" is not a DNS compatible name.`, { cause: e });
		}
	};
