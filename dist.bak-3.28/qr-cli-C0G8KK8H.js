...
import { GO as readGatewayPasswordEnv, KO as readGatewayTokenEnv, f as loadConfig, fw as resolveCommandSecretRefsViaGateway, qy as assertExplicitGatewayAuthModeWhenBothConfigured, wI as resolveRequiredConfiguredSecretRefInputString } from "./auth-profiles-D5vQ2NEm.js";
import { u as resolveGatewayPort } from "./paths-Y4UT24Of.js";
import { n as runCommandWithTimeout } from "./exec-CLVZ7JOg.js";
import { a as hasConfiguredSecretInput, d as resolveSecretInputRef, l as normalizeSecretInputString } from "./types.secrets-Rqz2qv-w.js";
import { a as isCarrierGradeNatIpv4Address, f as isRfc1918Ipv4Address } from "./ip-Bta3TOaV.js";
import { c as resolveTailnetHostWithRunner, l as resolveGatewayBindUrl } from "./core-Dj4AGPqv.js";
import { _ as pickMatchingExternalInterfaceAddress, v as safeNetworkInterfaces } from "./net-BJZF7zzH.js";
import { i as getQrRemoteCommandSecretTargetIds } from "./command-secret-targets-DayQlnoD.js";
import { a as PAIRING_SETUP_BOOTSTRAP_PROFILE, n as issueDeviceBootstrapToken } from "./device-bootstrap-DKsEcfsd.js";
...
async function resolveGatewayTokenSecretRef(cfg, env) {
	if (resolveGatewayTokenFromEnv(env)) {return cfg;}
	const mode = cfg.gateway?.auth?.mode;
	if (mode === "password" || mode === "none" || mode === "trusted-proxy") {return cfg;}
	if (mode !== "token") {
		if (env.OPENCLAW_GATEWAY_PASSWORD?.trim()) {return cfg;}
	}
...
async function resolveGatewayPasswordSecretRef(cfg, env) {
	if (resolveGatewayPasswordFromEnv(env)) {return cfg;}
	const mode = cfg.gateway?.auth?.mode;
