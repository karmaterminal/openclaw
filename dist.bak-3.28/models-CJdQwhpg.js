...
import { BI as resolveModelKeysFromEntries, EP as loadModelCatalog, Es as resolvePluginProviders, FI as isLocalBaseUrl, GI as logConfigUpdated, Go as resolveApiKeyForProvider, HI as updateConfig, Ho as getCustomProviderApiKey, II as loadValidConfigOrThrow, Jf as resolveProfileUnusableUntilForDisplay, LI as mergePrimaryFallbackConfig, MI as ensureFlagCompatibility, NI as formatMs, NL as resolveAuthProfileDisplayLabel, Om as loadProviderUsageSummary, PI as formatTokenK, RI as normalizeAlias, Rf as resolveAuthProfileEligibility, Th as runEmbeddedPiAgent, UI as upsertCanonicalModelConfigEntry, VI as resolveModelTarget, Vf as clearAuthProfileCooldown, Wo as hasUsableCustomProviderApiKey, _ as readConfigFileSnapshotForWrite, bA as discoverModels, f as loadConfig, fw as resolveCommandSecretRefsViaGateway, gA as resolveModelWithRegistry, jI as applyDefaultModelPrimaryUpdate, jm as formatUsageWindowSummary, l as createConfigIO, qo as resolveUsableCustomProviderApiKey, ww as describeFailoverError, xA as shouldSuppressBuiltInModel, y as setRuntimeConfigSnapshot, yA as discoverAuthStorage, zI as resolveKnownAgentId, zf as resolveAuthProfileOrder } from "./auth-profiles-D5vQ2NEm.js";
import { d as resolveAuthStorePathForDisplay, i as loadAuthProfileStoreForRuntime, n as ensureAuthProfileStore, p as resolveOpenClawAgentDir } from "./store-BpAvd-ka.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-Dpv7c6Om.js";
import { n as findNormalizedProviderValue, r as normalizeProviderId } from "./provider-id-Bd9aU9Z8.js";
...
import { a as resolveAgentDir, m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir, s as resolveAgentExplicitModelPrimary, u as resolveAgentModelFallbacksOverride } from "./agent-scope-BSOSJbA_.js";
import { g as resolveDefaultAgentWorkspaceDir } from "./workspace-CFIQ0-q3.js";
import { f as parseModelRef, g as resolveDefaultModelForAgent, h as resolveConfiguredModelRef, i as buildModelAliasIndex, l as modelKey, s as isCliProvider, v as resolveModelRefFromString } from "./model-selection-CMtvxDDg.js";
import { d as isNonSecretApiKeyMarker, t as resolveEnvApiKey, w as shouldEnableShellEnvFallback, y as getShellEnvAppliedKeys } from "./model-auth-env-QeMWu7zp.js";
...
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-CFxPq48L.js";
import { i as resolveSecretRefString } from "./resolve-CFB7mNpd.js";
import { a as upsertAuthProfile, i as setAuthProfileOrder, n as listProfilesForProvider } from "./profiles-BPdDUT-J.js";
import { r as resolveAwsSdkEnvVarName } from "./provider-auth-runtime-Dm32mkHC.js";
import { r as getModelsCommandSecretTargetIds } from "./command-secret-targets-DayQlnoD.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-Cn7_lVDp.js";
import { r as withProgressTotals } from "./progress-BWNzIjJW.js";
import { m as resolveUsageProviderId } from "./provider-usage.fetch-8FvUl8iv.js";
import { n as openUrl } from "./browser-open-C4i2gCRs.js";
import "./onboard-helpers-DKerP5bm.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-Dfej3yGR.js";
import "./provider-auth-login-BWL1T-5J.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-Cet139yd.js";
import { t as maskApiKey } from "./mask-api-key-COLWOarw.js";
import { t as createClackPrompter } from "./clack-prompter-DSg64rDt.js";
import { n as renderTable, t as getTerminalTableWidth } from "./table-DJECaqHf.js";
import { a as isRemoteEnvironment, i as resolveProviderMatch, n as mergeConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-CW9JHXLJ.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-DgUDGxwX.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-og0reaKz.js";
import { n as redactSecrets } from "./format-DCr14uy2.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-Dp4h8VZx.js";
...
async function modelsListCommand(opts, runtime) {
	...
	const { ensureOpenClawModelsJson } = await import("./models-config-kBQSmfn3.js");
