...
import { Ds as applyPluginAutoEnable, Ry as formatHelpExamples, f as loadConfig, lw as resolveMessageChannelSelection, x as writeConfigFile } from "./auth-profiles-D5vQ2NEm.js";
...
function registerDirectoryCli(program) {
	...
	const resolve = async (opts) => {
		...
		} else if (autoEnabled.changes.length > 0) {await writeConfigFile(cfg);}
