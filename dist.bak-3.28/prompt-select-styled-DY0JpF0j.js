...
import { S as sleep, v as resolveUserPath, x as shortenHomePath } from "./utils-BfvDpbwh.js";
import { $y as resolveGatewayAuth, Ak as resolveMergedSafeBinProfileFixtures, CI as resolveConfiguredSecretInputWithFallback, DI as resolveCronStorePath, Ds as applyPluginAutoEnable, EI as loadCronStore, EL as LEGACY_TALK_PROVIDER_ID, EP as loadModelCatalog, ES as lookupTelegramChatId, Es as resolvePluginProviders, GI as logConfigUpdated, Go as resolveApiKeyForProvider, HS as listTelegramAccountIds, Jf as resolveProfileUnusableUntilForDisplay, Jy as hasAmbiguousGatewayAuthModeConfig, KO as readGatewayTokenEnv, KS as resolveTelegramAccount, Lk as getTrustedSafeBinDirs, M as migrateLegacyConfig, ML as formatAuthDoctorHint, NO as buildGatewayConnectionDetails, Nh as analyzeBootstrapBudget, OI as saveCronStore, OL as normalizeTalkSection, Ok as listInterpreterLikeSafeBins, PO as callGateway, Ph as buildBootstrapInjectionStats, QM as loadSessionStore, Qv as resolveGoogleChromeExecutableForPlatform, Rk as isTrustedSafeBinPath, TL as resolveNormalizedProviderModelMaxTokens, Xv as parseBrowserMajorVersion, Yk as listRiskyConfiguredSafeBins, Zv as readBrowserVersion, fg as resolveBootstrapContextForRun, fw as resolveCommandSecretRefsViaGateway, g as readConfigFileSnapshot, gI as isPrimarySessionTranscriptFileName, hI as formatSessionArchiveTimestamp, mc as resolveAgentSessionDirs, nA as resolveCommandResolutionFromArgv, t as resolveApiKeyForProfile, tg as resolveActiveMemoryBackendConfig, x as writeConfigFile, zS as inspectTelegramAccount, zk as normalizeTrustedSafeBinDirs } from "./auth-profiles-D5vQ2NEm.js";
import { c as updateAuthProfileStoreWithLock, n as ensureAuthProfileStore } from "./store-BpAvd-ka.js";
...
import { _ as resolveStateDir, d as resolveIsNixMode, h as resolveOAuthDir, t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-Y4UT24Of.js";
import { T as parseAgentSessionKey, _ as normalizeAccountId, g as DEFAULT_ACCOUNT_ID, v as normalizeOptionalAccountId } from "./session-key-BhxcMJEE.js";
import { a as resolveAgentDir, m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir } from "./agent-scope-BSOSJbA_.js";
import { n as runCommandWithTimeout, r as runExec } from "./exec-CLVZ7JOg.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-C-5WlcYo.js";
import { t as DEFAULT_AGENTS_FILENAME } from "./workspace-CFIQ0-q3.js";
import { _ as resolveHooksGmailModel, a as getModelRefStatus, h as resolveConfiguredModelRef } from "./model-selection-CMtvxDDg.js";
import { n as formatConfigIssueLines } from "./issue-format-CfhA-_wV.js";
import { a as hasConfiguredSecretInput, d as resolveSecretInputRef } from "./types.secrets-Rqz2qv-w.js";
import { k as cleanStaleLockFiles } from "./docker-ChQrdPd7.js";
import { y as migrateLegacyWebSearchConfig } from "./provider-web-search-I-919IKa.js";
import { C as formatSlackStreamingBooleanMigrationMessage, D as resolveSlackStreamingMode, E as resolveSlackNativeStreaming, O as resolveTelegramPreviewStreamMode, S as formatSlackStreamModeMigrationMessage, T as resolveDiscordPreviewStreamMode } from "./zod-schema.providers-core-BV8OcGxh.js";
import { r as normalizeChatChannelId } from "./chat-meta-xAV2SRO1.js";
import "./registry-M0RVxNlg.js";
import { i as normalizePluginId } from "./config-state-DDbfQQX4.js";
...
import { i as listRouteBindings } from "./bindings-sp0HwoK9.js";
import { d as shouldMoveSingleAccountChannelKey } from "./setup-helpers-D9SEfBub.js";
import { n as safeParseWithSchema, t as safeParseJsonWithSchema } from "./zod-parse-DgsspuWq.js";
import { s as parseToolsBySenderTypedKey } from "./channel-policy-CKDH6-ud.js";
import { r as resolveDmAllowState } from "./dm-policy-shared-C8YuyjhK.js";
import { n as listChannelPlugins } from "./plugins-BQ9CTy5q.js";
import { a as readChannelAllowFromStore } from "./pairing-store-CzypyvoV.js";
import { i as formatSetExplicitDefaultToConfiguredInstruction, n as formatChannelAccountsDefaultPath, r as formatSetExplicitDefaultInstruction } from "./routing-LZlQ54P8.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-CFxPq48L.js";
import { t as describeUnknownError } from "./shared-BjUNiwYH.js";
...
import { $ as resolveBootstrapTotalMaxChars, Z as resolveBootstrapMaxChars } from "./reply-payloads-dedupe-Cj4R1vEE.js";
import { l as DEFAULT_SANDBOX_IMAGE, r as resolveSandboxScope, s as DEFAULT_SANDBOX_BROWSER_IMAGE } from "./config-BSQFYjVD.js";
import "./logging-S_1ymJjU.js";
import { a as isWSL, s as isWSLEnv } from "./runtime-env-5bDkE44b.js";
import { d as resolveGatewayBindHost, r as isLoopbackHost } from "./net-BJZF7zzH.js";
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-DayQlnoD.js";
import { f as resolveGatewaySystemdServiceName, h as resolveNodeLaunchAgentLabel, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-yobxBGxY.js";
import { a as repairOAuthProfileIdMismatch } from "./provider-auth-wO8wlZma.js";
import { n as normalizeTelegramAllowFromEntry, t as isNumericTelegramUserId } from "./allow-from-B4Qrjj0t.js";
import { a as inspectPortUsage, c as formatPortDiagnostics } from "./ports-DaedVTZA.js";
import { t as collectProviderDangerousNameMatchingScopes } from "./dangerous-name-matching-PuaUWcr7.js";
import { a as resolveSystemNodeInfo, r as renderSystemNodeWarning } from "./runtime-paths-RaKpVytx.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint, t as resolveGatewayInstallToken } from "./gateway-install-token-huI-jdfs.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DzDNmci2.js";
import { a as guardCancel, d as randomToken, l as printWizardHeader, n as applyWizardMetadata } from "./onboard-helpers-DKerP5bm.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-Dfej3yGR.js";
import { i as launchAgentPlistExists, n as isLaunchAgentListed, r as isLaunchAgentLoaded, s as repairLaunchAgentBootstrap } from "./launchd-BdxtrFXa.js";
import { r as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-6gftUGdu.js";
import { d as uninstallLegacySystemdUnits, i as isSystemdUserServiceAvailable, p as classifySystemdUnavailableDetail } from "./systemd-DgFX5bKr.js";
...
import { t as readLastGatewayErrorLine } from "./diagnostics-DCyruA-_.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-BXVc9-ec.js";
import { _ as DEFAULT_GOOGLE_API_BASE_URL } from "./memory-core-host-engine-embeddings-DTYlGgeM.js";
import { t as hasConfiguredMemorySecretInput } from "./secret-input-96GwmPMH.js";
import { i as listBuiltinAutoSelectMemoryEmbeddingProviderDoctorMetadata, r as getBuiltinMemoryEmbeddingProviderDoctorMetadata } from "./manager-5q3dgpsQ.js";
import "./memory-core-engine-runtime-hUkaA31v.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-Czu6wMUQ.js";
import { a as buildPluginStatusReport, r as buildPluginCompatibilityWarnings } from "./status-DtTwgEYC.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-Cet139yd.js";
import { t as note$1 } from "./note-B43XVSkc.js";
import { r as resolveBundledPluginSources } from "./bundled-sources-DmXpo51Y.js";
import { r as healthCommand } from "./health-C4_k-zZi.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-C9ozoHA7.js";
import { g as normalizeStoredCronJobs, n as runGatewayUpdate, t as runStartupMatrixMigration } from "./server-startup-matrix-migration-BjcOXR_a.js";
import { n as runMatrixDoctorSequence, t as cleanStaleMatrixPluginConfig } from "./matrix-Buy7DL7I.js";
import { n as resolveProviderAuthLoginCommand, t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-og0reaKz.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-C4EGp4sv.js";
import { t as formatHealthCheckFailure } from "./health-format-DWoIMVon.js";
import { a as stripUnknownConfigKeys, i as resolveConfigPathTarget, n as formatConfigPath, r as noteOpencodeProviderOverrides, t as runDoctorConfigPreflight } from "./doctor-config-preflight-BO_EbrFq.js";
import { a as isMattermostMutableAllowEntry, i as isMSTeamsMutableAllowEntry, n as isGoogleChatMutableAllowEntry, o as isSlackMutableAllowEntry, r as isIrcMutableAllowEntry, s as isZalouserMutableGroupEntry, t as isDiscordMutableAllowEntry } from "./mutable-allowlist-detectors-kWeGYMw7.js";
import { n as doctorShellCompletion } from "./doctor-completion-chSbwkoi.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-CAy6o8Wy.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-i5Lfs2uG.js";
import { i as runLegacyStateMigrations, n as detectLegacyStateMigrations } from "./doctor-state-migrations-Ao4Fgi8j.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./provider-openai-codex-oauth-tls-DO9Y719h.js";
