import { $E as LogService, DD as ensureConfiguredAcpBindingReady, DE as isPollStartType, EE as isPollEventType, GE as resolveSharedMatrixClient, IE as resolveMatrixAccount, JE as resolveMatrixStoragePaths, LE as resolveMatrixAccountConfig, ME as resolveMatrixTargets, OD as resolveConfiguredAcpBindingRecord, PE as resolveConfiguredMatrixBotUserIds, WE as releaseSharedClientInstance, XE as resolveMatrixAuthContext, YE as resolveMatrixAuth, _E as MATRIX_REACTION_EVENT_TYPE, _j as formatLocationText, aE as sendReadReceiptMatrix, cE as inspectMatrixDirectRooms, dD as updateMatrixAccountConfig, dE as isStrictDirectMembership, eD as createAsyncLock, fE as isStrictDirectRoom, hE as setActiveMatrixClient, kE as parsePollStartContent, lP as getSessionBindingService, nE as reactMatrixMessage, oD as isBunRuntime, oE as sendTypingMatrix, pE as readJoinedMatrixMembers, qE as resolveMatrixStateFilePath, rE as sendMessageMatrix, tE as createMatrixThreadBindingManager, uE as hasDirectMatrixMemberFlag, vj as toLocationContext, wE as formatPollAsText, yE as extractMatrixReactionAnnotation } from "./auth-profiles-D5vQ2NEm.js";
...
import { n as formatAllowlistMatchMeta } from "./allowlist-match-CSOSv_ih.js";
...
import { c as buildAllowlistResolutionSummary, d as patchAllowlistUsersInConfigEntries, f as summarizeMapping, l as canonicalizeAllowlistWithResolvedIds, s as addAllowlistUserEntriesFromConfigEntry } from "./allow-from-C4_uNVuH.js";
import { c as getAgentScopedMediaLocalRoots } from "./web-media-BGv6FW5m.js";
import { n as createTypingCallbacks, o as createReplyPrefixOptions } from "./channel-reply-pipeline-DFacxqeY.js";
...
import { i as resolveMatrixRoomConfig, n as normalizeMatrixUserId, r as resolveMatrixAllowListMatch, t as normalizeMatrixAllowList } from "./allowlist-sPWuvCrJ.js";
import { n as summarizeMatrixDeviceHealth } from "./device-health-DtpOWJhJ.js";
import { t as syncMatrixOwnProfile } from "./profile-Bs9NUoaC.js";
import { t as formatMatrixEncryptedEventDisabledWarning } from "./encryption-guidance-Um5fmqbK.js";
import { a as formatMatrixMessageText, i as formatMatrixMediaUnavailableText, n as fetchMatrixPollSnapshot, o as resolveMatrixMessageAttachment, s as resolveMatrixMessageBody } from "./poll-summary-cm8TceiU.js";
...
function createDirectRoomTracker(client, opts = {}) {
	...
	return {
		...
		isDirectMessage: async (params) => {
			...
			if (strictDirectMembership) {
				if (await resolveDirectMemberFlag(roomId, senderId) || await resolveDirectMemberFlag(roomId, selfUserId)) {
...
function createMatrixRoomMessageHandler(params) {
	...
	return async (roomId, event) => {
		...
		try {
			...
			const replyContext = replyToEventId && replyToEventId === _threadRootId && threadContext?.summary ? {
				replyToBody: threadContext.summary,
				replyToSender: threadContext.senderLabel
			} : replyToEventId ? await resolveReplyContext({
				roomId,
