//#region src/plugins/bundled-plugin-metadata.generated.ts
const GENERATED_BUNDLED_PLUGIN_METADATA = [
	{
		dirName: "acpx",
		idHint: "acpx",
		source: {
	...
	},
	{
		...
		manifest: {
			...
			enabledByDefault: true,
			providers: ["litellm"],
			providerAuthEnvVars: { litellm: ["LITELLM_API_KEY"] },
			providerAuthChoices: [{
				provider: "litellm",
				method: "api-key",
	...
	},
	{
		...
		manifest: {
			...
			providerAuthEnvVars: { "microsoft-foundry": ["AZURE_OPENAI_API_KEY"] },
			providerAuthChoices: [{
	...
	},
	{
		...
		manifest: {
			...
			contracts: { mediaUnderstandingProviders: ["mistral"] }
		}
	},
	{
		dirName: "modelstudio",
	...
	},
	{
		...
		manifest: {
			...
			contracts: { mediaUnderstandingProviders: ["openrouter"] }
		}
	},
	{
		dirName: "openshell",
...
//#endregion
export { CHAT_CHANNEL_ORDER as a, CHANNEL_IDS as i, listChatChannels as n, GENERATED_BUNDLED_PLUGIN_METADATA as o, normalizeChatChannelId as r, getChatChannelMeta as t };
