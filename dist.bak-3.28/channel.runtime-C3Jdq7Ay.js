...
import { i as resolveInboundRouteEnvelopeBuilderWithRuntime, r as resolveMentionGatingWithBypass } from "./text-chunking-DzwxNDbL.js";
import { a as resolveWebhookTargetWithAuthOrReject, c as withResolvedWebhookRequestPipeline, n as registerWebhookTargetWithPluginRoute } from "./webhook-ingress-CTk9JGVm.js";
...
import { a as createWebhookInFlightLimiter, s as readJsonWebhookBodyOrReject } from "./webhook-request-guards-BcAHiveC.js";
...
import "./runtime-api-CQ7rS-Xv.js";
import { c as sendGoogleChatMessage, d as verifyGoogleChatRequest, i as downloadGoogleChatMedia, l as updateGoogleChatMessage, n as deleteGoogleChatMessage, s as probeGoogleChat, u as uploadGoogleChatAttachment } from "./api-DGQgof_j.js";
...
function warnDeprecatedUsersEmailEntries(logVerbose, entries) {
	...
	const key = deprecated.map((v) => v.toLowerCase()).toSorted().join(",");
...
function warnMutableGroupKeysConfigured(logVerbose, groups) {
	...
	const warningKey = mutableKeys.map((key) => key.toLowerCase()).toSorted().join(",");
...
async function uploadAttachmentForReply(params) {
	...
	const { uploadGoogleChatAttachment } = await import("./api-C_y5vi2b2.js");
