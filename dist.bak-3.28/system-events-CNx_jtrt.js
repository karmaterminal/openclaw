...
function parseContinuationSignal(text) {
	...
	if (delegateMatch) {
		...
		if (delayMatch) {
			delayMs = parseInt(delayMatch[1], 10) * 1e3;
	...
	if (workMatch) {
		const delaySec = workMatch[1] ? parseInt(workMatch[1], 10) : void 0;
		return {
			kind: "work",
...
//#endregion
export { normalizeAccountId as A, deliveryContextFromSession as C, normalizeDeliveryContext as D, mergeDeliveryContext as E, resolveFreshSessionTotalTokens as F, setSessionRuntimeModel as I, mergeSessionEntry as M, mergeSessionEntryPreserveActivity as N, normalizeSessionDeliveryFields as O, normalizeSessionRuntimeModelFields as P, stripSilentToken as S, formatConversationTarget as T, SILENT_REPLY_TOKEN as _, isSystemEventContextChanged as a, isSilentReplyText as b, removeSystemEvents as c, DEFAULT_HEARTBEAT_ACK_MAX_CHARS as d, HEARTBEAT_PROMPT as f, HEARTBEAT_TOKEN as g, stripHeartbeatToken as h, hasSystemEvents as i, DEFAULT_RESET_TRIGGERS as j, resolveConversationDeliveryTarget as k, resetSystemEventsForTest as l, resolveHeartbeatPrompt as m, drainSystemEvents as n, peekSystemEventEntries as o, isHeartbeatContentEffectivelyEmpty as p, enqueueSystemEvent as r, peekSystemEvents as s, drainSystemEventEntries as t, resolveSystemEventDeliveryContext as u, isSilentReplyPayloadText as v, deliveryContextKey as w, stripContinuationSignal as x, isSilentReplyPrefixText as y };
