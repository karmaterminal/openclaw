...
import { FL as inheritOptionFromParent, Lb as resolveGatewayConnectionAuth, NO as buildGatewayConnectionDetails, f as loadConfig } from "./auth-profiles-D5vQ2NEm.js";
import { o as sanitizeTerminalText } from "./issue-format-CfhA-_wV.js";
...
import { d as isKnownCoreToolId } from "./tool-policy-B6bYv49c.js";
import { r as listThinkingLevels } from "./thinking-BIe_TekB.js";
...
import { t as DANGEROUS_ACP_TOOLS } from "./dangerous-tools-B2Ih80tT.js";
import { t as readSecretFromFile } from "./secret-file-uZ-Qjlfh.js";
...
async function createAcpClient(opts = {}) {
	...
	const log = opts.verbose ? (msg) => console.error(`[acp-client] ${msg}`) : () => {};
	...
	const { getActiveSkillEnvKeys } = await import("./env-overrides.runtime-DVsjzfhe.js");
...
const ACP_PROVENANCE_MODE_VALUES = new Set([
	"off",
	"meta",
	"meta+receipt"
]);
function normalizeAcpProvenanceMode(value) {
	if (!value) return;
	const normalized = value.trim().toLowerCase();
	return ACP_PROVENANCE_MODE_VALUES.has(normalized) ? normalized : void 0;
}
