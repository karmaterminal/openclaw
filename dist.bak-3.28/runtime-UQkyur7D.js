...
import { $D as resolveAgentTimeoutMs, $M as readSessionUpdatedAt, $c as resolveThreadBindingIdleTimeoutMs, $j as pushTextMessageWithQuickReplies, $s as sendPollWhatsApp, BF as chunkTextWithMode, Bb as telegramMessageActions, Cb as CommandLane, Cj as isControlCommandMessage, Dp as runWebSearch, Ep as listWebSearchProviders, FM as probeLineBot, HF as resolveTextChunkLimit, Hc as setThreadBindingIdleTimeoutBySessionKey, Hs as loginWeb, IF as chunkByNewline, JP as saveMediaBuffer, Jc as getThreadBindingManager, Js as readWebSelfId, LF as chunkMarkdownText, Ls as getWebAuthAgeMs, Ob as setTelegramThreadBindingIdleTimeoutBySessionKey, Oj as formatAgentEnvelope, Ps as getActiveWebListener, QC as resolveHeartbeatSenderContext, QM as loadSessionStore, QO as setHeartbeatWakeHandler, Qd as monitorLineProvider, Qj as pushTemplateMessage, Qs as sendMessageWhatsApp, RF as chunkMarkdownTextWithMode, Rj as createInboundDebouncer, Rs as handleWhatsAppAction, Td as resolveHeartbeatReplyPayload, Uc as setThreadBindingMaxAgeBySessionKey, Uj as createQuickReplyItems, Us as logoutWeb, VF as resolveChunkMode, VM as dispatchReplyFromConfig, Vs as logWebSelfId, Wc as unbindThreadBindingsBySessionKey, Ws as monitorWebChannel, XO as areHeartbeatsEnabled, Xj as pushMessageLine, YS as resolveTelegramToken, Yj as pushLocationMessage, ZC as resolveHeartbeatDeliveryTarget, ZO as requestHeartbeatNow, Zj as pushMessagesLine, _b as getQueueSize, aM as normalizeAccountId, ac as loadPluginBoundaryModuleWithJiti, ag as onSessionTranscriptUpdate, bM as buildTemplateMessageFromPayload, cI as evaluateSessionFreshness, eN as recordSessionMetaFromInbound, ek as resolveHeartbeatReasonKind, el as resolveThreadBindingInactivityExpiresAt, f as loadConfig, fC as recordInboundSession, fd as getReplyFromConfig, fi as sendMessageIMessage, gM as recordChannelActivity, hM as getChannelActivity, iC as sendMessageSignal, iM as listLineAccountIds, iN as updateSessionStore, ic as webAuthExists, id as dispatchReplyWithBufferedBlockDispatcher, jF as convertMarkdownTables, jd as createReplyDispatcherWithTyping, jh as onAgentEvent, jj as resolveEnvelopeFormatOptions, kI as resolveMarkdownTableMode, kb as setTelegramThreadBindingMaxAgeBySessionKey, kd as withReplyDispatcher, kj as formatInboundEnvelope, ks as createRuntimeWhatsAppLoginTool, lM as resolveHeartbeatVisibility, mM as resolveIndicatorType, mg as clearBootstrapSnapshotOnSessionRollover, nN as saveSessionStore, nl as resolveThreadBindingMaxAgeMs, nw as deliverOutboundPayloads, oM as resolveDefaultLineAccountId, oc as resolvePluginRuntimeModulePath, ol as discordMessageActions, pi as probeIMessage, qj as pushFlexMessage, rC as monitorSignalProvider, rN as updateLastRoute, rc as waitForWebLogin, sL as appendCronStyleCurrentTimeLine, sM as resolveLineAccount, sc as resolvePluginRuntimeRecord, tC as probeSignal, tM as sendMessageLine, tc as startWebLoginWithQr, tl as resolveThreadBindingMaxAgeExpiresAt, tw as buildOutboundSessionContext, uF as isVoiceCompatibleAudio, uI as resolveSessionResetPolicy, uM as emitHeartbeatEvent, ui as monitorIMessageProvider, vC as signalMessageActions, vw as generateImage, wj as shouldComputeCommandAuthorized, x as writeConfigFile, xj as hasControlCommand, yw as listRuntimeImageGenerationProviders, zF as chunkText, zj as resolveInboundDebounceMs } from "./auth-profiles-D5vQ2NEm.js";
...
import { g as HEARTBEAT_TOKEN, h as stripHeartbeatToken, m as resolveHeartbeatPrompt$1, o as peekSystemEventEntries, p as isHeartbeatContentEffectivelyEmpty, r as enqueueSystemEvent, u as resolveSystemEventDeliveryContext } from "./system-events-CNx_jtrt.js";
import { h as fetchRemoteMedia, t as loadWebMedia } from "./web-media-BGv6FW5m.js";
...
import { n as collectTelegramUnmentionedGroupIds } from "./audit-CshMOFnq.js";
import "./line-runtime-C5DI2Dq-.js";
import { n as resolveHeartbeatIntervalMs, t as isHeartbeatEnabledForAgent } from "./heartbeat-summary-Ddyaw9vb.js";
...
const loadEmbeddedPiRuntime = createLazyRuntimeModule(() => import("./runtime-embedded-pi.runtime-DXu1aQzp.js"));
...
const bindDiscordRuntimeMethod = createLazyRuntimeMethodBinder(createLazyRuntimeSurface(() => import("./runtime-discord-ops.runtime-1Y1aAdYX.js"), ({ runtimeDiscordOps }) => runtimeDiscordOps));
...
const bindSlackRuntimeMethod = createLazyRuntimeMethodBinder(createLazyRuntimeSurface(() => import("./runtime-slack-ops.runtime-CDEIO3xi.js"), ({ runtimeSlackOps }) => runtimeSlackOps));
...
const bindTelegramRuntimeMethod = createLazyRuntimeMethodBinder(createLazyRuntimeSurface(() => import("./runtime-telegram-ops.runtime-CWsKiK6P.js"), ({ runtimeTelegramOps }) => runtimeTelegramOps));
...
async function runHeartbeatOnce(opts) {
	...
	try {
		...
		const continuationTrigger = opts.reason === "continuation" ? "work-wake" : opts.reason === "silent-wake-enrichment" ? "delegate-return" : void 0;
...
const loadTtsRuntime = createLazyRuntimeModule(() => import("./runtime-tts.runtime-U5kA1YPc.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("./runtime-media-understanding.runtime-CMXjsAXy.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("./runtime-model-auth.runtime-Bk9kx6Zl.js"));
