...
import { t as require_src$1 } from "./src-DjQPu5JV.js";
import { t as require_jsonwebtoken } from "./jsonwebtoken-DkbYQrdW.js";
import { n as require_logging, t as require_http } from "./http-DKMY7M3N.js";
...
var require_jwt_claims_set = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	exports.default = (protectedHeader, encodedPayload, options = {}) => {
		...
		for (const claim of new Set(requiredClaims.toReversed())) {if (!(claim in payload)) throw new errors_js_1.JWTClaimValidationFailed(`missing required "${claim}" claim`, claim, "missing");}
