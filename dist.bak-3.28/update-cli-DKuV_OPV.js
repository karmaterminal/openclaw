...
import { m as pathExists } from "./utils-BfvDpbwh.js";
import { t as formatDocsLink } from "./links-CNsP_rfF.js";
import { r as theme } from "./theme-D-TumEpz.js";
import { FL as inheritOptionFromParent, Hw as trimLogTail, Ry as formatHelpExamples, g as readConfigFileSnapshot, x as writeConfigFile } from "./auth-profiles-D5vQ2NEm.js";
import { n as DEFAULT_GATEWAY_PORT, u as resolveGatewayPort } from "./paths-Y4UT24Of.js";
...
import { a as parseSemver, i as nodeVersionSatisfiesEngine } from "./runtime-guard-CV-PHKDn.js";
import { n as replaceCliName, r as resolveCliName, t as formatCliCommand } from "./command-format-CR4nOXgc.js";
import { n as quoteCmdScriptArg } from "./cmd-argv-f68FnQYd.js";
import { r as formatDurationPrecise } from "./format-duration-QPQGNRFx.js";
import { f as resolveGatewaySystemdServiceName, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-yobxBGxY.js";
import { n as stylePromptMessage } from "./prompt-style-Dfej3yGR.js";
import { r as resolveGatewayService } from "./service-6gftUGdu.js";
import { r as runDaemonRestart, s as runDaemonInstall } from "./daemon-cli-BG52FcwC.js";
import { a as terminateStaleGatewayPids, i as renderRestartDiagnostics, s as waitForGatewayHealthyRestart } from "./status-fO8WhOVk.js";
import { r as installCompletion } from "./completion-cli-uSeinmGv.js";
import { n as renderTable, t as getTerminalTableWidth } from "./table-DJECaqHf.js";
import { c as resolveEffectiveUpdateChannel, i as formatUpdateChannelLabel, l as resolveUpdateChannelDisplay, r as channelToNpmTag, s as normalizeUpdateChannel } from "./update-channels-4XPhd4aG.js";
import { i as fetchNpmTagVersion, n as compareSemverStrings, o as resolveNpmChannelTag, r as fetchNpmPackageTargetStatus, t as checkUpdateStatus } from "./update-check-cCN4G58b.js";
import { a as collectInstalledGlobalPackageErrors, c as detectGlobalInstallManagerForRoot, d as resolveGlobalInstallSpec, f as resolveGlobalPackageRoot, h as readPackageVersion, i as cleanupGlobalRenameDirs, l as globalInstallArgs, m as readPackageName, n as runGatewayUpdate, o as createGlobalInstallEnv, p as normalizePackageTagInput, r as canResolveRegistryVersionForPackageTarget, s as detectGlobalInstallManagerByPresence, u as resolveExpectedInstalledVersionFromSpec } from "./server-startup-matrix-migration-BjcOXR_a.js";
import { n as updateNpmInstalledPlugins, t as syncPluginsForUpdateChannel } from "./update-gk4ubjrc.js";
import { n as doctorCommand, t as selectStyled } from "./prompt-select-styled-DY0JpF0j.js";
import { r as ensureCompletionCacheExists, t as checkShellCompletionStatus } from "./doctor-completion-chSbwkoi.js";
