import { IE as resolveMatrixAccount, LE as resolveMatrixAccountConfig, QE as setMatrixSdkLogMode, XE as resolveMatrixAuthContext, ZE as setMatrixSdkConsoleLogging, cD as matrixSetupAdapter, cE as inspectMatrixDirectRooms, dD as updateMatrixAccountConfig, lE as repairMatrixDirectRooms, tD as resolveMatrixRoomKeyBackupIssue, uD as resolveMatrixConfigPath } from "./auth-profiles-D5vQ2NEm.js";
...
import { c as getMatrixRoomKeyBackupStatus, h as restoreMatrixRoomKeyBackup, m as resetMatrixRoomKeyBackup, n as bootstrapMatrixVerification, u as getMatrixVerificationStatus, v as verifyMatrixRecoveryKey, x as withStartedActionClient, y as withResolvedActionClient } from "./verification-CzEGmwZv.js";
import { n as summarizeMatrixDeviceHealth, t as isOpenClawManagedMatrixDevice } from "./device-health-DtpOWJhJ.js";
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-wxL_C9Hx.js";
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-ClROfUO7.js");
