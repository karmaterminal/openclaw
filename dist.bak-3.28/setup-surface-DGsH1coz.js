...
import { Mj as createDirectDmPreCryptoGuardPolicy } from "./auth-profiles-D5vQ2NEm.js";
import { _ as normalizeAccountId$1, g as DEFAULT_ACCOUNT_ID, v as normalizeOptionalAccountId } from "./session-key-BhxcMJEE.js";
import { a as DmPolicySchema, m as MarkdownConfigSchema } from "./zod-schema.core-CGoKjdG2.js";
import { r as buildChannelConfigSchema, t as AllowFromListSchema } from "./config-schema-DGr8UxxF.js";
import { t as safeParseJsonWithSchema } from "./zod-parse-DgsspuWq.js";
import { i as listCombinedAccountIds, o as resolveListedDefaultAccountId } from "./account-helpers-DklgKoS9.js";
import "./routing-LZlQ54P8.js";
import "./setup-Fad77i7o.js";
import { C as createTopLevelChannelDmPolicy, D as mergeAllowFromEntries, E as createTopLevelChannelParsedAllowFromPrompt, I as patchTopLevelChannelConfigSection, N as parseSetupEntriesWithParser, st as splitSetupEntries, x as createStandardChannelSetupStatus } from "./setup-wizard-proxy-IaAsrs3a.js";
...
import "./runtime-api-49FuY-wZ.js";
...
const NostrConfigSchema = zod_exports.z.object({
	...
	privateKey: zod_exports.z.string().optional(),
...
function bytesToNumberLE(bytes) {
	return hexToNumber(bytesToHex(copyBytes$1(abytes$2(bytes)).toReversed()));
}
...
function numberToBytesLE(n, len) {
	return numberToBytesBE(n, len).toReversed();
}
/**
	...
	function pointFromBytes(bytes) {
		...
		if (length === comp && (head === 2 || head === 3)) {
			...
			try {
				...
				throw new Error("bad point: is not on curve, sqrt error" + err, { cause: sqrtError });
			}
			assertCompressionIsSupported();
...
function encodeTLV(tlv) {
	let entries = [];
	Object.entries(tlv).toReversed().forEach(([t, vs]) => {
		vs.forEach((v) => {
...
function decodePayload(payload) {
	...
	try {
		...
		throw new Error("invalid base64: " + error.message, { cause: error });
	}
