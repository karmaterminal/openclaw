...
import { Z as normalizeGoogleApiBaseUrl } from "./io-Cs-0dhMf.js";
...
import { F as resolveProviderSystemPromptContribution, I as resolveProviderTextTransforms, q as transformProviderSystemPrompt } from "./provider-runtime-DfaoEnkb.js";
...
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, o as startsWithSilentToken, r as isSilentReplyPayloadText } from "./tokens-CPoUE_99.js";
import { t as filterHeartbeatPairs } from "./heartbeat-filter-D0roj1rm.js";
import { B as resolveLiveToolResultMaxChars, C as limitHistoryTurns, E as estimateMessagesTokens, F as readLastCacheTtlTimestamp, G as installToolResultContextGuard, I as resolveTranscriptPolicy, J as assessLastAssistantMessage, K as repairSessionFileIfNeeded, L as shouldAllowProviderOwnedThinkingReplay, N as resolveCompactionTimeoutMs, P as isCacheTtlEligibleProvider, Q as buildStreamErrorAssistantMessage, R as guardSessionManager, S as getDmHistoryLimitFromSessionKey, T as SAFETY_MARGIN, U as truncateOversizedToolResultsInSessionManager, W as installContextEngineLoopHook, X as createBundleLspToolRuntime, Y as dropThinkingBlocks, Z as releaseWsSession, _ as trackSessionManagerAccess, a as collectAllowedToolNames, b as validateReplayTurns, c as applySystemPromptOverrideToSession, d as describeEmbeddedAgentStreamStrategy, et as isReasoningTagProvider, f as resolveEmbeddedAgentApiKey, g as prewarmSessionFile, h as resolveEmbeddedRunSkillEntries, i as PI_RESERVED_TOOL_NAMES, j as applyFinalEffectiveToolPolicy, l as buildEmbeddedSystemPrompt, m as resolveEmbeddedAgentStreamFn, n as mapThinkingLevel, o as collectRegisteredToolNames, p as resolveEmbeddedAgentBaseStreamFn, q as createPreparedEmbeddedPiSettingsManager, r as splitSdkTools, s as toSessionToolAllowlist, t as flushPendingToolResultsAfterIdle, tt as resolveChannelCapabilities, u as createSystemPromptOverride, v as normalizeAssistantReplayContent, w as buildEmbeddedExtensionFactories, x as buildEmbeddedMessageActionDiscoveryInput, y as sanitizeSessionHistory, z as estimateToolResultReductionPotential } from "./wait-for-idle-before-flush-0K_Sexmv.js";
import { _ as stripProviderPrefix, g as isStrictAgenticSupportedProviderModel, v as isEmbeddedMode } from "./openclaw-tools-x0WbKigH.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-BtkRii-E.js";
...
import { n as getPluginToolMeta } from "./tools-DHDhlGv0.js";
...
import { a as prependBootstrapPromptWarning, i as buildBootstrapTruncationReportMeta, n as buildBootstrapInjectionStats, r as buildBootstrapPromptWarning, t as analyzeBootstrapBudget } from "./bootstrap-budget-COeZk8QH.js";
import { a as resolveContextInjectionMode, i as resolveBootstrapContextForRun, n as hasCompletedBootstrapTurn, r as makeBootstrapWarn, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-MdeD5byQ.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-BpR-M-em.js";
...
import { T as parseExecApprovalResultText, d as stableStringify$1, f as coerceChatContentText } from "./sanitize-user-facing-text-DhtkBIxZ.js";
import { a as formatAssistantErrorText, l as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-Do7ZlTNo.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-D6h4jsAt.js";
import { o as hasUnredactedSessionsSpawnAttachments, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-05zrgZyi.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-BSIcuxrK.js";
import { a as listChannelSupportedActions, c as resolveChannelReactionGuidance, o as resolveChannelMessageToolCapabilities, s as resolveChannelMessageToolHints } from "./channel-tools-C-dcr0JU.js";
import { t as resolveOpenClawDocsPath } from "./docs-path-CY6hajwR.js";
import { a as isTimeoutError } from "./failover-error-DLvpkqiP.js";
import { t as buildModelAliasLines } from "./model-alias-lines-C4wjTJgq.js";
import { t as sanitizeForConsole } from "./console-sanitize-DO-K4Q3S.js";
import { c as resolveModelAuthMode } from "./model-auth-CMq_TSIy.js";
import { a as supportsModelTools, n as normalizeProviderToolSchemas, t as logProviderToolSchemaDiagnostics } from "./tool-schema-runtime-DOOb8IQw.js";
import { t as registerProviderStreamForModel } from "./provider-stream-Bp1raIge.js";
import { t as log$3 } from "./logger-BGiI50uA.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-DHvpt940.js";
import { i as ensureGlobalUndiciStreamTimeouts, r as ensureGlobalUndiciEnvProxyDispatcher, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-C00f4BrA.js";
import { c as sanitizeTransportPayloadText, h as buildGuardedModelFetch, o as mergeTransportHeaders, p as sanitizeToolUseResultPairing } from "./transport-stream-shared-DwtR4Xuz.js";
import { i as getOrCreateSessionMcpRuntime } from "./pi-bundle-mcp-runtime-DdX3YJcs.js";
import { n as materializeBundleMcpToolsForRun } from "./pi-bundle-mcp-tools-qRT695En.js";
import { n as setReplyPayloadMetadata } from "./reply-payload-DSDhOmpq.js";
import { r as parseFenceSpans } from "./fences-C7g4n6ME.js";
import { r as splitMediaFromOutput } from "./parse-lIqF4Pb-.js";
import { u as parseReplyDirectives } from "./payloads-mE51ebOD.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-CTjR9c6j.js";
import { _ as sanitizeToolResult, b as formatToolAggregate, d as extractToolErrorMessage, f as extractToolResultMediaArtifact, g as isToolResultTimedOut, h as isToolResultError, l as runContextEngineMaintenance, m as filterToolResultMediaUrls, n as assembleHarnessContextEngine, o as finalizeHarnessContextEngineTurn, p as extractToolResultText, r as bootstrapHarnessContextEngine, t as buildEmbeddedAttemptToolRunContext, u as extractMessagingToolSend, v as isMessagingTool, y as isMessagingToolSendAction } from "./attempt.tool-run-context-Cm9PJr4Q.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-C8HkzMDO.js";
import { o as buildApiErrorObservationFields, s as buildTextObservationFields } from "./model-fallback-BVFj4gQZ.js";
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-7aw1Xm91.js";
import { a as stripDowngradedToolCallText } from "./assistant-visible-text-OS6-0xmV.js";
...
import { a as MIN_PROMPT_BUDGET_TOKENS, i as MIN_PROMPT_BUDGET_RATIO, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-BW3hztbs.js";
import { o as diagnosticErrorCategory } from "./pi-tools.before-tool-call-CvoLJzfW.js";
import { i as toClientToolDefinitions, n as findClientToolNameConflicts, t as createClientToolNameConflictError } from "./pi-tool-definition-adapter-oYHb8JMi.js";
import { n as resolveToolLoopDetectionConfig, t as createOpenClawCodingTools } from "./pi-tools-MtvWAeXz.js";
import { a as resolveGroupToolPolicy, o as resolveSubagentToolPolicyForSession, r as resolveEffectiveToolPolicy } from "./read-capability-BS3iiLfC.js";
import { i as resolveSubagentCapabilityStore, t as isSubagentEnvelopeSession } from "./subagent-capabilities-B5OlIhRI.js";
import { l as setActiveEmbeddedRun, n as clearActiveEmbeddedRun, u as updateActiveEmbeddedRunSnapshot } from "./runs-Cc8U4QH8.js";
import { t as resolveAgentTimeoutMs } from "./timeout-BSZPJ2oJ.js";
import { o as resolveSandboxContext } from "./sandbox-C2v_pBwb.js";
import { n as rewriteTranscriptEntriesInSessionManager } from "./transcript-rewrite-9kQvtAEn.js";
import { t as detectRuntimeShell } from "./shell-utils-Bn69N8Ga.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-lt3-hHCv.js";
import { s as resolveSkillsPromptForRun } from "./workspace-9W7oRVFf.js";
import "./skills-Btkps-SF.js";
import { t as resolveSystemPromptOverride } from "./system-prompt-override-CG2zDHfj.js";
import { t as buildSystemPromptParams } from "./system-prompt-params-DzuJgjYC.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-DRzFmFgd.js";
import "./tool-loop-detection-BOnA_ptR.js";
import { b as visitObjectContentBlocks, i as createHtmlEntityToolCallArgumentDecodingWrapper } from "./provider-stream-shared-C7C9MWDe.js";
import { n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-CAesiHZT.js";
import { n as buildAgentUserPromptPrefix } from "./system-prompt-B7w7bVeP.js";
import { i as streamWithPayloadPatch } from "./moonshot-thinking-stream-wrappers-DbZ_E7pR.js";
import { t as parseGeminiAuth } from "./gemini-auth-BcY_t-iA.js";
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-CU66zcc8.js";
import { a as shouldUseOpenAIWebSocketTransport, i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-BUzOohOk.js";
...
import { n as extractBalancedJsonPrefix } from "./balanced-json-AIoIshbd.js";
import { t as detectAndLoadPromptImages } from "./images-ixiJfZhg.js";
...
async function reconcileSessionStoreCompactionCountAfterSuccess(params) {
	const { reconcileSessionStoreCompactionCountAfterSuccess: reconcile } = await import("./pi-embedded-subscribe.handlers.compaction.runtime-BV1I-KMb.js");
...
function loadExecApprovalReply() {
	execApprovalReplyModulePromise ??= import("./exec-approval-reply-V1dGDAia.js");
...
function loadMediaParse() {
	mediaParseModulePromise ??= import("./parse-D_zkWw-D.js");
	return mediaParseModulePromise;
}
function loadBeforeToolCall() {
	beforeToolCallModulePromise ??= import("./pi-tools.before-tool-call-BRS7968N.js");
