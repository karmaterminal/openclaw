...
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-BTs7w1_x.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-Uyz9oNNv.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-C4cfCpm1.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("./jsonwebtoken-HPBlmA3b.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-CxAy9Z_i.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwt, { JwksClient }]) => ({
		jwt,
		JwksClient
	}));
