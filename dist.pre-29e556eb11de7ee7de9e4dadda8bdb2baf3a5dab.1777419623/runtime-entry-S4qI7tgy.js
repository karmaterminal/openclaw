...
import { g as resolveRealtimeVoiceAgentConsultToolsAllow, h as resolveRealtimeVoiceAgentConsultTools, s as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME } from "./provider-resolver-D04YQ4Uj.js";
import { s as consultRealtimeVoiceAgent, t as convertPcmToMulaw8k } from "./realtime-voice-BzykyGeN.js";
import { t as resolveConfiguredCapabilityProvider } from "./provider-selection-runtime-D58uIm4u.js";
import { t as zod_exports } from "./zod-_6ahcKaz.js";
import "./api-y34RlDPW.js";
import { a as deepMergeDefined, i as validateProviderConfig, n as normalizeVoiceCallConfig, r as resolveVoiceCallConfig } from "./config-FCTmVA3-.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-DjTRsPLt.js";
import { t as resolveVoiceResponseModel } from "./response-model-CQCDOLg3.js";
import { t as isProviderStatusTerminal } from "./call-status-CvE7baRZ.js";
import { t as getHeader } from "./http-headers-u6NiZNFw.js";
...
function loadRealtimeTranscriptionRuntime() {
	realtimeTranscriptionRuntimePromise ??= import("./realtime-transcription.runtime-CFXNEjZM.js");
	return realtimeTranscriptionRuntimePromise;
}
function loadResponseGeneratorModule() {
	responseGeneratorModulePromise ??= import("./response-generator-DnvwWVj3.js");
...
function loadTelnyxProvider() {
	telnyxProviderPromise ??= import("./telnyx-DizNdRtX.js");
	return telnyxProviderPromise;
}
function loadTwilioProvider() {
	twilioProviderPromise ??= import("./twilio-O61XmMCY.js");
	return twilioProviderPromise;
}
function loadPlivoProvider() {
	plivoProviderPromise ??= import("./plivo-D2_EzsOS.js");
	return plivoProviderPromise;
}
function loadMockProvider() {
	mockProviderPromise ??= import("./mock-OO0wABzU.js");
	return mockProviderPromise;
}
function loadRealtimeVoiceRuntime() {
	realtimeVoiceRuntimePromise ??= import("./realtime-voice.runtime-Clo9eVdg.js");
	return realtimeVoiceRuntimePromise;
}
function loadRealtimeHandler() {
	realtimeHandlerPromise ??= import("./realtime-handler-Dg7LRiXd.js");
