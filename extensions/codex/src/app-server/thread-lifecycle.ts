...
export async function startOrResumeThread(params: {
  ...
  // restricted thread can persist. The native-tool-restriction and explicit /
  // unknown web-search rotation kinds above (upstream) handle MCP-config churn
  // on a still-restricted turn; this deferral owns the legacy-fingerprint case.
