import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-Dm-cOPC0.js";
import { r as loadCrestodianOverview } from "./overview-D9D6aPOW.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-CY-Ln7Tm.js")).planCrestodianCommand)({
		input,
		overview
	});
