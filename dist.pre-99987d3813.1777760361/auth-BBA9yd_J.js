...
import { s as loadAuthProfileStoreForRuntime } from "./store-D-PUpS_m.js";
import { n as resolvePluginProviders } from "./providers.runtime-D9m8HZCm.js";
import "./model-selection-shared-C_hgcjGe.js";
import { n as listProfilesForProvider } from "./profile-list-DtbttjVj.js";
import { i as upsertAuthProfile } from "./profiles-xFFkxGDS.js";
import { n as clearAuthProfileCooldown } from "./usage-CD9yZJ44.js";
import "./workspace-DSIvVEKH.js";
import { n as validateAnthropicSetupToken } from "./provider-auth-token-B8G1yXL8.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-DWKifSeJ.js";
import { n as stylePromptMessage, t as stylePromptHint } from "./prompt-style-sImTPA14.js";
import { t as createClackPrompter } from "./clack-prompter-codgJDwL.js";
import { n as logConfigUpdated } from "./logging-YO-7Q2O7.js";
import { a as loadValidConfigOrThrow, s as resolveKnownAgentId, u as updateConfig } from "./shared-DjY3liej.js";
import { i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-CioZRi01.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-BEiXikUR.js";
import { t as isRemoteEnvironment } from "./remote-env-CEDHA8qY.js";
...
async function runProviderAuthMethod(params) {
	...
	await persistProviderAuthResult({
		result: await params.method.run({
			...
			openUrl: async (url) => {
				const { openUrl } = await import("./onboard-helpers-Dhkaze0n.js");
				await openUrl(url);
			},
