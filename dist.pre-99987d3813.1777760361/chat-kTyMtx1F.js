...
import { p as resolveSessionAgentId, x as resolveAgentWorkspaceDir } from "./agent-scope-DfXPuZUf.js";
import { r as setSafeTimeout } from "./timer-delay-CNEd-xoA.js";
import { a as hasGatewayClientCap, i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES, t as GATEWAY_CLIENT_CAPS } from "./client-info-a1QfCw6W.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-C693nazc.js";
import { n as isGatewayCliClient, o as isWebchatClient, u as normalizeMessageChannel } from "./message-channel-DgTkFEBi.js";
import { Br as ErrorCodes, Vr as errorShape, _ as validateChatHistoryParams, h as validateChatAbortParams, t as formatValidationErrors, v as validateChatInjectParams, y as validateChatSendParams } from "./protocol-CPVH8nrf.js";
import { o as normalizeInputProvenance } from "./input-provenance-3ApVptBO.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-CCNu0CLn.js";
import "./method-scopes--jsSkjrL.js";
import { i as resolveSessionFilePath } from "./paths-BCOWYnec.js";
import "./sessions-DTfZDTku.js";
import { l as emitSessionTranscriptUpdate } from "./transcript-y-FZWM2K.js";
import { h as jsonUtf8Bytes, i as readSessionMessages, n as capArrayByJsonBytes, s as stripEnvelopeFromMessage } from "./session-utils.fs-CSUPtGwf.js";
import { i as stripInlineDirectiveTagsForDisplay, n as sanitizeReplyDirectiveId } from "./directive-tags-Ch33OUaF.js";
import { a as loadSessionEntry, c as resolveDeletedAgentIdFromSessionKey, f as resolveGatewaySessionThinkingDefault, h as resolveSessionModelRef, u as resolveGatewayModelSupportsImages } from "./session-utils-MHYarXtm.js";
...
import { i as normalizeReplyPayloadsForDelivery } from "./payloads-BdKEREFs.js";
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-Bhfk5QRY.js";
import { a as safeFileURLToPath, t as assertNoWindowsNetworkPath } from "./local-file-access-qbNcQjuB.js";
import { r as getAgentScopedMediaLocalRoots, t as appendLocalMediaParentRoots } from "./local-roots-Bqo3qlkV.js";
import { i as deleteMediaBuffer, l as saveMediaBuffer, t as MEDIA_MAX_BYTES } from "./store-Bfd4_fWY.js";
import { n as assertLocalMediaAllowed, t as LocalMediaAccessError } from "./local-media-access-DSrd27I1.js";
import { t as resolveAgentTimeoutMs } from "./timeout-CRld88BP.js";
import { a as ensureSandboxWorkspaceForSession } from "./sandbox-DkLicFcl.js";
import { t as rewriteTranscriptEntriesInSessionFile } from "./transcript-rewrite-P9YYKzQh.js";
import { u as isPluginOwnedSessionBindingRecord } from "./conversation-binding-Clz6DgP9.js";
import { i as createReplyDispatcher, t as dispatchInboundMessage } from "./dispatch-xmeBvXJj.js";
...
import { u as logLargePayload } from "./http-common-CUW9xdur.js";
import { n as isSuppressedControlReplyText } from "./control-reply-text-COTXWsQp.js";
import { a as projectRecentChatDisplayMessages, n as isToolHistoryBlockType, o as resolveEffectiveChatHistoryMaxChars, r as projectChatDisplayMessage } from "./chat-display-projection-h-VKt1kF.js";
import { c as getMaxChatHistoryMessagesBytes } from "./server-constants-CerudlGK.js";
import { t as stageSandboxMedia } from "./stage-sandbox-media-VbQLonwC.js";
import { n as isChatStopCommandText, r as registerChatAbortController, t as abortChatRunById } from "./chat-abort-WOPrAxkZ.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, r as UnsupportedAttachmentError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-DpZS5BiY.js";
import { i as createManagedOutgoingImageBlocks, n as attachManagedOutgoingImagesToMessage, r as cleanupManagedOutgoingImageRecords } from "./managed-image-attachments-BuI2BR0B.js";
