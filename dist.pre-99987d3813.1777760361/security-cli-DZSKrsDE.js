...
import { d as createIcaclsResetCommand, f as formatIcaclsResetCommand } from "./audit-fs-DBnSfo2x.js";
import { c as normalizeAgentId } from "./session-key-CWdvMTMr.js";
import { S as resolveDefaultAgentId } from "./agent-scope-DfXPuZUf.js";
import { i as getRuntimeConfig, r as createConfigIO } from "./io-DTtpq82f.js";
...
import { s as getSecurityAuditCommandSecretTargetIds } from "./command-secret-targets-BKgQ9hgh.js";
import { t as formatHelpExamples } from "./help-format-Bjb8XJYm.js";
import { t as runSecurityAudit } from "./audit-Cd7XTtMB.js";
import { t as collectIncludePathsRecursive } from "./includes-scan-DbREofaL.js";
...
async function collectChannelSecurityConfigFixMutation(params) {
	...
	const collectPlugins = async () => {
		...
		try {
			...
			const { listBundledChannelPlugins } = await import("./bundled-CIEStKC1.js");
