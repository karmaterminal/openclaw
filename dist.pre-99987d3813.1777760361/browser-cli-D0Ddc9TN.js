...
import { t as shouldEagerRegisterSubcommands } from "./command-registration-policy-CAl2OIBW.js";
import { t as addGatewayClientOptions } from "./gateway-rpc-O7AJpLTx.js";
import { t as formatHelpExamples } from "./help-format-Bjb8XJYm.js";
import { i as registerCommandGroups } from "./register-command-groups-Coms1NkK.js";
import "./cli-runtime-CaAXrHRD.js";
import "./core-api-BBg2dJL0.js";
...
const browserCommandGroupDefinitions = [
	{
		...
		register: async (args) => {
			(await import("./browser-cli-manage-Bp443JTD.js")).registerBrowserManageCommands(args.browser, args.parentOpts);
		}
	},
	{
		...
		register: async (args) => {
			(await import("./browser-cli-inspect-ClTAgyHX.js")).registerBrowserInspectCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-input-ThFr03mC.js")).registerBrowserActionInputCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-observe-BVU1sYKM.js")).registerBrowserActionObserveCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-debug-BZ4PBTso.js")).registerBrowserDebugCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-state-D_DQLoSf.js")).registerBrowserStateCommands(args.browser, args.parentOpts);
		}
	}
];
