...
import { t as formatLiteralProviderPrefixedModelRef } from "./model-ref-shared-D2HoQpBV.js";
...
import { n as openUrl } from "./browser-open-7Sqv9zY8.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-DP7qKDuF.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-CysqIWGF.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-CioZRi01.js";
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-CYoW19LQ.js") };
...
async function applyAuthChoiceLoadedPluginProvider(params) {
	...
	if (!resolved && installCatalogEntry) {
		const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-BvaPHSSc.js");
