...
import { a as createFixedWindowRateLimiter, r as WEBHOOK_RATE_LIMIT_DEFAULTS } from "./webhook-ingress-mNQs6uhb.js";
import { a as createWebhookInFlightLimiter, c as readWebhookBodyOrReject } from "./webhook-request-guards-DP0wn7J-.js";
import { t as normalizeWebhookPath } from "./webhook-path-LUDpjuwm.js";
import { l as withResolvedWebhookRequestPipeline, n as registerWebhookTargetWithPluginRoute, s as resolveWebhookTargetWithAuthOrRejectSync } from "./webhook-targets-BsJEEwgM.js";
import "./security-runtime-CgsTN2qE.js";
import "./string-coerce-runtime-DaMLhYpk.js";
import { F as resolveBlueBubblesEffectiveAllowPrivateNetwork, _ as normalizeWebhookReaction, g as normalizeWebhookMessage, o as probeBlueBubbles, t as fetchBlueBubblesServerInfo, u as asRecord } from "./probe-DYDEy9l3.js";
import { t as getBlueBubblesRuntime } from "./runtime-QZMqIY6s.js";
import { n as resolveWebhookPathFromConfig } from "./webhook-shared-4j1Lms0r.js";
import { a as resolveBlueBubblesMessageId, b as sendMessageBlueBubbles } from "./reactions-4MbDmgid.js";
import { i as sendBlueBubblesMedia, n as processMessage, r as processReaction, t as logVerbose } from "./monitor-processing-EFJ7mUw6.js";
...
async function monitorBlueBubblesProvider(options) {
	...
	return await new Promise((resolve) => {
		...
		import("./catchup-DasPq18O.js").then(({ runBlueBubblesCatchup }) => runBlueBubblesCatchup(target)).catch((err) => {
