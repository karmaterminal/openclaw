...
import { i as extractFirstTextBlock } from "./chat-message-content-D6D-0R9c.js";
...
var OpenClawChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			import("./client-bootstrap-4xDGoHJT.js"),
			import("./client-DAG3v8Yf.js"),
			import("./client-start-readiness-CEEWP4wQ.js"),
			import("./method-scopes-DhOQytsk.js"),
			import("./client-info-fbelIQdC.js")
		]);
