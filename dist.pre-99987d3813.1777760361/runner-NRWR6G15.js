...
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-CmJUh_Pm.js";
import { c as kindFromMime, i as getFileExtension, n as detectMime, o as isAudioFileName } from "./mime-B44wpfKR.js";
import { r as fetchWithTimeout } from "./fetch-timeout-XtCPwdrO.js";
...
import { n as MediaFetchError, r as fetchRemoteMedia } from "./fetch-CA2opuGY.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-D64cZNOQ.js";
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-BJtyb8qw.js";
import { t as providerSupportsCapability } from "./provider-supports-BsKMxCLa.js";
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve-DXQZlXcC.js";
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-fox1OzVB.js";
import { t as buildRandomTempFilePath } from "./temp-download-DHC8k5YN.js";
import "./temp-path-DORItDY6.js";
import { _ as fileExists, a as runCliEntry, g as extractGeminiResponse, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, v as MediaUnderstandingSkipError, y as isMediaUnderstandingSkipError } from "./runner.entries-BqVfDg-A.js";
import "./shared-CXXMI7E7.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-Bqpj1oVz.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-CngqrLDF.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-CvjKZ5jF.js");
