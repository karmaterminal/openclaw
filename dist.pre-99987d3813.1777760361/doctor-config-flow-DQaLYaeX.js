...
import { $ as normalizeBaseCompatibilityConfigValues, T as validateConfigObjectWithPlugins, et as normalizeLegacyCommandsConfig, k as migrateLegacySecretRefEnvMarkers, lt as applyLegacyDoctorMigrations, tt as normalizeLegacyOpenAICodexModelsAddMetadata, ut as applyChannelDoctorCompatibilityMigrations, z as findLegacyConfigIssues } from "./io-DTtpq82f.js";
import { n as formatConfigIssueLines } from "./issue-format-CIrBljpw.js";
import { s as runPluginSetupConfigMigrations } from "./setup-registry-cJMtIQjp.js";
import { i as listRouteBindings } from "./bindings-CJZklmri.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-Ck9_thc4.js";
import { t as note } from "./note-Deih_6FT.js";
import { a as stripUnknownConfigKeys, r as noteOpencodeProviderOverrides } from "./doctor-config-analysis-D-eMDFhc.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-BzLkyiaq.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-DMy4eMKc.js";
import { t as asObjectRecord } from "./object-oJC83c9I.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = await (async () => {
		...
		const { collectRelevantDoctorPluginIds, listPluginDoctorLegacyConfigRules } = await import("./doctor-contract-registry-Dv5XaTGN.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-c1lrgLSe.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-Df-awUgY.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-lla8Wgu6.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-BAstIbbW.js");
		emitDoctorNotes({
			note,
