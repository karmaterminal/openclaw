...
import { a as freezeDiagnosticTraceContext } from "./diagnostic-trace-context-Cn2rNQJ4.js";
import { i as isCronSessionKey } from "./session-key-utils-B26T5hOk.js";
import { m as resolveSessionAgentIds, r as resolveAgentExecutionContract, t as hasConfiguredModelFallbacks, x as resolveAgentWorkspaceDir } from "./agent-scope-DfXPuZUf.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER, t as DEFAULT_CONTEXT_TOKENS } from "./defaults-CyUAeHC6.js";
import { r as resolveProviderIdForAuth } from "./provider-auth-aliases-D6TSWm6g.js";
import { n as resolveSafeTimeoutDelayMs } from "./timer-delay-CNEd-xoA.js";
import { i as isMarkdownCapableMessageChannel } from "./message-channel-DgTkFEBi.js";
...
import { s as emitAgentPlanEvent } from "./agent-events-DE3So3Se.js";
import { n as extractAssistantTextForPhase } from "./chat-message-content-D6D-0R9c.js";
import { X as resolveProviderAuthProfileId, x as prepareProviderRuntimeAuth } from "./provider-runtime-CbKqm0yg.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-CkJkZaS2.js";
import { n as sleepWithAbort } from "./backoff-DPLQWtIE.js";
import "./auth-profiles-DJ905QVz.js";
import { a as isProfileInCooldown } from "./usage-state-O7hGnjGD.js";
import { n as resolveAuthProfileOrder, t as resolveAuthProfileEligibility } from "./order-ehN5Yd_1.js";
import { t as markAuthProfileGood } from "./profiles-xFFkxGDS.js";
import { f as sanitizeRuntimeProviderRequestOverrides, s as resolveProviderRequestConfig } from "./provider-request-config-_2a0fYY5.js";
import { t as redactIdentifier } from "./redact-identifier-uXFH6Agt.js";
import { t as sanitizeForConsole } from "./console-sanitize-aXe_dhYm.js";
import { a as markAuthProfileUsed, i as markAuthProfileFailure, s as resolveProfilesUnavailableReason } from "./usage-CD9yZJ44.js";
import { f as shouldPreferExplicitConfigApiKeyAuth, n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel, t as applyAuthHeaderOverride } from "./model-auth-B0VX5Kxx.js";
import "./runs-DkQmuNSQ.js";
import { n as ensureOpenClawModelsJson } from "./models-config-B12DlGPT.js";
import { n as derivePromptTokens, o as normalizeUsage } from "./usage-CbNR5ctp.js";
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-DJ6vzAk_.js";
import { l as isRawApiErrorPayload, n as formatBillingErrorMessage, o as getApiErrorPayloadFingerprint, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-BkLQoEce.js";
import { c as isTimeoutErrorMessage } from "./failover-matches-MFHDJDza.js";
import { t as ensureContextEnginesInitialized } from "./init-CmKFRfXB.js";
import { s as runPostCompactionSideEffects, t as readPiModelContextTokens } from "./model-context-tokens-B6o6QLlw.js";
import { i as enqueueCommandInLane } from "./command-queue-DaWipAKS.js";
import { a as resolveContextWindowInfo, i as formatContextWindowWarningMessage, n as evaluateContextWindowGuard, r as formatContextWindowBlockMessage } from "./context-window-guard-CcgNxg6q.js";
import { n as SILENT_REPLY_TOKEN, r as isSilentReplyPayloadText } from "./tokens-fh59FP1B.js";
import { g as isStrictAgenticExecutionContractActive } from "./openclaw-tools-DCJR53sU.js";
import { C as shouldTreatEmptyAssistantReplyAsSilent, S as resolveSilentToolResultReplyPayload, T as observeReplayMetadata, _ as resolvePlanningOnlyRetryInstruction, a as createEmbeddedRunStageTracker, b as resolveReplayInvalidFlag, d as extractPlanningOnlyPlanDetails, g as resolveIncompleteTurnPayloadText, h as resolveEmptyResponseRetryInstruction, i as selectAgentHarness, m as resolveAttemptReplayMetadata, o as formatEmbeddedRunStageSummary, p as resolveAckExecutionFastPathInstruction, r as runAgentHarnessAttemptWithFallback, s as shouldWarnEmbeddedRunStageSummary, u as STRICT_AGENTIC_BLOCKED_TEXT, v as resolvePlanningOnlyRetryLimit, w as createEmbeddedRunReplayState, x as resolveRunLivenessState, y as resolveReasoningOnlyRetryInstruction } from "./selection-CJrCnQoW.js";
import "./compaction-successor-transcript-BCy1H5AJ.js";
import { a as formatAssistantErrorText, b as parseImageSizeError, c as isBillingAssistantError, f as isFailoverAssistantError, h as isRateLimitAssistantError, i as extractObservedOverflowTokenCount, m as isLikelyContextOverflowError, p as isFailoverErrorMessage, s as isAuthAssistantError, t as classifyFailoverReason, u as isCompactionFailureError, y as parseImageDimensionError } from "./errors-CTr-JKNG.js";
import { o as normalizeTextForComparison, r as pickFallbackThinkingLevel } from "./pi-embedded-helpers-BCdH26FE.js";
import { n as coerceToFailoverError, r as describeFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-CQwRMDjb.js";
import { t as log } from "./logger-3KEv9Tay.js";
import { c as retireSessionMcpRuntime, l as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-BuGXdJuK.js";
import "./pi-bundle-mcp-tools-ClCYHpoW.js";
import { u as parseReplyDirectives } from "./payloads-BdKEREFs.js";
import { s as hasOutboundReplyContent } from "./reply-payload-Bhfk5QRY.js";
import { C as formatToolAggregate, d as runAgentCleanupStep } from "./attempt.tool-run-context-Ca8gOFQe.js";
import { a as shouldAllowCooldownProbeForReason, i as LiveSessionModelSwitchError, o as buildApiErrorObservationFields } from "./model-fallback-DgsGm-S-.js";
import { n as isLikelyMutatingToolName } from "./tool-mutation-ClFthIAn.js";
import { i as extractAssistantVisibleText, r as extractAssistantThinking, s as formatReasoningMessage } from "./pi-embedded-utils-Cxk4dKhC.js";
import { a as generateSecureToken } from "./secure-random-CMBv2wnp.js";
import { a as truncateOversizedToolResultsInSession, i as sessionLikelyHasOversizedToolResults, r as resolveLiveToolResultMaxChars } from "./tool-result-truncation-DvH7IKwl.js";
...
import "./extra-params-B7D5HkvY.js";
import { t as runContextEngineMaintenance } from "./context-engine-maintenance-D_zcDKZX.js";
import { t as buildEmbeddedCompactionRuntimeContext } from "./compaction-runtime-context-DBx7M5Yi.js";
import { r as forgetPromptBuildDrainCacheForRun } from "./attempt.prompt-helpers-B675jkr7.js";
...
import "./compact.queued-BaA7nHZh.js";
import { a as resolveSessionKeyForRequest, n as shouldSwitchToLiveModel, o as resolveStoredSessionKeyForSessionId, t as clearLiveModelSwitchPending } from "./live-model-switch-CgWfwnyl.js";
import { i as buildAgentRuntimeAuthPlan, r as buildAgentRuntimePlan } from "./build-D2H5nn6c.js";
import { n as resolveRunWorkspaceDir, t as redactRunIdentifier } from "./workspace-run-CyywMqte.js";
				...
				while (true) {
					...
					if (timedOut && !timedOutDuringCompaction) {
						...
						if (timeoutCompactionAttempts >= MAX_TIMEOUT_COMPACTION_ATTEMPTS) log.warn(`[timeout-compaction] already attempted timeout compaction ${timeoutCompactionAttempts} time(s); falling through to timeout handling`);
							...
							const timeoutSessionKey = requireSessionKeyOrSkip(params, log, "pi-runner.timeout-compaction");
					...
					if (contextOverflowError) {
						...
						if (!isCompactionFailure && !hadAttemptLevelCompaction && overflowCompactionAttempts < MAX_OVERFLOW_COMPACTION_ATTEMPTS) {
							...
							const overflowSessionKey = requireSessionKeyOrSkip(params, log, "pi-runner.overflow-compaction");
