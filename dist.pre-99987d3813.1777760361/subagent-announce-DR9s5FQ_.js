...
function loadSubagentRegistryRuntime() {
	subagentRegistryRuntimePromise ??= import("./subagent-announce.registry.runtime-rrS0GzV1.js");
	return subagentRegistryRuntimePromise;
}
function loadContinuationStateRuntime() {
	continuationStateRuntimePromise ??= import("./state-BeC4Ink1.js");
	return continuationStateRuntimePromise;
}
function loadSubagentSpawnRuntime() {
	subagentSpawnRuntimePromise ??= import("./subagent-spawn-CydrBUyz.js");
...
async function runSubagentAnnounceFlow(params) {
	...
	try {
		...
		if (params.silentAnnounce) {
			const { enqueueSystemEvent } = await import("./system-events-Cvtva0Ay.js");
			const { createSubsystemLogger } = await import("./subsystem-D7--Gji4.js");
			...
			if (params.wakeOnReturn) {
				const { requestHeartbeatNow } = await import("./heartbeat-wake-CyzDpGXN.js");
				requestHeartbeatNow({
