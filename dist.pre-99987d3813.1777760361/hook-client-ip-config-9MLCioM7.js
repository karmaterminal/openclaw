...
import { n as isVitestRuntimeEnv } from "./env-CqfGXlE5.js";
import { n as defaultRuntime } from "./runtime-CChwgwyg.js";
import { i as getChildLogger } from "./logger-BnvCi6Wb.js";
import { t as createSubsystemLogger } from "./subsystem-W9_E260X.js";
import { r as isCronRunSessionKey } from "./session-key-utils-B26T5hOk.js";
...
import { n as resolveSubagentMaxConcurrent, t as resolveAgentMaxConcurrent } from "./agent-limits-BQN3k8u8.js";
...
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, t as canonicalizeMainSessionAlias } from "./main-session-DImA1KnV.js";
import { u as resolveStorePath } from "./paths-BCOWYnec.js";
import { t as loadSessionStore } from "./store-load-CDajuL7y.js";
import { c as updateSessionStore, t as archiveRemovedSessionTranscripts } from "./store-APN60wqF.js";
import "./sessions-DTfZDTku.js";
import "./logging-C3XXPTXw.js";
import { t as abortAndDrainEmbeddedPiRun } from "./runs-DkQmuNSQ.js";
import { i as isGatewayModelPricingEnabled } from "./model-pricing-cache-DpGAuf_R.js";
import "./session-utils.fs-CSUPtGwf.js";
import { i as cleanupArchivedSessionTranscripts } from "./session-transcript-files.fs-DrXz3D5-.js";
import { i as enqueueCommandInLane, p as setCommandLaneConcurrency } from "./command-queue-DaWipAKS.js";
import { r as normalizeCronJobInput } from "./openclaw-tools-DCJR53sU.js";
import { o as resolveFailoverReasonFromError } from "./failover-error-CQwRMDjb.js";
import { t as SsrFBlockedError } from "./ssrf-nwJHqKWi.js";
import { n as fetchWithSsrFGuard } from "./fetch-guard-I2SYZHil.js";
import { a as resolveCronNotificationSessionKey, i as resolveCronDeliverySessionKey, o as resolveCronSessionTargetSessionKey, r as isInvalidCronSessionTargetIdError, t as normalizeHttpWebhookUrl } from "./webhook-url-D0Bt3D1b.js";
...
import { a as isRetryableHeartbeatBusySkipReason, o as requestHeartbeatNow } from "./heartbeat-wake-20VUckmO.js";
import { i as enqueueSystemEvent } from "./system-events-Zf4xMpvh.js";
import { i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-i2h5BcKG.js";
import "./pi-embedded-BRAWqaVM.js";
import { a as cronSchedulingInputsEqual, i as saveCronStore, r as resolveCronStorePath, t as loadCronStore } from "./store-BZ2CNV4g.js";
import { n as resolveAgentOutboundIdentity } from "./identity-CKazg4pE.js";
import { t as createOutboundSendDeps } from "./outbound-send-deps-Bt-EuVuv.js";
import { t as cleanupBrowserSessionsForLifecycleEnd } from "./browser-lifecycle-cleanup-CcZ8fOSR.js";
import { i as markCronJobActive, t as clearCronJobActive } from "./active-jobs-bDLThwlf.js";
import { a as resolveCronRunLogPath, o as resolveCronRunLogPruneOptions, t as appendCronRunLog } from "./run-log-DMk1lvuQ.js";
import { n as resolveFailureDestination, t as resolveCronDeliveryPlan } from "./delivery-plan-BpdyvBWw.js";
import { t as runCronIsolatedAgentTurn } from "./isolated-agent-DJVNTKZD.js";
import { _ as resolveDeliveryTarget, a as computeJobPreviousRunAtMs, c as findJobOrThrow, d as isJobEnabled, f as nextWakeAtMs, g as resolveJobPayloadTextForMain, h as recordScheduleComputeError, i as computeJobNextRunAtMs, l as hasScheduledNextRunAtMs, m as recomputeNextRunsForMaintenance, n as applyJobPatch, o as createJob, p as recomputeNextRuns, r as assertSupportedJobSpec, s as errorBackoffMs, t as DEFAULT_ERROR_BACKOFF_SCHEDULE_MS, u as isJobDue } from "./jobs-BZq5ddG9.js";
import { t as createCronExecutionId } from "./run-id-0iZisi5e.js";
import { n as resolveGatewayReloadSettings } from "./config-reload-8XXi1QKT.js";
import { n as runHeartbeatOnce, r as startHeartbeatRunner } from "./heartbeat-runner-z3DZu1bT.js";
...
function recoverPendingOutboundDeliveries(params) {
	(async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-Dpu6nDDP.js");
		const { deliverOutboundPayloads } = await import("./deliver-CeUFyWg7.js");
...
function recoverPendingSessionDeliveries(params) {
	setTimeout(() => {
		(async () => {
			const { recoverPendingRestartContinuationDeliveries } = await import("./server-restart-sentinel-wWyPB9uB.js");
...
function startGatewayModelPricingRefreshOnDemand(params) {
	...
	let stopRefresh;
	(async () => {
		const { startGatewayModelPricingRefresh } = await import("./model-pricing-cache-CA4fP9EW.js");
		if (stopped) return;
