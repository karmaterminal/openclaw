import{t as e,A as i,f as a,Q as r}from"./index-Zcru02Hy.js";function b(t){const l=(t.status&&typeof t.status=="object"?t.status.securityAudit:null)?.summary??null,d=l?.critical??0,c=l?.warn??0,n=l?.info??0,u=d>0?"danger":c>0?"warn":"success",o=d>0?e("debug.security.critical",{count:String(d)}):c>0?e("debug.security.warnings",{count:String(c)}):e("debug.security.noCriticalIssues");return a`
    <section class="grid">
      <div class="card">
...
//# sourceMappingURL=debug-usKODLml.js.map
