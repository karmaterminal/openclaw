...
import { i as failFlow, o as finishFlow, r as deleteTaskFlowRecordById, t as createManagedTaskFlow, u as listTaskFlowsForOwnerKey } from "./task-flow-runtime-internal-CrXbHxCe.js";
import { z } from "zod";
...
const PendingDelegateStateSchema = z.object({
	...
	if ([
		...
		hasSilentWake,
		hasPostCompaction
	].filter(Boolean).length <= 1 || hasSilent && hasSilentWake && !hasPostCompaction) return;
	ctx.addIssue({
