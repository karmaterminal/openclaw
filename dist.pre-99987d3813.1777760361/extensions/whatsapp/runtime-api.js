...
import { canonicalizeMainSessionAlias, loadSessionStore, resolveSessionKey, resolveSessionStoreEntry, resolveStorePath, updateSessionStore as updateSessionStore$1 } from "openclaw/plugin-sdk/session-store-runtime";
...
async function runWebHeartbeatOnce(opts) {
	...
	if (sessionId) {
		...
		for (const legacyKey of memResolved.legacyKeys) delete store[legacyKey];
