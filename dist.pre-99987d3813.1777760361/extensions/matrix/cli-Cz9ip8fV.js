...
import { i as resolveMatrixAccount } from "./accounts-fKbzcSER.js";
import { t as formatMatrixErrorMessage } from "./errors-CTcpEDq-.js";
import { n as resolveMatrixConfigPath } from "./config-paths-nsVaysCu.js";
import { n as updateMatrixAccountConfig } from "./config-update-DTNzvIb5.js";
import { n as matrixSetupAdapter } from "./setup-core-DgaDVEuY.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-Cabu_WQC.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-DXhjK3XW.js";
import { n as withResolvedActionClient } from "./client-DMtHaUoo.js";
import { r as resolveMatrixAuthContext } from "./config-BpgBKVSD.js";
import "./client-pB6lGsuQ.js";
import { i as formatZonedTimestamp } from "./runtime-api-kR5zPh41.js";
import { isOpenClawManagedMatrixDevice, summarizeMatrixDeviceHealth } from "./device-health-UVYpbA_W.js";
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-BOB8GnEh.js";
import { a as confirmMatrixVerificationSas, b as verifyMatrixRecoveryKey, c as getMatrixRoomKeyBackupStatus, d as listMatrixVerifications, f as mismatchMatrixVerificationSas, g as runMatrixSelfVerification, h as restoreMatrixRoomKeyBackup, l as getMatrixVerificationSas, m as resetMatrixRoomKeyBackup, n as bootstrapMatrixVerification, p as requestMatrixVerification, r as cancelMatrixVerification, t as acceptMatrixVerification, u as getMatrixVerificationStatus, v as startMatrixVerification } from "./verification-1ZIbhYsJ.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-DMtHaUoo.js").then((n) => n.t);
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-C-c6-UL4.js").then((n) => n.t);
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-Buq0_Uj4.js");
