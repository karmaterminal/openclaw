...
import { t as getMatrixRuntime } from "./runtime-D_X8lxrw.js";
import { n as resolveConfiguredMatrixBotUserIds } from "./accounts-fKbzcSER.js";
...
import { a as canonicalizeAllowlistWithResolvedIds, c as formatAllowlistMatchMeta, d as logInboundDrop, f as logTypingFailure, h as toLocationContext, i as buildAllowlistResolutionSummary, l as formatLocationText, m as summarizeMapping, n as resolveMatrixRoomConfig, o as createReplyPrefixOptions, p as patchAllowlistUsersInConfigEntries, r as addAllowlistUserEntriesFromConfigEntry, s as createTypingCallbacks, t as resolveMatrixStoredSessionMeta, u as getAgentScopedMediaLocalRoots } from "./session-store-metadata-DzUtzfTr.js";
import { i as resolveMatrixStateFilePath } from "./storage-aY8htdj3.js";
import { a as sendMessageMatrix, g as isPollStartType, h as isPollEventType, p as formatPollAsText, t as chunkMatrixText, v as parsePollStartContent } from "./send-I0gFhByV.js";
import { i as promoteMatrixDirectRoomCandidate, s as MATRIX_OPENCLAW_FINALIZED_PREVIEW_KEY } from "./direct-management-C-c6-UL4.js";
...
import { t as createMatrixThreadBindingManager } from "./thread-bindings-BqfiPxnc.js";
import { t as createAsyncLock } from "./async-lock-uQfhfQIY.js";
import { n as LogService } from "./logger-BKblJmj9.js";
import { i as isMatrixMediaSizeLimitError, r as MatrixMediaSizeLimitError } from "./http-client-DegQmU1w.js";
...
import { a as resolveMatrixMessageBody, i as resolveMatrixMessageAttachment, n as formatMatrixMediaUnavailableText, r as formatMatrixMessageText, s as fetchMatrixPollSnapshot, t as formatMatrixMediaTooLargeText } from "./media-text-Bio1mxrQ.js";
import { n as setActiveMatrixClient } from "./active-client-uhlxdhEy.js";
import { t as isBunRuntime } from "./runtime-C6X4h_SJ.js";
import { n as resolveMatrixAuth, r as resolveMatrixAuthContext, t as backfillMatrixAuthDeviceIdAfterStartup } from "./config-BpgBKVSD.js";
import { i as resolveSharedMatrixClient, n as releaseSharedClientInstance } from "./shared-CgyqlAHQ.js";
import "./client-pB6lGsuQ.js";
import { d as resolveDefaultGroupPolicy, h as warnMissingProviderGroupPolicyFallbackOnce, m as resolveThreadBindingMaxAgeMsForChannel, p as resolveThreadBindingIdleTimeoutMsForChannel, t as GROUP_POLICY_BLOCKED_LABEL, u as resolveAllowlistProviderRuntimeGroupPolicy } from "./runtime-api-kR5zPh41.js";
import { t as resolveMatrixTargets } from "./resolve-targets-Cx1igHMZ.js";
import { t as formatMatrixEncryptedEventDisabledWarning } from "./encryption-guidance-BmL7KHQA.js";
...
async function loadMatrixDirectRoomDeps() {
	matrixDirectRoomDepsPromise ??= Promise.all([import("./direct-management-C-c6-UL4.js").then((n) => n.t), import("./direct-room-XkutHjES.js").then((n) => n.t)]).then(([directManagementModule, directRoomModule]) => ({
...
function loadMatrixSendModule() {
	matrixSendModulePromise ??= import("./send-I0gFhByV.js").then((n) => n.l);
...
function loadMatrixReactionEvents() {
	matrixReactionEventsPromise ??= import("./reaction-events-Bj9NstsS.js");
	return matrixReactionEventsPromise;
}
function loadMatrixDraftStream() {
	matrixDraftStreamPromise ??= import("./draft-stream-Do7mdN1D.js");
...
function formatMatrixCommandOutputToolProgress(payload) {
	if (!payload.name) return payload.title;
	if (payload.exitCode === 0) return `${payload.name} ok`;
	if (payload.exitCode != null) return `${payload.name} (exit ${payload.exitCode})`;
	return payload.name;
}
	...
	return async (roomId, event) => {
		...
		try {
			...
			const pushPreviewToolProgress = (line) => {
				if (!draftStream || !shouldStreamPreviewToolProgress || previewToolProgressSuppressed) return;
				...
				draftStream.update(["Working...", ...previewToolProgressLines.map((entry) => `- ${formatMatrixToolProgressMarkdownCode(entry)}`)].join("\n"));
			};
			...
			const buildPreviewToolProgressReplyOptions = () => {
				if (!shouldStreamPreviewToolProgress) return {};
				return {
...
async function loadMatrixStartupMaintenanceDeps() {
	matrixStartupMaintenanceDepsPromise ??= Promise.all([
		import("./config-update-DTNzvIb5.js").then((n) => n.t),
		import("./device-health-UVYpbA_W.js"),
		import("./profile-BlHu0wDX.js").then((n) => n.n),
		import("./legacy-crypto-restore-DiSTaiRw.js"),
		import("./startup-verification-Cxa7PVp6.js")
...
function resolveMatrixStreamingMode(streaming) {
	...
	if (isMatrixStreamingConfig(streaming)) {
		if (streaming.mode === "partial" || streaming.mode === "quiet") return streaming.mode;
	}
	return "off";
}
