...
import { $ as editChannelMessage, J as createChannelMessage, Z as deleteChannelMessage, t as discord_exports } from "./discord-dGuI-41N.js";
import { M as createDiscordRestClient, N as createDiscordRuntimeAccountContext } from "./send.shared-CtymBXYp.js";
import { i as resolveTimestampMs } from "./format-D8TsaXxW.js";
import { i as normalizeDiscordSlug } from "./allow-list-DJQxodPK.js";
import { a as removeReactionDiscord, d as editMessageDiscord, r as reactMessageDiscord } from "./send-B5ph6ATv.js";
import { t as resolveDiscordConversationIdentity } from "./conversation-identity-BQIVhUQT.js";
import { t as DISCORD_TEXT_CHUNK_LIMIT } from "./outbound-adapter-B91KygPa.js";
import { t as resolveDiscordPreviewStreamMode } from "./preview-streaming-C0O92Qqz.js";
import { n as DISCORD_ATTACHMENT_TOTAL_TIMEOUT_MS, t as DISCORD_ATTACHMENT_IDLE_TIMEOUT_MS } from "./timeouts-WMG3-NWo.js";
import { a as resolveForwardedMediaList, i as buildDiscordMediaPayload, o as resolveMediaList, r as resolveDiscordMessageText } from "./message-utils-DTDS2LpC.js";
import { a as resolveDiscordThreadStarter, n as resolveDiscordAutoThreadReplyPlan } from "./threading-DLucgrqB.js";
import { n as buildDiscordInboundAccessContext, r as createDiscordSupplementalContextAccessChecker } from "./inbound-context-DK8HTAwL.js";
import { i as resolveReplyContext, n as buildDirectLabel, r as buildGuildLabel, t as deliverDiscordReply } from "./reply-delivery-eLTquvRi.js";
import { sendTyping } from "./typing-B3zrWw57.js";
...
async function buildDiscordMessageProcessContext(params) {
	...
	const { cfg, discordConfig, accountId, runtime, guildHistories, historyLimit, replyToMode, message, author, sender, data, client, channelInfo, channelName, messageChannelId, isGuildMessage, isDirectMessage, baseText, preflightAudioTranscript, threadChannel, threadParentId, threadParentName, threadParentType, threadName, displayChannelSlug, guildInfo, guildSlug, memberRoleIds, channelConfig, baseSessionKey, boundSessionKey, route, commandAuthorized } = ctx;
...
async function processDiscordMessage(ctx, observer) {
	...
	const shouldSendAckReaction = !sourceRepliesAreToolOnly && shouldAckReaction$1();
