...
import { $ as editChannelMessage, Ct as listGuildScheduledEvents, Dt as removeGuildMemberRole, Et as removeGuildMember, G as createOwnMessageReaction, J as createChannelMessage, K as deleteOwnMessageReaction, Ot as timeoutGuildMember, Q as editChannel, St as listGuildRoles, Tt as putChannelPermission, X as deleteChannel, Y as createThread, Z as deleteChannelMessage, _t as getGuildMember, at as pinChannelMessage, bt as listGuildChannels, ct as unpinChannelMessage, dt as createGuildChannel, et as getChannel, ft as createGuildEmoji, ht as deleteChannelPermission, it as listChannelPins, lt as addGuildMemberRole, mt as createGuildSticker, nt as listChannelArchivedThreads, ot as searchGuildMessages, p as RateLimitError, pt as createGuildScheduledEvent, q as listMessageReactionUsers, rt as listChannelMessages, st as sendChannelTyping, tt as getChannelMessage, ut as createGuildBan, vt as getGuildVoiceState, wt as moveGuildChannels, xt as listGuildEmojis, yt as listGuildActiveThreads } from "./discord-dGuI-41N.js";
import { C as DiscordSendError, D as hasAnyGuildPermissionDiscord, E as hasAllGuildPermissionsDiscord, F as resolveDiscordRest, O as parseAndResolveRecipient, P as resolveDiscordClientAccountContext, S as DISCORD_MAX_STICKER_BYTES, T as fetchMemberGuildPermissionsDiscord, b as DISCORD_MAX_EMOJI_BYTES, i as formatReactionEmoji, j as createDiscordClient, l as resolveChannelId, o as normalizeEmojiName, r as buildReactionIdentifier, s as normalizeReactionEmoji, t as buildDiscordSendError, w as fetchChannelPermissionsDiscord, x as DISCORD_MAX_EVENT_COVER_BYTES } from "./send.shared-CtymBXYp.js";
import { n as rewriteDiscordKnownMentions } from "./mentions-BUtYuxA_.js";
import { n as sendPollDiscord, r as sendStickerDiscord, t as sendMessageDiscord } from "./send.outbound-BHPs-imo.js";
...
async function createThreadDiscord(channelId, payload, opts) {
	...
	if (!isForumLike && payload.content?.trim() && "id" in thread) await createChannelMessage(rest, thread.id, { body: { content: payload.content } });
	return thread;
}
