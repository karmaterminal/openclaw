...
function readRetryAfter(body, response) {
	const bodyValue = body && typeof body === "object" && "retry_after" in body ? body.retry_after : void 0;
	const headerValue = response.headers.get("Retry-After");
	const seconds = typeof bodyValue === "number" ? bodyValue : typeof bodyValue === "string" ? Number(bodyValue) : headerValue ? Number(headerValue) : 0;
...
var RestScheduler = class {
	...
	updateRateLimitState(routeKey, path, response, parsed) {
		...
		const retryAfterMs = Math.max(0, readRetryAfter(parsed, response) * 1e3);
...
//#endregion
export { editChannelMessage as $, MediaGallery as A, BaseMessageInteractiveComponent as B, RadioGroup as C, listGuildScheduledEvents as Ct, Container as D, removeGuildMemberRole as Dt, ChannelSelectMenu as E, removeGuildMember as Et, Separator as F, createOwnMessageReaction as G, createChannelWebhook as H, StringSelectMenu as I, createChannelMessage as J, deleteOwnMessageReaction as K, TextDisplay as L, RoleSelectMenu as M, Row as N, File as O, timeoutGuildMember as Ot, Section as P, editChannel as Q, Thumbnail as R, Modal as S, listGuildRoles as St, Button as T, putChannelPermission as Tt, createUserDmChannel as U, parseCustomId as V, getCurrentUser as W, deleteChannel as X, createThread as Y, deleteChannelMessage as Z, Message as _, getGuildMember as _t, MessageReactionRemoveListener as a, pinChannelMessage as at, CheckboxGroup as b, listGuildChannels as bt, ThreadUpdateListener as c, unpinChannelMessage as ct, Plugin as d, createGuildChannel as dt, getChannel as et, RequestClient as f, createGuildEmoji as ft, Guild as g, getGuild as gt, CommandWithSubcommands as h, deleteChannelPermission as ht, MessageReactionAddListener as i, listChannelPins as it, MentionableSelectMenu as j, LinkButton as k, overwriteApplicationCommands as kt, Embed as l, addGuildMemberRole as lt, Command as m, createGuildSticker as mt, InteractionCreateListener as n, listChannelArchivedThreads as nt, PresenceUpdateListener as o, searchGuildMessages as ot, RateLimitError as p, createGuildScheduledEvent as pt, listMessageReactionUsers as q, MessageCreateListener as r, listChannelMessages as rt, ReadyListener as s, sendChannelTyping as st, discord_exports as t, getChannelMessage as tt, Client as u, createGuildBan as ut, User as v, getGuildVoiceState as vt, TextInput as w, moveGuildChannels as wt, Label as x, listGuildEmojis as xt, serializePayload as y, listGuildActiveThreads as yt, UserSelectMenu as z };
