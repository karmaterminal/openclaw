...
import { _ as Message, t as discord_exports, tt as getChannelMessage } from "./discord-dGuI-41N.js";
...
import { l as isRecentlyUnboundThreadWebhookMessage } from "./thread-bindings.state-BmmtDgzF.js";
import "./thread-bindings-DuJFP2Pn.js";
import { c as resolveDiscordChannelInfo, d as resolveDiscordChannelInfoSafe, f as resolveDiscordChannelNameSafe, l as resolveDiscordMessageChannelId, r as resolveDiscordMessageText } from "./message-utils-DTDS2LpC.js";
import { a as shouldIgnoreStaleDiscordRouteBinding, i as resolveDiscordEffectiveRoute, o as handleDiscordDmCommandDecision, r as resolveDiscordConversationRoute, s as resolveDiscordDmCommandAccess, t as buildDiscordRoutePeer } from "./route-resolution-BNtrhX88.js";
import { n as resolveDiscordWebhookId, t as resolveDiscordSenderIdentity } from "./sender-identity-VIW3S0ks.js";
...
async function loadDiscordSendRuntime() {
	discordSendRuntimePromise ??= import("./send-B5ph6ATv.js").then((n) => n.t);
...
async function loadPluralKitRuntime() {
	pluralkitRuntimePromise ??= import("./pluralkit-BD5SBsdp.js").then((n) => n.n);
...
async function loadSystemEventsRuntime() {
	systemEventsRuntimePromise ??= import("./system-events-RF-491Jy.js");
	return await systemEventsRuntimePromise;
}
async function loadDiscordThreadingRuntime() {
	discordThreadingRuntimePromise ??= import("./threading-DLucgrqB.js").then((n) => n.t);
...
async function preflightDiscordMessage(params) {
	...
	if (isPreflightAborted(params.abortSignal)) return null;
	const isDirectMessage = channelInfo?.type === discord_exports.ChannelType.DM;
	const isGroupDm = channelInfo?.type === discord_exports.ChannelType.GroupDM;
