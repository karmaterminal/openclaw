...
import { C as modelKey } from "./model-selection-shared-C_hgcjGe.js";
import { i as shouldSuppressBuiltInModelFromManifest, r as shouldSuppressBuiltInModel } from "./model-suppression-DntDBELM.js";
import { f as isLocalBaseUrl } from "./shared-DjY3liej.js";
import { t as toModelRow } from "./list.model-row-B_FxhJKe.js";
...
function loadModelCatalogModule() {
	modelCatalogModulePromise ??= import("./model-catalog-Bqpj1oVz.js");
	return modelCatalogModulePromise;
}
function loadModelResolverModule() {
	modelResolverModulePromise ??= import("./model-CIr7ACG4.js");
	return modelResolverModulePromise;
}
function loadProviderCatalogModule() {
	providerCatalogModulePromise ??= import("./list.provider-catalog-ChHWMq6g.js");
