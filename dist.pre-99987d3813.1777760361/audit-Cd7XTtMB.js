...
import { i as inspectPathPermissions, n as formatPermissionDetail, r as formatPermissionRemediation } from "./audit-fs-DBnSfo2x.js";
import { n as resolveGatewayAuth } from "./auth-resolve-Q2OUKdaD.js";
import { t as DEFAULT_AGENT_ID } from "./session-key-CWdvMTMr.js";
...
import { i as normalizeTrustedSafeBinDirs, o as listRiskyConfiguredSafeBins } from "./exec-safe-bin-trust-sTbeoY_r.js";
import { i as resolveSandboxConfigForAgent } from "./config-DU7A4GQi.js";
import { u as isInterpreterLikeAllowlistPattern } from "./exec-approvals-allowlist-D8Xsp_RU.js";
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-DkHqIwi5.js";
import { u as loadExecApprovals } from "./exec-approvals-CSDE03Ac.js";
import { n as collectCoreInsecureOrDangerousFlags, t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-BKMn-_OA.js";
import { t as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-BGNQZwL6.js";
import path from "node:path";
import { isIP } from "node:net";
//#region src/security/audit-deep-code-safety.ts
let auditDeepModulePromise;
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-pkvMksn3.js");
