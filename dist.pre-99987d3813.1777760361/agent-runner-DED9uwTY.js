...
import { a as freezeDiagnosticTraceContext, t as createChildDiagnosticTraceContext } from "./diagnostic-trace-context-Cn2rNQJ4.js";
import { i as isDiagnosticsEnabled, r as emitTrustedDiagnosticEvent } from "./diagnostic-events-BOjU629z.js";
...
import { t as hasConfiguredModelFallbacks, v as resolveAgentConfig, x as resolveAgentWorkspaceDir } from "./agent-scope-DfXPuZUf.js";
import { at as isCliRuntimeAlias, ct as resolveCliRuntimeExecutionProvider, i as getRuntimeConfig } from "./io-DTtpq82f.js";
import "./defaults-CyUAeHC6.js";
import { n as parseNonNegativeByteSize } from "./zod-schema-DSWYIS3F.js";
import "./config-DbmohW6s.js";
import { f as resolveMessageChannel, i as isMarkdownCapableMessageChannel, r as isInternalMessageChannel } from "./message-channel-DgTkFEBi.js";
import { v as resolveMemoryFlushPlan } from "./memory-state-CvGBZ376.js";
import { i as emitAgentEvent, u as registerAgentRunContext } from "./agent-events-DE3So3Se.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath } from "./paths-BCOWYnec.js";
import { t as loadSessionStore } from "./store-load-CDajuL7y.js";
import { c as resolveSessionPluginTraceLines, o as resolveFreshSessionTotalTokens, s as resolveSessionPluginStatusLines } from "./types-BPr0tDWQ2.js";
import { c as updateSessionStore, f as resolveSessionStoreEntry, l as updateSessionStoreEntry, y as resolveGroupSessionKey } from "./store-APN60wqF.js";
import "./sessions-DTfZDTku.js";
import { a as resolveContextTokensForModel } from "./context-DxEScNmr.js";
import { h as resolveResponseUsageMode, m as normalizeVerboseLevel } from "./thinking-DSGLhopZ.js";
import { _ as resolveModelRefFromString } from "./model-selection-shared-C_hgcjGe.js";
import { t as isCliProvider } from "./model-selection-cli-CLNcc0l1.js";
import "./model-selection-DJFAuwNY.js";
import { u as resolveModelAuthMode } from "./model-auth-B0VX5Kxx.js";
import { _ as ReplyRunAlreadyActiveError, l as queueEmbeddedPiMessage, v as createReplyOperation, y as replyRunRegistry } from "./runs-DkQmuNSQ.js";
import { n as spawnSubagentDirect } from "./subagent-spawn-CyU0lQl-.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-BPKeRNYU.js";
import { i as hasNonzeroUsage, n as derivePromptTokens, o as normalizeUsage, r as deriveSessionTotalTokens, t as deriveContextPromptTokens } from "./usage-CbNR5ctp.js";
import { i as readSessionMessages } from "./session-utils.fs-CSUPtGwf.js";
import { a as resolveSessionTranscriptCandidates } from "./session-transcript-files.fs-DrXz3D5-.js";
...
import { d as sanitizeUserFacingText, i as formatRateLimitOrOverloadedErrorCopy, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-BkLQoEce.js";
import { i as isOverloadedErrorMessage, o as isRateLimitErrorMessage, r as isBillingErrorMessage } from "./failover-matches-MFHDJDza.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-DaWipAKS.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-fh59FP1B.js";
import { c as stripHeartbeatToken } from "./heartbeat-O5E1JtiY.js";
import { n as resolveHeartbeatIntervalMs } from "./heartbeat-summary-Dbe01-bB.js";
import { o as isAudioFileName } from "./mime-B44wpfKR.js";
import { f as isLikelyExecutionAckPrompt } from "./selection-CJrCnQoW.js";
import { o as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-Dw_ujOAF.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-D8uuJ9I7.js";
import { _ as isTransientHttpError, d as isContextOverflowError, m as isLikelyContextOverflowError, u as isCompactionFailureError } from "./errors-CTr-JKNG.js";
import "./pi-embedded-helpers-BCdH26FE.js";
import { n as setReplyPayloadMetadata, t as getReplyPayloadMetadata } from "./reply-payload-DuTGAZBT.js";
...
import { i as LiveSessionModelSwitchError, r as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-DgsGm-S-.js";
import { o as generateSecureUuid, t as generateChainId } from "./secure-random-CMBv2wnp.js";
import { n as resolveContinuationRuntimeConfig } from "./config-DwvQ7TEM.js";
import { d as pendingDelegateCount, i as consumePendingDelegates, l as highestDelayedContinuationReservationHop, m as takeDelayedContinuationReservation, n as cancelPendingDelegates, p as stagedPostCompactionDelegateCount, r as clearDelayedContinuationReservations, t as addDelayedContinuationReservation } from "./delegate-store-CVlYcoo1.js";
import { i as isRenderablePayload, n as applyReplyThreading, t as applyReplyTagsToPayload } from "./reply-payloads-DL0B_sx2.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-DLiKQDR7.js";
import { n as filterMessagingToolMediaDuplicates, r as shouldSuppressMessagingToolReplies, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-BKJ05okA.js";
import { o as requestHeartbeatNow } from "./heartbeat-wake-20VUckmO.js";
import { i as enqueueSystemEvent } from "./system-events-Zf4xMpvh.js";
import { n as hasCotFramePrefix } from "./normalize-reply-CTJuTB7e.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-Dq73jIL9.js";
import { a as enqueueFollowupRun, c as scheduleFollowupDrain, l as refreshQueuedFollowupSession, n as resolvePiSteeringModeForQueueMode } from "./queue-aDmg4o1A.js";
import "./sandbox-DkLicFcl.js";
import { n as readPostCompactionContext } from "./post-compaction-context-Die_RvpA.js";
import { i as estimateMessagesTokens } from "./compaction-CBN4X6qE.js";
import { t as runEmbeddedPiAgent } from "./pi-embedded-BRAWqaVM.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-D2H5nn6c.js";
import { c as upsertInferredCommitments, i as listPendingCommitmentsForScope, l as resolveCommitmentTimezone, u as resolveCommitmentsConfig } from "./store-Br4REnV9.js";
import { i as emitContinuationDisabledSpan, n as emitContinuationDelegateFireSpan, o as emitContinuationWorkFireSpan, r as emitContinuationDelegateSpan, s as emitContinuationWorkSpan, t as emitContinuationCompactionReleasedSpan } from "./continuation-tracer-CmryIAHV.js";
import { n as stagePostCompactionDelegate, t as consumeStagedPostCompactionDelegates } from "./continuation-delegate-store-CbiiDiHR.js";
import { t as checkContextPressure } from "./context-pressure-CQrSAdlp.js";
import { l as retainContinuationTimerRef, o as registerContinuationTimerHandle, t as clearTrackedContinuationTimers, u as unregisterContinuationTimerHandle } from "./state-C7rQNty8.js";
import { t as formatProviderModelRef } from "./model-runtime-CG7m9ExS.js";
import { t as runCliAgent } from "./cli-runner-B4WojyVJ.js";
import { c as setCliSessionId, r as getCliSessionBinding, s as setCliSessionBinding } from "./cli-session-SWdifm5J.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-HOMX1iDx.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-B5i5s_ju.js";
import { a as createBlockReplyContentKey, i as createAudioAsVoiceBuffer, o as createBlockReplyPipeline, r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-BrFkbrpf.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-_uvbKl-b.js";
import { n as incrementCompactionCount } from "./session-updates-jyb7H0zB.js";
import { r as resolveCronStorePath, t as loadCronStore } from "./store-BZ2CNV4g.js";
import { n as dispatchPostCompactionDelegates, r as persistPendingPostCompactionDelegates } from "./post-compaction-delegate-dispatch-DoVYK5fb.js";
...
const log$1 = createSubsystemLogger("commitments");
let runtime = {};
let queue = [];
let timer = null;
let draining = false;
...
function enqueueCommitmentExtraction(input) {
	...
	if (!timer) timer = setTimer(() => {
		...
		drainCommitmentExtractionQueue().catch((err) => {
			log$1.warn("commitment extraction failed", { error: String(err) });
		});
...
async function runEmbeddedPiAgentDefault$1(...args) {
	const { runEmbeddedPiAgent } = await import("./pi-embedded.runtime-B5Ny-Xy2.js");
						...
						const result = await runEmbeddedPiAgentDefault$1({
							...
							requestCompactionOpts: runtimeConfig?.agents?.defaults?.continuation?.enabled === true ? {
								...
								triggerCompaction: async (request) => {
									try {
										const { compactEmbeddedPiSession } = await import("./compact.queued-Erxl9qrf.js");
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded-BIF4FSBo.js");
...
function loadReplyPayloadsDedupeRuntime() {
	replyPayloadsDedupeRuntimePromise ??= import("./reply-payloads-dedupe.runtime-BJzzmruo.js");
		...
		try {
			...
			if (runtimeConfig?.agents?.defaults?.continuation?.enabled === true && sessionKey) {
				const [{ dispatchToolDelegates }, { resolveContinuationRuntimeConfig }, { loadContinuationChainState, persistContinuationChainState }, { updateSessionStore, resolveSessionStoreEntry }] = await Promise.all([
					import("./delegate-dispatch-CDBGHizC.js"),
					import("./config-BY1_tieZ.js"),
					import("./state-BeC4Ink1.js"),
					import("./store-CuvNoswW.js")
				]);
