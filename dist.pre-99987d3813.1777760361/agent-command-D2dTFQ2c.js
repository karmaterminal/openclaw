...
import { c as normalizeAgentId, u as resolveAgentIdFromSessionKey } from "./session-key-CWdvMTMr.js";
import { _ as listAgentIds, b as resolveAgentDir, l as resolveAgentSkillsFilter, p as resolveSessionAgentId, u as resolveEffectiveModelFallbacks, x as resolveAgentWorkspaceDir } from "./agent-scope-DfXPuZUf.js";
import { d as readConfigFileSnapshotForWrite, i as getRuntimeConfig } from "./io-DTtpq82f.js";
...
import { f as resolveMessageChannel } from "./message-channel-DgTkFEBi.js";
import { n as ensureAuthProfileStore } from "./store-D-PUpS_m.js";
import { i as emitAgentEvent, t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-DE3So3Se.js";
import { h as stringifyRouteThreadId } from "./channel-route-B76mVc9n.js";
import { o as normalizeAccountId } from "./delivery-context.shared-DU5_-FxH.js";
...
import { C as modelKey, T as parseModelRef, m as resolveConfiguredModelRef, r as buildConfiguredModelCatalog, w as normalizeModelRef } from "./model-selection-shared-C_hgcjGe.js";
...
import { n as normalizeSpawnedRunMetadata } from "./spawned-context-CXOL9esF.js";
import { n as loadModelCatalog } from "./model-catalog-hbxjrLud.js";
import { t as AGENT_LANE_SUBAGENT } from "./lanes-DHa7Y930.js";
import { t as createTrajectoryRuntimeRecorder } from "./runtime-BpDP-95O.js";
import { l as ensureAgentWorkspace } from "./workspace-DSIvVEKH.js";
import { i as LiveSessionModelSwitchError, r as runWithModelFallback } from "./model-fallback-DgsGm-S-.js";
import { t as getAgentRuntimeCommandSecretTargetIds } from "./command-secret-targets-BKgQ9hgh.js";
...
import { i as resolveSession } from "./live-model-switch-CgWfwnyl.js";
...
import { t as clearSessionAuthProfileOverride } from "./session-override-DvOVcLpe.js";
import { n as applyVerboseOverride } from "./level-overrides-BISZP7W8.js";
import { i as resolveInternalEventTranscriptBody, n as prependInternalEventContext, r as resolveAcpPromptBody, s as createAcpVisibleTextAccumulator, t as persistSessionEntry$1 } from "./attempt-execution.shared-DNXblyi9.js";
...
async function resolveAgentRuntimeConfig(runtime, params) {
	...
	}) ? (await (await import("./command-config-resolution.runtime-E1SIkPRL.js")).resolveCommandConfigWithSecrets({
		config: loadedRaw,
		commandName: "agent",
...
function loadAttemptExecutionRuntime() {
	attemptExecutionRuntimePromise ??= import("./attempt-execution.runtime-A0tCjEX0.js");
	return attemptExecutionRuntimePromise;
}
function loadAcpManagerRuntime() {
	acpManagerRuntimePromise ??= import("./manager-b29ta35N.js");
	return acpManagerRuntimePromise;
}
function loadAcpPolicyRuntime() {
	acpPolicyRuntimePromise ??= import("./policy-DbfglP7B.js");
	return acpPolicyRuntimePromise;
}
function loadAcpRuntimeErrorsRuntime() {
	acpRuntimeErrorsRuntimePromise ??= import("./errors-C4Y9IIyS.js");
	return acpRuntimeErrorsRuntimePromise;
}
function loadAcpSessionIdentifiersRuntime() {
	acpSessionIdentifiersRuntimePromise ??= import("./session-identifiers-CABtkkrT.js");
	return acpSessionIdentifiersRuntimePromise;
}
function loadDeliveryRuntime() {
	deliveryRuntimePromise ??= import("./delivery.runtime-wZYRNd8M.js");
	return deliveryRuntimePromise;
}
function loadSessionStoreRuntime() {
	sessionStoreRuntimePromise ??= import("./session-store.runtime-C6hhgdep.js");
	return sessionStoreRuntimePromise;
}
function loadCliCompactionRuntime() {
	cliCompactionRuntimePromise ??= import("./cli-compaction-CZqgwFkl.js");
	return cliCompactionRuntimePromise;
}
function loadTranscriptResolveRuntime() {
	transcriptResolveRuntimePromise ??= import("./transcript-resolve.runtime-x8THx4Gu.js");
	return transcriptResolveRuntimePromise;
}
function loadCliDepsRuntime() {
	cliDepsRuntimePromise ??= import("./deps-CJvyDGgR.js");
	return cliDepsRuntimePromise;
}
function loadExecDefaultsRuntime() {
	execDefaultsRuntimePromise ??= import("./exec-defaults-uUOTJsSW.js");
	return execDefaultsRuntimePromise;
}
function loadSkillsRuntime() {
	skillsRuntimePromise ??= import("./skills-Dsskl3cH.js");
	return skillsRuntimePromise;
}
function loadSkillsFilterRuntime() {
	skillsFilterRuntimePromise ??= import("./filter-CS4NJNou.js");
	return skillsFilterRuntimePromise;
}
function loadSkillsRefreshStateRuntime() {
	skillsRefreshStateRuntimePromise ??= import("./refresh-state-DbB8kHzl.js");
	return skillsRefreshStateRuntimePromise;
}
function loadSkillsRemoteRuntime() {
	skillsRemoteRuntimePromise ??= import("./skills-remote-D-U7qYsT.js");
