...
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT, y as SANDBOX_BROWSER_SECURITY_HASH_EPOCH } from "./constants-Dis70qw1.js";
import { n as isToolAllowed } from "./tool-policy-BLi2sfIe.js";
import { i as resolveSandboxConfigForAgent, r as resolveSandboxBrowserDockerCreateConfig } from "./config-DU7A4GQi.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-9Sc5uXER.js";
import { c as DEFAULT_USER_FILENAME, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-DSIvVEKH.js";
import { f as isSameSsrFPolicy } from "./ssrf-nwJHqKWi.js";
import { a as resolveSandboxPath, i as resolveSandboxInputPath } from "./sandbox-paths-BQsZxg0w.js";
import { a as DEFAULT_OPENCLAW_BROWSER_COLOR, d as ensureBrowserControlAuth, f as resolveBrowserControlAuth, l as resolveBrowserConfig, n as DEFAULT_BROWSER_ACTION_TIMEOUT_MS, s as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as resolveProfile } from "./browser-profiles-D_hdtqQ7.js";
import { C as removeRegistryEntry, E as computeSandboxBrowserConfigHash, S as removeBrowserRegistryEntry, T as updateRegistry, _ as resolveSandboxScopeKey, a as execDocker, b as readBrowserRegistry, c as isDockerDaemonUnavailable, d as readDockerNetworkDriver, f as readDockerNetworkGateway, g as resolveSandboxAgentId, h as appendWorkspaceMountArgs, l as readDockerContainerEnvVar, n as dockerContainerState, p as readDockerPort, s as formatDockerDaemonUnavailableError, t as buildSandboxCreateArgs, u as readDockerContainerLabel, v as resolveSandboxWorkspaceDir, w as updateBrowserRegistry, x as readRegistry, y as slugifySessionKey } from "./docker-B-lldQna.js";
import { a as splitSandboxBindSpec, i as resolveSandboxHostPathViaExistingAncestor, n as validateNetworkMode } from "./validate-sandbox-security-Bmgi0Dm9.js";
import { C as buildPinnedAppendPlan, D as buildPinnedWritePlan, E as buildPinnedRenamePlan, O as dockerSandboxBackendManager, T as buildPinnedRemovePlan, a as getSandboxBackendManager, k as runDockerSandboxShellCommand, n as startBrowserBridgeServer, r as stopBrowserBridgeServer, s as requireSandboxBackendFactory, t as BROWSER_BRIDGES, v as isPathInsideContainerRoot, w as buildPinnedMkdirpPlan, y as normalizeContainerPath } from "./browser-bridges-OIFWNoWa.js";
	...
	if (workspaceDir === sandboxWorkspaceDir) {
		...
		if (cfg.workspaceAccess !== "rw") try {
			const [{ getRemoteSkillEligibility }, { canExecRequestNode }, { syncSkillsToWorkspace }] = await Promise.all([
				import("./skills-remote-D-U7qYsT.js"),
				import("./exec-defaults-uUOTJsSW.js"),
				import("./skills-Dsskl3cH.js")
			]);
...
async function resolveSandboxContext(params) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune-BL1EJH_T.js")).maybePruneSandboxes(cfg);
