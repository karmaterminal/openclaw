...
import { c as getAgentRunContext, l as onAgentEvent } from "./agent-events-DE3So3Se.js";
...
import { r as configureSubagentRegistrySpawnRuntime, t as emitSessionLifecycleEvent } from "./session-lifecycle-events-CKPJU_Rk.js";
import { i as callGateway } from "./call-BXBUsPlF.js";
import { A as subagentRuns, C as SUBAGENT_ENDED_OUTCOME_ERROR, D as SUBAGENT_ENDED_REASON_ERROR, E as SUBAGENT_ENDED_REASON_COMPLETE, O as SUBAGENT_ENDED_REASON_KILLED, S as resolveSubagentSessionStatus, T as SUBAGENT_ENDED_OUTCOME_TIMEOUT, a as countActiveRunsForSessionFromRuns, b as getSubagentSessionRuntimeMs, c as getSubagentRunByChildSessionKeyFromRuns, d as listRunsForControllerFromRuns, i as countActiveDescendantRunsFromRuns, k as SUBAGENT_TARGET_KIND_SUBAGENT, n as persistSubagentRunsToDisk, r as restoreSubagentRunsFromDisk, s as countPendingDescendantRunsFromRuns, t as getSubagentRunsSnapshotForRead, u as listDescendantRunsForRequesterFromRuns, v as isStaleUnendedSubagentRun, w as SUBAGENT_ENDED_OUTCOME_KILLED, x as getSubagentSessionStartedAt } from "./subagent-registry-state-e98Aydy5.js";
import { a as isSilentReplyText } from "./tokens-fh59FP1B.js";
import { l as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-BuGXdJuK.js";
import "./pi-bundle-mcp-tools-ClCYHpoW.js";
import { t as registerPendingSpawnedChildrenQuery } from "./pending-spawn-query-DaBMQ2oG.js";
import { i as failTaskRunByRunId, r as createRunningTaskRun, s as setDetachedTaskDeliveryStatusByRunId, t as completeTaskRunByRunId } from "./detached-task-runtime-i2h5BcKG.js";
import "./subagent-announce-queue-pL8Z3BDe.js";
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-B4L1m1sk.js";
import { d as importRuntimeModule, u as withSubagentOutcomeTiming } from "./subagent-announce-output-BnHxIC-o.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-YBVmaB44.js";
...
async function loadCleanupBrowserSessionsForLifecycleEnd$1() {
	browserCleanupPromise$1 ??= import("./browser-lifecycle-cleanup-DLiIWa2x.js");
...
async function loadSubagentAnnounceModule() {
	subagentAnnouncePromise ??= import("./subagent-announce-DR9s5FQ_.js");
	return await subagentAnnouncePromise;
}
async function loadCleanupBrowserSessionsForLifecycleEnd() {
	browserCleanupPromise ??= import("./browser-lifecycle-cleanup-DLiIWa2x.js");
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-B-emba8O.js").then(({ scheduleOrphanRecovery }) => {
