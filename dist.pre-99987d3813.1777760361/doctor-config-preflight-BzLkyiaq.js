...
import { g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-DTtpq82f.js";
import { n as formatConfigIssueLines } from "./issue-format-CIrBljpw.js";
import { t as note } from "./note-Deih_6FT.js";
import { n as noteIncludeConfinementWarning } from "./doctor-config-analysis-D-eMDFhc.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-BWerEg5o.js");
