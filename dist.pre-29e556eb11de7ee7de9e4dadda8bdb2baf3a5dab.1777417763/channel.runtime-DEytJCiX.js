...
import { P as resolveBlueBubblesEffectiveAllowPrivateNetwork, _ as normalizeWebhookReaction, g as normalizeWebhookMessage, o as probeBlueBubbles, t as fetchBlueBubblesServerInfo, u as asRecord } from "./probe-DxZgPkQr.js";
import { t as getBlueBubblesRuntime } from "./runtime-CJDYliPm.js";
import { n as resolveWebhookPathFromConfig } from "./webhook-shared-BY2IGjun.js";
import { a as resolveBlueBubblesMessageId, b as sendMessageBlueBubbles } from "./reactions-CamhTpmZ.js";
import { i as sendBlueBubblesMedia, n as processMessage, r as processReaction, t as logVerbose } from "./monitor-processing-WZ7uz991.js";
...
async function monitorBlueBubblesProvider(options) {
	...
	return await new Promise((resolve) => {
		...
		import("./catchup-AX1UG_E7.js").then(({ runBlueBubblesCatchup }) => runBlueBubblesCatchup(target)).catch((err) => {
