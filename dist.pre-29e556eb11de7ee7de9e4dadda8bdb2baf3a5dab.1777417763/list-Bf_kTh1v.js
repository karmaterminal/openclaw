...
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-CaJhX8j0.js";
import { t as maskApiKey } from "./mask-api-key--8v7PaC9.js";
import { n as loadModelsConfigWithSource, t as loadModelsConfig } from "./load-config-B5Jgvftg.js";
import { n as loadProviderCatalogModelsForList, t as hasProviderStaticCatalogForFilter } from "./list.runtime-DsXNSI2n.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-Dna8P6NI.js";
...
async function modelsListCommand(opts, runtime) {
	...
	const { ensureAuthProfileStore, resolveOpenClawAgentDir } = await import("./list.runtime-CI7Hg3-D.js");
...
function loadProviderUsageRuntime() {
	providerUsageRuntimePromise ??= import("./provider-usage-BRMPF9oA.js");
...
function loadTerminalTableRuntime() {
	terminalTableRuntimePromise ??= import("./table-D80wvD4Q.js");
	return terminalTableRuntimePromise;
}
function loadListProbeRuntime() {
	listProbeRuntimePromise ??= import("./list.probe-BlfncAQi.js");
...
async function modelsStatusCommand(opts, runtime) {
	...
	if (missingProvidersInUse.length > 0) {
		const { buildProviderAuthRecoveryHint } = await import("./provider-auth-guidance-rbx8T2yN.js");
		runtime.log("");
