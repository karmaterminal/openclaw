...
import "./daemon-runtime-BVJas-k1.js";
import { c as isValidEnvSecretRefId, p as resolveSecretInputRef } from "./types.secrets-D9j6Z-gp.js";
import { l as resolveDefaultSecretProviderAlias } from "./ref-contract-CmDf3_tu.js";
import { t as resolveGatewayAuthToken } from "./auth-token-resolution-B4Y_d-nd.js";
import { u as readConfigFileSnapshot } from "./io-HGX0xk55.js";
...
import { c as normalizeGatewayTokenInput, m as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-DolocO0f.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-3xACND9q.js";
import { t as runSetupWizard } from "./setup-pif420sj.js";
import { i as applySkipBootstrapConfig, r as applyLocalSetupWorkspaceConfig } from "./onboard-config-BOPVn4Tz.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-irnMrWCB.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	const inferredAuthChoice = opts.authChoice ? void 0 : (await import("./auth-choice-inference-BqxR2uHU.js")).inferAuthChoiceFromFlags(opts, {
		config: nextConfig,
		workspaceDir,
		env: process.env
	});
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-CU2EQ37j.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-CqQhcbLC.js");
