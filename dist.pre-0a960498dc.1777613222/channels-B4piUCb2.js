...
import { i as normalizeChannelId, n as getLoadedChannelPlugin, r as listChannelPlugins, t as getChannelPlugin } from "./registry-DPUPp9Ly.js";
...
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-CVG-UkbI.js";
...
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-B7mjmIZr.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-P3bVHWjM.js";
import { t as createClackPrompter } from "./clack-prompter-C5vNWRch.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-B_TTshNl.js";
import { n as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-C2vZmJCu.js";
import { t as parseLogLine } from "./parse-log-line-DsnECb57.js";
import { a as describeBinding, t as applyAgentBindings } from "./agents.bindings-Dr0biEmU.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-BYdsv5yg.js";
import { c as requireValidConfig, l as shouldUseWizard, o as channelLabel, s as formatChannelAccountLabel } from "./shared-BWRTlNDf.js";
import { t as channelsListCommand } from "./list-BhT2n9ox.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-BCErUaq2.js";
...
function loadChannelSetupPluginInstall() {
	channelSetupPluginInstallPromise ??= import("./plugin-install-B3lZveit.js");
	return channelSetupPluginInstallPromise;
}
function loadOnboardChannels() {
	onboardChannelsPromise ??= import("./onboard-channels-CZxzzoNm.js");
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	const { listChannelPluginCatalogEntries } = await import("./catalog-D3ay3rFV.js");
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-fLxHvzFH.js"), loadOnboardChannels()]);
	...
	if (!channel && catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-ClElt5VI.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = !useWizard && rawChannel && (!channel || !getChannelPlugin(channel)) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-DT7tdxhC.js");
