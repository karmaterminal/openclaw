import { U as shouldMigrateStateFromPath } from "./logger--l1ykZMf.js";
...
async function ensureConfigReady(params) {
	...
	if (!didRunDoctorConfigFlow && shouldMigrateStateFromPath(commandPath)) {
		...
		const runDoctorConfigPreflight = async () => (await import("./doctor-config-preflight-DgfYEysa.js")).runDoctorConfigPreflight({
			migrateState: false,
	...
	const { formatConfigIssueLines } = await import("./issue-format-DR655_1y.js");
	...
	const [{ colorize, isRich, theme }, { shortenHomePath }, { formatCliCommand }] = await Promise.all([
		import("./theme-CgwNzhjJ.js"),
		import("./utils-DMQR8q6t.js"),
		import("./command-format-CvdT6mLW.js")
	]);
	const rich = isRich();
