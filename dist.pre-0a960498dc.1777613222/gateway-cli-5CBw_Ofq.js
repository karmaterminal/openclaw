...
import { d as setConsoleTimestampPrefix, t as createSubsystemLogger, u as setConsoleSubsystemFilter } from "./subsystem-DRUx3zf3.js";
...
import { _ as resolveStateDir, t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-CrDgDBYA.js";
import { d as resolveGatewayLaunchAgentLabel, m as resolveGatewayWindowsTaskName, p as resolveGatewaySystemdServiceName } from "./paths-DisUnE6t.js";
import { o as hasConfiguredSecretInput } from "./types.secrets-D9j6Z-gp.js";
import "./globals-BMZFdRyi.js";
import { n as isContainerEnvironment, t as defaultGatewayBindMode } from "./net-lcLTXl0l.js";
import "./auth-vAn16E25.js";
import { n as resolveGatewayAuth } from "./auth-resolve-BHz5g_Dw.js";
import { a as loadConfig, g as recoverConfigFromLastKnownGood, h as recoverConfigFromJsonRootSuffix, l as readBestEffortConfig, r as createConfigIO, u as readConfigFileSnapshot, y as writeConfigFile } from "./io-HGX0xk55.js";
import { b as resolveWorkspaceTemplateDir, v as resolveDefaultAgentWorkspaceDir } from "./workspace-ibYRWzQC.js";
import { t as cleanStaleGatewayProcessesSync } from "./restart-stale-pids-Dx50Y3GM.js";
import { a as inspectPortUsage, s as formatPortDiagnostics } from "./ports-Dr5GDon3.js";
import { r as resolveGatewayService } from "./service-lE9-aXkd.js";
import { t as parsePort } from "./parse-port-D3nlsRIv.js";
import "./config-B3U8IbHS.js";
import { g as GATEWAY_CLIENT_NAMES, h as GATEWAY_CLIENT_MODES } from "./message-channel-BEwkHNOF.js";
import { a as getActiveTaskCount, c as markGatewayDraining, d as waitForActiveTasks, l as resetAllLanes } from "./command-queue-B2X59ob3.js";
import { r as callGateway } from "./call-O_DAf3Ts.js";
import { f as writeRestartSentinel } from "./restart-sentinel-yOW_EH6f.js";
import { a as markGatewaySigusr1RestartHandled, i as isGatewaySigusr1RestartExternallyAllowed, l as triggerOpenClawRestart, o as scheduleGatewaySigusr1Restart, t as consumeGatewaySigusr1RestartAuthorization } from "./restart-CKZ_MmAj.js";
import { d as waitForActiveEmbeddedRuns, r as getActiveEmbeddedRunCount, t as abortEmbeddedPiRun } from "./runs-rRV0MELk.js";
import { _ as selectDiagnosticStabilitySnapshot, f as writeDiagnosticStabilityBundleForFailureSync, h as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-bundle-DX65JdM5.js";
...
import { n as setGatewayWsLogStyle } from "./ws-logging-yYaxoH6y.js";
import { t as formatHelpExamples } from "./help-format-CQy3j6Ac.js";
import { t as readSecretFromFile } from "./secret-file-DIa7IlyV.js";
import { n as buildGatewayDiscoveryTarget } from "./gateway-discovery-targets-DSm2jcwa.js";
import { o as resolveControlUiRootSync } from "./control-ui-assets-DUV04Bhb.js";
import { n as acquireGatewayLock, t as GatewayLockError } from "./gateway-lock-CdWDhpcr.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-B6mLshRt.js";
import { o as handleReset } from "./onboard-helpers-DolocO0f.js";
...
async function runGatewayCommand$1(opts) {
	...
	const { startGatewayServer } = await startupTrace.measure("cli.server-import", () => withProgress({
		...
		indeterminate: true
	}, async () => import("./server-DzDjMEfo.js")));
...
function loadConfigModule() {
	configModulePromise ??= import("./read-best-effort-config.runtime-CeqbtSIs.js");
	return configModulePromise;
}
function loadGatewayStatusModule() {
	gatewayStatusModulePromise ??= import("./gateway-status-hTyF_mel.js");
	return gatewayStatusModulePromise;
}
function loadGatewayHealthModule() {
	gatewayHealthModulePromise ??= import("./health-7VoLYUAI.js");
	return gatewayHealthModulePromise;
}
function loadBonjourDiscoveryModule() {
	bonjourDiscoveryModulePromise ??= import("./bonjour-discovery-BiZecz2y.js");
	return bonjourDiscoveryModulePromise;
}
function loadWideAreaDnsModule() {
	wideAreaDnsModulePromise ??= import("./widearea-dns-CnYNV_l8.js");
	return wideAreaDnsModulePromise;
}
function loadHealthStyleModule() {
	healthStyleModulePromise ??= import("./health-style-BB4uQBgu.js");
	return healthStyleModulePromise;
}
function loadUsageFormatModule() {
	usageFormatModulePromise ??= import("./usage-format-DNqaa1LL.js");
	return usageFormatModulePromise;
}
function loadStabilityBundleModule() {
	stabilityBundleModulePromise ??= import("./diagnostic-stability-bundle-B5OMdDlk.js");
	return stabilityBundleModulePromise;
}
function loadSupportExportModule() {
	supportExportModulePromise ??= import("./diagnostic-support-export-mQzIH8sl.js");
	return supportExportModulePromise;
}
function loadDaemonStatusGatherModule() {
	daemonStatusGatherModulePromise ??= import("./status.gather-B_KdFYc2.js");
