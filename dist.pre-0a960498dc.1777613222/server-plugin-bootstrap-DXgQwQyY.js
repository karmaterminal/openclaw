...
import { o as normalizePluginsConfig } from "./config-state-xYE_uUf9.js";
import { T as validateConfigObjectWithPlugins, X as normalizeTalkSection, Y as buildTalkConfigResponse, Z as resolveActiveTalkProviderConfig, a as loadConfig, d as readConfigFileSnapshotForWrite, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, v as resolveConfigSnapshotHash, y as writeConfigFile } from "./io-HGX0xk55.js";
...
import { r as loadOpenClawPlugins } from "./loader-Dbq7I8n7.js";
import { B as resolveMemoryLightDreamingConfig, F as resolveMemoryDeepDreamingConfig, I as resolveMemoryDreamingConfig, L as resolveMemoryDreamingPluginConfig, N as isSameMemoryDreamingDay, V as resolveMemoryRemDreamingConfig, z as resolveMemoryDreamingWorkspaces } from "./dreaming-C0URt89W.js";
import "./plugins-Bk33nzKG.js";
import { s as getPluginCommandSpecs } from "./command-registration-BunhsmiV.js";
import { i as hasInternalHookListeners, m as triggerInternalHook } from "./internal-hooks-DUx3ffaZ.js";
import { S as createEmptyPluginRegistry, a as getActivePluginRegistry, d as pinActivePluginChannelRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion, x as setActivePluginRegistry } from "./runtime-BLsgx2-v.js";
import { n as withPluginRuntimeGatewayRequestScope, t as getPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-UqpPu6mu.js";
import { r as createPluginRuntimeLoaderLogger } from "./load-context-Bz354tRk.js";
...
import { b as normalizeModelRef, x as parseModelRef } from "./model-selection-shared-BF-DQvbf.js";
import { t as buildAllowedModelSet } from "./model-selection-CZhXg7nY.js";
...
import { n as resolveMainSessionKeyFromConfig, r as canonicalizeSpawnedByForAgent, t as extractDeliveryInfo } from "./sessions-CQdlpJUR.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent } from "./paths-DOSS0HMP.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, r as mergeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-DBWNAPgn.js";
...
import { n as readJsonFile, r as writeJsonAtomic, t as createAsyncLock } from "./json-files-BXsNmWIg.js";
import { n as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-D3bbWZ04.js";
import { a as readSessionPreviewItemsFromTranscript, i as readSessionMessages } from "./session-utils.fs-Dn5nQNOb.js";
import { a as resolveSessionTranscriptCandidates, t as archiveFileOnDisk } from "./session-transcript-files.fs-CjL9o5JQ.js";
...
import { d as listSessionCompactionCheckpoints, u as getSessionCompactionCheckpoint } from "./model-context-tokens-CWNcry6N.js";
import { a as normalizeCronJobCreate, s as normalizeCronJobPatch } from "./openclaw-tools-kzAwpcnp.js";
import { _ as listCoreToolSections, h as PROFILE_OPTIONS, v as resolveCoreToolProfiles } from "./tool-policy-BEJUsLxm.js";
import { n as getPluginToolMeta, r as resolvePluginTools } from "./tools-Cf6EfoW-.js";
import { n as redactConfigSnapshot, r as restoreRedactedValues, t as redactConfigObject } from "./redact-snapshot-BRaC7Mly.js";
import { C as synthesizeSpeech, S as setTtsProvider, b as setTtsEnabled, c as isTtsEnabled, f as resolveExplicitTtsOverrides, g as resolveTtsProviderOrder, h as resolveTtsPrefsPath, i as getResolvedSpeechProviderConfig, l as isTtsProviderConfigured, m as resolveTtsConfig, o as getTtsProvider, p as resolveTtsAutoMode, w as textToSpeech } from "./tts-CepJD85f.js";
import "./auth-profiles-wtgOrnJU.js";
import { s as projectOutboundPayloadPlanForMirror, t as createOutboundPayloadPlan } from "./payloads-DEM757dI.js";
import { l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-BRkCNXs1.js";
import { g as writeFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-C6LQEdgq.js";
import { d as mergeExecApprovalsSocketDefaults, j as saveExecApprovals, o as ensureExecApprovals, p as normalizeExecApprovals, y as readExecApprovalsSnapshot } from "./exec-approvals-C2hB7k4d.js";
import { a as prepareSecretsRuntimeSnapshot } from "./runtime-B0T7UY8N.js";
import { i as parseAbsoluteTimeMs } from "./stagger-DLl9hEHh.js";
import { r as isInvalidCronSessionTargetIdError } from "./webhook-url-BRiFBp0U.js";
import { f as writeRestartSentinel, i as formatDoctorNonInteractiveHint } from "./restart-sentinel-yOW_EH6f.js";
import { o as scheduleGatewaySigusr1Restart } from "./restart-CKZ_MmAj.js";
import { o as listConfiguredAnnounceChannelIdsForConfig, r as resolveGatewayStartupPluginIds } from "./channel-plugin-ids-8RDRFO1Q.js";
import { i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry, s as dispatchChannelMessageAction } from "./message-action-runner-Bi_RRLsx.js";
import { n as normalizePollInput } from "./polls-B45uUoNq.js";
import { t as deliverOutboundPayloads } from "./deliver-B6B_mfXE.js";
import { n as resolveOutboundChannelPlugin } from "./channel-resolution-B1BB77ug.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-C-g97tpE.js";
import "./target-resolver-DlrAgEgx.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-FcIS2dS8.js";
import { i as resolveReplyToMode } from "./reply-threading-DKUQzq83.js";
...
import { r as resolveOutboundTarget } from "./targets-Cg71fb9T.js";
import { t as extractToolPayload } from "./tool-payload-BwUIMnp_.js";
import { i as setHeartbeatsEnabled } from "./heartbeat-wake-nI53QSWE.js";
import { i as enqueueSystemEvent, o as isSystemEventContextChanged } from "./system-events-DV5kbtQJ.js";
import { r as createRunningTaskRun } from "./detached-task-runtime-4OP4n2rb.js";
import { a as clearSessionQueues } from "./queue-7D5vMtql.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-CF59jhbb.js";
import { a as isEmbeddedPiRunActive, f as waitForEmbeddedPiRunEnd, t as abortEmbeddedPiRun } from "./runs-rRV0MELk.js";
import { h as normalizeDiagnosticStabilityQuery, m as getDiagnosticStabilitySnapshot } from "./diagnostic-stability-bundle-DX65JdM5.js";
import { t as resolveAgentTimeoutMs } from "./timeout-TgWmyBUs.js";
import { n as normalizeSpawnedRunMetadata, r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-BROB-vtw.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-Bp0Wh6HY.js";
import "./skills-QMfq-SDp.js";
...
import { t as primeConfiguredBindingRegistry } from "./binding-registry-DUWVusMa.js";
import { r as listPluginCommands } from "./commands-xJCxCfof.js";
import { i as setGatewaySubagentRuntime, r as setGatewayNodesRuntime } from "./gateway-bindings-Dsezc6_H.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-CN9kTRPz.js";
import "./commands-registry-CB2k7iyG.js";
import { n as resolveSendPolicy } from "./send-policy-BcinRs0k.js";
import { t as getChannelActivity } from "./channel-activity-DqxQNED1.js";
import { t as WizardCancelledError } from "./prompts-ZE6fbgyP.js";
import { t as canExecRequestNode } from "./exec-defaults-BmUCCTso.js";
import { t as bumpSkillsSnapshotVersion } from "./refresh-state-CD-lrAuh.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-DtTKPn9r.js";
import { o as resolveMissingRequestedScope } from "./pairing-token-Dy6CZOOk.js";
import { d as listNodePairing, f as rejectNodePairing, g as verifyNodeToken, l as approveNodePairing, m as requestNodePairing, p as renamePairedNode, t as getRemoteSkillEligibility } from "./skills-remote-BfvYckfh.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-DbUfIR9f.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-CmuXyLVB.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-DlSJVNHt.js";
import { r as getLastHeartbeatEvent } from "./heartbeat-visibility-Bqihl9je.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-DFnLSCNe.js";
import { r as agentCommandFromIngress } from "./agent-command-tqujgIh3.js";
import { n as getSpeechProvider, r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-eq_dX5Yj.js";
import { n as invokeNativeHookRelay } from "./native-hook-relay-6XCVgylr.js";
import { i as resolveNodeCommandAllowlist, n as isNodeCommandAllowed } from "./node-command-policy-Cg_pxeno.js";
import { t as formatForLog } from "./ws-log-CEgRJndl.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-C9P2AAZ2.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-Hic6pJ3V.js";
import { a as getPairedDevice, c as listApprovedPairedDeviceRoles, d as rejectDevicePairing, f as removePairedDevice, g as summarizeDeviceTokens, h as rotateDeviceToken, i as formatDevicePairingForbiddenMessage, l as listDevicePairing, m as revokeDeviceToken, n as approveDevicePairing, o as getPendingDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-CY15RWsZ.js";
import { o as REALTIME_VOICE_AGENT_CONSULT_TOOL, r as getRealtimeVoiceProvider, s as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, t as resolveConfiguredRealtimeVoiceProvider } from "./provider-resolver-3ymiCPzU.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-CaEQGt7A.js";
import { n as createOutboundSendDeps } from "./deps-BkoaWDDj.js";
import "./agent-DMht8SKX.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-CS5I-iy5.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-D-pl7QyC.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-Cbk_GLWS.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-BSLj3InI.js";
import { d as waitForTerminalGatewayDedupe, g as resolveAgentRunExpiresAtMs, h as registerChatAbortController, i as chatHandlers, l as readTerminalSnapshotFromGatewayDedupe, u as setGatewayDedupeEntry } from "./chat-BnhbxzAW.js";
import { n as MediaOffloadError, r as parseMessageWithAttachments, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-ChlHBCAl.js";
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp-Bywnmk8s.js";
import { t as resolveSessionKeyFromResolveParams } from "./sessions-resolve-CFxEeAd4.js";
import { t as loadProviderUsageSummary } from "./provider-usage-JXnLdVkC.js";
import { o as fetchClawHubSkillDetail } from "./clawhub-DXlk8uBv.js";
import { a as loadSessionUsageTimeSeries, i as loadSessionLogs, n as loadCostUsageSummary, o as resolveExistingUsageSessionFile, r as loadSessionCostSummary, t as discoverAllSessions } from "./session-cost-usage-DUFgyo4M.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-ChgmVdvw.js";
import { n as movePathToTrash } from "./browser-maintenance-Bvqw-bCD.js";
import { a as performGatewaySessionReset } from "./session-reset-service-Duyb2DBR.js";
import { t as buildChannelUiCatalog } from "./catalog-BLRFWIH-.js";
import { a as removeBackfillDiaryEntries, c as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeGroundedShortTermCandidates, r as previewGroundedRemMarkdown, s as repairDreamingArtifacts } from "./memory-core-bundled-runtime-BaEdwIDr.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-C9IzfdA3.js";
import { t as readConfiguredLogTail } from "./log-tail-CNa6PlYs.js";
import { n as purgeAgentSessionStoreEntries } from "./agents.command-shared-Drri2FU2.js";
import { o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-eBzrEg6I.js";
import { t as installSkill } from "./skills-install-UyAbHbp-.js";
import { m as normalizeUpdateChannel } from "./update-check-CWAyV16F.js";
import "./status-Bi6K5beE.js";
import { t as getStatusSummary } from "./status.summary-BS8qoCW5.js";
import { i as updateSkillsFromClawHub, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-BzKtUGs6.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-DC9XzDiw.js";
import { t as runGatewayUpdate } from "./update-runner-ChPZBN-B.js";
import { t as buildChannelAccountSnapshot } from "./status-YWfgD6ZI.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-vOLJkyR-.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-CVHPDKGW.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-CkRQAirD.js";
import "./heartbeat-runner-BcwyIv7S.js";
...
async function loadSessionSubagentReactivationRuntime() {
	return import("./session-subagent-reactivation.runtime-DAAz5J0c.js");
}
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-B-YXKBA3.js");
...
function loadSessionsRuntimeModule() {
	sessionsRuntimeModulePromise ??= import("./sessions.runtime-xlgQPROi.js");
