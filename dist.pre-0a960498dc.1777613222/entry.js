...
import { H as isRootVersionInvocation, V as isRootHelpInvocation } from "./logger--l1ykZMf.js";
import { t as resolveCliArgvInvocation } from "./argv-invocation-WovolAlT.js";
import { a as parseCliContainerArgs, n as applyCliProfileEnv, o as resolveCliContainerTarget, r as parseCliProfileArgs, t as normalizeWindowsArgv } from "./windows-argv-DzpibptW.js";
...
import { t as ensureOpenClawExecMarkerOnProcess } from "./openclaw-exec-env-kWgUrg-H.js";
import { t as installProcessWarningFilter } from "./warning-filter-BAZfpOXQ.js";
...
function tryHandleRootVersionFastPath(argv, deps = {}) {
	...
	(deps.resolveVersion ?? (async () => {
		const [{ VERSION }, { resolveCommitHash }] = await Promise.all([import("./version-BAqscPtH.js"), import("./git-commit-BfItfzuv.js")]);
		return {
			VERSION,
			resolveCommitHash
		};
...
function tryHandleRootHelpFastPath(argv, deps = {}) {
	...
	import("./root-help-metadata-Cz6B39mA.js").then(async ({ outputPrecomputedRootHelpText }) => {
...
function runMainOrRootHelp(argv) {
	...
	import("./run-main-D4nKQyXy.js").then(({ runCli }) => runCli(argv)).catch((error) => {
