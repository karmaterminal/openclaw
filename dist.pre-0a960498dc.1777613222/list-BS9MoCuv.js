...
import { V as getShellEnvAppliedKeys, W as shouldEnableShellEnvFallback, r as createConfigIO } from "./io-HGX0xk55.js";
...
import { i as resolveAgentExplicitModelPrimary, s as resolveAgentModelFallbacksOverride, y as resolveAgentDir } from "./agent-scope-zHoqFGPE.js";
import "./config-B3U8IbHS.js";
import { u as resolveAuthStorePathForDisplay } from "./source-check-DXkHiZ5I.js";
import { i as ensureAuthProfileStoreWithoutExternalProfiles } from "./store-B63eWvc7.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-DHYXEmd4.js";
import { u as isNonSecretApiKeyMarker, v as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-9f2IFvuI.js";
import { t as modelKey } from "./model-ref-shared-DcLkozLZ.js";
import { f as resolveConfiguredModelRef, h as resolveModelRefFromString, i as buildModelAliasIndex, x as parseModelRef, y as modelKey$1 } from "./model-selection-shared-BF-DQvbf.js";
...
import { i as discoverModels, l as resolveRuntimeSyntheticAuthProviderRefs, r as discoverAuthStorage } from "./pi-model-discovery-CXV6bky5.js";
import { i as resolveAuthProfileDisplayLabel } from "./auth-profiles-wtgOrnJU.js";
import { n as listProfilesForProvider } from "./profile-list-CT3GwYKf.js";
import { o as resolveProfileUnusableUntilForDisplay } from "./usage-1O9qU76_.js";
import "./profiles-DjXPV26S.js";
import { i as getCustomProviderApiKey, l as resolveUsableCustomProviderApiKey, o as hasUsableCustomProviderApiKey } from "./model-auth-z9q2AAmi.js";
import { n as shouldSuppressBuiltInModel } from "./model-suppression-C44r6_cX.js";
import { r as resolveModelWithRegistry } from "./model-AV_tazi3.js";
import { f as isLocalBaseUrl, i as formatTokenK, n as ensureFlagCompatibility, s as resolveKnownAgentId } from "./shared-RkAzCrGm.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-ChgmVdvw.js";
import { t as maskApiKey } from "./mask-api-key-MvdL-MSO.js";
import { n as loadModelsConfigWithSource, t as loadModelsConfig } from "./load-config-m2JFdZUZ.js";
import { n as loadProviderCatalogModelsForList, t as hasProviderStaticCatalogForFilter } from "./list.runtime-5nBU-XRG.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-1_H-GQ-I.js";
...
async function modelsListCommand(opts, runtime) {
	...
	const { ensureAuthProfileStore, resolveOpenClawAgentDir } = await import("./list.runtime-CPLVhj5-.js");
...
function loadProviderUsageRuntime() {
	providerUsageRuntimePromise ??= import("./provider-usage-WfA1GJ3E.js");
	return providerUsageRuntimePromise;
}
function loadProgressRuntime() {
	progressRuntimePromise ??= import("./progress-k88OUxXC.js");
	return progressRuntimePromise;
}
function loadTerminalTableRuntime() {
	terminalTableRuntimePromise ??= import("./table-Dubz6sPr.js");
	return terminalTableRuntimePromise;
}
function loadListProbeRuntime() {
	listProbeRuntimePromise ??= import("./list.probe-3lB22RUJ.js");
...
async function modelsStatusCommand(opts, runtime) {
	...
	if (missingProvidersInUse.length > 0) {
		const { buildProviderAuthRecoveryHint } = await import("./provider-auth-guidance-74Uvx6z1.js");
		runtime.log("");
