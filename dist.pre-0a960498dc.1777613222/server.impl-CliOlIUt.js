...
import { i as getChildLogger } from "./logger--l1ykZMf.js";
...
import { r as isDiagnosticsEnabled, s as setDiagnosticsEnabledForProcess } from "./diagnostic-events-Bq1LHJIn.js";
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-DRUx3zf3.js";
import { n as isVitestRuntimeEnv, r as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-DM4mWVZJ.js";
...
import { o as getTailnetHostname } from "./tailscale-DNKbjLq7.js";
...
import { a as hasForwardedRequestHeaders, i as authorizeWsControlUiGatewayConnect, o as isLocalDirectRequest, r as authorizeHttpGatewayConnect, s as checkBrowserOrigin, t as assertGatewayAuthConfigured } from "./auth-vAn16E25.js";
import { n as resolveGatewayAuth } from "./auth-resolve-BHz5g_Dw.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-Cx3e2QRz.js";
import { $ as resolveAgentMaxConcurrent, A as applyConfigOverrides, _ as registerConfigWriteListener, a as loadConfig, c as promoteConfigSnapshotToLastKnownGood, et as resolveSubagentMaxConcurrent, g as recoverConfigFromLastKnownGood, h as recoverConfigFromJsonRootSuffix, i as getRuntimeConfig, r as createConfigIO, u as readConfigFileSnapshot, y as writeConfigFile } from "./io-HGX0xk55.js";
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-Bpadcn3w.js";
...
import { n as getLoadedChannelPlugin, r as listChannelPlugins, t as getChannelPlugin } from "./registry-DPUPp9Ly.js";
...
import { _ as resolveAgentConfig, b as resolveAgentWorkspaceDir, x as resolveDefaultAgentId, y as resolveAgentDir } from "./agent-scope-zHoqFGPE.js";
import { t as matchesSkillFilter } from "./filter-wgxIzvgY.js";
import { i as isKnownSecretTargetId } from "./target-registry-DwxRH33G.js";
import { t as parseDurationMs } from "./parse-duration-DJdfoEt9.js";
import { n as resolveNormalizedAccountEntry, t as resolveAccountEntry } from "./account-lookup-CQTybHrh.js";
import { n as isRestartEnabled } from "./commands.flags-B6cEn_y9.js";
import "./config-B3U8IbHS.js";
import { G as validateExecApprovalResolveParams, U as validateExecApprovalGetParams, W as validateExecApprovalRequestParams, _t as validateRequestFrame, an as errorShape, cn as getPreauthHandshakeTimeoutMsFromEnv, in as ErrorCodes, k as validateConnectParams, ln as buildDeviceAuthPayload, mt as validatePluginApprovalResolveParams, pt as validatePluginApprovalRequestParams, r as formatValidationErrors, un as buildDeviceAuthPayloadV3, vt as validateSecretsResolveParams, yt as validateSecretsResolveResult } from "./client-EY3zDWsr.js";
...
import { a as isOperatorUiClient, h as GATEWAY_CLIENT_MODES, m as GATEWAY_CLIENT_IDS, n as isGatewayCliClient, o as isWebchatClient, s as isDeliverableMessageChannel, t as isBrowserOperatorUiClient, u as normalizeMessageChannel } from "./message-channel-BEwkHNOF.js";
...
import { n as formatConfigIssueLines } from "./issue-format-CdRaokQJ.js";
...
import { n as resolveChannelApprovalCapability, t as resolveChannelApprovalAdapter } from "./plugins-Bk33nzKG.js";
import { o as runGlobalGatewayStopSafely } from "./hook-runner-global-CkwTKwtc.js";
import { S as createEmptyPluginRegistry, a as getActivePluginRegistry, b as resolveActivePluginHttpRouteRegistry, d as pinActivePluginChannelRegistry, f as pinActivePluginHttpRouteRegistry, h as releasePinnedPluginHttpRouteRegistry, m as releasePinnedPluginChannelRegistry, x as setActivePluginRegistry } from "./runtime-BLsgx2-v.js";
...
import { n as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-UqpPu6mu.js";
...
import { c as normalizeModelSelection, f as resolveConfiguredModelRef, m as resolveHooksGmailModel } from "./model-selection-shared-BF-DQvbf.js";
import { i as resolveAllowedModelRef, r as getModelRefStatus, t as isCliProvider } from "./model-selection-cli-Bw0bTvbN.js";
import { p as resolveThinkingDefault } from "./model-selection-CZhXg7nY.js";
import { o as resetModelCatalogCache, r as loadModelCatalog } from "./model-catalog-CcWDLdw8.js";
...
import { n as resolveMainSessionKeyFromConfig } from "./sessions-CQdlpJUR.js";
import { o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-DOSS0HMP.js";
import { t as loadSessionStore } from "./store-load-BLzdjzCX.js";
import { u as setSessionRuntimeModel } from "./types--vJusqfs.js";
import { c as updateSessionStore, l as updateSessionStoreEntry, t as archiveRemovedSessionTranscripts } from "./store-BD0Vlvaq.js";
...
import { o as startGatewayModelPricingRefresh } from "./usage-format-kE6rXplS.js";
import { n as deriveSessionTotalTokens, r as hasNonzeroUsage } from "./usage-DyIOjex2.js";
import { i as readSessionMessages, t as attachOpenClawTranscriptMeta } from "./session-utils.fs-Dn5nQNOb.js";
import { i as stripInlineDirectiveTagsForDisplay } from "./directive-tags-DU9VED8M.js";
import { a as resolveSessionTranscriptCandidates, i as cleanupArchivedSessionTranscripts } from "./session-transcript-files.fs-CjL9o5JQ.js";
import { a as loadGatewaySessionRow, f as resolveGatewaySessionStoreTarget, i as loadCombinedSessionStoreForGateway, o as loadSessionEntry } from "./session-utils-BWJpwoCp.js";
import { i as enqueueCommandInLane, s as getTotalQueueSize, u as setCommandLaneConcurrency } from "./command-queue-B2X59ob3.js";
import { c as stripLeadingSilentToken, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken } from "./tokens-2Eginc2V.js";
import { s as stripHeartbeatToken } from "./heartbeat-BqbnwaZy.js";
import { o as normalizeCronJobInput } from "./openclaw-tools-kzAwpcnp.js";
import { t as getMachineDisplayName } from "./machine-name-D4Ztk6vM.js";
import { t as detectMime } from "./mime-CeX1JZPE.js";
import { o as resolveFailoverReasonFromError } from "./failover-error-Buq9wg2B.js";
import { t as SsrFBlockedError } from "./ssrf-Bg0Ww888.js";
import { n as fetchWithSsrFGuard } from "./fetch-guard-5Cmu0jDX.js";
import { a as retireSessionMcpRuntime } from "./pi-bundle-mcp-runtime-je5uazSo.js";
import "./pi-bundle-mcp-tools-BXRqVaUz.js";
import { c as getAgentRunContext, d as sweepStaleRunContexts, l as onAgentEvent, t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-BRkCNXs1.js";
import { t as loadGatewayTlsRuntime$1 } from "./gateway-B1dZ2XrH.js";
import { T as resolveExecApprovalRequestAllowedDecisions, r as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS, w as resolveExecApprovalAllowedDecisions } from "./exec-approvals-C2hB7k4d.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-B0T7UY8N.js";
import { n as assertSafeCronSessionTargetId, r as isInvalidCronSessionTargetIdError, t as normalizeHttpWebhookUrl } from "./webhook-url-BRiFBp0U.js";
import { c as setPreRestartDeferralCheck, n as deferGatewayRestartUntilIdle, r as emitGatewayRestart, s as setGatewaySigusr1RestartPolicy } from "./restart-CKZ_MmAj.js";
import { r as cleanOldMedia } from "./store-vYYFxkgL.js";
import { a as CANVAS_HOST_PATH, c as injectCanvasLiveReload, l as normalizeUrlPath, s as handleA2uiHttpRequest, u as resolveFileWithinRoot } from "./web-media-BbckQqQN.js";
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-secret-gateway-qibxLYrz.js";
import { i as evaluateGatewayAuthSurfaceStates, r as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-web-tools-BElYu6gg.js";
import { n as resolveConfiguredDeferredChannelPluginIds, r as resolveGatewayStartupPluginIds } from "./channel-plugin-ids-8RDRFO1Q.js";
import { t as deliverOutboundPayloads } from "./deliver-B6B_mfXE.js";
import { r as resetDirectoryCache } from "./target-resolver-DlrAgEgx.js";
import { t as buildOutboundSessionContext } from "./session-context-Bq9RD39Z.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-B7mjmIZr.js";
import { n as requestHeartbeatNow } from "./heartbeat-wake-nI53QSWE.js";
import { i as enqueueSystemEvent } from "./system-events-DV5kbtQJ.js";
import { i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-4OP4n2rb.js";
import { r as getActiveEmbeddedRunCount } from "./runs-rRV0MELk.js";
import { h as stopDiagnosticHeartbeat, m as startDiagnosticHeartbeat } from "./diagnostic-4pDCeq7X.js";
import { s as initSubagentRegistry } from "./subagent-registry-CHMdomh3.js";
import { a as onSessionLifecycleEvent } from "./subagent-registry-spawn-runtime-0J-9BlTC.js";
import { t as resolveAgentTimeoutMs } from "./timeout-TgWmyBUs.js";
import { c as resolveHookExternalContentSource, o as isExternalHookSession, s as mapHookExternalContentSource } from "./external-content-BMsxhGqS.js";
import { n as resolveCronStyleNow } from "./current-time-BN3cOz0d.js";
import { o as resolvePreferredSessionKeyForSessionIdMatches } from "./live-model-switch-DGceNEoA.js";
import { t as createPluginRuntime } from "./runtime-B79fBg50.js";
import { o as getTotalPendingReplies } from "./dispatch-DE8XjaE6.js";
import { n as sanitizeInboundSystemTags } from "./inbound-text-DKU86kfn.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-CfT0dhGX.js";
import { c as formatExecApprovalExpiresIn, f as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-reply-DNPJ0YYI.js";
import { t as CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "./approval-handler-adapter-runtime-RRT8Xbt0.js";
import { n as sanitizeExecApprovalDisplayText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-6-Gq8g38.js";
import { n as createChannelApprovalHandlerFromCapability } from "./approval-handler-runtime-jAWs9oKw.js";
import { i as watchChannelRuntimeContexts, n as getChannelRuntimeContext, t as createTaskScopedChannelRuntime } from "./channel-runtime-context-Co1tk90G.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-Bho7G64B.js";
import { n as resolveCronStorePath, r as saveCronStore, t as loadCronStore } from "./store-CWMFIAuz.js";
import { r as registerSkillsChangeListener } from "./refresh-state-CD-lrAuh.js";
import "./refresh-B4iJy6OU.js";
import { c as roleScopesAllow } from "./pairing-token-Dy6CZOOk.js";
import { a as refreshRemoteBinsForConnectedNodes, c as setSkillsRemoteRegistry, h as updatePairedNodeMetadata, i as recordRemoteNodeInfo, m as requestNodePairing, n as primeRemoteSkillsCache, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo, u as getPairedNode } from "./skills-remote-BfvYckfh.js";
import { i as onHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-Bqihl9je.js";
import { n as resolveAgentOutboundIdentity } from "./identity-DkN-K9O1.js";
import { i as resolveNodeCommandAllowlist, r as normalizeDeclaredNodeCommands } from "./node-command-policy-Cg_pxeno.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs, t as formatForLog } from "./ws-log-CEgRJndl.js";
import { i as safeParseJson } from "./nodes.helpers-C9P2AAZ2.js";
import { i as assertGatewayAuthNotKnownWeak, n as mergeGatewayAuthConfig, r as mergeGatewayTailscaleConfig, t as ensureGatewayStartupAuth } from "./startup-auth-BFjUcYHa.js";
import { r as resolveBootstrapProfileScopesForRole } from "./device-bootstrap-profile-D-dLE14W.js";
import { _ as updatePairedDeviceMetadata, a as getPairedDevice, c as listApprovedPairedDeviceRoles, l as listDevicePairing, n as approveDevicePairing, p as requestDevicePairing, r as ensureDeviceToken, s as hasEffectivePairedDeviceRole, t as approveBootstrapDevicePairing, u as listEffectivePairedDeviceRoles, v as verifyDeviceToken } from "./device-pairing-CY15RWsZ.js";
import { a as redeemDeviceBootstrapTokenProfile, n as getBoundDeviceBootstrapProfile, o as revokeDeviceBootstrapToken, r as getDeviceBootstrapTokenProfile, s as verifyDeviceBootstrapToken } from "./device-bootstrap-L9sLNOYE.js";
import { t as createDefaultDeps } from "./deps-BkoaWDDj.js";
import { i as buildSystemRunApprovalEnvBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-CS5I-iy5.js";
import { n as resolveSystemRunApprovalRequestContext } from "./system-run-approval-context-D-pl7QyC.js";
import { t as closeMcpLoopbackServer } from "./mcp-http-DSj_JfLy.js";
import { A as getHookSessionKeyPrefixError, B as resolveHookIdempotencyKey, C as setDefaultSecurityHeaders, D as extractHookToken, F as normalizeHookHeaders, H as resolveHookTargetAgentId, I as normalizeWakePayload, K as logRejectedLargePayload, L as readJsonBody, M as isSessionKeyAllowedByPrefix, N as normalizeAgentPayload, O as getHookAgentPolicyError, P as normalizeHookDispatchSessionKey, R as resolveHookChannel, U as resolveHooksConfig, V as resolveHookSessionKey, W as applyHookMappings, _ as loadGatewayModelCatalog, d as resolveHttpBrowserOriginPolicy, g as __resetModelCatalogCacheForTest, h as resolveTrustedHttpOperatorScopes, j as isHookAgentAllowed, k as getHookChannelError, o as getBearerToken, r as authorizeGatewayHttpRequestOrReply, s as getHeader, y as sendGatewayAuthFailure, z as resolveHookDeliver } from "./http-utils-DIGlw93G.js";
import { t as createOutboundSendDeps } from "./outbound-send-deps-CyJRwbWH.js";
import { C as TICK_INTERVAL_MS, S as MAX_PREAUTH_PAYLOAD_BYTES, _ as DEDUPE_MAX, b as MAX_BUFFERED_BYTES, f as isSuppressedControlReplyLeadFragment, m as abortChatRunById, p as isSuppressedControlReplyText, v as DEDUPE_TTL_MS, x as MAX_PAYLOAD_BYTES, y as HEALTH_REFRESH_INTERVAL_MS } from "./chat-BnhbxzAW.js";
import { t as cleanupBrowserSessionsForLifecycleEnd } from "./browser-lifecycle-cleanup-CaXw10Xj.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-B1YZbm7d.js";
import { a as writeWideAreaGatewayZone, i as resolveWideAreaDiscoveryDomain } from "./widearea-dns-BZbr-q6A.js";
import { a as resolveControlUiRootOverrideSync, n as isPackageProvenControlUiRootSync, o as resolveControlUiRootSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DUV04Bhb.js";
import { t as GatewayLockError } from "./gateway-lock-CdWDhpcr.js";
import { t as getHealthSnapshot } from "./health-De790w6R.js";
import { t as runSetupWizard } from "./setup-pif420sj.js";
import { d as startTaskRegistryMaintenance, f as stopTaskRegistryMaintenance, g as markCronJobActive, h as clearCronJobActive, n as getInspectableTaskRegistrySummary } from "./task-registry.maintenance-B7ehbncm.js";
import { i as migrateOrphanedSessionKeys } from "./state-migrations-Dv32nf5q.js";
import { _ as resolveDeliveryTarget, a as computeJobPreviousRunAtMs, c as findJobOrThrow, d as isJobEnabled, f as nextWakeAtMs, g as resolveJobPayloadTextForMain, h as recordScheduleComputeError, i as computeJobNextRunAtMs, l as hasScheduledNextRunAtMs, m as recomputeNextRunsForMaintenance, n as applyJobPatch, o as createJob, p as recomputeNextRuns, r as assertSupportedJobSpec, s as errorBackoffMs, t as DEFAULT_ERROR_BACKOFF_SCHEDULE_MS, u as isJobDue } from "./jobs-vOLJkyR-.js";
import { t as createCronExecutionId } from "./run-id-aZvuZFx1.js";
import { a as resolveHeartbeatAckMaxChars$1, i as resolveCronPayloadOutcome, t as isHeartbeatOnlyResponse } from "./helpers-juV16cB-.js";
import { a as resolveCronChannelOutputPolicy, n as markCronSessionPreRun, r as persistCronSkillsSnapshotIfChanged, t as createPersistCronSessionEntry } from "./run-session-state-Bb774c3C.js";
import { t as runChannelPluginStartupMaintenance } from "./lifecycle-startup-DhQT9Do5.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-CVHPDKGW.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-CkRQAirD.js";
import { C as resolveGatewayReloadSettings, D as roleCanSkipDeviceIdentity, E as parseGatewayRole, O as pruneStaleControlPlaneBuckets, S as diffConfigPaths, T as buildGatewayReloadPlan, _ as appendCronRunLog, a as coreGatewayHandlers, b as resolveCronDeliveryPlan, c as listSystemPresence, d as CANVAS_CAPABILITY_TTL_MS, f as buildCanvasScopedHostUrl, g as loadVoiceWakeConfig, h as formatError, i as setFallbackGatewayContextResolver, l as upsertPresence, m as normalizeCanvasScopedUrl, o as handleGatewayRequest, p as mintCanvasCapabilityToken, s as broadcastPresenceSnapshot, t as loadGatewayStartupPlugins, u as clearNodeWakeState, v as resolveCronRunLogPath, w as startGatewayConfigReloader, x as resolveFailureDestination, y as resolveCronRunLogPruneOptions } from "./server-plugin-bootstrap-DXgQwQyY.js";
import { i as resolveCronSession, n as runHeartbeatOnce, r as startHeartbeatRunner } from "./heartbeat-runner-BcwyIv7S.js";
import { n as stopGmailWatcher, t as startGmailWatcherWithLogs } from "./gmail-watcher-lifecycle-giFbH3c8.js";
import "./paths-REl0xQDw.js";
import { t as getUpdateAvailable } from "./update-startup-CybqQ2nO.js";
import { t as hasConfiguredInternalHooks } from "./configured-mJPBVdPZ.js";
...
function loadExecApprovalForwarderRuntime() {
	execApprovalForwarderRuntimePromise ??= import("./exec-approval-forwarder.runtime-2ylGOzNe.js");
...
async function loadSkillsSnapshotRuntime() {
	skillsSnapshotRuntimePromise ??= import("./skills-snapshot.runtime-DyoBal8d.js");
...
async function loadCliRunnerRuntime() {
	return await import("./cli-runner.runtime-DMGBfrzq.js");
}
async function loadUsageFormatRuntime() {
	return await import("./usage-format-DNqaa1LL.js");
}
...
function recoverPendingOutboundDeliveries(params) {
	(async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-BMHOSwkI.js");
		const { deliverOutboundPayloads } = await import("./deliver-DgqaaN9R.js");
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-B2EgtStg.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-CquZxsmI.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-DbAnlnuR.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-C-bKlGGB.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-YpAOwinl.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-oYWkka3v.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-CE51tYm7.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-B1nZppcj.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-CagS4Ys0.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-BkCvOWVW.js");
	return toolsInvokeHttpModulePromise;
}
function getVoiceClawRealtimeUpgradeModule() {
	voiceClawRealtimeUpgradeModulePromise ??= import("./upgrade-DV49GeIQ.js");
...
async function hasGatewayStartupInternalHookListeners() {
	const { hasInternalHookListeners } = await import("./internal-hooks-CV1LUNPd.js");
...
async function prewarmConfiguredPrimaryModel(params) {
	...
	const [{ resolveOpenClawAgentDir }, { DEFAULT_MODEL, DEFAULT_PROVIDER }, { selectAgentHarness }, { isCliProvider, resolveConfiguredModelRef }, { ensureOpenClawModelsJson }, { resolveModel, resolveModelAsync }, { resolveEmbeddedAgentRuntime }] = await Promise.all([
		import("./agent-paths-vdccT8CL.js"),
		import("./defaults-Bg4-Ke4I.js"),
		import("./selection-BoPFOcED.js"),
		import("./model-selection-BAXr95BR.js"),
		import("./models-config-DBpAZiYW.js"),
		import("./model-DBrPnsor.js"),
		import("./runtime-C0_7snuf.js")
	]);
...
async function startGatewaySidecars(params) {
	await measureStartup(params.startupTrace, "sidecars.session-locks", async () => {
		try {
			const [{ resolveStateDir }, { resolveAgentSessionDirs }, { cleanStaleLockFiles }] = await Promise.all([
				...
				import("./session-write-lock-90cXBOh-.js")
			]);
	...
	await measureStartup(params.startupTrace, "sidecars.gmail-watch", async () => {
		if (params.cfg.hooks?.enabled && params.cfg.hooks.gmail?.account) {
			const { startGmailWatcherWithLogs } = await import("./gmail-watcher-lifecycle-D_yR0SiS.js");
			await startGmailWatcherWithLogs({
				cfg: params.cfg,
				log: params.logHooks
			});
	...
	await measureStartup(params.startupTrace, "sidecars.gmail-model", async () => {
		if (params.cfg.hooks?.gmail?.model) {
			const [{ DEFAULT_MODEL, DEFAULT_PROVIDER }, { loadModelCatalog }, { getModelRefStatus, resolveConfiguredModelRef, resolveHooksGmailModel }] = await Promise.all([
				import("./defaults-Bg4-Ke4I.js"),
				import("./model-catalog-CV2Fb7yC.js"),
				import("./model-selection-BAXr95BR.js")
			]);
	...
	await measureStartup(params.startupTrace, "sidecars.internal-hooks", async () => {
		try {
			if (internalHooksConfigured) {
				const [{ setInternalHooksEnabled }, { loadInternalHooks }] = await Promise.all([import("./internal-hooks-CV1LUNPd.js"), import("./loader-sY4J6117.js")]);
	...
	if (internalHooksConfigured || await hasGatewayStartupInternalHookListeners()) setTimeout(() => {
		import("./internal-hooks-CV1LUNPd.js").then(({ createInternalHookEvent, triggerInternalHook }) => {
	...
	await measureStartup(params.startupTrace, "sidecars.plugin-services", async () => {
		try {
			const { startPluginServices } = await import("./services-CjPlxOdw.js");
	...
	if (params.cfg.acp?.enabled) {
		const [{ getAcpSessionManager }, { ACP_SESSION_IDENTITY_RENDERER_VERSION }] = await Promise.all([import("./manager-CUaO_MfR.js"), import("./session-identifiers-Cr9Bu5xE.js")]);
	...
	await measureStartup(params.startupTrace, "sidecars.memory", async () => {
		...
		setImmediate(() => {
			import("./server-startup-memory-D02DfG-Z.js").then(({ startGatewayMemoryBackend }) => startGatewayMemoryBackend({
				cfg: params.cfg,
				log: params.log
			})).catch((err) => {
	...
	await measureStartup(params.startupTrace, "sidecars.restart-sentinel", async () => {
		...
		const { hasRestartSentinel } = await import("./restart-sentinel-50RjdDaj.js");
		if (!await hasRestartSentinel()) return;
		setTimeout(() => {
			import("./server-restart-sentinel-I1GwMc3E.js").then(({ scheduleRestartSentinelWake }) => scheduleRestartSentinelWake({ deps: params.deps })).catch((err) => {
	...
	await measureStartup(params.startupTrace, "sidecars.subagent-recovery", async () => {
		const { scheduleSubagentOrphanRecovery } = await import("./subagent-registry-Clv6DwQS.js");
		scheduleSubagentOrphanRecovery();
	});
	return { pluginServices };
}
const defaultGatewayPostAttachRuntimeDeps = {
	getGlobalHookRunner: async () => (await import("./hook-runner-global-CunX-XX4.js")).getGlobalHookRunner(),
	logGatewayStartup: async (params) => (await import("./server-startup-log-Ci9YhbuR.js")).logGatewayStartup(params),
	scheduleGatewayUpdateCheck: async (...args) => (await import("./update-startup-DnC2C33V.js")).scheduleGatewayUpdateCheck(...args),
	startGatewaySidecars,
	startGatewayTailscaleExposure: async (...args) => (await import("./server-tailscale-DoDHpX9x.js")).startGatewayTailscaleExposure(...args)
};
	...
	try {
		...
		if (!minimalTestGateway) {
			if (deferredConfiguredChannelPluginIds.length > 0) {
				const { reloadDeferredGatewayPlugins } = await import("./server-plugin-bootstrap-Cfj2uAHo.js");
