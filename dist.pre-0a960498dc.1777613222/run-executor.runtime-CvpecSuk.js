...
import { u as resolveEffectiveModelFallbacks } from "./agent-scope-zHoqFGPE.js";
...
import { o as resolveSessionTranscriptPath } from "./paths-DOSS0HMP.js";
import { o as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-CWSpa_GU.js";
import { u as registerAgentRunContext } from "./agent-events-BRkCNXs1.js";
import { i as LiveSessionModelSwitchError, r as runWithModelFallback } from "./model-fallback-BDqX_3RA.js";
import { i as resolveCronPayloadOutcome } from "./helpers-juV16cB-.js";
import { n as isLikelyInterimCronMessage } from "./subagent-followup-hints-C7eYWbwE.js";
import { a as resolveCronChannelOutputPolicy, i as syncCronSessionLiveSelection, o as resolveCurrentChannelTarget } from "./run-session-state-Bb774c3C.js";
...
async function loadCronExecutionCliRuntime() {
	cronExecutionCliRuntimePromise ??= import("./run-execution-cli.runtime-SjRRPgDQ.js");
...
async function loadCronEmbeddedRuntime() {
	cronEmbeddedRuntimePromise ??= import("./run-embedded.runtime-Df95Jhs3.js");
	return await cronEmbeddedRuntimePromise;
}
async function loadCronSubagentRegistryRuntime() {
	cronSubagentRegistryRuntimePromise ??= import("./run-subagent-registry.runtime-CRPmfMKm.js");
