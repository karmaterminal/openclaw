...
import { r as ensureAuthProfileStoreForLocalUpdate } from "./store-B63eWvc7.js";
import { a as normalizeModelCompat } from "./provider-model-compat-DK8OdTEu.js";
import { n as listProfilesForProvider } from "./profile-list-CT3GwYKf.js";
import { c as cloneFirstTemplateModel, l as matchesExactOrPrefix } from "./provider-model-shared-DvpYy-ov.js";
...
import { r as loginOpenAICodexOAuth } from "./provider-auth-login-DjZfJfmo.js";
import { o as findCatalogTemplate } from "./provider-catalog-shared-Bx8RNEld.js";
import { i as fetchCodexUsage } from "./provider-usage-Bh-NBNMv.js";
import { t as OPENAI_CODEX_DEFAULT_MODEL } from "./default-models--Hh5mwT1.js";
import { n as isOpenAICodexBaseUrl, t as isOpenAIApiBaseUrl } from "./base-url-tcBMvvCP.js";
import { n as buildOpenAIResponsesProviderHooks, r as buildOpenAISyntheticCatalogEntry } from "./shared-CKSxPEbN.js";
import { a as OPENAI_CODEX_LOGIN_LABEL, i as OPENAI_CODEX_LOGIN_HINT, n as OPENAI_CODEX_DEVICE_PAIRING_HINT, o as OPENAI_WIZARD_GROUP, r as OPENAI_CODEX_DEVICE_PAIRING_LABEL } from "./auth-choice-copy-H1FAkl0_.js";
import { r as resolveCodexAuthIdentity } from "./openai-codex-auth-identity-DDW-z1s3.js";
import { n as buildOpenAICodexProvider } from "./openai-codex-catalog-BxVrjs9i.js";
import { t as loginOpenAICodexDeviceCode } from "./openai-codex-device-code-eWWExGpI.js";
...
const OPENAI_CODEX_GPT_55_NATIVE_CONTEXT_TOKENS = 1e6;
...
function resolveCodexForwardCompatModel(ctx) {
	...
	if (lower === OPENAI_CODEX_GPT_55_MODEL_ID) return ctx.modelRegistry.find(PROVIDER_ID, trimmedModelId) ?? normalizeModelCompat({
		id: trimmedModelId,
		name: trimmedModelId,
