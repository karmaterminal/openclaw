...
import { h as MarkdownConfigSchema, l as GroupPolicySchema, o as DmPolicySchema } from "./zod-schema.core-FcJGI_qL.js";
import { n as buildCatchallMultiAccountChannelSchema, r as buildChannelConfigSchema, t as AllowFromListSchema } from "./config-schema-OPypi1r3.js";
import { t as DEFAULT_ACCOUNT_ID } from "./account-id-C3j_3_su.js";
import { b as sendPayloadWithChunkedTextAndMedia, l as isNumericTargetId } from "./reply-payload-BHlpKYDP.js";
import { i as createLazyRuntimeNamedExport, r as createLazyRuntimeModule } from "./lazy-runtime-CJ_4WY79.js";
import { g as readStringParam, l as jsonResult } from "./common-B-ADznUd.js";
import { l as createScopedDmSecurityResolver, m as mapAllowFromEntries, s as createScopedChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-YfAsHuaY.js";
import "./text-runtime-BK-9rIrb.js";
import { r as describeWebhookAccountSnapshot } from "./account-helpers-Dc5rCzoi.js";
import { n as createStaticReplyToModeResolver } from "./threading-helpers-BGvjaxpR.js";
import { d as stripTargetKindPrefix, i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-C1EU-l7z.js";
...
import { S as createOpenProviderGroupPolicyWarningCollector, o as buildOpenGroupPolicyRestrictSendersWarning, s as buildOpenGroupPolicyWarning } from "./channel-policy-bYI4GGC4.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-C5ZGiVlt.js";
import { p as listResolvedDirectoryUserEntriesFromAllowFrom } from "./directory-config-helpers-DKJBxo_z.js";
import { d as createDefaultChannelRuntimeState, o as buildTokenChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-C2uknUoo.js";
...
import { a as coerceStatusIssueAccountId, d as readStatusIssueFields } from "./extension-shared-CIJ9YE6k.js";
import "./channel-actions-BX2bVJ9w.js";
import { a as createEmptyChannelResult, o as createRawChannelSendResultAdapter } from "./channel-send-result-C3Bidvxg.js";
import "./channel-status-Df3aTcDN.js";
import { t as zod_exports } from "./zod-CkvcfOBZ.js";
import { i as resolveZaloAccount, n as listZaloAccountIds, r as resolveDefaultZaloAccountId, t as listEnabledZaloAccounts } from "./accounts-DPaUAhPb.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-Dha_J0cC.js";
import { r as zaloSetupAdapter, t as createZaloSetupWizardProxy } from "./setup-core-BVufZ2mg.js";
//#region extensions/zalo/src/actions.ts
const loadZaloActionsRuntime = createLazyRuntimeNamedExport(() => import("./actions.runtime-LuUo0NDO.js"), "zaloActionsRuntime");
...
const loadZaloChannelRuntime = createLazyRuntimeModule(() => import("./channel.runtime-CJmmdCbJ.js"));
const zaloSetupWizard = createZaloSetupWizardProxy(async () => (await import("./setup-surface-BGt-nKx9.js")).zaloSetupWizard);
