...
import { h as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-HGX0xk55.js";
import { n as formatConfigIssueLines } from "./issue-format-CdRaokQJ.js";
import { t as note } from "./note-CSFP_p8c.js";
import { n as noteIncludeConfinementWarning } from "./doctor-config-analysis-DQOSJaP7.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-nTV8H_JL.js");
