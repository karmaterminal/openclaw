...
import { i as hasConfiguredChannelsForReadOnlyScope } from "./channel-plugin-ids-8RDRFO1Q.js";
import { t as createEmptyTaskRegistrySummary } from "./task-registry.summary-DrjT1cex.js";
import { n as createEmptyTaskAuditSummary } from "./task-registry.audit.shared-DPjF4m2O.js";
import { t as pickGatewaySelfPresence } from "./gateway-presence-Bd_ItPk7.js";
import { t as resolveGatewayProbeTarget } from "./probe-target-Mu2iGo9c.js";
...
function loadGatewayProbeModule() {
	gatewayProbeModulePromise ??= import("./status.gateway-probe-CLkvAlKC.js");
	return gatewayProbeModulePromise;
}
function loadProbeGatewayModule() {
	probeGatewayModulePromise ??= import("./probe-D6W8aLHP.js");
...
function loadStatusScanDepsRuntimeModule() {
	statusScanDepsRuntimeModulePromise ??= import("./status.scan.deps.runtime-BZ07Oh4q.js");
	return statusScanDepsRuntimeModulePromise;
}
function loadStatusAgentLocalModule() {
	statusAgentLocalModulePromise ??= import("./status.agent-local-DN5eX6Qq.js");
	return statusAgentLocalModulePromise;
}
function loadStatusUpdateModule() {
	statusUpdateModulePromise ??= import("./status.update-Bu4J6DFs.js");
	return statusUpdateModulePromise;
}
function loadStatusScanRuntimeModule() {
	statusScanRuntimeModulePromise ??= import("./status.scan.runtime-BFPtBjel.js");
	return statusScanRuntimeModulePromise;
}
function loadGatewayCallModule() {
	gatewayCallModulePromise ??= import("./call-DAjlRDuo.js");
	return gatewayCallModulePromise;
}
function loadStatusSummaryModule() {
	statusSummaryModulePromise ??= import("./status.summary-VW7QRHwC.js");
	return statusSummaryModulePromise;
}
function loadConfigModule() {
	configModulePromise ??= import("./config-B4IihvwY.js");
	return configModulePromise;
}
function loadCommandConfigResolutionModule() {
	commandConfigResolutionModulePromise ??= import("./command-config-resolution-zkyzl_b4.js");
	return commandConfigResolutionModulePromise;
}
function loadCommandSecretTargetsModule() {
	commandSecretTargetsModulePromise ??= import("./command-secret-targets-CTbDq6nf.js");
