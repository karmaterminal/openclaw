...
import { t as loadPluginManifestRegistry } from "./manifest-registry-B3DZmlKC.js";
import { J as normalizeGoogleApiBaseUrl } from "./io-HGX0xk55.js";
...
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-DYFxxI8I.js";
import { f as isWorkspaceBootstrapPending, r as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-ibYRWzQC.js";
import { h as listAgentEntries, m as resolveSessionAgentIds } from "./agent-scope-zHoqFGPE.js";
import { u as normalizeMessageChannel } from "./message-channel-BEwkHNOF.js";
import { i as createStreamIteratorWrapper, r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-Bf3Wc1GL.js";
import { u as listRegisteredAgentHarnesses } from "./loader-Dbq7I8n7.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-CkwTKwtc.js";
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-BLsgx2-v.js";
import { F as resolveProviderSystemPromptContribution, I as resolveProviderTextTransforms, q as transformProviderSystemPrompt } from "./provider-runtime-B5tHTXWf.js";
...
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-DK8OdTEu.js";
import { n as acquireSessionWriteLock, o as resolveSessionLockMaxHoldFromTimeout } from "./session-write-lock-DR9N7yGa.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-Dh-Zgvbs.js";
import { a as normalizeUsage, i as makeZeroUsageSnapshot, r as hasNonzeroUsage } from "./usage-DyIOjex2.js";
import { o as parseAssistantTextSignature, s as resolveAssistantMessagePhase } from "./chat-message-content-DAezUt6n.js";
import { t as parseInlineDirectives } from "./directive-tags-DU9VED8M.js";
import { n as resolveEmbeddedAgentHarnessFallback, r as resolveEmbeddedAgentRuntime, t as normalizeEmbeddedAgentRuntime } from "./runtime-B484LEF1.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, o as startsWithSilentToken, r as isSilentReplyPayloadText } from "./tokens-2Eginc2V.js";
import { t as filterHeartbeatPairs } from "./heartbeat-filter-CSaqCvm-.js";
import { $ as createBundleLspToolRuntime, B as sanitizeToolUseResultPairing, C as limitHistoryTurns, E as estimateMessagesTokens, F as isCacheTtlEligibleProvider, H as estimateToolResultReductionPotential, I as readLastCacheTtlTimestamp, J as installToolResultContextGuard, K as truncateOversizedToolResultsInSessionManager, L as resolveTranscriptPolicy, M as applyFinalEffectiveToolPolicy, P as resolveCompactionTimeoutMs, Q as dropThinkingBlocks, R as shouldAllowProviderOwnedThinkingReplay, S as getDmHistoryLimitFromSessionKey, T as SAFETY_MARGIN, U as resolveLiveToolResultMaxChars, X as createPreparedEmbeddedPiSettingsManager, Y as repairSessionFileIfNeeded, Z as assessLastAssistantMessage, _ as trackSessionManagerAccess, a as collectAllowedToolNames, b as validateReplayTurns, c as applySystemPromptOverrideToSession, d as describeEmbeddedAgentStreamStrategy, et as releaseWsSession, f as resolveEmbeddedAgentApiKey, g as prewarmSessionFile, h as resolveEmbeddedRunSkillEntries, i as PI_RESERVED_TOOL_NAMES, it as resolveChannelCapabilities, l as buildEmbeddedSystemPrompt, m as resolveEmbeddedAgentStreamFn, n as mapThinkingLevel, o as collectRegisteredToolNames, p as resolveEmbeddedAgentBaseStreamFn, q as installContextEngineLoopHook, r as splitSdkTools, rt as isReasoningTagProvider, s as toSessionToolAllowlist, t as flushPendingToolResultsAfterIdle, tt as buildStreamErrorAssistantMessage, u as createSystemPromptOverride, v as normalizeAssistantReplayContent, w as buildEmbeddedExtensionFactories, x as buildEmbeddedMessageActionDiscoveryInput, y as sanitizeSessionHistory, z as guardSessionManager } from "./wait-for-idle-before-flush-DV1kMVgL.js";
import { b as isEmbeddedMode, v as isStrictAgenticSupportedProviderModel, y as stripProviderPrefix } from "./openclaw-tools-kzAwpcnp.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-BtMTWWUE.js";
import { t as getMachineDisplayName } from "./machine-name-D4Ztk6vM.js";
import { f as MAX_IMAGE_BYTES } from "./mime-CeX1JZPE.js";
import { p as normalizeToolName } from "./tool-policy-BEJUsLxm.js";
import { n as getPluginToolMeta } from "./tools-Cf6EfoW-.js";
import { t as redactConfigObject } from "./redact-snapshot-BRaC7Mly.js";
import { n as resolveCommitHash } from "./git-commit-ub3lqNmf.js";
import { t as resolveOsSummary } from "./os-summary-DeIU7aTI.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-23Q3Zswq.js";
import { n as estimateBase64DecodedBytes } from "./base64-C8GI4p-v.js";
import { t as parseBooleanValue } from "./boolean-Dj-H44-B.js";
import { n as buildTtsSystemPromptHint } from "./tts-CepJD85f.js";
import { a as prependBootstrapPromptWarning, i as buildBootstrapTruncationReportMeta, n as buildBootstrapInjectionStats, r as buildBootstrapPromptWarning, t as analyzeBootstrapBudget } from "./bootstrap-budget-CWSpa_GU.js";
import { a as resolveContextInjectionMode, i as resolveBootstrapContextForRun, n as hasCompletedBootstrapTurn, r as makeBootstrapWarn, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-I8--yfzF.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-DwM1rX9F.js";
...
import { T as parseExecApprovalResultText, d as stableStringify$1, f as coerceChatContentText } from "./sanitize-user-facing-text-ByUPtx4k.js";
import { a as formatAssistantErrorText, c as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-MpyiTt6j.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-CiIhWcfX.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-D2JNL9xJ.js";
import { a as listChannelSupportedActions, c as resolveChannelReactionGuidance, o as resolveChannelMessageToolCapabilities, s as resolveChannelMessageToolHints } from "./channel-tools-C-5d8QZ3.js";
import { t as resolveOpenClawDocsPath } from "./docs-path-Bby3UXgt.js";
import { a as isTimeoutError } from "./failover-error-Buq9wg2B.js";
import { t as buildModelAliasLines } from "./model-alias-lines-C7ZjhW2O.js";
import { t as sanitizeForConsole } from "./console-sanitize-b0XfAOpY.js";
import { c as resolveModelAuthMode } from "./model-auth-z9q2AAmi.js";
import { a as supportsModelTools, n as normalizeProviderToolSchemas, t as logProviderToolSchemaDiagnostics } from "./tool-schema-runtime-Cd1hNlJv.js";
import { t as registerProviderStreamForModel } from "./provider-stream-ClOXfQfb.js";
import { t as log$3 } from "./logger-B8TPD8B9.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-Duphh8m6.js";
import { i as ensureGlobalUndiciStreamTimeouts, r as ensureGlobalUndiciEnvProxyDispatcher, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-DKeDDYkU.js";
import { c as sanitizeTransportPayloadText, o as mergeTransportHeaders, u as buildGuardedModelFetch } from "./transport-stream-shared-58yrRqt_.js";
import { r as getOrCreateSessionMcpRuntime } from "./pi-bundle-mcp-runtime-je5uazSo.js";
import { n as materializeBundleMcpToolsForRun } from "./pi-bundle-mcp-tools-BXRqVaUz.js";
import { n as setReplyPayloadMetadata } from "./reply-payload-h6n18JT-.js";
import { r as parseFenceSpans } from "./fences-CD1aGcRU.js";
import { r as splitMediaFromOutput } from "./parse-CIRCk3mD.js";
import { u as parseReplyDirectives } from "./payloads-DEM757dI.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-BHlpKYDP.js";
import { _ as sanitizeToolResult, b as formatToolAggregate, d as extractToolErrorMessage, f as extractToolResultMediaArtifact, g as isToolResultTimedOut, h as isToolResultError, l as runContextEngineMaintenance, m as filterToolResultMediaUrls, n as assembleHarnessContextEngine, o as finalizeHarnessContextEngineTurn, p as extractToolResultText, r as bootstrapHarnessContextEngine, t as buildEmbeddedAttemptToolRunContext, u as extractMessagingToolSend, v as isMessagingTool, y as isMessagingToolSendAction } from "./attempt.tool-run-context-Cxn8qnwY.js";
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent } from "./agent-events-BRkCNXs1.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-DX0PXjZZ.js";
import { o as buildApiErrorObservationFields, s as buildTextObservationFields } from "./model-fallback-BDqX_3RA.js";
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-Dtr04Ban.js";
import { a as stripDowngradedToolCallText } from "./assistant-visible-text-Bln76yKO.js";
...
import { a as MIN_PROMPT_BUDGET_TOKENS, i as MIN_PROMPT_BUDGET_RATIO, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-LiH5nVXf.js";
import { o as diagnosticErrorCategory } from "./pi-tools.before-tool-call-CjZet1Y1.js";
import { i as toClientToolDefinitions, n as findClientToolNameConflicts, t as createClientToolNameConflictError } from "./pi-tool-definition-adapter-RaW7i1vZ.js";
import { n as resolveToolLoopDetectionConfig, t as createOpenClawCodingTools } from "./pi-tools-BkRKs_ud.js";
...
import { l as setActiveEmbeddedRun, n as clearActiveEmbeddedRun, u as updateActiveEmbeddedRunSnapshot } from "./runs-rRV0MELk.js";
import { t as resolveAgentTimeoutMs } from "./timeout-TgWmyBUs.js";
import { o as resolveSandboxContext } from "./sandbox-D2A6r4WD.js";
import { n as rewriteTranscriptEntriesInSessionManager } from "./transcript-rewrite-D6wbXODT.js";
import { t as detectRuntimeShell } from "./shell-utils-Buy8Lg5U.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-DfBsFUbF.js";
import { s as resolveSkillsPromptForRun } from "./workspace-Bp0Wh6HY.js";
import "./skills-QMfq-SDp.js";
import { t as resolveSystemPromptOverride } from "./system-prompt-override-CRSchAxm.js";
import { t as buildSystemPromptParams } from "./system-prompt-params-Y02acYTd.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-CJeQBduY.js";
import "./tool-loop-detection-CPc-0Sfn.js";
import { b as visitObjectContentBlocks, i as createHtmlEntityToolCallArgumentDecodingWrapper } from "./provider-stream-shared-CGhK5p6V.js";
import { n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-DKKg-Eo5.js";
import { n as buildAgentUserPromptPrefix } from "./system-prompt-DvJmBOLL.js";
...
import { a as shouldUseOpenAIWebSocketTransport, i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-DUOFwmAA.js";
...
import { n as extractBalancedJsonPrefix } from "./balanced-json-Cv1bTLF7.js";
import { t as detectAndLoadPromptImages } from "./images-C1oIhvEc.js";
...
function hasCommittedUserVisibleToolDelivery(attempt) {
	return attempt.didSendViaMessagingTool || hasStringEntry(attempt.messagingToolSentTexts) || hasStringEntry(attempt.messagingToolSentMediaUrls);
}
...
function resolveIncompleteTurnPayloadText(params) {
	...
	if (hasCommittedUserVisibleToolDelivery(params.attempt) && stopReason !== "error" && !incompleteTerminalAssistant) return null;
...
async function reconcileSessionStoreCompactionCountAfterSuccess(params) {
	const { reconcileSessionStoreCompactionCountAfterSuccess: reconcile } = await import("./pi-embedded-subscribe.handlers.compaction.runtime-D1BxwlXM.js");
...
function loadExecApprovalReply() {
	execApprovalReplyModulePromise ??= import("./exec-approval-reply-COy9T1lW.js");
	return execApprovalReplyModulePromise;
}
function loadHookRunnerGlobal() {
	hookRunnerGlobalModulePromise ??= import("./hook-runner-global-CunX-XX4.js");
	return hookRunnerGlobalModulePromise;
}
function loadMediaParse() {
	mediaParseModulePromise ??= import("./parse-B7OVWhuK.js");
	return mediaParseModulePromise;
}
function loadBeforeToolCall() {
	beforeToolCallModulePromise ??= import("./pi-tools.before-tool-call-BbO98HxC.js");
