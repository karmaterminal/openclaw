...
import { t as registerPendingSpawnedChildrenQuery } from "./pending-spawn-query-CXEQ-ehI.js";
import { i as failTaskRunByRunId, o as setDetachedTaskDeliveryStatusByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-4OP4n2rb.js";
import { d as importRuntimeModule, u as withSubagentOutcomeTiming } from "./subagent-announce-output-DIidB__j.js";
import { r as waitForAgentRun } from "./run-wait-DJJfmks9.js";
import { i as emitSessionLifecycleEvent, t as configureSubagentRegistrySpawnRuntime } from "./subagent-registry-spawn-runtime-0J-9BlTC.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-BNQF9sCV.js";
...
async function loadCleanupBrowserSessionsForLifecycleEnd$1() {
	browserCleanupPromise$1 ??= import("./browser-lifecycle-cleanup-B-eQIoD-.js");
...
async function loadSubagentAnnounceModule() {
	subagentAnnouncePromise ??= import("./subagent-announce-nB7mPyXg.js");
	return await subagentAnnouncePromise;
}
async function loadCleanupBrowserSessionsForLifecycleEnd() {
	browserCleanupPromise ??= import("./browser-lifecycle-cleanup-B-eQIoD-.js");
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-Wkh_nolv.js").then(({ scheduleOrphanRecovery }) => {
