...
export declare function hasCommittedUserVisibleToolDelivery(attempt: Pick<EmbeddedRunAttemptResult, "didSendViaMessagingTool" | "messagingToolSentTexts" | "messagingToolSentMediaUrls">): boolean;
