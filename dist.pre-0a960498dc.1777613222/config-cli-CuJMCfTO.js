...
import { a as coerceSecretRef, c as isValidEnvSecretRefId, p as resolveSecretInputRef } from "./types.secrets-D9j6Z-gp.js";
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-CmDf3_tu.js";
import { n as info, o as success, t as danger } from "./globals-BMZFdRyi.js";
import { a as resolveSecretRefValue } from "./resolve-D3pGwFuc.js";
import { w as SecretProviderSchema } from "./zod-schema.core-FcJGI_qL.js";
import { C as validateConfigObjectRaw, u as readConfigFileSnapshot, x as collectUnsupportedSecretRefPolicyIssues } from "./io-HGX0xk55.js";
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-DwxRH33G.js";
import { r as replaceConfigFile } from "./mutate-iJdsrGph.js";
import "./config-B3U8IbHS.js";
import { a as normalizeConfigIssues, n as formatConfigIssueLines } from "./issue-format-CdRaokQJ.js";
import { t as redactConfigObject } from "./redact-snapshot-BRaC7Mly.js";
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-C9IzfdA3.js";
import { n as setCommandJsonMode } from "./json-mode-DBXAYcXO.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-eRqiZmqJ.js");
