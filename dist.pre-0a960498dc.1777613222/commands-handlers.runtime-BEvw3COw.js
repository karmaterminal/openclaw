...
import { V as stripToolResultDetails } from "./wait-for-idle-before-flush-DV1kMVgL.js";
import { n as redactSupportString } from "./diagnostic-support-redaction-23Q3Zswq.js";
import { C as safeTrajectorySessionFileName, S as resolveTrajectoryPointerFilePath, T as sanitizeDiagnosticPayload, b as TRAJECTORY_RUNTIME_FILE_MAX_BYTES, w as safeJsonStringify, x as resolveTrajectoryFilePath } from "./selection-sNhZ1IUb.js";
...
import { n as buildThreadingToolContext } from "./agent-runner-utils-BIZNMNXG.js";
...
import { n as resolveSessionEntryForKey, r as stopSubagentsForRequester, t as formatAbortReplyText } from "./abort-B6X9JJN1.js";
...
import { t as handleAcpCommand } from "./commands-acp-DRUHTvaD.js";
...
import { r as createExecTool } from "./bash-tools-C5QUh791.js";
import { n as listTasksForAgentIdForStatus, r as listTasksForSessionKeyForStatus } from "./status-text-Dp65Zw4S.js";
import { d as resolveChannelAccountId, f as resolveCommandSurfaceChannel, l as resolveSubagentsAction, o as resolveHandledPrefix, s as resolveRequesterSessionKey, u as stopWithText } from "./shared-DLfFQtkL.js";
...
import { t as buildStatusReply } from "./commands-status-Pn4ePoil.js";
...
function loadCompactRuntime() {
	compactRuntimePromise ??= import("./commands-compact.runtime-Dequ73KS.js");
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-CpMV3_Gc.js");
...
function loadAgentsAction() {
	actionAgentsPromise ??= import("./action-agents-DW5o1BIk.js");
	return actionAgentsPromise;
}
function loadFocusAction() {
	actionFocusPromise ??= import("./action-focus-DG9OROfg.js");
	return actionFocusPromise;
}
function loadHelpAction() {
	actionHelpPromise ??= import("./action-help-8oCCrZ4z.js");
	return actionHelpPromise;
}
function loadInfoAction() {
	actionInfoPromise ??= import("./action-info-Blrlc797.js");
	return actionInfoPromise;
}
function loadKillAction() {
	actionKillPromise ??= import("./action-kill-B3P5xdmH.js");
	return actionKillPromise;
}
function loadListAction() {
	actionListPromise ??= import("./action-list-CSowQ0SE.js");
	return actionListPromise;
}
function loadLogAction() {
	actionLogPromise ??= import("./action-log-DjcwOnNb.js");
	return actionLogPromise;
}
function loadSendAction() {
	actionSendPromise ??= import("./action-send-qyIbgrzL.js");
	return actionSendPromise;
}
function loadSpawnAction() {
	actionSpawnPromise ??= import("./action-spawn-CAR-MhWA.js");
	return actionSpawnPromise;
}
function loadUnfocusAction() {
	actionUnfocusPromise ??= import("./action-unfocus-kRcHYNKp.js");
	return actionUnfocusPromise;
}
function loadControlRuntime() {
	controlRuntimePromise ??= import("./commands-subagents-control.runtime-DsZVsIJv.js");
