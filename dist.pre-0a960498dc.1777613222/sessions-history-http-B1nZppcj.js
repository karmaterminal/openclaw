...
import { c as stripEnvelopeFromMessages, i as readSessionMessages, t as attachOpenClawTranscriptMeta } from "./session-utils.fs-Dn5nQNOb.js";
import { a as resolveSessionTranscriptCandidates } from "./session-transcript-files.fs-CjL9o5JQ.js";
import { f as resolveGatewaySessionStoreTarget, u as resolveFreshestSessionEntryFromStoreKeys } from "./session-utils-BWJpwoCp.js";
import { S as sendMethodNotAllowed, a as checkGatewayHttpRequestAuth, b as sendInvalidRequest, h as resolveTrustedHttpOperatorScopes, i as authorizeScopedGatewayHttpRequestOrReply, s as getHeader, w as setSseHeaders, x as sendJson } from "./http-utils-DIGlw93G.js";
import { c as sanitizeChatHistoryMessages, n as DEFAULT_CHAT_HISTORY_TEXT_MAX_CHARS } from "./chat-BnhbxzAW.js";
...
function buildSessionHistorySnapshot(params) {
	const history = paginateSessionMessages(toSessionHistoryMessages(sanitizeChatHistoryMessages(stripEnvelopeFromMessages(params.rawMessages), params.maxChars ?? 8e3)), params.limit, params.cursor);
