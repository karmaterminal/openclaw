...
export const gatewayDatabaseWorkerTestFiles = [
  ...
  "src/gateway/worker-environments/placement-dispatch-conflict-lookup.test.ts",
  ...
  "src/gateway/worker-environments/placement-turn-authority.test.ts",
  ...
  "src/gateway/worker-environments/provider-ssh-identity.test.ts",
...
export const gatewayCoreTestExclude = [
  ...
  // Owned by the dedicated return-covenant shard, not gateway-core. Listed
  // literally rather than spreading gatewayServerBackedHttpTestFiles, which is
  // declared further down this file and would be in its TDZ here.
