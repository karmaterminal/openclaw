...
import { Bi as CLAUDE_CLI_PROFILE_ID, Er as resolveConfiguredModelRef, G as writeConfigFile, Ii as DEFAULT_MODEL, Kn as repairOAuthProfileIdMismatch, Li as DEFAULT_PROVIDER, Or as resolveHooksGmailModel, V as readConfigFileSnapshot, Vi as CODEX_CLI_PROFILE_ID, d as resolveApiKeyForProfile, er as ensureAuthProfileStore, gr as getModelRefStatus, ir as updateAuthProfileStoreWithLock, l as resolveProfileUnusableUntilForDisplay, mi as resolveApiKeyForProvider } from "./auth-profiles-g_IwaokD.js";
import { t as formatCliCommand } from "./command-format-CLEQe4bk.js";
import { a as resolveAgentDir, d as resolveDefaultAgentId, g as DEFAULT_AGENTS_FILENAME, u as resolveAgentWorkspaceDir } from "./agent-scope-C5bklqr1.js";
...
import { A as hasConfiguredSecretInput } from "./registry-BrR1Dq5T.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-B3CPQXIz.js";
import { B as cleanStaleLockFiles, o as loadSessionStore, ot as formatSessionArchiveTimestamp, st as isPrimarySessionTranscriptFileName, tt as resolveMainSessionKey } from "./sessions-hV-TIgW5.js";
import { n as listChannelPlugins } from "./plugins-B4AetCpQ.js";
import { Nn as analyzeBootstrapBudget, Pn as buildBootstrapInjectionStats, b as loadOpenClawPlugins, dn as buildAuthHealthSummary, fn as formatRemainingShort, un as DEFAULT_OAUTH_WARN_MS, vr as resolveAgentSessionDirs, wr as resolveBootstrapContextForRun } from "./subagent-registry-CcvVYXEz.js";
import { c as resolveStorePath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveSessionTranscriptsDirForAgent } from "./paths-DvFmz0MB.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-BPb_1Wbv.js";
import { r as isLoopbackHost, u as resolveGatewayBindHost } from "./net-DULSGgS2.js";
import { B as resolveBootstrapTotalMaxChars, R as resolveBootstrapMaxChars } from "./pi-embedded-helpers-RQ0iakKf.js";
import { D as DEFAULT_SANDBOX_COMMON_IMAGE, E as DEFAULT_SANDBOX_BROWSER_IMAGE, O as DEFAULT_SANDBOX_IMAGE, p as resolveSandboxScope } from "./sandbox-Cl58Ljp3.js";
import { a as resolveGatewayAuth } from "./auth-l3KQ3Wf5.js";
import { n as inspectPortUsage, o as formatPortDiagnostics } from "./ports-DA8HamoF.js";
import { n as loadModelCatalog } from "./model-catalog-Dt1OZnEX.js";
import { f as resolveGatewaySystemdServiceName, h as resolveNodeLaunchAgentLabel, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-C8Mfdyag.js";
import { l as resolveDmAllowState } from "./pi-tools.policy-BBwg980o.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-CvQfS6aU.js";
import { h as randomToken, n as applyWizardMetadata, p as printWizardHeader, s as guardCancel } from "./onboard-helpers-DPwYh7mV.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-BfCTyCoH.js";
import { i as resolveMemoryBackendConfig } from "./memory-cli-lYg9IWIg.js";
import { n as DEFAULT_LOCAL_MODEL, r as resolveMemorySearchConfig } from "./manager-BwiZYB4Q.js";
import { t as note$1 } from "./note-nDlrTKjH.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-JgPH8x7b.js";
import { d as resolveSystemNodeInfo, l as renderSystemNodeWarning, n as gatewayInstallErrorHint, t as buildGatewayInstallPlan } from "./daemon-install-helpers-CyjpUUrm.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-Dgg-ogyc.js";
import { l as uninstallLegacySystemdUnits, r as isSystemdUserServiceAvailable } from "./systemd-CfkbKf0a.js";
import { a as launchAgentPlistExists, i as isLaunchAgentLoaded, o as repairLaunchAgentBootstrap, r as isLaunchAgentListed, s as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-DpoMFg_T.js";
import { i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as formatRuntimeStatus, t as isSystemdUnavailableDetail } from "./systemd-hints-5a0ljpsV.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-DuePITTA.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-Drptu1PE.js";
import { r as healthCommand } from "./health-CpI-F9ZX.js";
import { n as resolveControlUiDistIndexHealth, r as resolveControlUiDistIndexPathForRoot } from "./control-ui-assets-1CYoFkJQ.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-BjsJwBrl.js";
import { t as runGatewayUpdate } from "./update-runner-BGq8vodR.js";
import { n as logConfigUpdated } from "./logging-DoGVpb2p.js";
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-CZfhs_ab.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./oauth-tls-preflight-D7Jpiqaa.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-unPyYNoN.js";
import { t as formatHealthCheckFailure } from "./health-format-5jHeUz3P.js";
import { n as doctorShellCompletion } from "./doctor-completion-DCnMyPcd.js";
