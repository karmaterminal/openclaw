	...
	switch (action) {
		...
		case "threadCreate": {
			...
			const payload = {
				name,
				messageId,
				autoArchiveMinutes: typeof autoArchiveMinutesRaw === "number" && Number.isFinite(autoArchiveMinutesRaw) ? autoArchiveMinutesRaw : void 0,
				content,
