import { $ as normalizeAgentId, I as resolvePathViaExistingAncestorSync, J as buildAgentMainSessionKey, K as DEFAULT_AGENT_ID, O as runExec, S as ensureAgentWorkspace, _ as DEFAULT_HEARTBEAT_FILENAME, b as DEFAULT_TOOLS_FILENAME, et as normalizeMainKey, f as resolveSessionAgentId, g as DEFAULT_BOOTSTRAP_FILENAME, h as DEFAULT_AGENT_WORKSPACE_DIR, i as resolveAgentConfig, j as openBoundaryFile, m as DEFAULT_AGENTS_FILENAME, st as normalizeOptionalAccountId, tt as resolveAgentIdFromSessionKey, v as DEFAULT_IDENTITY_FILENAME, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./run-with-concurrency-qFOkp49n.js";
import { a as resolveGatewayPort, d as resolveRequiredHomeDir, n as STATE_DIR } from "./paths-MKyEVmEb.js";
import { Gr as resolveSecretInputRef, H as parseDurationMs, Mr as getProcessStartTime, Nr as isPidAlive, Pr as formatCliCommand, U as parseByteSize, V as getBlockedNetworkModeReason, _t as CHANNEL_IDS, br as secretRefKey, jr as resolveProcessScopedMap, n as loadConfig, o as writeConfigFile, pr as resolveSecretRefValues, t as createConfigIO, ti as parseBooleanValue } from "./config-Btd0LI-j.js";
import { E as resolveUserPath, N as truncateUtf16Safe, S as normalizeE164, a as createSubsystemLogger, c as defaultRuntime } from "./logger-z1vqlUc1.js";
import { J as normalizeHyphenSlug, d as getChannelDock, o as normalizeThinkLevel } from "./thinking-kR5jJN3L.js";
import { T as normalizeMessageChannel, i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS, w as listDeliverableMessageChannels } from "./image-ops-Bg3knMR1.js";
import { W as normalizeChatType, r as normalizeChannelId } from "./plugins-B4GwK3Rj.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-NcyWgkDa.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-DWkbMpSx.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-DWkbMpSx.js")).closePlaywrightBrowserConnection();
	} catch {}
}
...
//#endregion
export { expandToolGroups as $, canonicalizeMainSessionAlias as $t, isTransientHttpError as A, normalizeAccountId as At, registerBrowserRoutes as B, jsonUtf8Bytes as Bt, isCompactionFailureError as C, isCacheEnabled as Ct, isLikelyContextOverflowError as D, mergeDeliveryContext as Dt, isFailoverErrorMessage as E, deliveryContextKey as Et, isTimeoutErrorMessage as F, parseInlineDirectives as Ft, resolveBrowserControlAuth as G, resolveChannelResetConfig as Gt, resolveProfile as H, resolveSessionLockMaxHoldFromTimeout as Ht, ensureSandboxWorkspaceForSession as I, INPUT_PROVENANCE_KIND_VALUES as It, buildPluginToolGroups as J, resolveThreadFlag as Jt, resolveSandboxConfigForAgent as K, resolveSessionResetPolicy as Kt, resolveSandboxContext as L, applyInputProvenanceToUserMessage as Lt, parseImageSizeError as M, capArrayByJsonBytes as Mt, sanitizeUserFacingText as N, countToolResults as Nt, isRateLimitAssistantError as O, normalizeDeliveryContext as Ot, isAuthPermanentErrorMessage as P, extractToolCallNames as Pt, stripPluginOnlyAllowlist as Q, setSessionRuntimeModel as Qt, resolveSandboxRuntimeStatus as R, hasInterSessionUserProvenance as Rt, isCloudCodeAssistFormatError as S, updateSessionStoreEntry as St, isFailoverAssistantError as T, deliveryContextFromSession as Tt, getBridgeAuthForPort as U, resolveSessionKey as Ut, resolveBrowserConfig as V, acquireSessionWriteLock as Vt, ensureBrowserControlAuth as W, evaluateSessionFreshness as Wt, expandPolicyWithPluginGroups as X, mergeSessionEntry as Xt, collectExplicitAllowlist as Y, DEFAULT_RESET_TRIGGERS as Yt, mergeAlsoAllowPolicy as Z, resolveFreshSessionTotalTokens as Zt, formatBillingErrorMessage as _, loadSessionStore as _t, isMessagingToolDuplicateNormalized as a, ensureSessionHeader as at, isAuthAssistantError as b, updateLastRoute as bt, extractToolCallsFromAssistant as c, resolveBootstrapTotalMaxChars as ct, downgradeOpenAIFunctionCallReasoningPairs as d, trimToUndefined as dt, resolveExplicitAgentSessionKey as en, normalizeToolName as et, downgradeOpenAIReasoningBlocks as f, extractDeliveryInfo as ft, formatAssistantErrorText as g, resolveAndPersistSessionFile as gt, classifyFailoverReason as h, resolveMirroredTranscriptText as ht, isMessagingToolDuplicate as i, resolveGroupSessionKey as in, buildBootstrapContextFiles as it, parseImageDimensionError as j, archiveSessionTranscripts as jt, isRawApiErrorPayload as k, normalizeSessionDeliveryFields as kt, extractToolResultId as l, sanitizeGoogleTurnOrdering as lt, BILLING_ERROR_USER_MESSAGE as m, appendAssistantMessageToSessionTranscript as mt, validateGeminiTurns as n, deriveSessionMetaPatch as nn, compileGlobPatterns as nt, normalizeTextForComparison as o, resolveBootstrapMaxChars as ot, isGoogleModelApi as p, parseSessionThreadInfo as pt, applyOwnerOnlyToolPolicy as q, resolveSessionResetType as qt, pickFallbackThinkingLevel as r, resolveConversationLabel as rn, matchesAnyGlobPattern as rt, sanitizeSessionMessagesImages as s, resolveBootstrapPromptTruncationWarningMode as st, validateAnthropicTurns as t, resolveMainSessionKey as tn, resolveToolProfilePolicy as tt, sanitizeToolCallIdsForCloudCodeAssist as u, resolveGatewayCredentialsFromConfig as ut, formatRawAssistantErrorForUi as v, readSessionUpdatedAt as vt, isContextOverflowError as w, resolveCacheTtlMs as wt, isBillingAssistantError as x, updateSessionStore as xt, getApiErrorPayloadFingerprint as y, recordSessionMetaFromInbound as yt, createBrowserRouteContext as z, normalizeInputProvenance as zt };