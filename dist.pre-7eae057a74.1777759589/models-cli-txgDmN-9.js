...
import { Gt as describeFailoverError, a as buildAuthHealthSummary, bt as formatUsageWindowSummary, f as runEmbeddedPiAgent, i as DEFAULT_OAUTH_WARN_MS, o as formatRemainingShort, r as maskApiKey, vt as loadProviderUsageSummary, xt as resolveUsageProviderId } from "./reply-CvALVR_H.js";
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-Ckfy1eLE.js";
...
import { $t as loadConfig, Ai as resolveAuthProfileDisplayLabel, Bi as DEFAULT_MODEL, Ct as resolveProfileUnusableUntilForDisplay, Dn as parseDurationMs, Nt as resolveSecretRefString, Ti as resolveOpenClawAgentDir, Vi as DEFAULT_PROVIDER, _t as resolveAuthProfileOrder, at as resolveEnvApiKey, c as modelKey, d as normalizeProviderId, f as parseModelRef, fi as listProfilesForProvider, g as resolveDefaultModelForAgent, gt as resolveAuthProfileEligibility, h as resolveConfiguredModelRef, hi as upsertAuthProfile, i as findNormalizedProviderValue, ii as getShellEnvAppliedKeys, it as resolveAwsSdkEnvVarName, mi as setAuthProfileOrder, r as buildModelAliasIndex, rt as resolveApiKeyForProvider, si as shouldEnableShellEnvFallback, tt as getCustomProviderApiKey, v as resolveModelRefFromString, vi as ensureAuthProfileStore, wi as resolveAuthStorePathForDisplay } from "./model-selection-B7i1xwmj.js";
import { N as normalizeSecretInputString, k as coerceSecretRef } from "./registry-XafKMtuN.js";
...
import { t as ensureOpenClawModelsJson } from "./models-config-DBOUE3xm.js";
...
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-D24h0XR4.js";
...
import { r as resolveForwardCompatModel } from "./model-BQ3jRxLO.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-BSu-yYWJ.js";
...
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-Cj02j2Fc.js";
import "./session-cost-usage-BY7a_j5T.js";
import { f as openUrl } from "./onboard-helpers-CGbA5tJv.js";
...
import { r as withProgressTotals } from "./progress-BVvswfoL.js";
import "./server-lifecycle-C_73vFc4.js";
import "./stagger-DL-XRpny.js";
import "./note-DvFtKTA_.js";
import { t as createClackPrompter } from "./clack-prompter-Bm5AEAXo.js";
import "./issue-format-BpK5bnjM.js";
import { t as renderTable } from "./table-hmH594co.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-DhHzFqPC.js";
import { n as redactSecrets } from "./format-BrqJ-lIP.js";
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-BSlhlh7D.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-4E5v_QAY.js";
import { n as logConfigUpdated } from "./logging-44hOrQ79.js";
import { a as createVpsAwareOAuthHandlers, c as githubCopilotLoginCommand, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-DCicTjdw.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./model-selection-B7i1xwmj.js").then((n) => n.ht);
	const cfg = await loadModelsConfig({
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-BQ3jRxLO.js").then((n) => n.t);
