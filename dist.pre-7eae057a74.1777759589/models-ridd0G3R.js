...
import { Cr as parseModelRef, Dr as resolveDefaultModelForAgent, Er as resolveConfiguredModelRef, Ii as DEFAULT_MODEL, Jn as listProfilesForProvider, Li as DEFAULT_PROVIDER, Ri as resolveAuthProfileDisplayLabel, Sr as normalizeProviderId, Xn as setAuthProfileOrder, Zn as upsertAuthProfile, er as ensureAuthProfileStore, fi as getCustomProviderApiKey, gi as resolveEnvApiKey, hi as resolveAwsSdkEnvVarName, hr as findNormalizedProviderValue, kr as resolveModelRefFromString, l as resolveProfileUnusableUntilForDisplay, mi as resolveApiKeyForProvider, mr as buildModelAliasIndex, n as resolveAuthProfileEligibility, or as resolveAuthStorePathForDisplay, pt as parseDurationMs, r as resolveAuthProfileOrder, sr as resolveOpenClawAgentDir, vi as getShellEnvAppliedKeys, xi as shouldEnableShellEnvFallback, y as resolveSecretRefString, yr as modelKey, z as loadConfig } from "./auth-profiles-g_IwaokD.js";
import { t as formatCliCommand } from "./command-format-CLEQe4bk.js";
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-C5bklqr1.js";
import { x as shortenHomePath } from "./utils-cwpAMi-t.js";
import { N as normalizeSecretInputString, k as coerceSecretRef } from "./registry-BrR1Dq5T.js";
import { r as resolveForwardCompatModel } from "./model-B-bAhMoU.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-CvdRmsym.js";
import { Mn as resolveUsageProviderId, Nt as describeFailoverError, dn as buildAuthHealthSummary, fn as formatRemainingShort, jn as formatUsageWindowSummary, kn as loadProviderUsageSummary, ln as maskApiKey, u as runEmbeddedPiAgent, un as DEFAULT_OAUTH_WARN_MS } from "./subagent-registry-CcvVYXEz.js";
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-DvFmz0MB.js";
import { t as ensureOpenClawModelsJson } from "./models-config-CqksOjvw.js";
import { n as loadModelCatalog } from "./model-catalog-Dt1OZnEX.js";
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-B61R-FeR.js";
import { f as openUrl } from "./onboard-helpers-DPwYh7mV.js";
...
import { t as createClackPrompter } from "./clack-prompter-CcxUeG62.js";
import { t as renderTable } from "./table-D9z5aFl9.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-B5WDRptZ.js";
import { n as redactSecrets } from "./format-A_N-0ymb.js";
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-B8le6qTP.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-D6CpKQyI.js";
import { n as logConfigUpdated } from "./logging-DoGVpb2p.js";
import { a as createVpsAwareOAuthHandlers, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-BlLGK9e2.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles-g_IwaokD.js").then((n) => n.t);
	const cfg = await loadModelsConfig({
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-B-bAhMoU.js").then((n) => n.t);
