...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-DPwYh7mV.js";
import { t as WizardCancelledError } from "./prompts-l_pUOv42.js";
import { t as createClackPrompter } from "./clack-prompter-CcxUeG62.js";
import { t as assertSupportedRuntime } from "./runtime-guard-DFO22ThU.js";
...
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-Czr9T-LJ.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-CPu1hjk8.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-Dk50bEMu.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-CpI-F9ZX.js").then((n) => n.i);
