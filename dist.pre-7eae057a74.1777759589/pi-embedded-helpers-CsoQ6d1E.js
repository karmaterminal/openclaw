...
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-BtoBqtXI.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-UAKcGiUQ.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-BkmC1jGw.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-BjxKNMNA.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-BjxKNMNA.js")).closePlaywrightBrowserConnection();
	} catch {}
}
...
//#endregion
export { deliveryContextFromSession as $, matchesAnyGlobPattern as $t, isTransientHttpError as A, resolveGroupSessionKey as At, parseSessionThreadInfo as B, resolveGatewayCredentialsFromConfig as Bt, isCompactionFailureError as C, resolveFreshSessionTotalTokens as Ct, isLikelyContextOverflowError as D, resolveMainSessionKey as Dt, isFailoverErrorMessage as E, resolveExplicitAgentSessionKey as Et, isTimeoutErrorMessage as F, resolveBrowserConfig as Ft, readSessionUpdatedAt as G, collectExplicitAllowlist as Gt, resolveMirroredTranscriptText as H, resolveSandboxConfigForAgent as Ht, ensureSandboxWorkspaceForSession as I, resolveProfile as It, updateLastRoute as J, stripPluginOnlyAllowlist as Jt, recordSessionMetaFromInbound as K, expandPolicyWithPluginGroups as Kt, resolveSandboxContext as L, getBridgeAuthForPort as Lt, parseImageSizeError as M, resolveSessionLockMaxHoldFromTimeout as Mt, sanitizeUserFacingText as N, createBrowserRouteContext as Nt, isRateLimitAssistantError as O, deriveSessionMetaPatch as Ot, isAuthPermanentErrorMessage as P, registerBrowserRoutes as Pt, resolveCacheTtlMs as Q, compileGlobPatterns as Qt, resolveSandboxRuntimeStatus as R, ensureBrowserControlAuth as Rt, isCloudCodeAssistFormatError as S, mergeSessionEntry as St, isFailoverAssistantError as T, canonicalizeMainSessionAlias as Tt, resolveAndPersistSessionFile as U, applyOwnerOnlyToolPolicy as Ut, appendAssistantMessageToSessionTranscript as V, trimToUndefined as Vt, loadSessionStore as W, buildPluginToolGroups as Wt, updateSessionStoreEntry as X, normalizeToolName as Xt, updateSessionStore as Y, expandToolGroups as Yt, isCacheEnabled as Z, resolveToolProfilePolicy as Zt, formatBillingErrorMessage as _, resolveChannelResetConfig as _t, isMessagingToolDuplicateNormalized as a, sanitizeGoogleTurnOrdering as an, archiveSessionTranscripts as at, isAuthAssistantError as b, resolveThreadFlag as bt, extractToolCallsFromAssistant as c, extractToolCallNames as ct, downgradeOpenAIFunctionCallReasoningPairs as d, applyInputProvenanceToUserMessage as dt, buildBootstrapContextFiles as en, deliveryContextKey as et, downgradeOpenAIReasoningBlocks as f, hasInterSessionUserProvenance as ft, formatAssistantErrorText as g, evaluateSessionFreshness as gt, classifyFailoverReason as h, resolveSessionKey as ht, isMessagingToolDuplicate as i, resolveBootstrapTotalMaxChars as in, normalizeAccountId as it, parseImageDimensionError as j, acquireSessionWriteLock as jt, isRawApiErrorPayload as k, resolveConversationLabel as kt, extractToolResultId as l, parseInlineDirectives as lt, BILLING_ERROR_USER_MESSAGE as m, jsonUtf8Bytes as mt, validateGeminiTurns as n, resolveBootstrapMaxChars as nn, normalizeDeliveryContext as nt, normalizeTextForComparison as o, capArrayByJsonBytes as ot, isGoogleModelApi as p, normalizeInputProvenance as pt, saveSessionStore as q, mergeAlsoAllowPolicy as qt, pickFallbackThinkingLevel as r, resolveBootstrapPromptTruncationWarningMode as rn, normalizeSessionDeliveryFields as rt, sanitizeSessionMessagesImages as s, countToolResults as st, validateAnthropicTurns as t, ensureSessionHeader$1 as tn, mergeDeliveryContext as tt, sanitizeToolCallIdsForCloudCodeAssist as u, INPUT_PROVENANCE_KIND_VALUES as ut, formatRawAssistantErrorForUi as v, resolveSessionResetPolicy as vt, isContextOverflowError as w, setSessionRuntimeModel as wt, isBillingAssistantError as x, DEFAULT_RESET_TRIGGERS as xt, getApiErrorPayloadFingerprint as y, resolveSessionResetType as yt, extractDeliveryInfo as z, resolveBrowserControlAuth as zt };