...
import { Cn as splitShellArgs, pt as parseDurationMs, z as loadConfig } from "./auth-profiles-g_IwaokD.js";
...
import { r as getMemoryCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-B61R-FeR.js";
import { f as listMemoryFiles, p as normalizeExtraMemoryPaths } from "./query-expansion-DfWHFCTw.js";
...
function loadManagerRuntime() {
	managerRuntimePromise ??= import("./manager-runtime-DGV90km9.js");
...
async function getMemorySearchManager(params) {
	...
	if (resolved.backend === "qmd" && resolved.qmd) {
		...
		try {
			const { QmdMemoryManager } = await import("./qmd-manager-Cwp95sXd.js");
