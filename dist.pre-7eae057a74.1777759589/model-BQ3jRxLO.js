...
import { Ti as resolveOpenClawAgentDir, d as normalizeProviderId, zi as DEFAULT_CONTEXT_TOKENS } from "./model-selection-B7i1xwmj.js";
...
function resolveModel(provider, modelId, agentDir, cfg) {
	...
	if (providerOverride?.baseUrl || providerOverride?.headers) {
		...
		if (providerOverride.baseUrl) overridden.baseUrl = providerOverride.baseUrl;
		if (providerOverride.headers) overridden.headers = {
			...model.headers,
