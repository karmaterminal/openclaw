...
import { At as AVATAR_MAX_BYTES, Cr as parseModelRef, Dr as resolveDefaultModelForAgent, Er as resolveConfiguredModelRef, Fi as DEFAULT_CONTEXT_TOKENS, Ii as DEFAULT_MODEL, It as isWorkspaceRelativeAvatarPath, Li as DEFAULT_PROVIDER, Mt as isAvatarHttpUrl, Pt as isPathWithinRoot, Rt as resolveAvatarMime, _r as inferUniqueProviderFromConfiguredModels, jt as isAvatarDataUrl, sr as resolveOpenClawAgentDir, z as loadConfig } from "./auth-profiles-g_IwaokD.js";
...
import { $ as resolveAgentMainSessionKey, C as normalizeSessionDeliveryFields, Q as canonicalizeMainSessionAlias, X as resolveFreshSessionTotalTokens, ct as buildGroupDisplayName, j as readSessionTitleFieldsFromTranscript, o as loadSessionStore, tt as resolveMainSessionKey } from "./sessions-hV-TIgW5.js";
...
function ensureContextWindowCacheLoaded() {
	...
	loadPromise = (async () => {
		...
		try {
			const { discoverAuthStorage, discoverModels } = await import("./pi-model-discovery-CvdRmsym.js").then((n) => n.r);
