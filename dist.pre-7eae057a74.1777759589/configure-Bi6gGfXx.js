...
import { G as writeConfigFile, V as readConfigFileSnapshot, er as ensureAuthProfileStore, z as loadConfig } from "./auth-profiles-g_IwaokD.js";
...
import { N as normalizeSecretInputString } from "./registry-BrR1Dq5T.js";
import { n as listChannelPlugins, t as getChannelPlugin } from "./plugins-B4AetCpQ.js";
import { a as findTailscaleBinary } from "./tailscale-D4zNU-0Q.js";
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, g as resolveControlUiLinks, h as randomToken, m as probeGatewayReachable, n as applyWizardMetadata, p as printWizardHeader, s as guardCancel, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput, v as summarizeExistingConfig, y as validateGatewayPasswordInput } from "./onboard-helpers-DPwYh7mV.js";
...
import { r as setupChannels, t as noteChannelStatus } from "./onboard-channels-0SC80Czi.js";
import { n as gatewayInstallErrorHint, t as buildGatewayInstallPlan } from "./daemon-install-helpers-CyjpUUrm.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-Dgg-ogyc.js";
import { t as resolveGatewayService } from "./service-DpoMFg_T.js";
import { r as healthCommand } from "./health-CpI-F9ZX.js";
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-1CYoFkJQ.js";
import { n as logConfigUpdated } from "./logging-DoGVpb2p.js";
import { n as promptAuthChoiceGrouped } from "./auth-choice-prompt-uHHsmf6M.js";
import { i as applyAuthChoice, n as resolvePreferredProviderForAuthChoice } from "./auth-choice-C5ziAm5Q.js";
import { a as promptDefaultModel, n as applyModelFallbacksFromSelection, o as promptModelAllowlist, r as applyPrimaryModel, t as applyModelAllowlist } from "./model-picker-CnHOhwhS.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-unPyYNoN.js";
import { a as promptCustomApiConfig } from "./onboard-custom-D7ut5QBd.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-DLm6D_Vs.js";
import { t as formatHealthCheckFailure } from "./health-format-5jHeUz3P.js";
import { n as promptRemoteGatewayConfig } from "./onboard-remote-Bi7KnEOa.js";
import { n as setupSkills } from "./onboard-skills-DwD3dhaw.js";
...
async function promptWebToolsConfig(nextConfig, runtime) {
	...
	const hasPerplexityKey = Boolean(existingSearch?.perplexity?.apiKey || process.env.PERPLEXITY_API_KEY);
	...
	if (enableSearch) {
		...
		if (providerChoice === "perplexity") {
			...
			const keyInput = guardCancel(await text$1({
				message: hasKey ? "Perplexity API key (leave blank to keep current or use PERPLEXITY_API_KEY)" : "Perplexity API key (paste it here; leave blank to use PERPLEXITY_API_KEY)",
			...
			else if (!hasKey && !process.env.PERPLEXITY_API_KEY) note$1([
			...
			const keyInput = guardCancel(await text$1({
				message: hasKey ? "Brave Search API key (leave blank to keep current or use BRAVE_API_KEY)" : "Brave Search API key (paste it here; leave blank to use BRAVE_API_KEY)",
			...
			else if (!hasKey && !process.env.BRAVE_API_KEY) note$1([
				"No key stored yet, so web_search will stay unavailable.",
