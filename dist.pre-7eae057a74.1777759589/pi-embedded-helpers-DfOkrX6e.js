...
import { n as SsrFBlockedError } from "./proxy-env-D9IYwjc-.js";
import { i as saveMediaBuffer, n as ensureMediaDir } from "./store-CK_KPHGA.js";
...
import { t as sanitizeContentBlocksImages } from "./tool-images-CVs6nDvi.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-COCwMVt9.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-COCwMVt9.js")).closePlaywrightBrowserConnection();
	} catch {}
}
...
//#endregion
export { deliveryContextKey as $, matchesAnyGlobPattern as $t, isTransientHttpError as A, resolveGroupSessionKey as At, parseSessionThreadInfo as B, resolveGatewayCredentialsFromConfig as Bt, isCompactionFailureError as C, setSessionRuntimeModel as Ct, isLikelyContextOverflowError as D, resolveMainSessionKey as Dt, isFailoverErrorMessage as E, resolveExplicitAgentSessionKey as Et, isTimeoutErrorMessage as F, resolveBrowserConfig as Ft, readSessionUpdatedAt as G, collectExplicitAllowlist as Gt, resolveMirroredTranscriptText as H, resolveSandboxConfigForAgent as Ht, ensureSandboxWorkspaceForSession as I, resolveProfile as It, updateSessionStore as J, stripPluginOnlyAllowlist as Jt, recordSessionMetaFromInbound as K, expandPolicyWithPluginGroups as Kt, resolveSandboxContext as L, getBridgeAuthForPort as Lt, parseImageSizeError as M, resolveSessionLockMaxHoldFromTimeout as Mt, sanitizeUserFacingText as N, createBrowserRouteContext as Nt, isRateLimitAssistantError as O, deriveSessionMetaPatch as Ot, isAuthPermanentErrorMessage as P, registerBrowserRoutes as Pt, deliveryContextFromSession as Q, compileGlobPatterns as Qt, resolveSandboxRuntimeStatus as R, ensureBrowserControlAuth as Rt, isCloudCodeAssistFormatError as S, resolveFreshSessionTotalTokens as St, isFailoverAssistantError as T, resolveAgentMainSessionKey as Tt, resolveAndPersistSessionFile as U, applyOwnerOnlyToolPolicy as Ut, appendAssistantMessageToSessionTranscript as V, trimToUndefined as Vt, loadSessionStore as W, buildPluginToolGroups as Wt, isCacheEnabled as X, normalizeToolName as Xt, updateSessionStoreEntry as Y, expandToolGroups as Yt, resolveCacheTtlMs as Z, resolveToolProfilePolicy as Zt, formatBillingErrorMessage as _, resolveSessionResetPolicy as _t, isMessagingToolDuplicateNormalized as a, sanitizeGoogleTurnOrdering as an, capArrayByJsonBytes as at, isAuthAssistantError as b, DEFAULT_RESET_TRIGGERS as bt, extractToolCallsFromAssistant as c, parseInlineDirectives as ct, downgradeOpenAIFunctionCallReasoningPairs as d, hasInterSessionUserProvenance as dt, buildBootstrapContextFiles as en, mergeDeliveryContext as et, downgradeOpenAIReasoningBlocks as f, normalizeInputProvenance as ft, formatAssistantErrorText as g, resolveChannelResetConfig as gt, classifyFailoverReason as h, evaluateSessionFreshness as ht, isMessagingToolDuplicate as i, resolveBootstrapTotalMaxChars as in, archiveSessionTranscripts as it, parseImageDimensionError as j, acquireSessionWriteLock as jt, isRawApiErrorPayload as k, resolveConversationLabel as kt, extractToolResultId as l, INPUT_PROVENANCE_KIND_VALUES as lt, BILLING_ERROR_USER_MESSAGE as m, resolveSessionKey as mt, validateGeminiTurns as n, resolveBootstrapMaxChars as nn, normalizeSessionDeliveryFields as nt, normalizeTextForComparison as o, countToolResults as ot, isGoogleModelApi as p, jsonUtf8Bytes as pt, updateLastRoute as q, mergeAlsoAllowPolicy as qt, pickFallbackThinkingLevel as r, resolveBootstrapPromptTruncationWarningMode as rn, normalizeAccountId as rt, sanitizeSessionMessagesImages as s, extractToolCallNames as st, validateAnthropicTurns as t, ensureSessionHeader$1 as tn, normalizeDeliveryContext as tt, sanitizeToolCallIdsForCloudCodeAssist as u, applyInputProvenanceToUserMessage as ut, formatRawAssistantErrorForUi as v, resolveSessionResetType as vt, isContextOverflowError as w, canonicalizeMainSessionAlias as wt, isBillingAssistantError as x, mergeSessionEntry as xt, getApiErrorPayloadFingerprint as y, resolveThreadFlag as yt, extractDeliveryInfo as z, resolveBrowserControlAuth as zt };