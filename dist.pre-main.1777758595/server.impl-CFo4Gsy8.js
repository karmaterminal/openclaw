...
import { n as isVitestRuntimeEnv, r as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-CqfGXlE5.js";
...
import { d as runWithDiagnosticTraceContext, n as createDiagnosticTraceContext } from "./diagnostic-trace-context-Cn2rNQJ4.js";
import { c as setDiagnosticsEnabledForProcess, i as isDiagnosticsEnabled } from "./diagnostic-events-BOjU629z.js";
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-W9_E260X.js";
import { i as runExec } from "./exec-D7DCHV5v.js";
import { o as getTailnetHostname } from "./tailscale-Di53RhqF.js";
import { t as isContainerEnvironment } from "./container-environment-DAGbmAa8.js";
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-CKEgmR9K.js";
import { a as isPrivateOrLoopbackAddress, c as isTrustedProxyAddress, f as resolveClientIp, g as resolveRequestClientIp, h as resolveHostName, i as isLoopbackHost, l as isValidIPv4, m as resolveGatewayListenHosts, n as isLocalishHost, o as isPrivateOrLoopbackHost, p as resolveGatewayBindHost, r as isLoopbackAddress, t as defaultGatewayBindMode } from "./net-D2ag99RA.js";
import { a as createAuthRateLimiter, i as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, n as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN } from "./auth-rate-limit-e78kx8nq.js";
import { a as hasForwardedRequestHeaders, i as authorizeWsControlUiGatewayConnect, o as isLocalDirectRequest, r as authorizeHttpGatewayConnect, s as checkBrowserOrigin, t as assertGatewayAuthConfigured } from "./auth-CxszTMg5.js";
import { n as resolveGatewayAuth } from "./auth-resolve-Q2OUKdaD.js";
import { n as normalizeAccountId, r as normalizeOptionalAccountId } from "./account-id-N6BXsI_x.js";
import { l as normalizeMainKey } from "./session-key-CWdvMTMr.js";
import { S as resolveDefaultAgentId, x as resolveAgentWorkspaceDir } from "./agent-scope-DfXPuZUf.js";
import { H as isPluginLocalInvalidConfigSnapshot, I as asResolvedSourceConfig, R as materializeRuntimeConfig, T as validateConfigObjectWithPlugins, U as shouldAttemptLastKnownGoodRecovery, X as isDiagnosticsTimelineEnabled, Y as emitDiagnosticsTimelineEvent, Z as measureDiagnosticsTimelineSpan, _ as recoverConfigFromLastKnownGood, c as promoteConfigSnapshotToLastKnownGood, f as readConfigFileSnapshotWithPluginMetadata, g as recoverConfigFromJsonRootSuffix, i as getRuntimeConfig, j as applyConfigOverrides, r as createConfigIO, u as readConfigFileSnapshot, v as registerConfigWriteListener } from "./io-DTtpq82f.js";
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-CRTzSGS4.js";
import { i as listChannelPlugins, n as getLoadedChannelPlugin, r as getLoadedChannelPluginOrigin, t as getChannelPlugin } from "./registry-BD-kXbDr.js";
import { n as resolveNormalizedAccountEntry, t as resolveAccountEntry } from "./account-lookup-BPl9W5uD.js";
import { r as replaceConfigFile } from "./mutate--W6Y6erO.js";
import "./config-DbmohW6s.js";
import { n as isRestartEnabled } from "./commands.flags-DCoMs1RR.js";
import { c as buildDeviceAuthPayloadV3, o as gatewayStartupUnavailableDetails, s as buildDeviceAuthPayload } from "./client-CtrkocR-.js";
import { n as resolvePreauthHandshakeTimeoutMs } from "./handshake-timeouts-CgUHh4yv.js";
import { i as normalizeDevicePublicKeyBase64Url, s as verifyDeviceSignature, t as deriveDeviceIdFromPublicKey } from "./device-identity-DzmBqDy-.js";
...
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-a1QfCw6W.js";
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient, s as isDeliverableMessageChannel, t as isBrowserOperatorUiClient, u as normalizeMessageChannel } from "./message-channel-DgTkFEBi.js";
import { t as normalizeDeviceMetadataForAuth } from "./device-metadata-normalization-BGhzkv0B.js";
import { i as buildPairingConnectErrorMessage, m as resolveDeviceAuthConnectErrorDetailCode, n as buildPairingConnectCloseReason, p as resolveAuthConnectErrorDetailCode, r as buildPairingConnectErrorDetails, t as ConnectErrorDetailCodes } from "./connect-error-details-BvvJGABh.js";
import { Br as ErrorCodes, Ct as validateSecretsResolveParams, G as validateExecApprovalResolveParams, O as validateConnectParams, U as validateExecApprovalGetParams, Vr as errorShape, W as validateExecApprovalRequestParams, _t as validatePluginApprovalResolveParams, gt as validatePluginApprovalRequestParams, t as formatValidationErrors, wt as validateSecretsResolveResult, xt as validateRequestFrame } from "./protocol-CPVH8nrf.js";
import { a as approvalDecisionLabel, n as MAX_PLUGIN_APPROVAL_TIMEOUT_MS, o as buildPluginApprovalExpiredMessage, s as buildPluginApprovalRequestMessage, t as DEFAULT_PLUGIN_APPROVAL_TIMEOUT_MS } from "./plugin-approvals-DcA_05gy.js";
import { i as READ_SCOPE, n as APPROVALS_SCOPE$1, o as WRITE_SCOPE, r as PAIRING_SCOPE, t as ADMIN_SCOPE } from "./operator-scopes-CCNu0CLn.js";
import "./method-scopes--jsSkjrL.js";
import { n as formatConfigIssueLines } from "./issue-format-CIrBljpw.js";
import { f as setGatewaySigusr1RestartPolicy, p as setPreRestartDeferralCheck } from "./restart-D_GM-Kpn.js";
import { r as normalizeControlUiBasePath } from "./control-ui-shared-Dg9wbwO5.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-CrRnVsLK.js";
import "./loader-UaaxQ4fP.js";
import { o as runGlobalGatewayStopSafely } from "./hook-runner-global-CbPxjSBS.js";
import { S as createEmptyPluginRegistry, a as getActivePluginRegistry, b as resolveActivePluginHttpRouteRegistry, d as pinActivePluginChannelRegistry, f as pinActivePluginHttpRouteRegistry, h as releasePinnedPluginHttpRouteRegistry, m as releasePinnedPluginChannelRegistry, x as setActivePluginRegistry } from "./runtime-B-5HHEpR.js";
import { f as sweepStaleRunContexts, l as onAgentEvent, t as clearAgentRunContext } from "./agent-events-DE3So3Se.js";
import { i as resolveMainSessionKey } from "./main-session-DImA1KnV.js";
import { n as channelRouteDedupeKey } from "./channel-route-B76mVc9n.js";
import { n as resolveChannelApprovalCapability, t as resolveChannelApprovalAdapter } from "./approvals-D20swcxn.js";
...
import { g as getActiveEmbeddedRunCount } from "./runs-DkQmuNSQ.js";
import { h as stopDiagnosticHeartbeat, m as startDiagnosticHeartbeat } from "./diagnostic-DsZ4vZSS.js";
import { n as onSessionLifecycleEvent } from "./session-lifecycle-events-CKPJU_Rk.js";
import { t as loadGatewayTlsRuntime$1 } from "./gateway-BgM1A5ft.js";
import { r as setCurrentPluginMetadataSnapshot, t as clearCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-Dka76S8j.js";
import { l as getTotalQueueSize } from "./command-queue-DaWipAKS.js";
import { t as getMachineDisplayName } from "./machine-name-gkQJscAl.js";
import { n as detectMime } from "./mime-B44wpfKR.js";
import { D as resolveExecApprovalRequestAllowedDecisions, E as resolveExecApprovalAllowedDecisions, r as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-CSDE03Ac.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-BU0AORQc.js";
import { r as cleanOldMedia } from "./store-Bfd4_fWY.js";
import { a as CANVAS_HOST_PATH, n as normalizeUrlPath, r as resolveFileWithinRoot, s as injectCanvasLiveReload, t as handleA2uiHttpRequest } from "./a2ui-DQmCbh_z.js";
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-secret-gateway-TjUP5dxA.js";
import { i as evaluateGatewayAuthSurfaceStates, r as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-web-tools-DM5GjY7O.js";
import { r as resetDirectoryCache } from "./target-resolver-M5WW0ePd.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-DVrEb58F.js";
import { i as enqueueSystemEvent } from "./system-events-Zf4xMpvh.js";
import { c as initSubagentRegistry } from "./subagent-registry-BCjOCdxP.js";
import { r as registerSkillsChangeListener } from "./refresh-state-B84Cx70L.js";
import "./refresh-CMz3AbOC.js";
import { l as roleScopesAllow } from "./pairing-token-Cjayz-bF.js";
import { c as updatePairedNodeMetadata, n as getPairedNode, s as requestNodePairing } from "./node-pairing-DIFms3ks.js";
import { a as refreshRemoteBinsForConnectedNodes, c as setSkillsRemoteRegistry, i as recordRemoteNodeInfo, n as primeRemoteSkillsCache, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo } from "./skills-remote-CWJbKU__.js";
import { r as resolveCronStorePath } from "./store-BZ2CNV4g.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-xzQ3DcPZ.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-DLyk8ySA.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-BTz5Zq2A.js";
import { c as formatExecApprovalExpiresIn, f as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-reply-DLLgsHsE.js";
import { t as CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "./approval-handler-adapter-runtime-Cz4Tt6HG.js";
import { a as isExecApprovalChannelRuntimeTerminalStartError } from "./approval-native-runtime-WN4j4rBd.js";
import { n as sanitizeExecApprovalDisplayText, r as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-BH8X_fm1.js";
import { n as createChannelApprovalHandlerFromCapability } from "./approval-handler-runtime-EJj7V6L_.js";
import { i as watchChannelRuntimeContexts, n as getChannelRuntimeContext, t as createTaskScopedChannelRuntime } from "./channel-runtime-context-BSiQzhNs.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-DPoHIpu2.js";
import { r as onHeartbeatEvent } from "./heartbeat-events-CG54N-Ev.js";
import { a as resolveNodeCommandAllowlist, i as normalizeDeclaredNodeCommands } from "./node-command-policy-B6J6PJYX.js";
import { t as safeParseJson } from "./server-json-oj3xLbJe.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs, t as formatForLog } from "./ws-log-DrL3bw0w.js";
import { i as assertGatewayAuthNotKnownWeak, n as mergeGatewayAuthConfig, r as mergeGatewayTailscaleConfig, t as ensureGatewayStartupAuth } from "./startup-auth-Cm40zypB.js";
import { i as resolveBootstrapProfileScopesForRole } from "./device-bootstrap-profile-ZKf6Oluj.js";
import { _ as updatePairedDeviceMetadata, a as getPairedDevice, c as listApprovedPairedDeviceRoles, l as listDevicePairing, n as approveDevicePairing, p as requestDevicePairing, r as ensureDeviceToken, s as hasEffectivePairedDeviceRole, t as approveBootstrapDevicePairing, u as listEffectivePairedDeviceRoles, v as verifyDeviceToken } from "./device-pairing-DinTyli9.js";
import { a as redeemDeviceBootstrapTokenProfile, n as getBoundDeviceBootstrapProfile, o as revokeDeviceBootstrapToken, r as getDeviceBootstrapTokenProfile, s as verifyDeviceBootstrapToken } from "./device-bootstrap-C97uwf3D.js";
import { t as createDefaultDeps } from "./deps-Cix7U4f3.js";
import { i as buildSystemRunApprovalEnvBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-zdFk1YtJ.js";
import { n as resolveSystemRunApprovalRequestContext } from "./system-run-approval-context-B4Njl_4c.js";
import { d as logRejectedLargePayload, n as sendGatewayAuthFailure, o as setDefaultSecurityHeaders } from "./http-common-CUW9xdur.js";
import { _ as resolveHooksConfig } from "./hooks-C8QTrnlm.js";
import { n as loadGatewayModelCatalog, t as __resetModelCatalogCacheForTest } from "./server-model-catalog-D6DMOOPy.js";
import { a as MAX_PAYLOAD_BYTES, i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES, r as HEALTH_REFRESH_INTERVAL_MS, s as TICK_INTERVAL_MS, t as DEDUPE_MAX } from "./server-constants-CerudlGK.js";
import { t as abortChatRunById } from "./chat-abort-WOPrAxkZ.js";
import { a as writeWideAreaGatewayZone, i as resolveWideAreaDiscoveryDomain } from "./widearea-dns-WrF2rtRk.js";
import { t as GatewayLockError } from "./gateway-lock-DZpZgvXd.js";
import { c as resolveControlUiRootSync, n as isPackageProvenControlUiRootSync, s as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DJsAxXsE.js";
import { t as getHealthSnapshot } from "./health-DSQ_Qgjd.js";
import { f as startTaskRegistryMaintenance, p as stopTaskRegistryMaintenance, r as getInspectableTaskRegistrySummary, t as configureTaskRegistryMaintenance } from "./task-registry.maintenance-CMITmIKZ.js";
import { i as migrateOrphanedSessionKeys } from "./state-migrations-CTmuCrZb.js";
import { t as runChannelPluginStartupMaintenance } from "./lifecycle-startup-DEnV8wdE.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-PMkxy-Cw.js";
import { a as createToolEventRecipientRegistry, i as createSessionMessageSubscriberRegistry, n as createChatRunState, r as createSessionEventSubscriberRegistry } from "./server-chat-state-DTWbwS-G.js";
import { S as roleCanSkipDeviceIdentity, a as resolveSessionKeyForRun, c as clearNodeWakeState, d as formatError, h as loadVoiceWakeRoutingConfig, i as upsertPresence, n as listSystemPresence, p as loadVoiceWakeConfig, t as broadcastPresenceSnapshot, w as pruneStaleControlPlaneBuckets, x as parseGatewayRole } from "./presence-events-sQx98JOn.js";
import { i as buildGatewayReloadPlan, t as diffConfigPaths } from "./config-reload-8XXi1QKT.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-BRVTFaZE.js";
import { i as normalizeCanvasScopedUrl, n as buildCanvasScopedHostUrl, r as mintCanvasCapabilityToken, t as CANVAS_CAPABILITY_TTL_MS } from "./canvas-capability-B7j4upXk.js";
import { a as loadPluginLookUpTable, i as setFallbackGatewayContextResolver, o as mergeActivationSectionsIntoRuntimeConfig, t as loadGatewayStartupPlugins } from "./server-plugin-bootstrap-CmLTvUst.js";
import { a as getRequiredSharedGatewaySessionGeneration, d as DEFAULT_CHANNEL_CONNECT_GRACE_MS, f as DEFAULT_CHANNEL_STALE_EVENT_THRESHOLD_MS, g as enqueueConfigRecoveryNotice, h as buildGatewayCronService, i as enforceSharedGatewaySessionGenerationForConfigWrite, m as applyGatewayLaneConcurrency, n as disconnectAllSharedGatewayAuthClients, o as setCurrentSharedGatewaySessionGeneration, p as evaluateChannelHealth, r as disconnectStaleSharedGatewayAuthClients, s as activateGatewayScheduledServices, t as resolveHookClientIpConfig, u as startGatewayRuntimeServices } from "./hook-client-ip-config-9MLCioM7.js";
import { a as resolvePluginRoutePathContext, i as isProtectedPluginRoutePathFromContext, n as shouldEnforceGatewayAuthForPluginPath } from "./route-auth-BCpcqZqw.js";
import "./paths-b9_PpVdM.js";
import { t as getUpdateAvailable } from "./update-startup-Co2o_GUb.js";
import { t as hasConfiguredInternalHooks } from "./configured-Df3y0b6u.js";
import { t as truncateCloseReason } from "./close-reason-Bza5HKXa.js";
...
function loadExecApprovalForwarderRuntime() {
	execApprovalForwarderRuntimePromise ??= import("./exec-approval-forwarder.runtime-DXZ39sYZ.js");
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-D-e1G1my.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-BWOfBVOm.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-DrfT-mrT.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-CrVxS8X4.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-BAe9bXMo.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-DK65gTU4.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-Thk8hMos.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-K8h71gON.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-CBIOTaB6.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-C8A9_TM7.js");
	return toolsInvokeHttpModulePromise;
}
function getVoiceClawRealtimeUpgradeModule() {
	voiceClawRealtimeUpgradeModulePromise ??= import("./upgrade-9q0jKuAy.js");
	return voiceClawRealtimeUpgradeModulePromise;
}
function getCanvasAuthModule() {
	canvasAuthModulePromise ??= import("./http-auth-DDUFzGXI.js");
	return canvasAuthModulePromise;
}
function getHttpAuthUtilsModule() {
	httpAuthUtilsModulePromise ??= import("./http-auth-utils-CiHs9qK0.js");
	return httpAuthUtilsModulePromise;
}
function getPluginRouteRuntimeScopesModule() {
	pluginRouteRuntimeScopesModulePromise ??= import("./plugin-route-runtime-scopes-9hPC-QzM.js");
	...
	try {
		...
		const handleHooksRequest = async (req, res) => {
			...
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-DReg0rDM.js");
		...
		const handlePluginRequest = async (req, res, pathContext, dispatchContext) => {
			...
			if (!loadedPluginRequestHandler) {
				const { createGatewayPluginRequestHandler } = await import("./plugins-http-B7OTzz1i.js");
...
function startGatewayEventSubscriptions(params) {
	...
	const getAgentEventHandler = () => {
		agentEventHandlerPromise ??= import("./server-chat-CldoH7Aq.js").then(({ createAgentEventHandler }) => createAgentEventHandler({
			broadcast: params.broadcast,
			broadcastToConnIds: params.broadcastToConnIds,
			nodeSendToSession: params.nodeSendToSession,
			agentRunSeq: params.agentRunSeq,
	...
	const getTranscriptUpdateHandler = () => {
		transcriptUpdateHandlerPromise ??= import("./server-session-events-DTp45RlR.js").then(({ createTranscriptUpdateBroadcastHandler }) => createTranscriptUpdateBroadcastHandler({
			broadcastToConnIds: params.broadcastToConnIds,
			sessionEventSubscribers: params.sessionEventSubscribers,
	...
	const getLifecycleEventHandler = () => {
		lifecycleEventHandlerPromise ??= import("./server-session-events-DTp45RlR.js").then(({ createLifecycleEventBroadcastHandler }) => createLifecycleEventBroadcastHandler({
			broadcastToConnIds: params.broadcastToConnIds,
			sessionEventSubscribers: params.sessionEventSubscribers
		}));
...
function scheduleGatewayMemoryBackend(params) {
	...
	const start = () => {
		import("./server-startup-memory-CZcL0w2s.js").then(({ startGatewayMemoryBackend }) => startGatewayMemoryBackend({
			cfg: params.cfg,
			log: params.log
		})).catch((err) => {
...
async function hasGatewayStartupInternalHookListeners() {
	const { hasInternalHookListeners } = await import("./internal-hooks-CDx7O2pu.js");
	return hasInternalHookListeners("gateway", "startup");
}
async function waitForAcpRuntimeBackendReady(params) {
	const { getAcpRuntimeBackend } = await import("./registry-D248ybhz.js");
...
async function prewarmConfiguredPrimaryModel(params) {
	const { resolveAgentModelPrimaryValue } = await import("./model-input-B2kVpwPz.js");
	...
	const [{ resolveOpenClawAgentDir }, { resolveAgentWorkspaceDir, resolveDefaultAgentId }, { DEFAULT_MODEL, DEFAULT_PROVIDER }, { isCliProvider, resolveConfiguredModelRef }, { resolveEmbeddedAgentRuntime }] = await Promise.all([
		import("./agent-paths-Bs9-PlC_.js"),
		import("./agent-scope-C5AjrRDR.js"),
		import("./defaults-DWtC7hvW.js"),
		import("./model-selection-DcqbTlZM.js"),
		import("./runtime-CBmhLABq.js")
	]);
	...
	const { ensureOpenClawModelsJson } = await import("./models-config-BkRmzp6U.js");
...
async function startGatewaySidecars(params) {
	await measureStartup(params.startupTrace, "sidecars.session-locks", async () => {
		try {
			const [{ resolveStateDir }, { resolveAgentSessionDirs }, { cleanStaleLockFiles }] = await Promise.all([
				...
				import("./session-dirs-D0oVnTYe.js"),
				import("./session-write-lock-ZB_lfIeD.js")
			]);
			...
			for (const sessionsDir of sessionDirs) {
				...
				if (result.cleaned.length > 0) {
					const { markRestartAbortedMainSessionsFromLocks } = await import("./main-session-restart-recovery-CHu4gu-E.js");
	...
	await measureStartup(params.startupTrace, "sidecars.gmail-watch", async () => {
		if (params.cfg.hooks?.enabled && params.cfg.hooks.gmail?.account) {
			const { startGmailWatcherWithLogs } = await import("./gmail-watcher-lifecycle-DBIo4GuY.js");
	...
	await measureStartup(params.startupTrace, "sidecars.gmail-model", async () => {
		if (params.cfg.hooks?.gmail?.model) {
			const [{ DEFAULT_MODEL, DEFAULT_PROVIDER }, { loadModelCatalog }, { getModelRefStatus, resolveConfiguredModelRef, resolveHooksGmailModel }] = await Promise.all([
				import("./defaults-DWtC7hvW.js"),
				import("./model-catalog-Bqpj1oVz.js"),
				import("./model-selection-DcqbTlZM.js")
			]);
	...
	await measureStartup(params.startupTrace, "sidecars.internal-hooks", async () => {
		try {
			if (internalHooksConfigured) {
				const [{ setInternalHooksEnabled }, { loadInternalHooks }] = await Promise.all([import("./internal-hooks-CDx7O2pu.js"), import("./loader-Wzpi3K2s.js")]);
	...
	if (internalHooksConfigured || await hasGatewayStartupInternalHookListeners()) setTimeout(() => {
		import("./internal-hooks-CDx7O2pu.js").then(({ createInternalHookEvent, triggerInternalHook }) => {
	...
	await measureStartup(params.startupTrace, "sidecars.plugin-services", async () => {
		try {
			const { startPluginServices } = await import("./services-cWUZutg_.js");
	...
	if (params.cfg.acp?.enabled) (async () => {
		...
		const [{ getAcpSessionManager }, { ACP_SESSION_IDENTITY_RENDERER_VERSION }] = await Promise.all([import("./manager-b29ta35N.js"), import("./session-identifiers-CABtkkrT.js")]);
	...
	await measureStartup(params.startupTrace, "sidecars.restart-sentinel", async () => {
		...
		const { hasRestartSentinel } = await import("./restart-sentinel-DI8alDNy.js");
		if (!await hasRestartSentinel()) return;
		setTimeout(() => {
			import("./server-restart-sentinel-wWyPB9uB.js").then(({ scheduleRestartSentinelWake }) => scheduleRestartSentinelWake({ deps: params.deps })).catch((err) => {
	...
	await measureStartup(params.startupTrace, "sidecars.subagent-recovery", async () => {
		const { scheduleSubagentOrphanRecovery } = await import("./subagent-registry-CLi75di2.js");
		scheduleSubagentOrphanRecovery();
	});
	await measureStartup(params.startupTrace, "sidecars.main-session-recovery", async () => {
		const { scheduleRestartAbortedMainSessionRecovery } = await import("./main-session-restart-recovery-CHu4gu-E.js");
		scheduleRestartAbortedMainSessionRecovery();
	});
	return { pluginServices };
}
const defaultGatewayPostAttachRuntimeDeps = {
	getGlobalHookRunner: async () => (await import("./hook-runner-global-DmnQbDk7.js")).getGlobalHookRunner(),
	logGatewayStartup: async (params) => (await import("./server-startup-log-BJFYOtVa.js")).logGatewayStartup(params),
	refreshLatestUpdateRestartSentinel: async () => (await import("./server-restart-sentinel-wWyPB9uB.js")).refreshLatestUpdateRestartSentinel(),
	scheduleGatewayUpdateCheck: async (...args) => (await import("./update-startup-B665DhRe.js")).scheduleGatewayUpdateCheck(...args),
	startGatewaySidecars,
	startGatewayTailscaleExposure: async (...args) => (await import("./server-tailscale-CcQCYrob.js")).startGatewayTailscaleExposure(...args)
};
...
function attachGatewayWsMessageHandler(params) {
	...
	const handleMessage = async (data) => {
		...
		try {
			...
			(async () => {
				const { handleGatewayRequest } = await import("./server-methods-BLS9rB4U.js");
...
function getChannelRuntime() {
	cachedChannelRuntimePromise ??= import("./runtime-channel-CEjZe-A8.js").then(({ createRuntimeChannel }) => createRuntimeChannel());
	return cachedChannelRuntimePromise;
}
function getStartupChannelRuntime() {
	cachedStartupChannelRuntimePromise ??= import("./channel-runtime-contexts-spIFc0mp.js").then(({ createChannelRuntimeContextRegistry }) => ({ runtimeContexts: createChannelRuntimeContextRegistry() }));
	return cachedStartupChannelRuntimePromise;
}
async function closeMcpLoopbackServerOnDemand() {
	const { closeMcpLoopbackServer } = await import("./mcp-http-BuRAcKWi.js");
	await closeMcpLoopbackServer();
}
let gatewayCloseModulePromise = null;
function loadGatewayCloseModule() {
	gatewayCloseModulePromise ??= import("./server-close-CU3_IHrr.js");
...
const runDefaultSetupWizard = async (...args) => {
	const { runSetupWizard } = await import("./setup-DzEcholU.js");
	...
	try {
		...
		if (!minimalTestGateway) {
			if (deferredConfiguredChannelPluginIds.length > 0) {
				const { reloadDeferredGatewayPlugins } = await import("./server-plugin-bootstrap-CSQcUG3l.js");
		...
		const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-B86XmvZN.js");
