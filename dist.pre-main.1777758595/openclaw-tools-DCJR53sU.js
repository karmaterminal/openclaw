...
import { a as shouldLogVerbose, r as logVerbose } from "./globals-DMzUDF8N.js";
import { t as logDebug } from "./logger-tSct8h87.js";
import { c as parseThreadSessionSuffix, o as parseAgentSessionKey } from "./session-key-utils-B26T5hOk.js";
import { n as normalizeAccountId } from "./account-id-N6BXsI_x.js";
import { c as normalizeAgentId, f as sanitizeAgentId, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-CWdvMTMr.js";
import { m as resolveSessionAgentIds, n as resolveAgentEffectiveModelPrimary, p as resolveSessionAgentId, r as resolveAgentExecutionContract, v as resolveAgentConfig, x as resolveAgentWorkspaceDir } from "./agent-scope-DfXPuZUf.js";
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-DTtpq82f.js";
import { t as applyMergePatch } from "./merge-patch-D43HvE6x.js";
import { o as normalizeChannelId } from "./registry-CQ3V4guW.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-BD-kXbDr.js";
import { t as isWindowsDrivePath } from "./archive-path-CxXMW_Vn.js";
import { g as writeFileWithinRoot, r as appendFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-sE-UBZ2L.js";
import { g as selectApplicableRuntimeConfig } from "./runtime-snapshot-DFeUzjt3.js";
...
import { t as isInboundPathAllowed } from "./inbound-path-policy-CmJUh_Pm.js";
...
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-C693nazc.js";
import { u as normalizeMessageChannel } from "./message-channel-DgTkFEBi.js";
import { d as readConnectPairingRequiredMessage } from "./connect-error-details-BvvJGABh.js";
...
import { n as resolveBundledPluginCompatibleLoadValues } from "./activation-context-CBRSxyff.js";
import { t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-DE3So3Se.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-BCOWYnec.js";
import { i as normalizeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-DU5_-FxH.js";
...
import { t as extractDeliveryInfo } from "./sessions-DTfZDTku.js";
import { n as resolveSessionConversationRef } from "./session-conversation-TAGeyui1.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-CbKqm0yg.js";
import { C as modelKey, _ as resolveModelRefFromString, i as buildModelAliasIndex, r as buildConfiguredModelCatalog, w as normalizeModelRef } from "./model-selection-shared-C_hgcjGe.js";
import { o as resolveDefaultModelForAgent, p as resolveThinkingDefault, t as buildAllowedModelSet } from "./model-selection-DJFAuwNY.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-CAdVMBUp.js";
import { t as requireApiKey } from "./model-auth-runtime-shared-Dqn6G6tC.js";
import { r as getApiKeyForModel } from "./model-auth-B0VX5Kxx.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-BFPeok_L.js";
import { i as SUBAGENT_SPAWN_MODES, n as spawnSubagentDirect, r as SUBAGENT_SPAWN_CONTEXT_MODES } from "./subagent-spawn-CyU0lQl-.js";
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-BnHpte4i.js";
import { i as callGateway } from "./call-BXBUsPlF.js";
import { t as resolveAgentRuntimeMetadata } from "./agent-runtime-metadata-BLpd7hMK.js";
import { n as ensureOpenClawModelsJson } from "./models-config-B12DlGPT.js";
import { n as loadModelCatalog } from "./model-catalog-hbxjrLud.js";
import { h as jsonUtf8Bytes, n as capArrayByJsonBytes, o as readSessionTitleFieldsFromTranscript } from "./session-utils.fs-CSUPtGwf.js";
import { m as resolveSessionModelIdentityRef, t as deriveSessionTitle } from "./session-utils-MHYarXtm.js";
import "./delivery-context-Cy90Hwn3.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-DHa7Y930.js";
import { A as describeSessionsHistoryTool, C as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, D as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, E as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, M as describeSessionsSendTool, N as describeSessionsSpawnTool, O as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY, P as describeUpdatePlanTool, S as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, T as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, j as describeSessionsListTool, k as describeSessionStatusTool, w as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, y as CRON_TOOL_DISPLAY_SUMMARY } from "./tool-policy-D3hzQRe0.js";
import { a as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-BgHnkp1t.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-BD-KfEME.js";
import { l as stripReasoningTagsFromText } from "./assistant-visible-text-CYb0WyAR.js";
import { n as extractTextFromChatContent } from "./chat-content-C8BtNp8Y.js";
import { r as stripToolMessages } from "./chat-history-text-DUHSRVdg.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-fh59FP1B.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-B44wpfKR.js";
import { i as resolvePluginTools } from "./tools-WWV5h-kJ.js";
import { D as textToSpeech } from "./tts-runtime-Cwx2jJaC.js";
import "./tts-CUSZMri9.js";
import { a as getImageMetadata } from "./image-ops-C6Ub2xZN.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-Ba3cieKS.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-Bfbt1cRW.js";
import { a as listChannelSupportedActions, r as listAllChannelSupportedActions } from "./channel-tools-BTBp-1RJ.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-XtCPwdrO.js";
import { t as SsrFBlockedError } from "./ssrf-nwJHqKWi.js";
import { u as parseReplyDirectives } from "./payloads-BdKEREFs.js";
import { n as runWithImageModelFallback } from "./model-fallback-DgsGm-S-.js";
import { n as extractAssistantText } from "./pi-embedded-utils-Cxk4dKhC.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-BO8e_IxA.js";
import { b as readSnakeCaseParamRaw, f as readNumberParam, g as readStringParam$1, i as asToolParamsRecord, l as jsonResult, m as readStringArrayParam, r as ToolInputError, s as imageResult } from "./common-Dke0Zlji.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-BEIr03vt.js";
import { o as trySafeFileURLToPath, r as hasEncodedFileUrlSeparator } from "./local-file-access-qbNcQjuB.js";
import { n as assertSandboxPath } from "./sandbox-paths-BQsZxg0w.js";
import { n as normalizeWorkspaceDir, o as toRelativeWorkspacePath, r as resolveWorkspaceRoot } from "./read-capability-CQ2a53Ko.js";
...
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata } from "./runtime-BU0AORQc.js";
import { t as sniffMimeFromBase64 } from "./sniff-mime-from-base64-C_c4IzoP.js";
import { a as parseCanvasSnapshotPayload, c as parseCameraSnapPayload, d as writeCameraPayloadToFile, i as canvasSnapshotTempPath, l as writeBase64ToFile, n as screenRecordTempPath, o as cameraTempPath, r as writeScreenRecordToFile, s as parseCameraClipPayload, t as parseScreenRecordPayload, u as writeCameraClipPayloadToFile } from "./nodes-screen-BzU4gXL7.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-Bqo3qlkV.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-vEQB9GPP.js";
import { r as resolveMaxDelegatesPerTurn } from "./config-DwvQ7TEM.js";
import { c as getContinuationDelegateQueueDepths, f as stagePostCompactionDelegate, s as enqueuePendingDelegate } from "./delegate-store-CVlYcoo1.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-B7dh6B_Q.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-oYb5qK3_.js";
import { t as inferLegacyName } from "./normalize-B7IaNHl6.js";
import { n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-D0Bt3D1b.js";
import { i as formatDoctorNonInteractiveHint, l as removeRestartSentinelFile, m as writeRestartSentinel, n as buildRestartSuccessContinuation } from "./restart-sentinel-CS4O9FoC.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-BKMn-_OA.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-B57hvDva.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-BHKoafk4.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-BCbMemDr.js";
import { l as saveMediaBuffer } from "./store-Bfd4_fWY.js";
import { a as classifyMediaReferenceSource, o as normalizeMediaReferenceSource, r as getDefaultLocalRoots } from "./local-media-access-DSrd27I1.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-BDQNoM-s.js";
import { a as coerceImageModelConfig, c as resolveConfiguredImageModelRefs, d as coerceToolModelConfig, f as hasAuthForProvider, l as resolveProviderVisionModelFromConfig, m as resolveDefaultModelRef, n as isMinimaxVlmProvider, o as decodeDataUrl, p as hasToolModelConfig, u as buildToolModelConfigFromCandidates } from "./minimax-vlm-C6XzMEor.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-CfyguDZu.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-BGPiPOFn.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-D64cZNOQ.js";
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-CFzn8eCU.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-B9feYjvS.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-BJtyb8qw.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-uJPc2k9s.js";
import { s as resolveTimeoutMs } from "./resolve-DXQZlXcC.js";
import { t as buildProviderRegistry } from "./runner-NRWR6G15.js";
import "./media-understanding-DPmchXrY.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-BAj2Y_gQ.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-TjUP5dxA.js";
import { o as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-BKgQ9hgh.js";
import { a as POLL_CREATION_PARAM_DEFS, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-Cx_fe5qc.js";
import { t as sendMessage } from "./message-CpR7KECZ.js";
import { n as resolveMusicGenerationModeCapabilities, t as listSupportedMusicGenerationModes } from "./capabilities-hW-jlzdz.js";
import { r as parseMusicGenerationModelRef } from "./provider-registry-Dk2t9uKY.js";
import { n as listRuntimeMusicGenerationProviders, t as generateMusic } from "./runtime-DhBsjYRE.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-DN9j6xNt.js";
import { i as failTaskRunByRunId, o as recordTaskRunProgressByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-i2h5BcKG.js";
import "./task-registry-delivery-runtime-C2RjqPnv.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-2ok-lUWi.js";
import { i as loadSessionEntryByKey, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-BsR3UGrP.js";
...
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-BozCdQH2.js";
import { t as parseTimeoutMs } from "./parse-timeout-DgeV0a4V.js";
import { t as extractPdfContent } from "./pdf-extract-kNh7dD9h.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-DOwpBwrI.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-C2yRDFhn.js";
import { n as isRequesterParentOfBackgroundAcpSession } from "./session-interaction-mode-D_BO6vzS.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, n as readLatestAssistantReply, r as readLatestAssistantReplySnapshot } from "./run-wait-B4L1m1sk.js";
import { f as runAgentStep, g as isReplySkip, h as isAnnounceSkip, m as REPLY_SKIP_TOKEN, p as ANNOUNCE_SKIP_TOKEN } from "./subagent-announce-output-BnHxIC-o.js";
import { p as registerSubagentRun } from "./subagent-registry-BCjOCdxP.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-DrwerGye.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-B5yIbtib.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, r as listSupportedVideoGenerationModes } from "./duration-support-CCwnevjG.js";
import { t as parseVideoGenerationModelRef } from "./model-ref-CXb66yFh.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-CDixhYQl.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-DvOmlb3N.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-CEONPaRh.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-Bx0xpw_y.js";
import { a as readResponseText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds } from "./web-shared-yiaF2yQK.js";
import { a as runWebSearch, i as resolveWebSearchDefinition } from "./runtime-CfUuHTiW.js";
import "./web-search-provider-common-OmvN0TlB.js";
...
function createContinueDelegateTool(opts) {
	...
	return {
		...
		description: "Schedule a continuation delegate — a background sub-agent that can run now, later, or at compaction, then return visibly or silently to this session. Use for ambient enrichment, chunked/aspected fan-out, or preserving working state across compaction. Use \"silent-wake\" when the result should quietly enrich context and wake you to act. Can be called multiple times per turn for parallel fan-out while the main session stays free. Prefer this over exec or raw sessions_spawn when the goal is gateway-managed delayed/silent/wake-on-return delegate work. This is the (a)-shape continuation surface: explicit recipient-addressing via the session-delivery-queue substrate (intra-host today). The (b)-shape evolution — broadcast/publish-stream addressing across hosts where the dispatcher names an aspect-stream and listeners tune in independently — is tracked in karmaterminal/binary-canticle#11; both shapes share the same substrate when the (b)-shape lands.",
...
async function getRuntime() {
	if (!runtimeMod) runtimeMod = await import("./embedded-gateway-stub.runtime-BInOiFDq.js");
	return runtimeMod;
}
...
function loadCommandsStatusRuntime() {
	commandsStatusRuntimePromise ??= import("./session-status.runtime-BbIlVXQL.js");
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-DE46g_N2.js");
...
async function loadAcpSpawnModule() {
	acpSpawnModulePromise ??= import("./acp-spawn-BM_FnwGa.js");
...
async function loadWebFetchRuntime() {
	webFetchRuntimePromise ??= import("./runtime-DmgrN71h.js");
	return await webFetchRuntimePromise;
}
async function loadWebGuardedFetch() {
	webGuardedFetchPromise ??= import("./web-guarded-fetch-of41oh5Q.js");
