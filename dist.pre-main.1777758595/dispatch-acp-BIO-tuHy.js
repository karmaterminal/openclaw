...
import { b as resolveAgentDir } from "./agent-scope-DfXPuZUf.js";
import { i as emitAgentEvent } from "./agent-events-DE3So3Se.js";
import { i as toAcpRuntimeError } from "./errors-B87_vHT9.js";
import { a as resolveAcpDispatchPolicyError, i as resolveAcpAgentPolicyError } from "./policy-tA7t_lVB.js";
import { s as hasOutboundReplyContent } from "./reply-payload-Bhfk5QRY.js";
import { n as formatToolSummary, r as resolveToolDisplay } from "./tool-display-CPJ_Capf.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-BuhDaYRM.js";
import { o as generateSecureUuid } from "./secure-random-CMBv2wnp.js";
import { o as createBlockReplyPipeline, r as resolveEffectiveBlockStreamingConfig, t as clampPositiveInteger } from "./block-streaming-BrFkbrpf.js";
import { o as isSessionIdentityPending, u as resolveSessionIdentityFromMeta } from "./session-identity-j27D4eCU.js";
import { r as prefixSystemMessage } from "./system-message-Dp4JHekQ.js";
import { t as createTtsDirectiveTextStreamCleaner } from "./directives-DgKz2LOK.js";
import { i as shouldCleanTtsDirectiveText, t as resolveConfiguredTtsMode } from "./tts-config-BXWmSwHc.js";
import { t as hasInboundMedia } from "./inbound-media-P4m--p-n.js";
import { t as formatAcpRuntimeErrorText } from "./error-text-Bn_wvj0G.js";
import { a as resolveAcpThreadSessionDetailLines } from "./session-identifiers-BS8e_hME.js";
import { t as resolveStatusTtsSnapshot } from "./status-config-gpSp6_8b.js";
...
function loadDispatchAcpMediaRuntime() {
	dispatchAcpMediaRuntimePromise ??= import("./dispatch-acp-media.runtime-BEU2bO_V.js");
...
function loadDispatchAcpTtsRuntime$1() {
	dispatchAcpTtsRuntimePromise$1 ??= import("./dispatch-acp-tts.runtime-D7W7D_2s.js");
	return dispatchAcpTtsRuntimePromise$1;
}
function loadChannelPluginRuntime() {
	channelPluginRuntimePromise ??= import("./plugins-dR6fOOi2.js");
	return channelPluginRuntimePromise;
}
function loadMessageActionRuntime() {
	messageActionRuntimePromise ??= import("./message-action-runner-0guFFBGe.js");
...
function loadDispatchAcpManagerRuntime() {
	dispatchAcpManagerRuntimePromise ??= import("./dispatch-acp-manager.runtime-C_jeHyMi.js");
	return dispatchAcpManagerRuntimePromise;
}
function loadDispatchAcpSessionRuntime() {
	dispatchAcpSessionRuntimePromise ??= import("./dispatch-acp-session.runtime-D5ikEa05.js");
	return dispatchAcpSessionRuntimePromise;
}
function loadDispatchAcpTtsRuntime() {
	dispatchAcpTtsRuntimePromise ??= import("./dispatch-acp-tts.runtime-D7W7D_2s.js");
	return dispatchAcpTtsRuntimePromise;
}
function loadDispatchAcpTranscriptRuntime() {
	dispatchAcpTranscriptRuntimePromise ??= import("./dispatch-acp-transcript.runtime-gmXzC-uo.js");
