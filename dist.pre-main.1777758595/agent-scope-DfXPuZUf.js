...
import { c as normalizeAgentId, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-CWdvMTMr.js";
...
import { t as resolveEffectiveAgentSkillFilter } from "./agent-filter-C2Di_i8A.js";
import fs from "node:fs";
import path from "node:path";
//#region src/agents/agent-scope-config.ts
let defaultAgentWarned = false;
function warnMultipleDefaultAgents() {
	import("./subsystem-D7--Gji4.js").then(({ createSubsystemLogger }) => {
