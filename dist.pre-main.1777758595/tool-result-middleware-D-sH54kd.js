...
import { $ as resolveProviderRuntimePlugin, p as inspectProviderToolSchemasWithPlugin, v as normalizeProviderToolSchemasWithPlugin } from "./provider-runtime-CbKqm0yg.js";
import "./model-selection-DJFAuwNY.js";
import { n as isGoogleModelApi, t as isGemma4ModelRequiringReasoningStrip } from "./google-DOSfeqQ6.js";
import { t as log$1 } from "./logger-3KEv9Tay.js";
import { k as shouldPreserveThinkingBlocks } from "./provider-model-shared-L7SDd0Sc.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolveHandlers = async () => {
		...
		resolvedHandlersPromise ??= import("./agent-tool-result-middleware-loader-B0y-sr_j.js").then(({ loadAgentToolResultMiddlewaresForRuntime }) => loadAgentToolResultMiddlewaresForRuntime({ runtime: ctx.runtime }));
