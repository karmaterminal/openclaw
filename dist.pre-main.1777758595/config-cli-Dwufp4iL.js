...
import { n as info, o as success, t as danger } from "./globals-DMzUDF8N.js";
import { a as resolveSecretRefValue } from "./resolve-GO8EgGVz.js";
import { C as validateConfigObjectRaw, u as readConfigFileSnapshot, x as collectUnsupportedSecretRefPolicyIssues } from "./io-DTtpq82f.js";
import { r as replaceConfigFile } from "./mutate--W6Y6erO.js";
import "./config-DbmohW6s.js";
import { a as normalizeConfigIssues, n as formatConfigIssueLines } from "./issue-format-CIrBljpw.js";
import { n as redactConfigObject } from "./redact-snapshot-BU_OBIBq.js";
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-CNSWg_Mj.js";
import { n as setCommandJsonMode } from "./json-mode-gYQIaJCE.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-B1tnrhVh.js");
