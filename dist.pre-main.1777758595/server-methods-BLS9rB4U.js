...
import { a as logWarn, t as logDebug } from "./logger-tSct8h87.js";
import { t as runTasksWithConcurrency } from "./run-with-concurrency-DM2J4Agp.js";
import "./auth-CxszTMg5.js";
import { t as resolveEffectiveSharedGatewayAuth } from "./auth-resolve-Q2OUKdaD.js";
import { a as isSubagentSessionKey, c as parseThreadSessionSuffix, n as isAcpSessionKey, o as parseAgentSessionKey, s as parseRawSessionConversationRef } from "./session-key-utils-B26T5hOk.js";
import { t as DEFAULT_ACCOUNT_ID } from "./account-id-N6BXsI_x.js";
import { c as normalizeAgentId, h as toAgentStoreSessionKey, o as classifySessionKeyShape, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-CWdvMTMr.js";
import { n as resolveDefaultAgentWorkspaceDir } from "./workspace-default-Dshtffqb.js";
import { S as resolveDefaultAgentId, _ as listAgentIds, b as resolveAgentDir, g as listAgentEntries, p as resolveSessionAgentId, x as resolveAgentWorkspaceDir } from "./agent-scope-DfXPuZUf.js";
import { T as validateConfigObjectWithPlugins, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, y as resolveConfigSnapshotHash } from "./io-DTtpq82f.js";
import { i as asOptionalRecord, n as asNullableRecord } from "./record-coerce-BmegIfMK.js";
import { t as applyMergePatch } from "./merge-patch-D43HvE6x.js";
import { a as normalizeChannelId, i as listChannelPlugins, t as getChannelPlugin } from "./registry-BD-kXbDr.js";
import { r as DEFAULT_PROVIDER } from "./defaults-CyUAeHC6.js";
import { i as resolveActiveTalkProviderConfig, r as normalizeTalkSection, t as buildTalkConfigResponse } from "./talk-wgoqk6op.js";
import { g as writeFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-sE-UBZ2L.js";
import { h as resolveRuntimeConfigCacheKey } from "./runtime-snapshot-DFeUzjt3.js";
...
import { f as patchPluginSessionExtension } from "./loader-UaaxQ4fP.js";
import { G as resolveMemoryDreamingConfig, H as isSameMemoryDreamingDay, J as resolveMemoryDreamingWorkspaces, K as resolveMemoryDreamingPluginConfig, W as resolveMemoryDeepDreamingConfig, X as resolveMemoryRemDreamingConfig, Y as resolveMemoryLightDreamingConfig } from "./dreaming-DQNtheXE.js";
import { a as getActivePluginRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion } from "./runtime-B-5HHEpR.js";
import { i as hasInternalHookListeners, m as triggerInternalHook } from "./internal-hooks-CL2mvBNh.js";
import { l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-DE3So3Se.js";
import { d as isPluginJsonValue } from "./host-hook-runtime-CxrLh_Yv.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey } from "./main-session-DImA1KnV.js";
import { n as canonicalizeSpawnedByForAgent, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-Bud9w99a.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent } from "./paths-BCOWYnec.js";
import { h as stringifyRouteThreadId } from "./channel-route-B76mVc9n.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, r as mergeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-DU5_-FxH.js";
import { t as loadSessionStore } from "./store-load-CDajuL7y.js";
import { n as mergeSessionEntry } from "./types-BPr0tDWQ2.js";
import { c as updateSessionStore } from "./store-APN60wqF.js";
import "./plugins-BBSdAu-6.js";
import { i as resolveMainSessionKeyFromConfig, r as resolveSessionLifecycleTimestamps, t as extractDeliveryInfo } from "./sessions-DTfZDTku.js";
import { c as resolveSessionResetPolicy, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-BlY-VzXZ.js";
import { n as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-B9Qd-qry.js";
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-DnC640Ei.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-CkJkZaS2.js";
import { d as normalizeThinkLevel, u as normalizeReasoningLevel } from "./thinking-DSGLhopZ.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-CAdVMBUp.js";
...
import { n as getDiagnosticStabilitySnapshot, r as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-3pQdx1YD.js";
import { n as normalizeSpawnedRunMetadata, r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-CXOL9esF.js";
import { t as resolveAgentRuntimeMetadata } from "./agent-runtime-metadata-BLpd7hMK.js";
import { n as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read--J9hZZm6.js";
import { a as readSessionPreviewItemsFromTranscript, i as readSessionMessages } from "./session-utils.fs-CSUPtGwf.js";
import { a as resolveSessionTranscriptCandidates, t as archiveFileOnDisk } from "./session-transcript-files.fs-DrXz3D5-.js";
...
import { _ as listCoreToolSections, h as PROFILE_OPTIONS, v as resolveCoreToolProfiles } from "./tool-policy-D3hzQRe0.js";
import { i as resolveSandboxConfigForAgent } from "./config-DU7A4GQi.js";
import { t as extractToolPayload } from "./tool-payload-C5j2HMwp.js";
import { d as listSessionCompactionCheckpoints, u as getSessionCompactionCheckpoint } from "./model-context-tokens-B6o6QLlw.js";
import { i as normalizeCronJobPatch, n as normalizeCronJobCreate } from "./openclaw-tools-DCJR53sU.js";
import { i as resolvePluginTools, r as getPluginToolMeta, t as buildPluginToolMetadataKey } from "./tools-WWV5h-kJ.js";
import { i as restoreRedactedValues, n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-BU_OBIBq.js";
import { D as textToSpeech, E as synthesizeSpeech, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, f as listTtsPersonas, g as resolveTtsConfig, h as resolveTtsAutoMode, i as getResolvedSpeechProviderConfig, l as isTtsEnabled, m as resolveExplicitTtsOverrides, o as getTtsPersona, s as getTtsProvider, u as isTtsProviderConfigured, v as resolveTtsProviderOrder, w as setTtsPersona } from "./tts-runtime-Cwx2jJaC.js";
import "./tts-CUSZMri9.js";
import { a as DEFAULT_MEMORY_FILENAME, c as DEFAULT_USER_FILENAME, f as isWorkspaceSetupCompleted, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-DSIvVEKH.js";
import { a as isTimeoutError } from "./failover-error-CQwRMDjb.js";
import { s as projectOutboundPayloadPlanForMirror, t as createOutboundPayloadPlan } from "./payloads-BdKEREFs.js";
import { N as saveExecApprovals, b as readExecApprovalsSnapshot, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, s as ensureExecApprovals } from "./exec-approvals-CSDE03Ac.js";
import { a as prepareSecretsRuntimeSnapshot } from "./runtime-BU0AORQc.js";
import { i as parseAbsoluteTimeMs } from "./stagger-oYb5qK3_.js";
import { i as resolveCronDeliverySessionKey, r as isInvalidCronSessionTargetIdError } from "./webhook-url-D0Bt3D1b.js";
import { i as formatDoctorNonInteractiveHint, m as writeRestartSentinel } from "./restart-sentinel-CS4O9FoC.js";
import { l as listConfiguredAnnounceChannelIdsForConfig } from "./channel-plugin-ids-B15YKct5.js";
import { i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry, s as dispatchChannelMessageAction } from "./message-action-runner-Cx_fe5qc.js";
import { a as resolveTrustedGroupId } from "./pi-tools.policy-D41eV0-2.js";
import { n as normalizePollInput } from "./polls-iJrk4J7V.js";
import { t as deliverOutboundPayloads } from "./deliver-BT73k34K.js";
import { n as resolveOutboundChannelPlugin } from "./channel-resolution-GtuKZpwr.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-DRUh4UTH.js";
import "./target-resolver-M5WW0ePd.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-94XEWAiQ.js";
import { i as resolveReplyToMode } from "./reply-threading-DLiKQDR7.js";
...
import { r as resolveOutboundTarget } from "./targets-CVQl2S69.js";
import { c as setHeartbeatsEnabled } from "./heartbeat-wake-20VUckmO.js";
import { i as enqueueSystemEvent, o as isSystemEventContextChanged } from "./system-events-Zf4xMpvh.js";
import { a as finalizeTaskRunByRunId, r as createRunningTaskRun } from "./detached-task-runtime-i2h5BcKG.js";
import { n as resolveAgentIdentity } from "./identity-Cojf61YG.js";
import { s as clearSessionQueues } from "./queue-aDmg4o1A.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-DFJYm-VP.js";
import { t as resolveAgentTimeoutMs } from "./timeout-CRld88BP.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-BC1EtjUv.js";
import "./skills-CtBOrA9U.js";
import { n as getActiveMemorySearchManager } from "./memory-runtime--tlqOtHw.js";
import { t as compactEmbeddedPiSession } from "./compact.queued-BaA7nHZh.js";
import "./pi-embedded-BRAWqaVM.js";
import { t as resolvePreferredSessionKeyForSessionIdMatches } from "./session-id-resolution-3v-vuQyT.js";
import { t as canExecRequestNode } from "./exec-defaults-mA4mkJDQ.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-UUKCgwWM.js";
import { a as removePairedNode, i as rejectNodePairing, l as verifyNodeToken, o as renamePairedNode, r as listNodePairing, s as requestNodePairing, t as approveNodePairing } from "./node-pairing-DIFms3ks.js";
import { t as getRemoteSkillEligibility } from "./skills-remote-CWJbKU__.js";
import { t as detectRespawnSupervisor } from "./supervisor-markers-B2Z8Wr6e.js";
import { a as getPluginCommandSpecs, r as listPluginCommands } from "./commands-BB4nEWXP.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-BTeGQ-JI.js";
import "./commands-registry-eOWtYpGJ.js";
import { n as resolveSendPolicy } from "./send-policy-BzV9Pn6k.js";
import { n as getSpeechProvider, r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-YRyHEMOh.js";
import { t as getChannelActivity } from "./channel-activity-k7zA9rsc.js";
import { t as WizardCancelledError } from "./prompts-JWnOKrjK.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-TyTJ-8tJ.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-Dq4V6KqU.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-B2HE1yjV.js";
import { t as movePathToTrash } from "./browser-trash-DM4JAkIs.js";
import "./browser-maintenance-D98him_C.js";
import { n as getLastHeartbeatEvent } from "./heartbeat-events-CG54N-Ev.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-B4Edl3nG.js";
import { n as resolvePublicAgentAvatarSource, t as resolveAgentAvatar } from "./identity-avatar-CjxzEFtV.js";
import { r as agentCommandFromIngress } from "./agent-command-D2dTFQ2c.js";
...
import { t as formatForLog } from "./ws-log-DrL3bw0w.js";
import { n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-CaPgJk2q.js";
import { r as invokeNativeHookRelay } from "./native-hook-relay-DlRxc8Sr.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-CUk5nHQT.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-DrNzKOgb.js";
import { d as rejectDevicePairing, f as removePairedDevice, g as summarizeDeviceTokens, h as rotateDeviceToken, i as formatDevicePairingForbiddenMessage, l as listDevicePairing, m as revokeDeviceToken, n as approveDevicePairing, o as getPendingDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-DinTyli9.js";
import { b as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, i as getRealtimeVoiceProvider, n as resolveConfiguredRealtimeVoiceProvider, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession } from "./session-runtime-D_CvaxJf.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-Dk8B52XF.js";
import { n as createOutboundSendDeps } from "./deps-Cix7U4f3.js";
import "./agent-ydC85aZr.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-zdFk1YtJ.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-B4Njl_4c.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-UzMjzBNW.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-rhPFPuNX.js";
import "./server-constants-CerudlGK.js";
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-kTyMtx1F.js";
import { i as resolveAgentRunExpiresAtMs, r as registerChatAbortController } from "./chat-abort-WOPrAxkZ.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-DpZS5BiY.js";
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp-X-NlvOJJ.js";
import { t as resolveSessionKeyFromResolveParams } from "./sessions-resolve-DLQ0n77E.js";
import { t as loadProviderUsageSummary } from "./provider-usage-B8gnNLfu.js";
import { o as fetchClawHubSkillDetail } from "./clawhub-M7crWBZF.js";
import { a as loadSessionUsageTimeSeries, i as loadSessionLogs, n as loadCostUsageSummary, o as resolveExistingUsageSessionFile, r as loadSessionCostSummary, t as discoverAllSessions } from "./session-cost-usage-D2VJYS4x.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-BxcmyfyC.js";
import { a as performGatewaySessionReset } from "./session-reset-service-CTl1NkiE.js";
import { t as buildChannelUiCatalog } from "./catalog-BN8jT5CN.js";
import { c as repairDreamingArtifacts, i as previewRemHarness, l as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeBackfillDiaryEntries, r as previewGroundedRemMarkdown, s as removeGroundedShortTermCandidates } from "./memory-core-bundled-runtime-Dx2W4nxC.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-CNSWg_Mj.js";
import { t as readConfiguredLogTail } from "./log-tail-B4NBw4QI.js";
import { n as purgeAgentSessionStoreEntries } from "./agents.command-shared-DlD43Gh3.js";
import { o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-Bl7-4Lwz.js";
import { t as buildChannelAccountSnapshot } from "./status-CK5udxMP.js";
import { t as installSkill } from "./skills-install-DZDEtnO9.js";
import { m as normalizeUpdateChannel } from "./update-check-DEh4oqto.js";
import { t as getStatusSummary } from "./status.summary-Y5cdDWLW.js";
import "./status-CEegGe4G.js";
import { a as resolveCronRunLogPath, n as readCronRunLogEntriesPage, r as readCronRunLogEntriesPageAll } from "./run-log-DMk1lvuQ.js";
import { i as updateSkillsFromClawHub, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-INmYpeHp.js";
import { m as readPackageVersion, n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-CZFPehzH.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-C_gzYGIu.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-BpdyvBWw.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-BZq5ddG9.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-PMkxy-Cw.js";
import { C as consumeControlPlaneWriteBudget, _ as resolveVoiceWakeRouteByTrigger, a as resolveSessionKeyForRun, b as isRoleAuthorizedForMethod, d as formatError$1, f as normalizeVoiceWakeTriggers, g as normalizeVoiceWakeRoutingConfig, h as loadVoiceWakeRoutingConfig, l as nodeWakeById, m as setVoiceWakeTriggers, n as listSystemPresence, o as NODE_WAKE_RECONNECT_RETRY_WAIT_MS, p as loadVoiceWakeConfig, r as updateSystemPresence, s as NODE_WAKE_RECONNECT_WAIT_MS, t as broadcastPresenceSnapshot, u as nodeWakeNudgeById, v as setVoiceWakeRoutingConfig, x as parseGatewayRole, y as validateVoiceWakeRoutingConfigInput } from "./presence-events-sQx98JOn.js";
import { i as buildGatewayReloadPlan, n as resolveGatewayReloadSettings, t as diffConfigPaths } from "./config-reload-8XXi1QKT.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-BRVTFaZE.js";
import { n as buildCanvasScopedHostUrl, r as mintCanvasCapabilityToken, t as CANVAS_CAPABILITY_TTL_MS } from "./canvas-capability-B7j4upXk.js";
import "./heartbeat-runner-z3DZu1bT.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-C2Vc11Hc.js";
...
async function loadSessionSubagentReactivationRuntime() {
	return import("./session-subagent-reactivation.runtime-BC4-PAdk.js");
}
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-CixdzpvL.js");
...
function loadSessionsRuntimeModule() {
	sessionsRuntimeModulePromise ??= import("./sessions.runtime-Cc0VIIQN.js");
