...
import { u as parseDiagnosticTraceparent } from "./diagnostic-trace-context-Cn2rNQJ4.js";
...
function normalizeTraceparent(traceparent) {
	...
	if (!trimmed) return;
	return parseDiagnosticTraceparent(trimmed) ? trimmed.toLowerCase() : void 0;
}
...
//#endregion
export { hasSystemEvents as a, peekSystemEvents as c, resolveSystemEventDeliveryContext as d, enqueueSystemEvent as i, removeSystemEvents as l, drainSystemEventEntries as n, isSystemEventContextChanged as o, drainSystemEvents as r, peekSystemEventEntries as s, consumeSystemEventEntries as t, resetSystemEventsForTest as u };
