...
import { n as getBridgeAuthForPort } from "./bridge-auth-registry-DF8SR5WK.js";
import { h as resolveBrowserRateLimitMessage } from "./cdp.helpers-C4M818kJ.js";
...
async function fetchBrowserJson(url, init) {
	...
	try {
		...
		const { dispatchBrowserControlRequest } = await import("./local-dispatch.runtime-CBkcMofa.js");
