...
import { a as freezeDiagnosticTraceContext, i as formatDiagnosticTraceparent, r as createDiagnosticTraceContextFromActiveScope, t as createChildDiagnosticTraceContext } from "./diagnostic-trace-context-Cn2rNQJ4.js";
import { r as emitTrustedDiagnosticEvent } from "./diagnostic-events-BOjU629z.js";
import { t as createSubsystemLogger } from "./subsystem-W9_E260X.js";
import { a as isSubagentSessionKey, n as isAcpSessionKey } from "./session-key-utils-B26T5hOk.js";
import { c as normalizeAgentId } from "./session-key-CWdvMTMr.js";
import { g as listAgentEntries, m as resolveSessionAgentIds } from "./agent-scope-DfXPuZUf.js";
import { n as resolveOwnerDisplaySetting } from "./owner-display-CiTTVhXw.js";
import { at as isCliRuntimeAlias, i as getRuntimeConfig, nt as normalizeGoogleApiBaseUrl } from "./io-DTtpq82f.js";
import { n as resolveAgentRuntimePolicy } from "./channel-env-var-names-B9sFbnYq.js";
import "./defaults-CyUAeHC6.js";
import "./config-DbmohW6s.js";
import { i as ensureGlobalUndiciStreamTimeouts, r as ensureGlobalUndiciEnvProxyDispatcher, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-BSvhgpA5.js";
...
import { i as createStreamIteratorWrapper, r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-DSd5ujzr.js";
import { y as listRegisteredAgentHarnesses } from "./loader-UaaxQ4fP.js";
import { l as listRegisteredPluginAgentPromptGuidance } from "./command-registration-DII73eqZ.js";
import { c as fireAndForgetBoundedHook, t as getGlobalHookRunner } from "./hook-runner-global-CbPxjSBS.js";
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-B-5HHEpR.js";
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent } from "./agent-events-DE3So3Se.js";
import { n as acquireSessionWriteLock, o as resolveSessionLockMaxHoldFromTimeout } from "./session-write-lock-K7vHGDEi.js";
import { c as resolveAssistantMessagePhase, o as parseAssistantTextSignature } from "./chat-message-content-D6D-0R9c.js";
import { F as resolveProviderTextTransforms, K as transformProviderSystemPrompt, P as resolveProviderSystemPromptContribution } from "./provider-runtime-CbKqm0yg.js";
...
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-CS5nHh_A.js";
import { t as sanitizeForConsole } from "./console-sanitize-aXe_dhYm.js";
import { u as resolveModelAuthMode } from "./model-auth-B0VX5Kxx.js";
import { f as setActiveEmbeddedRun, p as updateActiveEmbeddedRunSnapshot, r as clearActiveEmbeddedRun } from "./runs-DkQmuNSQ.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-BFPeok_L.js";
import { i as resolveSubagentCapabilityStore, t as isSubagentEnvelopeSession } from "./subagent-capabilities-51thCj20.js";
import { n as resolveEmbeddedAgentHarnessFallback, r as resolveEmbeddedAgentRuntime, t as normalizeEmbeddedAgentRuntime } from "./runtime-xOcPge5e.js";
import { a as makeZeroUsageSnapshot, i as hasNonzeroUsage, o as normalizeUsage } from "./usage-CbNR5ctp.js";
import { t as parseInlineDirectives } from "./directive-tags-Ch33OUaF.js";
import { u as stripRuntimeContextCustomMessages } from "./internal-runtime-context-DPUTT2wY.js";
import { p as normalizeToolName } from "./tool-policy-D3hzQRe0.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-9Sc5uXER.js";
import { a as stripDowngradedToolCallText, c as hasOrphanReasoningCloseBoundary } from "./assistant-visible-text-CYb0WyAR.js";
import { n as extractTextFromChatContent, t as coerceChatContentText } from "./chat-content-C8BtNp8Y.js";
import { f as stableStringify$1, h as parseExecApprovalResultText } from "./sanitize-user-facing-text-BkLQoEce.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, r as isSilentReplyPayloadText } from "./tokens-fh59FP1B.js";
import { t as filterHeartbeatPairs } from "./heartbeat-filter-CcDPkgg0.js";
import { _ as isStrictAgenticSupportedProviderModel, v as stripProviderPrefix, y as isEmbeddedMode } from "./openclaw-tools-DCJR53sU.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-Dbe01-bB.js";
import { t as getMachineDisplayName } from "./machine-name-gkQJscAl.js";
import { m as MAX_IMAGE_BYTES } from "./mime-B44wpfKR.js";
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-5JsLClXq.js";
import { r as getPluginToolMeta } from "./tools-WWV5h-kJ.js";
import { n as redactConfigObject } from "./redact-snapshot-BU_OBIBq.js";
import { n as resolveCommitHash } from "./git-commit-BtDP4-Cf.js";
import { t as resolveOsSummary } from "./os-summary-l5Jk4zdu.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-CaFccI3v.js";
import { n as sanitizeDiagnosticPayload, t as safeJsonStringify } from "./safe-json-Ag03kqtT.js";
import { n as toTrajectoryToolDefinitions, r as getQueuedFileWriter, t as createTrajectoryRuntimeRecorder } from "./runtime-BpDP-95O.js";
import { t as parseBooleanValue } from "./boolean-DNIxlqz8.js";
import { n as buildTtsSystemPromptHint } from "./tts-runtime-Cwx2jJaC.js";
import "./tts-CUSZMri9.js";
import { B as dropReasoningFromHistory, C as validateReplayTurns, D as buildEmbeddedExtensionFactories, E as limitHistoryTurns, F as readLastCacheTtlTimestamp, H as isZeroUsageEmptyStopAssistantTurn, I as guardSessionManager, K as isReasoningTagProvider, L as repairSessionFileIfNeeded, N as resolveCompactionTimeoutMs, P as isCacheTtlEligibleProvider, R as collectRuntimeChannelCapabilities, S as sanitizeSessionHistory, T as getDmHistoryLimitFromSessionKey, U as releaseWsSession, V as dropThinkingBlocks, W as buildStreamErrorAssistantMessage, _ as resolveEmbeddedAgentStreamFn, a as mapThinkingLevel, b as trackSessionManagerAccess, c as collectAllowedToolNames, d as applySystemPromptOverrideToSession, f as buildEmbeddedSystemPrompt, g as resolveEmbeddedAgentBaseStreamFn, h as resolveEmbeddedAgentApiKey, i as flushPendingToolResultsAfterIdle, l as collectRegisteredToolNames, m as describeEmbeddedAgentStreamStrategy, n as shouldRotateCompactionTranscript, o as splitSdkTools, p as createSystemPromptOverride, s as PI_RESERVED_TOOL_NAMES, t as rotateTranscriptAfterCompaction, u as toSessionToolAllowlist, v as resolveEmbeddedRunSkillEntries, w as buildEmbeddedMessageActionDiscoveryInput, x as normalizeAssistantReplayContent, y as prewarmSessionFile, z as assessLastAssistantMessage } from "./compaction-successor-transcript-BCy1H5AJ.js";
import { a as prependBootstrapPromptWarning, i as buildBootstrapTruncationReportMeta, n as buildBootstrapInjectionStats, r as buildBootstrapPromptWarning, t as analyzeBootstrapBudget } from "./bootstrap-budget-Dw_ujOAF.js";
import { d as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-DSIvVEKH.js";
import { a as resolveContextInjectionMode, i as resolveBootstrapContextForRun, n as hasCompletedBootstrapTurn, r as makeBootstrapWarn, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-DHRvrX6u.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-GgBePb3F.js";
import { a as resolveBootstrapMaxChars, o as resolveBootstrapPromptTruncationWarningMode, s as resolveBootstrapTotalMaxChars } from "./google-DOSfeqQ6.js";
import { a as formatAssistantErrorText, l as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-CTr-JKNG.js";
import { a as isMessagingToolDuplicateNormalized, c as downgradeOpenAIFunctionCallReasoningPairs, l as downgradeOpenAIReasoningBlocks, n as validateGeminiTurns, o as normalizeTextForComparison, t as validateAnthropicTurns } from "./pi-embedded-helpers-BCdH26FE.js";
import { o as hasUnredactedSessionsSpawnAttachments, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-xPmSHEyG.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-Ba3cieKS.js";
import { a as listChannelSupportedActions, c as resolveChannelReactionGuidance, o as resolveChannelMessageToolHints } from "./channel-tools-BTBp-1RJ.js";
import { i as resolveOpenClawReferencePaths } from "./docs-path-DIWmvFM2.js";
import { a as isTimeoutError } from "./failover-error-CQwRMDjb.js";
import { t as buildModelAliasLines } from "./model-alias-lines-DJ2g50X8.js";
import { n as resolveTranscriptPolicy, o as collectTextContentBlocks, r as shouldAllowProviderOwnedThinkingReplay, s as supportsModelTools } from "./tool-result-middleware-D-sH54kd.js";
import { g as sanitizeTransportPayloadText, p as mergeTransportHeaders, v as buildGuardedModelFetch } from "./openai-transport-stream-Dh04IWDk.js";
import { t as log$4 } from "./logger-3KEv9Tay.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-DE9TmAEa.js";
import { g as streamWithPayloadPatch } from "./provider-model-shared-L7SDd0Sc.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing } from "./session-transcript-repair-OPD38lTb.js";
import { t as registerProviderStreamForModel } from "./provider-stream-BWhGSMXf.js";
import { t as createBundleLspToolRuntime } from "./pi-bundle-lsp-runtime-DW8yzkOX.js";
import { o as getOrCreateSessionMcpRuntime } from "./pi-bundle-mcp-runtime-BuGXdJuK.js";
import { n as materializeBundleMcpToolsForRun } from "./pi-bundle-mcp-materialize-CwlYy9fV.js";
import "./pi-bundle-mcp-tools-ClCYHpoW.js";
import { n as setReplyPayloadMetadata } from "./reply-payload-DuTGAZBT.js";
import { r as parseFenceSpans } from "./fences-CgyEydv0.js";
import { r as splitMediaFromOutput } from "./parse-BVm5Z7cY.js";
import { u as parseReplyDirectives } from "./payloads-BdKEREFs.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-Bhfk5QRY.js";
import { C as formatToolAggregate, S as isMessagingToolSendAction, _ as isToolResultError, b as sanitizeToolResult, d as runAgentCleanupStep, f as extractMessagingToolSend, g as filterToolResultMediaUrls, h as extractToolResultText, l as logAgentRuntimeToolDiagnostics, m as extractToolResultMediaArtifact, n as assembleHarnessContextEngine, o as finalizeHarnessContextEngineTurn, p as extractToolErrorMessage, r as bootstrapHarnessContextEngine, t as buildEmbeddedAttemptToolRunContext, u as normalizeAgentRuntimeTools, v as isToolResultTimedOut, x as isMessagingTool, y as sanitizeToolArgs } from "./attempt.tool-run-context-Ca8gOFQe.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-BuhDaYRM.js";
import { o as buildApiErrorObservationFields, s as buildTextObservationFields } from "./model-fallback-DgsGm-S-.js";
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-ClFthIAn.js";
...
import { c as normalizeCompactionTrigger } from "./request-compaction-tool-BO8e_IxA.js";
import { c as formatContextLimitTruncationNotice, l as createPreparedEmbeddedPiSettingsManager, o as truncateOversizedToolResultsInSessionManager, r as resolveLiveToolResultMaxChars } from "./tool-result-truncation-DvH7IKwl.js";
import { n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-he7Ftapi.js";
import { i as diagnosticProviderRequestIdHash, n as diagnosticErrorFailureKind, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-Cp-ZCy_z.js";
import { i as toClientToolDefinitions, n as findClientToolNameConflicts, t as createClientToolNameConflictError } from "./pi-tool-definition-adapter-BrqjtrRR.js";
import { n as resolveToolLoopDetectionConfig, t as createOpenClawCodingTools } from "./pi-tools-BaanW2ye.js";
import { i as resolveSubagentToolPolicyForSession, n as resolveEffectiveToolPolicy, r as resolveGroupToolPolicy } from "./pi-tools.policy-D41eV0-2.js";
import { t as resolveAgentTimeoutMs } from "./timeout-CRld88BP.js";
import { o as resolveSandboxContext } from "./sandbox-DkLicFcl.js";
import { t as detectRuntimeShell } from "./shell-utils-CD0aHmgK.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-FkgJuEoY.js";
import { s as resolveSkillsPromptForRun } from "./workspace-BC1EtjUv.js";
import "./skills-CtBOrA9U.js";
import { t as resolveSystemPromptOverride } from "./system-prompt-override-CaKRsW2d.js";
import { t as buildSystemPromptParams } from "./system-prompt-params-Dyzqc8CS.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-D0LYkpaS.js";
import "./tool-loop-detection-B2ZXqP4H.js";
import { o as createHtmlEntityToolCallArgumentDecodingWrapper, w as visitObjectContentBlocks } from "./provider-stream-shared-C7UoUn4N.js";
import { n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-B7D5HkvY.js";
import { t as runContextEngineMaintenance } from "./context-engine-maintenance-D_zcDKZX.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-DgTdZMCd.js";
import { n as buildAgentUserPromptPrefix } from "./system-prompt-By0TAv8Q.js";
import { t as parseGeminiAuth } from "./gemini-auth-DTQ2aMLt.js";
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-7JK2d_hb.js";
import { n as shouldPreemptivelyCompactBeforePrompt, t as PREEMPTIVE_OVERFLOW_ERROR_TEXT } from "./preemptive-compaction-B0vzj3Oq.js";
...
import { a as shouldUseOpenAIWebSocketTransport, i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-LYOdChkP.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-D7ODCxJD.js";
import { t as detectAndLoadPromptImages } from "./images-DQhNRDfp.js";
import { i as resolveRuntimeContextPromptParts, r as queueRuntimeContextForNextTurn, t as buildRuntimeContextSystemContext } from "./runtime-context-prompt-Jyw3ILOq.js";
...
async function reconcileSessionStoreCompactionCountAfterSuccess(params) {
	const { reconcileSessionStoreCompactionCountAfterSuccess: reconcile } = await import("./pi-embedded-subscribe.handlers.compaction.runtime-BJEW0a5m.js");
...
function loadExecApprovalReply() {
	execApprovalReplyModulePromise ??= import("./exec-approval-reply-ZWIP9OCw.js");
	return execApprovalReplyModulePromise;
}
function loadHookRunnerGlobal() {
	hookRunnerGlobalModulePromise ??= import("./hook-runner-global-DmnQbDk7.js");
	return hookRunnerGlobalModulePromise;
}
function loadMediaParse() {
	mediaParseModulePromise ??= import("./parse-BGIZnzPw.js");
	return mediaParseModulePromise;
}
function loadBeforeToolCall() {
	beforeToolCallModulePromise ??= import("./pi-tools.before-tool-call-BYQnUSlm.js");
...
//#endregion
export { shouldTreatEmptyAssistantReplyAsSilent as C, resolveSilentToolResultReplyPayload as S, observeReplayMetadata as T, resolvePlanningOnlyRetryInstruction as _, createEmbeddedRunStageTracker as a, resolveReplayInvalidFlag as b, resolveBootstrapMode as c, extractPlanningOnlyPlanDetails as d, isLikelyExecutionAckPrompt as f, resolveIncompleteTurnPayloadText as g, resolveEmptyResponseRetryInstruction as h, selectAgentHarness as i, prepareSessionManagerForRun as l, resolveAttemptReplayMetadata as m, resolveAgentHarnessPolicy as n, formatEmbeddedRunStageSummary as o, resolveAckExecutionFastPathInstruction as p, runAgentHarnessAttemptWithFallback as r, shouldWarnEmbeddedRunStageSummary as s, maybeCompactAgentHarnessSession as t, STRICT_AGENTIC_BLOCKED_TEXT as u, resolvePlanningOnlyRetryLimit as v, createEmbeddedRunReplayState as w, resolveRunLivenessState as x, resolveReasoningOnlyRetryInstruction as y };
