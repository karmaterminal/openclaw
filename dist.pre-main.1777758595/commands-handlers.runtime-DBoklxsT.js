...
import { r as logVerbose } from "./globals-DMzUDF8N.js";
import { r as normalizeOptionalAccountId } from "./account-id-N6BXsI_x.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-CWdvMTMr.js";
import { b as resolveAgentDir, p as resolveSessionAgentId, x as resolveAgentWorkspaceDir } from "./agent-scope-DfXPuZUf.js";
import { F as unsetConfigOverride, M as getConfigOverrides, N as resetConfigOverrides, P as setConfigOverride, T as validateConfigObjectWithPlugins, u as readConfigFileSnapshot } from "./io-DTtpq82f.js";
import { o as normalizeChannelId } from "./registry-CQ3V4guW.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-BD-kXbDr.js";
import { f as resolveArchiveKind } from "./archive-Bdbg1QXM.js";
import "./installed-plugin-index-records-BDMzr30g.js";
import { i as unsetConfigValueAtPath, n as parseConfigPath, r as setConfigValueAtPath, t as getConfigValueAtPath } from "./config-paths-Bu_vLdUk.js";
...
import { n as isRestartEnabled, t as isCommandFlagEnabled } from "./commands.flags-DCoMs1RR.js";
import { i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES } from "./client-info-a1QfCw6W.js";
import { r as isInternalMessageChannel, u as normalizeMessageChannel } from "./message-channel-DgTkFEBi.js";
import { d as scheduleGatewaySigusr1Restart, m as triggerOpenClawRestart } from "./restart-D_GM-Kpn.js";
import { t as getActivePluginChannelRegistry } from "./runtime-B-5HHEpR.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-CL2mvBNh.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, r as resolveDefaultSessionStorePath } from "./paths-BCOWYnec.js";
...
import { r as readLatestAssistantTextFromSessionTranscript } from "./transcript-y-FZWM2K.js";
import { x as prepareProviderRuntimeAuth } from "./provider-runtime-CbKqm0yg.js";
import { h as resolveResponseUsageMode, p as normalizeUsageDisplay } from "./thinking-DSGLhopZ.js";
...
import { a as getActiveEmbeddedRunSnapshot, y as replyRunRegistry } from "./runs-DkQmuNSQ.js";
import "./diagnostic-DsZ4vZSS.js";
import { t as diagnosticLogger } from "./diagnostic-runtime-CR_pjFfz.js";
import { i as callGateway } from "./call-BXBUsPlF.js";
import { n as ensureOpenClawModelsJson } from "./models-config-B12DlGPT.js";
import { i as formatUsd, r as formatTokenCount } from "./usage-format-BPKeRNYU.js";
import { n as stripInboundMetadata } from "./strip-inbound-meta-BDl97B8O.js";
import { r as getSessionBindingService } from "./session-binding-service-CyE0msFO.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-9Sc5uXER.js";
import { r as isSilentReplyPayloadText } from "./tokens-fh59FP1B.js";
import { C as setTtsMaxLength, D as textToSpeech, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, a as getTtsMaxLength, b as setSummarizationEnabled, c as isSummarizationEnabled, f as listTtsPersonas, g as resolveTtsConfig, i as getResolvedSpeechProviderConfig, l as isTtsEnabled, o as getTtsPersona, r as getLastTtsAttempt, s as getTtsProvider, u as isTtsProviderConfigured, w as setTtsPersona, y as setLastTtsAttempt } from "./tts-runtime-Cwx2jJaC.js";
import "./tts-CUSZMri9.js";
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-Dw_ujOAF.js";
import { a as resolveBootstrapMaxChars, s as resolveBootstrapTotalMaxChars } from "./google-DOSfeqQ6.js";
import { i as resolveImageSanitizationLimits, n as sanitizeImageBlocks } from "./tool-images-Ba3cieKS.js";
import { g as streamWithPayloadPatch } from "./provider-model-shared-L7SDd0Sc.js";
import { a as stripToolResultDetails } from "./session-transcript-repair-OPD38lTb.js";
...
import { a as isCompactionSkipReason } from "./request-compaction-tool-BO8e_IxA.js";
...
import { _ as authorizeConfigWriteShared, b as resolveConfigWriteTargetFromPathShared, v as canBypassConfigWritePolicyShared, y as formatConfigWriteDeniedMessageShared } from "./channel-config-helpers-Cc367LxV.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-DN9j6xNt.js";
import { n as routeReply } from "./route-reply-Dq73jIL9.js";
import { s as clearSessionQueues } from "./queue-aDmg4o1A.js";
import { t as formatDurationCompact } from "./format-duration-CgqjJi6G.js";
import "./sandbox-DkLicFcl.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-D0LYkpaS.js";
import { n as estimateTokensFromChars } from "./cjk-chars-B7xlImzJ.js";
import { r as resolveModelWithRegistry } from "./model-DgTjq0II.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-HOMX1iDx.js";
import { v as getFinishedSession, y as getSession } from "./bash-tools.exec-runtime-HNIg3qBK.js";
import { n as formatTimeAgo } from "./format-relative-Cgoykt9S.js";
import { i as matchPluginCommand, n as executePluginCommand } from "./commands-BB4nEWXP.js";
import { t as isApprovalNotFoundError } from "./approval-errors-k1AK-7qR.js";
import { i as resolveTextCommand, r as normalizeCommandBody } from "./commands-registry-normalize-BXbF0vyh.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-C30NOr8H.js";
...
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-gKqGWtZG.js";
import { o as stripMentions, s as stripStructuralPrefixes } from "./mentions-DXCq8bbC.js";
...
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-Dn7XE0de.js";
import { t as handleCrestodianCommand } from "./commands-crestodian-D9BiCPc4.js";
import { i as installPluginFromPath, r as installPluginFromNpmSpec } from "./install-BjObslWW.js";
import { n as isImplicitSameChatApprovalAuthorization } from "./approval-auth-helpers-xFyaaLnA.js";
import { n as parseActivationCommand } from "./group-activation-DxK9n1x8.js";
import { t as resolveFastModeState } from "./fast-mode-B04OKReC.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-DvOVcLpe.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-DgurTbPv.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-Clw7Uf1n.js";
import { a as shouldPersistAbortCutoff, i as resolveAbortCutoffFromContext, t as applyAbortCutoffToSessionEntry } from "./abort-cutoff-BWqiFXSI.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-Dq4V6KqU.js";
import { n as resolveSessionEntryForKey, r as stopSubagentsForRequester, t as formatAbortReplyText } from "./abort-DeqA8ecs.js";
import { t as extractBtwQuestion } from "./btw-command-kgK67-Mv.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-0Jf00GFY.js";
import { a as requireGatewayClientScopeForInternalChannel, i as requireCommandFlagEnabled, n as rejectNonOwnerCommand, r as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates-CyeWKPPd.js";
import { t as handleAcpCommand } from "./commands-acp-BdV-0zC2.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-GCEmSHaE.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-CUk5nHQT.js";
import { r as handleModelsCommand } from "./commands-models-Bg9p1ArG.js";
import { t as setPluginEnabledInConfig } from "./toggle-config-CVRNwT8w.js";
import { r as createExecTool } from "./bash-tools-DTqu6kFy.js";
import { n as listTasksForAgentIdForStatus, r as listTasksForSessionKeyForStatus } from "./status-text-B7Wa0Z5I.js";
import { d as resolveChannelAccountId, f as resolveCommandSurfaceChannel, l as resolveSubagentsAction, o as resolveHandledPrefix, s as resolveRequesterSessionKey, u as stopWithText } from "./shared-CeiTa22_.js";
import { t as buildToolsMessage } from "./status-C_WHM5Wl.js";
import { i as parseConfigValue, n as setConfiguredMcpServer, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-DVXMLK1f.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-CEu4pK4t.js";
import "./command-export-B8lXHIf9.js";
import { t as buildStatusReply } from "./commands-status-e8NBJ1az.js";
import { n as persistPluginInstall, r as buildNpmInstallRecordFields } from "./plugins-install-persist-BUmMac0Q.js";
import { t as parseClawHubPluginSpec } from "./clawhub-spec-BlONCB9R.js";
import "./clawhub-M7crWBZF.js";
import { n as installPluginFromClawHub } from "./clawhub-VlDfK9rk.js";
import { a as buildPluginDiagnosticsReport, l as formatPluginCompatibilityNotice, o as buildPluginInspectReport, s as buildPluginRegistrySnapshotReport, t as buildAllPluginInspectReports } from "./status-DlA41-uQ.js";
import { a as createPluginInstallLogger, f as resolveFileNpmSpecToLocalPath, o as decidePreferredClawHubFallback, r as buildPreferredClawHubSpec } from "./plugins-command-helpers-CP3p5yrN.js";
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-AWQIt_5z.js";
import { n as loadCostUsageSummary, r as loadSessionCostSummary } from "./session-cost-usage-D2VJYS4x.js";
...
async function handleBashChatCommand(params) {
	...
	if (request.action === "stop") {
		...
		const { killProcessTree } = await import("./kill-tree-CrDz29CE.js");
		killProcessTree(pid);
...
function loadCompactRuntime() {
	compactRuntimePromise ??= import("./commands-compact.runtime-BNtjrOgN.js");
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-CJidj7sq.js");
...
async function abortEmbeddedPiRunForSession(sessionId) {
	const { abortEmbeddedPiRun } = await import("./runs-BlkHfUcL.js");
...
function loadAgentsAction() {
	actionAgentsPromise ??= import("./action-agents-BHYh-uER.js");
	return actionAgentsPromise;
}
function loadFocusAction() {
	actionFocusPromise ??= import("./action-focus-AoJqRmLE.js");
	return actionFocusPromise;
}
function loadHelpAction() {
	actionHelpPromise ??= import("./action-help-D8EoWNEJ.js");
	return actionHelpPromise;
}
function loadInfoAction() {
	actionInfoPromise ??= import("./action-info-BNyvKEGu.js");
	return actionInfoPromise;
}
function loadKillAction() {
	actionKillPromise ??= import("./action-kill-BgkQ1RUF.js");
	return actionKillPromise;
}
function loadListAction() {
	actionListPromise ??= import("./action-list-lCVFrNin.js");
	return actionListPromise;
}
function loadLogAction() {
	actionLogPromise ??= import("./action-log-BGYNbpUn.js");
	return actionLogPromise;
}
function loadSendAction() {
	actionSendPromise ??= import("./action-send-C8JCvK4Q.js");
	return actionSendPromise;
}
function loadSpawnAction() {
	actionSpawnPromise ??= import("./action-spawn-BHNtD6lH.js");
	return actionSpawnPromise;
}
function loadUnfocusAction() {
	actionUnfocusPromise ??= import("./action-unfocus-BUdcjOPq.js");
	return actionUnfocusPromise;
}
function loadControlRuntime() {
	controlRuntimePromise ??= import("./commands-subagents-control.runtime-BVM_IBSI.js");
