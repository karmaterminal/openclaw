...
import { o as getResolvedLoggerSettings } from "./logger-BnvCi6Wb.js";
import { t as danger } from "./globals-DMzUDF8N.js";
...
import { i as getBundledChannelSetupPlugin } from "./bundled-CDosciCV.js";
...
import { a as normalizeChannelId$1, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-BD-kXbDr.js";
...
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-Bfbt1cRW.js";
import { n as listReadOnlyChannelPluginsForConfig } from "./read-only-CVZFeG4b.js";
...
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-DVrEb58F.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-DB1Y49FN.js";
...
import { n as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-DsviN55l.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-D9edSpCU.js";
import { n as resolveLogFile } from "./log-tail-B4NBw4QI.js";
import { t as parseLogLine } from "./parse-log-line-CorEUPki.js";
import { a as describeBinding, t as applyAgentBindings } from "./agents.bindings-DNiACG3M.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-CoFaIyIP.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-CkXOFwdt.js";
import { t as channelsListCommand } from "./list-Cr9ecMlk.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-aDAYp7BA.js";
...
function loadChannelSetupPluginInstall() {
	channelSetupPluginInstallPromise ??= import("./plugin-install-CmgtySyq.js");
	return channelSetupPluginInstallPromise;
}
function loadOnboardChannels() {
	onboardChannelsPromise ??= import("./onboard-channels-CoWycOHx.js");
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-C8sdzfFA.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-pXvsaYQD.js").then(({ listChannelPluginCatalogEntries }) => listChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-DygInlTF.js"), loadOnboardChannels()]);
	...
	if (!channel && catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-DgfFbd-n.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-Ce0Vu1av.js");
