...
import { t as PLUGIN_REGISTRY_STATE } from "./runtime-state-DAi7EyNz.js";
import { l as onAgentEvent } from "./agent-events-DE3So3Se.js";
import { i as dispatchPluginAgentEventSubscriptions, n as clearPluginHostRuntimeState } from "./host-hook-runtime-CxrLh_Yv.js";
...
async function cleanupPreviousPluginHostRegistry(params) {
	const [{ getRuntimeConfig }, { cleanupReplacedPluginHostRegistry }] = await Promise.all([import("./config/config.js"), import("./host-hook-cleanup-BOk5Yzt7.js")]);
