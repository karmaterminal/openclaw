...
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "./webhook-request-guards-DP0wn7J-.js";
import { _ as resolveRealtimeVoiceAgentConsultTools, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, v as resolveRealtimeVoiceAgentConsultToolsAllow } from "./session-runtime-D_CvaxJf.js";
import { o as consultRealtimeVoiceAgent, t as convertPcmToMulaw8k } from "./realtime-voice-BtAoh9-8.js";
import { t as resolveConfiguredCapabilityProvider } from "./provider-selection-runtime-BP3s-8_U.js";
import { t as zod_exports } from "./zod-O95JdqV1.js";
import "./api-_JkpPGqp.js";
import { a as deepMergeDefined, i as validateProviderConfig, n as normalizeVoiceCallConfig, r as resolveVoiceCallConfig } from "./config-BcLMfbgm.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-BekozjmT.js";
import { t as resolveVoiceResponseModel } from "./response-model-Bf4CdZeb.js";
import { t as isProviderStatusTerminal } from "./call-status-B4-3JL8R.js";
import { t as getHeader } from "./http-headers-DLWOkgVf.js";
...
function loadRealtimeTranscriptionRuntime() {
	realtimeTranscriptionRuntimePromise ??= import("./realtime-transcription.runtime-k12Xz8Ky.js");
	return realtimeTranscriptionRuntimePromise;
}
function loadResponseGeneratorModule() {
	responseGeneratorModulePromise ??= import("./response-generator-BszxeVqQ.js");
...
function loadTelnyxProvider() {
	telnyxProviderPromise ??= import("./telnyx-DZlZMzVW.js");
	return telnyxProviderPromise;
}
function loadTwilioProvider() {
	twilioProviderPromise ??= import("./twilio-fVxkvFFD.js");
	return twilioProviderPromise;
}
function loadPlivoProvider() {
	plivoProviderPromise ??= import("./plivo-DAXBBRui.js");
	return plivoProviderPromise;
}
function loadMockProvider() {
	mockProviderPromise ??= import("./mock-C3mlRh4X.js");
	return mockProviderPromise;
}
function loadRealtimeVoiceRuntime() {
	realtimeVoiceRuntimePromise ??= import("./realtime-voice.runtime-BjPKP2S2.js");
	return realtimeVoiceRuntimePromise;
}
function loadRealtimeHandler() {
	realtimeHandlerPromise ??= import("./realtime-handler-BVi0vHZ3.js");
