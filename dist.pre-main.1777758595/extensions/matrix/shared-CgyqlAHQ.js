...
import { n as resolveMatrixAuth, r as resolveMatrixAuthContext } from "./config-BpgBKVSD.js";
...
async function loadMatrixCreateClientDeps() {
	matrixCreateClientDepsPromise ??= import("./create-client-BfvlXFca.js").then((n) => n.n).then((runtime) => ({ createMatrixClient: runtime.createMatrixClient }));
