...
function loadMatrixVerificationRuntime() {
	matrixVerificationRuntimePromise ??= import("./verification-1ZIbhYsJ.js").then((n) => n.y);
...
async function ensureMatrixCryptoRuntime(...args) {
	const { ensureMatrixCryptoRuntime: ensureRuntime } = await import("./deps-BzNGG-kX.js").then((n) => n.t);
