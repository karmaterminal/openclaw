...
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-B8u4vF9P.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-KF01E9CM.js";
import { i as resolveScopedMatrixEnvConfig, n as resolveGlobalMatrixEnvConfig } from "./env-auth-Bon-uKig.js";
...
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-aY8htdj3.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-sLtNeBt-.js").then((n) => n.n), import("./logging-DXhjK3XW.js").then((n) => n.n)]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-0ge7H0Ls.js").then((n) => n.r).then((credentialsReadModule) => ({
...
async function loadMatrixCredentialsWriteRuntime() {
	matrixCredentialsWriteRuntimePromise ??= import("./credentials-write.runtime-DIrv49RQ.js");
