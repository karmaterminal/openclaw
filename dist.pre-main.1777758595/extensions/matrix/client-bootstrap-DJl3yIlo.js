...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-pB6lGsuQ.js").then((n) => n.t), import("./shared-CgyqlAHQ.js").then((n) => n.a)]).then(([clientModule, sharedModule]) => ({
