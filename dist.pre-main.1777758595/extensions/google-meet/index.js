...
import "../../gateway-runtime-xmx2b4hR.js";
import { n as callGatewayFromCli } from "../../gateway-rpc-O7AJpLTx.js";
import { _ as resolveRealtimeVoiceAgentConsultTools, b as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, f as buildRealtimeVoiceAgentConsultWorkingResponse, g as resolveRealtimeVoiceAgentConsultToolPolicy, n as resolveConfiguredRealtimeVoiceProvider, t as createRealtimeVoiceBridgeSession, v as resolveRealtimeVoiceAgentConsultToolsAllow, y as REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ } from "../../session-runtime-D_CvaxJf.js";
import { o as consultRealtimeVoiceAgent } from "../../realtime-voice-BtAoh9-8.js";
import { a as fetchGoogleMeetSpace, i as fetchGoogleMeetAttendance, o as fetchLatestGoogleMeetConferenceRecord, r as fetchGoogleMeetArtifacts, t as buildGoogleMeetPreflightReport } from "../../meet-Bhf-jUaa.js";
import { n as findGoogleMeetCalendarEvent, r as listGoogleMeetCalendarEvents, t as buildGoogleMeetCalendarDayWindow } from "../../calendar-bmtlFsb5.js";
import { a as isSameMeetUrlForReuse, c as resolveChromeNode, i as callBrowserProxyOnNode, l as resolveChromeNodeInfo, n as isGoogleMeetBrowserManualActionError, o as normalizeMeetUrlForReuse, r as asBrowserTabs, s as readBrowserTab, t as createMeetWithBrowserProxyOnNode } from "../../chrome-create-VDPIbKu5.js";
...
async function createMeetFromParams(params) {
	return (await import("../../create-M3jkn5Oa.js")).createMeetFromParams(params);
}
async function createAndJoinMeetFromParams(params) {
	return (await import("../../create-M3jkn5Oa.js")).createAndJoinMeetFromParams(params);
}
async function resolveGoogleMeetTokenFromParams(config, raw) {
	const { resolveGoogleMeetAccessToken } = await import("../../oauth-CK42DGhg.js");
...
async function exportGoogleMeetBundleFromParams(config, raw) {
	...
	const { buildGoogleMeetExportManifest, googleMeetExportFileNames, writeMeetExportBundle } = await import("../../cli-D2VWj-5O.js");
...
var google_meet_default = definePluginEntry({
	...
	register(api) {
		...
		api.registerCli(async ({ program }) => {
			const { registerGoogleMeetCli } = await import("../../cli-D2VWj-5O.js");
