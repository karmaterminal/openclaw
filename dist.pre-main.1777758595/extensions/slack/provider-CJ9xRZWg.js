import { a as resolveSlackAccount, d as resolveSlackBotToken, o as resolveSlackAccountAllowFrom, s as resolveSlackAccountDmPolicy, u as resolveSlackAppToken } from "./accounts-BMtNfl5Z.js";
import { i as isSlackExecApprovalClientEnabled, n as isSlackExecApprovalApprover, r as isSlackExecApprovalAuthorizedSender } from "./exec-approvals-BEeYbn_e.js";
import "./blocks-render-BA5Iijiy.js";
import { n as truncateSlackText, t as SLACK_TEXT_LIMIT } from "./limits-7Opyc6nA.js";
import { c as resolveSlackWebClientOptions } from "./client-CPe4GmDR.js";
import { n as normalizeAllowList, o as resolveSlackAllowListMatch, s as resolveSlackUserAllowed } from "./allow-list-DrqC25jf.js";
...
import { D as resolveSlackSlashCommandConfig, E as buildSlackSlashCommandMatcher, O as stripSlackMentionsForCommandDetection, S as resolveOpenProviderRuntimeGroupPolicy, T as warnMissingProviderGroupPolicyFallbackOnce, _ as getRuntimeConfig$1, d as createSlackMonitorContext, f as isSlackChannelAllowedByPolicy, g as resolveSlackChannelLabel, h as resolveSlackChannelConfig, i as parsePluginBindingApprovalCustomId, l as authorizeSlackSystemEventSender, m as resolveSlackChatType, n as authorizeSlackDirectMessage, p as normalizeSlackChannelType, r as buildPluginBindingResolvedText, s as resolvePluginConversationBindingApproval, t as resolveSlackRoomContextHints, u as resolveSlackEffectiveAllowFrom, v as isDangerousNameMatchingEnabled, x as resolveDefaultGroupPolicy } from "./room-context-RIraEsHZ.js";
...
import { formatCommandArgMenuTitle, resolveStoredModelOverride } from "openclaw/plugin-sdk/command-auth";
...
function loadSlackMessagePipeline() {
	slackMessagePipelinePromise ??= import("./pipeline.runtime-CXmeBqdy.js");
...
function createSlackBoltApp(params) {
	const socketModeReceiverOptions = {
		...
		clientPingTimeout: params.socketMode?.clientPingTimeout ?? 15e3,
...
function loadSlashDispatchRuntime() {
	slashDispatchRuntimePromise ??= import("./slash-dispatch.runtime-afoMfUeA.js");
