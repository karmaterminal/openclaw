...
import { i as formatWhatsAppWebAuthStatusState, m as readWebAuthState } from "./auth-store-0EdfQAN5.js";
...
async function finalizeWhatsAppSetup(params) {
	...
	if (await params.prompter.confirm({
		...
		const { loginWeb } = await import("./login-ClGWlCDl.js").then((n) => n.n);
