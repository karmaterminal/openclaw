...
import { a as projectCredentialSnapshotFields, n as PAIRING_APPROVED_MESSAGE, o as resolveConfiguredFromCredentialStatuses, r as buildTokenChannelStatusSummary, t as DEFAULT_ACCOUNT_ID } from "./channel-api-rFq6o8WB.js";
...
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-Cij_IvL1.js";
import { t as getDiscordApprovalCapability } from "./approval-native-BmBdfFqP.js";
import { t as discordMessageActions$1 } from "./channel-actions-8bJreMW_.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-BQIVhUQT.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-CNN4UNs5.js";
import { n as discordOutbound } from "./outbound-adapter-B91KygPa.js";
import { t as getDiscordRuntime } from "./runtime-Cn1X4Wff.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-CSz5tzbi.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-w633CncX.js").then((n) => n.t));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-DR-4uT8T.js").then((n) => n.n));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-xsFa-oiB.js").then((n) => n.n));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-yF7mz8vi.js").then((n) => n.a));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime-CPCVQK2F.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-Ag8yGkJy.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-DB72Ws6i.js").then((n) => n.n);
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-B5ph6ATv.js").then((n) => n.t);
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-CsJerYC0.js").then((n) => n.t);
