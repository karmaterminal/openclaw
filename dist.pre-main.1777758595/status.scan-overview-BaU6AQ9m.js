...
import { u as isLoopbackIpAddress } from "./ip-6JaFsyBG.js";
...
import { s as hasConfiguredChannelsForReadOnlyScope } from "./channel-plugin-ids-B15YKct5.js";
import { t as createEmptyTaskRegistrySummary } from "./task-registry.summary-BZmh87Mw.js";
import { n as createEmptyTaskAuditSummary } from "./task-registry.audit.shared-BVq-6ncM.js";
import { t as pickGatewaySelfPresence } from "./gateway-presence-BJEIgHfa.js";
import { i as isProbeReachable } from "./helpers-9fjBLUDB.js";
...
function loadGatewayProbeModule() {
	gatewayProbeModulePromise ??= import("./status.gateway-probe-DiphTzmU.js");
	return gatewayProbeModulePromise;
}
function loadProbeGatewayModule() {
	probeGatewayModulePromise ??= import("./probe-BKTgbyj-.js");
	return probeGatewayModulePromise;
}
function loadGatewayCallModule$1() {
	gatewayCallModulePromise$1 ??= import("./call-DE46g_N2.js");
...
function loadStatusScanDepsRuntimeModule() {
	statusScanDepsRuntimeModulePromise ??= import("./status.scan.deps.runtime-Fu9rop8N.js");
	return statusScanDepsRuntimeModulePromise;
}
function loadStatusAgentLocalModule() {
	statusAgentLocalModulePromise ??= import("./status.agent-local-Dge4vEHi.js");
	return statusAgentLocalModulePromise;
}
function loadStatusUpdateModule() {
	statusUpdateModulePromise ??= import("./status.update-DvJuO2GT.js");
	return statusUpdateModulePromise;
}
function loadStatusScanRuntimeModule() {
	statusScanRuntimeModulePromise ??= import("./status.scan.runtime-DQD5yA9c.js");
	return statusScanRuntimeModulePromise;
}
function loadGatewayCallModule() {
	gatewayCallModulePromise ??= import("./call-DE46g_N2.js");
	return gatewayCallModulePromise;
}
function loadStatusSummaryModule() {
	statusSummaryModulePromise ??= import("./status.summary-cmSxEcG2.js");
...
function loadCommandConfigResolutionModule() {
	commandConfigResolutionModulePromise ??= import("./command-config-resolution-DB17LrxG.js");
	return commandConfigResolutionModulePromise;
}
function loadCommandSecretTargetsModule() {
	commandSecretTargetsModulePromise ??= import("./command-secret-targets-D9OvCbSy.js");
