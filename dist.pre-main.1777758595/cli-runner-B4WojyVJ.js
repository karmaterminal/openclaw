...
import "./tokens-fh59FP1B.js";
import { p as isFailoverErrorMessage, t as classifyFailoverReason } from "./errors-CTr-JKNG.js";
import "./pi-embedded-helpers-BCdH26FE.js";
import { i as isFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-CQwRMDjb.js";
import { i as buildAgentHookConversationMessages, n as loadCliSessionHistoryMessages } from "./session-history-DcU1Dwk2.js";
import { i as runAgentHarnessLlmOutputHook, r as runAgentHarnessLlmInputHook, t as runAgentHarnessAgentEndHook } from "./lifecycle-hook-helpers-C0fsMJbf.js";
...
async function runCliAgent(params) {
	...
	const { prepareCliRunContext } = await import("./prepare.runtime-CX4w3J2R.js");
	const context = await prepareCliRunContext(params);
	try {
		return await runPreparedCliAgent(context);
	} finally {
		if (params.cleanupCliLiveSessionOnRunEnd === true) {
			const { closeClaudeLiveSessionForContext } = await import("./claude-live-session-DxpGEtlK.js");
...
async function runPreparedCliAgent(context) {
	const { executePreparedCliRun } = await import("./execute.runtime-nEYhP8f6.js");
