...
import { a as mergeModelProviderRequestOverrides, d as sanitizeConfiguredProviderRequest, u as sanitizeConfiguredModelProviderRequest } from "./provider-request-config-_2a0fYY5.js";
import { t as resolveSystemBin } from "./resolve-system-bin-BZS8Oo6s.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-D64cZNOQ.js";
import { t as describeImageWithModel } from "./image-runtime-B9feYjvS.js";
import { c as DEFAULT_VIDEO_MAX_BASE64_BYTES, d as getMediaUnderstandingProvider, l as MIN_AUDIO_FILE_BYTES, s as DEFAULT_TIMEOUT_SECONDS, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-BJtyb8qw.js";
import { a as resolvePrompt, n as resolveMaxBytes, r as resolveMaxChars, s as resolveTimeoutMs } from "./resolve-DXQZlXcC.js";
...
import { i as resolveProxyFetchFromEnv } from "./proxy-fetch-BUuKnZ2l.js";
...
async function loadModelAuth() {
	cachedModelAuth ??= await import("./model-auth-CngqrLDF.js");
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-CvjKZ5jF.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio"
		}) || entry.model;
