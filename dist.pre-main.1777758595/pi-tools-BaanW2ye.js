...
import { v as resolveAgentConfig } from "./agent-scope-DfXPuZUf.js";
import { g as writeFileWithinRoot, o as mkdirPathWithinRoot, p as removePathWithinRoot } from "./fs-safe-sE-UBZ2L.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-DkwpoWjW.js";
import { d as resolveGatewayMessageChannel } from "./message-channel-DgTkFEBi.js";
import { i as resolveSubagentCapabilityStore, t as isSubagentEnvelopeSession } from "./subagent-capabilities-51thCj20.js";
import { b as EXEC_TOOL_DISPLAY_SUMMARY, c as mergeAlsoAllowPolicy, i as collectExplicitAllowlist, m as resolveToolProfilePolicy, n as applyOwnerOnlyToolPolicy, p as normalizeToolName, x as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-policy-D3hzQRe0.js";
import { a as createHostWorkspaceAppendTool, c as createOpenClawReadTool, d as createSandboxedWriteTool, f as wrapToolMemoryDayFileWriteGuard, h as wrapToolWorkspaceRootGuardWithOptions, l as createSandboxedEditTool, m as wrapToolWorkspaceRootGuard, o as createHostWorkspaceEditTool, p as wrapToolMemoryFlushAppendOnlyWrite, s as createHostWorkspaceWriteTool, t as createOpenClawTools, u as createSandboxedReadTool } from "./openclaw-tools-DCJR53sU.js";
import { n as copyPluginToolMeta, r as getPluginToolMeta } from "./tools-WWV5h-kJ.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-Ba3cieKS.js";
import { i as listChannelAgentTools, t as copyChannelAgentToolMeta } from "./channel-tools-BTBp-1RJ.js";
import { t as normalizeToolParameterSchema } from "./pi-tools-parameter-schema-CWLOwU5Z.js";
import { t as bindAbortRelay } from "./fetch-timeout-XtCPwdrO.js";
import { c as wrapToolWithBeforeToolCallHook } from "./pi-tools.before-tool-call-wHQa5rMB.js";
import { i as resolveMergedSafeBinProfileFixtures } from "./exec-safe-bin-runtime-policy-DkHqIwi5.js";
import { n as assertSandboxPath } from "./sandbox-paths-BQsZxg0w.js";
import { a as toRelativeSandboxPath, i as resolvePathFromInput, r as resolveWorkspaceRoot } from "./read-capability-CQ2a53Ko.js";
...
import { s as shouldSuppressManagedWebSearchTool } from "./codex-native-web-search-core-S5hIebPo.js";
import "./codex-native-web-search-MQ0W-sZP.js";
import { t as isToolAllowedByPolicies } from "./tool-policy-match-CI-kiKFh.js";
import { i as resolveToolFsConfig, t as createToolFsPolicy } from "./tool-fs-policy-DbjSoUrw.js";
...
import { n as buildDefaultToolPolicyPipelineSteps, t as applyToolPolicyPipeline } from "./tool-policy-pipeline-1nGgDAVO.js";
...
function loadBashToolsModule() {
	bashToolsModulePromise ??= import("./bash-tools-CYwgEtWc.js");
...
function createOpenClawCodingTools(options) {
	...
	const base = createCodingTools(workspaceRoot).flatMap((tool) => {
		...
		if (tool.name === "write") {
			...
			return [wrapToolMemoryDayFileWriteGuard(workspaceOnly ? wrapToolWorkspaceRootGuard(wrapped, workspaceRoot) : wrapped)];
		}
		if (tool.name === "edit") {
			if (sandboxRoot) return [];
	...
	const tools = [
		...
		...sandboxRoot ? [] : [workspaceOnly ? wrapToolWorkspaceRootGuard(createHostWorkspaceAppendTool(workspaceRoot, { workspaceOnly }), workspaceRoot) : createHostWorkspaceAppendTool(workspaceRoot, { workspaceOnly })],
