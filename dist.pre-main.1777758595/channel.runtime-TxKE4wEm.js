...
import "./accounts-8idpeLiU.js";
import "./runtime-api-BO26j_t4.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-QBIfuTIN.js";
import { t as sendMessageZalo } from "./send-rb1dBfx3.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-CmEX1QY_.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-CSkFKG-0.js");
