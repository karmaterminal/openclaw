...
import { l as loadDeviceAuthToken, n as GatewayClient, r as GatewayClientRequestError } from "./client-CtrkocR-.js";
...
import { i as READ_SCOPE } from "./operator-scopes-CCNu0CLn.js";
...
async function probeGateway(opts) {
	...
	const deviceIdentity = await (async () => {
		try {
			...
			const { loadDeviceIdentityIfPresent } = await import("./device-identity-DookxvSt.js");
