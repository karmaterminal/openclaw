...
import { S as resolveDefaultAgentId, g as listAgentEntries, n as resolveAgentEffectiveModelPrimary } from "./agent-scope-DfXPuZUf.js";
...
import { i as resolveOpenClawReferencePaths, n as OPENCLAW_SOURCE_URL, t as OPENCLAW_DOCS_URL } from "./docs-path-DIWmvFM2.js";
...
async function loadCrestodianOverview(opts = {}) {
	...
	let gatewayError;
	try {
		const details = (deps.buildGatewayConnectionDetails ?? (await import("./call-DE46g_N2.js")).buildGatewayConnectionDetails)({
			config: cfg,
			configPath
		});
