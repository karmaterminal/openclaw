...
import { S as resolveDefaultAgentId, b as resolveAgentDir } from "./agent-scope-DfXPuZUf.js";
...
import { p as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-D-PUpS_m.js";
import { i as listMemoryEmbeddingProviders, o as registerMemoryEmbeddingProvider } from "./memory-embedding-providers-DuX22vU8.js";
import "./auth-profiles-DJ905QVz.js";
import { n as listProfilesForProvider } from "./profile-list-DtbttjVj.js";
import { t as buildGatewayConnectionDetailsWithResolvers } from "./connection-details-lWiIkWjn.js";
import { i as callGateway, u as randomIdempotencyKey } from "./call-BXBUsPlF.js";
import { n as loadModelCatalog } from "./model-catalog-hbxjrLud.js";
import { n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-B44wpfKR.js";
import { D as textToSpeech, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, d as listSpeechVoices, f as listTtsPersonas, g as resolveTtsConfig, m as resolveExplicitTtsOverrides, o as getTtsPersona, s as getTtsProvider, w as setTtsPersona } from "./tts-runtime-Cwx2jJaC.js";
...
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-BJtyb8qw.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-CDixhYQl.js";
import { a as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-CfUuHTiW.js";
import { t as resolveMemorySearchConfig } from "./memory-search-M3EfUllE.js";
import { r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-YRyHEMOh.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-CfUwm6dB.js";
import { n as runCommandWithRuntime } from "./cli-utils-u72Ucgba.js";
import { t as removeCommandByName } from "./command-tree-fnFgrmVL.js";
import { t as collectOption } from "./helpers-CojMtEv8.js";
import { a as transcribeAudioFile, n as describeImageFileWithModel, r as describeVideoFile, t as describeImageFile } from "./runtime-CByIuL7O.js";
import { a as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-Dx2W4nxC.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-C7k47U_i.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-Dv6Q5jEi.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-BBA9yd_J.js");
