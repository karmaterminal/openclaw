...
export declare const pluginSdkDocCategories: readonly ["core", "channel", "provider", "runtime", "utilities", "legacy"];
export declare const pluginSdkDocEntrypoints: PluginSdkDocEntrypoint[];
