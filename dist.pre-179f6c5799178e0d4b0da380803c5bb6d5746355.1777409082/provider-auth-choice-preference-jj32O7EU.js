import { n as resolveManifestProviderAuthChoice } from "./provider-auth-choices-GCrmkTsr.js";
import { r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-BIdFByOb.js";
...
async function resolvePreferredProviderForAuthChoice(params) {
	...
	const { resolveProviderPluginChoice, resolvePluginProviders } = await import("./provider-auth-choice.runtime-C9Lhr48L.js");
