...
import { a as clearPluginManifestRegistryCache } from "./manifest-registry-Bg22SiwE.js";
import { M as resetConfigOverrides, N as setConfigOverride, P as unsetConfigOverride, T as validateConfigObjectWithPlugins, j as getConfigOverrides, u as readConfigFileSnapshot, y as writeConfigFile } from "./io-CgtDzW1a.js";
import { r as normalizeOptionalAccountId } from "./account-id-DWChvwa8.js";
...
import { i as normalizeChannelId$1, t as getChannelPlugin } from "./registry-BL4cljde.js";
import { i as unsetConfigValueAtPath, n as parseConfigPath, r as setConfigValueAtPath, t as getConfigValueAtPath } from "./config-paths-BeHEzVFz.js";
import { b as resolveAgentWorkspaceDir, p as resolveSessionAgentId, y as resolveAgentDir } from "./agent-scope-Cmx30dd2.js";
import { t as parseDurationMs } from "./parse-duration-CQ49DviP.js";
import { n as isRestartEnabled, t as isCommandFlagEnabled } from "./commands.flags-McyAH4_K.js";
import "./config-C9V3s22v.js";
import { g as GATEWAY_CLIENT_NAMES, h as GATEWAY_CLIENT_MODES, r as isInternalMessageChannel, u as normalizeMessageChannel } from "./message-channel-BSGc07rB.js";
import { n as resolveChannelApprovalCapability } from "./plugins-BXj_dAAn.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-biaRu-0D.js";
import { x as prepareProviderRuntimeAuth } from "./provider-runtime-CiBW3Awl.js";
import { n as ensureOpenClawModelsJson } from "./models-config-BLGXHp-w.js";
import { g as resolveResponseUsageMode, m as normalizeUsageDisplay } from "./thinking-CGwszwLq.js";
...
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, r as resolveDefaultSessionStorePath } from "./paths-C9Qq8LIv.js";
...
import { i as formatUsd, r as formatTokenCount } from "./usage-format-Bb9o50Xl.js";
import { n as stripInboundMetadata } from "./strip-inbound-meta-BZubu-9f.js";
import { t as diagnosticLogger } from "./diagnostic-runtime-D4hvxLY_.js";
import { V as stripToolResultDetails } from "./wait-for-idle-before-flush-BOMgYG9u.js";
import { n as redactSupportString } from "./diagnostic-support-redaction-DNroL_92.js";
import { C as safeTrajectorySessionFileName, S as resolveTrajectoryPointerFilePath, T as sanitizeDiagnosticPayload, b as TRAJECTORY_RUNTIME_FILE_MAX_BYTES, w as safeJsonStringify, x as resolveTrajectoryFilePath } from "./selection-SHbwfJm2.js";
import { S as setTtsProvider, _ as setLastTtsAttempt, a as getTtsMaxLength, b as setTtsEnabled, c as isTtsEnabled, h as resolveTtsPrefsPath, i as getResolvedSpeechProviderConfig, l as isTtsProviderConfigured, m as resolveTtsConfig, o as getTtsProvider, r as getLastTtsAttempt, s as isSummarizationEnabled, v as setSummarizationEnabled, w as textToSpeech, x as setTtsMaxLength } from "./tts-Dxaj4ngf.js";
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-BbAfMb5p.js";
import { S as resolveBootstrapMaxChars, w as resolveBootstrapTotalMaxChars } from "./pi-embedded-helpers-CjIsUZ-S.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-DbGsWo-9.js";
import { i as resolveImageSanitizationLimits, n as sanitizeImageBlocks } from "./tool-images-BfcPpUMq.js";
...
import { i as unsetConfiguredMcpServer, r as setConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-D_hWHfie.js";
...
import { l as triggerOpenClawRestart, o as scheduleGatewaySigusr1Restart } from "./restart-CWPEfC-L.js";
import { i as resolveReplyToMode } from "./reply-threading-DINJQY6z.js";
import { _ as authorizeConfigWriteShared, b as resolveConfigWriteTargetFromPathShared, v as canBypassConfigWritePolicyShared, y as formatConfigWriteDeniedMessageShared } from "./channel-config-helpers-BlZJEaPp.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-B-o2RNgp.js";
...
import { h as replyRunRegistry, i as getActiveEmbeddedRunSnapshot } from "./runs-CGD-1aD2.js";
import "./diagnostic-CCOkZzFJ.js";
import { t as formatDurationCompact } from "./format-duration-CTeO5sfo.js";
import "./sandbox-DMVxFt34.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-B5bb8BdF.js";
import { n as estimateTokensFromChars } from "./cjk-chars-8BpzuHW3.js";
import { i as streamWithPayloadPatch } from "./moonshot-thinking-stream-wrappers-DgcmkMib.js";
import { r as resolveModelWithRegistry } from "./model-DGlpPESa.js";
import { i as matchPluginCommand, n as executePluginCommand } from "./commands-CqHSU_vP.js";
import { t as isApprovalNotFoundError } from "./approval-errors-Bn-tTr6P.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-DjTFIAXb.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-Dg5oxANZ.js";
import "./commands-registry-Bt3ZgbN-.js";
import { n as formatTimeAgo } from "./format-relative-BUaZvtg2.js";
import { o as stripMentions, s as stripStructuralPrefixes } from "./mentions-5OLNfSny.js";
import { n as setChannelConversationBindingMaxAgeBySessionKey, t as setChannelConversationBindingIdleTimeoutBySessionKey } from "./conversation-bindings-BuOm3yEO.js";
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-DpPnFAh7.js";
import { i as installPluginFromPath, r as installPluginFromNpmSpec } from "./install-BAbmVbV1.js";
import { l as resolveArchiveKind } from "./archive-9bu3Gk7b.js";
import { n as isImplicitSameChatApprovalAuthorization } from "./approval-auth-helpers-BqqrDH2r.js";
import { n as parseActivationCommand } from "./group-activation-D6c5zDYV.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-BpI2xquj.js";
import { _ as getFinishedSession, v as getSession } from "./bash-tools.exec-runtime-DFzXp9C_.js";
import { t as resolveFastModeState } from "./fast-mode-MBC647tq.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-CDFU6WWe.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-DRl5iSVk.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-727qgZEH.js";
import { a as shouldPersistAbortCutoff, i as resolveAbortCutoffFromContext, t as applyAbortCutoffToSessionEntry } from "./abort-cutoff-C843ad49.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-Dndm2buY.js";
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-BlWkGgD1.js";
import { n as resolveSessionEntryForKey, r as stopSubagentsForRequester, t as formatAbortReplyText } from "./abort-BvEI385c.js";
import { t as extractBtwQuestion } from "./btw-command-j7zODIyN.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-BfJXOU7O.js";
...
import { a as requireGatewayClientScopeForInternalChannel, i as requireCommandFlagEnabled, n as rejectNonOwnerCommand, r as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates-C0GAm_yh.js";
import { t as handleAcpCommand } from "./commands-acp-BeLBDGaW.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-Cczs-Rpq.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-CwkBgzr5.js";
import { r as handleModelsCommand } from "./commands-models-DEy2Rhn5.js";
import { n as setPluginEnabledInConfig } from "./enable-Dq9h5ts0.js";
import { r as createExecTool } from "./bash-tools-BNuyfS1B.js";
import { n as listTasksForAgentIdForStatus, r as listTasksForSessionKeyForStatus } from "./status-text-zY1FTsGY.js";
import { d as resolveChannelAccountId, f as resolveCommandSurfaceChannel, l as resolveSubagentsAction, o as resolveHandledPrefix, s as resolveRequesterSessionKey, u as stopWithText } from "./shared-DdlrE1u3.js";
import { t as buildToolsMessage } from "./status-DIhuJ0Ax.js";
import { t as parseConfigValue } from "./config-value-Bek7HPwP.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-DnWyngh2.js";
import { a as writeSupportBundleDirectory, i as textSupportBundleFile, n as jsonlSupportBundleFile, r as supportBundleContents, t as jsonSupportBundleFile } from "./diagnostic-support-bundle-BHDdr9Dx.js";
import { t as buildStatusReply } from "./commands-status-CLgeXGM_.js";
import { i as buildNpmInstallRecordFields, n as persistPluginInstall } from "./plugins-install-persist-BhPTtNFA.js";
import { m as parseClawHubPluginSpec } from "./clawhub-Ds94vf0q.js";
import { r as installPluginFromClawHub } from "./clawhub-BxEsyH6C.js";
import { a as buildPluginDiagnosticsReport, c as formatPluginCompatibilityNotice, o as buildPluginInspectReport, s as buildPluginSnapshotReport, t as buildAllPluginInspectReports } from "./status-DOk74ZtM.js";
import { a as decidePreferredClawHubFallback, i as createPluginInstallLogger, n as buildPreferredClawHubSpec, u as resolveFileNpmSpecToLocalPath } from "./plugins-command-helpers-CW3ylxCA.js";
import { n as loadCostUsageSummary, r as loadSessionCostSummary } from "./session-cost-usage-C29zsH3T.js";
...
function loadCompactRuntime() {
	compactRuntimePromise ??= import("./commands-compact.runtime-BZwNEscY.js");
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-CajloQxR.js");
...
async function abortEmbeddedPiRunForSession(sessionId) {
	const { abortEmbeddedPiRun } = await import("./runs-BWVKEXjD.js");
...
function loadAgentsAction() {
	actionAgentsPromise ??= import("./action-agents-DJ6UpK7C.js");
	return actionAgentsPromise;
}
function loadFocusAction() {
	actionFocusPromise ??= import("./action-focus-DRAs1KV3.js");
	return actionFocusPromise;
}
function loadHelpAction() {
	actionHelpPromise ??= import("./action-help-Bm2S9Vi6.js");
	return actionHelpPromise;
}
function loadInfoAction() {
	actionInfoPromise ??= import("./action-info-Ddpa1ura.js");
	return actionInfoPromise;
}
function loadKillAction() {
	actionKillPromise ??= import("./action-kill-BUzG4E9L.js");
	return actionKillPromise;
}
function loadListAction() {
	actionListPromise ??= import("./action-list-b1QJWTtB.js");
	return actionListPromise;
}
function loadLogAction() {
	actionLogPromise ??= import("./action-log-GrLgprIu.js");
	return actionLogPromise;
}
function loadSendAction() {
	actionSendPromise ??= import("./action-send-DMdPSb33.js");
	return actionSendPromise;
}
function loadSpawnAction() {
	actionSpawnPromise ??= import("./action-spawn-BSOt1knn.js");
	return actionSpawnPromise;
}
function loadUnfocusAction() {
	actionUnfocusPromise ??= import("./action-unfocus-CN9L7oKQ.js");
	return actionUnfocusPromise;
}
function loadControlRuntime() {
	controlRuntimePromise ??= import("./commands-subagents-control.runtime-DDjrdAAN.js");
