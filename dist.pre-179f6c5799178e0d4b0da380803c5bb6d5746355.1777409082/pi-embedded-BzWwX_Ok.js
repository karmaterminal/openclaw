...
import { i as isCronSessionKey } from "./session-key-utils-BdCb1Ic0.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER, t as DEFAULT_CONTEXT_TOKENS } from "./defaults-Db0k6oKb.js";
import { n as resolveProviderIdForAuth } from "./provider-auth-aliases-Drq9GRoe.js";
import { b as resolveAgentWorkspaceDir, m as resolveSessionAgentIds, r as resolveAgentExecutionContract, t as hasConfiguredModelFallbacks } from "./agent-scope-Cmx30dd2.js";
import { i as isMarkdownCapableMessageChannel } from "./message-channel-BSGc07rB.js";
...
import { i as resolveContextEngine } from "./registry-DLuGAVhE.js";
import { $ as resolveProviderAuthProfileId, x as prepareProviderRuntimeAuth } from "./provider-runtime-CiBW3Awl.js";
...
import { t as ensureContextEnginesInitialized } from "./init-BZSxjVp5.js";
import { t as ensureRuntimePluginsLoaded } from "./runtime-plugins-BnbGhpB4.js";
import { n as sleepWithAbort } from "./backoff-T_izlAFX.js";
import { a as normalizeUsage, t as derivePromptTokens } from "./usage-CSBA3_Jc.js";
import { n as extractAssistantTextForPhase } from "./chat-message-content-WJFmpqVH.js";
import { _ as resolveSessionCompactionCheckpointReason, a as readPiModelContextTokens, d as runPostCompactionSideEffects, f as captureCompactionCheckpointSnapshot, g as persistSessionCompactionCheckpoint, i as buildAgentRuntimeAuthPlan, o as asCompactionHookRunner, p as cleanupCompactionCheckpointSnapshot, r as buildAgentRuntimePlan } from "./build-2TBzY30Q.js";
import { i as enqueueCommandInLane } from "./command-queue-BYs_ZoM6.js";
import { a as formatContextWindowWarningMessage, i as formatContextWindowBlockMessage, n as CONTEXT_WINDOW_WARN_BELOW_TOKENS, o as resolveContextWindowInfo, r as evaluateContextWindowGuard, t as CONTEXT_WINDOW_HARD_MIN_TOKENS } from "./context-window-guard-CZsfqxoV.js";
import { r as isSilentReplyPayloadText } from "./tokens-Bnib3S4J.js";
import { G as truncateOversizedToolResultsInSession, U as resolveLiveToolResultMaxChars, W as sessionLikelyHasOversizedToolResults } from "./wait-for-idle-before-flush-BOMgYG9u.js";
import { h as isStrictAgenticExecutionContractActive } from "./openclaw-tools-DclzkKxa.js";
import { _ as resolveRunLivenessState, c as extractPlanningOnlyPlanDetails, d as resolveEmptyResponseRetryInstruction, f as resolveIncompleteTurnPayloadText, g as resolveReplayInvalidFlag, h as resolveReasoningOnlyRetryInstruction, i as selectAgentHarness, m as resolvePlanningOnlyRetryLimit, p as resolvePlanningOnlyRetryInstruction, r as runAgentHarnessAttemptWithFallback, s as STRICT_AGENTIC_BLOCKED_TEXT, t as maybeCompactAgentHarnessSession, u as resolveAckExecutionFastPathInstruction, v as createEmbeddedRunReplayState, y as observeReplayMetadata } from "./selection-SHbwfJm2.js";
import { o as normalizeTextForComparison, r as pickFallbackThinkingLevel } from "./pi-embedded-helpers-CjIsUZ-S.js";
import { D as formatRawAssistantErrorForUi, l as isRawApiErrorPayload, n as formatBillingErrorMessage, o as getApiErrorPayloadFingerprint, t as BILLING_ERROR_USER_MESSAGE, x as isTimeoutErrorMessage } from "./sanitize-user-facing-text-CMVX4RHP.js";
import { a as formatAssistantErrorText, d as isFailoverAssistantError, f as isFailoverErrorMessage, i as extractObservedOverflowTokenCount, l as isCompactionFailureError, m as isRateLimitAssistantError, o as isAuthAssistantError, p as isLikelyContextOverflowError, s as isBillingAssistantError, t as classifyFailoverReason, v as parseImageDimensionError, y as parseImageSizeError } from "./errors-D1qO8jiB.js";
import { n as coerceToFailoverError, r as describeFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-VOS38tD8.js";
import "./auth-profiles-dn9rLdoX.js";
import { a as markAuthProfileUsed, i as markAuthProfileFailure, s as resolveProfilesUnavailableReason, u as isProfileInCooldown } from "./usage-CWBZsWsW.js";
import { n as resolveAuthProfileOrder, t as resolveAuthProfileEligibility } from "./order-B3gFMCzg.js";
import { t as markAuthProfileGood } from "./profiles-ByOh6QBz.js";
import { t as redactIdentifier } from "./redact-identifier-kmIBrFRO.js";
import { t as sanitizeForConsole } from "./console-sanitize-3W0hnms8.js";
import { n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel, t as applyAuthHeaderOverride, u as shouldPreferExplicitConfigApiKeyAuth } from "./model-auth-CUr5avFe.js";
import { t as log } from "./logger-aV2efqyD.js";
import { d as sanitizeRuntimeProviderRequestOverrides, s as resolveProviderRequestConfig } from "./provider-request-config-oAG7RQNZ.js";
import { a as retireSessionMcpRuntime, o as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-OI_sa8Ev.js";
import "./pi-bundle-mcp-tools-DauHLxG-.js";
import { u as parseReplyDirectives } from "./payloads-Bt9OVSAu.js";
import { s as hasOutboundReplyContent } from "./reply-payload-kJANadVo.js";
import { b as formatToolAggregate, l as runContextEngineMaintenance } from "./attempt.tool-run-context-DJ6PJE3W.js";
import { s as emitAgentPlanEvent } from "./agent-events-BU2pAhDZ.js";
import { a as shouldAllowCooldownProbeForReason, i as LiveSessionModelSwitchError, o as buildApiErrorObservationFields } from "./model-fallback-sO5hL8Gz.js";
import { n as isLikelyMutatingToolName } from "./tool-mutation--Ktm3yy7.js";
import { n as extractAssistantThinking, o as formatReasoningMessage, r as extractAssistantVisibleText } from "./pi-embedded-utils-CCE8O9CP.js";
...
import { n as resolveGlobalLane, r as resolveSessionLane } from "./lanes-C49saFol.js";
import "./runs-CGD-1aD2.js";
import "./extra-params-DuHdIXff.js";
import { o as buildEmbeddedCompactionRuntimeContext, s as resolveEmbeddedCompactionTarget } from "./attempt.thread-helpers-Bzr-6VUQ.js";
import { n as resolveModelAsync } from "./model-DGlpPESa.js";
import { a as resolveStoredSessionKeyForSessionId, i as resolveSessionKeyForRequest, n as shouldSwitchToLiveModel, t as clearLiveModelSwitchPending } from "./live-model-switch-C0Na5H8M.js";
import { n as resolveRunWorkspaceDir, t as redactRunIdentifier } from "./workspace-run-B8T1FD_J.js";
			...
			try {
				...
				while (true) {
					...
					if (timedOut && !timedOutDuringCompaction) {
						...
						if (timeoutCompactionAttempts >= MAX_TIMEOUT_COMPACTION_ATTEMPTS) log.warn(`[timeout-compaction] already attempted timeout compaction ${timeoutCompactionAttempts} time(s); falling through to timeout handling`);
							...
							log.warn(`[context-pressure:fire] mid-turn trigger=timeout ratio=${Math.round(tokenUsedRatio * 100)}% tokens=${Math.round((lastTurnPromptTokens ?? 0) / 1e3)}k/${Math.round(ctxInfo.tokens / 1e3)}k sessionKey=${params.sessionKey ?? params.sessionId}`);
							...
							else log.warn(`[context-pressure:event-skipped] no sessionKey trigger=timeout ratio=${Math.round(tokenUsedRatio * 100)}%`);
					...
					if (contextOverflowError) {
						...
						if (!isCompactionFailure && !hadAttemptLevelCompaction && overflowCompactionAttempts < MAX_OVERFLOW_COMPACTION_ATTEMPTS) {
							...
							log.warn(`[context-pressure:fire] mid-turn trigger=overflow attempt=${overflowCompactionAttempts}/${MAX_OVERFLOW_COMPACTION_ATTEMPTS} tokens=${observedOverflowTokens !== void 0 ? Math.round(observedOverflowTokens / 1e3) : "?"}k/${Math.round(ctxInfo.tokens / 1e3)}k sessionKey=${params.sessionKey ?? params.sessionId}`);
							...
							else log.warn(`[context-pressure:event-skipped] no sessionKey trigger=overflow attempt=${overflowCompactionAttempts}/${MAX_OVERFLOW_COMPACTION_ATTEMPTS}`);
							let compactResult;
