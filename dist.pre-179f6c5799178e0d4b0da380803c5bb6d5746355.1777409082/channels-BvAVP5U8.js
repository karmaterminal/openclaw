...
import { t as danger } from "./globals-BGbp8MG5.js";
...
import { i as normalizeChannelId, n as getLoadedChannelPlugin, r as listChannelPlugins, t as getChannelPlugin } from "./registry-BL4cljde.js";
...
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-C81fffLk.js";
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-BTc97zIa.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-C98HXUIZ.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-CdDG09w4.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-D2FCSunP.js";
...
import { n as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-B8hPkobP.js";
import { t as parseLogLine } from "./parse-log-line-CyIKOFP5.js";
import { a as describeBinding, t as applyAgentBindings } from "./agents.bindings-DgX7c9_f.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-B5r0WCqp.js";
import { c as requireValidConfig, l as shouldUseWizard, o as channelLabel, s as formatChannelAccountLabel } from "./shared-BeXQ587_.js";
import { t as channelsListCommand } from "./list-C011Z04C.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status--xrYfDCr.js";
...
function loadChannelSetupPluginInstall() {
	channelSetupPluginInstallPromise ??= import("./plugin-install-VWEyLjRx.js");
	return channelSetupPluginInstallPromise;
}
function loadOnboardChannels() {
	onboardChannelsPromise ??= import("./onboard-channels-CJp2w2a4.js");
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	const { listChannelPluginCatalogEntries } = await import("./catalog-JUKvJoeD.js");
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-DZ9EzyuD.js"), loadOnboardChannels()]);
	...
	if (!channel && catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-xhBxnrYG.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = !useWizard && rawChannel && (!channel || !getChannelPlugin(channel)) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-WBiabZ2X.js");
