...
import { l as withResolvedWebhookRequestPipeline, n as registerWebhookTargetWithPluginRoute, s as resolveWebhookTargetWithAuthOrRejectSync } from "./webhook-targets-Cgswfzay.js";
import "./webhook-ingress-DJHUcvA_.js";
import "./browser-security-runtime-CTRV8l_7.js";
import "./string-coerce-runtime-BMKiHkE6.js";
import { P as resolveBlueBubblesEffectiveAllowPrivateNetwork, _ as normalizeWebhookReaction, g as normalizeWebhookMessage, o as probeBlueBubbles, t as fetchBlueBubblesServerInfo, u as asRecord } from "./probe-BTSK7XfL.js";
import { t as getBlueBubblesRuntime } from "./runtime-BtBVrg0y.js";
import { n as resolveWebhookPathFromConfig } from "./webhook-shared-CxEFzd-T.js";
import { a as resolveBlueBubblesMessageId, b as sendMessageBlueBubbles } from "./reactions-bUzSUv8Y.js";
import { i as sendBlueBubblesMedia, n as processMessage, r as processReaction, t as logVerbose } from "./monitor-processing-YUnVDv7Y.js";
...
async function monitorBlueBubblesProvider(options) {
	...
	return await new Promise((resolve) => {
		...
		import("./catchup-B4UW56Pd.js").then(({ runBlueBubblesCatchup }) => runBlueBubblesCatchup(target)).catch((err) => {
