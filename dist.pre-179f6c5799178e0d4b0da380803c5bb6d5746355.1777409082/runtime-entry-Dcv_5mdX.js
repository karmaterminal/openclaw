...
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "./webhook-request-guards-D66StMnH.js";
import "./webhook-ingress-DJHUcvA_.js";
import { g as resolveRealtimeVoiceAgentConsultToolsAllow, h as resolveRealtimeVoiceAgentConsultTools, s as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME } from "./provider-resolver-duyCRwkI.js";
import { s as consultRealtimeVoiceAgent, t as convertPcmToMulaw8k } from "./realtime-voice-ojh9vg-Y.js";
import { t as resolveConfiguredCapabilityProvider } from "./provider-selection-runtime-BfWQPv8t.js";
import { t as zod_exports } from "./zod-wD6cuybd.js";
import "./api-BWUh5oYP.js";
import { a as deepMergeDefined, i as validateProviderConfig, n as normalizeVoiceCallConfig, r as resolveVoiceCallConfig } from "./config-FPezkkNB.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-CMLAx_KC.js";
import { t as resolveVoiceResponseModel } from "./response-model-w1iNtVnB.js";
import { t as isProviderStatusTerminal } from "./call-status-CXnl3hMB.js";
import { t as getHeader } from "./http-headers-C5LDvA9c.js";
...
function loadRealtimeTranscriptionRuntime() {
	realtimeTranscriptionRuntimePromise ??= import("./realtime-transcription.runtime-DdUct383.js");
	return realtimeTranscriptionRuntimePromise;
}
function loadResponseGeneratorModule() {
	responseGeneratorModulePromise ??= import("./response-generator-T6X6GP3u.js");
...
function loadTelnyxProvider() {
	telnyxProviderPromise ??= import("./telnyx-BBjZJsO1.js");
	return telnyxProviderPromise;
}
function loadTwilioProvider() {
	twilioProviderPromise ??= import("./twilio-CFBIWEzn.js");
	return twilioProviderPromise;
}
function loadPlivoProvider() {
	plivoProviderPromise ??= import("./plivo-DbDULva1.js");
	return plivoProviderPromise;
}
function loadMockProvider() {
	mockProviderPromise ??= import("./mock-TO2ldtBv.js");
	return mockProviderPromise;
}
function loadRealtimeVoiceRuntime() {
	realtimeVoiceRuntimePromise ??= import("./realtime-voice.runtime-7O0Eowsv.js");
	return realtimeVoiceRuntimePromise;
}
function loadRealtimeHandler() {
	realtimeHandlerPromise ??= import("./realtime-handler-BuJ2hG_F.js");
