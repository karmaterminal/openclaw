...
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-oZV4MnHw.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-Bcl0fL-M.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-Bzd5H93H.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("./jsonwebtoken-7xR7hjmf.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-CkT53eO9.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwt, { JwksClient }]) => ({
		jwt,
		JwksClient
	}));
