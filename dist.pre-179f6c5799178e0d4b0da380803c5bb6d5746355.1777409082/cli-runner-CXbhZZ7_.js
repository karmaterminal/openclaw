...
import { f as isFailoverErrorMessage, t as classifyFailoverReason } from "./errors-D1qO8jiB.js";
import { i as isFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-VOS38tD8.js";
import { n as buildAgentHookConversationMessages, t as loadCliSessionHistoryMessages } from "./session-history-BFcT-5mJ.js";
...
async function runCliAgent(params) {
	...
	const { prepareCliRunContext } = await import("./prepare.runtime-DksJfYWO.js");
	return runPreparedCliAgent(await prepareCliRunContext(params));
}
async function runPreparedCliAgent(context) {
	const { executePreparedCliRun } = await import("./execute.runtime-IIIUxfk4.js");
