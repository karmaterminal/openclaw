...
import { a as logWarn, r as logInfo } from "./logger-HXvGEyjy.js";
import { H as getShellPathFromLoginShell, U as resolveShellEnvFallbackTimeoutMs } from "./io-CgtDzW1a.js";
import { a as isSubagentSessionKey, i as isCronSessionKey, o as parseAgentSessionKey } from "./session-key-utils-BdCb1Ic0.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-05a3Ypk7.js";
import { d as resolveApprovalAuditCandidatePath } from "./exec-safe-bin-trust-BNvYcSQV.js";
import { t as killProcessTree } from "./kill-tree-BmChn7XO.js";
import { c as isGatewayMessageChannel, u as normalizeMessageChannel } from "./message-channel-BSGc07rB.js";
import { i as normalizeDeliveryContext } from "./delivery-context.shared-Cjcgi24o.js";
import { b as EXEC_TOOL_DISPLAY_SUMMARY, x as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-policy-DZ8Bwz3v.js";
import { C as formatExecDeniedUserMessage, T as parseExecApprovalResultText, u as sanitizeUserFacingText, w as isExecDeniedResultText } from "./sanitize-user-facing-text-CMVX4RHP.js";
import { o as failedTextResult, v as textResult } from "./common-CiiKqT5H.js";
import { t as callGatewayTool } from "./gateway-C_AHjOfl.js";
import { t as splitShellArgs } from "./shell-argv-D34PSIYZ.js";
import { c as describeInterpreterInlineEval, f as analyzeShellCommand, l as detectInterpreterInlineEvalArgv, n as evaluateShellAllowlist, p as buildEnforcedShellCommand } from "./exec-approvals-allowlist-CrDnjlEW.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-CS2T7EYE.js";
...
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-vaEnww3x.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-DfTG5DQf.js";
import "./delivery-context-BsPnUBeq.js";
import { i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-DTcIlPmA.js";
import { t as sendMessage } from "./message-Bco-TIst.js";
import { t as resolveExternalBestEffortDeliveryTarget } from "./best-effort-delivery-BEdsWQyQ.js";
...
import { a as coerceEnv, c as readEnvInt, d as sliceLogLines, f as truncateMiddle, i as clampWithDefault, l as resolveSandboxWorkdir, n as buildSandboxEnv, o as deriveSessionName, s as pad, u as resolveWorkdir } from "./bash-tools.shared-DFNtZCuF.js";
import { f as resolveExecApprovalInitiatingSurfaceState, s as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-BRsfYrP2.js";
import { i as normalizePathPrepend, t as applyPathPrepend } from "./path-prepend-Obau9P5z.js";
import { t as getProcessSupervisor } from "./supervisor-WNILY1E7.js";
import { C as setJobTtlMs, S as markExited, _ as getFinishedSession, a as DEFAULT_PENDING_MAX_OUTPUT, b as listRunningSessions, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, g as drainSession, h as deleteSession, i as DEFAULT_PATH, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput, v as getSession, w as tail, x as markBackgrounded, y as listFinishedSessions } from "./bash-tools.exec-runtime-DFzXp9C_.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-UB4ccguI.js";
import { n as recordCommandPoll, r as resetCommandPollCount } from "./command-poll-backoff-o1W8H1ML.js";
...
async function loadFsSafeModule() {
	fsSafeModulePromise ??= import("./fs-safe-DoxSIxQL.js");
