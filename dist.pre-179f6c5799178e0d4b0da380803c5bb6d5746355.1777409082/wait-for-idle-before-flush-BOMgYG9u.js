...
import { a as logWarn, t as logDebug } from "./logger-HXvGEyjy.js";
...
import { c as resolveEffectivePluginActivationState, o as normalizePluginsConfig } from "./config-state-D7mm0cjk.js";
...
import { r as resolveProviderEndpoint } from "./provider-attribution-DLA9sDdf.js";
import { i as applyMergePatch } from "./schema-validator-C2rdO_4k.js";
import { v as resolveAgentContextLimits } from "./agent-scope-Cmx30dd2.js";
...
import { a as normalizeInputProvenance, n as applyInputProvenanceToUserMessage, r as hasInterSessionUserProvenance } from "./input-provenance-3AB0L-Nv.js";
import { s as getCompactionProvider } from "./loader-DIJaLaot.js";
import "./plugins-BXj_dAAn.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-Yxkhw9TF.js";
import { t as listAgentToolResultMiddlewares } from "./agent-tool-result-middleware-iSq99tdA.js";
...
import { c as createExpiringMapCache, d as resolveCacheTtlMs, u as isCacheEnabled } from "./store-cache-vxZHIMwR.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-DwHiSbCw.js";
import { a as normalizeUsage, i as makeZeroUsageSnapshot } from "./usage-CSBA3_Jc.js";
import { a as normalizeAssistantPhase, o as parseAssistantTextSignature, t as encodeAssistantTextSignature } from "./chat-message-content-WJFmpqVH.js";
import { o as resolveContextWindowInfo } from "./context-window-guard-CZsfqxoV.js";
import { a as isSilentReplyText } from "./tokens-Bnib3S4J.js";
import { s as stripHeartbeatToken } from "./heartbeat-B2eoifs0.js";
import { c as mergeAlsoAllowPolicy, m as resolveToolProfilePolicy, n as applyOwnerOnlyToolPolicy } from "./tool-policy-DZ8Bwz3v.js";
import { i as setPluginToolMeta, n as getPluginToolMeta } from "./tools-CqiGxZl1.js";
import { T as sanitizeGoogleTurnOrdering, _ as downgradeOpenAIFunctionCallReasoningPairs, c as extractToolCallsFromAssistant, d as REDACTED_SESSIONS_SPAWN_ATTACHMENT_CONTENT, f as SESSIONS_SPAWN_ATTACHMENT_METADATA_KEYS, g as normalizeAllowedToolNames, h as isRedactedSessionsSpawnAttachment, l as extractToolResultId, m as isAllowedToolCallName, n as validateGeminiTurns, s as sanitizeSessionMessagesImages, t as validateAnthropicTurns, u as sanitizeToolCallIdsForCloudCodeAssist, v as downgradeOpenAIReasoningBlocks, y as isGoogleModelApi } from "./pi-embedded-helpers-CjIsUZ-S.js";
import { n as matchesAnyGlobPattern, t as compileGlobPatterns } from "./glob-pattern-Ky3826UL.js";
...
import { i as collectTextContentBlocks, r as createAgentToolResultMiddlewareRunner } from "./tool-schema-runtime-CAr7YYe_.js";
import { c as mapOpenAIReasoningEffortForModel, i as createBoundaryAwareStreamFnForModel, l as resolveOpenAIStrictToolSetting, o as normalizeOpenAIStrictToolParameters, s as resolveOpenAIStrictToolFlagForInventory } from "./provider-stream-DOwIzMBN.js";
import { d as resolveDebugProxySettings, n as captureWsEvent, u as createDebugProxyWebSocketAgent } from "./runtime-CHkCpYt8.js";
import { i as normalizeOpenAIReasoningEffort } from "./openai-responses-payload-policy-BERSrGoq.js";
import { t as log$3 } from "./logger-aV2efqyD.js";
import { y as resolveOpenAITextVerbosity } from "./proxy-stream-wrappers-Bnn8iaYe.js";
import { c as resolveProviderRequestPolicyConfig, i as getModelProviderRequestTransport, r as buildProviderRequestTlsClientOptions } from "./provider-request-config-oAG7RQNZ.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-CXRaq9d2.js";
import { r as hasCopilotVisionInput, t as buildCopilotDynamicHeaders } from "./copilot-dynamic-headers-D6V6isKF.js";
import { s as mergeTransportMetadata } from "./transport-stream-shared-iKObhPl6.js";
import { n as loadEnabledBundleLspConfig } from "./bundle-lsp-B0y84M2h.js";
import { d as resolveStdioMcpServerLaunchConfig, l as loadEmbeddedPiMcpConfig, u as describeStdioMcpServerLaunchConfig } from "./pi-bundle-mcp-runtime-OI_sa8Ev.js";
import { r as applyPiCompactionSettingsFromConfig } from "./pi-settings-C0XZQEqE.js";
import { a as toToolDefinitions } from "./pi-tool-definition-adapter-DPOKSu3Z.js";
import { a as resolveGroupToolPolicy, i as resolveGroupContextFromSessionKey, o as resolveSubagentToolPolicyForSession, r as resolveEffectiveToolPolicy } from "./read-capability-CQkQhNiw.js";
...
import { i as setRawSessionAppendMessage, n as rewriteTranscriptEntriesInSessionManager, r as getRawSessionAppendMessage } from "./transcript-rewrite-BFnwe-wg.js";
import { i as resolveSkillRuntimeConfig } from "./env-overrides-BuZOKEvq.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-5QzCExza.js";
import "./skills-BebyV_sJ.js";
import { i as resolveUserTimezone } from "./date-time-CRoC7hma.js";
import { y as shouldPreserveThinkingBlocks } from "./provider-model-shared-BupW1wb7.js";
import { C as isAnthropicModelRef, S as isAnthropicFamilyCacheTtlEligible } from "./provider-stream-shared-D5BvSWI3.js";
import { o as isGooglePromptCacheEligible } from "./extra-params-DuHdIXff.js";
...
import { n as isQueryStopWordToken, t as extractKeywords } from "./query-expansion-Dn2CUDBd.js";
import "./query-CSK7kwip.js";
import { o as wrapUntrustedPromptDataBlock, t as buildAgentSystemPrompt } from "./system-prompt-CQDuFU7n.js";
import { t as estimateStringChars } from "./cjk-chars-8BpzuHW3.js";
import { t as createAnthropicVertexStreamFnForModel } from "./anthropic-vertex-stream-BpFWcM_6.js";
...
//#endregion
export { createBundleLspToolRuntime as $, consumeCompactionSafeguardCancelReason as A, sanitizeToolUseResultPairing as B, limitHistoryTurns as C, hasMeaningfulConversationContent as D, estimateMessagesTokens as E, isCacheTtlEligibleProvider as F, truncateOversizedToolResultsInSession as G, estimateToolResultReductionPotential as H, readLastCacheTtlTimestamp as I, installToolResultContextGuard as J, truncateOversizedToolResultsInSessionManager as K, resolveTranscriptPolicy as L, applyFinalEffectiveToolPolicy as M, compactWithSafetyTimeout as N, isRealConversationMessage as O, resolveCompactionTimeoutMs as P, dropThinkingBlocks as Q, shouldAllowProviderOwnedThinkingReplay as R, getDmHistoryLimitFromSessionKey as S, SAFETY_MARGIN as T, resolveLiveToolResultMaxChars as U, stripToolResultDetails as V, sessionLikelyHasOversizedToolResults as W, createPreparedEmbeddedPiSettingsManager as X, repairSessionFileIfNeeded as Y, assessLastAssistantMessage as Z, trackSessionManagerAccess as _, collectAllowedToolNames as a, validateReplayTurns as b, applySystemPromptOverrideToSession as c, describeEmbeddedAgentStreamStrategy as d, releaseWsSession as et, resolveEmbeddedAgentApiKey as f, prewarmSessionFile as g, resolveEmbeddedRunSkillEntries as h, PI_RESERVED_TOOL_NAMES as i, resolveChannelCapabilities as it, setCompactionSafeguardCancelReason as j, readPostCompactionContext as k, buildEmbeddedSystemPrompt as l, resolveEmbeddedAgentStreamFn as m, mapThinkingLevel as n, buildUsageWithNoCost as nt, collectRegisteredToolNames as o, resolveEmbeddedAgentBaseStreamFn as p, installContextEngineLoopHook as q, splitSdkTools as r, isReasoningTagProvider as rt, toSessionToolAllowlist as s, flushPendingToolResultsAfterIdle as t, buildStreamErrorAssistantMessage as tt, createSystemPromptOverride as u, normalizeAssistantReplayContent as v, buildEmbeddedExtensionFactories as w, buildEmbeddedMessageActionDiscoveryInput as x, sanitizeSessionHistory as y, guardSessionManager as z };
