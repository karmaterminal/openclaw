...
import { B as resolveMemoryLightDreamingConfig, F as resolveMemoryDeepDreamingConfig, I as resolveMemoryDreamingConfig, L as resolveMemoryDreamingPluginConfig, N as isSameMemoryDreamingDay, V as resolveMemoryRemDreamingConfig, z as resolveMemoryDreamingWorkspaces } from "./dreaming-CyNvLfZj.js";
import "./plugins-BXj_dAAn.js";
import { s as getPluginCommandSpecs } from "./command-registration-D8RLjIRH.js";
import { i as hasInternalHookListeners, m as triggerInternalHook } from "./internal-hooks-biaRu-0D.js";
import { S as createEmptyPluginRegistry, a as getActivePluginRegistry, d as pinActivePluginChannelRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion, x as setActivePluginRegistry } from "./runtime-AU4GSMts.js";
import { n as withPluginRuntimeGatewayRequestScope, t as getPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-BvqUCFCl.js";
import { r as createPluginRuntimeLoaderLogger } from "./load-context-3i3aDa2k.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-DGDPUqkd.js";
import { d as normalizeReasoningLevel, f as normalizeThinkLevel } from "./thinking-CGwszwLq.js";
import { b as normalizeModelRef, x as parseModelRef } from "./model-selection-shared-BsuJEYVd.js";
import { t as buildAllowedModelSet } from "./model-selection-CZMUiuFR.js";
...
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey } from "./main-session-DlEMU4Ot.js";
import { n as resolveMainSessionKeyFromConfig, t as extractDeliveryInfo } from "./sessions-CD6GeuLj.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent } from "./paths-C9Qq8LIv.js";
import { n as mergeSessionEntry } from "./types-BuGAfG5X.js";
import { n as readJsonFile, r as writeJsonAtomic, t as createAsyncLock } from "./json-files-DdgOTcyw.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, r as mergeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-Cjcgi24o.js";
import { t as loadSessionStore } from "./store-load-DghVySJ7.js";
import { n as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-DbiIfelu.js";
import { t as canonicalizeSpawnedByForAgent } from "./session-store-key-fmv5EUHK.js";
import { a as readSessionPreviewItemsFromTranscript, i as readSessionMessages } from "./session-utils.fs-CblkYA9E.js";
import { a as resolveSessionTranscriptCandidates, t as archiveFileOnDisk } from "./session-transcript-files.fs-BVYCHx7P.js";
...
import { h as listSessionCompactionCheckpoints, m as getSessionCompactionCheckpoint } from "./build-2TBzY30Q.js";
import { a as normalizeCronJobPatch, r as normalizeCronJobCreate } from "./openclaw-tools-DclzkKxa.js";
import { _ as listCoreToolSections, h as PROFILE_OPTIONS, v as resolveCoreToolProfiles } from "./tool-policy-DZ8Bwz3v.js";
import { n as getPluginToolMeta, r as resolvePluginTools } from "./tools-CqiGxZl1.js";
import { n as redactConfigSnapshot, r as restoreRedactedValues, t as redactConfigObject } from "./redact-snapshot-CNHLfn6R.js";
import { C as synthesizeSpeech, S as setTtsProvider, b as setTtsEnabled, c as isTtsEnabled, f as resolveExplicitTtsOverrides, g as resolveTtsProviderOrder, h as resolveTtsPrefsPath, i as getResolvedSpeechProviderConfig, l as isTtsProviderConfigured, m as resolveTtsConfig, o as getTtsProvider, p as resolveTtsAutoMode, w as textToSpeech } from "./tts-Dxaj4ngf.js";
import "./auth-profiles-dn9rLdoX.js";
import { s as projectOutboundPayloadPlanForMirror, t as createOutboundPayloadPlan } from "./payloads-Bt9OVSAu.js";
import { l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-BU2pAhDZ.js";
import { g as writeFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-BsNurHhz.js";
import { d as mergeExecApprovalsSocketDefaults, j as saveExecApprovals, o as ensureExecApprovals, p as normalizeExecApprovals, y as readExecApprovalsSnapshot } from "./exec-approvals-B2scP4BT.js";
import { a as prepareSecretsRuntimeSnapshot } from "./runtime-LLD3_uFb.js";
import { i as parseAbsoluteTimeMs } from "./stagger-BGDLuN1L.js";
import { r as isInvalidCronSessionTargetIdError } from "./webhook-url-BuvY94bs.js";
import { f as writeRestartSentinel, i as formatDoctorNonInteractiveHint } from "./restart-sentinel-D08So3wr.js";
import { o as scheduleGatewaySigusr1Restart } from "./restart-CWPEfC-L.js";
import { o as listConfiguredAnnounceChannelIdsForConfig, r as resolveGatewayStartupPluginIds } from "./channel-plugin-ids-CR84c_yu.js";
import { i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry, s as dispatchChannelMessageAction } from "./message-action-runner-CcSVIDHK.js";
import { n as normalizePollInput } from "./polls-B45uUoNq.js";
import { t as deliverOutboundPayloads } from "./deliver-BM2htO6C.js";
import { n as resolveOutboundChannelPlugin } from "./channel-resolution-C07iSi6t.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-C98HXUIZ.js";
import "./target-resolver-D7l9LTDt.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-kK3eo6m6.js";
import { i as resolveReplyToMode } from "./reply-threading-DINJQY6z.js";
...
import { i as setHeartbeatsEnabled } from "./heartbeat-wake-CVc6aaHq.js";
import { i as enqueueSystemEvent, o as isSystemEventContextChanged } from "./system-events-zzYXvZSs.js";
import { r as createRunningTaskRun } from "./detached-task-runtime-BfgHfuvs.js";
import { a as clearSessionQueues } from "./queue-CX_rZ1TS.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-BEdsWQyQ.js";
import { a as isEmbeddedPiRunActive, f as waitForEmbeddedPiRunEnd, t as abortEmbeddedPiRun } from "./runs-CGD-1aD2.js";
import { h as normalizeDiagnosticStabilityQuery, m as getDiagnosticStabilitySnapshot } from "./diagnostic-stability-bundle-BGwQm6Po.js";
import { t as resolveAgentTimeoutMs } from "./timeout-DPG38lna.js";
import { n as normalizeSpawnedRunMetadata, r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-khF7eyhM.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-5QzCExza.js";
import "./skills-BebyV_sJ.js";
import { n as getActiveMemorySearchManager } from "./memory-runtime-BOYWQlv6.js";
...
import { t as primeConfiguredBindingRegistry } from "./binding-registry-CO-Y4Bln.js";
import { r as listPluginCommands } from "./commands-CqHSU_vP.js";
import { i as setGatewaySubagentRuntime, r as setGatewayNodesRuntime } from "./gateway-bindings-YVKsGSNi.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-CAgIN8dY.js";
import "./commands-registry-Bt3ZgbN-.js";
import { n as resolveSendPolicy } from "./send-policy-BHeuzgVr.js";
import { t as getChannelActivity } from "./channel-activity-CffKGOWA.js";
import { t as WizardCancelledError } from "./prompts-ZriG88mV.js";
import { t as canExecRequestNode } from "./exec-defaults-DlZjqsSR.js";
import { t as bumpSkillsSnapshotVersion } from "./refresh-state-D876d_Ml.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-C_61Twhr.js";
import { o as resolveMissingRequestedScope } from "./pairing-token-CvkH6oPL.js";
import { d as listNodePairing, f as rejectNodePairing, g as verifyNodeToken, l as approveNodePairing, m as requestNodePairing, p as renamePairedNode, t as getRemoteSkillEligibility } from "./skills-remote-Ckll4HnX.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-B1g7wz5t.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-Dndm2buY.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-BDVTujNi.js";
import { r as getLastHeartbeatEvent } from "./heartbeat-visibility-CChHV8ut.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-DIE6kOy2.js";
import { r as agentCommandFromIngress } from "./agent-command-CwWiZJLC.js";
import { n as getSpeechProvider, r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-PU5o0GmJ.js";
import { n as invokeNativeHookRelay } from "./native-hook-relay-CPUP3lXB.js";
import { i as resolveNodeCommandAllowlist, n as isNodeCommandAllowed } from "./node-command-policy-ClFut90s.js";
import { t as formatForLog } from "./ws-log-FglwQqN7.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-DSa1QMVP.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-CwkBgzr5.js";
import { a as getPairedDevice, c as listApprovedPairedDeviceRoles, d as rejectDevicePairing, f as removePairedDevice, g as summarizeDeviceTokens, h as rotateDeviceToken, i as formatDevicePairingForbiddenMessage, l as listDevicePairing, m as revokeDeviceToken, n as approveDevicePairing, o as getPendingDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-DdqDCc5T.js";
import { o as REALTIME_VOICE_AGENT_CONSULT_TOOL, r as getRealtimeVoiceProvider, s as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, t as resolveConfiguredRealtimeVoiceProvider } from "./provider-resolver-duyCRwkI.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-rhSsnWc5.js";
import { n as createOutboundSendDeps } from "./deps-Dcq4XFFJ.js";
import "./agent-DZj0fWBM.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-DjneIUI3.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-UB4ccguI.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-DF7Ocqtm.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-B1cUkU4v.js";
import { d as waitForTerminalGatewayDedupe, g as resolveAgentRunExpiresAtMs, h as registerChatAbortController, i as chatHandlers, l as readTerminalSnapshotFromGatewayDedupe, u as setGatewayDedupeEntry } from "./chat-j4TAC2IE.js";
import { n as MediaOffloadError, r as parseMessageWithAttachments, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-Bhf0ihXJ.js";
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp-BljveFp0.js";
import { t as resolveSessionKeyFromResolveParams } from "./sessions-resolve-DSsh1vjX.js";
import { t as loadProviderUsageSummary } from "./provider-usage-ByUbBuXm.js";
import { o as fetchClawHubSkillDetail } from "./clawhub-Ds94vf0q.js";
import { a as loadSessionUsageTimeSeries, i as loadSessionLogs, n as loadCostUsageSummary, o as resolveExistingUsageSessionFile, r as loadSessionCostSummary, t as discoverAllSessions } from "./session-cost-usage-C29zsH3T.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-CEa2o3X6.js";
import { n as movePathToTrash } from "./browser-maintenance-DaF3V63W.js";
import { a as performGatewaySessionReset } from "./session-reset-service-Bas1BH7k.js";
import { t as buildChannelUiCatalog } from "./catalog-BFNE4fk8.js";
import { a as removeBackfillDiaryEntries, c as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeGroundedShortTermCandidates, r as previewGroundedRemMarkdown, s as repairDreamingArtifacts } from "./memory-core-bundled-runtime-Bn56FKLS.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-DPI1XbWh.js";
import { t as readConfiguredLogTail } from "./log-tail-BfAeLD0a.js";
import { n as purgeAgentSessionStoreEntries } from "./agents.command-shared-CM2NRUJF.js";
import { o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-t0jZsBf5.js";
import { t as installSkill } from "./skills-install-BQChIryy.js";
import { m as normalizeUpdateChannel } from "./update-check-BFSz_2e7.js";
import "./status-C5j_VEJO.js";
import { t as getStatusSummary } from "./status.summary-BOOdZH8F.js";
import { i as updateSkillsFromClawHub, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-BSfD87zM.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-CIg9u4h1.js";
import { t as runGatewayUpdate } from "./update-runner-By-WREYk.js";
import { t as buildChannelAccountSnapshot } from "./status-Bg0cRL_6.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-DD_QR7h5.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-DA53F75F.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-OVgpv8Ar.js";
import "./heartbeat-runner-01wPNJ71.js";
...
async function loadSessionSubagentReactivationRuntime() {
	return import("./session-subagent-reactivation.runtime-0OOgX6VC.js");
}
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-DSI74BRp.js");
...
function loadSessionsRuntimeModule() {
	sessionsRuntimeModulePromise ??= import("./sessions.runtime-BDpTwSjj.js");
