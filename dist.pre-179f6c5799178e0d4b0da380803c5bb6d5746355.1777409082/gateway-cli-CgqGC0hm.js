...
import { a as loadConfig, g as recoverConfigFromLastKnownGood, h as recoverConfigFromJsonRootSuffix, l as readBestEffortConfig, r as createConfigIO, u as readConfigFileSnapshot, y as writeConfigFile } from "./io-CgtDzW1a.js";
import { b as resolveWorkspaceTemplateDir, v as resolveDefaultAgentWorkspaceDir } from "./workspace-BoT_VDZH.js";
import { t as cleanStaleGatewayProcessesSync } from "./restart-stale-pids-9J0uRZHM.js";
import { a as inspectPortUsage, s as formatPortDiagnostics } from "./ports-D7xv2gcP.js";
import { r as resolveGatewayService } from "./service-LQAhtQPd.js";
import { t as parsePort } from "./parse-port-DWVhCET6.js";
import "./config-C9V3s22v.js";
import { g as GATEWAY_CLIENT_NAMES, h as GATEWAY_CLIENT_MODES } from "./message-channel-BSGc07rB.js";
import { a as getActiveTaskCount, c as markGatewayDraining, d as waitForActiveTasks, l as resetAllLanes } from "./command-queue-BYs_ZoM6.js";
import { r as callGateway } from "./call-TrQWMVYB.js";
import { f as writeRestartSentinel } from "./restart-sentinel-D08So3wr.js";
import { a as markGatewaySigusr1RestartHandled, i as isGatewaySigusr1RestartExternallyAllowed, l as triggerOpenClawRestart, o as scheduleGatewaySigusr1Restart, t as consumeGatewaySigusr1RestartAuthorization } from "./restart-CWPEfC-L.js";
import { d as waitForActiveEmbeddedRuns, r as getActiveEmbeddedRunCount, t as abortEmbeddedPiRun } from "./runs-CGD-1aD2.js";
import { _ as selectDiagnosticStabilitySnapshot, f as writeDiagnosticStabilityBundleForFailureSync, h as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-bundle-BGwQm6Po.js";
import { n as parseTimeoutMsWithFallback } from "./parse-timeout-BqySWFmU.js";
import { n as withProgress } from "./progress-D-shW4ku.js";
import { n as runCommandWithRuntime } from "./cli-utils-DjfQyVIh.js";
import { n as setGatewayWsLogStyle } from "./ws-logging-CxZPBnuH.js";
import { t as formatHelpExamples } from "./help-format-BXdC2bIr.js";
import { t as readSecretFromFile } from "./secret-file-Bfm_Y8Q4.js";
import { n as buildGatewayDiscoveryTarget } from "./gateway-discovery-targets-BoKG_IKP.js";
import { o as resolveControlUiRootSync } from "./control-ui-assets-DoeRc1Lh.js";
import { n as acquireGatewayLock, t as GatewayLockError } from "./gateway-lock-DVsHiqoH.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-Ct_3r86k.js";
import { o as handleReset } from "./onboard-helpers-D7_KWpUY.js";
...
async function runGatewayCommand$1(opts) {
	...
	const { startGatewayServer } = await startupTrace.measure("cli.server-import", () => withProgress({
		...
		indeterminate: true
	}, async () => import("./server-DUZvONwz.js")));
...
function loadConfigModule() {
	configModulePromise ??= import("./read-best-effort-config.runtime-Ca-fjtbY.js");
	return configModulePromise;
}
function loadGatewayStatusModule() {
	gatewayStatusModulePromise ??= import("./gateway-status-Bx4sKd7W.js");
	return gatewayStatusModulePromise;
}
function loadGatewayHealthModule() {
	gatewayHealthModulePromise ??= import("./health-C0bGseH1.js");
	return gatewayHealthModulePromise;
}
function loadBonjourDiscoveryModule() {
	bonjourDiscoveryModulePromise ??= import("./bonjour-discovery-xzeRxU9o.js");
	return bonjourDiscoveryModulePromise;
}
function loadWideAreaDnsModule() {
	wideAreaDnsModulePromise ??= import("./widearea-dns-BoEhKEjd.js");
	return wideAreaDnsModulePromise;
}
function loadHealthStyleModule() {
	healthStyleModulePromise ??= import("./health-style-C_pWoQMM.js");
	return healthStyleModulePromise;
}
function loadUsageFormatModule() {
	usageFormatModulePromise ??= import("./usage-format-DMUhGPfm.js");
	return usageFormatModulePromise;
}
function loadStabilityBundleModule() {
	stabilityBundleModulePromise ??= import("./diagnostic-stability-bundle-lGI3b_mr.js");
	return stabilityBundleModulePromise;
}
function loadSupportExportModule() {
	supportExportModulePromise ??= import("./diagnostic-support-export-DkE0jkCP.js");
	return supportExportModulePromise;
}
function loadDaemonStatusGatherModule() {
	daemonStatusGatherModulePromise ??= import("./status.gather-C9CmNUAW.js");
