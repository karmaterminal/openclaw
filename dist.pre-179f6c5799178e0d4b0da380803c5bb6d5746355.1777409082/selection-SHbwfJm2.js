...
import { g as createDiagnosticTraceContext, h as createChildDiagnosticTraceContext, v as freezeDiagnosticTraceContext } from "./logger--l1ykZMf.js";
import { m as resolveUserPath } from "./utils-BMRcljdi.js";
import { n as emitDiagnosticEvent } from "./diagnostic-events-Bq1LHJIn.js";
...
import { J as normalizeGoogleApiBaseUrl } from "./io-CgtDzW1a.js";
import { a as isSubagentSessionKey, n as isAcpSessionKey } from "./session-key-utils-BdCb1Ic0.js";
import { c as normalizeAgentId } from "./session-key-05a3Ypk7.js";
import { r as normalizeProviderId } from "./provider-id-Ct2qVXr0.js";
import "./defaults-Db0k6oKb.js";
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-DLA9sDdf.js";
import { f as isWorkspaceBootstrapPending, r as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-BoT_VDZH.js";
import { h as listAgentEntries, m as resolveSessionAgentIds } from "./agent-scope-Cmx30dd2.js";
import { u as normalizeMessageChannel } from "./message-channel-BSGc07rB.js";
import { i as createStreamIteratorWrapper, r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-sjWzWBYj.js";
import { u as listRegisteredAgentHarnesses } from "./loader-DIJaLaot.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-Yxkhw9TF.js";
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-AU4GSMts.js";
import { F as resolveProviderSystemPromptContribution, I as resolveProviderTextTransforms, q as transformProviderSystemPrompt } from "./provider-runtime-CiBW3Awl.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-DGDPUqkd.js";
import { o as resolveDefaultModelForAgent } from "./model-selection-CZMUiuFR.js";
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-DJuBtE-z.js";
import { n as acquireSessionWriteLock, o as resolveSessionLockMaxHoldFromTimeout } from "./session-write-lock-A2xLw4ed.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-DwHiSbCw.js";
import { a as normalizeUsage, i as makeZeroUsageSnapshot, r as hasNonzeroUsage } from "./usage-CSBA3_Jc.js";
import { o as parseAssistantTextSignature, s as resolveAssistantMessagePhase } from "./chat-message-content-WJFmpqVH.js";
import { t as parseInlineDirectives } from "./directive-tags-BRJuzSv2.js";
import { n as resolveEmbeddedAgentHarnessFallback, r as resolveEmbeddedAgentRuntime, t as normalizeEmbeddedAgentRuntime } from "./runtime-BP4ybsND.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, o as startsWithSilentToken, r as isSilentReplyPayloadText } from "./tokens-Bnib3S4J.js";
import { t as filterHeartbeatPairs } from "./heartbeat-filter-BFyLLi6Q.js";
import { $ as createBundleLspToolRuntime, B as sanitizeToolUseResultPairing, C as limitHistoryTurns, E as estimateMessagesTokens, F as isCacheTtlEligibleProvider, H as estimateToolResultReductionPotential, I as readLastCacheTtlTimestamp, J as installToolResultContextGuard, K as truncateOversizedToolResultsInSessionManager, L as resolveTranscriptPolicy, M as applyFinalEffectiveToolPolicy, P as resolveCompactionTimeoutMs, Q as dropThinkingBlocks, R as shouldAllowProviderOwnedThinkingReplay, S as getDmHistoryLimitFromSessionKey, T as SAFETY_MARGIN, U as resolveLiveToolResultMaxChars, X as createPreparedEmbeddedPiSettingsManager, Y as repairSessionFileIfNeeded, Z as assessLastAssistantMessage, _ as trackSessionManagerAccess, a as collectAllowedToolNames, b as validateReplayTurns, c as applySystemPromptOverrideToSession, d as describeEmbeddedAgentStreamStrategy, et as releaseWsSession, f as resolveEmbeddedAgentApiKey, g as prewarmSessionFile, h as resolveEmbeddedRunSkillEntries, i as PI_RESERVED_TOOL_NAMES, it as resolveChannelCapabilities, l as buildEmbeddedSystemPrompt, m as resolveEmbeddedAgentStreamFn, n as mapThinkingLevel, o as collectRegisteredToolNames, p as resolveEmbeddedAgentBaseStreamFn, q as installContextEngineLoopHook, r as splitSdkTools, rt as isReasoningTagProvider, s as toSessionToolAllowlist, t as flushPendingToolResultsAfterIdle, tt as buildStreamErrorAssistantMessage, u as createSystemPromptOverride, v as normalizeAssistantReplayContent, w as buildEmbeddedExtensionFactories, x as buildEmbeddedMessageActionDiscoveryInput, y as sanitizeSessionHistory, z as guardSessionManager } from "./wait-for-idle-before-flush-BOMgYG9u.js";
import { _ as isEmbeddedMode, g as isStrictAgenticSupportedProviderModel } from "./openclaw-tools-DclzkKxa.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-BwV1hxi3.js";
import { t as getMachineDisplayName } from "./machine-name-CyO7R_7Q.js";
import { f as MAX_IMAGE_BYTES } from "./mime-DFfgvUW_.js";
import { p as normalizeToolName } from "./tool-policy-DZ8Bwz3v.js";
import { n as getPluginToolMeta } from "./tools-CqiGxZl1.js";
import { t as redactConfigObject } from "./redact-snapshot-CNHLfn6R.js";
import { n as resolveCommitHash } from "./git-commit-BB5HlXbC.js";
import { t as resolveOsSummary } from "./os-summary-CMsFPC_U.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-DNroL_92.js";
import { n as estimateBase64DecodedBytes } from "./base64-B8L4jxeV.js";
import { t as parseBooleanValue } from "./boolean-BfN6Axbq.js";
import { n as buildTtsSystemPromptHint } from "./tts-Dxaj4ngf.js";
import { a as prependBootstrapPromptWarning, i as buildBootstrapTruncationReportMeta, n as buildBootstrapInjectionStats, r as buildBootstrapPromptWarning, t as analyzeBootstrapBudget } from "./bootstrap-budget-BbAfMb5p.js";
import { a as resolveContextInjectionMode, i as resolveBootstrapContextForRun, n as hasCompletedBootstrapTurn, r as makeBootstrapWarn, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-DPYjMFBO.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-D73YAuDI.js";
...
import { T as parseExecApprovalResultText, d as stableStringify$1, f as coerceChatContentText } from "./sanitize-user-facing-text-CMVX4RHP.js";
import { a as formatAssistantErrorText, c as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-D1qO8jiB.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-DbGsWo-9.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-BfcPpUMq.js";
import { a as listChannelSupportedActions, c as resolveChannelReactionGuidance, o as resolveChannelMessageToolCapabilities, s as resolveChannelMessageToolHints } from "./channel-tools-D7aSZI_6.js";
import { t as resolveOpenClawDocsPath } from "./docs-path-DJM2xcew.js";
import { a as isTimeoutError } from "./failover-error-VOS38tD8.js";
import { t as buildModelAliasLines } from "./model-alias-lines-Dhp-NAAE.js";
import { t as sanitizeForConsole } from "./console-sanitize-3W0hnms8.js";
import { c as resolveModelAuthMode } from "./model-auth-CUr5avFe.js";
import { a as supportsModelTools, n as normalizeProviderToolSchemas, t as logProviderToolSchemaDiagnostics } from "./tool-schema-runtime-CAr7YYe_.js";
import { t as registerProviderStreamForModel } from "./provider-stream-DOwIzMBN.js";
import { t as log$3 } from "./logger-aV2efqyD.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-CXRaq9d2.js";
import { i as ensureGlobalUndiciStreamTimeouts, r as ensureGlobalUndiciEnvProxyDispatcher, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-CSJ4AmVb.js";
import { c as sanitizeTransportPayloadText, o as mergeTransportHeaders, u as buildGuardedModelFetch } from "./transport-stream-shared-iKObhPl6.js";
import { r as getOrCreateSessionMcpRuntime } from "./pi-bundle-mcp-runtime-OI_sa8Ev.js";
import { n as materializeBundleMcpToolsForRun } from "./pi-bundle-mcp-tools-DauHLxG-.js";
import { n as setReplyPayloadMetadata } from "./reply-payload-CXbG-jFU.js";
import { r as parseFenceSpans } from "./fences-Bpr-ieGZ.js";
import { r as splitMediaFromOutput } from "./parse-KQ08jBth.js";
import { u as parseReplyDirectives } from "./payloads-Bt9OVSAu.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-kJANadVo.js";
import { _ as sanitizeToolResult, b as formatToolAggregate, d as extractToolErrorMessage, f as extractToolResultMediaArtifact, g as isToolResultTimedOut, h as isToolResultError, l as runContextEngineMaintenance, m as filterToolResultMediaUrls, n as assembleHarnessContextEngine, o as finalizeHarnessContextEngineTurn, p as extractToolResultText, r as bootstrapHarnessContextEngine, t as buildEmbeddedAttemptToolRunContext, u as extractMessagingToolSend, v as isMessagingTool, y as isMessagingToolSendAction } from "./attempt.tool-run-context-DJ6PJE3W.js";
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent } from "./agent-events-BU2pAhDZ.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-BYGdsB7W.js";
import { o as buildApiErrorObservationFields, s as buildTextObservationFields } from "./model-fallback-sO5hL8Gz.js";
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation--Ktm3yy7.js";
import { a as stripDowngradedToolCallText } from "./assistant-visible-text-BpamnAIx.js";
...
import { a as MIN_PROMPT_BUDGET_TOKENS, i as MIN_PROMPT_BUDGET_RATIO, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-C0XZQEqE.js";
import { o as diagnosticErrorCategory } from "./pi-tools.before-tool-call-C1-hxc9k.js";
import { i as toClientToolDefinitions, n as findClientToolNameConflicts, t as createClientToolNameConflictError } from "./pi-tool-definition-adapter-DPOKSu3Z.js";
import { n as resolveToolLoopDetectionConfig, t as createOpenClawCodingTools } from "./pi-tools-CRyFONIX.js";
...
import { l as setActiveEmbeddedRun, n as clearActiveEmbeddedRun, u as updateActiveEmbeddedRunSnapshot } from "./runs-CGD-1aD2.js";
import { t as resolveAgentTimeoutMs } from "./timeout-DPG38lna.js";
import { o as resolveSandboxContext } from "./sandbox-DMVxFt34.js";
import { n as rewriteTranscriptEntriesInSessionManager } from "./transcript-rewrite-BFnwe-wg.js";
import { t as detectRuntimeShell } from "./shell-utils-C88GKiQT.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-BuZOKEvq.js";
import { s as resolveSkillsPromptForRun } from "./workspace-5QzCExza.js";
import "./skills-BebyV_sJ.js";
import { t as resolveSystemPromptOverride } from "./system-prompt-override-DKlntya4.js";
import { t as buildSystemPromptParams } from "./system-prompt-params-Bi5oH5JK.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-B5bb8BdF.js";
import "./tool-loop-detection-Ur9SIhE8.js";
import { b as visitObjectContentBlocks, i as createHtmlEntityToolCallArgumentDecodingWrapper } from "./provider-stream-shared-D5BvSWI3.js";
import { n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-DuHdIXff.js";
import { n as buildAgentUserPromptPrefix } from "./system-prompt-CQDuFU7n.js";
...
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-BNec-Rh6.js";
import { a as shouldUseOpenAIWebSocketTransport, i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-Bzr-6VUQ.js";
import { a as resolveAttemptFsWorkspaceOnly, c as resolvePromptModeForSession, i as prependSystemPromptAddition, l as shouldInjectHeartbeatPrompt, n as buildAfterTurnRuntimeContextFromUsage, o as resolveAttemptPrependSystemContext, r as mergeOrphanedTrailingUserPrompt, s as resolvePromptBuildHookResult, t as buildAfterTurnRuntimeContext, u as shouldWarnOnOrphanedUserRepair } from "./attempt.prompt-helpers-DqtCW3iS.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-CuoXbDKm.js";
import { t as detectAndLoadPromptImages } from "./images-BLF1tY-d.js";
...
async function reconcileSessionStoreCompactionCountAfterSuccess(params) {
	const { reconcileSessionStoreCompactionCountAfterSuccess: reconcile } = await import("./pi-embedded-subscribe.handlers.compaction.runtime-l32hc21v.js");
...
function loadExecApprovalReply() {
	execApprovalReplyModulePromise ??= import("./exec-approval-reply-DVm2ZRvo.js");
	return execApprovalReplyModulePromise;
}
function loadHookRunnerGlobal() {
	hookRunnerGlobalModulePromise ??= import("./hook-runner-global-Gahvk1eU.js");
	return hookRunnerGlobalModulePromise;
}
function loadMediaParse() {
	mediaParseModulePromise ??= import("./parse-Dsw49JOU.js");
	return mediaParseModulePromise;
}
function loadBeforeToolCall() {
	beforeToolCallModulePromise ??= import("./pi-tools.before-tool-call-Btvpgrfb.js");
...
//#endregion
export { safeTrajectorySessionFileName as C, resolveTrajectoryPointerFilePath as S, sanitizeDiagnosticPayload as T, resolveRunLivenessState as _, resolveBootstrapMode as a, TRAJECTORY_RUNTIME_FILE_MAX_BYTES as b, extractPlanningOnlyPlanDetails as c, resolveEmptyResponseRetryInstruction as d, resolveIncompleteTurnPayloadText as f, resolveReplayInvalidFlag as g, resolveReasoningOnlyRetryInstruction as h, selectAgentHarness as i, isLikelyExecutionAckPrompt as l, resolvePlanningOnlyRetryLimit as m, resolveAgentHarnessPolicy as n, prepareSessionManagerForRun as o, resolvePlanningOnlyRetryInstruction as p, runAgentHarnessAttemptWithFallback as r, STRICT_AGENTIC_BLOCKED_TEXT as s, maybeCompactAgentHarnessSession as t, resolveAckExecutionFastPathInstruction as u, createEmbeddedRunReplayState as v, safeJsonStringify as w, resolveTrajectoryFilePath as x, observeReplayMetadata as y };
