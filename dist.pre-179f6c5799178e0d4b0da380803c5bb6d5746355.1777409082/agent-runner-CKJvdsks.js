...
import { v as freezeDiagnosticTraceContext } from "./logger--l1ykZMf.js";
import { n as defaultRuntime } from "./runtime-CHryl7ev.js";
import { t as sanitizeForLog } from "./ansi-CTONNaNi.js";
import { n as emitDiagnosticEvent, r as isDiagnosticsEnabled } from "./diagnostic-events-Bq1LHJIn.js";
import { t as createSubsystemLogger } from "./subsystem-DRUx3zf3.js";
import { r as logVerbose } from "./globals-BGbp8MG5.js";
import { a as loadConfig, it as resolveCliRuntimeExecutionProvider } from "./io-CgtDzW1a.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-05a3Ypk7.js";
import "./defaults-Db0k6oKb.js";
import { b as resolveAgentWorkspaceDir, f as resolveRunModelFallbacksOverride, p as resolveSessionAgentId, t as hasConfiguredModelFallbacks } from "./agent-scope-Cmx30dd2.js";
import "./config-C9V3s22v.js";
import { f as resolveMessageChannel, i as isMarkdownCapableMessageChannel, r as isInternalMessageChannel } from "./message-channel-BSGc07rB.js";
import { _ as resolveMemoryFlushPlan } from "./memory-state-HtGx9sKB.js";
import { g as resolveResponseUsageMode, h as normalizeVerboseLevel } from "./thinking-CGwszwLq.js";
import { t as isCliProvider } from "./model-selection-cli-DxhsOm_Y.js";
import "./model-selection-CZMUiuFR.js";
import { _ as resolveGroupSessionKey, o as updateSessionStore, s as updateSessionStoreEntry, u as resolveSessionStoreEntry } from "./store-YSRCrOf6.js";
import "./sessions-CD6GeuLj.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath } from "./paths-C9Qq8LIv.js";
import { c as resolveSessionPluginTraceLines, o as resolveFreshSessionTotalTokens, s as resolveSessionPluginStatusLines } from "./types-BuGAfG5X.js";
import { t as loadSessionStore } from "./store-load-DghVySJ7.js";
import { a as resolveContextTokensForModel } from "./context-DqGdVicy.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-Bb9o50Xl.js";
import { a as normalizeUsage, n as deriveSessionTotalTokens, r as hasNonzeroUsage, t as derivePromptTokens } from "./usage-CSBA3_Jc.js";
import { i as readSessionMessages } from "./session-utils.fs-CblkYA9E.js";
import { a as resolveSessionTranscriptCandidates } from "./session-transcript-files.fs-BVYCHx7P.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-2TBzY30Q.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-BYs_ZoM6.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-Bnib3S4J.js";
import { s as stripHeartbeatToken } from "./heartbeat-B2eoifs0.js";
import { E as estimateMessagesTokens, k as readPostCompactionContext } from "./wait-for-idle-before-flush-BOMgYG9u.js";
import { a as isAudioFileName } from "./mime-DFfgvUW_.js";
import { l as isLikelyExecutionAckPrompt } from "./selection-SHbwfJm2.js";
import { o as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-BbAfMb5p.js";
import "./pi-embedded-helpers-CjIsUZ-S.js";
import { D as formatRawAssistantErrorForUi, _ as isOverloadedErrorMessage, g as isBillingErrorMessage, i as formatRateLimitOrOverloadedErrorCopy, t as BILLING_ERROR_USER_MESSAGE, u as sanitizeUserFacingText, y as isRateLimitErrorMessage } from "./sanitize-user-facing-text-CMVX4RHP.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-CNnsAfN_.js";
import { g as isTransientHttpError, l as isCompactionFailureError, p as isLikelyContextOverflowError, u as isContextOverflowError } from "./errors-D1qO8jiB.js";
import { i as resolveSandboxConfigForAgent } from "./config-CFAv8XYe.js";
...
import { n as setReplyPayloadMetadata, t as getReplyPayloadMetadata } from "./reply-payload-CXbG-jFU.js";
...
import { i as emitAgentEvent, u as registerAgentRunContext } from "./agent-events-BU2pAhDZ.js";
import { i as LiveSessionModelSwitchError, r as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-sO5hL8Gz.js";
import { a as consumeStagedPostCompactionDelegates, c as highestDelayedContinuationReservationHop, d as stagePostCompactionDelegate, f as stagedPostCompactionDelegateCount, i as consumePendingDelegates, l as pendingDelegateCount, n as cancelPendingDelegates, p as takeDelayedContinuationReservation, r as clearDelayedContinuationReservations, t as addDelayedContinuationReservation, u as setTaskFlowDelegatesEnabled } from "./continuation-delegate-store-DWY_oNWi.js";
import { u as resolveContinuationRuntimeConfig } from "./subagent-announce-delivery-CTGDTMHt.js";
import { a as generateSecureUuid } from "./secure-random-DXbHDsH7.js";
import { i as isRenderablePayload, n as applyReplyThreading, t as applyReplyTagsToPayload } from "./reply-payloads-BCZaAzUe.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-DINJQY6z.js";
import { n as filterMessagingToolMediaDuplicates, r as shouldSuppressMessagingToolReplies, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-AtSsi4AV.js";
...
import { n as routeReply, t as isRoutableChannel } from "./route-reply-B7YPE_jC.js";
import { o as scheduleFollowupDrain, r as enqueueFollowupRun, s as refreshQueuedFollowupSession } from "./queue-CX_rZ1TS.js";
import { h as replyRunRegistry, m as createReplyOperation, p as ReplyRunAlreadyActiveError, s as queueEmbeddedPiMessage } from "./runs-CGD-1aD2.js";
import { n as spawnSubagentDirect } from "./subagent-spawn-BWZjexsh.js";
import "./sandbox-DMVxFt34.js";
import { n as compactEmbeddedPiSession, t as runEmbeddedPiAgent } from "./pi-embedded-BzWwX_Ok.js";
import { n as resolveCronStorePath, t as loadCronStore } from "./store-DObD_x30.js";
import { t as formatProviderModelRef } from "./model-runtime-BHxB4Bki.js";
import { t as runCliAgent } from "./cli-runner-CXbhZZ7_.js";
import { c as setCliSessionId, r as getCliSessionBinding, s as setCliSessionBinding } from "./cli-session-DwkvFtoq.js";
import { a as resolveModelFallbackOptions, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyExecutionConfig, r as formatBunFetchSocketError, s as resolveQueuedReplyRuntimeConfig, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-BpI2xquj.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-0LTEscZz.js";
import { a as createBlockReplyContentKey, i as createAudioAsVoiceBuffer, o as createBlockReplyPipeline, r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-Dlqa_Uo0.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-D6tujXS2.js";
import { n as incrementCompactionCount } from "./session-updates-CK2UcPx6.js";
import { a as currentContinuationGeneration, d as unregisterContinuationTimerHandle, i as clearTrackedContinuationTimers, l as retainContinuationTimerRef, n as clearDelegatePending, o as maybeDropContinuationGeneration, r as clearDelegatePendingIfNoDelayedReservations, s as registerContinuationTimerHandle, t as bumpContinuationGeneration, u as setDelegatePending } from "./continuation-state-CRa5wUzC.js";
...
async function runEmbeddedPiAgentDefault$1(...args) {
	const { runEmbeddedPiAgent } = await import("./pi-embedded.runtime-B0O3fpwi.js");
				...
				return (async () => {
					...
					try {
						const result = await runEmbeddedPiAgentDefault$1({
							...
							requestCompactionOpts: params.followupRun.run.config?.agents?.defaults?.continuation?.enabled === true ? {
								getContextUsage: () => {
									const entry = params.sessionKey ? params.activeSessionStore?.[params.sessionKey] : void 0;
									if (!entry?.totalTokens || entry.totalTokensFresh === false) return 0;
								...
								triggerCompaction: async () => {
									try {
										const result = await compactEmbeddedPiSession({
											sessionId: params.followupRun.run.sessionId ?? params.getActiveSessionEntry()?.sessionId ?? "",
											sessionKey: params.sessionKey ?? "",
											sessionFile: params.followupRun.run.sessionFile,
											workspaceDir: params.followupRun.run.workspaceDir,
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded-CSafyVIe.js");
...
function loadReplyPayloadsDedupeRuntime() {
	replyPayloadsDedupeRuntimePromise ??= import("./reply-payloads-dedupe.runtime-O1RDUi4I.js");
...
async function runReplyAgent(params) {
	...
	try {
		...
		setTaskFlowDelegatesEnabled(cfg.agents?.defaults?.continuation?.enabled === true && cfg.agents?.defaults?.continuation?.taskFlowDelegates === true);
		...
		const { runId, runResult, fallbackProvider, fallbackModel, fallbackAttempts, directlySentBlockKeys, continueWorkRequest } = runOutcome;
		...
		const payloadArray = runResult.payloads ?? [];
		setTaskFlowDelegatesEnabled(continuationFeatureEnabled && cfg.agents?.defaults?.continuation?.taskFlowDelegates === true);
		let continuationSignal = null;
		if (continuationFeatureEnabled && payloadArray.length > 0) {
			let lastTextPayload;
			for (let i = payloadArray.length - 1; i >= 0; i--) if (payloadArray[i].text) {
		...
		const effectiveContinuationSignal = continuationSignal ?? (continuationFeatureEnabled && continueWorkRequest ? {
			kind: "work",
			delayMs: continueWorkRequest.delaySeconds * 1e3
		} : null);
		const continuationWorkReason = !continuationSignal && effectiveContinuationSignal?.kind === "work" ? continueWorkRequest?.reason : void 0;
		...
		if (autoCompactionCount > 0) {
			...
			if (sessionKey) {
				...
				try {
					...
					defaultRuntime.log(`Failed to load post-compaction delegates for ${sessionKey}: ${String(err)}`);
				}
				const allCompactionDelegates = [...persistedCompactionDelegates, ...stagedCompactionDelegates].map(normalizePostCompactionDelegate);
				const { maxChainLength: maxCompactionChainLength, maxDelegatesPerTurn: maxCompactionDelegates, costCapTokens: compactionCostCapTokens } = resolveContinuationRuntimeConfig(cfg);
				...
				let droppedCompactionDelegates = Math.max(0, allCompactionDelegates.length - releasedCompactionDelegates.length);
				...
				const compactionChainStartedAt = activeSessionEntry?.continuationChainStartedAt ?? Date.now();
				const compactionChainTokens = activeSessionEntry?.continuationChainTokens ?? 0;
				let dispatchedCompactionDelegates = 0;
				readPostCompactionContext(typeof followupRun.run.workspaceDir === "string" && followupRun.run.workspaceDir.trim() ? followupRun.run.workspaceDir : resolveAgentWorkspaceDir(cfg, followupRun.run.agentId), {
					cfg,
				...
				for (const delegate of releasedCompactionDelegates) {
					if (currentCompactionChainCount >= maxCompactionChainLength) {
						...
						defaultRuntime.log(`Post-compaction delegate rejected: chain length ${currentCompactionChainCount} >= ${maxCompactionChainLength} for session ${sessionKey}`);
						enqueueSystemEvent(`[continuation] Post-compaction delegate rejected: chain length ${maxCompactionChainLength} reached. Task: ${delegate.task}`, { sessionKey });
						continue;
					}
					if (compactionCostCapTokens > 0 && compactionChainTokens > compactionCostCapTokens) {
						droppedCompactionDelegates += 1;
						defaultRuntime.log(`Post-compaction delegate rejected: cost cap exceeded (${compactionChainTokens} > ${compactionCostCapTokens}) for session ${sessionKey}`);
						enqueueSystemEvent(`[continuation] Post-compaction delegate rejected: cost cap exceeded (${compactionChainTokens} > ${compactionCostCapTokens}). Task: ${delegate.task}`, { sessionKey });
						continue;
					}
					const nextCompactionChainCount = currentCompactionChainCount + 1;
					defaultRuntime.log(`Post-compaction delegate dispatch for session ${sessionKey}: ${delegate.task}`);
					try {
						...
						const spawnResult = await spawnSubagentDirect({
							task: `[continuation:post-compaction] [continuation:chain-hop:${nextCompactionChainCount}] Compaction just completed. Carry this working state to the post-compaction session: ${delegate.task}`,
						...
						if (spawnResult.status === "accepted") {
							...
							enqueueSystemEvent(`[continuation:compaction-delegate-spawned] Post-compaction shard dispatched: ${delegate.task}`, { sessionKey });
						} else {
							droppedCompactionDelegates += 1;
							postCompactionDelegatesToPreserve.push(delegate);
							defaultRuntime.log(`Post-compaction delegate rejected (${spawnResult.status}) for session ${sessionKey} (re-staged)`);
						}
					} catch (err) {
						droppedCompactionDelegates += 1;
						postCompactionDelegatesToPreserve.push(delegate);
						defaultRuntime.log(`Post-compaction delegate failed for session ${sessionKey} (re-staged): ${String(err)}`);
					}
				}
				if (postCompactionDelegatesToPreserve.length > 0) try {
					...
					defaultRuntime.log(`Failed to persist re-staged post-compaction delegates for ${sessionKey} (${postCompactionDelegatesToPreserve.length}): ${String(err)}`);
				}
				enqueueSystemEvent(buildPostCompactionLifecycleEvent({
				...
				if (currentCompactionChainCount > originalCompactionChainCount) {
					...
					if (storePath) try {
						...
						defaultRuntime.log(`Failed to persist post-compaction delegate chain state for ${sessionKey}: ${String(err)}`);
					}
				}
			}
			if (verboseEnabled) {
				...
				if (allocatedChainHop >= maxChainLength) {
					...
					if (costCapTokens > 0 && accumulatedChainTokens > costCapTokens) {
						...
						if (effectiveContinuationSignal.kind === "delegate") {
							...
							if (sessionKey) setDelegatePending(sessionKey);
		...
		if (continuationFeatureEnabled && sessionKey) {
			...
			if (toolDelegates.length > 0) {
				...
				for (const droppedDelegate of delegatesOverLimit) enqueueSystemEvent(`[continuation] Tool delegate rejected: maxDelegatesPerTurn exceeded (${maxDelegatesPerTurn}). Task: ${droppedDelegate.task}`, { sessionKey });
