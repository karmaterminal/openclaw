...
import { r as writeRuntimeJson } from "./runtime-CHryl7ev.js";
import { r as theme, t as colorize } from "./theme-BrRleVfL.js";
import { V as getShellEnvAppliedKeys, W as shouldEnableShellEnvFallback, r as createConfigIO } from "./io-CgtDzW1a.js";
...
import { i as resolveAgentExplicitModelPrimary, s as resolveAgentModelFallbacksOverride, y as resolveAgentDir } from "./agent-scope-Cmx30dd2.js";
import "./config-C9V3s22v.js";
import { u as resolveAuthStorePathForDisplay } from "./source-check-BF2yQkmu.js";
import { i as ensureAuthProfileStoreWithoutExternalProfiles } from "./store-DlTWjzi2.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-DGDPUqkd.js";
import { u as isNonSecretApiKeyMarker, v as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-OFrmb6OJ.js";
import { t as modelKey } from "./model-ref-shared-_RqTYw_1.js";
import { f as resolveConfiguredModelRef, h as resolveModelRefFromString, i as buildModelAliasIndex, x as parseModelRef, y as modelKey$1 } from "./model-selection-shared-BsuJEYVd.js";
...
import { n as resolveAwsSdkEnvVarName } from "./model-auth-runtime-shared-DzemnHMl.js";
import { r as loadModelCatalog } from "./model-catalog-BQjlGG04.js";
import { i as discoverModels, l as resolveRuntimeSyntheticAuthProviderRefs, r as discoverAuthStorage } from "./pi-model-discovery-T8FxHLHF.js";
...
import { o as resolveProfileUnusableUntilForDisplay } from "./usage-CWBZsWsW.js";
import "./profiles-ByOh6QBz.js";
import { i as getCustomProviderApiKey, l as resolveUsableCustomProviderApiKey, o as hasUsableCustomProviderApiKey } from "./model-auth-CUr5avFe.js";
import { n as shouldSuppressBuiltInModel } from "./model-suppression-DSgfAyd8.js";
import { r as resolveModelWithRegistry } from "./model-DGlpPESa.js";
import { f as isLocalBaseUrl, i as formatTokenK, n as ensureFlagCompatibility, s as resolveKnownAgentId } from "./shared-CdJRJi2c.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-CEa2o3X6.js";
import { t as maskApiKey } from "./mask-api-key-BJoQiVrb.js";
import { n as loadModelsConfigWithSource, t as loadModelsConfig } from "./load-config-BTzDrMz_.js";
import { n as loadProviderCatalogModelsForList, t as hasProviderStaticCatalogForFilter } from "./list.runtime-wJcwrp7R.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-DfAIkOd9.js";
...
async function modelsListCommand(opts, runtime) {
	...
	const { ensureAuthProfileStore, resolveOpenClawAgentDir } = await import("./list.runtime-BT98iZBH.js");
...
function loadProviderUsageRuntime() {
	providerUsageRuntimePromise ??= import("./provider-usage-CCO8LsjN.js");
	return providerUsageRuntimePromise;
}
function loadProgressRuntime() {
	progressRuntimePromise ??= import("./progress-C6oI8hJ-.js");
	return progressRuntimePromise;
}
function loadTerminalTableRuntime() {
	terminalTableRuntimePromise ??= import("./table-DAi4DLiK.js");
	return terminalTableRuntimePromise;
}
function loadListProbeRuntime() {
	listProbeRuntimePromise ??= import("./list.probe-CcIpROeT.js");
...
async function modelsStatusCommand(opts, runtime) {
	...
	if (missingProvidersInUse.length > 0) {
		const { buildProviderAuthRecoveryHint } = await import("./provider-auth-guidance-C8VdLqcM.js");
		runtime.log("");
