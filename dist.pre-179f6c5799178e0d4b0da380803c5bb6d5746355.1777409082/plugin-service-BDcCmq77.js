...
import { _ as browserTabs, c as browserFocusTab, f as browserSnapshot, h as browserStop, i as browserCloseTab, l as browserOpenTab, m as browserStatus, n as trackSessionBrowserTab, p as browserStart, r as untrackSessionBrowserTab, s as browserDoctor, u as browserProfiles } from "./session-tab-registry-Bu6mkUo6.js";
import { a as applyBrowserProxyPaths, c as browserPdfSave, d as browserArmFileChooser, f as browserNavigate, i as resolveRequestedBrowserProfile, l as browserAct, n as isPersistentBrowserProfileMutation, o as persistBrowserProxyFiles, p as browserScreenshotAction, s as browserConsoleMessages, u as browserArmDialog } from "./browser-runtime-RaILLFjY.js";
import { n as resolveProfile, t as resolveBrowserConfig } from "./config-CLeyqVJp.js";
import { c as DEFAULT_AI_SNAPSHOT_MAX_CHARS, i as resolveExistingPathsWithinRoot, r as DEFAULT_UPLOAD_DIR } from "./paths-fD96EJYS.js";
import { f as redactCdpUrl } from "./cdp.helpers-Daf7aqOi.js";
import { r as getBrowserProfileCapabilities } from "./target-id-CaEBbiTR.js";
import { l as normalizeBrowserFormField, u as normalizeBrowserFormFieldValue } from "./pw-role-snapshot-yNrcqI81.js";
import { a as createBrowserRouteDispatcher, r as startBrowserControlServiceFromConfig, t as createBrowserControlContext } from "./control-service-BqHY0SWl.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-cEVt-Fu4.js"),
