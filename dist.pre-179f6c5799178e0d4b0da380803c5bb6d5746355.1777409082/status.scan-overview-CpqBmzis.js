...
import { i as hasConfiguredChannelsForReadOnlyScope } from "./channel-plugin-ids-CR84c_yu.js";
import { t as createEmptyTaskRegistrySummary } from "./task-registry.summary-CFfjdjcQ.js";
import { n as createEmptyTaskAuditSummary } from "./task-registry.audit.shared-CmCa0vpB.js";
import { t as pickGatewaySelfPresence } from "./gateway-presence-CG_JCclx.js";
import { t as resolveGatewayProbeTarget } from "./probe-target-CsNeeEMG.js";
...
function loadGatewayProbeModule() {
	gatewayProbeModulePromise ??= import("./status.gateway-probe-Cx98fmKx.js");
...
function loadStatusScanDepsRuntimeModule() {
	statusScanDepsRuntimeModulePromise ??= import("./status.scan.deps.runtime-Bgu6Ucne.js");
	return statusScanDepsRuntimeModulePromise;
}
function loadStatusAgentLocalModule() {
	statusAgentLocalModulePromise ??= import("./status.agent-local-k-y96s81.js");
	return statusAgentLocalModulePromise;
}
function loadStatusUpdateModule() {
	statusUpdateModulePromise ??= import("./status.update-GvrWQBl1.js");
	return statusUpdateModulePromise;
}
function loadStatusScanRuntimeModule() {
	statusScanRuntimeModulePromise ??= import("./status.scan.runtime-Cgql4h8a.js");
	return statusScanRuntimeModulePromise;
}
function loadGatewayCallModule() {
	gatewayCallModulePromise ??= import("./call-CHLUatfa.js");
	return gatewayCallModulePromise;
}
function loadStatusSummaryModule() {
	statusSummaryModulePromise ??= import("./status.summary-WtXQPa9B.js");
	return statusSummaryModulePromise;
}
function loadConfigModule() {
	configModulePromise ??= import("./config-DV9rjqBe.js");
	return configModulePromise;
}
function loadCommandConfigResolutionModule() {
	commandConfigResolutionModulePromise ??= import("./command-config-resolution-r8z5yNyb.js");
	return commandConfigResolutionModulePromise;
}
function loadCommandSecretTargetsModule() {
	commandSecretTargetsModulePromise ??= import("./command-secret-targets-DwQBPyyr.js");
