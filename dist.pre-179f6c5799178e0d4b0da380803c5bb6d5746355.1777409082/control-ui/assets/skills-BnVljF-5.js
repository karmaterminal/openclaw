import{h as e,l as t,p as n,r}from"./i18n-B3qLZCy2.js";import{t as i}from"./format-C6Fj4uuq.js";import{m as a,u as o}from"./index-B4ACMD1E.js";import{i as s,n as c,r as l,t as u}from"./skills-shared-Iso6b0XO.js";function d(e){return e?o(e,window.location.href):null}function f(e){!(e instanceof HTMLDialogElement)||e.open||e.showModal()}var p=[{id:`all`,label:`All`},{id:`ready`,label:`Ready`},{id:`needs-setup`,label:`Needs Setup`},{id:`disabled`,label:`Disabled`}];function m(e,t){switch(t){case`all`:return!0;case`ready`:return!e.disabled&&e.eligible;case`needs-setup`:return!e.disabled&&!e.eligible;case`disabled`:return e.disabled}throw Error(`Unsupported skills status filter`)}function h(e){return e.disabled?`muted`:e.eligible?`ok`:`warn`}function g(i){let a=i.report?.skills??[],o={all:a.length,ready:0,"needs-setup":0,disabled:0};for(let e of a)e.disabled?o.disabled++:e.eligible?o.ready++:o[`needs-setup`]++;let c=i.statusFilter===`all`?a:a.filter(e=>m(e,i.statusFilter)),l=t(i.filter),u=l?c.filter(e=>t([e.name,e.description,e.source].join(` `)).includes(l)):c,d=s(u),f=i.detailKey?a.find(e=>e.skillKey===i.detailKey)??null:null;return e`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        ...
        <button
          ...
          @click=${i.onRefresh}
        >
          ${i.loading?r(`common.loading`):r(`common.refresh`)}
        </button>
      </div>
  ...
  `:n}function v(t){let i=t.clawhubDetail;return e`
    <dialog
      ...
      <div class="md-preview-dialog__panel">
        <div class="md-preview-dialog__header">
          <div class="md-preview-dialog__title">
            ${i?.skill?.displayName??t.clawhubDetailSlug}
          </div>
          <button
            class="btn btn--sm"
        ...
        <div class="md-preview-dialog__body" style="display: grid; gap: 16px;">
          ${t.clawhubDetailLoading?e`<div class="muted">${r(`common.loading`)}</div>`:t.clawhubDetailError?e`<div class="callout danger">${t.clawhubDetailError}</div>`:i?.skill?e`
                    ...
                    >
                      ${t.clawhubInstallSlug===t.clawhubDetailSlug?`Installing…`:`Install ${i.skill.displayName}`}
                    </button>
...
//# sourceMappingURL=skills-BnVljF-5.js.map