...
function createAnthropicVertexStreamFn(projectId, region, baseURL) {
	const streamFnPromise = import("./stream-runtime.js").then((runtime) => runtime.createAnthropicVertexStreamFn(projectId, region, baseURL));
...
function createAnthropicVertexStreamFnForModel(model, env = process.env) {
	const streamFnPromise = import("./stream-runtime.js").then((runtime) => runtime.createAnthropicVertexStreamFnForModel(model, env));
	return async (...args) => {
