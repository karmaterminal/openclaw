...
import { d as resolveSecretInputRef, i as coerceSecretRef, s as isValidEnvSecretRefId } from "./types.secrets-v6szeegc.js";
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-cHj1Typp.js";
import { n as info, o as success, t as danger } from "./globals-BGbp8MG5.js";
import { a as resolveSecretRefValue } from "./resolve-DzV-TKXt.js";
import { w as SecretProviderSchema } from "./zod-schema.core-Bi0Ke4ns.js";
import { C as validateConfigObjectRaw, u as readConfigFileSnapshot, x as collectUnsupportedSecretRefPolicyIssues } from "./io-CgtDzW1a.js";
import { r as replaceConfigFile } from "./mutate-BZ9COnKf.js";
import "./config-C9V3s22v.js";
import { a as normalizeConfigIssues, n as formatConfigIssueLines } from "./issue-format-BMX-Jwhc.js";
import { t as redactConfigObject } from "./redact-snapshot-CNHLfn6R.js";
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-CL9S4cja.js";
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-DPI1XbWh.js";
import { n as setCommandJsonMode } from "./json-mode-CRPjBAhC.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-Ccf9x76K.js");
