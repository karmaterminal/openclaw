...
import { n as normalizeAtHashSlug, s as normalizeStringEntries } from "./string-normalization-ColQTP6c.js";
import { a as loadConfig } from "./io-CgtDzW1a.js";
import { a as isSubagentSessionKey, n as isAcpSessionKey, o as parseAgentSessionKey } from "./session-key-utils-BdCb1Ic0.js";
import { c as normalizeAgentId, l as normalizeMainKey, r as buildAgentMainSessionKey } from "./session-key-05a3Ypk7.js";
import { a as normalizeAnyChannelId } from "./registry-CW3lfH7N.js";
import { t as getLoadedChannelPluginById } from "./registry-loaded-Dgf_rPt-.js";
...
import { n as DEFAULT_AGENT_WORKSPACE_DIR, u as ensureAgentWorkspace } from "./workspace-BoT_VDZH.js";
import { _ as resolveAgentConfig, b as resolveAgentWorkspaceDir, h as listAgentEntries, l as resolveAgentSkillsFilter, p as resolveSessionAgentId, y as resolveAgentDir } from "./agent-scope-Cmx30dd2.js";
import "./config-C9V3s22v.js";
import { d as resolveGatewayMessageChannel, r as isInternalMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-BSGc07rB.js";
import "./message-channel-core-CCOC4Bdb.js";
import { i as isInterSessionInputProvenance } from "./input-provenance-3AB0L-Nv.js";
import { d as resetRegisteredAgentHarnessSessions } from "./loader-DIJaLaot.js";
import "./plugins-BXj_dAAn.js";
import { n as fireAndForgetHook } from "./fire-and-forget-ws6yDiV7.js";
...
import { g as requireActivePluginChannelRegistry, n as getActivePluginChannelRegistryVersion } from "./runtime-AU4GSMts.js";
import { f as normalizeThinkLevel, h as normalizeVerboseLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, t as formatThinkingLevels } from "./thinking-CGwszwLq.js";
import { h as resolveModelRefFromString } from "./model-selection-shared-BsuJEYVd.js";
import "./model-selection-CZMUiuFR.js";
import { _ as resolveGroupSessionKey, o as updateSessionStore, p as deriveSessionMetaPatch, u as resolveSessionStoreEntry } from "./store-YSRCrOf6.js";
...
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-C9Qq8LIv.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-BuGAfG5X.js";
...
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, n as deliveryContextKey, t as deliveryContextFromSession } from "./delivery-context.shared-Cjcgi24o.js";
import { o as resolveMaintenanceConfigFromInput, t as loadSessionStore } from "./store-load-DghVySJ7.js";
import { a as resolveAndPersistSessionFile } from "./transcript-DGwh8iNr.js";
import { n as parseSessionThreadInfoFast } from "./thread-info-C8F9QXHt.js";
import { o as getQueueSize, r as clearCommandLane } from "./command-queue-BYs_ZoM6.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-Bnib3S4J.js";
import { rt as isReasoningTagProvider } from "./wait-for-idle-before-flush-BOMgYG9u.js";
import { n as applyOwnerOnlyToolPolicy } from "./tool-policy-DZ8Bwz3v.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-BF1ltDJz.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-DbGsWo-9.js";
import { i as collectTextContentBlocks } from "./tool-schema-runtime-CAr7YYe_.js";
...
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-Cuyod0-3.js";
import { i as generateSecureToken } from "./secure-random-DXbHDsH7.js";
import { n as resolveSilentReplySettings } from "./silent-reply-DTaEDojC.js";
import { t as buildOutboundSessionContext } from "./session-context-CbzVoOos.js";
import { i as enqueueSystemEvent, l as removeSystemEvents } from "./system-events-zzYXvZSs.js";
import { t as resolveQueueSettings } from "./queue-CX_rZ1TS.js";
...
import { r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-khF7eyhM.js";
import { o as forkSessionFromParent, s as resolveParentForkMaxTokens } from "./subagent-spawn-BWZjexsh.js";
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-BNec-Rh6.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-DjTFIAXb.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-Dg5oxANZ.js";
import { t as hasControlCommand } from "./command-detection-CKo9Glf3.js";
import "./commands-registry-Bt3ZgbN-.js";
import { t as resolveRunTypingPolicy } from "./typing-policy-BSSdKbEO.js";
import { t as normalizeInboundTextNewlines } from "./inbound-text-DNj7_tPx.js";
import { t as finalizeInboundContext } from "./inbound-context-CY3JICXN.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-C8vEbSJB.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-5OLNfSny.js";
import { n as createTypingKeepaliveLoop, t as createTypingStartGuard } from "./typing-start-guard-BTkLiLEe.js";
import { t as resolveChannelModelOverride } from "./model-overrides-Do5ln7CT.js";
import { t as normalizeGroupActivation } from "./group-activation-D6c5zDYV.js";
import { i as resolveTypingMode, r as resolveActiveRunQueueAction, t as cancelContinuationTimer } from "./agent-runner-CKJvdsks.js";
import { r as getCliSessionBinding } from "./cli-session-DwkvFtoq.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-0LTEscZz.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-Dlqa_Uo0.js";
import { n as buildSessionStartHookPayload, t as buildSessionEndHookPayload } from "./session-hooks-C8KsgQrm.js";
import { r as drainFormattedSystemEvents } from "./session-updates-CK2UcPx6.js";
import { t as resolveDefaultModel } from "./directive-handling.defaults-D4MOEuto.js";
import { t as resolveFastModeState } from "./fast-mode-MBC647tq.js";
import { t as buildCommandContext } from "./commands-context-CZaYIYg5.js";
import { t as parseInlineDirectives } from "./directive-handling.parse-B9mKHCJa.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-C_1ATE3c.js";
import { t as resolveModelSelectionFromDirective } from "./directive-handling.model-selection-MR1p01UW.js";
...
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-BEX5FVFM.js";
import { n as parseSoftResetCommand, t as isResetAuthorizedForContext } from "./reset-authorization-XhjNr_6H.js";
...
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-0UBVH7Jk.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-C843ad49.js";
import { t as hasInboundMedia } from "./inbound-media-BRmwbEV8.js";
...
import { t as resolveResetPreservedSelection } from "./reset-preserved-selection-BDyQvVHq.js";
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-KLiG5W-a.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-BlWkGgD1.js";
...
function loadCommandsStatus() {
	commandsStatusPromise ??= import("./commands-status.runtime-xFEQM1HF.js");
	return commandsStatusPromise;
}
function loadDirectiveLevels() {
	directiveLevelsPromise ??= import("./directive-handling.levels-BG4rZEqm.js");
	return directiveLevelsPromise;
}
function loadDirectiveImpl() {
	directiveImplPromise ??= import("./directive-handling.impl-CD2YLMh5.js");
	return directiveImplPromise;
}
function loadDirectiveFastLane() {
	directiveFastLanePromise ??= import("./directive-handling.fast-lane-DLKM9tBT.js");
	return directiveFastLanePromise;
}
function loadDirectivePersist() {
	directivePersistPromise ??= import("./directive-handling.persist.runtime-D4-LZxjt.js");
...
function loadGroupsRuntime() {
	groupsRuntimePromise ??= import("./groups.runtime-BvYPmuNq.js");
...
function loadCommandsRegistry() {
	commandsRegistryPromise ??= import("./commands-registry.runtime-DeRSrCe6.js");
	return commandsRegistryPromise;
}
function loadSkillCommands() {
	skillCommandsPromise ??= import("./skill-commands.runtime-ZyCTAKEL.js");
...
function loadSkillCommandsRuntime() {
	skillCommandsRuntimePromise ??= import("./skill-commands.runtime-ZyCTAKEL.js");
	return skillCommandsRuntimePromise;
}
function loadOpenClawToolsRuntime() {
	openClawToolsRuntimePromise ??= import("./openclaw-tools.runtime-BlhAo3Cg.js");
	return openClawToolsRuntimePromise;
}
function loadAbortCutoffRuntime() {
	abortCutoffRuntimePromise ??= import("./abort-cutoff.runtime-CC_yqnSW.js");
	return abortCutoffRuntimePromise;
}
function loadCommandsRuntime() {
	commandsRuntimePromise ??= import("./commands.runtime-e7trkXKI.js");
...
function loadSessionStoreRuntime$1() {
	sessionStoreRuntimePromise$1 ??= import("./store.runtime-BTwCGXUu.js");
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded.runtime-B0O3fpwi.js");
	return piEmbeddedRuntimePromise;
}
function loadAgentRunnerRuntime() {
	agentRunnerRuntimePromise ??= import("./agent-runner.runtime-xfv2vYZb.js");
	return agentRunnerRuntimePromise;
}
function loadSessionUpdatesRuntime() {
	sessionUpdatesRuntimePromise ??= import("./session-updates.runtime-DGMMeeO6.js");
...
async function runPreparedReply(params) {
	...
	if (isDelegateWake && sessionKey) clearDelegatePending(sessionKey);
...
function loadDeliverRuntime() {
	deliverRuntimePromise ??= import("./deliver-runtime-B1fXupr2.js");
...
function loadSessionArchiveRuntime() {
	sessionArchiveRuntimePromise ??= import("./session-archive.runtime-DzZw-Oz1.js");
...
function loadSessionResetModelRuntime() {
	sessionResetModelRuntimePromise ??= import("./session-reset-model.runtime-CRVrzWEC.js");
	return sessionResetModelRuntimePromise;
}
function loadStageSandboxMediaRuntime() {
	stageSandboxMediaRuntimePromise ??= import("./stage-sandbox-media.runtime-nxrGewgi.js");
	return stageSandboxMediaRuntimePromise;
}
function loadMediaUnderstandingApplyRuntime() {
	mediaUnderstandingApplyRuntimePromise ??= import("./apply.runtime-C06-TXmb.js");
	return mediaUnderstandingApplyRuntimePromise;
}
function loadLinkUnderstandingApplyRuntime() {
	linkUnderstandingApplyRuntimePromise ??= import("./apply.runtime-a7NeIXlu.js");
	return linkUnderstandingApplyRuntimePromise;
}
function loadCommandsCoreRuntime() {
	commandsCoreRuntimePromise ??= import("./commands-core.runtime-D6NLDcCd.js");
...
function loadHookRunnerGlobal() {
	hookRunnerGlobalPromise ??= import("./hook-runner-global-Gahvk1eU.js");
	return hookRunnerGlobalPromise;
}
function loadOriginRouting() {
	originRoutingPromise ??= import("./origin-routing-RXRxwRJc.js");
