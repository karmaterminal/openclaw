...
import { n as formatToolSummary, r as resolveToolDisplay } from "./tool-display-sV7ERp4f.js";
...
import { r as prefixSystemMessage } from "./system-message-CvJk5HgA.js";
import { t as resolveConfiguredTtsMode } from "./tts-config-DFlkBXLf.js";
import { o as createBlockReplyPipeline, r as resolveEffectiveBlockStreamingConfig, t as clampPositiveInteger } from "./block-streaming-Dlqa_Uo0.js";
import { t as hasInboundMedia } from "./inbound-media-BRmwbEV8.js";
import { i as toAcpRuntimeError } from "./errors-8Eu5sh9U.js";
import { o as isSessionIdentityPending, u as resolveSessionIdentityFromMeta } from "./session-identity-BXp100kY.js";
import { t as formatAcpRuntimeErrorText } from "./error-text-BxkdXOcE.js";
import { a as resolveAcpDispatchPolicyError, i as resolveAcpAgentPolicyError } from "./policy-l5DWlW6f.js";
import { a as resolveAcpThreadSessionDetailLines } from "./session-identifiers-C2G3v52m.js";
import { t as resolveStatusTtsSnapshot } from "./status-config-Bxr2xmMo.js";
...
function loadDispatchAcpMediaRuntime() {
	dispatchAcpMediaRuntimePromise ??= import("./dispatch-acp-media.runtime-_haf4j1o.js");
...
function loadDispatchAcpTtsRuntime$1() {
	dispatchAcpTtsRuntimePromise$1 ??= import("./dispatch-acp-tts.runtime-Dn-KoxK_.js");
	return dispatchAcpTtsRuntimePromise$1;
}
function loadChannelPluginRuntime() {
	channelPluginRuntimePromise ??= import("./plugins-FzdEyAm0.js");
	return channelPluginRuntimePromise;
}
function loadMessageActionRuntime() {
	messageActionRuntimePromise ??= import("./message-action-runner-Ch48cADU.js");
...
function loadDispatchAcpManagerRuntime() {
	dispatchAcpManagerRuntimePromise ??= import("./dispatch-acp-manager.runtime-BTibPmWG.js");
	return dispatchAcpManagerRuntimePromise;
}
function loadDispatchAcpSessionRuntime() {
	dispatchAcpSessionRuntimePromise ??= import("./dispatch-acp-session.runtime-Cn4_Vr7i.js");
	return dispatchAcpSessionRuntimePromise;
}
function loadDispatchAcpTtsRuntime() {
	dispatchAcpTtsRuntimePromise ??= import("./dispatch-acp-tts.runtime-Dn-KoxK_.js");
