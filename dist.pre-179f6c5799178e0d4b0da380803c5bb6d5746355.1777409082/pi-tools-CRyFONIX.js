...
import { _ as resolveAgentConfig } from "./agent-scope-Cmx30dd2.js";
import { d as resolveGatewayMessageChannel } from "./message-channel-BSGc07rB.js";
import { c as createOpenClawReadTool, d as createSandboxedWriteTool, f as wrapToolMemoryFlushAppendOnlyWrite, l as createSandboxedEditTool, m as wrapToolWorkspaceRootGuardWithOptions, o as createHostWorkspaceEditTool, p as wrapToolWorkspaceRootGuard, s as createHostWorkspaceWriteTool, t as createOpenClawTools, u as createSandboxedReadTool } from "./openclaw-tools-DclzkKxa.js";
import { b as EXEC_TOOL_DISPLAY_SUMMARY, c as mergeAlsoAllowPolicy, i as collectExplicitAllowlist, m as resolveToolProfilePolicy, n as applyOwnerOnlyToolPolicy, x as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-policy-DZ8Bwz3v.js";
import { n as getPluginToolMeta, t as copyPluginToolMeta } from "./tools-CqiGxZl1.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-BfcPpUMq.js";
import { i as listChannelAgentTools, t as copyChannelAgentToolMeta } from "./channel-tools-D7aSZI_6.js";
import { t as normalizeToolParameterSchema } from "./pi-tools-parameter-schema-DR1OdZKb.js";
import { t as bindAbortRelay } from "./fetch-timeout-CTh6YfXM.js";
import { a as wrapToolWithBeforeToolCallHook } from "./pi-tools.before-tool-call-C1-hxc9k.js";
import { i as resolveMergedSafeBinProfileFixtures } from "./exec-safe-bin-runtime-policy-CS2T7EYE.js";
import { g as writeFileWithinRoot, o as mkdirPathWithinRoot, p as removePathWithinRoot } from "./fs-safe-BsNurHhz.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-sQBZ4EUo.js";
import { n as assertSandboxPath } from "./sandbox-paths-SCfCeGQ9.js";
import { a as resolveGroupToolPolicy, c as resolveWorkspaceRoot, l as resolvePathFromInput, o as resolveSubagentToolPolicyForSession, r as resolveEffectiveToolPolicy, u as toRelativeSandboxPath } from "./read-capability-CQkQhNiw.js";
...
import { c as shouldSuppressManagedWebSearchTool } from "./codex-native-web-search-B_1nB2xs.js";
import { t as isToolAllowedByPolicies } from "./tool-policy-match-CphEMw8X.js";
import { i as resolveToolFsConfig, t as createToolFsPolicy } from "./tool-fs-policy-DtlmKEcx.js";
...
function loadBashToolsModule() {
	bashToolsModulePromise ??= import("./bash-tools-SUgzbY-o.js");
