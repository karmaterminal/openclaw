...
import { l as normalizeMainKey, u as resolveAgentIdFromSessionKey } from "./session-key-05a3Ypk7.js";
import "./config-C9V3s22v.js";
import { c as isGatewayMessageChannel, r as isInternalMessageChannel, u as normalizeMessageChannel } from "./message-channel-BSGc07rB.js";
...
import { i as normalizeDeliveryContext$1, r as mergeDeliveryContext$1 } from "./delivery-context.shared-Cjcgi24o.js";
import { t as loadSessionStore } from "./store-load-DghVySJ7.js";
import { r as callGateway } from "./call-TrQWMVYB.js";
import { n as resolveConversationDeliveryTarget } from "./delivery-context-BsPnUBeq.js";
import { t as getSubagentDepthFromSessionStore } from "./subagent-depth-D6sN6dac.js";
import { r as resolveComparableTargetForLoadedChannel } from "./target-parsing-loaded-7ivJKdLm.js";
...
import { r as normalizeConversationRef } from "./conversation-id-CuiK5pzV.js";
import { r as getSessionBindingService } from "./session-binding-service-DskOwwNl.js";
import { t as resolveConversationIdFromTargets } from "./conversation-id-DqnCEd7m.js";
import { a as isEmbeddedPiRunActive, c as resolveActiveEmbeddedRunSessionId, s as queueEmbeddedPiMessage } from "./runs-CGD-1aD2.js";
import { g as enqueueAnnounce } from "./subagent-announce-output-DYhIY-6J.js";
...
function resolveBoundConversationOrigin(params) {
	...
	if (requesterTo && conversationId && requesterConversationId && conversationId.toLowerCase() === requesterConversationId.toLowerCase()) return {
		...
		accountId: conversation.accountId,
		to: requesterTo,
		threadId: boundTarget.threadId ?? (params.requesterOrigin?.threadId != null && params.requesterOrigin.threadId !== "" ? String(params.requesterOrigin.threadId) : void 0)
	};
	return {
		channel: conversation.channel,
		accountId: conversation.accountId,
...
//#endregion
export { resolveSubagentCompletionOrigin as a, buildAnnounceIdFromChildRun as c, resolveMaxDelegatesPerTurn as d, resolveSubagentAnnounceTimeoutMs as i, buildAnnounceIdempotencyKey as l, loadRequesterSessionEntry as n, runAnnounceDeliveryWithRetry as o, loadSessionEntryByKey as r, resolveAnnounceOrigin as s, deliverSubagentAnnouncement as t, resolveContinuationRuntimeConfig as u };
