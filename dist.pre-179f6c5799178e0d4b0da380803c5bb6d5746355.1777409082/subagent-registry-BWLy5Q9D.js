...
import { t as registerPendingSpawnedChildrenQuery } from "./pending-spawn-query-D0aIl3x3.js";
import { i as failTaskRunByRunId, o as setDetachedTaskDeliveryStatusByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-BfgHfuvs.js";
import { u as withSubagentOutcomeTiming } from "./subagent-announce-output-DYhIY-6J.js";
import { r as waitForAgentRun } from "./run-wait-BVH2Pj-2.js";
import { i as emitSessionLifecycleEvent, t as configureSubagentRegistrySpawnRuntime } from "./subagent-registry-spawn-runtime-Cdq7aoOb.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-BPxAi864.js";
...
async function loadCleanupBrowserSessionsForLifecycleEnd$1() {
	browserCleanupPromise$1 ??= import("./browser-lifecycle-cleanup-CmLwf0Dh.js");
...
async function loadSubagentAnnounceModule() {
	subagentAnnouncePromise ??= import("./subagent-announce-BTWbaF4B.js");
	return await subagentAnnouncePromise;
}
async function loadCleanupBrowserSessionsForLifecycleEnd() {
	browserCleanupPromise ??= import("./browser-lifecycle-cleanup-CmLwf0Dh.js");
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-BIUhMvlP.js").then(({ scheduleOrphanRecovery }) => {
