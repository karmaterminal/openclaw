...
import { a as shouldLogVerbose, r as logVerbose } from "./globals-BGbp8MG5.js";
import { t as logDebug } from "./logger-HXvGEyjy.js";
import { n as resolveManifestContractOwnerPluginId, t as loadPluginManifestRegistry } from "./manifest-registry-Bg22SiwE.js";
import { c as resolveEffectivePluginActivationState, n as createPluginActivationSource, o as normalizePluginsConfig } from "./config-state-D7mm0cjk.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-CpZ02Rxn.js";
import { a as loadConfig, o as parseConfigJson5, v as resolveConfigSnapshotHash } from "./io-CgtDzW1a.js";
import { c as parseThreadSessionSuffix, o as parseAgentSessionKey } from "./session-key-utils-BdCb1Ic0.js";
import { n as normalizeAccountId } from "./account-id-DWChvwa8.js";
import { c as normalizeAgentId, f as sanitizeAgentId, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-05a3Ypk7.js";
import { r as normalizeProviderId } from "./provider-id-Ct2qVXr0.js";
import { o as normalizeChannelId } from "./registry-CW3lfH7N.js";
import { i as normalizeChannelId$1, r as listChannelPlugins, t as getChannelPlugin } from "./registry-BL4cljde.js";
...
import { _ as resolveAgentConfig, b as resolveAgentWorkspaceDir, m as resolveSessionAgentIds, p as resolveSessionAgentId, r as resolveAgentExecutionContract } from "./agent-scope-Cmx30dd2.js";
import { t as parseDurationMs } from "./parse-duration-CQ49DviP.js";
import { t as isInboundPathAllowed } from "./inbound-path-policy-osNGEO1b.js";
import { n as isRestartEnabled } from "./commands.flags-McyAH4_K.js";
import "./config-C9V3s22v.js";
import { h as GATEWAY_CLIENT_MODES, m as GATEWAY_CLIENT_IDS, u as normalizeMessageChannel } from "./message-channel-BSGc07rB.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-CCOC4Bdb.js";
import { d as readConnectPairingRequiredMessage } from "./connect-error-details-BaTnV6pA.js";
import { n as resolveBundledPluginCompatibleLoadValues } from "./activation-context-Mp8bHZj7.js";
import "./plugins-BXj_dAAn.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-CiBW3Awl.js";
import { n as ensureOpenClawModelsJson } from "./models-config-BLGXHp-w.js";
import { b as normalizeModelRef, h as resolveModelRefFromString, i as buildModelAliasIndex, r as buildConfiguredModelCatalog, y as modelKey } from "./model-selection-shared-BsuJEYVd.js";
import { o as resolveDefaultModelForAgent, p as resolveThinkingDefault, t as buildAllowedModelSet } from "./model-selection-CZMUiuFR.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-D5XzKQ7M.js";
import { t as requireApiKey } from "./model-auth-runtime-shared-DzemnHMl.js";
import { r as loadModelCatalog } from "./model-catalog-BQjlGG04.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-T8FxHLHF.js";
import { o as updateSessionStore } from "./store-YSRCrOf6.js";
import { t as extractDeliveryInfo } from "./sessions-CD6GeuLj.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-C9Qq8LIv.js";
import { i as normalizeDeliveryContext } from "./delivery-context.shared-Cjcgi24o.js";
import { c as createExpiringMapCache } from "./store-cache-vxZHIMwR.js";
import { t as loadSessionStore } from "./store-load-DghVySJ7.js";
import { n as resolveSessionConversationRef } from "./session-conversation-Bx0XP0sL.js";
import { n as capArrayByJsonBytes, o as readSessionTitleFieldsFromTranscript, p as jsonUtf8Bytes } from "./session-utils.fs-CblkYA9E.js";
import { p as resolveSessionModelIdentityRef, t as deriveSessionTitle } from "./session-utils-CnlJcBzh.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-Bnib3S4J.js";
import { i as imageMimeFromFormat, t as detectMime } from "./mime-DFfgvUW_.js";
import { A as describeSessionsListTool, C as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, D as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY, E as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, M as describeSessionsSpawnTool, N as describeUpdatePlanTool, O as describeSessionStatusTool, S as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, T as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, j as describeSessionsSendTool, k as describeSessionsHistoryTool, w as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, y as CRON_TOOL_DISPLAY_SUMMARY } from "./tool-policy-DZ8Bwz3v.js";
import { r as resolvePluginTools } from "./tools-CqiGxZl1.js";
import { w as textToSpeech } from "./tts-Dxaj4ngf.js";
import { p as extractTextFromChatContent } from "./sanitize-user-facing-text-CMVX4RHP.js";
import { a as getImageMetadata } from "./image-ops-Dg3mKXn0.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-BfcPpUMq.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-C81fffLk.js";
import { a as listChannelSupportedActions, r as listAllChannelSupportedActions } from "./channel-tools-D7aSZI_6.js";
import { r as getApiKeyForModel } from "./model-auth-CUr5avFe.js";
import { t as SsrFBlockedError } from "./ssrf-vXCRW9rS.js";
import { u as parseReplyDirectives } from "./payloads-Bt9OVSAu.js";
import { n as runWithImageModelFallback } from "./model-fallback-sO5hL8Gz.js";
import { c as stripReasoningTagsFromText } from "./assistant-visible-text-BpamnAIx.js";
import { t as extractAssistantText } from "./pi-embedded-utils-CCE8O9CP.js";
import { r as callGateway } from "./call-TrQWMVYB.js";
import { b as readSnakeCaseParamRaw, f as readNumberParam, g as readStringParam$1, i as asToolParamsRecord, l as jsonResult, m as readStringArrayParam, r as ToolInputError, s as imageResult } from "./common-CiiKqT5H.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-C_AHjOfl.js";
import { g as writeFileWithinRoot, r as appendFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-BsNurHhz.js";
import { t as isWindowsDrivePath } from "./archive-path-Dolf1Bps.js";
import { o as trySafeFileURLToPath, r as hasEncodedFileUrlSeparator } from "./local-file-access-CVe3zzHX.js";
import { n as assertSandboxPath } from "./sandbox-paths-SCfCeGQ9.js";
import { c as resolveWorkspaceRoot, d as toRelativeWorkspacePath, s as normalizeWorkspaceDir } from "./read-capability-CQkQhNiw.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata } from "./runtime-LLD3_uFb.js";
import "./delivery-context-BsPnUBeq.js";
import { t as sniffMimeFromBase64 } from "./sniff-mime-from-base64-DtmeK8Wy.js";
import { a as createSessionVisibilityGuard, c as resolveDisplaySessionKey, d as resolveSessionReference, f as resolveVisibleSessionReference, i as createAgentToAgentPolicy, l as resolveInternalSessionKey, n as deriveChannel, o as resolveEffectiveSessionToolsVisibility, p as shouldResolveSessionIdInput, r as resolveSessionToolContext, s as resolveSandboxedSessionToolContext, t as classifySessionKind, u as resolveMainSessionAlias } from "./sessions-helpers-DEtNtN8Y.js";
import { r as stripToolMessages } from "./chat-history-text-CMyxM2sL.js";
import { a as parseCanvasSnapshotPayload, c as parseCameraSnapPayload, d as writeCameraPayloadToFile, i as canvasSnapshotTempPath, l as writeBase64ToFile, n as screenRecordTempPath, o as cameraTempPath, r as writeScreenRecordToFile, s as parseCameraClipPayload, t as parseScreenRecordPayload, u as writeCameraClipPayloadToFile } from "./nodes-screen-DxCaQVyP.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-DmwJPWVR.js";
...
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-DTcIlPmA.js";
import { d as stagePostCompactionDelegate, f as stagedPostCompactionDelegateCount, l as pendingDelegateCount, s as enqueuePendingDelegate } from "./continuation-delegate-store-DWY_oNWi.js";
import { d as resolveMaxDelegatesPerTurn, r as loadSessionEntryByKey, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-CTGDTMHt.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-gf2VtEqP.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-BGDLuN1L.js";
import { t as inferLegacyName } from "./normalize-CUZY-W6U.js";
import { n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-BuvY94bs.js";
import { c as removeRestartSentinelFile, f as writeRestartSentinel, i as formatDoctorNonInteractiveHint, n as buildRestartSuccessContinuation } from "./restart-sentinel-D08So3wr.js";
import { o as scheduleGatewaySigusr1Restart } from "./restart-CWPEfC-L.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-AM4IvvUm.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-C-vWym1B.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-CjunD9J8.js";
import { n as resolveConfiguredMediaMaxBytes } from "./configured-max-bytes-B8XS0iCH.js";
import { l as saveMediaBuffer } from "./store-a6nK9wuy.js";
import { a as classifyMediaReferenceSource, o as normalizeMediaReferenceSource, r as getDefaultLocalRoots } from "./local-media-access-xGnD3kB5.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-Cfnn4itl.js";
import { a as coerceImageModelConfig, c as resolveProviderVisionModelFromConfig, d as hasAuthForProvider, f as hasToolModelConfig, l as buildToolModelConfigFromCandidates, n as isMinimaxVlmProvider, o as decodeDataUrl, p as resolveDefaultModelRef, u as coerceToolModelConfig } from "./minimax-vlm-DATEA1nA.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-BOzH8XCT.js";
import { b as resolveAutoMediaKeyProviders, w as getMediaUnderstandingProvider, x as resolveDefaultMediaModel, y as providerSupportsNativePdfDocument } from "./resolve-CrFilxpp.js";
import { n as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-BaA3Yr2r.js";
import { t as buildProviderRegistry } from "./runner-DWNBwiUc.js";
import "./media-understanding-DSHC_2_v.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-BqGa4yUg.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-D_WFogjX.js";
import { o as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-BTc97zIa.js";
import { a as POLL_CREATION_PARAM_DEFS, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-CcSVIDHK.js";
import { t as sendMessage } from "./message-Bco-TIst.js";
import { i as resolveMusicGenerationModeCapabilities, n as listRuntimeMusicGenerationProviders, r as listSupportedMusicGenerationModes, t as generateMusic } from "./runtime-CIy4UfMg.js";
import { r as parseMusicGenerationModelRef } from "./provider-registry-D5uE9vsQ.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-B-o2RNgp.js";
...
import { a as recordTaskRunProgressByRunId, i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-BfgHfuvs.js";
import "./task-registry-delivery-runtime-CCuR_lex.js";
import { t as formatAgentInternalEventsForPrompt } from "./internal-events-BTo2Iqi7.js";
import { d as runAgentStep, f as ANNOUNCE_SKIP_TOKEN, h as isReplySkip, m as isAnnounceSkip, p as REPLY_SKIP_TOKEN } from "./subagent-announce-output-DYhIY-6J.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-CQKa9JNW.js";
import { t as parseTimeoutMs } from "./parse-timeout-BqySWFmU.js";
import { t as extractPdfContent } from "./pdf-extract-E8PrAgTN.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-T7y6LdHL.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-CpIirPwd.js";
import { n as isRequesterParentOfBackgroundAcpSession } from "./session-interaction-mode-V1_2NGIC.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-C_BLhX0F.js";
import { i as waitForAgentRunAndReadUpdatedAssistantReply, n as readLatestAssistantReplySnapshot, r as waitForAgentRun, t as readLatestAssistantReply } from "./run-wait-BVH2Pj-2.js";
import { f as registerSubagentRun } from "./subagent-registry-BWLy5Q9D.js";
import { i as SUBAGENT_SPAWN_MODES, n as spawnSubagentDirect, r as SUBAGENT_SPAWN_CONTEXT_MODES } from "./subagent-spawn-BWZjexsh.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-CXTYblOs.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-BnEx8cyU.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, n as listRuntimeVideoGenerationProviders, r as listSupportedVideoGenerationModes, t as generateVideo } from "./runtime-DsJmpWel.js";
import { r as parseVideoGenerationModelRef } from "./provider-registry-Z2EMUcta.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-CQ8q3hLJ.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-DrNsOska.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-DBbFXC-I.js";
import { a as readResponseText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds } from "./web-shared-CR8eKOIR.js";
import { a as runWebSearch, i as resolveWebSearchDefinition } from "./runtime-JP3G4C3S.js";
import "./web-search-provider-common-8eu3TfUg.js";
...
function createContinueDelegateTool(opts) {
	return {
		...
		execute: async (_toolCallId, args) => {
			...
			log$7.debug(`[continue_delegate:enqueue] session=${sessionKey} silent=${silent} silentWake=${silentWake} delayMs=${delayMs} task=${task.slice(0, 80)}`);
...
async function getRuntime() {
	if (!runtimeMod) runtimeMod = await import("./embedded-gateway-stub.runtime-DPcZaR6t.js");
	return runtimeMod;
}
...
async function wakeMediaGenerationTaskCompletion(params) {
	...
	if (isAsyncMediaDirectSendEnabled(params.config)) try {
		...
		log$4.warn("Media generation direct completion delivery failed; falling back to announce", {
...
function createRequestCompactionTool(opts) {
	return {
		...
		execute: async (_toolCallId, args) => {
			...
			log$2.info(`[request_compaction:enqueuing] session=${sessionKey} usage=${(contextUsage * 100).toFixed(1)}% reason=${reason}`);
			...
			opts.triggerCompaction().then((result) => {
				...
				log$2.error(`[request_compaction:background-error] session=${sessionKey} error=${err instanceof Error ? err.message : String(err)}`);
			}).finally(() => {
...
function loadCommandsStatusRuntime() {
	commandsStatusRuntimePromise ??= import("./session-status.runtime-DGFxZc1r.js");
...
async function loadAcpSpawnModule() {
	acpSpawnModulePromise ??= import("./acp-spawn-CHcJ0h3G.js");
...
async function loadWebFetchRuntime() {
	webFetchRuntimePromise ??= import("./runtime-g9NrC7wK.js");
	return await webFetchRuntimePromise;
}
async function loadWebGuardedFetch() {
	webGuardedFetchPromise ??= import("./web-guarded-fetch-C5PMHpcA.js");
...
//#endregion
export { isEmbeddedMode as _, normalizeCronJobPatch as a, createOpenClawReadTool as c, createSandboxedWriteTool as d, wrapToolMemoryFlushAppendOnlyWrite as f, isStrictAgenticSupportedProviderModel as g, isStrictAgenticExecutionContractActive as h, normalizeCronJobInput as i, createSandboxedEditTool as l, wrapToolWorkspaceRootGuardWithOptions as m, getVolitionalCompactionCount as n, createHostWorkspaceEditTool as o, wrapToolWorkspaceRootGuard as p, normalizeCronJobCreate as r, createHostWorkspaceWriteTool as s, createOpenClawTools as t, createSandboxedReadTool as u, setEmbeddedMode as v };
