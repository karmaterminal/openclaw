...
import { h as resolveModelRefFromString, t as buildAllowedModelSetWithFallbacks, y as modelKey } from "./model-selection-shared-BsuJEYVd.js";
...
import { t as resolveModelDirectiveSelection } from "./model-selection-directive-Cohz5qAM.js";
...
async function resolveResetFallbackModels(params) {
	if (params.agentId) {
		const { resolveAgentModelFallbacksOverride } = await import("./agent-scope-CiX5BLtO.js");
