...
import { h as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-CgtDzW1a.js";
import { n as formatConfigIssueLines } from "./issue-format-BMX-Jwhc.js";
import { t as note } from "./note-CkJnPYMf.js";
import { n as noteIncludeConfinementWarning } from "./doctor-config-analysis-9M--TzY-.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-BQHJors_.js");
