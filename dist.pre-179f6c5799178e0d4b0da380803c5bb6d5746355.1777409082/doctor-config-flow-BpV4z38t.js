...
import { G as normalizeBaseCompatibilityConfigValues, K as normalizeLegacyCommandsConfig, L as findLegacyConfigIssues, T as validateConfigObjectWithPlugins, at as applyLegacyDoctorMigrations, ot as applyChannelDoctorCompatibilityMigrations, q as normalizeLegacyOpenAICodexModelsAddMetadata } from "./io-CgtDzW1a.js";
...
import { i as runPluginSetupConfigMigrations } from "./setup-registry-C6v0HwMX.js";
import { i as listRouteBindings } from "./bindings-DL6V-u6m.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-BHRfRsR-.js";
import { t as note } from "./note-CkJnPYMf.js";
import { a as stripUnknownConfigKeys, r as noteOpencodeProviderOverrides } from "./doctor-config-analysis-9M--TzY-.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-DCPIkWHQ.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-DtklV0ZD.js";
import { t as asObjectRecord } from "./object-DKs7NbAO.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = await (async () => {
		...
		const { collectRelevantDoctorPluginIds, listPluginDoctorLegacyConfigRules } = await import("./doctor-contract-registry-CrYbtbnv.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-BOqg1cYr.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-BletesYI.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-hk5kiUqU.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-BhCvKKTe.js");
		emitDoctorNotes({
			note,
