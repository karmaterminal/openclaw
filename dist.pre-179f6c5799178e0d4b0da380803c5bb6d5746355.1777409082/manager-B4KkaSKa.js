...
import { t as extractKeywords } from "./query-expansion-Dn2CUDBd.js";
import { i as getMemoryMultimodalExtensions, r as classifyMemoryMultimodalPath, t as buildCaseInsensitiveExtensionGlob } from "./multimodal-DyMz8kz8.js";
...
import { a as ensureDir, c as listMemoryFiles, d as remapChunkLines, f as runWithConcurrency, h as hasNonTextEmbeddingParts, i as cosineSimilarity, l as normalizeExtraMemoryPaths, n as buildMultimodalChunkForIndexing, o as hashText, p as isFileMissingError, r as chunkMarkdown, t as buildFileEntry, u as parseEmbedding } from "./internal-DT2pshY9.js";
import { r as readMemoryFile } from "./backend-config-BCaOGA2M.js";
import { n as listMemoryEmbeddingProviders, r as listRegisteredMemoryEmbeddingProviderAdapters, t as getMemoryEmbeddingProvider } from "./memory-embedding-provider-runtime-CGuT_cwy.js";
import { D as createLocalEmbeddingProvider, E as DEFAULT_LOCAL_MODEL, u as enforceEmbeddingMaxInputTokens } from "./engine-embeddings-D_oYxLLq.js";
import "./memory-core-host-engine-embeddings-BdHooFsC.js";
import "./memory-core-host-engine-foundation-C3taiQ8u.js";
import { c as buildSessionEntry, l as listSessionFilesForAgent, p as sessionPathForFile } from "./engine-qmd-eSVa5q_d.js";
import "./memory-core-host-engine-qmd-oDe9ZZWY.js";
import { n as loadSqliteVecExtension, r as ensureMemoryIndexSchema, t as requireNodeSqlite } from "./engine-storage-DxdhRtdv.js";
import "./memory-core-host-engine-storage-BJitVYI5.js";
import "./provider-env-vars-CcaN8l6Y.js";
import "./dreaming-shared-BZ4nIq4Y.js";
...
var MemoryIndexManager = class MemoryIndexManager extends MemoryManagerEmbeddingOps {
	...
	async search(query, opts) {
		...
		if (!this.provider) {
			...
			const fullQueryResults = await this.searchKeyword(cleaned, candidates, { boostFallbackRanking: true }).catch(() => []);
			const resultSets = fullQueryResults.length > 0 ? [fullQueryResults] : await Promise.all((() => {
				...
				return (keywords.length > 0 ? keywords : [cleaned]).map((term) => this.searchKeyword(term, candidates, { boostFallbackRanking: true }).catch(() => []));
			})());
	...
	async searchKeyword(query, limit, options) {
