...
import "./net-DRRI6SJt.js";
import { n as getBridgeAuthForPort } from "./bridge-auth-registry-Bbwt7co9.js";
import { t as resolveBrowserRateLimitMessage } from "./rate-limit-message-FvAlR-mn.js";
...
async function fetchBrowserJson(url, init) {
	...
	try {
		...
		const { dispatchBrowserControlRequest } = await import("./local-dispatch.runtime-Bb8eq-6r.js");
