...
import { a as resolveNodeProgramArguments, n as resolveDaemonInstallRuntimeInputs, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-DRGf4J70.js";
import { n as VERSION } from "./version-DZq9J0ei.js";
import { s as buildNodeServiceEnvironment } from "./runtime-paths-5-2EC4RK.js";
...
import { i as runServiceUninstall, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-BhZytVmB.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS } from "./node-commands-BUc7yjNs.js";
import { a as getActivePluginRegistry } from "./runtime-AU4GSMts.js";
import { t as getMachineDisplayName } from "./machine-name-CyO7R_7Q.js";
import { t as splitShellArgs } from "./shell-argv-D34PSIYZ.js";
import { _ as resolvePlannedSegmentArgv, c as describeInterpreterInlineEval, d as analyzeArgvCommand, l as detectInterpreterInlineEvalArgv, n as evaluateShellAllowlist, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-CrDnjlEW.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-CS2T7EYE.js";
...
import { t as resolveGatewayConnectionAuth } from "./connection-auth-CbfC4IrQ.js";
import { t as formatHelpExamples } from "./help-format-BXdC2bIr.js";
import { n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-DjneIUI3.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-QR08qPEj.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-fyQNS4KB.js";
import { t as resolveNodeService } from "./node-service-JqfgYpAB.js";
...
async function loadSystemRunConfig(opts) {
	...
	const { loadConfig } = await import("./config-DV9rjqBe.js");
	return loadConfig();
}
...
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-D1lv_v4u.js");
