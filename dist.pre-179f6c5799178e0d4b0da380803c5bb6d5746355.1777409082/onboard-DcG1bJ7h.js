...
import { d as resolveSecretInputRef, s as isValidEnvSecretRefId } from "./types.secrets-v6szeegc.js";
import { l as resolveDefaultSecretProviderAlias } from "./ref-contract-cHj1Typp.js";
import { t as resolveGatewayAuthToken } from "./auth-token-resolution-Bpj3Z5ji.js";
import { u as readConfigFileSnapshot } from "./io-CgtDzW1a.js";
...
import { c as normalizeGatewayTokenInput, m as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-D7_KWpUY.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-BIdFByOb.js";
import { t as runSetupWizard } from "./setup-DY3ibHPK.js";
import { i as applySkipBootstrapConfig, r as applyLocalSetupWorkspaceConfig } from "./onboard-config-D13bZEOs.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-BatWFFTW.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	const inferredAuthChoice = opts.authChoice ? void 0 : (await import("./auth-choice-inference-BDefF4w8.js")).inferAuthChoiceFromFlags(opts, {
		config: nextConfig,
		workspaceDir,
		env: process.env
	});
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-Dac_9Kce.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-DmQ-bDXl.js");
