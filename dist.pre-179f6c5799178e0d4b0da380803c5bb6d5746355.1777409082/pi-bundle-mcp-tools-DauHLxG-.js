...
import { i as setPluginToolMeta } from "./tools-CqiGxZl1.js";
import { c as normalizeReservedToolNames, s as buildSafeToolName } from "./pi-bundle-mcp-runtime-OI_sa8Ev.js";
...
async function createBundleMcpToolRuntime(params) {
	const runtime = (params.createRuntime ?? (await import("./pi-bundle-mcp-runtime-hy76odnn.js")).createSessionMcpRuntime)({
