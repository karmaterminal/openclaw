...
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-nbKqXCXC.js";
import { n as resolveGatewayAuth } from "./auth-resolve-DdWtrW_q.js";
import { n as asNullableRecord } from "./record-coerce-DZKKYOg9.js";
import { t as DEFAULT_AGENT_ID } from "./session-key-05a3Ypk7.js";
import { i as normalizeTrustedSafeBinDirs, o as listRiskyConfiguredSafeBins } from "./exec-safe-bin-trust-BNvYcSQV.js";
...
import { u as isInterpreterLikeAllowlistPattern } from "./exec-approvals-allowlist-CrDnjlEW.js";
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-CS2T7EYE.js";
import { l as loadExecApprovals } from "./exec-approvals-B2scP4BT.js";
import { n as collectCoreInsecureOrDangerousFlags, t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-AM4IvvUm.js";
...
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-Bx-z3y4b.js");
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-FzdEyAm0.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-BXvVG60D.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-DOIsL24S.js");
