...
import { n as isVitestRuntimeEnv, r as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-Ddh8dE-m.js";
...
import { o as getTailnetHostname } from "./tailscale-BRQzDtRJ.js";
...
import { a as hasForwardedRequestHeaders, i as authorizeWsControlUiGatewayConnect, o as isLocalDirectRequest, r as authorizeHttpGatewayConnect, s as checkBrowserOrigin, t as assertGatewayAuthConfigured } from "./auth-Ct3hC6yL.js";
import { n as resolveGatewayAuth } from "./auth-resolve-DdWtrW_q.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-CpZ02Rxn.js";
import { $ as resolveAgentMaxConcurrent, A as applyConfigOverrides, _ as registerConfigWriteListener, a as loadConfig, c as promoteConfigSnapshotToLastKnownGood, et as resolveSubagentMaxConcurrent, g as recoverConfigFromLastKnownGood, h as recoverConfigFromJsonRootSuffix, i as getRuntimeConfig, r as createConfigIO, u as readConfigFileSnapshot, y as writeConfigFile } from "./io-CgtDzW1a.js";
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-BkXrKuD5.js";
import { r as isCronRunSessionKey } from "./session-key-utils-BdCb1Ic0.js";
import { n as normalizeAccountId, r as normalizeOptionalAccountId } from "./account-id-DWChvwa8.js";
import { c as normalizeAgentId, h as toAgentStoreSessionKey, l as normalizeMainKey, m as toAgentRequestSessionKey, u as resolveAgentIdFromSessionKey } from "./session-key-05a3Ypk7.js";
import { n as getLoadedChannelPlugin, r as listChannelPlugins, t as getChannelPlugin } from "./registry-BL4cljde.js";
...
import { _ as resolveAgentConfig, b as resolveAgentWorkspaceDir, x as resolveDefaultAgentId, y as resolveAgentDir } from "./agent-scope-Cmx30dd2.js";
import { t as matchesSkillFilter } from "./filter-DjjMOxRY.js";
...
import { n as isRestartEnabled } from "./commands.flags-McyAH4_K.js";
import "./config-C9V3s22v.js";
import { G as validateExecApprovalResolveParams, U as validateExecApprovalGetParams, W as validateExecApprovalRequestParams, _t as validateRequestFrame, an as errorShape, cn as getPreauthHandshakeTimeoutMsFromEnv, in as ErrorCodes, k as validateConnectParams, ln as buildDeviceAuthPayload, mt as validatePluginApprovalResolveParams, pt as validatePluginApprovalRequestParams, r as formatValidationErrors, un as buildDeviceAuthPayloadV3, vt as validateSecretsResolveParams, yt as validateSecretsResolveResult } from "./client-CZESa3X-.js";
import { o as verifyDeviceSignature, r as normalizeDevicePublicKeyBase64Url, t as deriveDeviceIdFromPublicKey } from "./device-identity-lUfKMDc7.js";
import { t as rawDataToString } from "./ws-CAaQsOjx.js";
import { a as isOperatorUiClient, h as GATEWAY_CLIENT_MODES, m as GATEWAY_CLIENT_IDS, n as isGatewayCliClient, o as isWebchatClient, s as isDeliverableMessageChannel, t as isBrowserOperatorUiClient, u as normalizeMessageChannel } from "./message-channel-BSGc07rB.js";
import { t as normalizeDeviceMetadataForAuth } from "./device-metadata-normalization-xp1XA7Pa.js";
import { i as buildPairingConnectErrorMessage, m as resolveDeviceAuthConnectErrorDetailCode, n as buildPairingConnectCloseReason, p as resolveAuthConnectErrorDetailCode, r as buildPairingConnectErrorDetails, t as ConnectErrorDetailCodes } from "./connect-error-details-BaTnV6pA.js";
import { a as approvalDecisionLabel, n as MAX_PLUGIN_APPROVAL_TIMEOUT_MS, o as buildPluginApprovalExpiredMessage, s as buildPluginApprovalRequestMessage, t as DEFAULT_PLUGIN_APPROVAL_TIMEOUT_MS } from "./plugin-approvals-CkzhvWHV.js";
import { c as PAIRING_SCOPE, d as WRITE_SCOPE, l as READ_SCOPE, o as ADMIN_SCOPE, s as APPROVALS_SCOPE$1, t as CLI_DEFAULT_OPERATOR_SCOPES } from "./method-scopes-B0lRfzEA.js";
import { n as formatConfigIssueLines } from "./issue-format-BMX-Jwhc.js";
import { r as normalizeControlUiBasePath } from "./control-ui-shared-Dl39vIUL.js";
import { t as hasAnyAuthProfileStoreSource } from "./source-check-BF2yQkmu.js";
...
import { n as resolveChannelApprovalCapability, t as resolveChannelApprovalAdapter } from "./plugins-BXj_dAAn.js";
import { o as runGlobalGatewayStopSafely } from "./hook-runner-global-Yxkhw9TF.js";
import { S as createEmptyPluginRegistry, a as getActivePluginRegistry, b as resolveActivePluginHttpRouteRegistry, d as pinActivePluginChannelRegistry, f as pinActivePluginHttpRouteRegistry, h as releasePinnedPluginHttpRouteRegistry, m as releasePinnedPluginChannelRegistry, x as setActivePluginRegistry } from "./runtime-AU4GSMts.js";
import { i as canonicalizePathVariant, n as PROTECTED_PLUGIN_ROUTE_PREFIXES, r as canonicalizePathForSecurity } from "./http-route-overlap-DkZVmG35.js";
import { n as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-BvqUCFCl.js";
import "./logging-GUqn4RIk.js";
import { f as normalizeThinkLevel, h as normalizeVerboseLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel } from "./thinking-CGwszwLq.js";
import { c as normalizeModelSelection, f as resolveConfiguredModelRef, m as resolveHooksGmailModel } from "./model-selection-shared-BsuJEYVd.js";
import { i as resolveAllowedModelRef, r as getModelRefStatus, t as isCliProvider } from "./model-selection-cli-DxhsOm_Y.js";
import { p as resolveThinkingDefault } from "./model-selection-CZMUiuFR.js";
import { o as resetModelCatalogCache, r as loadModelCatalog } from "./model-catalog-BQjlGG04.js";
import { o as updateSessionStore, s as updateSessionStoreEntry, t as archiveRemovedSessionTranscripts } from "./store-YSRCrOf6.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, t as canonicalizeMainSessionAlias } from "./main-session-DlEMU4Ot.js";
import { n as resolveMainSessionKeyFromConfig } from "./sessions-CD6GeuLj.js";
import { o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-C9Qq8LIv.js";
import { u as setSessionRuntimeModel } from "./types-BuGAfG5X.js";
...
import { o as startGatewayModelPricingRefresh } from "./usage-format-Bb9o50Xl.js";
import { n as deriveSessionTotalTokens, r as hasNonzeroUsage } from "./usage-CSBA3_Jc.js";
import { i as readSessionMessages, t as attachOpenClawTranscriptMeta } from "./session-utils.fs-CblkYA9E.js";
import { i as stripInlineDirectiveTagsForDisplay } from "./directive-tags-BRJuzSv2.js";
import { a as resolveSessionTranscriptCandidates, i as cleanupArchivedSessionTranscripts } from "./session-transcript-files.fs-BVYCHx7P.js";
import { a as loadGatewaySessionRow, f as resolveGatewaySessionStoreTarget, i as loadCombinedSessionStoreForGateway, o as loadSessionEntry } from "./session-utils-CnlJcBzh.js";
import { i as enqueueCommandInLane, s as getTotalQueueSize, u as setCommandLaneConcurrency } from "./command-queue-BYs_ZoM6.js";
import { c as stripLeadingSilentToken, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken } from "./tokens-Bnib3S4J.js";
import { s as stripHeartbeatToken } from "./heartbeat-B2eoifs0.js";
import { i as normalizeCronJobInput } from "./openclaw-tools-DclzkKxa.js";
import { t as getMachineDisplayName } from "./machine-name-CyO7R_7Q.js";
import { t as detectMime } from "./mime-DFfgvUW_.js";
import { o as resolveFailoverReasonFromError } from "./failover-error-VOS38tD8.js";
import { t as SsrFBlockedError } from "./ssrf-vXCRW9rS.js";
import { n as fetchWithSsrFGuard } from "./fetch-guard-LAmyTYUM.js";
import { a as retireSessionMcpRuntime } from "./pi-bundle-mcp-runtime-OI_sa8Ev.js";
import "./pi-bundle-mcp-tools-DauHLxG-.js";
import { c as getAgentRunContext, d as sweepStaleRunContexts, l as onAgentEvent, t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-BU2pAhDZ.js";
import { t as loadGatewayTlsRuntime$1 } from "./gateway-CEPOBLba.js";
import { T as resolveExecApprovalRequestAllowedDecisions, r as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS, w as resolveExecApprovalAllowedDecisions } from "./exec-approvals-B2scP4BT.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-LLD3_uFb.js";
import { n as assertSafeCronSessionTargetId, r as isInvalidCronSessionTargetIdError, t as normalizeHttpWebhookUrl } from "./webhook-url-BuvY94bs.js";
import { c as setPreRestartDeferralCheck, n as deferGatewayRestartUntilIdle, r as emitGatewayRestart, s as setGatewaySigusr1RestartPolicy } from "./restart-CWPEfC-L.js";
import { r as cleanOldMedia } from "./store-a6nK9wuy.js";
import { a as CANVAS_HOST_PATH, c as injectCanvasLiveReload, l as normalizeUrlPath, s as handleA2uiHttpRequest, u as resolveFileWithinRoot } from "./web-media-Cfnn4itl.js";
import { i as isKnownSecretTargetId } from "./target-registry-CL9S4cja.js";
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-secret-gateway-D_WFogjX.js";
import { i as evaluateGatewayAuthSurfaceStates, r as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-web-tools-BjRIgJ5e.js";
import { n as resolveConfiguredDeferredChannelPluginIds, r as resolveGatewayStartupPluginIds } from "./channel-plugin-ids-CR84c_yu.js";
import { t as deliverOutboundPayloads } from "./deliver-BM2htO6C.js";
import { r as resetDirectoryCache } from "./target-resolver-D7l9LTDt.js";
import { t as buildOutboundSessionContext } from "./session-context-CbzVoOos.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-CdDG09w4.js";
...
import { i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-BfgHfuvs.js";
import { r as getActiveEmbeddedRunCount } from "./runs-CGD-1aD2.js";
import { h as stopDiagnosticHeartbeat, m as startDiagnosticHeartbeat } from "./diagnostic-CCOkZzFJ.js";
import { s as initSubagentRegistry } from "./subagent-registry-BWLy5Q9D.js";
import { a as onSessionLifecycleEvent } from "./subagent-registry-spawn-runtime-Cdq7aoOb.js";
import { t as resolveAgentTimeoutMs } from "./timeout-DPG38lna.js";
import { c as resolveHookExternalContentSource, o as isExternalHookSession, s as mapHookExternalContentSource } from "./external-content-CQ8q3hLJ.js";
import { n as resolveCronStyleNow } from "./current-time-CUwTVeQJ.js";
import { o as resolvePreferredSessionKeyForSessionIdMatches } from "./live-model-switch-C0Na5H8M.js";
import { t as createPluginRuntime } from "./runtime-DbYlnRFp.js";
import { o as getTotalPendingReplies } from "./dispatch-D4Aw9CB0.js";
import { n as sanitizeInboundSystemTags } from "./inbound-text-DNj7_tPx.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-C_iJ7t9x.js";
import { c as formatExecApprovalExpiresIn, f as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-reply-BRsfYrP2.js";
import { t as CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "./approval-handler-adapter-runtime-Dc2CdM3J.js";
import { n as sanitizeExecApprovalDisplayText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-CV8Kcz1M.js";
import { n as createChannelApprovalHandlerFromCapability } from "./approval-handler-runtime-CgyPrnRQ.js";
...
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-BgdFObjI.js";
import { n as resolveCronStorePath, r as saveCronStore, t as loadCronStore } from "./store-DObD_x30.js";
import { r as registerSkillsChangeListener } from "./refresh-state-D876d_Ml.js";
import "./refresh-BQSnJyS7.js";
import { c as roleScopesAllow } from "./pairing-token-CvkH6oPL.js";
import { a as refreshRemoteBinsForConnectedNodes, c as setSkillsRemoteRegistry, h as updatePairedNodeMetadata, i as recordRemoteNodeInfo, m as requestNodePairing, n as primeRemoteSkillsCache, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo, u as getPairedNode } from "./skills-remote-Ckll4HnX.js";
import { i as onHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-CChHV8ut.js";
import { n as resolveAgentOutboundIdentity } from "./identity-B2uMl_3g.js";
import { i as resolveNodeCommandAllowlist, r as normalizeDeclaredNodeCommands } from "./node-command-policy-ClFut90s.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs, t as formatForLog } from "./ws-log-FglwQqN7.js";
import { i as safeParseJson } from "./nodes.helpers-DSa1QMVP.js";
import { i as assertGatewayAuthNotKnownWeak, n as mergeGatewayAuthConfig, r as mergeGatewayTailscaleConfig, t as ensureGatewayStartupAuth } from "./startup-auth-8Sa3TNif.js";
import { r as resolveBootstrapProfileScopesForRole } from "./device-bootstrap-profile-Do4zDf86.js";
import { _ as updatePairedDeviceMetadata, a as getPairedDevice, c as listApprovedPairedDeviceRoles, l as listDevicePairing, n as approveDevicePairing, p as requestDevicePairing, r as ensureDeviceToken, s as hasEffectivePairedDeviceRole, t as approveBootstrapDevicePairing, u as listEffectivePairedDeviceRoles, v as verifyDeviceToken } from "./device-pairing-DdqDCc5T.js";
import { a as redeemDeviceBootstrapTokenProfile, n as getBoundDeviceBootstrapProfile, o as revokeDeviceBootstrapToken, r as getDeviceBootstrapTokenProfile, s as verifyDeviceBootstrapToken } from "./device-bootstrap-DotkViP2.js";
import { t as createDefaultDeps } from "./deps-Dcq4XFFJ.js";
import { i as buildSystemRunApprovalEnvBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-DjneIUI3.js";
import { n as resolveSystemRunApprovalRequestContext } from "./system-run-approval-context-UB4ccguI.js";
import { t as closeMcpLoopbackServer } from "./mcp-http-DaqvZHFO.js";
import { A as getHookSessionKeyPrefixError, B as resolveHookIdempotencyKey, C as setDefaultSecurityHeaders, D as extractHookToken, F as normalizeHookHeaders, H as resolveHookTargetAgentId, I as normalizeWakePayload, K as logRejectedLargePayload, L as readJsonBody, M as isSessionKeyAllowedByPrefix, N as normalizeAgentPayload, O as getHookAgentPolicyError, P as normalizeHookDispatchSessionKey, R as resolveHookChannel, U as resolveHooksConfig, V as resolveHookSessionKey, W as applyHookMappings, _ as loadGatewayModelCatalog, d as resolveHttpBrowserOriginPolicy, g as __resetModelCatalogCacheForTest, h as resolveTrustedHttpOperatorScopes, j as isHookAgentAllowed, k as getHookChannelError, o as getBearerToken, r as authorizeGatewayHttpRequestOrReply, s as getHeader, y as sendGatewayAuthFailure, z as resolveHookDeliver } from "./http-utils-Ei5N23ER.js";
import { t as createOutboundSendDeps } from "./outbound-send-deps-BBxgDxsu.js";
import { C as TICK_INTERVAL_MS, S as MAX_PREAUTH_PAYLOAD_BYTES, _ as DEDUPE_MAX, b as MAX_BUFFERED_BYTES, f as isSuppressedControlReplyLeadFragment, m as abortChatRunById, p as isSuppressedControlReplyText, v as DEDUPE_TTL_MS, x as MAX_PAYLOAD_BYTES, y as HEALTH_REFRESH_INTERVAL_MS } from "./chat-j4TAC2IE.js";
import { t as cleanupBrowserSessionsForLifecycleEnd } from "./browser-lifecycle-cleanup-DwWEHxpt.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-QR08qPEj.js";
import { a as writeWideAreaGatewayZone, i as resolveWideAreaDiscoveryDomain } from "./widearea-dns-GuPix6Y7.js";
import { a as resolveControlUiRootOverrideSync, n as isPackageProvenControlUiRootSync, o as resolveControlUiRootSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DoeRc1Lh.js";
import { t as GatewayLockError } from "./gateway-lock-DVsHiqoH.js";
import { t as getHealthSnapshot } from "./health-7rBkg1zJ.js";
import { t as runSetupWizard } from "./setup-DY3ibHPK.js";
import { d as startTaskRegistryMaintenance, f as stopTaskRegistryMaintenance, g as markCronJobActive, h as clearCronJobActive, n as getInspectableTaskRegistrySummary } from "./task-registry.maintenance-DE8eNFJO.js";
import { i as migrateOrphanedSessionKeys } from "./state-migrations-DZ9csTZW.js";
import { _ as resolveDeliveryTarget, a as computeJobPreviousRunAtMs, c as findJobOrThrow, d as isJobEnabled, f as nextWakeAtMs, g as resolveJobPayloadTextForMain, h as recordScheduleComputeError, i as computeJobNextRunAtMs, l as hasScheduledNextRunAtMs, m as recomputeNextRunsForMaintenance, n as applyJobPatch, o as createJob, p as recomputeNextRuns, r as assertSupportedJobSpec, s as errorBackoffMs, t as DEFAULT_ERROR_BACKOFF_SCHEDULE_MS, u as isJobDue } from "./jobs-DD_QR7h5.js";
import { t as createCronExecutionId } from "./run-id-Cky3hhCL.js";
import { a as resolveHeartbeatAckMaxChars$1, i as resolveCronPayloadOutcome, t as isHeartbeatOnlyResponse } from "./helpers-3cA3w8Lu.js";
import { a as resolveCronChannelOutputPolicy, n as markCronSessionPreRun, r as persistCronSkillsSnapshotIfChanged, t as createPersistCronSessionEntry } from "./run-session-state-DKGxac9S.js";
import { t as runChannelPluginStartupMaintenance } from "./lifecycle-startup-DkrSJy1Y.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-DA53F75F.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-OVgpv8Ar.js";
import { C as resolveGatewayReloadSettings, D as roleCanSkipDeviceIdentity, E as parseGatewayRole, O as pruneStaleControlPlaneBuckets, S as diffConfigPaths, T as buildGatewayReloadPlan, _ as appendCronRunLog, a as coreGatewayHandlers, b as resolveCronDeliveryPlan, c as listSystemPresence, d as CANVAS_CAPABILITY_TTL_MS, f as buildCanvasScopedHostUrl, g as loadVoiceWakeConfig, h as formatError, i as setFallbackGatewayContextResolver, l as upsertPresence, m as normalizeCanvasScopedUrl, o as handleGatewayRequest, p as mintCanvasCapabilityToken, s as broadcastPresenceSnapshot, t as loadGatewayStartupPlugins, u as clearNodeWakeState, v as resolveCronRunLogPath, w as startGatewayConfigReloader, x as resolveFailureDestination, y as resolveCronRunLogPruneOptions } from "./server-plugin-bootstrap-DsSdJ2HJ.js";
import { i as resolveCronSession, n as runHeartbeatOnce, r as startHeartbeatRunner } from "./heartbeat-runner-01wPNJ71.js";
import { n as stopGmailWatcher, t as startGmailWatcherWithLogs } from "./gmail-watcher-lifecycle-DUNjWOYQ.js";
import "./paths-Cez9bzGd.js";
import { t as getUpdateAvailable } from "./update-startup-HMrTssrQ.js";
import { t as hasConfiguredInternalHooks } from "./configured-DF46kUVF.js";
...
function loadExecApprovalForwarderRuntime() {
	execApprovalForwarderRuntimePromise ??= import("./exec-approval-forwarder.runtime-BawtgVW3.js");
...
async function loadSkillsSnapshotRuntime() {
	skillsSnapshotRuntimePromise ??= import("./skills-snapshot.runtime-g4atH9xJ.js");
...
async function loadCliRunnerRuntime() {
	return await import("./cli-runner.runtime-BIo1tZoJ.js");
}
async function loadUsageFormatRuntime() {
	return await import("./usage-format-DMUhGPfm.js");
}
...
function recoverPendingOutboundDeliveries(params) {
	(async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-BBRJCcq2.js");
		const { deliverOutboundPayloads } = await import("./deliver-Ll6MoyJr.js");
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-DNYq1XFj.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-BP7tRzpl.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-D7e3KqWh.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-DuKpIpuP.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-D_4tP2BQ.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-DGfIVUpC.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-DAnrO5iu.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-C5Ua5Q4L.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-CLlwXpwh.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-B7wpjChz.js");
	return toolsInvokeHttpModulePromise;
}
function getVoiceClawRealtimeUpgradeModule() {
	voiceClawRealtimeUpgradeModulePromise ??= import("./upgrade-BkMOHHGe.js");
...
async function hasGatewayStartupInternalHookListeners() {
	const { hasInternalHookListeners } = await import("./internal-hooks-7lO9Fmkr.js");
	return hasInternalHookListeners("gateway", "startup");
}
async function prewarmConfiguredPrimaryModel(params) {
	const { resolveAgentModelPrimaryValue } = await import("./model-input-DlFkt9Xa.js");
	const explicitPrimary = resolveAgentModelPrimaryValue(params.cfg.agents?.defaults?.model)?.trim();
	if (!explicitPrimary) return;
	const { normalizeProviderId } = await import("./provider-id-CYMZh6Bf.js");
	...
	const [{ resolveOpenClawAgentDir }, { DEFAULT_MODEL, DEFAULT_PROVIDER }, { selectAgentHarness }, { isCliProvider, resolveConfiguredModelRef }, { ensureOpenClawModelsJson }, { resolveModel, resolveModelAsync }, { resolveEmbeddedAgentRuntime }] = await Promise.all([
		import("./agent-paths-JnnxhkWe.js"),
		import("./defaults-DgMuuJzc.js"),
		import("./selection-CMDtAu32.js"),
		import("./model-selection-DbX4v4Qn.js"),
		import("./models-config-DeV6Hl5T.js"),
		import("./model-CZQYlUCu.js"),
		import("./runtime-BzFhrCfz.js")
	]);
...
async function startGatewaySidecars(params) {
	await measureStartup(params.startupTrace, "sidecars.session-locks", async () => {
		try {
			const [{ resolveStateDir }, { resolveAgentSessionDirs }, { cleanStaleLockFiles }] = await Promise.all([
				...
				import("./session-dirs-DaX5tfsK.js"),
				import("./session-write-lock-BUA-pJRZ.js")
			]);
	...
	await measureStartup(params.startupTrace, "sidecars.gmail-watch", async () => {
		if (params.cfg.hooks?.enabled && params.cfg.hooks.gmail?.account) {
			const { startGmailWatcherWithLogs } = await import("./gmail-watcher-lifecycle-0-dCR4DB.js");
			await startGmailWatcherWithLogs({
				cfg: params.cfg,
				log: params.logHooks
			});
	...
	await measureStartup(params.startupTrace, "sidecars.gmail-model", async () => {
		if (params.cfg.hooks?.gmail?.model) {
			const [{ DEFAULT_MODEL, DEFAULT_PROVIDER }, { loadModelCatalog }, { getModelRefStatus, resolveConfiguredModelRef, resolveHooksGmailModel }] = await Promise.all([
				import("./defaults-DgMuuJzc.js"),
				import("./model-catalog-C_S0w6ak.js"),
				import("./model-selection-DbX4v4Qn.js")
			]);
	...
	await measureStartup(params.startupTrace, "sidecars.internal-hooks", async () => {
		try {
			if (internalHooksConfigured) {
				const [{ setInternalHooksEnabled }, { loadInternalHooks }] = await Promise.all([import("./internal-hooks-7lO9Fmkr.js"), import("./loader-Crc2Q-mp.js")]);
	...
	if (internalHooksConfigured || await hasGatewayStartupInternalHookListeners()) setTimeout(() => {
		import("./internal-hooks-7lO9Fmkr.js").then(({ createInternalHookEvent, triggerInternalHook }) => {
	...
	await measureStartup(params.startupTrace, "sidecars.plugin-services", async () => {
		try {
			const { startPluginServices } = await import("./services-DVPaaaaS.js");
	...
	if (params.cfg.acp?.enabled) {
		const [{ getAcpSessionManager }, { ACP_SESSION_IDENTITY_RENDERER_VERSION }] = await Promise.all([import("./manager-DC_-XZwM.js"), import("./session-identifiers-DoopXXL6.js")]);
	...
	await measureStartup(params.startupTrace, "sidecars.memory", async () => {
		...
		setImmediate(() => {
			import("./server-startup-memory-C-YWveMV.js").then(({ startGatewayMemoryBackend }) => startGatewayMemoryBackend({
				cfg: params.cfg,
				log: params.log
			})).catch((err) => {
	...
	await measureStartup(params.startupTrace, "sidecars.restart-sentinel", async () => {
		...
		const { hasRestartSentinel } = await import("./restart-sentinel-D8qpKsNw.js");
		if (!await hasRestartSentinel()) return;
		setTimeout(() => {
			import("./server-restart-sentinel-DlGZnQPZ.js").then(({ scheduleRestartSentinelWake }) => scheduleRestartSentinelWake({ deps: params.deps })).catch((err) => {
	...
	await measureStartup(params.startupTrace, "sidecars.subagent-recovery", async () => {
		const { scheduleSubagentOrphanRecovery } = await import("./subagent-registry-DtsXQcGW.js");
		scheduleSubagentOrphanRecovery();
	});
	return { pluginServices };
}
const defaultGatewayPostAttachRuntimeDeps = {
	getGlobalHookRunner: async () => (await import("./hook-runner-global-Gahvk1eU.js")).getGlobalHookRunner(),
	logGatewayStartup: async (params) => (await import("./server-startup-log-vtfWcoSb.js")).logGatewayStartup(params),
	scheduleGatewayUpdateCheck: async (...args) => (await import("./update-startup-CH7tQN5M.js")).scheduleGatewayUpdateCheck(...args),
	startGatewaySidecars,
	startGatewayTailscaleExposure: async (...args) => (await import("./server-tailscale-BIR4LG5K.js")).startGatewayTailscaleExposure(...args)
};
	...
	try {
		...
		if (!minimalTestGateway) {
			if (deferredConfiguredChannelPluginIds.length > 0) {
				const { reloadDeferredGatewayPlugins } = await import("./server-plugin-bootstrap-DGhIRbbJ.js");
