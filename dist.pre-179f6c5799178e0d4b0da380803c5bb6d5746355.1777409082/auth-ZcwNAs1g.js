...
import { s as loadAuthProfileStoreForRuntime } from "./store-DlTWjzi2.js";
import { n as resolvePluginProviders } from "./providers.runtime-DSc95Nja.js";
import "./model-selection-shared-BsuJEYVd.js";
import { n as listProfilesForProvider } from "./profile-list-CrmV9iII.js";
import { n as clearAuthProfileCooldown } from "./usage-CWBZsWsW.js";
import { i as upsertAuthProfile } from "./profiles-ByOh6QBz.js";
import { n as validateAnthropicSetupToken } from "./provider-auth-token-BdODftGa.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-EeCBEk18.js";
import { n as stylePromptMessage, t as stylePromptHint } from "./prompt-style-M7caE4BS.js";
import { t as createClackPrompter } from "./clack-prompter-B7LIQAIQ.js";
import { n as logConfigUpdated } from "./logging-ApQT1VhX.js";
import { a as loadValidConfigOrThrow, u as updateConfig } from "./shared-CdJRJi2c.js";
import { t as isRemoteEnvironment } from "./remote-env-CjpzXqoj.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-DaVm4dLH.js";
import { i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-otaHmiIv.js";
...
async function runProviderAuthMethod(params) {
	...
	await persistProviderAuthResult({
		result: await params.method.run({
			...
			openUrl: async (url) => {
				const { openUrl } = await import("./onboard-helpers-CbcJC1I6.js");
				await openUrl(url);
			},
