...
| Value                  | Behavior                                                                                                                                                                                                                                                            |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `"disabled"` (default) | Delegates can only return to the dispatching session or its lineage. Explicit cross-session targeting (`targetSessionKey` to a non-self session, `targetSessionKeys`, `fanoutMode: "all"`) is rejected. `fanoutMode: "tree"` and self-targeting are always allowed. |
