...
import { i as listRouteBindings } from "./bindings-FesoICSI.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-BSrCs1kN.js";
import { t as note } from "./note-D6Igj8ec.js";
import { a as stripUnknownConfigKeys, r as noteOpencodeProviderOverrides } from "./doctor-config-analysis-7iyggh7U.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-BdcyooeX.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-DESF9LuI.js";
import { t as asObjectRecord } from "./object-Bq6wrCZb.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-D3d-Ts6R.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-9QHobAbI.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-BdIEr9Rd.js");
		emitDoctorNotes({
			note,
