import { n as resolveManifestProviderAuthChoice } from "./provider-auth-choices-DhjoDlsg.js";
import { r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-D5sJJeWm.js";
...
async function resolvePreferredProviderForAuthChoice(params) {
	...
	const { resolveProviderPluginChoice, resolvePluginProviders } = await import("./provider-auth-choice.runtime-C3vSpxuK.js");
