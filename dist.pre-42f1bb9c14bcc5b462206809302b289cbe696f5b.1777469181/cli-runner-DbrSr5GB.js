...
import { p as isFailoverErrorMessage, t as classifyFailoverReason } from "./errors-Do7ZlTNo.js";
import { i as isFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-DLvpkqiP.js";
import { n as buildAgentHookConversationMessages, t as loadCliSessionHistoryMessages } from "./session-history-DKiFSxkq.js";
...
async function runCliAgent(params) {
	...
	const { prepareCliRunContext } = await import("./prepare.runtime-DsRU-JC0.js");
	return runPreparedCliAgent(await prepareCliRunContext(params));
}
async function runPreparedCliAgent(context) {
	const { executePreparedCliRun } = await import("./execute.runtime-B5IGYUxH.js");
