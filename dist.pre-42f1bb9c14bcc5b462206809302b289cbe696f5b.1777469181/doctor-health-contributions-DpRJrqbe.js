...
async function runAuthProfileHealth(ctx) {
	...
	const { buildGatewayConnectionDetails } = await import("./call-Dx52RI4r.js");
	const { note } = await import("./note-DlWfIMrg.js");
...
async function runGatewayAuthHealth(ctx) {
	...
	const { note } = await import("./note-DlWfIMrg.js");
	const { randomToken } = await import("./onboard-helpers-QxQI9x1l.js");
...
async function runWorkspaceStatusHealth(ctx) {
	const { noteWorkspaceStatus } = await import("./doctor-workspace-status-C1dc7z04.js");
...
async function runGatewayHealthChecks(ctx) {
	const { checkGatewayHealth, probeGatewayMemoryStatus } = await import("./doctor-gateway-health-CGReQu6g.js");
...
async function runDevicePairingHealth(ctx) {
	const { noteDevicePairingHealth } = await import("./doctor-device-pairing-9xoIjwNU.js");
...
async function runGatewayDaemonHealth(ctx) {
	const { maybeRepairGatewayDaemon } = await import("./doctor-gateway-daemon-flow-B4kXegye.js");
...
async function runWriteConfigHealth(ctx) {
	const { formatCliCommand } = await import("./command-format-B-CmRDIm.js");
	const { applyWizardMetadata } = await import("./onboard-helpers-QxQI9x1l.js");
