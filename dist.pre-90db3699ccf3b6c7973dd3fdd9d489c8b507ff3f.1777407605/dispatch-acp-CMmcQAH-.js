...
import { n as formatToolSummary, r as resolveToolDisplay } from "./tool-display-CJs_BEAF.js";
...
import { r as prefixSystemMessage } from "./system-message-jwyKNX0d.js";
import { t as resolveConfiguredTtsMode } from "./tts-config-CRp9VtCI.js";
import { o as createBlockReplyPipeline, r as resolveEffectiveBlockStreamingConfig, t as clampPositiveInteger } from "./block-streaming-Dhc3nH3u.js";
import { t as hasInboundMedia } from "./inbound-media-YXGxvVN3.js";
import { i as toAcpRuntimeError } from "./errors-B0nemt8d.js";
import { o as isSessionIdentityPending, u as resolveSessionIdentityFromMeta } from "./session-identity-Dk-7W2uK.js";
import { t as formatAcpRuntimeErrorText } from "./error-text-BlxcLxSh.js";
import { a as resolveAcpDispatchPolicyError, i as resolveAcpAgentPolicyError } from "./policy-guEljUEt.js";
import { a as resolveAcpThreadSessionDetailLines } from "./session-identifiers-_hnaDpPj.js";
import { t as resolveStatusTtsSnapshot } from "./status-config-BunVqqPf.js";
...
function loadDispatchAcpMediaRuntime() {
	dispatchAcpMediaRuntimePromise ??= import("./dispatch-acp-media.runtime-DoUsodX8.js");
...
function loadDispatchAcpTtsRuntime$1() {
	dispatchAcpTtsRuntimePromise$1 ??= import("./dispatch-acp-tts.runtime-967PxluV.js");
	return dispatchAcpTtsRuntimePromise$1;
}
function loadChannelPluginRuntime() {
	channelPluginRuntimePromise ??= import("./plugins-ByUzyfsv.js");
	return channelPluginRuntimePromise;
}
function loadMessageActionRuntime() {
	messageActionRuntimePromise ??= import("./message-action-runner-C1fJz2Hu.js");
...
function loadDispatchAcpManagerRuntime() {
	dispatchAcpManagerRuntimePromise ??= import("./dispatch-acp-manager.runtime-h2KW_LTt.js");
	return dispatchAcpManagerRuntimePromise;
}
function loadDispatchAcpSessionRuntime() {
	dispatchAcpSessionRuntimePromise ??= import("./dispatch-acp-session.runtime-BOYKryKz.js");
	return dispatchAcpSessionRuntimePromise;
}
function loadDispatchAcpTtsRuntime() {
	dispatchAcpTtsRuntimePromise ??= import("./dispatch-acp-tts.runtime-967PxluV.js");
...
async function tryDispatchAcpReply(params) {
	...
	try {
		...
		const attachments = hasInboundMedia(params.ctx) ? await resolveAcpAttachments({
			ctx: params.ctx,
			cfg: params.cfg
		}) : [];
