import { F as shouldMigrateStateFromPath } from "./logger-DTX5koY3.js";
...
async function ensureConfigReady(params) {
	...
	if (!didRunDoctorConfigFlow && shouldMigrateStateFromPath(commandPath)) {
		...
		const runDoctorConfigPreflight = async () => (await import("./doctor-config-preflight-CnHedKBY.js")).runDoctorConfigPreflight({
			migrateState: false,
	...
	const { formatConfigIssueLines } = await import("./issue-format-aVJR1HVD.js");
	...
	const [{ colorize, isRich, theme }, { shortenHomePath }, { formatCliCommand }] = await Promise.all([
		...
		import("./utils-_4d_XLRF.js"),
		import("./command-format-TDWvfZgS.js")
	]);
	const rich = isRich();
