import{h as e,l as t,o as n,p as r,r as i}from"./i18n-B3qLZCy2.js";import{u as a}from"./format-C6Fj4uuq.js";import{A as o,C as s,D as c,E as l,O as u,S as d,T as f,_ as p,a as m,b as h,d as g,f as _,g as v,h as y,k as b,n as x,p as S,r as C,t as w,v as T,w as E,x as ee,y as D}from"./index-y1R4cA0v.js";import{r as te}from"./channel-config-extras-DPCmlDq8.js";import{i as O,n as ne,r as re,t as k}from"./skills-shared-Iso6b0XO.js";function A(t){let{agent:n,configForm:a,agentFilesList:o,configLoading:c,configSaving:u,configDirty:m,onConfigReload:h,onConfigSave:g,onModelChange:_,onModelFallbacksChange:v,onSelectPanel:y}=t,b=s(a,n.id),x=n.model,S=(o&&o.agentId===n.id?o.workspace:null)||b.entry?.workspace||b.defaults?.workspace||n.workspace||`default`,C=b.entry?.model?f(b.entry?.model):b.defaults?.model?f(b.defaults?.model):f(x),w=f(b.defaults?.model??x),T=l(b.entry?.model),D=l(b.defaults?.model)||(w===`-`?null:ee(w))||(a?null:l(x)),te=T??D??null,O=E(b.entry?.model)??E(b.defaults?.model)??(a?null:E(x))??[],ne=Array.isArray(b.entry?.skills)?b.entry?.skills:null,re=ne?.length??null,k=!!(t.defaultId&&n.id===t.defaultId),A=!a||c||u,ie=e=>{let t=O.filter((t,n)=>n!==e);v(n.id,t)};return e`
    <section class="card">
        ...
        <div class="agent-model-fields">
          <label class="field">
            ...
            <select
              .value=${k?te??``:T??``}
              ?disabled=${A}
              @change=${e=>_(n.id,e.target.value||null)}
            >
          ...
          <div class="field">
            ...
            >
              ...
              <input
                ...
                @keydown=${e=>{let t=e.target;if(e.key===`Enter`||e.key===`,`){e.preventDefault();let r=d(t.value);r.length>0&&(v(n.id,[...O,...r]),t.value=``)}}}
                @blur=${e=>{let t=e.target,r=d(t.value);r.length>0&&(v(n.id,[...O,...r]),t.value=``)}}
              />
            </div>
          </div>
        </div>
...
Please report this to https://github.com/markedjs/marked.`,e){let e=`<p>An error occurred:</p><pre>`+G(n.message+``,!0)+`</pre>`;return t?Promise.resolve(e):e}if(t)return Promise.reject(n);throw n}}};function $(e,t){return Q.parse(e,t)}$.options=$.setOptions=function(e){return Q.setOptions(e),$.defaults=Q.defaults,De($.defaults),$},$.getDefaults=Ee,$.defaults=P,$.use=function(...e){return Q.use(...e),$.defaults=Q.defaults,De($.defaults),$},$.walkTokens=function(e,t){return Q.walkTokens(e,t)},$.parseInline=Q.parseInline,$.Parser=X,$.parser=X.parse,$.Renderer=Y,$.TextRenderer=It,$.Lexer=J,$.lexer=J.lex,$.Tokenizer=q,$.Hooks=Z,$.parse=$,$.options,$.setOptions,$.use,$.walkTokens,$.parseInline,X.parse,J.lex;function Lt(t,n,r){return e`
      ...
      <section class="card">
        <div class="row" style="justify-content: space-between;">
          ...
          <button class="btn btn--sm" ?disabled=${t.loading} @click=${t.onRefresh}>
            ${t.loading?i(`common.refreshing`):i(`common.refresh`)}
          </button>
        </div>
        ...
        ${t.snapshot?r:e`
            ...
            `}
        ${n.length===0?e` <div class="muted" style="margin-top: 16px">No channels found.</div> `:e`
              <div class="list" style="margin-top: 16px;">
                ${n.map(n=>{let i=Vt(n.accounts),a=i.total?`${i.connected}/${i.total} connected`:`no accounts`,o=i.configured?`${i.configured} configured`:`not configured`,s=i.total?`${i.enabled} enabled`:`disabled`,c=te({configForm:t.configForm,channelId:n.id,fields:Bt});return e`
                    <div class="list-item">
                      <div class="list-main">
  ...
  `}function Ut(t){let n=t.jobs.filter(e=>e.agentId===t.agentId);return e`
    <section class="grid grid-cols-2">
      ...
      <section class="card">
        ...
        <div class="stat-grid" style="margin-top: 16px;">
          <div class="stat">
            <div class="stat-label">${i(`common.enabled`)}</div>
            <div class="stat-value">
              ${t.status?t.status.enabled?i(`common.yes`):i(`common.no`):i(`common.na`)}
            </div>
          </div>
          <div class="stat">
            <div class="stat-label">Jobs</div>
            <div class="stat-value">${t.status?.jobs??i(`common.na`)}</div>
          </div>
          <div class="stat">
    ...
    <section class="card">
      ...
      ${n.length===0?e` <div class="muted" style="margin-top: 16px">No jobs assigned.</div> `:e`
            <div class="list" style="margin-top: 16px;">
              ${n.map(n=>e`
                  <div class="list-item">
                    <div class="list-main">
  ...
  `}function Wt(t){let n=t.agentFilesList?.agentId===t.agentId?t.agentFilesList:null,a=n?.files??[],o=t.agentFileActive??null,s=o?a.find(e=>e.name===o)??null:null,c=o?t.agentFileContents[o]??``:``,l=o?t.agentFileDrafts[o]??c:``,u=o?l!==c:!1;return e`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
        ...
        >
          ${t.agentFilesLoading?i(`common.loading`):i(`common.refresh`)}
        </button>
      </div>
      ${n?e`<div class="muted mono" style="margin-top: 8px;">
            Workspace: <span>${n.workspace}</span>
          </div>`:r}
      ${t.agentFilesError?e`<div class="callout danger" style="margin-top: 12px;">
            ${t.agentFilesError}
          </div>`:r}
      ${n?a.length===0?e` <div class="muted" style="margin-top: 16px">No files found.</div> `:e`
                    ...
                    >
                      <div class="md-preview-dialog__panel">
                        ...
                        <div class="md-preview-dialog__body">
                          ${_(we($.parse(l,{gfm:!0,breaks:!0}),{sanitize:e=>g.sanitize(e)}))}
                        </div>
                      </div>
                    </dialog>
  ...
  `}function Kt(e){return e.source===`plugin`?e.pluginId?i(`agentTools.connectedSource`,{id:e.pluginId}):i(`agentTools.connected`):e.source===`channel`?e.channelId?i(`agentTools.channelSource`,{id:e.channelId}):i(`agentTools.channel`):i(`agentTools.builtIn`)}function qt(t){let n=s(t.configForm,t.agentId),a=n.entry?.tools??{},l=n.globalTools??{},d=a.profile??l.profile??`full`,f=u(t.toolsCatalogResult),p=b(t.toolsCatalogResult),m=a.profile?`agent override`:l.profile?`global default`:`default`,h=Array.isArray(a.allow)&&a.allow.length>0,g=Array.isArray(l.allow)&&l.allow.length>0,_=!!t.configForm&&!t.configLoading&&!t.configSaving&&!h&&!(t.toolsCatalogLoading&&!t.toolsCatalogResult&&!t.toolsCatalogError),v=h?[]:Array.isArray(a.alsoAllow)?a.alsoAllow:[],y=h?[]:Array.isArray(a.deny)?a.deny:[],x=h?{allow:a.allow??[],deny:a.deny??[]}:c(d)??void 0,S=p.flatMap(e=>e.tools.map(e=>e.id)),C=e=>{let t=T(e,x),n=D(e,v),r=D(e,y);return{allowed:(t||n)&&!r,baseAllowed:t,denied:r}},w=S.filter(e=>C(e).allowed).length,E=(e,n)=>{let r=new Set(v.map(e=>o(e)).filter(e=>e.length>0)),i=new Set(y.map(e=>o(e)).filter(e=>e.length>0)),a=C(e).baseAllowed,s=o(e);n?(i.delete(s),a||r.add(s)):(r.delete(s),i.add(s)),t.onOverridesChange(t.agentId,[...r],[...i])},ee=e=>{let n=new Set(v.map(e=>o(e)).filter(e=>e.length>0)),r=new Set(y.map(e=>o(e)).filter(e=>e.length>0));for(let t of S){let i=C(t).baseAllowed,a=o(t);e?(r.delete(a),i||n.add(a)):(n.delete(a),r.add(a))}t.onOverridesChange(t.agentId,[...n],[...r])};return e`
    <section class="card">
      <div class="row" style="justify-content: space-between; flex-wrap: wrap;">
        ...
        <div class="row" style="gap: 8px; flex-wrap: wrap;">
          <button class="btn btn--sm" ?disabled=${!_} @click=${()=>ee(!0)}>
            Enable All
          </button>
          <button class="btn btn--sm" ?disabled=${!_} @click=${()=>ee(!1)}>
            Disable All
          </button>
          <button
            class="btn btn--sm"
  ...
  `}function Jt(n){let a=!!n.configForm&&!n.configLoading&&!n.configSaving,o=s(n.configForm,n.agentId),c=Array.isArray(o.entry?.skills)?o.entry?.skills:void 0,l=new Set((c??[]).map(e=>e.trim()).filter(Boolean)),u=c!==void 0,d=!!(n.report&&n.activeAgentId===n.agentId),f=d?n.report?.skills??[]:[],p=t(n.filter),m=p?f.filter(e=>t([e.name,e.description,e.source].join(` `)).includes(p)):f,h=O(m),g=u?f.filter(e=>l.has(e.name)).length:f.length,_=f.length;return e`
    <section class="card">
      <div class="row" style="justify-content: space-between; flex-wrap: wrap;">
        <div style="min-width: 0;">
      ...
      ${!d&&!n.loading?e`
          ...
          `:r}
      ${n.error?e`<div class="callout danger" style="margin-top: 12px;">${n.error}</div>`:r}
      ...
      ${m.length===0?e` <div class="muted" style="margin-top: 16px">No skills found.</div> `:e`
            <div class="agent-skills-groups" style="margin-top: 16px;">
              ${h.map(e=>Yt(e,{agentId:n.agentId,allowSet:l,usingAllowlist:u,editable:a,onToggle:n.onToggle}))}
            </div>
          `}
    </section>
  ...
  `}function Zt(t){let n=t.agentsList?.agents??[],a=t.agentsList?.defaultId??null,o=t.selectedAgentId??a??n[0]?.id??null,s=o?n.find(e=>e.id===o)??null:null,c=o&&t.agentSkills.agentId===o?t.agentSkills.report?.skills?.length??null:null,l=t.channels.snapshot?Object.keys(t.channels.snapshot.channelAccounts??{}).length:null,u=o?t.cron.jobs.filter(e=>e.agentId===o).length:null,d={files:t.agentFiles.list?.files?.length??null,skills:c,channels:l,cron:u||null};return e`
      ...
      <section class="agents-toolbar">
        <div class="agents-toolbar-row">
          <div class="agents-control-select">
            ...
            >
              ${n.length===0?e` <option value="">No agents</option> `:n.map(t=>e`
...
//# sourceMappingURL=agents-WLmwWBDx.js.map