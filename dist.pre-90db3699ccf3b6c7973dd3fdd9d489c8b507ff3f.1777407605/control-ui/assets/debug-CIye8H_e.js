import{h as e,p as t,r as n}from"./i18n-B3qLZCy2.js";import{i as r}from"./index-y1R4cA0v.js";function i(i){let a=(i.status&&typeof i.status==`object`?i.status.securityAudit:null)?.summary??null,o=a?.critical??0,s=a?.warn??0,c=a?.info??0,l=o>0?`danger`:s>0?`warn`:`success`,u=o>0?`${o} critical`:s>0?`${s} warnings`:`No critical issues`;return e`
    <section class="grid">
      <div class="card">
      ...
      <div class="card">
        ...
        <div class="stack" style="margin-top: 16px;">
          <label class="field">
            ...
            >
              ${i.callMethod?t:e` <option value="" disabled>Select a method…</option> `}
        ...
        ${i.callError?e`<div class="callout danger" style="margin-top: 12px;">${i.callError}</div>`:t}
        ${i.callResult?e`<pre class="code-block" style="margin-top: 12px;">${i.callResult}</pre>`:t}
      </div>
    </section>
...
//# sourceMappingURL=debug-CIye8H_e.js.map