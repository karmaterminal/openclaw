...
import { a as normalizeLowercaseStringOrEmpty, n as localeLowercasePreservingWhitespace } from "./string-coerce-CjxCKZ6B.js";
...
import { b as resolveAgentWorkspaceDir, v as resolveAgentContextLimits } from "./agent-scope-D-T17Rdc.js";
import { a as withFileLock } from "./file-lock-7-B8nAS7.js";
import { g as writeFileWithinRoot } from "./fs-safe-CH-zulhg.js";
import { n as resolveMemorySearchSyncConfig } from "./memory-search-DLD3zBhp.js";
import "./text-runtime-ITCc6m8o.js";
import "./error-runtime-CrlbYtTr.js";
import { m as statRegularFile, p as isFileMissingError } from "./internal-Cn9n4_mF.js";
import { o as buildMemoryReadResult, s as buildMemoryReadResultFromSlice } from "./backend-config-C2kYVp_f.js";
import "./memory-core-host-engine-foundation-BlfA1WFS.js";
import { a as deriveQmdScopeChatType, c as buildSessionEntry, i as deriveQmdScopeChannel, l as listSessionFilesForAgent, n as resolveCliSpawnInvocation, o as isQmdScopeAllowed, r as runCliCommand, s as parseQmdQueryJson } from "./engine-qmd-DaN67D_R.js";
import "./memory-core-host-engine-qmd-DQwwvNyf.js";
import { t as requireNodeSqlite } from "./engine-storage-DztWLQ_v.js";
...
function isDefaultMemoryPath(relPath) {
	...
	if (normalized === "MEMORY.md" || normalized === "memory.md" || normalized === "DREAMS.md" || normalized === "dreams.md") return true;
	...
	isEquivalentDefaultMemoryRootPattern(collectionPath, leftPattern, rightPattern) {
		...
		try {
			...
			for (const entry of fs.readdirSync(collectionPath, { withFileTypes: true })) {
				...
				if (entry.name === "MEMORY.md") sawCanonical = true;
				else if (entry.name === "memory.md") sawLegacyFallback = true;
			}
			if (sawCanonical && sawLegacyFallback) return false;
