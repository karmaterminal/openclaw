...
import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, f as readStringValue, l as normalizeOptionalStringifiedId, s as normalizeOptionalLowercaseString } from "./string-coerce-CjxCKZ6B.js";
import { i as resolveOsHomeDir, t as expandHomePrefix } from "./home-dir-C44RaPME.js";
import { b as truncateUtf16Safe, l as isRecord, m as resolveUserPath } from "./utils-CB8xp0O4.js";
import { t as createSubsystemLogger } from "./subsystem-CJBoMDt5.js";
import { a as shouldLogVerbose, r as logVerbose } from "./globals-Bo8QPRgM.js";
import { t as logDebug } from "./logger-Dm9TyjBd.js";
import { n as resolveManifestContractOwnerPluginId } from "./manifest-registry-_hxKCS2K.js";
import { a as loadConfig, o as parseConfigJson5, v as resolveConfigSnapshotHash } from "./io-CBRjt33P.js";
import { r as normalizeProviderId } from "./provider-id-ZTkpwCTd.js";
import { C as parseThreadSessionSuffix, c as normalizeAgentId, f as sanitizeAgentId, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey, x as parseAgentSessionKey } from "./session-key-Cn2QoOyX.js";
import { n as normalizeAccountId } from "./account-id-BM1T6029.js";
import { o as normalizeChannelId } from "./registry-CGsqKAN1.js";
import { i as normalizeChannelId$1, r as listChannelPlugins, t as getChannelPlugin } from "./registry-CaUS2Z2d.js";
...
import { _ as resolveAgentConfig, b as resolveAgentWorkspaceDir, m as resolveSessionAgentIds, p as resolveSessionAgentId, r as resolveAgentExecutionContract } from "./agent-scope-D-T17Rdc.js";
import { t as parseDurationMs } from "./parse-duration-CKmCMtsX.js";
import { t as isInboundPathAllowed } from "./inbound-path-policy-pj2rw1HH.js";
import { r as isRestartEnabled } from "./commands.flags-D8n75DQv.js";
import "./config-BjiV0z87.js";
import { h as GATEWAY_CLIENT_MODES, m as GATEWAY_CLIENT_IDS, u as normalizeMessageChannel } from "./message-channel-Bk_YHfQg.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-DTA--Gjh.js";
import { d as readConnectPairingRequiredMessage } from "./connect-error-details-CNaj8mih.js";
import "./plugins-BcqWcAy9.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-C-l-2kdJ.js";
import { n as ensureOpenClawModelsJson } from "./models-config-DXUZyX32.js";
import { S as normalizeModelRef, _ as resolveModelRefFromString, c as buildModelAliasIndex, s as buildConfiguredModelCatalog, x as modelKey } from "./model-selection-cli-BCNxTSmc.js";
import { o as resolveDefaultModelForAgent, p as resolveThinkingDefault, t as buildAllowedModelSet } from "./model-selection-B7RNWcLj.js";
...
import { a as discoverModels, i as discoverAuthStorage } from "./pi-model-discovery-CC03N-69.js";
import { o as updateSessionStore } from "./store-COeaE7A7.js";
import { t as extractDeliveryInfo } from "./sessions-THKm0e_w.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-D6msg0S1.js";
...
import { n as resolveSessionConversationRef } from "./session-conversation-BAzvkg4H.js";
import { n as capArrayByJsonBytes, o as readSessionTitleFieldsFromTranscript, p as jsonUtf8Bytes } from "./session-utils.fs-DgRtLXgk.js";
import { p as resolveSessionModelIdentityRef, t as deriveSessionTitle } from "./session-utils-TWBJFzaE.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-CYuOTnyM.js";
import { i as imageMimeFromFormat, t as detectMime } from "./mime-Dx8S3QoZ.js";
import { A as describeSessionsListTool, C as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, D as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY, E as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, M as describeSessionsSpawnTool, N as describeUpdatePlanTool, O as describeSessionStatusTool, S as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, T as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, j as describeSessionsSendTool, k as describeSessionsHistoryTool, w as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, y as CRON_TOOL_DISPLAY_SUMMARY } from "./tool-policy-4C90huEY.js";
import { r as resolvePluginTools } from "./tools-CjyAaC4m.js";
import { w as textToSpeech } from "./tts-CWnNX49f.js";
import { _ as extractTextFromChatContent } from "./sanitize-user-facing-text-Bzewcv8R.js";
import { a as getImageMetadata } from "./image-ops-CI-IGr62.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-6H3qxotJ.js";
import { a as resolveChannelMessageToolSchemaProperties, n as channelSupportsMessageCapabilityForChannel, t as channelSupportsMessageCapability } from "./message-action-discovery-6sG1xPgv.js";
import { a as listChannelSupportedActions, r as listAllChannelSupportedActions } from "./channel-tools-VnD0W0uJ.js";
import { r as getApiKeyForModel } from "./model-auth-CnLreLvU.js";
import { t as SsrFBlockedError } from "./ssrf-CTA9WgMa.js";
import { l as parseReplyDirectives } from "./payloads-nIfLjbWq.js";
import { n as runWithImageModelFallback } from "./model-fallback-CE1uOaB3.js";
import { c as stripReasoningTagsFromText } from "./assistant-visible-text-BAXvhm6N.js";
import { t as extractAssistantText } from "./pi-embedded-utils-Du-NhvYE.js";
import { r as callGateway } from "./call-DsaRhCZc.js";
import { b as readSnakeCaseParamRaw, f as readNumberParam, g as readStringParam$1, i as asToolParamsRecord, l as jsonResult, m as readStringArrayParam, r as ToolInputError, s as imageResult } from "./common-BGcbYPyw.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-0G0WDa7x.js";
import { g as writeFileWithinRoot, r as appendFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-CH-zulhg.js";
import { t as isWindowsDrivePath } from "./archive-path-DQosmKv_.js";
import { o as trySafeFileURLToPath, r as hasEncodedFileUrlSeparator } from "./local-file-access-BpdUv1jJ.js";
import { n as assertSandboxPath } from "./sandbox-paths-OtvpaIO7.js";
import { c as resolveWorkspaceRoot, d as toRelativeWorkspacePath, s as normalizeWorkspaceDir } from "./read-capability-CpiE5rmu.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata } from "./runtime-V2Yz6WBE.js";
import "./delivery-context-BuYaqSek.js";
import { t as sniffMimeFromBase64 } from "./sniff-mime-from-base64-Dp_aC_2G.js";
import { a as createSessionVisibilityGuard, c as resolveDisplaySessionKey, d as resolveSessionReference, f as resolveVisibleSessionReference, i as createAgentToAgentPolicy, l as resolveInternalSessionKey, n as deriveChannel, o as resolveEffectiveSessionToolsVisibility, p as shouldResolveSessionIdInput, r as resolveSessionToolContext, s as resolveSandboxedSessionToolContext, t as classifySessionKind, u as resolveMainSessionAlias } from "./sessions-helpers-u5aeF7Kw.js";
import { r as stripToolMessages } from "./chat-history-text-BoSkczk7.js";
import { a as parseCanvasSnapshotPayload, c as parseCameraSnapPayload, d as writeCameraPayloadToFile, i as canvasSnapshotTempPath, l as writeBase64ToFile, n as screenRecordTempPath, o as cameraTempPath, r as writeScreenRecordToFile, s as parseCameraClipPayload, t as parseScreenRecordPayload, u as writeCameraClipPayloadToFile } from "./nodes-screen-DN4GglBC.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-DDn7G0b_.js";
...
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-DOqkhF7o.js";
import { d as stagePostCompactionDelegate, f as stagedPostCompactionDelegateCount, l as pendingDelegateCount, s as enqueuePendingDelegate } from "./continuation-delegate-store-BpJu5jp4.js";
import { n as resolveMaxDelegatesPerTurn } from "./continuation-runtime-CQecsvYD.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-DApGZcew.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-BQF4zDGf.js";
import { t as inferLegacyName } from "./normalize-BzwbYio4.js";
import { n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-CLUaf-m2.js";
import { c as removeRestartSentinelFile, f as writeRestartSentinel, i as formatDoctorNonInteractiveHint, n as buildRestartSuccessContinuation } from "./restart-sentinel-ZznJ7MqL.js";
import { o as scheduleGatewaySigusr1Restart } from "./restart-BcbTn2CL.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-DlgNAQ82.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-CKY2FCLl.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-BjaKggaK.js";
import { n as resolveConfiguredMediaMaxBytes } from "./configured-max-bytes-36-ygflT.js";
import { l as saveMediaBuffer } from "./store-BuB7MfIQ.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-DDaJekDB.js";
import { r as getDefaultLocalRoots } from "./local-media-access-1NrFiEok.js";
import { a as coerceImageModelConfig, c as resolveProviderVisionModelFromConfig, d as hasAuthForProvider, f as hasToolModelConfig, l as buildToolModelConfigFromCandidates, n as isMinimaxVlmProvider, o as decodeDataUrl, p as resolveDefaultModelRef, u as coerceToolModelConfig } from "./minimax-vlm-ftT8h8mi.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-mM-3-hsz.js";
import { b as resolveAutoMediaKeyProviders, w as getMediaUnderstandingProvider, x as resolveDefaultMediaModel, y as providerSupportsNativePdfDocument } from "./resolve-DWXt9dt9.js";
import { n as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-D9eG0ZjO.js";
import { t as buildProviderRegistry } from "./runner-DrtbIZ8q.js";
import "./media-understanding-DG6DM3vk.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-6yx5UexZ.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-D5MGM6PE.js";
import { o as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-DM2pXoIP.js";
import { a as POLL_CREATION_PARAM_DEFS, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-BGDFqiwJ.js";
import { t as sendMessage } from "./message-CNRvnqaX.js";
import { i as resolveMusicGenerationModeCapabilities, n as listRuntimeMusicGenerationProviders, r as listSupportedMusicGenerationModes, t as generateMusic } from "./runtime-pvvouxvo.js";
import { r as parseMusicGenerationModelRef } from "./provider-registry-aJ682LN5.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-Ous3qGdi.js";
import { f as listTasksForOwnerKey } from "./task-registry-k5FxC8l3.js";
import "./runtime-internal-DHgvz6ak.js";
import { a as recordTaskRunProgressByRunId, i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-Cwd30X8h.js";
import "./task-registry-delivery-runtime-Dv7DFpgC.js";
import { t as formatAgentInternalEventsForPrompt } from "./internal-events-D-mlvYG5.js";
import { r as loadSessionEntryByKey, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-Dvw_ZC2K.js";
import { d as runAgentStep, f as ANNOUNCE_SKIP_TOKEN, h as isReplySkip, m as isAnnounceSkip, p as REPLY_SKIP_TOKEN } from "./subagent-announce-output-CqU05Wpx.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-B176W6uL.js";
import { t as parseTimeoutMs } from "./parse-timeout-0v0tZDOC.js";
import { t as extractPdfContent } from "./pdf-extract-JwGyZJX_.js";
import { t as createRequestCompactionTool } from "./request-compaction-tool-DnHSm9sF.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-e8ISaSUe.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-CjeErtyj.js";
import { n as isRequesterParentOfBackgroundAcpSession } from "./session-interaction-mode-DiYsWzTX.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-VuzaNVL8.js";
import { i as waitForAgentRunAndReadUpdatedAssistantReply, n as readLatestAssistantReplySnapshot, r as waitForAgentRun, t as readLatestAssistantReply } from "./run-wait-BsHZBqIP.js";
import { f as registerSubagentRun } from "./subagent-registry-QM0aZmYG.js";
import { n as spawnSubagentDirect, r as SUBAGENT_SPAWN_MODES } from "./subagent-spawn-COUAK1hZ.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-DImdArO9.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-DHfYYkBw.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, n as listRuntimeVideoGenerationProviders, r as listSupportedVideoGenerationModes, t as generateVideo } from "./runtime-0WvflIKS.js";
import { r as parseVideoGenerationModelRef } from "./provider-registry-CNrHOdfC.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-CCshYPPL.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-CfPg9Ri8.js";
import { a as readResponseText, d as extractReadableContent, f as htmlToMarkdown, i as readCache, l as writeCache, m as truncateText$1, o as resolveCacheTtlMs, p as markdownToText, r as normalizeCacheKey, s as resolveTimeoutSeconds, u as extractBasicHtmlContent } from "./web-shared-DQMl4WcH.js";
import { a as runWebSearch, i as resolveWebSearchDefinition } from "./runtime-Czyfa1jp.js";
import "./web-search-provider-common-E2XHPgc0.js";
...
function createContinueDelegateTool(opts) {
	return {
		...
		execute: async (_toolCallId, args) => {
			...
			const currentCount = pendingDelegateCount(sessionKey) + stagedPostCompactionDelegateCount(sessionKey);
			if (currentCount >= maxPerTurn) return jsonResult({
				status: "error",
			...
			log$6.debug(`[continue_delegate:enqueue] session=${sessionKey} silent=${silent} silentWake=${silentWake} delayMs=${delayMs} task=${task.slice(0, 80)}`);
...
async function getRuntime() {
	if (!runtimeMod) runtimeMod = await import([".", "embedded-gateway-stub.runtime.js"].join("/"));
	return runtimeMod;
}
...
function isProtectedPathEqual(currentConfig, nextConfig, path) {
	const bracketIdx = path.indexOf("[]");
	if (bracketIdx === -1) return isDeepStrictEqual(getValueAtPath(currentConfig, path), getValueAtPath(nextConfig, path));
	const arrayPath = path.slice(0, bracketIdx);
	const subPath = path.slice(bracketIdx + 2).replace(/^\./, "");
	...
	if (!Array.isArray(currentList) && !Array.isArray(nextList)) return true;
	const readProjectedEntries = (list) => {
		if (!Array.isArray(list)) return {
			duplicateIds: false,
			hasUnkeyedProtectedValue: false,
			keyedValues: /* @__PURE__ */ new Map()
		};
		let duplicateIds = false;
		let hasUnkeyedProtectedValue = false;
		const keyedValues = /* @__PURE__ */ new Map();
		for (const entry of list) {
			const id = entry && typeof entry === "object" && !Array.isArray(entry) && typeof entry.id === "string" && entry.id.length > 0 ? entry.id : void 0;
			const value = !subPath || !entry || typeof entry !== "object" || Array.isArray(entry) ? entry : getValueAtCanonicalPath(entry, subPath);
			if (!id) {
				hasUnkeyedProtectedValue ||= value !== void 0;
				continue;
			}
		...
		return {
			duplicateIds,
			hasUnkeyedProtectedValue,
			keyedValues
		};
	};
	const currentProjected = readProjectedEntries(currentList);
	const nextProjected = readProjectedEntries(nextList);
	if (nextProjected.duplicateIds || nextProjected.hasUnkeyedProtectedValue) return false;
	for (const [id, currentValue] of currentProjected.keyedValues) {
		...
		if (!isDeepStrictEqual(currentValue, nextProjected.keyedValues.get(id))) return false;
	}
	for (const [id, nextValue] of nextProjected.keyedValues) if (!currentProjected.keyedValues.has(id) && nextValue !== void 0) return false;
	return true;
}
function assertGatewayConfigMutationAllowed(params) {
	...
	const changedProtectedPaths = PROTECTED_GATEWAY_CONFIG_PATHS.filter((path) => !isProtectedPathEqual(params.currentConfig, nextConfig, path));
...
function loadCommandsStatusRuntime() {
	commandsStatusRuntimePromise ??= import("./session-status.runtime-BBYX3YPM.js");
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-B76vl_hd.js");
...
async function loadAcpSpawnModule() {
	acpSpawnModulePromise ??= import("./acp-spawn-CpreWrps.js");
...
async function loadWebFetchRuntime() {
	webFetchRuntimePromise ??= import("./runtime-DxfjtkA3.js");
	return await webFetchRuntimePromise;
}
async function loadWebGuardedFetch() {
	webGuardedFetchPromise ??= import("./web-guarded-fetch-PY2HwcNY.js");
...
function createOpenClawTools(options) {
	...
	const tools = [
		...
		...options?.config?.agents?.defaults?.continuation?.enabled === true ? [createContinueDelegateTool({ agentSessionKey: options?.agentSessionKey })] : [],
...
//#endregion
export { isStrictAgenticExecutionContractActive as _, normalizeCronJobCreate as a, setEmbeddedMode as b, createHostWorkspaceEditTool as c, createSandboxedEditTool as d, createSandboxedReadTool as f, wrapToolWorkspaceRootGuardWithOptions as g, wrapToolWorkspaceRootGuard as h, findActiveSessionTask as i, createHostWorkspaceWriteTool as l, wrapToolMemoryFlushAppendOnlyWrite as m, buildActiveVideoGenerationTaskPromptContextForSession as n, normalizeCronJobInput as o, createSandboxedWriteTool as p, buildActiveMusicGenerationTaskPromptContextForSession as r, normalizeCronJobPatch as s, createOpenClawTools as t, createOpenClawReadTool as u, isStrictAgenticSupportedProviderModel as v, isEmbeddedMode as y };
