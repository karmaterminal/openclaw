import { n as resolveManifestProviderAuthChoice } from "./provider-auth-choices-IdvmFWhX.js";
import { r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-4wVQKYhI.js";
...
async function resolvePreferredProviderForAuthChoice(params) {
	...
	const { resolveProviderPluginChoice, resolvePluginProviders } = await import("./provider-auth-choice.runtime-BBgfhRF5.js");
