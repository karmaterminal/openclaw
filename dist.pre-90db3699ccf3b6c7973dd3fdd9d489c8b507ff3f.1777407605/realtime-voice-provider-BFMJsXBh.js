...
import { a as resolveOpenAIProviderConfigRecord, i as readRealtimeErrorDetail, o as trimToUndefined, r as captureOpenAIRealtimeWsClose, t as asFiniteNumber } from "./realtime-provider-shared-sU25qL2r.js";
...
var OpenAIRealtimeVoiceBridge = class OpenAIRealtimeVoiceBridge {
	static {
		this.DEFAULT_MODEL = "gpt-realtime";
	}
	static {
	...
	async doConnect() {
		await new Promise((resolve, reject) => {
			...
			const connectTimeout = setTimeout(() => {
				reject(/* @__PURE__ */ new Error("OpenAI realtime connection timeout"));
