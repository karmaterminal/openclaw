...
import { n as prepareBundledPluginRuntimeRoot, t as isBuiltBundledPluginRuntimeRoot } from "./bundled-runtime-root-B-aAjcsD.js";
import { n as formatPluginLoadProfileLine, r as shouldProfilePluginLoader, t as createProfiler } from "./plugin-load-profile-kP6V6eFL.js";
...
function defineBundledChannelSetupEntry({ importMetaUrl, plugin, secrets, runtime, legacyStateMigrations, legacySessionSurface, features }) {
	...
	const loadLegacyStateMigrationDetector = legacyStateMigrations ? () => loadBundledEntryExportSync(importMetaUrl, legacyStateMigrations) : void 0;
	const loadLegacySessionSurface = legacySessionSurface ? () => loadBundledEntryExportSync(importMetaUrl, legacySessionSurface) : void 0;
	return {
