...
import { _ as resolveModelRefFromString, c as buildModelAliasIndex, m as resolveConfiguredModelRef, t as isCliProvider } from "./model-selection-cli-BCNxTSmc.js";
...
import { c as resolveSessionPluginTraceLines, s as resolveSessionPluginStatusLines } from "./types-ASqeFakT.js";
import { a as resolveContextTokensForModel } from "./context-BYRc5RHZ.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount$1 } from "./usage-format-CFG0b3V-.js";
import { r as readLatestSessionUsageFromTranscript } from "./session-utils.fs-DgRtLXgk.js";
...
import { n as findDecisionReason, s as summarizeDecisionReason } from "./runner.entries-CsjW617U.js";
import "./sandbox-CJSotrdf.js";
import { r as resolveExtraParams } from "./extra-params-XxqPm0T2.js";
...
import { n as resolveSelectedAndActiveModel, t as formatProviderModelRef } from "./model-runtime-CXTdM7SK.js";
import { t as resolveActiveFallbackState } from "./fallback-notice-state-yPRLBemY.js";
...
function resolveRunnerLabel(args) {
	...
	if (provider && isCliProvider(provider, args.config)) return `${provider} (cli)`;
	return "pi (embedded)";
}
