...
import { i as createPairingPrefixStripper, r as createLoggedPairingApprovalNotifier } from "./channel-pairing-Di-QWGuY.js";
	...
	base: {
		...
		gateway: {
			startAccount: async (ctx) => {
				...
				const { monitorTwitchProvider } = await import("./monitor-BlwwUKxz.js");
