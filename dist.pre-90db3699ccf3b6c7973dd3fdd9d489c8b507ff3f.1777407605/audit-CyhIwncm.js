...
import { _ as resolveStateDir, o as resolveConfigPath } from "./paths-D92DjaZ-.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-BZ6RGKR0.js";
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-DNqHeAl9.js";
...
import { i as normalizeTrustedSafeBinDirs, o as listRiskyConfiguredSafeBins } from "./exec-safe-bin-trust-CInTCtp-.js";
...
import { u as isInterpreterLikeAllowlistPattern } from "./exec-approvals-allowlist-jzBM7IP-.js";
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-CiyctINB.js";
import { l as loadExecApprovals } from "./exec-approvals-CFEClmo3.js";
...
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-6sqHBd5y.js");
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-ByUzyfsv.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-CHIhniOP.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-BVUta4b3.js");
