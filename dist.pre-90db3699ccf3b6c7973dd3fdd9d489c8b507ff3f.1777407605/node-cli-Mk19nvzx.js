import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, o as normalizeNullableString } from "./string-coerce-CjxCKZ6B.js";
...
import { _ as resolveNodeSystemdServiceName, g as resolveNodeLaunchAgentLabel, u as formatNodeServiceDescription, v as resolveNodeWindowsTaskName } from "./paths-CJrJgeHo.js";
import { a as resolveNodeProgramArguments, n as resolveDaemonInstallRuntimeInputs, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-C-zyu1EB.js";
import { n as VERSION } from "./version-Bym9kFjy.js";
import { s as buildNodeServiceEnvironment } from "./runtime-paths-BOtHrzgd.js";
...
import { i as runServiceUninstall, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-C7RWDpMZ.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS } from "./node-commands-CUkVM3Gb.js";
import { a as getActivePluginRegistry } from "./runtime-Cym-fqI8.js";
import { t as getMachineDisplayName } from "./machine-name-D_yx7Swp.js";
import { t as splitShellArgs } from "./shell-argv-VbVOJlPI.js";
import { _ as resolvePlannedSegmentArgv, c as describeInterpreterInlineEval, d as analyzeArgvCommand, l as detectInterpreterInlineEvalArgv, n as evaluateShellAllowlist, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-jzBM7IP-.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-CiyctINB.js";
...
import { t as resolveGatewayConnectionAuth } from "./connection-auth-kZs23aC1.js";
import { t as formatHelpExamples } from "./help-format-oS7J2-Gq.js";
import { n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-kuX308TQ.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-D5hqnRCG.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-BBC-ebnO.js";
import { t as resolveNodeService } from "./node-service-D6FK_MnJ.js";
...
async function loadSystemRunConfig(opts) {
	...
	const { loadConfig } = await import("./config-D_gwExo-.js");
	return loadConfig();
}
...
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-CRpKNLW6.js");
