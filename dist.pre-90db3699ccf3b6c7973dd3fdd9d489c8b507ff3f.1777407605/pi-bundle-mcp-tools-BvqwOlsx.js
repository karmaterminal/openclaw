...
import { i as setPluginToolMeta } from "./tools-CjyAaC4m.js";
import { c as normalizeReservedToolNames, s as buildSafeToolName } from "./pi-bundle-mcp-runtime-DAdkA6n_.js";
...
async function createBundleMcpToolRuntime(params) {
	const runtime = (params.createRuntime ?? (await import("./pi-bundle-mcp-runtime-BZTTThTM.js")).createSessionMcpRuntime)({
