...
import { t as CONFIG_DIR } from "./utils-CB8xp0O4.js";
...
import { t as prepareOomScoreAdjustedSpawn } from "./linux-oom-score-B6cKs3ha.js";
import "./text-runtime-ITCc6m8o.js";
import "./process-runtime-BuUNdgAT.js";
import "./logging-core-B3Iy3nt1.js";
import "./browser-security-runtime-B5AXFvrX.js";
import { s as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME } from "./utils-DLZa1oC8.js";
import { E as BrowserCdpEndpointBlockedError, L as assertBrowserNavigationAllowed, V as withBrowserNavigationPolicy, _ as CHROME_BOOTSTRAP_PREFS_TIMEOUT_MS, b as CHROME_STDERR_HINT_MAX_CHARS, c as isWebSocketUrl, f as redactCdpUrl, g as CHROME_BOOTSTRAP_EXIT_TIMEOUT_MS, i as fetchJson, l as normalizeCdpHttpBaseForJsonEndpoints, n as assertCdpEndpointAllowed, p as withCdpSocket, r as fetchCdpChecked, s as isDirectCdpWebSocketEndpoint, t as appendCdpPath, u as openCdpWebSocket, v as CHROME_LAUNCH_READY_WINDOW_MS, x as CHROME_STOP_TIMEOUT_MS } from "./cdp.helpers-BC5SjFUf.js";
...
async function launchOpenClawChrome(resolved, profile) {
	...
	if (!await isChromeReachable(profile.cdpUrl)) {
		...
		throw new Error(`Failed to start Chrome CDP on port ${profile.cdpPort} for profile "${profile.name}". ${diagnosticText}${sandboxHint}${stderrHint}`);
	}
...
//#endregion
export { matchBrowserUrlPattern as A, normalizeBrowserFormField as C, normalizeActBoundedNonNegativeMs as D, ACT_MAX_WAIT_TIME_MS as E, resolveActInteractionTimeoutMs as O, DEFAULT_FILL_FIELD_TYPE as S, ACT_MAX_CLICK_DELAY_MS as T, captureScreenshot as _, resolveOpenClawUserDataDir as a, normalizeCdpWsUrl as b, formatChromeCdpDiagnostic as c, getRoleSnapshotStats as d, parseRoleRef as f, AX_REF_PATTERN as g, STRUCTURAL_ROLES as h, launchOpenClawChrome as i, resolveActWaitTimeoutMs as k, buildRoleSnapshotFromAiSnapshot as l, INTERACTIVE_ROLES as m, isChromeCdpReady as n, stopOpenClawChrome as o, CONTENT_ROLES as p, isChromeReachable as r, diagnoseChromeCdp as s, getChromeWebSocketUrl as t, buildRoleSnapshotFromAriaSnapshot as u, createTargetViaCdp as v, normalizeBrowserFormFieldValue as w, snapshotAria as x, formatAriaSnapshot as y };
