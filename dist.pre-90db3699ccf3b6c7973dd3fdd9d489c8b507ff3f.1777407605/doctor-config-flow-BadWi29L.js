...
import { T as validateConfigObjectWithPlugins, V as findLegacyConfigIssues, Y as normalizeBaseCompatibilityConfigValues, it as applyChannelDoctorCompatibilityMigrations, rt as applyLegacyDoctorMigrations } from "./io-CBRjt33P.js";
...
import { i as runPluginSetupConfigMigrations } from "./setup-registry-ivK2QpZk.js";
import { i as listRouteBindings } from "./bindings-Ff23d3eO.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-DUMDHW-c.js";
import { t as note } from "./note-C-5kMv2A.js";
import { a as stripUnknownConfigKeys, r as noteOpencodeProviderOverrides } from "./doctor-config-analysis-BafCD82P.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-Bj2vDIre.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-DnxVp2tm.js";
import { t as asObjectRecord } from "./object-BKnT8A7f.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = await (async () => {
		...
		const { collectRelevantDoctorPluginIds, listPluginDoctorLegacyConfigRules } = await import("./doctor-contract-registry-i7yjumc2.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-1QTxBi3N.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-BSaPrFg3.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-CStunHKY.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-DpUuzmMm.js");
		emitDoctorNotes({
			note,
