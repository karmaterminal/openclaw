...
import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, f as readStringValue } from "./string-coerce-CjxCKZ6B.js";
...
import { p as resolveSessionAgentId } from "./agent-scope-D-T17Rdc.js";
import { _ as hasGatewayClientCap, g as GATEWAY_CLIENT_NAMES, h as GATEWAY_CLIENT_MODES, n as isGatewayCliClient, o as isWebchatClient, p as GATEWAY_CLIENT_CAPS, u as normalizeMessageChannel } from "./message-channel-Bk_YHfQg.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-DTA--Gjh.js";
import { _ as validateChatInjectParams, g as validateChatHistoryParams, h as validateChatAbortParams, in as errorShape, rn as ErrorCodes, t as formatValidationErrors, v as validateChatSendParams } from "./protocol-Bcs0YWrz.js";
import { a as normalizeInputProvenance } from "./input-provenance-CNf_1qHV.js";
import { o as ADMIN_SCOPE } from "./method-scopes-7zKnuhA9.js";
import { p as resolveThinkingDefault } from "./model-selection-B7RNWcLj.js";
import "./sessions-THKm0e_w.js";
import { i as resolveSessionFilePath } from "./paths-D6msg0S1.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-BSJWlilY.js";
import { c as stripEnvelopeFromMessages, i as readSessionMessages, n as capArrayByJsonBytes, p as jsonUtf8Bytes, s as stripEnvelopeFromMessage, t as attachOpenClawTranscriptMeta } from "./session-utils.fs-DgRtLXgk.js";
import { o as parseAssistantTextSignature, s as resolveAssistantMessagePhase } from "./chat-message-content-BqgwRnGh.js";
import { a as stripInlineDirectiveTagsFromMessageForDisplay, i as stripInlineDirectiveTagsForDisplay, n as sanitizeReplyDirectiveId } from "./directive-tags-Bb9KtDtd.js";
import { n as stripInboundMetadata } from "./strip-inbound-meta-CmdyYDK1.js";
import { d as resolveGatewayModelSupportsImages, l as resolveDeletedAgentIdFromSessionKey, m as resolveSessionModelRef, o as loadSessionEntry } from "./session-utils-TWBJFzaE.js";
...
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-Bp4halqE.js";
import { a as safeFileURLToPath, t as assertNoWindowsNetworkPath } from "./local-file-access-BpdUv1jJ.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-DDn7G0b_.js";
import { l as saveMediaBuffer } from "./store-BuB7MfIQ.js";
import { n as assertLocalMediaAllowed, t as LocalMediaAccessError } from "./local-media-access-1NrFiEok.js";
import { t as resolveAgentTimeoutMs } from "./timeout-htOXkzfH.js";
import { t as rewriteTranscriptEntriesInSessionFile } from "./transcript-rewrite-DLFL__mi.js";
import { n as isAbortRequestText } from "./abort-primitives-cqGFEGHq.js";
import { i as createReplyDispatcher, t as dispatchInboundMessage } from "./dispatch-QTzIv_tK.js";
...
import { t as logLargePayload } from "./diagnostic-payload-BNc0oyeh.js";
				...
				if (!agentRunStarted) {
					...
					if (btwReplies.length > 0 && btwText) {
						...
						if (mediaMessage || combinedReply) {
							...
							if (appended.ok) if (hasSensitiveMedia && mediaMessage) message = {
								...appended.message,
								content: mediaMessage.content
							};
							else message = appended.message;
							else {
...
//#endregion
export { augmentChatHistoryWithCliSessionImports as C, getMaxChatHistoryMessagesBytes as S, HEALTH_REFRESH_INTERVAL_MS as _, enforceChatHistoryFinalBudget as a, MAX_PREAUTH_PAYLOAD_BYTES as b, sanitizeChatHistoryMessages as c, waitForTerminalGatewayDedupe as d, isSuppressedControlReplyLeadFragment as f, DEDUPE_TTL_MS as g, DEDUPE_MAX as h, chatHandlers as i, readTerminalSnapshotFromGatewayDedupe as l, abortChatRunById as m, DEFAULT_CHAT_HISTORY_TEXT_MAX_CHARS as n, replaceOversizedChatHistoryMessages as o, isSuppressedControlReplyText as p, augmentChatHistoryWithCanvasBlocks as r, resolveEffectiveChatHistoryMaxChars as s, CHAT_HISTORY_MAX_SINGLE_MESSAGE_BYTES as t, setGatewayDedupeEntry as u, MAX_BUFFERED_BYTES as v, TICK_INTERVAL_MS as x, MAX_PAYLOAD_BYTES as y };
