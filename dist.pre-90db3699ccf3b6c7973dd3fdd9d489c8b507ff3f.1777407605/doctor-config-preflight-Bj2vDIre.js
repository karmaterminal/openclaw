...
import { h as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-CBRjt33P.js";
import { n as formatConfigIssueLines } from "./issue-format-zM6cvDu4.js";
import { t as note } from "./note-C-5kMv2A.js";
import { n as noteIncludeConfinementWarning } from "./doctor-config-analysis-BafCD82P.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-BCZx5iFF.js");
