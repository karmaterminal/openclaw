...
import "./accounts-BtFQ5aaj.js";
import "./runtime-api-Dsp0pRus.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-C-QOO9zJ.js";
import { t as sendMessageZalo } from "./send-B9hEDSDl.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-BFIbUfX4.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-CSMFUQUJ.js");
