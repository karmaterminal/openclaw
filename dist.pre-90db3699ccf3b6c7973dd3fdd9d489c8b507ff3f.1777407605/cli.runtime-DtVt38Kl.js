...
import { V as resolveMemoryRemDreamingConfig } from "./dreaming-C4iELShs.js";
...
import { a as readShortTermRecallEntries, c as recordShortTermRecalls, d as resolveShortTermRecallLockPath, f as resolveShortTermRecallStorePath, i as rankShortTermPromotionCandidates, l as removeGroundedShortTermCandidates, n as applyShortTermPromotions, r as auditShortTermPromotionArtifacts, s as recordGroundedShortTermCandidates, u as repairShortTermPromotionArtifacts } from "./short-term-promotion-CbMijT_r.js";
import "./dreaming-shared-CsighQz4.js";
import { a as seedHistoricalDailyMemorySignals, i as previewRemDreaming, n as resolveDreamingBlockedReason, r as resolveShortTermPromotionDreamingConfig } from "./dreaming-KHnPgGvA.js";
import { a as writeBackfillDiaryEntries, i as removeBackfillDiaryEntries } from "./dreaming-narrative-CqAsjqgv.js";
import { n as getMemorySearchManager } from "./memory-bSxQc1wR.js";
import { t as previewGroundedRemMarkdown } from "./rem-evidence-8d7NrWdS.js";
...
async function runMemoryStatus(opts) {
	...
	for (const result of allResults) {
		...
		if (dreamingBlockedReason) lines.push(`${label("Dreaming status")} ${warn(`blocked - ${dreamingBlockedReason}`)}`);
		if (embeddingProbe) {
