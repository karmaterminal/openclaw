...
import { t as restoreTerminalState } from "./restore-Cq7ylBPo.js";
...
import { d as resolveSecretInputRef, s as isValidEnvSecretRefId } from "./types.secrets-BZ6RGKR0.js";
import { l as resolveDefaultSecretProviderAlias } from "./ref-contract-CsOjNPCR.js";
import { t as resolveGatewayAuthToken } from "./auth-token-resolution-Cv3D42p-.js";
...
import { c as normalizeGatewayTokenInput, m as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-Dourk4Vm.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-4wVQKYhI.js";
import { t as runSetupWizard } from "./setup-CJe8aDcv.js";
import { r as applyLocalSetupWorkspaceConfig } from "./onboard-config-C9sXVXE8.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-C29K5gV8.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	const inferredAuthChoice = opts.authChoice ? void 0 : (await import("./auth-choice-inference-AYHQCRhV.js")).inferAuthChoiceFromFlags(opts, {
		config: nextConfig,
		workspaceDir,
		env: process.env
	});
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-DMH9Jk37.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-C57QPVAd.js");
