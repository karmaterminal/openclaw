import { a as markdownToWhatsApp, g as resolveWhatsAppMediaMaxBytes, i as jidToE164, m as resolveWhatsAppAccount, o as resolveJidToE164, r as isSelfChatMode, s as toWhatsappJid, t as text_runtime_exports } from "./text-runtime-pSZYjiCV.js";
import { t as resolveWhatsAppReactionLevel } from "./reaction-level-DBya_yDS.js";
import { r as sendReactionWhatsApp } from "./send-hk5DLdjj.js";
import { n as cacheInboundMessageMeta, r as lookupInboundMessageMeta, t as buildQuotedMessageOptions } from "./quoted-message-BnVl5P4C.js";
import { _ as readWebSelfIdentityForDecision, a as getWebAuthAgeMs, h as readWebSelfId, r as WhatsAppAuthUnstableError, y as restoreCredsFromBackupIfNeeded } from "./auth-store-lH9AsQ9n.js";
import { a as getSelfIdentity, c as resolveComparableIdentity, i as getReplyContext, n as getMentionIdentities, o as getSenderIdentity, r as getPrimaryIdentityId, s as identitiesOverlap, t as getComparableIdentityValues } from "./identity-CnN6D7NY.js";
import { i as resolveWhatsAppInboundPolicy, n as checkInboundAccessControl, r as resolveWhatsAppCommandAuthorized } from "./access-control-CNmzwKT9.js";
import { n as getStatusCode, t as formatError } from "./session-errors-CMsvhfK-.js";
import { a as waitForWhatsAppLoginResult, c as waitForWaConnection, d as newConnectionId, f as resolveHeartbeatSeconds, i as closeWaSocketSoon, l as DEFAULT_RECONNECT_POLICY, m as sleepWithAbort, n as WhatsAppConnectionController, o as createWaSocket, p as resolveReconnectPolicy, u as computeBackoff } from "./connection-controller-Dv0ZiBkR.js";
import { resolveAccountEntry } from "openclaw/plugin-sdk/account-core";
import { getChildLogger, logInfo, normalizeLowercaseStringOrEmpty } from "openclaw/plugin-sdk/text-runtime";
import { shouldAckReactionForWhatsApp } from "openclaw/plugin-sdk/channel-feedback";
import { formatCliCommand } from "openclaw/plugin-sdk/cli-runtime";
import { evaluateSessionFreshness, getRuntimeConfigSourceSnapshot, loadConfig, loadConfig as loadConfig$1, loadSessionStore, recordSessionMetaFromInbound, resolveChannelContextVisibilityMode, resolveChannelResetConfig, resolveSessionKey, resolveSessionResetPolicy, resolveSessionResetType, resolveStorePath, resolveThreadFlag, updateLastRoute, updateSessionStore } from "openclaw/plugin-sdk/config-runtime";
import { createDedupeCache } from "openclaw/plugin-sdk/core";
import { getAgentScopedMediaLocalRoots, saveMediaBuffer } from "openclaw/plugin-sdk/media-runtime";
import { createSubsystemLogger, danger, defaultRuntime, formatDurationPrecise, getChildLogger as getChildLogger$1, logVerbose, logVerbose as logVerbose$1, registerUnhandledRejectionHandler, shouldLogVerbose, shouldLogVerbose as shouldLogVerbose$1, success } from "openclaw/plugin-sdk/runtime-env";
...
import { isReasoningReplyPayload, resolveOutboundMediaUrls, resolveSendableOutboundReplyParts as resolveSendableOutboundReplyParts$1, sendMediaWithLeadingCaption } from "openclaw/plugin-sdk/reply-payload";
import { dispatchReplyWithBufferedBlockDispatcher, finalizeInboundContext, normalizeGroupActivation, parseActivationCommand, resolveChunkMode, resolveTextChunkLimit } from "openclaw/plugin-sdk/reply-runtime";
import { resolveIdentityNamePrefix, resolveMessagePrefix } from "openclaw/plugin-sdk/agent-runtime";
import { buildMentionRegexes, createInboundDebouncer, formatInboundEnvelope, formatInboundEnvelope as formatInboundEnvelope$1, formatLocationText, implicitMentionKindWhen, normalizeMentionText, resolveInboundDebounceMs, resolveInboundMentionDecision, resolveInboundSessionEnvelopeContext, toLocationContext } from "openclaw/plugin-sdk/channel-inbound";
...
function resolveWhatsAppGroupSystemPrompt(params) {
	...
	return groups?.[params.groupId]?.systemPrompt?.trim() || groups?.["*"]?.systemPrompt?.trim() || void 0;
}
function resolveWhatsAppDirectSystemPrompt(params) {
	if (!params.peerId) return;
	const direct = params.accountConfig?.direct;
	return direct?.[params.peerId]?.systemPrompt?.trim() || direct?.["*"]?.systemPrompt?.trim() || void 0;
}
//#endregion
...
async function deliverWebReply(params) {
	...
	const textChunks = chunkMarkdownTextWithMode(markdownToWhatsApp((0, text_runtime_exports.convertMarkdownTables)(replyResult.text || "", tableMode)), textLimit, chunkMode);
	...
	await sendMediaWithLeadingCaption({
		...
		send: async ({ mediaUrl, caption }) => {
			const media = await loadWebMedia$1(mediaUrl, {
	...
	const { queuedFinal, counts } = await dispatchReplyWithBufferedBlockDispatcher({
		...
		dispatcherOptions: {
			...
			deliver: async (payload, info) => {
				...
				const reply = resolveSendableOutboundReplyParts$1(payload);
				if (shouldLogVerbose$1()) logVerbose$1(`Reply body: ${payload.text != null ? reply.text : "<media>"}${reply.hasMedia ? " (media)" : ""} -> ${fromDisplay}`);
			},
...
function loadReplyResolverRuntime() {
	replyResolverRuntimePromise ??= import("./reply-resolver.runtime-D290bwH7.js");
...
//#endregion
export { whatsappHeartbeatLog as S, resolveSessionKey as _, loadWebMedia$1 as a, resolveStorePath as b, optimizeImageToPng as c, extractMediaPlaceholder as d, extractText as f, resolveChannelResetConfig as g, loadSessionStore as h, getDefaultLocalRoots as i, monitorWebInbox as l, evaluateSessionFreshness as m, monitorWebChannel as n, loadWebMediaRaw as o, resetWebInboundDedupe as p, LocalMediaAccessError as r, optimizeImageToJpeg as s, loginWeb as t, extractLocationData as u, resolveSessionResetPolicy as v, resolveThreadFlag as x, resolveSessionResetType as y };
