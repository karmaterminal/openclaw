...
function resolveCodexAppServerRuntimeOptions(params = {}) {
	...
	return {
		...
		approvalsReviewer: resolveApprovalsReviewer(config.approvalsReviewer) ?? (policyMode === "guardian" ? "guardian_subagent" : "user"),
...
//#endregion
export { readCodexPluginConfig as n, resolveCodexAppServerRuntimeOptions as r, codexAppServerStartOptionsKey as t };
