import { a as resolveSlackAccount, c as resolveSlackBotToken, s as resolveSlackAppToken } from "./accounts-4xzH_k5j.js";
import { r as isSlackExecApprovalClientEnabled } from "./exec-approvals-ECITbBVY.js";
import { a as truncateSlackText } from "./blocks-render-BHOo7XUv.js";
import { n as isSlackInteractiveRepliesEnabled, t as compileSlackInteractiveReplies } from "./interactive-replies-CVhFBMpF.js";
import { a as resolveSlackWebClientOptions } from "./client-BfPZ6k8d.js";
import { i as normalizeSlackAllowOwnerEntry, n as normalizeAllowList, o as resolveSlackAllowListMatch, s as resolveSlackUserAllowed } from "./allow-list-GR9Gx-es.js";
import { t as SLACK_TEXT_LIMIT } from "./limits-DeULmw1T.js";
import { n as resolveSlackNativeStreaming, r as resolveSlackStreamingMode, t as mapStreamingModeToSlackLegacyDraftStreamMode } from "./streaming-compat-19prNxvY.js";
...
import { i as buildSlackBlocksFallbackText, r as normalizeSlackOutboundText, t as sendMessageSlack } from "./send-DG4kOuUp.js";
import { f as removeSlackReaction, l as reactSlackMessage, r as editSlackMessage, t as deleteSlackMessage } from "./actions-DyUi6vba.js";
import { n as registerSlackHttpHandler, r as normalizeSlackWebhookPath } from "./registry-Ow5iTFdh.js";
import { r as recordSlackThreadParticipation } from "./sent-thread-cache-BeD_EofT.js";
import { C as resolveSlackSlashCommandConfig, S as buildSlackSlashCommandMatcher, _ as resolveDefaultGroupPolicy, a as buildPluginBindingResolvedText, b as updateLastRoute, c as authorizeSlackSystemEventSender, d as isSlackChannelAllowedByPolicy, f as normalizeSlackChannelType, g as loadConfig$1, h as isDangerousNameMatchingEnabled, i as resolveSlackThreadTargets, l as resolveSlackEffectiveAllowFrom, m as resolveSlackChannelLabel, n as resolveSlackRoomContextHints, o as parsePluginBindingApprovalCustomId, p as resolveSlackChannelConfig, r as authorizeSlackDirectMessage, s as resolvePluginConversationBindingApproval, t as prepareSlackMessage, u as createSlackMonitorContext, v as resolveOpenProviderRuntimeGroupPolicy, w as stripSlackMentionsForCommandDetection, x as warnMissingProviderGroupPolicyFallbackOnce, y as resolveStorePath } from "./prepare-BH5U3jEx.js";
import { a as dispatchInboundMessage, c as resolveTextChunkLimit, r as createReplyDispatcherWithTyping } from "./send.runtime-B9xdpv6p.js";
import { a as resolveSlackThreadTs, i as readSlackReplyBlocks, n as deliverReplies, t as createSlackReplyDeliveryPlan } from "./replies-B7-eEtpH.js";
import { normalizeResolvedSecretInputString } from "openclaw/plugin-sdk/secret-input";
import { chunkItems, normalizeLowercaseStringOrEmpty, normalizeOptionalLowercaseString, normalizeOptionalString, normalizeStringEntries } from "openclaw/plugin-sdk/text-runtime";
import { resolveAgentOutboundIdentity } from "openclaw/plugin-sdk/outbound-runtime";
import { normalizeAccountId, normalizeMainKey } from "openclaw/plugin-sdk/routing";
import { CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "openclaw/plugin-sdk/approval-handler-adapter-runtime";
import { enqueueSystemEvent, generateSecureToken } from "openclaw/plugin-sdk/infra-runtime";
...
import { DEFAULT_GROUP_HISTORY_LIMIT, clearHistoryEntriesIfEnabled } from "openclaw/plugin-sdk/reply-history";
...
import { listProviderPluginCommandSpecs, resolveCommandAuthorizedFromAuthorizers, resolveNativeCommandSessionTargets } from "openclaw/plugin-sdk/command-auth";
...
async function dispatchPreparedSlackMessage(prepared) {
	...
	const deliverPendingStreamFallback = async (session, err) => {
		...
		try {
			await ctx.app.client.chat.postMessage.bind(ctx.app.client.chat)({
			...
			logVerbose(`slack-stream: streamed delivery failed (${err.slackCode}); delivered ${fallbackText.length} chars via chat.postMessage fallback`);
			return true;
		} catch (postErr) {
			runtime.error?.(danger(`slack-stream: fallback chat.postMessage failed after ${err.slackCode}: ${formatErrorMessage(postErr)}`));
			return false;
		}
	};
	...
	const deliverWithStreaming = async (params) => {
		...
		try {
			...
			if (err instanceof SlackStreamNotDeliveredError) {
				streamFailed = true;
				if (streamSession) {
					if (await deliverPendingStreamFallback(streamSession, err)) {
						replyPlan.markSent();
						deliveryTracker.markDelivered({
							kind: params.kind,
							payload: params.payload,
	...
	try {
		const result = await dispatchInboundMessage({
			...
			replyOptions: {
				...
				hasRepliedRef,
				disableBlockStreaming: useStreaming ? true : typeof resolveChannelStreamingBlockEnabled(account.config) === "boolean" ? !resolveChannelStreamingBlockEnabled(account.config) : void 0,
				onModelSelected,
...
function loadSlashCommandsRuntime() {
	slashCommandsRuntimePromise ??= import("./slash-commands.runtime-W1dGz4tN.js");
	return slashCommandsRuntimePromise;
}
function loadSlashDispatchRuntime() {
	slashDispatchRuntimePromise ??= import("./slash-dispatch.runtime-CCSYr0YJ.js");
	return slashDispatchRuntimePromise;
}
function loadSlashSkillCommandsRuntime() {
	slashSkillCommandsRuntimePromise ??= import("./slash-skill-commands.runtime-3KR3pI9n.js");
