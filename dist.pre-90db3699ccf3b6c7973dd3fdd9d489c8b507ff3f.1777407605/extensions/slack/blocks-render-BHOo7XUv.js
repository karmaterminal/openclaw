	...
	return reduceInteractiveReply(interactive, {
		...
		if (block.type === "buttons") {
			const elements = block.buttons.flatMap((button, choiceIndex) => {
				if (!button.value && !button.url) return [];
...
function buildSlackPresentationBlocks(presentation) {
...
//#endregion
export { truncateSlackText as a, buildSlackPresentationBlocks as i, SLACK_REPLY_SELECT_ACTION_ID as n, buildSlackInteractiveBlocks as r, SLACK_REPLY_BUTTON_ACTION_ID as t };
