import { E as isRecoverableTelegramNetworkError, k as isTelegramPollingNetworkError } from "./send-trgrTBon.js";
...
import { t as resolveTelegramAllowedUpdates } from "./allowed-updates-Ck2ppHDX.js";
...
function loadAuditMembershipRuntime() {
	auditMembershipRuntimePromise ??= import("./audit-membership-runtime-DClXiiUy.js");
...
async function loadTelegramActionRuntime() {
	telegramActionRuntimePromise ??= import("./action-runtime-BHjxTwhY.js");
...
async function loadTelegramMonitorPollingRuntime() {
	telegramMonitorPollingRuntimePromise ??= import("./monitor-polling.runtime-BUepTpZ1.js");
...
async function loadTelegramMonitorWebhookRuntime() {
	telegramMonitorWebhookRuntimePromise ??= import("./monitor-webhook.runtime-DoLYzi_u.js");
