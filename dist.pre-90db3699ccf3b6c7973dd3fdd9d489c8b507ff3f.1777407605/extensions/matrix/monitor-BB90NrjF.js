...
import { a as canonicalizeAllowlistWithResolvedIds, c as formatAllowlistMatchMeta, d as logInboundDrop, f as logTypingFailure, h as toLocationContext, i as buildAllowlistResolutionSummary, l as formatLocationText, m as summarizeMapping, n as resolveMatrixRoomConfig, o as createReplyPrefixOptions, p as patchAllowlistUsersInConfigEntries, r as addAllowlistUserEntriesFromConfigEntry, s as createTypingCallbacks, t as resolveMatrixStoredSessionMeta, u as getAgentScopedMediaLocalRoots } from "./session-store-metadata-Bf4M1p3g.js";
import { i as resolveMatrixStateFilePath } from "./storage-BKmFsYpZ.js";
import { a as sendMessageMatrix, g as isPollStartType, h as isPollEventType, p as formatPollAsText, t as chunkMatrixText, v as parsePollStartContent } from "./send-BsyVDDcn.js";
import { i as promoteMatrixDirectRoomCandidate, s as MATRIX_OPENCLAW_FINALIZED_PREVIEW_KEY } from "./direct-management-IHGhF8CI.js";
import { i as isStrictDirectMembership, n as hasDirectMatrixMemberFlag, o as readJoinedMatrixMembers } from "./direct-room-UAaDxWpp.js";
import { t as createMatrixThreadBindingManager } from "./thread-bindings-CYheZSHy.js";
import { t as createAsyncLock } from "./async-lock-dOsDOhzc.js";
import { n as LogService } from "./logger-FpzJs643.js";
import { i as isMatrixMediaSizeLimitError, r as MatrixMediaSizeLimitError } from "./http-client-6EF-uD15.js";
import { i as throwIfMatrixStartupAborted, r as isMatrixStartupAbortError } from "./startup-abort-Dkfg4VLa.js";
import { n as isMatrixReadySyncState, r as isMatrixTerminalSyncState, t as isMatrixDisconnectedSyncState } from "./sync-state-BWGRWCEy.js";
import { a as resolveMatrixMessageBody, i as resolveMatrixMessageAttachment, n as formatMatrixMediaUnavailableText, r as formatMatrixMessageText, s as fetchMatrixPollSnapshot, t as formatMatrixMediaTooLargeText } from "./media-text-DnfVFa3m.js";
import { n as setActiveMatrixClient } from "./active-client-BgBnA31v.js";
import { t as isBunRuntime } from "./runtime-DiJjx5FN.js";
import { n as resolveMatrixAuth, r as resolveMatrixAuthContext, t as backfillMatrixAuthDeviceIdAfterStartup } from "./config-CpHvZGxt.js";
import { f as resolveThreadBindingIdleTimeoutMsForChannel, h as warnMissingProviderGroupPolicyFallbackOnce, l as resolveAllowlistProviderRuntimeGroupPolicy, p as resolveThreadBindingMaxAgeMsForChannel, t as GROUP_POLICY_BLOCKED_LABEL, u as resolveDefaultGroupPolicy } from "./runtime-api-XcEO17BZ.js";
import { i as resolveSharedMatrixClient, n as releaseSharedClientInstance } from "./shared-L0iFKL1f.js";
import "./client-DBPd-8_B.js";
import { t as resolveMatrixTargets } from "./resolve-targets-DSeGOM8Y.js";
import { t as formatMatrixEncryptedEventDisabledWarning } from "./encryption-guidance-DCUzBtBp.js";
import { a as EventType, i as resolveMatrixThreadRouting, n as resolveMatrixReplyToEventId, o as RelationType, r as resolveMatrixThreadRootId, t as resolveMatrixInboundRoute } from "./route-BHLqDl8t.js";
...
async function loadMatrixDirectRoomDeps() {
	matrixDirectRoomDepsPromise ??= Promise.all([import("./direct-management-IHGhF8CI.js").then((n) => n.t), import("./direct-room-UAaDxWpp.js").then((n) => n.t)]).then(([directManagementModule, directRoomModule]) => ({
...
function loadMatrixSendModule() {
	matrixSendModulePromise ??= import("./send-BsyVDDcn.js").then((n) => n.l);
...
function loadMatrixReactionEvents() {
	matrixReactionEventsPromise ??= import("./reaction-events-DQi51Cgb.js");
	return matrixReactionEventsPromise;
}
function loadMatrixDraftStream() {
	matrixDraftStreamPromise ??= import("./draft-stream-rpTkUUzD.js");
...
async function loadMatrixStartupMaintenanceDeps() {
	matrixStartupMaintenanceDepsPromise ??= Promise.all([
		import("./config-update-CGejYzc0.js").then((n) => n.t),
		import("./device-health-b1BoC3nU.js"),
		import("./profile-BWFYtcCQ.js").then((n) => n.n),
		import("./legacy-crypto-restore-CICSqswF.js"),
		import("./startup-verification-Bq_xuqh_.js")
