...
import { t as claimCurrentTokenStorageState } from "./storage-BKmFsYpZ.js";
import { n as resolveMatrixRoomKeyBackupReadinessError } from "./backup-health-D-KP2mUx.js";
import { t as createAsyncLock } from "./async-lock-dOsDOhzc.js";
import { n as LogService, r as noop, t as ConsoleLogger } from "./logger-FpzJs643.js";
import { t as createMatrixJsSdkClientLogger } from "./logging-Di1RMADF.js";
import { a as matrixEventToRaw, n as createMatrixGuardedFetch, o as parseMxc, t as MatrixAuthedHttpClient } from "./http-client-6EF-uD15.js";
import { n as isRepairableSecretStorageAccessError, r as MATRIX_IDB_PERSIST_INTERVAL_MS, t as MatrixRecoveryKeyStore } from "./recovery-key-store-gfPRhbwu.js";
import { i as throwIfMatrixStartupAborted, n as createMatrixStartupAbortError } from "./startup-abort-Dkfg4VLa.js";
import { n as isMatrixReadySyncState, r as isMatrixTerminalSyncState } from "./sync-state-BWGRWCEy.js";
...
async function loadMatrixCryptoRuntime() {
	matrixCryptoRuntimePromise ??= import("./crypto-runtime-BibFwZHp.js").then((runtime) => {
...
var MatrixClient = class {
	...
	async getOwnDeviceVerificationStatus() {
		...
		const ownerVerified = deviceVerification.crossSigningVerified || deviceVerification.signedByOwner;
		return {
			...deviceVerification,
