...
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-Bl0WGrAg.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-BKmFsYpZ.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-CUthZt_Q.js").then((n) => n.n), import("./logging-Di1RMADF.js").then((n) => n.n)]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsWriteRuntime() {
	matrixCredentialsWriteRuntimePromise ??= import("./credentials-write.runtime-B77ha0sk.js");
	return await matrixCredentialsWriteRuntimePromise;
}
async function loadMatrixSecretInputDeps() {
	matrixSecretInputDepsPromise ??= import("./config-secret-input.runtime-BQNJl91q.js").then((runtime) => ({ resolveConfiguredSecretInputString: runtime.resolveConfiguredSecretInputString }));
