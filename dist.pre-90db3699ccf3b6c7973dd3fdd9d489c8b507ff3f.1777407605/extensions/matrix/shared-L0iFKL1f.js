...
import { t as awaitMatrixStartupWithAbort } from "./startup-abort-Dkfg4VLa.js";
import { n as resolveMatrixAuth, r as resolveMatrixAuthContext } from "./config-CpHvZGxt.js";
...
async function loadMatrixCreateClientDeps() {
	matrixCreateClientDepsPromise ??= import("./create-client-b28tWeXd.js").then((n) => n.n).then((runtime) => ({ createMatrixClient: runtime.createMatrixClient }));
