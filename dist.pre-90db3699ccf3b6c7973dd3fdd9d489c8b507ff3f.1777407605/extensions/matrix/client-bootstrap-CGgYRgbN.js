...
import { t as getActiveMatrixClient } from "./active-client-BgBnA31v.js";
...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-DBPd-8_B.js").then((n) => n.t), import("./shared-L0iFKL1f.js").then((n) => n.a)]).then(([clientModule, sharedModule]) => ({
