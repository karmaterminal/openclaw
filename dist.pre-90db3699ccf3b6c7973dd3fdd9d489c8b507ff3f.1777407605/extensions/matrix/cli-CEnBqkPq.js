...
import { n as resolveMatrixConfigPath } from "./config-paths-CzXbnXGG.js";
import { n as updateMatrixAccountConfig } from "./config-update-CGejYzc0.js";
import { n as matrixSetupAdapter } from "./setup-core-CbQA4jE6.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-D-KP2mUx.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-Di1RMADF.js";
import { i as withStartedActionClient, n as withResolvedActionClient } from "./client-BJEs6zZ6.js";
import { r as resolveMatrixAuthContext } from "./config-CpHvZGxt.js";
import "./client-DBPd-8_B.js";
import { isOpenClawManagedMatrixDevice, summarizeMatrixDeviceHealth } from "./device-health-b1BoC3nU.js";
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-CQ5_yW00.js";
import { c as getMatrixRoomKeyBackupStatus, h as restoreMatrixRoomKeyBackup, m as resetMatrixRoomKeyBackup, n as bootstrapMatrixVerification, u as getMatrixVerificationStatus, y as verifyMatrixRecoveryKey } from "./verification-w8w6bZE-.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-BJEs6zZ6.js").then((n) => n.t);
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-IHGhF8CI.js").then((n) => n.t);
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-JqvYDoWO.js");
