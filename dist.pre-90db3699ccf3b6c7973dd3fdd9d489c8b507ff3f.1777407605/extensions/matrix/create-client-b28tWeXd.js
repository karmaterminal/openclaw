...
import { a as resolveMatrixStoragePaths, n as maybeMigrateLegacyStorage, o as writeStorageMeta } from "./storage-BKmFsYpZ.js";
import "./config-CpHvZGxt.js";
import { m as ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "./runtime-api-XcEO17BZ.js";
...
async function loadMatrixCreateClientRuntimeDeps() {
	matrixCreateClientRuntimeDepsPromise ??= Promise.all([import("./sdk-CUthZt_Q.js").then((n) => n.n), import("./logging-Di1RMADF.js").then((n) => n.n)]).then(([sdkModule, loggingModule]) => ({
