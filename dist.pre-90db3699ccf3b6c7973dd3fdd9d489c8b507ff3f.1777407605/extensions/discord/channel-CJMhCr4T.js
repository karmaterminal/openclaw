...
import { t as getDiscordApprovalCapability } from "./approval-native-2UyhYZn6.js";
import { t as discordMessageActions$1 } from "./channel-actions-DN5MWVDs.js";
import { r as resolveDiscordCurrentConversationIdentity, t as isLikelyDiscordVideoMedia } from "./media-detection-BLICNQvM.js";
...
import { n as normalizeDiscordMessagingTarget, r as normalizeDiscordOutboundTarget, t as looksLikeDiscordTargetId } from "./normalize-Wb6YkZe1.js";
import { t as getDiscordRuntime } from "./runtime-DwbCVZGx.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-Hnp1X5Hn.js";
...
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-6AA3rLSn.js").then((n) => n.n));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-Dn_Vt7SX.js").then((n) => n.n));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-D7_K36Jt.js").then((n) => n.a));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime-DPOp5B0C.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-Dh_2ervO.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-COXQDWh9.js").then((n) => n.n);
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-lsr_UsIt.js").then((n) => n.t);
