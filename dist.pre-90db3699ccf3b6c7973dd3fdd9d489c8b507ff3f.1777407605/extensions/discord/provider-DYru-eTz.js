...
import { a as resolveDiscordComponentEntry, o as resolveDiscordModalEntry, t as editDiscordComponentMessage } from "./send.components-CZYBPmpZ.js";
import { c as setPresence, i as unregisterGateway, r as registerGateway } from "./gateway-registry-BKG4KIVC.js";
import { B as chunkDiscordTextWithMode, I as createDiscordRequestClient, L as resolveDiscordProxyFetchForAccount, R as validateDiscordProxyUrl, j as createDiscordRestClient, z as withValidatedDiscordProxy } from "./send.shared-DCi0J1Yy.js";
...
import { i as isDiscordExecApprovalClientEnabled, n as getDiscordExecApprovalApprovers } from "./approval-shared-1FPBNIqk.js";
import "./approval-native-2UyhYZn6.js";
import { n as resolveDiscordConversationIdentity } from "./media-detection-BLICNQvM.js";
import { a as isThreadArchived, d as formatThreadBindingDurationLabel } from "./thread-bindings.discord-api-DZpJvQwT.js";
...
import { _ as resolveDiscordChannelNameSafe, b as resolveDiscordChannelTopicSafe, g as resolveDiscordChannelInfoSafe, h as resolveDiscordChannelIdSafe, i as resolveDiscordThreadParentInfo, u as resolveDiscordChannelInfo, v as resolveDiscordChannelParentIdSafe } from "./threading-F7SLL3ho.js";
import { n as buildDiscordInboundAccessContext, t as buildDiscordGroupSystemPrompt } from "./inbound-context-DlofaYH_.js";
import { a as handleDiscordDmCommandDecision, c as buildDirectLabel, d as resolveDiscordSenderIdentity, i as resolveDiscordEffectiveRoute, l as buildGuildLabel, n as resolveDiscordBoundConversationRoute, o as resolveDiscordDmCommandAccess, s as deliverDiscordReply } from "./route-resolution-BlbhEhYJ.js";
import { t as authorizeDiscordVoiceIngress } from "./access-DS_i8B7S.js";
import "./approval-handler.runtime-Blv0Pd7n.js";
import { t as resolveDiscordChannelAllowlist } from "./resolve-channels-6AA3rLSn.js";
import { t as resolveDiscordUserAllowlist } from "./resolve-users-Dn_Vt7SX.js";
...
function resolveDiscordGuildNativeCommandAuthorized(params) {
	...
	return resolveCommandAuthorizedFromAuthorizers({
		...
		authorizers: params.useAccessGroups ? params.commandsAllowFromAccess.configured ? [commandAllowlistAuthorizer] : fallbackAuthorizers : params.commandsAllowFromAccess.configured ? [commandAllowlistAuthorizer] : fallbackAuthorizers,
...
async function loadConversationRuntime() {
	conversationRuntimePromise ??= import("./agent-components.runtime-Bu_xCRPb.js");
...
async function loadTypingRuntime() {
	typingRuntimePromise ??= import("./typing-YIvvZe4q.js").then((n) => n.n);
...
function createDiscordGatewayPlugin(params) {
	...
	if (!proxy) return createGatewayPlugin({
		...
		fetchImpl: async (input, init) => {
			...
			if (!debugProxySettings.enabled) captureHttpExchange({
				url: input,
	...
	try {
		...
		return createGatewayPlugin({
			options,
			fetchImpl: async (input, init) => {
				const response = await (params.__testing?.undiciFetch ?? undici.fetch)(input, init);
				captureHttpExchange({
					url: input,
					method: init?.method ?? "GET",
					requestHeaders: init?.headers,
...
async function loadDiscordVoiceRuntime() {
	discordVoiceRuntimePromise ??= import("./manager.runtime-DZtenh59.js");
	return await discordVoiceRuntimePromise;
}
async function loadDiscordProviderSessionRuntime() {
	discordProviderSessionRuntimePromise ??= import("./provider-session.runtime-DwIGEnF3.js");
