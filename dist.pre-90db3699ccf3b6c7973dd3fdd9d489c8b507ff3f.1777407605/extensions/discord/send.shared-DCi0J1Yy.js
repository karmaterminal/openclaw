...
function resolveDiscordClientAccountContext(opts, cfg, runtime) {
	...
	if (!config) throw new Error("Discord client requires a resolved runtime config. Load and resolve config at the command or gateway boundary, then pass cfg through the runtime path.");
...
async function parseAndResolveRecipient(raw, accountId, cfg, parseOptions = {}) {
...
async function resolveDiscordTargetChannelId(raw, opts) {
	...
	const recipient = await parseAndResolveRecipient(raw, opts.accountId, cfg, { defaultKind: "channel" });
...
//#endregion
export { createDiscordClient as A, chunkDiscordTextWithMode as B, DiscordSendError as C, hasAnyGuildPermissionDiscord as D, hasAllGuildPermissionsDiscord as E, createDiscordRetryRunner as F, createDiscordRequestClient as I, resolveDiscordProxyFetchForAccount as L, createDiscordRuntimeAccountContext as M, resolveDiscordClientAccountContext as N, parseAndResolveRecipient as O, resolveDiscordRest as P, validateDiscordProxyUrl as R, DISCORD_MAX_STICKER_BYTES as S, fetchMemberGuildPermissionsDiscord as T, sendDiscordText as _, buildReactionIdentifier as a, DISCORD_MAX_EMOJI_BYTES as b, normalizeEmojiName as c, resolveChannelId as d, resolveDiscordChannelType as f, sendDiscordMedia as g, resolveDiscordTargetChannelId as h, buildDiscordTextChunks as i, createDiscordRestClient as j, resolveDiscordTarget as k, normalizeReactionEmoji as l, resolveDiscordSendEmbeds as m, buildDiscordMessagePayload as n, formatReactionEmoji as o, resolveDiscordSendComponents as p, buildDiscordSendError as r, normalizeDiscordPollInput as s, SUPPRESS_NOTIFICATIONS_FLAG as t, normalizeStickerIds as u, stripUndefinedFields as v, fetchChannelPermissionsDiscord as w, DISCORD_MAX_EVENT_COVER_BYTES as x, toDiscordFileBlob as y, withValidatedDiscordProxy as z };
