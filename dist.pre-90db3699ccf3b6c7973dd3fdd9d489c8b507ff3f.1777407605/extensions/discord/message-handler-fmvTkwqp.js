import { a as resolveDefaultDiscordAccountId, c as resolveDiscordMaxLinesPerMessage } from "./accounts-zcI4mtzH.js";
import { B as chunkDiscordTextWithMode, M as createDiscordRuntimeAccountContext, j as createDiscordRestClient } from "./send.shared-DCi0J1Yy.js";
...
import { a as removeReactionDiscord, l as editMessageDiscord, r as reactMessageDiscord } from "./send-lsr_UsIt.js";
import { n as resolveDiscordConversationIdentity } from "./media-detection-BLICNQvM.js";
...
import "./thread-bindings-fFEyL-Xm.js";
import { l as runDiscordTaskWithTimeout, n as DISCORD_ATTACHMENT_TOTAL_TIMEOUT_MS, s as normalizeDiscordInboundWorkerTimeoutMs, t as DISCORD_ATTACHMENT_IDLE_TIMEOUT_MS } from "./timeouts-DDxjtlnF.js";
import { _ as resolveDiscordChannelNameSafe, a as resolveDiscordThreadStarter, c as buildDiscordMediaPayload, d as resolveDiscordMessageChannelId, f as resolveDiscordMessageText, g as resolveDiscordChannelInfoSafe, h as resolveDiscordChannelIdSafe, l as hasDiscordMessageStickers, m as resolveMediaList, n as resolveDiscordReplyDeliveryPlan, p as resolveForwardedMediaList, t as resolveDiscordAutoThreadReplyPlan, u as resolveDiscordChannelInfo, y as resolveDiscordChannelParentSafe } from "./threading-F7SLL3ho.js";
import { t as DISCORD_TEXT_CHUNK_LIMIT } from "./outbound-adapter-Bn4jJ6Q8.js";
import { n as buildDiscordInboundAccessContext, r as createDiscordSupplementalContextAccessChecker } from "./inbound-context-DlofaYH_.js";
import { a as handleDiscordDmCommandDecision, c as buildDirectLabel, d as resolveDiscordSenderIdentity, f as resolveDiscordWebhookId, i as resolveDiscordEffectiveRoute, l as buildGuildLabel, o as resolveDiscordDmCommandAccess, r as resolveDiscordConversationRoute, s as deliverDiscordReply, t as buildDiscordRoutePeer, u as resolveReplyContext } from "./route-resolution-BlbhEhYJ.js";
import { t as sendTyping } from "./typing-YIvvZe4q.js";
import { convertMarkdownTables, logDebug, normalizeOptionalString, stripInlineDirectiveTagsForDelivery, stripReasoningTagsFromText, truncateUtf16Safe } from "openclaw/plugin-sdk/text-runtime";
...
import { danger, formatDurationSeconds, getChildLogger, logVerbose, shouldLogVerbose } from "openclaw/plugin-sdk/runtime-env";
...
import { buildMentionRegexes, createChannelInboundDebouncer, formatInboundEnvelope, implicitMentionKindWhen, logInboundDrop, matchesMentionWithExplicit, resolveEnvelopeFormatOptions, resolveInboundMentionDecision, shouldDebounceTextInbound } from "openclaw/plugin-sdk/channel-inbound";
import { createClaimableDedupe } from "openclaw/plugin-sdk/persistent-dedupe";
import { createFinalizableDraftLifecycle, createRunStateMachine, deliverFinalizableDraftPreview } from "openclaw/plugin-sdk/channel-lifecycle";
...
import { readSessionUpdatedAt, resolveStorePath as resolveStorePath$1 } from "openclaw/plugin-sdk/session-store-runtime";
...
async function processDiscordMessage(ctx, observer) {
	...
	const { groupSystemPrompt, ownerAllowFrom, untrustedContext } = buildDiscordInboundAccessContext({
		...
		allowNameMatching: isDangerousNameMatchingEnabled$1(discordConfig),
	...
	const storePath = resolveStorePath$1(cfg.session?.store, { agentId: route.agentId });
			...
			if (draftStream && isFinal) {
				...
				if (await deliverFinalizableDraftPreview({
					...
					editFinal: async (previewMessageId, edit) => {
						...
						await editMessageDiscord(deliverChannelId, previewMessageId, edit, { rest: deliveryRest });
					},
...
async function loadDiscordSendRuntime() {
	discordSendRuntimePromise ??= import("./send-lsr_UsIt.js").then((n) => n.t);
	return await discordSendRuntimePromise;
}
async function loadPreflightAudioRuntime() {
	preflightAudioRuntimePromise ??= import("./preflight-audio-DwljQloV.js");
	return await preflightAudioRuntimePromise;
}
async function loadSystemEventsRuntime() {
	systemEventsRuntimePromise ??= import("./system-events-CErwRgFF.js");
	return await systemEventsRuntimePromise;
}
async function loadDiscordThreadingRuntime() {
	discordThreadingRuntimePromise ??= import("./threading-F7SLL3ho.js").then((n) => n.s);
