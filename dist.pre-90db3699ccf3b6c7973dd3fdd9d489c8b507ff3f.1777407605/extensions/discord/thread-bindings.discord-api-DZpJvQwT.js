...
import { j as createDiscordRestClient } from "./send.shared-DCi0J1Yy.js";
import { s as createThreadDiscord } from "./send-lsr_UsIt.js";
import { a as sendWebhookMessageDiscord, t as sendMessageDiscord } from "./send.outbound-HSw17Jx_.js";
...
async function resolveChannelIdForBinding(params) {
	...
	try {
		const channel = await createDiscordRestClient({
			accountId: params.accountId,
			token: params.token
		}, params.cfg).rest.get(Routes.channel(lookupThreadId));
