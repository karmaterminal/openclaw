...
import { _ as resolveAgentConfig, b as resolveAgentWorkspaceDir, p as resolveSessionAgentId } from "./agent-scope-D-T17Rdc.js";
import { u as normalizeMessageChannel } from "./message-channel-Bk_YHfQg.js";
import "./message-channel-core-DTA--Gjh.js";
import { n as getGlobalPluginRegistry, t as getGlobalHookRunner } from "./hook-runner-global-DuCZiaZE.js";
...
import { m as normalizeVerboseLevel } from "./thinking-Bh-7MqXz.js";
import { u as resolveSessionStoreEntry } from "./store-COeaE7A7.js";
...
import { r as isDiagnosticsEnabled } from "./diagnostic-events-C2InyoqQ.js";
import { a as isSilentReplyText, n as SILENT_REPLY_TOKEN } from "./tokens-CYuOTnyM.js";
import { t as getReplyPayloadMetadata } from "./reply-payload-hIkyznVT.js";
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-Bp4halqE.js";
import { c as toPluginInboundClaimEvent, f as fireAndForgetHook, i as toInternalMessageReceivedContext, l as toPluginMessageContext, n as deriveInboundMessageHookContext, s as toPluginInboundClaimContext, u as toPluginMessageReceivedEvent } from "./message-hook-mappers-BNyqCYCV.js";
import { r as generateSecureInt } from "./secure-random-bHiMyod8.js";
import { t as resolveSilentReplyPolicy } from "./silent-reply-DYEiwQ4D.js";
import { t as normalizeReplyPayload } from "./normalize-reply-D9qpdj0n.js";
import { i as logMessageQueued, o as logSessionStateChange, r as logMessageProcessed } from "./diagnostic-CLYAjMPL.js";
import { t as isParentOwnedBackgroundAcpSession } from "./session-interaction-mode-DiYsWzTX.js";
import { a as buildPluginBindingUnavailableText, b as touchConversationBindingRecord, c as hasShownPluginBindingFallbackNotice, d as markPluginBindingFallbackNoticeShown, h as toPluginConversationBinding, n as buildPluginBindingDeclinedText, r as buildPluginBindingErrorText, u as isPluginOwnedSessionBindingRecord, y as resolveConversationBindingRecord } from "./conversation-binding-TfOuSzmZ.js";
import { n as resolveSendPolicy } from "./send-policy-D5yeDZXf.js";
import { n as normalizeTtsAutoMode } from "./tts-auto-mode-C9F6weyY.js";
import { n as shouldAttemptTtsPayload, t as resolveConfiguredTtsMode } from "./tts-config-CRp9VtCI.js";
...
function loadRouteReplyRuntime() {
	routeReplyRuntimePromise ??= import("./route-reply.runtime-BAUsauSE.js");
	return routeReplyRuntimePromise;
}
function loadGetReplyFromConfigRuntime() {
	getReplyFromConfigRuntimePromise ??= import("./get-reply-from-config.runtime-DQ0JqulC.js");
	return getReplyFromConfigRuntimePromise;
}
function loadAbortRuntime() {
	abortRuntimePromise ??= import("./abort.runtime-DB1oMSNL.js");
	return abortRuntimePromise;
}
function loadTtsRuntime() {
	ttsRuntimePromise ??= import("./tts.runtime-3IQMxAcx.js");
	return ttsRuntimePromise;
}
function loadReplyMediaPathsRuntime() {
	replyMediaPathsRuntimePromise ??= import("./reply-media-paths.runtime-D4Sm8kzS.js");
...
function shouldPreserveSilentFinalPayload(params) {
	if (params.kind !== "final") return false;
	if (!isSilentReplyText(params.payload.text, "NO_REPLY")) return false;
	...
	if (shouldPreserve) silentReplyLogger.debug("preserving exact NO_REPLY final payload before normalization", {
...
function resolveDispatcherSilentReplyContext(ctx, cfg) {
	...
	return {
		cfg,
		sessionKey: finalized.CommandSource === "native" ? finalized.CommandTargetSessionKey ?? finalized.SessionKey : finalized.SessionKey,
