...
import { N as isRootHelpInvocation, P as isRootVersionInvocation } from "./logger-DTX5koY3.js";
import { t as resolveCliArgvInvocation } from "./argv-invocation-cHYqVrRf.js";
import { a as parseCliContainerArgs, n as applyCliProfileEnv, o as resolveCliContainerTarget, r as parseCliProfileArgs, t as normalizeWindowsArgv } from "./windows-argv-B7UOV81C.js";
import { t as resolveNodeStartupTlsEnvironment } from "./node-startup-env-CYCnjry6.js";
...
function tryHandleRootVersionFastPath(argv, deps = {}) {
	...
	(deps.resolveVersion ?? (async () => {
		const [{ VERSION }, { resolveCommitHash }] = await Promise.all([import("./version-1fmuKOza.js"), import("./git-commit-Clzswdut.js")]);
		return {
			VERSION,
			resolveCommitHash
		};
...
function tryHandleRootHelpFastPath(argv, deps = {}) {
	...
	import("./root-help-metadata-D-aO_vLu.js").then(async ({ outputPrecomputedRootHelpText }) => {
...
function runMainOrRootHelp(argv) {
	...
	import("./run-main-B5mzap5z.js").then(({ runCli }) => runCli(argv)).catch((error) => {
