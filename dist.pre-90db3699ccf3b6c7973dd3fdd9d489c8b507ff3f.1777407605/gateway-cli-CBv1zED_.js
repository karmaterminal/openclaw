...
import { _ as shortenHomePath, m as resolveUserPath } from "./utils-CB8xp0O4.js";
import { r as setVerbose } from "./global-state-CGb9JSDC.js";
import { n as defaultRuntime } from "./runtime-Dy0KdPiM.js";
import { d as setConsoleTimestampPrefix, t as createSubsystemLogger, u as setConsoleSubsystemFilter } from "./subsystem-CJBoMDt5.js";
...
import { _ as resolveStateDir, t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-D92DjaZ-.js";
import { d as resolveGatewayLaunchAgentLabel, m as resolveGatewayWindowsTaskName, p as resolveGatewaySystemdServiceName } from "./paths-CJrJgeHo.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-BZ6RGKR0.js";
import "./globals-Bo8QPRgM.js";
import { n as isContainerEnvironment, t as defaultGatewayBindMode } from "./net-B-vYkUV_.js";
import "./auth-DFx0epA_.js";
import { n as resolveGatewayAuth } from "./auth-resolve-BsgRpY-H.js";
import { a as loadConfig, g as recoverConfigFromLastKnownGood, h as recoverConfigFromJsonRootSuffix, l as readBestEffortConfig, r as createConfigIO, u as readConfigFileSnapshot, y as writeConfigFile } from "./io-CBRjt33P.js";
import { b as resolveWorkspaceTemplateDir, v as resolveDefaultAgentWorkspaceDir } from "./workspace-DGJIk8rw.js";
import { t as cleanStaleGatewayProcessesSync } from "./restart-stale-pids-BUk5aJLm.js";
import { a as inspectPortUsage, s as formatPortDiagnostics } from "./ports-BJMmG7hC.js";
import { r as resolveGatewayService } from "./service-kQkBLBlg.js";
import { t as parsePort } from "./parse-port-kkHQleC9.js";
import "./config-BjiV0z87.js";
import { g as GATEWAY_CLIENT_NAMES, h as GATEWAY_CLIENT_MODES } from "./message-channel-Bk_YHfQg.js";
import { a as getActiveTaskCount, c as markGatewayDraining, d as waitForActiveTasks, l as resetAllLanes } from "./command-queue-CGrlxFYE.js";
import { r as callGateway } from "./call-DsaRhCZc.js";
import { f as writeRestartSentinel } from "./restart-sentinel-ZznJ7MqL.js";
import { a as markGatewaySigusr1RestartHandled, i as isGatewaySigusr1RestartExternallyAllowed, l as triggerOpenClawRestart, o as scheduleGatewaySigusr1Restart, t as consumeGatewaySigusr1RestartAuthorization } from "./restart-BcbTn2CL.js";
import { d as waitForActiveEmbeddedRuns, r as getActiveEmbeddedRunCount, t as abortEmbeddedPiRun } from "./runs-BbW2coSD.js";
import { _ as selectDiagnosticStabilitySnapshot, f as writeDiagnosticStabilityBundleForFailureSync, h as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-bundle-Ca_aoqgv.js";
import { n as parseTimeoutMsWithFallback } from "./parse-timeout-0v0tZDOC.js";
import { n as withProgress } from "./progress-o8N85mqG.js";
import { n as runCommandWithRuntime } from "./cli-utils-wqlE-Cte.js";
import { n as setGatewayWsLogStyle } from "./ws-logging-CWylsNAr.js";
import { t as formatHelpExamples } from "./help-format-oS7J2-Gq.js";
import { t as readSecretFromFile } from "./secret-file-DDO8STQQ.js";
import { n as buildGatewayDiscoveryTarget } from "./gateway-discovery-targets-BbB_QISP.js";
import { o as resolveControlUiRootSync } from "./control-ui-assets-C3-Vx8d1.js";
import { n as acquireGatewayLock, t as GatewayLockError } from "./gateway-lock-Bw8_JfuR.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-D1KH0AF7.js";
import { o as handleReset } from "./onboard-helpers-Dourk4Vm.js";
...
async function runGatewayCommand$1(opts) {
	...
	const { startGatewayServer } = await startupTrace.measure("cli.server-import", () => withProgress({
		...
		indeterminate: true
	}, async () => import("./server-CS9yAMJM.js")));
...
function loadConfigModule() {
	configModulePromise ??= import("./read-best-effort-config.runtime-wN9zR308.js");
	return configModulePromise;
}
function loadGatewayStatusModule() {
	gatewayStatusModulePromise ??= import("./gateway-status-BlTxx9B9.js");
	return gatewayStatusModulePromise;
}
function loadGatewayHealthModule() {
	gatewayHealthModulePromise ??= import("./health-DbOhNdBd.js");
	return gatewayHealthModulePromise;
}
function loadBonjourDiscoveryModule() {
	bonjourDiscoveryModulePromise ??= import("./bonjour-discovery-DUCFzvmy.js");
	return bonjourDiscoveryModulePromise;
}
function loadWideAreaDnsModule() {
	wideAreaDnsModulePromise ??= import("./widearea-dns-DoQyzc-D.js");
	return wideAreaDnsModulePromise;
}
function loadHealthStyleModule() {
	healthStyleModulePromise ??= import("./health-style-C8aSH55w.js");
...
function loadStabilityBundleModule() {
	stabilityBundleModulePromise ??= import("./diagnostic-stability-bundle-DHMAJNi0.js");
	return stabilityBundleModulePromise;
}
function loadSupportExportModule() {
	supportExportModulePromise ??= import("./diagnostic-support-export-B0Zay9pL.js");
	return supportExportModulePromise;
}
function loadDaemonStatusGatherModule() {
	daemonStatusGatherModulePromise ??= import("./status.gather-Bguj4xsZ.js");
