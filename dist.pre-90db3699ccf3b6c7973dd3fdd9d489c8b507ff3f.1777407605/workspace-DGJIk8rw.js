import { f as readStringValue, s as normalizeOptionalLowercaseString } from "./string-coerce-CjxCKZ6B.js";
...
async function resolveWorkspaceBootstrapStatus(dir) {
	...
	return await fileExists(path.join(resolvedDir, "BOOTSTRAP.md")) ? "pending" : "complete";
}
...
//#endregion
export { loadWorkspaceBootstrapFiles as _, DEFAULT_IDENTITY_FILENAME as a, resolveWorkspaceTemplateDir as b, DEFAULT_SOUL_FILENAME as c, ensureAgentWorkspace as d, filterBootstrapFilesForSession as f, loadExtraBootstrapFilesWithDiagnostics as g, loadExtraBootstrapFiles as h, DEFAULT_HEARTBEAT_FILENAME as i, DEFAULT_TOOLS_FILENAME as l, isWorkspaceSetupCompleted as m, DEFAULT_AGENT_WORKSPACE_DIR as n, DEFAULT_MEMORY_ALT_FILENAME as o, isWorkspaceBootstrapPending as p, DEFAULT_BOOTSTRAP_FILENAME as r, DEFAULT_MEMORY_FILENAME as s, DEFAULT_AGENTS_FILENAME as t, DEFAULT_USER_FILENAME as u, resolveDefaultAgentWorkspaceDir as v, resolveWorkspaceBootstrapStatus as y };
