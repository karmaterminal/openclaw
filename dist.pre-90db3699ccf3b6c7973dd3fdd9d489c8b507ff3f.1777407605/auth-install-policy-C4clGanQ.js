...
import { t as collectDurableServiceEnvVars } from "./state-dir-dotenv-BBZenLZD.js";
import { d as resolveGatewayLaunchAgentLabel } from "./paths-CJrJgeHo.js";
import { i as resolveGatewayProgramArguments, n as resolveDaemonInstallRuntimeInputs, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-C-zyu1EB.js";
import { c as buildServiceEnvironment } from "./runtime-paths-BOtHrzgd.js";
...
function loadDaemonInstallAuthProfileSourceRuntime() {
	daemonInstallAuthProfileSourceRuntimePromise ??= import("./daemon-install-auth-profiles-source.runtime-DuzDADKr.js");
	return daemonInstallAuthProfileSourceRuntimePromise;
}
function loadDaemonInstallAuthProfileStoreRuntime() {
	daemonInstallAuthProfileStoreRuntimePromise ??= import("./daemon-install-auth-profiles-store.runtime-DJPW7VV2.js");
