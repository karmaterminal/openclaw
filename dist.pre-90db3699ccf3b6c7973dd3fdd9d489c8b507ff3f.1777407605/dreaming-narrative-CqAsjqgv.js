import { c as readErrorName, i as formatErrorMessage, r as extractErrorCode } from "./errors-CS5wW5eD.js";
...
import { t as createAsyncLock } from "./json-files-DcOQMqKi.js";
...
async function generateAndAppendDreamNarrative(params) {
	...
	try {
		...
		if (params.subagent && runId && waitStatus === "timeout") try {
