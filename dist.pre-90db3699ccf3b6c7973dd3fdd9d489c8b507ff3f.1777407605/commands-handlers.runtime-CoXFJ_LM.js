...
import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, i as normalizeFastMode, s as normalizeOptionalLowercaseString } from "./string-coerce-CjxCKZ6B.js";
import { m as resolveUserPath, r as clampInt } from "./utils-CB8xp0O4.js";
...
import { a as clearPluginManifestRegistryCache } from "./manifest-registry-_hxKCS2K.js";
import { F as getConfigValueAtPath, I as parseConfigPath, L as setConfigValueAtPath, M as resetConfigOverrides, N as setConfigOverride, P as unsetConfigOverride, R as unsetConfigValueAtPath, T as validateConfigObjectWithPlugins, j as getConfigOverrides, u as readConfigFileSnapshot, y as writeConfigFile } from "./io-CBRjt33P.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-Cn2QoOyX.js";
import { r as normalizeOptionalAccountId } from "./account-id-BM1T6029.js";
import { o as normalizeChannelId } from "./registry-CGsqKAN1.js";
import { i as normalizeChannelId$1, t as getChannelPlugin } from "./registry-CaUS2Z2d.js";
import { b as resolveAgentWorkspaceDir, p as resolveSessionAgentId, y as resolveAgentDir } from "./agent-scope-D-T17Rdc.js";
import { t as parseDurationMs } from "./parse-duration-CKmCMtsX.js";
import { r as isRestartEnabled, t as isCommandFlagEnabled } from "./commands.flags-D8n75DQv.js";
import "./config-BjiV0z87.js";
import { g as GATEWAY_CLIENT_NAMES, h as GATEWAY_CLIENT_MODES, r as isInternalMessageChannel, u as normalizeMessageChannel } from "./message-channel-Bk_YHfQg.js";
import { n as resolveChannelApprovalCapability } from "./plugins-BcqWcAy9.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-CpgiJgbB.js";
import { x as prepareProviderRuntimeAuth } from "./provider-runtime-C-l-2kdJ.js";
import { n as ensureOpenClawModelsJson } from "./models-config-DXUZyX32.js";
import { h as resolveResponseUsageMode, p as normalizeUsageDisplay } from "./thinking-Bh-7MqXz.js";
...
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, r as resolveDefaultSessionStorePath } from "./paths-D6msg0S1.js";
...
import { i as formatUsd, r as formatTokenCount } from "./usage-format-CFG0b3V-.js";
import { n as stripInboundMetadata } from "./strip-inbound-meta-CmdyYDK1.js";
import { t as diagnosticLogger } from "./diagnostic-runtime-B2TJHvYc.js";
import { n as redactSupportString } from "./diagnostic-support-redaction-2mb8sNkS.js";
import { a as safeTrajectorySessionFileName, i as resolveTrajectoryPointerFilePath, l as sanitizeDiagnosticPayload, r as resolveTrajectoryFilePath, s as safeJsonStringify, t as TRAJECTORY_RUNTIME_FILE_MAX_BYTES } from "./runtime-C66Tw-2E.js";
import { S as setTtsProvider, _ as setLastTtsAttempt, a as getTtsMaxLength, b as setTtsEnabled, c as isTtsEnabled, h as resolveTtsPrefsPath, i as getResolvedSpeechProviderConfig, l as isTtsProviderConfigured, m as resolveTtsConfig, o as getTtsProvider, r as getLastTtsAttempt, s as isSummarizationEnabled, v as setSummarizationEnabled, w as textToSpeech, x as setTtsMaxLength } from "./tts-CWnNX49f.js";
import { a as stripToolResultDetails } from "./session-transcript-repair-CCTG_cJr.js";
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-D3YMWmaU.js";
import { S as resolveBootstrapMaxChars, w as resolveBootstrapTotalMaxChars } from "./pi-embedded-helpers-BrjvE3y6.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-C1n8qP4Z.js";
import { i as resolveImageSanitizationLimits, n as sanitizeImageBlocks } from "./tool-images-6H3qxotJ.js";
...
import { i as unsetConfiguredMcpServer, r as setConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-DHdbhYLz.js";
...
import { l as triggerOpenClawRestart, o as scheduleGatewaySigusr1Restart } from "./restart-BcbTn2CL.js";
import { i as resolveReplyToMode } from "./reply-threading-S29pX9Jx.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-Ous3qGdi.js";
...
import { h as replyRunRegistry, i as getActiveEmbeddedRunSnapshot } from "./runs-BbW2coSD.js";
import "./diagnostic-CLYAjMPL.js";
import { t as formatDurationCompact } from "./format-duration-DyLpmhiM.js";
import { O as getFinishedSession, k as getSession } from "./bash-tools.exec-runtime-yUwpemL9.js";
import "./sandbox-CJSotrdf.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-DJQNRpPn.js";
import { n as estimateTokensFromChars } from "./cjk-chars-DQosqDHX.js";
...
import { i as matchPluginCommand, n as executePluginCommand } from "./commands-BwMa6V9t.js";
import { t as isApprovalNotFoundError } from "./approval-errors-uad_Azi5.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-NmA5MFOg.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-cqGFEGHq.js";
import "./commands-registry-x2AHOYwB.js";
import { n as formatTimeAgo } from "./format-relative-BUaZvtg2.js";
import { o as stripMentions, s as stripStructuralPrefixes } from "./mentions-C4SCO0eQ.js";
import { n as setChannelConversationBindingMaxAgeBySessionKey, t as setChannelConversationBindingIdleTimeoutBySessionKey } from "./conversation-bindings-BrUcB-J1.js";
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-0WlWJwl7.js";
import { i as installPluginFromPath, r as installPluginFromNpmSpec } from "./install-Oj5ePV_c.js";
import { l as resolveArchiveKind } from "./archive-DcFYBex5.js";
import { n as isImplicitSameChatApprovalAuthorization } from "./approval-auth-helpers-e5L44gUV.js";
import { n as parseActivationCommand } from "./group-activation-D2jH_N0s.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-XTZJsspt.js";
import { t as resolveFastModeState } from "./fast-mode-0NckV-km.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-Dh6FerW0.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-DpqsGvmI.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-CZGMIpGW.js";
import { a as shouldPersistAbortCutoff, i as resolveAbortCutoffFromContext, t as applyAbortCutoffToSessionEntry } from "./abort-cutoff-DdU8BehR.js";
...
import { n as resolveSessionEntryForKey, r as stopSubagentsForRequester, t as formatAbortReplyText } from "./abort-Cv6ek-gD.js";
import { t as extractBtwQuestion } from "./btw-command-DpvrPRhS.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-f4uUrcoB.js";
...
import { a as requireGatewayClientScopeForInternalChannel, i as requireCommandFlagEnabled, n as rejectNonOwnerCommand, r as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates-BbbTDXTE.js";
import { t as handleAcpCommand } from "./commands-acp-Bf94M-m7.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-D_GupQz7.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-CifzhBU3.js";
import { a as resolveConfigWriteDeniedText, o as resolveConfigWriteTargetFromPath, r as handleModelsCommand } from "./commands-models-CtGL83V3.js";
import { n as resolveCommandSurfaceChannel, t as resolveChannelAccountId } from "./channel-context-yU_lHjCl.js";
import { n as setPluginEnabledInConfig } from "./enable-Bm0sLHVk.js";
import { r as createExecTool } from "./bash-tools-v4Hmiitr.js";
import { n as listTasksForAgentIdForStatus, r as listTasksForSessionKeyForStatus } from "./status-text-xAvPDGBR.js";
import { f as resolveSubagentsAction, l as resolveHandledPrefix, p as stopWithText, u as resolveRequesterSessionKey } from "./shared-C0pYo-28.js";
import { t as buildToolsMessage } from "./status-B2WQeQ-S.js";
import { t as parseConfigValue } from "./config-value-DT-5-UKR.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-DNmjjSYl.js";
import { a as writeSupportBundleDirectory, i as textSupportBundleFile, n as jsonlSupportBundleFile, r as supportBundleContents, t as jsonSupportBundleFile } from "./diagnostic-support-bundle-CWgEyr6e.js";
import { t as buildStatusReply } from "./commands-status-BVGGNFdO.js";
import { i as buildNpmInstallRecordFields, n as persistPluginInstall } from "./plugins-install-persist-BDpTSGAn.js";
import { m as parseClawHubPluginSpec } from "./clawhub-RXpU01PU.js";
import { r as installPluginFromClawHub } from "./clawhub-BhAC4gt7.js";
import { a as buildPluginDiagnosticsReport, c as formatPluginCompatibilityNotice, o as buildPluginInspectReport, s as buildPluginSnapshotReport, t as buildAllPluginInspectReports } from "./status-B5JGqXul.js";
import { a as decidePreferredClawHubFallback, i as createPluginInstallLogger, n as buildPreferredClawHubSpec, u as resolveFileNpmSpecToLocalPath } from "./plugins-command-helpers-D4Fg0mYE.js";
import { n as loadCostUsageSummary, r as loadSessionCostSummary } from "./session-cost-usage-C919LdFZ.js";
...
async function handleBashChatCommand(params) {
	...
	if (request.action === "stop") {
		...
		const { killProcessTree } = await import("./kill-tree-BCVl-PNk.js");
		killProcessTree(pid);
...
function loadCompactRuntime() {
	compactRuntimePromise ??= import("./commands-compact.runtime-B4dLkCTZ.js");
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-Dghdv2Wx.js");
...
function exportTrajectoryBundle(params) {
	...
	const header = sessionManager.getHeader();
	const leafId = sessionManager.getLeafId();
	const branchEntries = sessionManager.getBranch(leafId ?? void 0);
...
function parseExportTrajectoryArgs(commandBodyNormalized) {
	const normalized = commandBodyNormalized.trim();
	if (normalized === "/export-trajectory" || normalized === "/trajectory") return {};
	return { outputPath: normalized.replace(/^\/(export-trajectory|trajectory)\s*/, "").trim().split(/\s+/).find((part) => !part.startsWith("-")) };
}
...
async function abortEmbeddedPiRunForSession(sessionId) {
	const { abortEmbeddedPiRun } = await import("./runs-Bj-n2ytF.js");
...
function loadAgentsAction() {
	actionAgentsPromise ??= import("./action-agents-CAJ05D6T.js");
	return actionAgentsPromise;
}
function loadFocusAction() {
	actionFocusPromise ??= import("./action-focus-mNCR1s2C.js");
	return actionFocusPromise;
}
function loadHelpAction() {
	actionHelpPromise ??= import("./action-help-CrDDHxkh.js");
	return actionHelpPromise;
}
function loadInfoAction() {
	actionInfoPromise ??= import("./action-info-DCMql_xC.js");
	return actionInfoPromise;
}
function loadKillAction() {
	actionKillPromise ??= import("./action-kill-BDJfGyfC.js");
	return actionKillPromise;
}
function loadListAction() {
	actionListPromise ??= import("./action-list-CtUnGGXO.js");
	return actionListPromise;
}
function loadLogAction() {
	actionLogPromise ??= import("./action-log-nXRmPsfv.js");
	return actionLogPromise;
}
function loadSendAction() {
	actionSendPromise ??= import("./action-send-1FEwOxr8.js");
	return actionSendPromise;
}
function loadSpawnAction() {
	actionSpawnPromise ??= import("./action-spawn-PzqcftGi.js");
	return actionSpawnPromise;
}
function loadUnfocusAction() {
	actionUnfocusPromise ??= import("./action-unfocus-BL-3krSd.js");
	return actionUnfocusPromise;
}
function loadControlRuntime() {
	controlRuntimePromise ??= import("./commands-subagents-control.runtime-BC1yMir5.js");
