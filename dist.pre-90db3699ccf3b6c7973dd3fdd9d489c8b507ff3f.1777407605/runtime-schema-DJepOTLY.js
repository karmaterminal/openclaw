...
import { t as CHANNEL_IDS } from "./ids-BPsM98Uu.js";
import { t as loadPluginManifestRegistry } from "./manifest-registry-_hxKCS2K.js";
import { D as collectPluginSchemaMetadata, E as collectChannelSchemaMetadata, O as GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA, a as loadConfig, u as readConfigFileSnapshot } from "./io-CBRjt33P.js";
import { b as resolveAgentWorkspaceDir, x as resolveDefaultAgentId } from "./agent-scope-D-T17Rdc.js";
import "./config-BjiV0z87.js";
import { a as applySensitiveUrlHints, i as applySensitiveHints, o as applyDerivedTags } from "./redact-snapshot-BakPiQfA.js";
					...
					defaults: {
						...
						properties: {
							...
							embeddedHarness: {
								...
								properties: {
									...
									fallback: {
										...
										description: "Embedded harness fallback when no plugin harness matches. Selected plugin harness failures surface directly. Set none to disable automatic PI fallback."
									}
								},
								additionalProperties: false,
							...
							continuation: {
								...
								properties: {
									enabled: { type: "boolean" },
									taskFlowDelegates: { type: "boolean" },
									defaultDelayMs: {
										type: "integer",
										exclusiveMinimum: 0,
										maximum: 9007199254740991
						...
						items: {
							...
							properties: {
								...
								embeddedHarness: {
									...
									description: "Per-agent embedded harness policy override. Use fallback=none to make missing plugin harness selection fail instead of falling back to PI."
								},
								model: { anyOf: [{ type: "string" }, {
									type: "object",
									properties: {
			...
			commands: {
				...
				properties: {
					...
					modelsWrite: {
						...
						description: "Allow model-management write commands such as `/models add` to register provider/model entries directly into config and make them available without restarting the gateway (default: true)."
					},
					bash: {
						type: "boolean",
