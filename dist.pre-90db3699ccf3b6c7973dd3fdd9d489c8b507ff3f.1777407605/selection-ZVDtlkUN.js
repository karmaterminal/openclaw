...
import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, f as readStringValue, s as normalizeOptionalLowercaseString } from "./string-coerce-CjxCKZ6B.js";
import { g as shortenHomeInString, m as resolveUserPath } from "./utils-CB8xp0O4.js";
...
import { n as resolveOwnerDisplaySetting } from "./owner-display-BU1_ItQ7.js";
import { t as loadPluginManifestRegistry } from "./manifest-registry-_hxKCS2K.js";
import { X as normalizeGoogleApiBaseUrl } from "./io-CBRjt33P.js";
import { r as normalizeProviderId } from "./provider-id-ZTkpwCTd.js";
import { _ as isAcpSessionKey, b as isSubagentSessionKey, c as normalizeAgentId, y as isCronSessionKey } from "./session-key-Cn2QoOyX.js";
import "./defaults-BofKZKJ4.js";
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-2AJ1WJ1n.js";
import { p as isWorkspaceBootstrapPending, r as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-DGJIk8rw.js";
import { h as listAgentEntries, m as resolveSessionAgentIds } from "./agent-scope-D-T17Rdc.js";
import { u as normalizeMessageChannel } from "./message-channel-Bk_YHfQg.js";
import { i as createStreamIteratorWrapper, r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-BZ7rmS3q.js";
import { d as listRegisteredAgentHarnesses } from "./loader-708jrx4Y.js";
import { s as joinPresentTextSegments, t as getGlobalHookRunner } from "./hook-runner-global-DuCZiaZE.js";
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-Cym-fqI8.js";
import { F as resolveProviderSystemPromptContribution, I as resolveProviderTextTransforms, q as transformProviderSystemPrompt } from "./provider-runtime-C-l-2kdJ.js";
...
import { a as resolveToolCallArgumentsEncoding } from "./provider-model-compat-CFqcq0it.js";
import { n as acquireSessionWriteLock, o as resolveSessionLockMaxHoldFromTimeout } from "./session-write-lock-3uPK7XQA.js";
import { n as sleepWithAbort } from "./backoff-CLV-C1Ec.js";
import { a as normalizeUsage, i as makeZeroUsageSnapshot, r as hasNonzeroUsage, t as derivePromptTokens } from "./usage-B1cMBf1I.js";
import { o as parseAssistantTextSignature, s as resolveAssistantMessagePhase } from "./chat-message-content-BqgwRnGh.js";
import { t as parseInlineDirectives } from "./directive-tags-Bb9KtDtd.js";
import { i as enqueueCommandInLane, o as getQueueSize } from "./command-queue-CGrlxFYE.js";
import { n as resolveEmbeddedAgentHarnessFallback, r as resolveEmbeddedAgentRuntime, t as normalizeEmbeddedAgentRuntime } from "./runtime-CtT-vmah.js";
import { a as isSilentReplyText, c as stripLeadingSilentToken, i as isSilentReplyPrefixText, o as startsWithSilentToken, r as isSilentReplyPayloadText } from "./tokens-CYuOTnyM.js";
import { $ as createBundleLspToolRuntime, B as shouldAllowProviderOwnedThinkingReplay, C as buildEmbeddedMessageActionDiscoveryInput, D as SAFETY_MARGIN, E as buildEmbeddedExtensionFactories, H as estimateToolResultReductionPotential, I as resolveCompactionTimeoutMs, J as installToolResultContextGuard, K as truncateOversizedToolResultsInSessionManager, L as isCacheTtlEligibleProvider, O as estimateMessagesTokens, P as applyFinalEffectiveToolPolicy, Q as dropThinkingBlocks, R as readLastCacheTtlTimestamp, S as validateReplayTurns, T as limitHistoryTurns, U as resolveLiveToolResultMaxChars, V as guardSessionManager, X as createPreparedEmbeddedPiSettingsManager, Y as repairSessionFileIfNeeded, Z as assessLastAssistantMessage, _ as resolveEmbeddedRunSkillEntries, a as splitSdkTools, b as normalizeAssistantReplayContent, c as collectRegisteredToolNames, d as buildEmbeddedSystemPrompt, et as releaseWsSession, f as createSystemPromptOverride, g as resolveEmbeddedAgentStreamFn, h as resolveEmbeddedAgentBaseStreamFn, i as mapThinkingLevel, it as filterHeartbeatPairs, l as toSessionToolAllowlist, m as resolveEmbeddedAgentApiKey, o as PI_RESERVED_TOOL_NAMES, p as describeEmbeddedAgentStreamStrategy, q as installContextEngineLoopHook, r as flushPendingToolResultsAfterIdle, rt as resolveChannelCapabilities, s as collectAllowedToolNames, t as buildEmbeddedCompactionRuntimeContext, tt as buildStreamErrorAssistantMessage, u as applySystemPromptOverrideToSession, v as prewarmSessionFile, w as getDmHistoryLimitFromSessionKey, x as sanitizeSessionHistory, y as trackSessionManagerAccess, z as resolveTranscriptPolicy } from "./compaction-runtime-context-BXR92FQ8.js";
import { i as findActiveSessionTask, n as buildActiveVideoGenerationTaskPromptContextForSession, r as buildActiveMusicGenerationTaskPromptContextForSession, v as isStrictAgenticSupportedProviderModel, y as isEmbeddedMode } from "./openclaw-tools-BM64FZFo.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-Bi99g3ud.js";
import { t as getMachineDisplayName } from "./machine-name-D_yx7Swp.js";
import { f as MAX_IMAGE_BYTES } from "./mime-Dx8S3QoZ.js";
import { p as normalizeToolName } from "./tool-policy-4C90huEY.js";
import { n as getPluginToolMeta } from "./tools-CjyAaC4m.js";
import { t as redactConfigObject } from "./redact-snapshot-BakPiQfA.js";
import { n as resolveCommitHash } from "./git-commit-DwURkKG0.js";
import { t as resolveOsSummary } from "./os-summary-D207jVCA.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-2mb8sNkS.js";
import { c as getQueuedFileWriter, l as sanitizeDiagnosticPayload, n as createTrajectoryRuntimeRecorder, o as toTrajectoryToolDefinitions, s as safeJsonStringify } from "./runtime-C66Tw-2E.js";
import { t as parseBooleanValue } from "./boolean-DpHj__Gl.js";
import { n as buildTtsSystemPromptHint } from "./tts-CWnNX49f.js";
import { i as sanitizeToolUseResultPairing, o as isReasoningTagProvider } from "./session-transcript-repair-CCTG_cJr.js";
import { a as prependBootstrapPromptWarning, i as buildBootstrapTruncationReportMeta, n as buildBootstrapInjectionStats, r as buildBootstrapPromptWarning, t as analyzeBootstrapBudget } from "./bootstrap-budget-D3YMWmaU.js";
import { a as resolveContextInjectionMode, i as resolveBootstrapContextForRun, n as hasCompletedBootstrapTurn, o as resolveHeartbeatPromptForSystemPrompt, r as makeBootstrapWarn, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-DpyOQK-6.js";
import { C as resolveBootstrapPromptTruncationWarningMode, S as resolveBootstrapMaxChars, _ as downgradeOpenAIFunctionCallReasoningPairs, a as isMessagingToolDuplicateNormalized, c as extractToolCallsFromAssistant, n as validateGeminiTurns, o as normalizeTextForComparison, p as hasUnredactedSessionsSpawnAttachments, t as validateAnthropicTurns, u as sanitizeToolCallIdsForCloudCodeAssist, v as downgradeOpenAIReasoningBlocks, w as resolveBootstrapTotalMaxChars } from "./pi-embedded-helpers-BrjvE3y6.js";
import { d as stableStringify$1, g as coerceChatContentText, k as parseExecApprovalResultText } from "./sanitize-user-facing-text-Bzewcv8R.js";
import { a as formatAssistantErrorText, c as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-Bd1ET-5C.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-C1n8qP4Z.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-6H3qxotJ.js";
import { a as listChannelSupportedActions, c as resolveChannelReactionGuidance, o as resolveChannelMessageToolCapabilities, s as resolveChannelMessageToolHints } from "./channel-tools-VnD0W0uJ.js";
import { t as resolveOpenClawDocsPath } from "./docs-path-CqIJn-5e.js";
import { a as isTimeoutError } from "./failover-error-Bly4bj4L.js";
import { t as buildModelAliasLines } from "./model-alias-lines-KXflBdS2.js";
import { t as sanitizeForConsole } from "./console-sanitize-B0gsXsnR.js";
import { c as resolveModelAuthMode } from "./model-auth-CnLreLvU.js";
import { a as shouldUseOpenAIWebSocketTransport, i as shouldPersistCompletedBootstrapTurn, l as supportsModelTools, n as composeSystemPromptWithHookContext, o as logProviderToolSchemaDiagnostics, r as resolveAttemptSpawnWorkspaceDir, s as normalizeProviderToolSchemas, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-C-SEPR1D.js";
import { t as registerProviderStreamForModel } from "./provider-stream-BUlKLyKX.js";
import { t as log$3 } from "./logger-Blw-ywDf.js";
import { i as stripSystemPromptCacheBoundary, n as prependSystemPromptAdditionAfterCacheBoundary } from "./system-prompt-cache-boundary-Cp6VbLcK.js";
import { c as sanitizeTransportPayloadText, o as mergeTransportHeaders, u as buildGuardedModelFetch } from "./transport-stream-shared-D5utzL5u.js";
import { r as getOrCreateSessionMcpRuntime } from "./pi-bundle-mcp-runtime-DAdkA6n_.js";
import { n as materializeBundleMcpToolsForRun } from "./pi-bundle-mcp-tools-BvqwOlsx.js";
import { n as setReplyPayloadMetadata } from "./reply-payload-hIkyznVT.js";
import { r as parseFenceSpans } from "./fences-uiK3_9qC.js";
import { r as splitMediaFromOutput } from "./parse-BJwsv_sk.js";
import { l as parseReplyDirectives } from "./payloads-nIfLjbWq.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-Bp4halqE.js";
import { r as resolveToolDisplay } from "./tool-display-CJs_BEAF.js";
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent } from "./agent-events-CN4p9Z8t.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-Duec1JC0.js";
import { o as buildApiErrorObservationFields, s as buildTextObservationFields } from "./model-fallback-CE1uOaB3.js";
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-CcZ3Jy4P.js";
import { a as stripDowngradedToolCallText } from "./assistant-visible-text-BAXvhm6N.js";
...
import { a as extractToolResultText, c as isToolResultTimedOut, d as isMessagingToolSendAction, i as extractToolResultMediaArtifact, l as sanitizeToolResult, n as extractMessagingToolSend, o as filterToolResultMediaUrls, r as extractToolErrorMessage, s as isToolResultError, t as buildEmbeddedAttemptToolRunContext, u as isMessagingTool } from "./attempt.tool-run-context-Dql1RKPg.js";
import { a as MIN_PROMPT_BUDGET_TOKENS, i as MIN_PROMPT_BUDGET_RATIO, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-BxFx5D3x.js";
import { i as toClientToolDefinitions, n as findClientToolNameConflicts, t as createClientToolNameConflictError } from "./pi-tool-definition-adapter-DfZwyV03.js";
import { n as resolveToolLoopDetectionConfig, t as createOpenClawCodingTools } from "./pi-tools-C1RI3cQK.js";
import { c as resolveEffectiveToolFsWorkspaceOnly } from "./local-roots-DDn7G0b_.js";
import { n as ensureGlobalUndiciEnvProxyDispatcher, r as ensureGlobalUndiciStreamTimeouts } from "./undici-global-dispatcher-CFDovg4g.js";
import { a as recordTaskRunProgressByRunId, i as failTaskRunByRunId, n as createQueuedTaskRun, o as setDetachedTaskDeliveryStatusByRunId, s as startTaskRunByRunId, t as completeTaskRunByRunId } from "./detached-task-runtime-Cwd30X8h.js";
import { u as resolveSessionLane } from "./queue-Bsh8rsUi.js";
import { l as setActiveEmbeddedRun, n as clearActiveEmbeddedRun, u as updateActiveEmbeddedRunSnapshot } from "./runs-BbW2coSD.js";
import { c as updateTaskNotifyPolicyForOwner, i as findTaskByRunIdForOwner, n as cancelTaskByIdForOwner } from "./task-owner-access-CjeErtyj.js";
import { t as resolveAgentTimeoutMs } from "./timeout-htOXkzfH.js";
import { s as resolveSkillsPromptForRun } from "./workspace-DEVw-slo.js";
import { t as detectRuntimeShell } from "./shell-utils-Awwl_Ipu.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-DhHqBQHP.js";
import "./skills-C5C1PDgi.js";
import { o as resolveSandboxContext } from "./sandbox-CJSotrdf.js";
import { n as rewriteTranscriptEntriesInSessionManager, t as rewriteTranscriptEntriesInSessionFile } from "./transcript-rewrite-DLFL__mi.js";
import { t as resolveSystemPromptOverride } from "./system-prompt-override-BcvtLr-1.js";
import { t as buildSystemPromptParams } from "./system-prompt-params-BUiXYbio.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-DJQNRpPn.js";
import "./tool-loop-detection-CRPrqVZ_.js";
import { i as createHtmlEntityToolCallArgumentDecodingWrapper, y as visitObjectContentBlocks } from "./provider-stream-shared-CtbEGrd3.js";
import { a as resolveCacheRetention, i as isGooglePromptCacheEligible, n as resolveAgentTransportOverride, t as applyExtraParamsToAgent } from "./extra-params-XxqPm0T2.js";
import { n as buildAgentUserPromptPrefix } from "./system-prompt-x8IUEag3.js";
...
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-CJW1k-8d.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-Dw_VCPli.js";
import { t as detectAndLoadPromptImages } from "./images-DO8QSUDD.js";
...
function resolveIncompleteTurnPayloadText(params) {
	...
	if (params.attempt.didSendViaMessagingTool && stopReason === "stop") return null;
...
async function reconcileSessionStoreCompactionCountAfterSuccess(params) {
	const { reconcileSessionStoreCompactionCountAfterSuccess: reconcile } = await import("./pi-embedded-subscribe.handlers.compaction.runtime-DSye8bsF.js");
...
function loadExecApprovalReply() {
	execApprovalReplyModulePromise ??= import("./exec-approval-reply-DmsvzttV.js");
	return execApprovalReplyModulePromise;
}
function loadHookRunnerGlobal() {
	hookRunnerGlobalModulePromise ??= import("./hook-runner-global-CxgQsGwp.js");
	return hookRunnerGlobalModulePromise;
}
function loadMediaParse() {
	mediaParseModulePromise ??= import("./parse-CTvzSQVH.js");
	return mediaParseModulePromise;
}
function loadBeforeToolCall() {
	beforeToolCallModulePromise ??= import("./pi-tools.before-tool-call-C4nlsSGB.js");
...
//#endregion
export { resolveReplayInvalidFlag as _, resolveBootstrapMode as a, observeReplayMetadata as b, STRICT_AGENTIC_BLOCKED_TEXT as c, resolveAckExecutionFastPathInstruction as d, resolveEmptyResponseRetryInstruction as f, resolveReasoningOnlyRetryInstruction as g, resolvePlanningOnlyRetryLimit as h, selectAgentHarness as i, extractPlanningOnlyPlanDetails as l, resolvePlanningOnlyRetryInstruction as m, resolveAgentHarnessPolicy as n, prepareSessionManagerForRun as o, resolveIncompleteTurnPayloadText as p, runAgentHarnessAttemptWithFallback as r, runContextEngineMaintenance as s, maybeCompactAgentHarnessSession as t, isLikelyExecutionAckPrompt as u, resolveRunLivenessState as v, formatToolAggregate as x, createEmbeddedRunReplayState as y };
