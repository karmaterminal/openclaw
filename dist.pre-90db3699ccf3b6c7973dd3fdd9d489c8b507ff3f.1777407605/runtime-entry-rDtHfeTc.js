...
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "./webhook-request-guards-BMnk847v.js";
import "./webhook-ingress-BwLHLxph.js";
import { t as zod_exports } from "./zod-BsWnlRO5.js";
import "./api-C6UT_IS7.js";
import { a as deepMergeDefined, i as validateProviderConfig, n as normalizeVoiceCallConfig, r as resolveVoiceCallConfig } from "./config-DYtAi91o.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-D_68lIT9.js";
import { a as convertPcmToMulaw8k, t as isProviderStatusTerminal } from "./call-status-B_B-0oDk.js";
import { t as getHeader } from "./http-headers-Ct_s63Uu.js";
...
function loadRealtimeTranscriptionRuntime() {
	realtimeTranscriptionRuntimePromise ??= import("./realtime-transcription.runtime-BiEdT-xh.js");
	return realtimeTranscriptionRuntimePromise;
}
function loadResponseGeneratorModule() {
	responseGeneratorModulePromise ??= import("./response-generator-CJfapu2Y.js");
...
function loadTelnyxProvider() {
	telnyxProviderPromise ??= import("./telnyx-BwESNUlC.js");
	return telnyxProviderPromise;
}
function loadTwilioProvider() {
	twilioProviderPromise ??= import("./twilio-B6hDMJpC.js");
	return twilioProviderPromise;
}
function loadPlivoProvider() {
	plivoProviderPromise ??= import("./plivo-DyVspOzr.js");
	return plivoProviderPromise;
}
function loadMockProvider() {
	mockProviderPromise ??= import("./mock-DdRMTwLz.js");
	return mockProviderPromise;
}
function loadRealtimeVoiceRuntime() {
	realtimeVoiceRuntimePromise ??= import("./realtime-voice.runtime-DmhvHCIr.js");
	return realtimeVoiceRuntimePromise;
}
function loadRealtimeHandler() {
	realtimeHandlerPromise ??= import("./realtime-handler-BwbIitio.js");
