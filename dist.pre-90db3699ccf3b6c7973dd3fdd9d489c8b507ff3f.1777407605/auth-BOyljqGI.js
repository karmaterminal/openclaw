...
import { s as loadAuthProfileStoreForRuntime } from "./store-De_brRTx.js";
import { n as resolvePluginProviders } from "./providers.runtime-CeArq6YC.js";
import "./model-selection-cli-BCNxTSmc.js";
import { n as listProfilesForProvider, o as upsertAuthProfile } from "./profiles-DQiFenPb.js";
import { n as clearAuthProfileCooldown } from "./usage-CjcxlRTg.js";
import { n as validateAnthropicSetupToken } from "./provider-auth-token-CPtxkRrr.js";
...
import { a as loadValidConfigOrThrow, u as updateConfig } from "./shared-BBGZUNzS.js";
...
import { i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-ByRkI8zI.js";
...
async function runProviderAuthMethod(params) {
	...
	await persistProviderAuthResult({
		result: await params.method.run({
			...
			openUrl: async (url) => {
				const { openUrl } = await import("./onboard-helpers-jgWjf1UF.js");
				await openUrl(url);
			},
