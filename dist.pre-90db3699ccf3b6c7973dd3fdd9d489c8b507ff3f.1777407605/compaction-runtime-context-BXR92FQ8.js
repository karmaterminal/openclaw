...
import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, f as readStringValue, n as localeLowercasePreservingWhitespace, s as normalizeOptionalLowercaseString } from "./string-coerce-CjxCKZ6B.js";
import { n as isAbortError } from "./unhandled-rejections-1YGsKksF.js";
...
import { i as openBoundaryFileSync, r as openBoundaryFile } from "./boundary-file-read-BSd9MXPy.js";
import { t as loadPluginManifestRegistry } from "./manifest-registry-_hxKCS2K.js";
import { c as resolveEffectivePluginActivationState, o as normalizePluginsConfig } from "./config-state-COejNgwx.js";
...
import { v as resolveAgentContextLimits } from "./agent-scope-D-T17Rdc.js";
...
import { a as normalizeInputProvenance, n as applyInputProvenanceToUserMessage, r as hasInterSessionUserProvenance } from "./input-provenance-CNf_1qHV.js";
import { c as getCompactionProvider, o as listEmbeddedExtensionFactories } from "./loader-708jrx4Y.js";
import "./plugins-BcqWcAy9.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-DuCZiaZE.js";
import { $ as resolveProviderRuntimePlugin, D as resolveProviderCacheTtlEligibility, J as validateProviderReplayTurnsWithPlugin, R as resolveProviderTransportTurnStateWithPlugin, V as resolveProviderWebSocketSessionPolicyWithPlugin, W as sanitizeProviderReplayHistoryWithPlugin } from "./provider-runtime-C-l-2kdJ.js";
...
import { a as normalizeUsage, i as makeZeroUsageSnapshot } from "./usage-B1cMBf1I.js";
import { a as normalizeAssistantPhase, o as parseAssistantTextSignature, t as encodeAssistantTextSignature } from "./chat-message-content-BqgwRnGh.js";
import { o as resolveContextWindowInfo } from "./context-window-guard-BDr1-4ae.js";
import { a as isSilentReplyText } from "./tokens-CYuOTnyM.js";
import { s as stripHeartbeatToken } from "./heartbeat-DiRG9-0G.js";
import { c as mergeAlsoAllowPolicy, m as resolveToolProfilePolicy, n as applyOwnerOnlyToolPolicy } from "./tool-policy-4C90huEY.js";
import { i as setPluginToolMeta, n as getPluginToolMeta } from "./tools-CjyAaC4m.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing, n as repairToolUseResultPairing, r as sanitizeToolCallInputs, t as makeMissingToolResult } from "./session-transcript-repair-CCTG_cJr.js";
...
import { n as matchesAnyGlobPattern, t as compileGlobPatterns } from "./glob-pattern-DcRDxzEs.js";
...
import { c as mapOpenAIReasoningEffortForModel, i as createBoundaryAwareStreamFnForModel, l as resolveOpenAIStrictToolSetting, o as normalizeOpenAIStrictToolParameters, s as resolveOpenAIStrictToolFlagForInventory } from "./provider-stream-BUlKLyKX.js";
import { d as resolveDebugProxySettings, n as captureWsEvent, u as createDebugProxyWebSocketAgent } from "./runtime-nqJhayUi.js";
import { i as normalizeOpenAIReasoningEffort } from "./openai-responses-payload-policy-B9BYNN62.js";
import { t as log$3 } from "./logger-Blw-ywDf.js";
import { y as resolveOpenAITextVerbosity } from "./proxy-stream-wrappers-D9R4HswP.js";
import { c as resolveProviderRequestPolicyConfig, i as getModelProviderRequestTransport, r as buildProviderRequestTlsClientOptions } from "./provider-request-config-COmDgAeZ.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-Cp6VbLcK.js";
import { s as mergeTransportMetadata } from "./transport-stream-shared-D5utzL5u.js";
import { n as loadEnabledBundleLspConfig } from "./bundle-lsp-JUAR-tRC.js";
import { d as resolveStdioMcpServerLaunchConfig, l as loadEmbeddedPiMcpConfig, u as describeStdioMcpServerLaunchConfig } from "./pi-bundle-mcp-runtime-DAdkA6n_.js";
import { r as applyPiCompactionSettingsFromConfig } from "./pi-settings-BxFx5D3x.js";
import { a as toToolDefinitions } from "./pi-tool-definition-adapter-DfZwyV03.js";
import { a as resolveGroupToolPolicy, i as resolveGroupContextFromSessionKey, o as resolveSubagentToolPolicyForSession, r as resolveEffectiveToolPolicy } from "./read-capability-CpiE5rmu.js";
...
import { i as resolveSkillRuntimeConfig } from "./env-overrides-DhHqBQHP.js";
import "./skills-C5C1PDgi.js";
import { i as setRawSessionAppendMessage, n as rewriteTranscriptEntriesInSessionManager, r as getRawSessionAppendMessage } from "./transcript-rewrite-DLFL__mi.js";
import { i as resolveUserTimezone } from "./date-time-bQsEpkWY.js";
import { y as shouldPreserveThinkingBlocks } from "./provider-model-shared-BPfrxqlL.js";
import { S as isAnthropicModelRef, x as isAnthropicFamilyCacheTtlEligible } from "./provider-stream-shared-CtbEGrd3.js";
import { i as isGooglePromptCacheEligible } from "./extra-params-XxqPm0T2.js";
...
import { n as isQueryStopWordToken, t as extractKeywords } from "./query-expansion-7NCu_SCa.js";
import "./query-DnpIW68-.js";
import { o as wrapUntrustedPromptDataBlock, t as buildAgentSystemPrompt } from "./system-prompt-x8IUEag3.js";
import { t as estimateStringChars } from "./cjk-chars-DQosqDHX.js";
import { t as createAnthropicVertexStreamFnForModel } from "./anthropic-vertex-stream-GgEGX4Rr.js";
	...
	return (model, context, options) => {
		...
		const run = async () => {
			...
			while (true) {
				...
				if (turnInput.mode === "incremental_tool_results") log$3.debug(`[ws-stream] session=${sessionId}: incremental send (${turnInput.inputItems.length} tool results) previous_response_id=${turnInput.previousResponseId}`);
				else if (turnInput.mode === "full_context_restart") log$3.debug(`[ws-stream] session=${sessionId}: no new tool results found; sending full context without previous_response_id`);
				else log$3.debug(`[ws-stream] session=${sessionId}: full context send (${turnInput.inputItems.length} items)`);
				turnAttempt++;
...
//#endregion
export { createBundleLspToolRuntime as $, isRealConversationMessage as A, shouldAllowProviderOwnedThinkingReplay as B, buildEmbeddedMessageActionDiscoveryInput as C, SAFETY_MARGIN as D, buildEmbeddedExtensionFactories as E, compactWithSafetyTimeout as F, truncateOversizedToolResultsInSession as G, estimateToolResultReductionPotential as H, resolveCompactionTimeoutMs as I, installToolResultContextGuard as J, truncateOversizedToolResultsInSessionManager as K, isCacheTtlEligibleProvider as L, consumeCompactionSafeguardCancelReason as M, setCompactionSafeguardCancelReason as N, estimateMessagesTokens as O, applyFinalEffectiveToolPolicy as P, dropThinkingBlocks as Q, readLastCacheTtlTimestamp as R, validateReplayTurns as S, limitHistoryTurns as T, resolveLiveToolResultMaxChars as U, guardSessionManager as V, sessionLikelyHasOversizedToolResults as W, createPreparedEmbeddedPiSettingsManager as X, repairSessionFileIfNeeded as Y, assessLastAssistantMessage as Z, resolveEmbeddedRunSkillEntries as _, splitSdkTools as a, isHeartbeatOkResponse as at, normalizeAssistantReplayContent as b, collectRegisteredToolNames as c, buildEmbeddedSystemPrompt as d, releaseWsSession as et, createSystemPromptOverride as f, resolveEmbeddedAgentStreamFn as g, resolveEmbeddedAgentBaseStreamFn as h, mapThinkingLevel as i, filterHeartbeatPairs as it, readPostCompactionContext as j, hasMeaningfulConversationContent as k, toSessionToolAllowlist as l, resolveEmbeddedAgentApiKey as m, resolveEmbeddedCompactionTarget as n, buildUsageWithNoCost as nt, PI_RESERVED_TOOL_NAMES as o, isHeartbeatUserMessage as ot, describeEmbeddedAgentStreamStrategy as p, installContextEngineLoopHook as q, flushPendingToolResultsAfterIdle as r, resolveChannelCapabilities as rt, collectAllowedToolNames as s, buildEmbeddedCompactionRuntimeContext as t, buildStreamErrorAssistantMessage as tt, applySystemPromptOverrideToSession as u, prewarmSessionFile as v, getDmHistoryLimitFromSessionKey as w, sanitizeSessionHistory as x, trackSessionManagerAccess as y, resolveTranscriptPolicy as z };
