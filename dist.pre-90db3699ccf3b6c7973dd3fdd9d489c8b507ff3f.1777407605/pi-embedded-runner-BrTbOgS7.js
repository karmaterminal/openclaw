...
import { y as isCronSessionKey } from "./session-key-Cn2QoOyX.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER, t as DEFAULT_CONTEXT_TOKENS } from "./defaults-BofKZKJ4.js";
import { b as resolveAgentWorkspaceDir, m as resolveSessionAgentIds, r as resolveAgentExecutionContract, t as hasConfiguredModelFallbacks } from "./agent-scope-D-T17Rdc.js";
import { i as isMarkdownCapableMessageChannel } from "./message-channel-Bk_YHfQg.js";
...
import { i as resolveContextEngine } from "./registry-CJ9kiBp3.js";
...
import { t as ensureContextEnginesInitialized } from "./init-CaTUt4E2.js";
import { t as ensureRuntimePluginsLoaded } from "./runtime-plugins-J0NKXu0i.js";
import { n as sleepWithAbort } from "./backoff-CLV-C1Ec.js";
import { a as normalizeUsage, t as derivePromptTokens } from "./usage-B1cMBf1I.js";
import { n as extractAssistantTextForPhase } from "./chat-message-content-BqgwRnGh.js";
...
import { i as enqueueCommandInLane } from "./command-queue-CGrlxFYE.js";
import { a as formatContextWindowWarningMessage, i as formatContextWindowBlockMessage, n as CONTEXT_WINDOW_WARN_BELOW_TOKENS, o as resolveContextWindowInfo, r as evaluateContextWindowGuard, t as CONTEXT_WINDOW_HARD_MIN_TOKENS } from "./context-window-guard-BDr1-4ae.js";
import { r as isSilentReplyPayloadText } from "./tokens-CYuOTnyM.js";
import { G as truncateOversizedToolResultsInSession, U as resolveLiveToolResultMaxChars, W as sessionLikelyHasOversizedToolResults, n as resolveEmbeddedCompactionTarget, t as buildEmbeddedCompactionRuntimeContext } from "./compaction-runtime-context-BXR92FQ8.js";
import { _ as isStrictAgenticExecutionContractActive } from "./openclaw-tools-BM64FZFo.js";
import { _ as resolveReplayInvalidFlag, b as observeReplayMetadata, c as STRICT_AGENTIC_BLOCKED_TEXT, d as resolveAckExecutionFastPathInstruction, f as resolveEmptyResponseRetryInstruction, g as resolveReasoningOnlyRetryInstruction, h as resolvePlanningOnlyRetryLimit, l as extractPlanningOnlyPlanDetails, m as resolvePlanningOnlyRetryInstruction, p as resolveIncompleteTurnPayloadText, r as runAgentHarnessAttemptWithFallback, s as runContextEngineMaintenance, t as maybeCompactAgentHarnessSession, v as resolveRunLivenessState, x as formatToolAggregate, y as createEmbeddedRunReplayState } from "./selection-ZVDtlkUN.js";
import { o as normalizeTextForComparison, r as pickFallbackThinkingLevel } from "./pi-embedded-helpers-BrjvE3y6.js";
import { T as isTimeoutErrorMessage, j as formatRawAssistantErrorForUi, l as isRawApiErrorPayload, n as formatBillingErrorMessage, o as getApiErrorPayloadFingerprint, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-Bzewcv8R.js";
import { _ as parseImageDimensionError, a as formatAssistantErrorText, d as isFailoverAssistantError, f as isFailoverErrorMessage, i as extractObservedOverflowTokenCount, l as isCompactionFailureError, m as isRateLimitAssistantError, o as isAuthAssistantError, p as isLikelyContextOverflowError, s as isBillingAssistantError, t as classifyFailoverReason, v as parseImageSizeError } from "./errors-Bd1ET-5C.js";
import { n as coerceToFailoverError, r as describeFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-Bly4bj4L.js";
import "./auth-profiles-k8Wc2Eeh.js";
import { r as markAuthProfileGood } from "./profiles-DQiFenPb.js";
import { t as redactIdentifier } from "./redact-identifier-CmqNr0l7.js";
import { t as sanitizeForConsole } from "./console-sanitize-B0gsXsnR.js";
import { a as isProfileInCooldown, c as markAuthProfileUsed, d as resolveProfilesUnavailableReason, s as markAuthProfileFailure } from "./usage-CjcxlRTg.js";
import { n as resolveAuthProfileOrder, t as resolveAuthProfileEligibility } from "./order-DI4ZiJXM.js";
import { n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel, t as applyAuthHeaderOverride, u as shouldPreferExplicitConfigApiKeyAuth } from "./model-auth-CnLreLvU.js";
import { t as log } from "./logger-Blw-ywDf.js";
import { d as sanitizeRuntimeProviderRequestOverrides, s as resolveProviderRequestConfig } from "./provider-request-config-COmDgAeZ.js";
import { a as retireSessionMcpRuntime, o as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-DAdkA6n_.js";
import "./pi-bundle-mcp-tools-BvqwOlsx.js";
import { l as parseReplyDirectives } from "./payloads-nIfLjbWq.js";
import { s as hasOutboundReplyContent } from "./reply-payload-Bp4halqE.js";
import { s as emitAgentPlanEvent } from "./agent-events-CN4p9Z8t.js";
import { a as shouldAllowCooldownProbeForReason, i as LiveSessionModelSwitchError, o as buildApiErrorObservationFields } from "./model-fallback-CE1uOaB3.js";
import { n as isLikelyMutatingToolName } from "./tool-mutation-CcZ3Jy4P.js";
import { n as extractAssistantThinking, o as formatReasoningMessage, r as extractAssistantVisibleText } from "./pi-embedded-utils-Du-NhvYE.js";
...
import { l as resolveGlobalLane, u as resolveSessionLane } from "./queue-Bsh8rsUi.js";
import "./runs-BbW2coSD.js";
import "./extra-params-XxqPm0T2.js";
import { n as resolveModelAsync } from "./model-C2LXeqL4.js";
import { a as resolveStoredSessionKeyForSessionId, i as resolveSessionKeyForRequest, n as shouldSwitchToLiveModel, t as clearLiveModelSwitchPending } from "./live-model-switch-D63xlPb8.js";
import { n as resolveRunWorkspaceDir, t as redactRunIdentifier } from "./workspace-run-Tr1XCqyu.js";
