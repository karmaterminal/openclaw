...
import { d as pathExists } from "./utils-CB8xp0O4.js";
...
import { n as DEFAULT_GATEWAY_PORT, u as resolveGatewayPort } from "./paths-D92DjaZ-.js";
...
import { o as resolveGatewayInstallEntrypoint } from "./daemon-install-plan.shared-C-zyu1EB.js";
import { a as parseSemver, i as nodeVersionSatisfiesEngine } from "./runtime-guard-DYXyo2C1.js";
import { r as runCommandWithTimeout } from "./exec-CIhMaoDG.js";
import { B as asRuntimeConfig, u as readConfigFileSnapshot, z as asResolvedSourceConfig } from "./io-CBRjt33P.js";
import { a as shellEscapeRestartLogValue, i as resolveGatewayRestartLogPath, n as renderPosixRestartLogSetup, s as quoteCmdScriptArg, t as renderCmdRestartLogSetup } from "./restart-logs-9G0fIinO.js";
import { r as resolveGatewayService } from "./service-kQkBLBlg.js";
import { t as runDaemonInstall } from "./install-Chi7_UyZ.js";
import { r as replaceConfigFile } from "./mutate-DLhVGTK-.js";
import "./config-BjiV0z87.js";
import { t as runDaemonRestart } from "./lifecycle-1PD9bJTK.js";
import { n as formatConfigIssueLines } from "./issue-format-zM6cvDu4.js";
import { l as waitForGatewayHealthyRestart, o as renderRestartDiagnostics, s as terminateStaleGatewayPids } from "./restart-health-3YWy75LF.js";
import { d as trimLogTail } from "./restart-sentinel-ZznJ7MqL.js";
import { r as formatDurationPrecise } from "./format-duration-DyLpmhiM.js";
import { n as stylePromptMessage } from "./prompt-style-M7caE4BS.js";
import { t as formatHelpExamples } from "./help-format-oS7J2-Gq.js";
import { r as installCompletion } from "./completion-runtime-Cj9rJa49.js";
import { n as renderTable, t as getTerminalTableWidth } from "./table-qc4bL_TD.js";
import { n as updateNpmInstalledPlugins, t as syncPluginsForUpdateChannel } from "./update-BVBk7ljo.js";
import { n as doctorCommand, t as selectStyled } from "./prompt-select-styled-KtdwlQOg.js";
import { d as formatUpdateChannelLabel, g as resolveUpdateChannelDisplay, h as resolveEffectiveUpdateChannel, i as fetchNpmTagVersion, m as normalizeUpdateChannel, n as compareSemverStrings, o as resolveNpmChannelTag, r as fetchNpmPackageTargetStatus, t as checkUpdateStatus, u as channelToNpmTag } from "./update-check-DTgzLYf5.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, t as formatUpdateAvailableHint } from "./status.update-CzRMvE5S.js";
import { a as createGlobalInstallEnv, c as globalInstallArgs, d as resolveGlobalInstallTarget, f as normalizePackageTagInput, i as collectInstalledGlobalPackageErrors, l as resolveExpectedInstalledVersionFromSpec, m as readPackageVersion, n as canResolveRegistryVersionForPackageTarget, o as detectGlobalInstallManagerByPresence, p as readPackageName, r as cleanupGlobalRenameDirs, s as detectGlobalInstallManagerForRoot, t as runGatewayUpdate, u as resolveGlobalInstallSpec } from "./update-runner-BJKm386y.js";
import { r as ensureCompletionCacheExists, t as checkShellCompletionStatus } from "./doctor-completion-DhMcWTPf.js";
...
async function updateCommand(opts) {
	...
	if (opts.dryRun) {
		...
		else if (packageAlreadyCurrent) actions.push(`Skip package update; current version already matches ${targetVersion}`);
	...
	if (packageAlreadyCurrent) {
		printResult({
			status: "skipped",
			mode: isPackageManagerUpdateMode(updateStatus.packageManager) ? updateStatus.packageManager : "unknown",
			root,
