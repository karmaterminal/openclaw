...
const LINKEDOM_MODULE$1 = "linkedom";
let parseHtmlPromise = null;
async function loadParseHTML() {
	parseHtmlPromise ??= import(LINKEDOM_MODULE$1).then(({ parseHTML }) => parseHTML);
...
//#endregion
export { readResponseText as a, withTimeout as c, extractReadableContent as d, htmlToMarkdown as f, readCache as i, writeCache as l, truncateText as m, DEFAULT_TIMEOUT_SECONDS as n, resolveCacheTtlMs as o, markdownToText as p, normalizeCacheKey as r, resolveTimeoutSeconds as s, DEFAULT_CACHE_TTL_MINUTES as t, extractBasicHtmlContent as u };
