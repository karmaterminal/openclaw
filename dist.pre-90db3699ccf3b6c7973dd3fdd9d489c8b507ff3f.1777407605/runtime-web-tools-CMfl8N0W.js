...
import { d as resolveSecretInputRef } from "./types.secrets-BZ6RGKR0.js";
import { t as createGatewayCredentialPlan } from "./credential-planner-BzMo-q7Z.js";
import { u as secretRefKey } from "./ref-contract-CsOjNPCR.js";
import "./shared-BBsAgaUp.js";
import { o as resolveSecretRefValues } from "./resolve-C33B7eeu.js";
import { n as getBootstrapChannelSecrets } from "./bootstrap-registry-kyeGno8Q.js";
import { l as resolveEnableState, o as normalizePluginsConfig } from "./config-state-COejNgwx.js";
import { b as resolveAgentWorkspaceDir, x as resolveDefaultAgentId } from "./agent-scope-D-T17Rdc.js";
import { n as resolvePluginConfigContractsById, t as collectPluginConfigContractMatches } from "./config-contracts-DGoLiw7V.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-k9H_9vvf.js";
import { i as resolveBundledExplicitWebSearchProvidersFromPublicArtifacts, r as resolveBundledExplicitWebFetchProvidersFromPublicArtifacts } from "./web-provider-public-artifacts.explicit-CnmrEHjj.js";
import { a as createLazyRuntimeSurface, i as createLazyRuntimeNamedExport } from "./lazy-runtime-CfxQKttd.js";
import { n as resolvePluginCapabilityProviders } from "./capability-provider-runtime-CuYqBiCW.js";
import { i as normalizeMediaProviderId, n as resolveEffectiveMediaEntryCapabilities, r as resolveImageCapableConfigProviderIds, t as resolveConfiguredMediaEntryCapabilities } from "./entry-capabilities-BVewVj8I.js";
import { t as loadBundledChannelSecretContractApi } from "./channel-contract-api-NQPJ9RYO.js";
import { c as pushInactiveSurfaceWarning, l as pushWarning, n as collectSecretInputAssignment } from "./runtime-shared-B0KrexH_.js";
import { t as collectTtsApiKeyAssignments } from "./runtime-config-collectors-tts-DN5h7sIu.js";
import { o as sortWebFetchProvidersForAutoDetect, r as sortWebSearchProvidersForAutoDetect } from "./web-search-providers.shared-B30uhXiw.js";
...
const loadResolveManifestContractOwnerPluginId = createLazyRuntimeNamedExport(() => import("./runtime-web-tools-manifest.runtime-BHErXRFN.js"), "resolveManifestContractOwnerPluginId");
...
const loadRuntimeWebToolsFallbackProviders = createLazyRuntimeSurface(() => import("./runtime-web-tools-fallback.runtime-G9fU6OZc.js"), ({ runtimeWebToolsFallbackProviders }) => runtimeWebToolsFallbackProviders);
const loadRuntimeWebToolsPublicArtifacts = createLazyRuntimeSurface(() => import("./runtime-web-tools-public-artifacts.runtime-Yb_goLVw.js"), (mod) => mod);
const loadRuntimeWebToolsManifest = createLazyRuntimeSurface(() => import("./runtime-web-tools-manifest.runtime-BHErXRFN.js"), (mod) => mod);
