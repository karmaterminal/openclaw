...
import { n as isGatewayConfigBypassCommandPath } from "./explicit-connection-policy-Db0Whi44.js";
//#region src/cli/plugin-registry-loader.ts
let pluginRegistryModulePromise;
function loadPluginRegistryModule() {
	pluginRegistryModulePromise ??= import("./plugin-registry-BUNhrPG2.js");
...
function loadConfigGuardModule() {
	configGuardModulePromise ??= import("./config-guard-4CFL1W-4.js");
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-BggYYDC1.js");
	if (params.argv) {
