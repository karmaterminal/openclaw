...
import { C as normalizeBrowserFormField, w as normalizeBrowserFormFieldValue } from "./chrome-C0n3do0L.js";
import { d as resolveExistingPathsWithinRoot, n as DEFAULT_AI_SNAPSHOT_MAX_CHARS, u as DEFAULT_UPLOAD_DIR } from "./utils-DLZa1oC8.js";
import { f as redactCdpUrl } from "./cdp.helpers-BC5SjFUf.js";
import { a as getBrowserProfileCapabilities } from "./server-context-Db6CgUM6.js";
import { n as resolveProfile, t as resolveBrowserConfig } from "./config-BeVnhQ2C.js";
import { c as browserOpenTab, d as browserSnapshot, f as browserStart, g as browserTabs, i as browserCloseTab, l as browserProfiles, m as browserStop, n as trackSessionBrowserTab, p as browserStatus, r as untrackSessionBrowserTab, s as browserFocusTab } from "./session-tab-registry-DOTU5Pbf.js";
import { c as browserPdfSave, d as browserArmFileChooser, f as browserNavigate, i as isPersistentBrowserProfileMutation, l as browserAct, n as persistBrowserProxyFiles, o as resolveRequestedBrowserProfile, p as browserScreenshotAction, s as browserConsoleMessages, t as applyBrowserProxyPaths, u as browserArmDialog } from "./browser-runtime-InwaYFRb.js";
import { a as createBrowserRouteDispatcher, r as startBrowserControlServiceFromConfig, t as createBrowserControlContext } from "./control-service-AchkQzXH.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-CD8wWEGT.js"),
