import { c as readErrorName, i as formatErrorMessage } from "./errors-CS5wW5eD.js";
...
import { t as registerPendingSpawnedChildrenQuery } from "./pending-spawn-query-BRSuTw_f.js";
import { i as failTaskRunByRunId, o as setDetachedTaskDeliveryStatusByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-Cwd30X8h.js";
import { u as withSubagentOutcomeTiming } from "./subagent-announce-output-CqU05Wpx.js";
import { r as waitForAgentRun } from "./run-wait-BsHZBqIP.js";
import { i as emitSessionLifecycleEvent, t as configureSubagentRegistrySpawnRuntime } from "./subagent-registry-spawn-runtime-D3oqRlpi.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-liA5KzKs.js";
...
async function loadCleanupBrowserSessionsForLifecycleEnd$1() {
	browserCleanupPromise$1 ??= import("./browser-lifecycle-cleanup-DfPHwAIu.js");
...
async function loadSubagentAnnounceModule() {
	subagentAnnouncePromise ??= import("./subagent-announce-BZFKEFD6.js");
	return await subagentAnnouncePromise;
}
async function loadCleanupBrowserSessionsForLifecycleEnd() {
	browserCleanupPromise ??= import("./browser-lifecycle-cleanup-DfPHwAIu.js");
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-D5BcSweu.js").then(({ scheduleOrphanRecovery }) => {
...
//#endregion
export { getLatestSubagentRunByChildSessionKey as a, listDescendantRunsForRequester as c, markSubagentRunTerminated as d, registerSubagentRun as f, countPendingDescendantRuns as i, listSubagentRunsForController as l, scheduleSubagentOrphanRecovery as m, countActiveDescendantRuns as n, getSubagentRunByChildSessionKey as o, replaceSubagentRunAfterSteer as p, countActiveRunsForSession as r, initSubagentRegistry as s, clearSubagentRunSteerRestart as t, markSubagentRunForSteerRestart as u };
