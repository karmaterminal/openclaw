...
import { s as resolveConfigPathCandidate } from "./paths-D92DjaZ-.js";
import { r as authorizeHttpGatewayConnect } from "./auth-DFx0epA_.js";
import { a as loadConfig } from "./io-CBRjt33P.js";
import { c as normalizeAgentId, r as buildAgentMainSessionKey, x as parseAgentSessionKey } from "./session-key-Cn2QoOyX.js";
import { r as listChannelPlugins } from "./registry-CaUS2Z2d.js";
import { g as listAgentIds, x as resolveDefaultAgentId } from "./agent-scope-D-T17Rdc.js";
import "./config-BjiV0z87.js";
import { u as normalizeMessageChannel } from "./message-channel-Bk_YHfQg.js";
import { n as normalizeMessageChannel$1 } from "./message-channel-core-DTA--Gjh.js";
import { n as authorizeOperatorScopesForMethod, o as ADMIN_SCOPE, t as CLI_DEFAULT_OPERATOR_SCOPES } from "./method-scopes-7zKnuhA9.js";
import "./plugins-BcqWcAy9.js";
import { C as parseModelRef, x as modelKey } from "./model-selection-cli-BCNxTSmc.js";
...
import { n as logRejectedLargePayload, r as parseContentLengthHeader } from "./diagnostic-payload-BNc0oyeh.js";
import { n as resolveFunctionModuleExport, t as importFileModule } from "./module-loader-ylufXQiT.js";
import { t as resolveAllowedAgentIds } from "./hooks-policy-DaO8U2Lg.js";
...
//#endregion
export { isSessionKeyAllowedByPrefix as A, resolveHookTargetAgentId as B, watchClientDisconnect as C, getHookChannelError as D, getHookAgentPolicyError as E, readJsonBody as F, applyHookMappings as H, resolveHookChannel as I, resolveHookDeliver as L, normalizeHookDispatchSessionKey as M, normalizeHookHeaders as N, getHookSessionKeyPrefixError as O, normalizeWakePayload as P, resolveHookIdempotencyKey as R, setSseHeaders as S, extractHookToken as T, resolveHooksConfig as V, sendGatewayAuthFailure as _, checkGatewayHttpRequestAuth as a, sendMethodNotAllowed as b, resolveAgentIdForRequest as c, resolveHttpBrowserOriginPolicy as d, resolveOpenAiCompatModelOverride as f, readJsonBodyOrError as g, resolveTrustedHttpOperatorScopes as h, authorizeScopedGatewayHttpRequestOrReply as i, normalizeAgentPayload as j, isHookAgentAllowed as k, resolveAgentIdFromModel as l, resolveOpenAiCompatibleHttpSenderIsOwner as m, OPENCLAW_MODEL_ID as n, getBearerToken as o, resolveOpenAiCompatibleHttpOperatorScopes as p, authorizeGatewayHttpRequestOrReply as r, getHeader as s, OPENCLAW_DEFAULT_MODEL_ID as t, resolveGatewayRequestContext as u, sendInvalidRequest as v, writeDone as w, setDefaultSecurityHeaders as x, sendJson as y, resolveHookSessionKey as z };
