...
import { u as resolveAgentIdFromSessionKey, y as isCronSessionKey } from "./session-key-Cn2QoOyX.js";
...
import { a as isSilentReplyText, c as stripLeadingSilentToken, l as stripSilentToken, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripContinuationSignal } from "./tokens-CYuOTnyM.js";
import { r as callGateway } from "./call-DsaRhCZc.js";
import "./delivery-context-BuYaqSek.js";
import { i as consumePendingDelegates } from "./continuation-delegate-store-BpJu5jp4.js";
...
function loadSubagentRegistryRuntime() {
	subagentRegistryRuntimePromise ??= import("./subagent-announce.registry.runtime-BogjKLKQ.js");
	return subagentRegistryRuntimePromise;
}
function loadContinuationStateRuntime() {
	continuationStateRuntimePromise ??= import("./continuation-state.runtime-Bvvdfpwc.js");
	return continuationStateRuntimePromise;
}
function loadSubagentSpawnRuntime() {
	subagentSpawnRuntimePromise ??= import("./subagent-spawn-BaUaknAL.js");
		...
		if (continuationEnabled && (findings !== "(no output)" || toolDelegates.length > 0)) {
			...
			if (toolDelegates.length > 0 && isContinuationChainDelegate) {
				...
				for (const toolDelegate of toolDelegates) {
					...
					const toolWake = toolDelegate.silentWake || parentWasSilent && params.wakeOnReturn === true;
