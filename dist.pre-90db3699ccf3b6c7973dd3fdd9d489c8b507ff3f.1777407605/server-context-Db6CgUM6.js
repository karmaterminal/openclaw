...
import { d as isPrivateNetworkAllowedByPolicy } from "./ssrf-CTA9WgMa.js";
import { a as ensureMediaDir, l as saveMediaBuffer } from "./store-BuB7MfIQ.js";
import { n as deriveDefaultBrowserCdpPortRange } from "./port-defaults-BouPbGqr.js";
import "./text-runtime-ITCc6m8o.js";
import "./browser-config-runtime-CAxLDX6f.js";
import "./browser-setup-tools-DhxaEz8Z.js";
import { A as matchBrowserUrlPattern, C as normalizeBrowserFormField, D as normalizeActBoundedNonNegativeMs, E as ACT_MAX_WAIT_TIME_MS, T as ACT_MAX_CLICK_DELAY_MS, _ as captureScreenshot, a as resolveOpenClawUserDataDir, b as normalizeCdpWsUrl, c as formatChromeCdpDiagnostic, d as getRoleSnapshotStats, h as STRUCTURAL_ROLES, i as launchOpenClawChrome, m as INTERACTIVE_ROLES, n as isChromeCdpReady, o as stopOpenClawChrome, p as CONTENT_ROLES, r as isChromeReachable, s as diagnoseChromeCdp, v as createTargetViaCdp, x as snapshotAria } from "./chrome-C0n3do0L.js";
import { c as DEFAULT_DOWNLOAD_DIR, d as resolveExistingPathsWithinRoot, l as DEFAULT_TRACE_DIR, n as DEFAULT_AI_SNAPSHOT_MAX_CHARS, p as resolveWritablePathWithinRoot, t as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, u as DEFAULT_UPLOAD_DIR } from "./utils-DLZa1oC8.js";
import { n as normalizeString } from "./record-shared-BvhQuv4g.js";
import { A as BrowserResetUnsupportedError, B as requiresInspectableBrowserNavigationRedirectsForUrl, C as resolveCdpReachabilityTimeouts, D as BrowserConflictError, F as toBrowserErrorResponse, I as InvalidBrowserNavigationUrlError, L as assertBrowserNavigationAllowed, M as BrowserTabNotFoundError, N as BrowserTargetAmbiguousError, O as BrowserProfileNotFoundError, P as BrowserValidationError, S as PROFILE_ATTACH_RETRY_TIMEOUT_MS, V as withBrowserNavigationPolicy, a as fetchOk, d as parseBrowserHttpUrl, f as redactCdpUrl, h as CDP_JSON_NEW_TIMEOUT_MS, i as fetchJson, j as BrowserResourceExhaustedError, k as BrowserProfileUnavailableError, l as normalizeCdpHttpBaseForJsonEndpoints, m as withAllowedHostname, n as assertCdpEndpointAllowed, t as appendCdpPath, w as usesFastLoopbackCdpProbeClass, y as CHROME_MCP_ATTACH_READY_WINDOW_MS, z as assertBrowserNavigationResultAllowed } from "./cdp.helpers-BC5SjFUf.js";
import { r as resolveBrowserExecutableForPlatform } from "./chrome.executables-cOeslAuJ.js";
import "./control-auth-1DN0C9sb.js";
import { n as resolveProfile, t as resolveBrowserConfig } from "./config-BeVnhQ2C.js";
import { t as movePathToTrash } from "./trash-DdfpiGGZ.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-DUkibZGq.js");
	} catch (err) {
