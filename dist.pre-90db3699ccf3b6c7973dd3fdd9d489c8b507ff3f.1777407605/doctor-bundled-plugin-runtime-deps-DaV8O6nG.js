...
import { a as scanBundledPluginRuntimeDeps, i as resolveBundledRuntimeDependencyPackageInstallRoot, n as installBundledRuntimeDeps } from "./bundled-runtime-deps-CZFrQpGI.js";
...
async function maybeRepairBundledPluginRuntimeDeps(params) {
	...
	try {
		const installRoot = resolveBundledRuntimeDependencyPackageInstallRoot(packageRoot, { env: params.env ?? process.env });
