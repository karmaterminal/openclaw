...
import { n as getBridgeAuthForPort } from "./bridge-auth-registry-CgVegMcZ.js";
import { n as resolveBrowserControlAuth } from "./control-auth-1DN0C9sb.js";
...
async function fetchBrowserJson(url, init) {
	...
	try {
		...
		const { dispatchBrowserControlRequest } = await import("./local-dispatch.runtime-Blqf5DXr.js");
