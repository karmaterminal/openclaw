import { c as normalizeOptionalString, d as normalizeStringifiedOptionalString } from "./string-coerce-CjxCKZ6B.js";
...
import { t as CONFIG_PATH } from "./paths-D92DjaZ-.js";
import { d as resolveSecretInputRef, i as coerceSecretRef, s as isValidEnvSecretRefId } from "./types.secrets-BZ6RGKR0.js";
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-CsOjNPCR.js";
import { n as info, o as success, t as danger } from "./globals-Bo8QPRgM.js";
import { a as resolveSecretRefValue } from "./resolve-C33B7eeu.js";
import { w as SecretProviderSchema } from "./zod-schema.core-BO_PdpIg.js";
import { C as validateConfigObjectRaw, u as readConfigFileSnapshot, x as collectUnsupportedSecretRefPolicyIssues } from "./io-CBRjt33P.js";
...
import { a as normalizeConfigIssues, n as formatConfigIssueLines } from "./issue-format-zM6cvDu4.js";
import { t as redactConfigObject } from "./redact-snapshot-BakPiQfA.js";
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-B-M_Mi4u.js";
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-DJepOTLY.js";
import { n as setCommandJsonMode } from "./json-mode-BIy7pupQ.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-BS5EAnO_.js");
