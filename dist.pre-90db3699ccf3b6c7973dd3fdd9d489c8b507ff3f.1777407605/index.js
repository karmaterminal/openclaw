...
import { r as runFatalErrorHooks } from "./fatal-error-hooks-C-fEYV-O.js";
import { t as isMainModule } from "./is-main-CV7usdjw.js";
import { t as installUnhandledRejectionHandler } from "./unhandled-rejections-1YGsKksF.js";
...
async function loadLegacyCliDeps() {
	const { runCli } = await import("./run-main-B5mzap5z.js");
	return { runCli };
}
...
if (!isMain) ({applyTemplate, createDefaultDeps, deriveSessionKey, describePortOwner, ensureBinary, ensurePortAvailable, getReplyFromConfig, handlePortError, loadConfig, loadSessionStore, monitorWebChannel, normalizeE164, PortInUseError, promptYesNo, resolveSessionKey, resolveStorePath, runCommandWithTimeout, runExec, saveSessionStore, waitForever} = await import("./library-D5aRhnMs.js"));
if (isMain) {
	const { restoreTerminalState } = await import("./restore-CW7bFcip.js");
