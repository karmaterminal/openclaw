...
import { c as escapeRegExp } from "./utils-CB8xp0O4.js";
import { s as sanitizeHostExecEnvWithDiagnostics } from "./host-env-security-Btzm9BXg.js";
import { a as logWarn, r as logInfo } from "./logger-Dm9TyjBd.js";
import { K as getShellPathFromLoginShell, q as resolveShellEnvFallbackTimeoutMs } from "./io-CBRjt33P.js";
import { b as isSubagentSessionKey, u as resolveAgentIdFromSessionKey, x as parseAgentSessionKey, y as isCronSessionKey } from "./session-key-Cn2QoOyX.js";
import { d as resolveApprovalAuditCandidatePath } from "./exec-safe-bin-trust-CInTCtp-.js";
import { t as killProcessTree } from "./kill-tree-DSz_msxx.js";
import { c as isGatewayMessageChannel, u as normalizeMessageChannel } from "./message-channel-Bk_YHfQg.js";
import { i as normalizeDeliveryContext } from "./delivery-context.shared-j5hC5qb1.js";
import { b as EXEC_TOOL_DISPLAY_SUMMARY, x as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-policy-4C90huEY.js";
import { D as formatExecDeniedUserMessage, O as isExecDeniedResultText, k as parseExecApprovalResultText, u as sanitizeUserFacingText } from "./sanitize-user-facing-text-Bzewcv8R.js";
import { o as failedTextResult, v as textResult } from "./common-BGcbYPyw.js";
import { t as callGatewayTool } from "./gateway-0G0WDa7x.js";
import { t as splitShellArgs } from "./shell-argv-VbVOJlPI.js";
import { c as describeInterpreterInlineEval, f as analyzeShellCommand, l as detectInterpreterInlineEvalArgv, n as evaluateShellAllowlist, p as buildEnforcedShellCommand } from "./exec-approvals-allowlist-jzBM7IP-.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-CiyctINB.js";
import { C as requiresExecApproval, D as resolveExecApprovalsFromFile, E as resolveExecApprovals, _ as normalizeExecTarget, a as addDurableCommandApproval, b as recordAllowlistMatchesUse, f as minSecurity, g as normalizeExecSecurity, l as loadExecApprovals, m as normalizeExecAsk, s as hasDurableExecApproval, u as maxAsk, v as persistAllowAlwaysPatterns, w as resolveExecApprovalAllowedDecisions } from "./exec-approvals-CFEClmo3.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-3INvZdKz.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-BcC7zUq_.js";
import "./delivery-context-BuYaqSek.js";
import { i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-DOqkhF7o.js";
import { t as sendMessage } from "./message-CNRvnqaX.js";
import { t as resolveExternalBestEffortDeliveryTarget } from "./best-effort-delivery-OVlwmjAo.js";
...
import { i as normalizePathPrepend, t as applyPathPrepend } from "./path-prepend-plkyfQlv.js";
import { t as getProcessSupervisor } from "./supervisor-D7jcrcNU.js";
import { A as listFinishedSessions, C as resolveWorkdir, D as drainSession, E as deleteSession, F as tail, M as markBackgrounded, N as markExited, O as getFinishedSession, P as setJobTtlMs, S as resolveSandboxWorkdir, T as truncateMiddle, _ as clampWithDefault, a as DEFAULT_PENDING_MAX_OUTPUT, b as pad, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, g as buildSandboxEnv, i as DEFAULT_PATH, j as listRunningSessions, k as getSession, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput, v as coerceEnv, w as sliceLogLines, x as readEnvInt, y as deriveSessionName } from "./bash-tools.exec-runtime-yUwpemL9.js";
import { f as resolveExecApprovalInitiatingSurfaceState, s as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-LzW_FneM.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-U_N3AvW5.js";
import { n as recordCommandPoll, r as resetCommandPollCount } from "./command-poll-backoff-Sq-q-T0F.js";
...
async function loadFsSafeModule() {
	fsSafeModulePromise ??= import("./fs-safe-B5-EeX5H.js");
