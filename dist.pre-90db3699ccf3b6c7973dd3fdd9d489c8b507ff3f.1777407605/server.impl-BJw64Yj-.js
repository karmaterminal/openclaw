import { i as formatErrorMessage, n as detectErrorKind } from "./errors-CS5wW5eD.js";
import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, r as lowercasePreservingWhitespace, s as normalizeOptionalLowercaseString } from "./string-coerce-CjxCKZ6B.js";
import { s as registerUnhandledRejectionHandler } from "./unhandled-rejections-1YGsKksF.js";
import { a as getLogger, i as getChildLogger } from "./logger-DTX5koY3.js";
import { b as truncateUtf16Safe, m as resolveUserPath, s as ensureDir, v as sleep } from "./utils-CB8xp0O4.js";
import { n as defaultRuntime } from "./runtime-Dy0KdPiM.js";
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-CJBoMDt5.js";
import { n as isVitestRuntimeEnv, r as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-Bm9OFWXY.js";
import { t as formatCliCommand } from "./command-format-LSnUCVVF.js";
import { _ as resolveStateDir, i as isNixMode, r as STATE_DIR } from "./paths-D92DjaZ-.js";
import { s as resolveRuntimeServiceVersion } from "./version-Bym9kFjy.js";
import { a as logWarn, t as logDebug } from "./logger-Dm9TyjBd.js";
import { i as runExec } from "./exec-CIhMaoDG.js";
import { o as getTailnetHostname } from "./tailscale-DoO5r4nG.js";
import { t as safeEqualSecret } from "./secret-equal-BBFaVgZ-.js";
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-B84QdFQz.js";
import { _ as resolveRequestClientIp, a as isLoopbackHost, g as resolveHostName, h as resolveGatewayListenHosts, i as isLoopbackAddress, l as isTrustedProxyAddress, m as resolveGatewayBindHost, n as isContainerEnvironment, o as isPrivateOrLoopbackAddress, p as resolveClientIp, r as isLocalishHost, s as isPrivateOrLoopbackHost, t as defaultGatewayBindMode, u as isValidIPv4 } from "./net-B-vYkUV_.js";
import { a as createAuthRateLimiter, i as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, n as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, o as normalizeRateLimitClientIp, r as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH } from "./auth-rate-limit-wySkXN2r.js";
import { a as hasForwardedRequestHeaders, i as authorizeWsControlUiGatewayConnect, o as isLocalDirectRequest, r as authorizeHttpGatewayConnect, s as checkBrowserOrigin, t as assertGatewayAuthConfigured } from "./auth-DFx0epA_.js";
import { n as resolveGatewayAuth } from "./auth-resolve-BsgRpY-H.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-BVl0NQAE.js";
import { A as applyConfigOverrides, _ as registerConfigWriteListener, a as loadConfig, c as promoteConfigSnapshotToLastKnownGood, g as recoverConfigFromLastKnownGood, h as recoverConfigFromJsonRootSuffix, i as getRuntimeConfig, nt as resolveSubagentMaxConcurrent, r as createConfigIO, tt as resolveAgentMaxConcurrent, u as readConfigFileSnapshot, y as writeConfigFile } from "./io-CBRjt33P.js";
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-q3lnyOTL.js";
import { c as normalizeAgentId, h as toAgentStoreSessionKey, l as normalizeMainKey, m as toAgentRequestSessionKey, u as resolveAgentIdFromSessionKey, v as isCronRunSessionKey } from "./session-key-Cn2QoOyX.js";
import { n as normalizeAccountId, r as normalizeOptionalAccountId } from "./account-id-BM1T6029.js";
import { n as getLoadedChannelPlugin, r as listChannelPlugins, t as getChannelPlugin } from "./registry-CaUS2Z2d.js";
...
import { _ as resolveAgentConfig, b as resolveAgentWorkspaceDir, x as resolveDefaultAgentId, y as resolveAgentDir } from "./agent-scope-D-T17Rdc.js";
import { t as matchesSkillFilter } from "./filter-CM2m13MB.js";
import { t as parseDurationMs } from "./parse-duration-CKmCMtsX.js";
import { n as resolveNormalizedAccountEntry, t as resolveAccountEntry } from "./account-lookup-CYczo_cp.js";
import { r as isRestartEnabled } from "./commands.flags-D8n75DQv.js";
import "./config-BjiV0z87.js";
import { a as buildDeviceAuthPayloadV3, i as buildDeviceAuthPayload, r as getPreauthHandshakeTimeoutMsFromEnv } from "./client-BzXrq-Vi.js";
import { o as verifyDeviceSignature, r as normalizeDevicePublicKeyBase64Url, t as deriveDeviceIdFromPublicKey } from "./device-identity-C12sfgbO.js";
import { t as rawDataToString } from "./ws-DGbhWWgu.js";
import { a as isOperatorUiClient, h as GATEWAY_CLIENT_MODES, m as GATEWAY_CLIENT_IDS, n as isGatewayCliClient, o as isWebchatClient, s as isDeliverableMessageChannel, t as isBrowserOperatorUiClient, u as normalizeMessageChannel } from "./message-channel-Bk_YHfQg.js";
import { t as normalizeDeviceMetadataForAuth } from "./device-metadata-normalization-DnL2u_xx.js";
import { i as buildPairingConnectErrorMessage, m as resolveDeviceAuthConnectErrorDetailCode, n as buildPairingConnectCloseReason, p as resolveAuthConnectErrorDetailCode, r as buildPairingConnectErrorDetails, t as ConnectErrorDetailCodes } from "./connect-error-details-CNaj8mih.js";
import { D as validateConnectParams, H as validateExecApprovalGetParams, U as validateExecApprovalRequestParams, W as validateExecApprovalResolveParams, ft as validatePluginApprovalRequestParams, gt as validateRequestFrame, in as errorShape, pt as validatePluginApprovalResolveParams, rn as ErrorCodes, t as formatValidationErrors, vt as validateSecretsResolveParams, yt as validateSecretsResolveResult } from "./protocol-Bcs0YWrz.js";
import { a as approvalDecisionLabel, n as MAX_PLUGIN_APPROVAL_TIMEOUT_MS, o as buildPluginApprovalExpiredMessage, s as buildPluginApprovalRequestMessage, t as DEFAULT_PLUGIN_APPROVAL_TIMEOUT_MS } from "./plugin-approvals-sugMHxyL.js";
import { c as PAIRING_SCOPE, d as WRITE_SCOPE, l as READ_SCOPE, o as ADMIN_SCOPE, s as APPROVALS_SCOPE$1, t as CLI_DEFAULT_OPERATOR_SCOPES } from "./method-scopes-7zKnuhA9.js";
import { n as formatConfigIssueLines } from "./issue-format-zM6cvDu4.js";
import { r as normalizeControlUiBasePath } from "./control-ui-shared-CP9duaRo.js";
import { t as hasAnyAuthProfileStoreSource } from "./source-check-80U6FTE-.js";
...
import { n as resolveChannelApprovalCapability, t as resolveChannelApprovalAdapter } from "./plugins-BcqWcAy9.js";
import { o as runGlobalGatewayStopSafely } from "./hook-runner-global-DuCZiaZE.js";
import { t as createEmptyPluginRegistry } from "./registry-empty-BzdJBxDW.js";
import { a as getActivePluginRegistry, b as resolveActivePluginHttpRouteRegistry, d as pinActivePluginChannelRegistry, f as pinActivePluginHttpRouteRegistry, h as releasePinnedPluginHttpRouteRegistry, m as releasePinnedPluginChannelRegistry, x as setActivePluginRegistry } from "./runtime-Cym-fqI8.js";
import { i as canonicalizePathVariant, n as PROTECTED_PLUGIN_ROUTE_PREFIXES, r as canonicalizePathForSecurity } from "./http-route-overlap-CBIhSNNb.js";
import { n as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-Cc9jmc-3.js";
import "./logging-CsdNOkNt.js";
import { a as resolveSupportedThinkingLevel, d as normalizeThinkLevel, m as normalizeVerboseLevel, n as isThinkingLevelSupported } from "./thinking-Bh-7MqXz.js";
import { d as normalizeModelSelection, g as resolveHooksGmailModel, i as resolveAllowedModelRef, m as resolveConfiguredModelRef, r as getModelRefStatus, t as isCliProvider } from "./model-selection-cli-BCNxTSmc.js";
import { p as resolveThinkingDefault } from "./model-selection-B7RNWcLj.js";
import { o as resetModelCatalogCache, r as loadModelCatalog } from "./model-catalog-CyQ5zC3m.js";
import { o as updateSessionStore, s as updateSessionStoreEntry, t as archiveRemovedSessionTranscripts } from "./store-COeaE7A7.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, t as canonicalizeMainSessionAlias } from "./main-session-B78uK7Dt.js";
import { n as resolveMainSessionKeyFromConfig } from "./sessions-THKm0e_w.js";
import { o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-D6msg0S1.js";
import { u as setSessionRuntimeModel } from "./types-ASqeFakT.js";
...
import { o as startGatewayModelPricingRefresh } from "./usage-format-CFG0b3V-.js";
import { n as deriveSessionTotalTokens, r as hasNonzeroUsage } from "./usage-B1cMBf1I.js";
import { i as readSessionMessages, t as attachOpenClawTranscriptMeta } from "./session-utils.fs-DgRtLXgk.js";
import { i as stripInlineDirectiveTagsForDisplay } from "./directive-tags-Bb9KtDtd.js";
import { a as resolveSessionTranscriptCandidates, i as cleanupArchivedSessionTranscripts } from "./session-transcript-files.fs-Bp5oGT4t.js";
import { a as loadGatewaySessionRow, f as resolveGatewaySessionStoreTarget, i as loadCombinedSessionStoreForGateway, o as loadSessionEntry } from "./session-utils-TWBJFzaE.js";
import { o as setDiagnosticsEnabledForProcess, r as isDiagnosticsEnabled } from "./diagnostic-events-C2InyoqQ.js";
import { i as enqueueCommandInLane, s as getTotalQueueSize, u as setCommandLaneConcurrency } from "./command-queue-CGrlxFYE.js";
import { c as stripLeadingSilentToken, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken } from "./tokens-CYuOTnyM.js";
import { s as stripHeartbeatToken } from "./heartbeat-DiRG9-0G.js";
import { o as normalizeCronJobInput } from "./openclaw-tools-BM64FZFo.js";
import { t as getMachineDisplayName } from "./machine-name-D_yx7Swp.js";
import { t as detectMime } from "./mime-Dx8S3QoZ.js";
import { o as resolveFailoverReasonFromError } from "./failover-error-Bly4bj4L.js";
import { t as SsrFBlockedError } from "./ssrf-CTA9WgMa.js";
import { n as fetchWithSsrFGuard } from "./fetch-guard-NDEizKJq.js";
import { a as retireSessionMcpRuntime } from "./pi-bundle-mcp-runtime-DAdkA6n_.js";
import "./pi-bundle-mcp-tools-BvqwOlsx.js";
import { c as getAgentRunContext, d as sweepStaleRunContexts, l as onAgentEvent, t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-CN4p9Z8t.js";
import { t as loadGatewayTlsRuntime$1 } from "./gateway-BRqhL4zZ.js";
import { T as resolveExecApprovalRequestAllowedDecisions, r as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS, w as resolveExecApprovalAllowedDecisions } from "./exec-approvals-CFEClmo3.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-V2Yz6WBE.js";
import { n as assertSafeCronSessionTargetId, r as isInvalidCronSessionTargetIdError, t as normalizeHttpWebhookUrl } from "./webhook-url-CLUaf-m2.js";
import { c as setPreRestartDeferralCheck, n as deferGatewayRestartUntilIdle, r as emitGatewayRestart, s as setGatewaySigusr1RestartPolicy } from "./restart-BcbTn2CL.js";
import { r as cleanOldMedia } from "./store-BuB7MfIQ.js";
import { a as CANVAS_HOST_PATH, c as injectCanvasLiveReload, l as normalizeUrlPath, s as handleA2uiHttpRequest, u as resolveFileWithinRoot } from "./web-media-DDaJekDB.js";
import { i as isKnownSecretTargetId } from "./target-registry-B-M_Mi4u.js";
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-secret-gateway-D5MGM6PE.js";
import { i as evaluateGatewayAuthSurfaceStates, r as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-web-tools-CMfl8N0W.js";
import { n as resolveConfiguredDeferredChannelPluginIds, r as resolveGatewayStartupPluginIds } from "./channel-plugin-ids-D2B9YLpe.js";
import { t as deliverOutboundPayloads } from "./deliver-D1-Y-7aa.js";
import { r as resetDirectoryCache } from "./target-resolver-x7yFE66G.js";
import { t as buildOutboundSessionContext } from "./session-context-BnE3tbzm.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-DIuSKnxZ.js";
import { n as requestHeartbeatNow } from "./heartbeat-wake-CrCSGuB0.js";
import { i as enqueueSystemEvent } from "./system-events-B-8iLjB8.js";
import { i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-Cwd30X8h.js";
import { r as getActiveEmbeddedRunCount } from "./runs-BbW2coSD.js";
import { h as stopDiagnosticHeartbeat, m as startDiagnosticHeartbeat } from "./diagnostic-CLYAjMPL.js";
import { s as initSubagentRegistry } from "./subagent-registry-QM0aZmYG.js";
import { a as onSessionLifecycleEvent } from "./subagent-registry-spawn-runtime-D3oqRlpi.js";
import { t as resolveAgentTimeoutMs } from "./timeout-htOXkzfH.js";
import { c as resolveHookExternalContentSource, o as isExternalHookSession, s as mapHookExternalContentSource } from "./external-content-CCshYPPL.js";
import { r as registerSkillsChangeListener } from "./refresh-state-C1yA64vg.js";
import { c as roleScopesAllow } from "./pairing-token-B-4nto3y.js";
import { a as refreshRemoteBinsForConnectedNodes, c as setSkillsRemoteRegistry, h as updatePairedNodeMetadata, i as recordRemoteNodeInfo, m as requestNodePairing, n as primeRemoteSkillsCache, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo, u as getPairedNode } from "./skills-remote-B7rYvoQE.js";
import { n as resolveCronStyleNow } from "./current-time-BN3cOz0d.js";
import { o as resolvePreferredSessionKeyForSessionIdMatches } from "./live-model-switch-D63xlPb8.js";
import { n as createPluginRuntime } from "./runtime-DYp3IZCN.js";
import { o as getTotalPendingReplies } from "./dispatch-QTzIv_tK.js";
import { n as sanitizeInboundSystemTags } from "./inbound-text-DNj7_tPx.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-Cmi2_rQR.js";
import { c as formatExecApprovalExpiresIn, f as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-reply-LzW_FneM.js";
import { t as CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "./approval-handler-adapter-runtime-CxBh3zkM.js";
import { n as sanitizeExecApprovalDisplayText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-CsCDZxE7.js";
import { n as createChannelApprovalHandlerFromCapability } from "./approval-handler-runtime-MJ6o8C2K.js";
import { i as watchChannelRuntimeContexts, n as getChannelRuntimeContext, t as createTaskScopedChannelRuntime } from "./channel-runtime-context-CG1k-hvk.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-DzjG3owD.js";
import { n as resolveCronStorePath, r as saveCronStore, t as loadCronStore } from "./store-Btnx_tCF.js";
import "./refresh-Y1_DPPyS.js";
import { i as onHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-0SbliaMo.js";
import { n as resolveAgentOutboundIdentity } from "./identity-CmwcDkMF.js";
import { i as resolveNodeCommandAllowlist, r as normalizeDeclaredNodeCommands } from "./node-command-policy-VkQBk7G2.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs, t as formatForLog } from "./ws-log-Ui7Wa18F.js";
import { i as safeParseJson } from "./nodes.helpers-CD6jwCU4.js";
import { i as assertGatewayAuthNotKnownWeak, n as mergeGatewayAuthConfig, r as mergeGatewayTailscaleConfig, t as ensureGatewayStartupAuth } from "./startup-auth-MQqjQ0xQ.js";
import { r as resolveBootstrapProfileScopesForRole } from "./device-bootstrap-profile-BfwRCf3w.js";
import { _ as updatePairedDeviceMetadata, a as getPairedDevice, c as listApprovedPairedDeviceRoles, l as listDevicePairing, n as approveDevicePairing, p as requestDevicePairing, r as ensureDeviceToken, s as hasEffectivePairedDeviceRole, t as approveBootstrapDevicePairing, u as listEffectivePairedDeviceRoles, v as verifyDeviceToken } from "./device-pairing-jHCJMfzR.js";
import { a as redeemDeviceBootstrapTokenProfile, n as getBoundDeviceBootstrapProfile, o as revokeDeviceBootstrapToken, r as getDeviceBootstrapTokenProfile, s as verifyDeviceBootstrapToken } from "./device-bootstrap-CE5vKceo.js";
import { t as createDefaultDeps } from "./deps-DwAVwozU.js";
import { i as buildSystemRunApprovalEnvBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-kuX308TQ.js";
import { n as resolveSystemRunApprovalRequestContext } from "./system-run-approval-context-U_N3AvW5.js";
import { t as closeMcpLoopbackServer } from "./mcp-http-De541jHd.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-BNc0oyeh.js";
import { A as isSessionKeyAllowedByPrefix, B as resolveHookTargetAgentId, D as getHookChannelError, E as getHookAgentPolicyError, F as readJsonBody, H as applyHookMappings, I as resolveHookChannel, L as resolveHookDeliver, M as normalizeHookDispatchSessionKey, N as normalizeHookHeaders, O as getHookSessionKeyPrefixError, P as normalizeWakePayload, R as resolveHookIdempotencyKey, T as extractHookToken, V as resolveHooksConfig, _ as sendGatewayAuthFailure, d as resolveHttpBrowserOriginPolicy, h as resolveTrustedHttpOperatorScopes, j as normalizeAgentPayload, k as isHookAgentAllowed, o as getBearerToken, r as authorizeGatewayHttpRequestOrReply, s as getHeader, x as setDefaultSecurityHeaders, z as resolveHookSessionKey } from "./http-utils-xxqm94um.js";
import { n as loadGatewayModelCatalog, t as __resetModelCatalogCacheForTest } from "./server-model-catalog-CV2qjVU7.js";
import { t as createOutboundSendDeps } from "./outbound-send-deps-Dyki9cdr.js";
import { t as cleanupBrowserSessionsForLifecycleEnd } from "./browser-lifecycle-cleanup-jJtpqcGA.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-D5hqnRCG.js";
import { a as writeWideAreaGatewayZone, i as resolveWideAreaDiscoveryDomain } from "./widearea-dns-w5yww9eF.js";
import { a as resolveControlUiRootOverrideSync, n as isPackageProvenControlUiRootSync, o as resolveControlUiRootSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-C3-Vx8d1.js";
import { t as GatewayLockError } from "./gateway-lock-Bw8_JfuR.js";
import { t as getHealthSnapshot } from "./health-DfcNGiWz.js";
import { t as runSetupWizard } from "./setup-CJe8aDcv.js";
import { d as startTaskRegistryMaintenance, f as stopTaskRegistryMaintenance, g as markCronJobActive, h as clearCronJobActive, n as getInspectableTaskRegistrySummary } from "./task-registry.maintenance-C63ogqzg.js";
import { _ as HEALTH_REFRESH_INTERVAL_MS, b as MAX_PREAUTH_PAYLOAD_BYTES, f as isSuppressedControlReplyLeadFragment, g as DEDUPE_TTL_MS, h as DEDUPE_MAX, m as abortChatRunById, p as isSuppressedControlReplyText, v as MAX_BUFFERED_BYTES, x as TICK_INTERVAL_MS, y as MAX_PAYLOAD_BYTES } from "./chat-CiqiBisN.js";
import { i as migrateOrphanedSessionKeys } from "./state-migrations-BnUMjY7w.js";
import { _ as resolveDeliveryTarget, a as computeJobPreviousRunAtMs, c as findJobOrThrow, d as isJobEnabled, f as nextWakeAtMs, g as resolveJobPayloadTextForMain, h as recordScheduleComputeError, i as computeJobNextRunAtMs, l as hasScheduledNextRunAtMs, m as recomputeNextRunsForMaintenance, n as applyJobPatch, o as createJob, p as recomputeNextRuns, r as assertSupportedJobSpec, s as errorBackoffMs, t as DEFAULT_ERROR_BACKOFF_SCHEDULE_MS, u as isJobDue } from "./jobs-CCzBBboj.js";
import { t as createCronExecutionId } from "./run-id-CJ7vqx_c.js";
import { a as resolveHeartbeatAckMaxChars$1, i as resolveCronPayloadOutcome, t as isHeartbeatOnlyResponse } from "./helpers-BDc7tDHx.js";
import { a as resolveCronChannelOutputPolicy, n as markCronSessionPreRun, r as persistCronSkillsSnapshotIfChanged, t as createPersistCronSessionEntry } from "./run-session-state-HewvS6am.js";
import { t as runChannelPluginStartupMaintenance } from "./lifecycle-startup-D2F0QAER.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-CX2MP4eu.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-DygyI7mB.js";
import { C as startGatewayConfigReloader, E as pruneStaleControlPlaneBuckets, S as resolveGatewayReloadSettings, T as roleCanSkipDeviceIdentity, _ as appendCronRunLog, a as coreGatewayHandlers, b as resolveCronDeliveryPlan, c as listSystemPresence, d as CANVAS_CAPABILITY_TTL_MS, f as buildCanvasScopedHostUrl, g as loadVoiceWakeConfig, h as formatError, i as setFallbackGatewayContextResolver, l as upsertPresence, m as normalizeCanvasScopedUrl, o as handleGatewayRequest, p as mintCanvasCapabilityToken, s as broadcastPresenceSnapshot, t as loadGatewayStartupPlugins, u as clearNodeWakeState, v as resolveCronRunLogPath, w as parseGatewayRole, x as resolveFailureDestination, y as resolveCronRunLogPruneOptions } from "./server-plugin-bootstrap-BEpa4qtw.js";
import { a as resolveCronSession, n as runHeartbeatOnce, r as startHeartbeatRunner } from "./heartbeat-runner-BDdF4j3B.js";
import { n as stopGmailWatcher, t as startGmailWatcherWithLogs } from "./gmail-watcher-lifecycle-m29SY-s-.js";
import { t as getUpdateAvailable } from "./update-startup-DrQ7w98h.js";
import { t as hasConfiguredInternalHooks } from "./configured-D3kWtCpQ.js";
...
function loadExecApprovalForwarderRuntime() {
	execApprovalForwarderRuntimePromise ??= import("./exec-approval-forwarder.runtime-BpMzlRQ7.js");
...
async function loadSkillsSnapshotRuntime() {
	skillsSnapshotRuntimePromise ??= import("./skills-snapshot.runtime-C_x4eXhb.js");
...
async function loadCliRunnerRuntime() {
	return await import("./cli-runner.runtime-Bq_Pg54A.js");
}
async function loadUsageFormatRuntime() {
	return await import("./usage-format-CH_NyGr_.js");
}
...
function recoverPendingOutboundDeliveries(params) {
	(async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-DQ4xwnx1.js");
		const { deliverOutboundPayloads } = await import("./deliver-DlFegcTm.js");
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-DPIsupCb.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-DkKYzb_m.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-bi3BFJze.js");
	return embeddingsHttpModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-DFge3ynE.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-FzdI7Zo3.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-QbTbo53o.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-DQ6Nh1cK.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-B_1fr745.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-QcIlifgW.js");
...
async function prepareGatewayPluginBootstrap(params) {
	...
	if (!params.minimalTestGateway) await Promise.all([runChannelPluginStartupMaintenance({
...
async function hasGatewayStartupInternalHookListeners() {
	const { hasInternalHookListeners } = await import("./internal-hooks-707hFXD-.js");
	return hasInternalHookListeners("gateway", "startup");
}
async function prewarmConfiguredPrimaryModel(params) {
	const { resolveAgentModelPrimaryValue } = await import("./model-input-BJjhyEp6.js");
	const explicitPrimary = resolveAgentModelPrimaryValue(params.cfg.agents?.defaults?.model)?.trim();
	if (!explicitPrimary) return;
	const { normalizeProviderId } = await import("./provider-id-DG5ev04P.js");
	...
	const [{ resolveOpenClawAgentDir }, { DEFAULT_MODEL, DEFAULT_PROVIDER }, { selectAgentHarness }, { isCliProvider, resolveConfiguredModelRef }, { ensureOpenClawModelsJson }, { resolveModel, resolveModelAsync }, { resolveEmbeddedAgentRuntime }] = await Promise.all([
		import("./agent-paths-DqtFNAjZ.js"),
		import("./defaults-DHAtiLbZ.js"),
		import("./selection-DdOb7GhV.js"),
		import("./model-selection-BY0--tfb.js"),
		import("./models-config-B7Q2ms2j.js"),
		import("./model-Bs6snMXR.js"),
		import("./runtime-BEdhquxR.js")
	]);
...
async function startGatewaySidecars(params) {
	await measureStartup(params.startupTrace, "sidecars.session-locks", async () => {
		try {
			const [{ resolveStateDir }, { resolveAgentSessionDirs }, { cleanStaleLockFiles }] = await Promise.all([
				import("./paths-BxiGeV0U.js"),
				import("./session-dirs-DuAiKlg9.js"),
				import("./session-write-lock-DcuFk9Fr.js")
			]);
	...
	await measureStartup(params.startupTrace, "sidecars.gmail-watch", async () => {
		if (params.cfg.hooks?.enabled && params.cfg.hooks.gmail?.account) {
			const { startGmailWatcherWithLogs } = await import("./gmail-watcher-lifecycle-V-CHw0k6.js");
			await startGmailWatcherWithLogs({
				cfg: params.cfg,
				log: params.logHooks
			});
	...
	await measureStartup(params.startupTrace, "sidecars.gmail-model", async () => {
		if (params.cfg.hooks?.gmail?.model) {
			const [{ DEFAULT_MODEL, DEFAULT_PROVIDER }, { loadModelCatalog }, { getModelRefStatus, resolveConfiguredModelRef, resolveHooksGmailModel }] = await Promise.all([
				import("./defaults-DHAtiLbZ.js"),
				import("./model-catalog-kWFpZQtt.js"),
				import("./model-selection-BY0--tfb.js")
			]);
	...
	await measureStartup(params.startupTrace, "sidecars.internal-hooks", async () => {
		try {
			if (internalHooksConfigured) {
				const [{ setInternalHooksEnabled }, { loadInternalHooks }] = await Promise.all([import("./internal-hooks-707hFXD-.js"), import("./loader-70apQtzM.js")]);
	...
	if (internalHooksConfigured || await hasGatewayStartupInternalHookListeners()) setTimeout(() => {
		import("./internal-hooks-707hFXD-.js").then(({ createInternalHookEvent, triggerInternalHook }) => {
	...
	await measureStartup(params.startupTrace, "sidecars.plugin-services", async () => {
		try {
			const { startPluginServices } = await import("./services-CgzJC_4-.js");
	...
	if (params.cfg.acp?.enabled) {
		const [{ getAcpSessionManager }, { ACP_SESSION_IDENTITY_RENDERER_VERSION }] = await Promise.all([import("./manager-B4-SRPlX.js"), import("./session-identifiers-YX1pyRE7.js")]);
	...
	await measureStartup(params.startupTrace, "sidecars.memory", async () => {
		...
		setImmediate(() => {
			import("./server-startup-memory-BlwFDlTc.js").then(({ startGatewayMemoryBackend }) => startGatewayMemoryBackend({
				cfg: params.cfg,
				log: params.log
			})).catch((err) => {
	...
	await measureStartup(params.startupTrace, "sidecars.restart-sentinel", async () => {
		...
		const { hasRestartSentinel } = await import("./restart-sentinel-CFU6EoIT.js");
		if (!await hasRestartSentinel()) return;
		setTimeout(() => {
			import("./server-restart-sentinel-CaK8pdiW.js").then(({ scheduleRestartSentinelWake }) => scheduleRestartSentinelWake({ deps: params.deps })).catch((err) => {
	...
	await measureStartup(params.startupTrace, "sidecars.subagent-recovery", async () => {
		const { scheduleSubagentOrphanRecovery } = await import("./subagent-registry-ucp0E3Zh.js");
		scheduleSubagentOrphanRecovery();
	});
	return { pluginServices };
}
const defaultGatewayPostAttachRuntimeDeps = {
	getGlobalHookRunner: async () => (await import("./hook-runner-global-CxgQsGwp.js")).getGlobalHookRunner(),
	logGatewayStartup: async (params) => (await import("./server-startup-log-CAnsD7qI.js")).logGatewayStartup(params),
	scheduleGatewayUpdateCheck: async (...args) => (await import("./update-startup-BsVTSIWG.js")).scheduleGatewayUpdateCheck(...args),
	startGatewaySidecars,
	startGatewayTailscaleExposure: async (...args) => (await import("./server-tailscale-Dvav8rKT.js")).startGatewayTailscaleExposure(...args)
};
	...
	try {
		...
		if (!minimalTestGateway) {
			if (deferredConfiguredChannelPluginIds.length > 0) {
				const { reloadDeferredGatewayPlugins } = await import("./server-plugin-bootstrap-CCLGuaJZ.js");
