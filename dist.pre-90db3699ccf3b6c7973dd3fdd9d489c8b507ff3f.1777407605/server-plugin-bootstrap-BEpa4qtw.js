...
import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, d as normalizeStringifiedOptionalString, f as readStringValue, o as normalizeNullableString, s as normalizeOptionalLowercaseString, u as normalizeOptionalThreadValue } from "./string-coerce-CjxCKZ6B.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-GhlHRwjz.js";
import { m as resolveUserPath, x as isPlainObject } from "./utils-CB8xp0O4.js";
...
import { t as resolveEffectiveSharedGatewayAuth } from "./auth-resolve-BsgRpY-H.js";
...
import { $ as resolveActiveTalkProviderConfig, Q as normalizeTalkSection, T as validateConfigObjectWithPlugins, Z as buildTalkConfigResponse, a as loadConfig, d as readConfigFileSnapshotForWrite, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, v as resolveConfigSnapshotHash, y as writeConfigFile } from "./io-CBRjt33P.js";
import { i as asOptionalRecord, n as asNullableRecord } from "./record-coerce-DZKKYOg9.js";
import { r as normalizeProviderId } from "./provider-id-ZTkpwCTd.js";
import { C as parseThreadSessionSuffix, _ as isAcpSessionKey, b as isSubagentSessionKey, c as normalizeAgentId, h as toAgentStoreSessionKey, o as classifySessionKeyShape, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey, x as parseAgentSessionKey } from "./session-key-Cn2QoOyX.js";
import { t as DEFAULT_ACCOUNT_ID } from "./account-id-BM1T6029.js";
import { i as normalizeChannelId, r as listChannelPlugins, t as getChannelPlugin } from "./registry-CaUS2Z2d.js";
import { r as DEFAULT_PROVIDER } from "./defaults-BofKZKJ4.js";
import { i as applyMergePatch } from "./schema-validator-BkLQHQcA.js";
import { a as DEFAULT_IDENTITY_FILENAME, c as DEFAULT_SOUL_FILENAME, d as ensureAgentWorkspace, i as DEFAULT_HEARTBEAT_FILENAME, l as DEFAULT_TOOLS_FILENAME, m as isWorkspaceSetupCompleted, o as DEFAULT_MEMORY_ALT_FILENAME, r as DEFAULT_BOOTSTRAP_FILENAME, s as DEFAULT_MEMORY_FILENAME, t as DEFAULT_AGENTS_FILENAME, u as DEFAULT_USER_FILENAME } from "./workspace-DGJIk8rw.js";
import { b as resolveAgentWorkspaceDir, g as listAgentIds, h as listAgentEntries, p as resolveSessionAgentId, x as resolveDefaultAgentId, y as resolveAgentDir } from "./agent-scope-D-T17Rdc.js";
import { t as parseByteSize } from "./parse-bytes-BHmh5pRx.js";
import "./config-BjiV0z87.js";
import { n as normalizeDeviceAuthScopes } from "./device-auth-DlVQ7NKi.js";
import { i as publicKeyRawBase64UrlFromPem, n as loadOrCreateDeviceIdentity } from "./device-identity-C12sfgbO.js";
import { _ as hasGatewayClientCap, c as isGatewayMessageChannel, h as GATEWAY_CLIENT_MODES, m as GATEWAY_CLIENT_IDS, p as GATEWAY_CLIENT_CAPS, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-Bk_YHfQg.js";
import "./message-channel-core-DTA--Gjh.js";
import { $ as validateNodeEventParams, $t as validateWizardCancelParams, A as validateCronRemoveParams, At as validateSessionsMessagesSubscribeParams, B as validateDeviceTokenRotateParams, Bt as validateSkillsInstallParams, C as validateConfigSchemaLookupParams, Ct as validateSessionsCompactionBranchParams, Dt as validateSessionsCreateParams, E as validateConfigSetParams, Et as validateSessionsCompactionRestoreParams, F as validateDevicePairApproveParams, Ft as validateSessionsResolveParams, G as validateExecApprovalsGetParams, Gt as validateTalkModeParams, Ht as validateSkillsStatusParams, I as validateDevicePairListParams, It as validateSessionsSendParams, J as validateExecApprovalsSetParams, Jt as validateToolsEffectiveParams, K as validateExecApprovalsNodeGetParams, Kt as validateTalkSpeakParams, L as validateDevicePairRejectParams, Lt as validateSessionsUsageParams, M as validateCronRunsParams, Mt as validateSessionsPatchParams, N as validateCronStatusParams, Nt as validateSessionsPreviewParams, O as validateCronAddParams, Ot as validateSessionsDeleteParams, P as validateCronUpdateParams, Pt as validateSessionsResetParams, Q as validateNodeDescribeParams, Qt as validateWebLoginWaitParams, R as validateDevicePairRemoveParams, Rt as validateSkillsBinsParams, S as validateConfigPatchParams, St as validateSessionsCompactParams, T as validateConfigSchemaParams, Tt as validateSessionsCompactionListParams, Ut as validateSkillsUpdateParams, Vt as validateSkillsSearchParams, Wt as validateTalkConfigParams, X as validateMessageActionParams, Xt as validateWakeParams, Y as validateLogsTailParams, Yt as validateUpdateRunParams, Z as validateModelsListParams, Zt as validateWebLoginStartParams, a as validateAgentsCreateParams, an as COMMAND_DESCRIPTION_MAX_LENGTH, at as validateNodePairRejectParams, b as validateConfigApplyParams, bt as validateSendParams, c as validateAgentsFilesListParams, ct as validateNodePendingAckParams, d as validateAgentsUpdateParams, dt as validateNodeRenameParams, en as validateWizardNextParams, et as validateNodeInvokeParams, f as validateChannelsLogoutParams, ht as validatePushTestParams, i as validateAgentWaitParams, in as errorShape, it as validateNodePairListParams, j as validateCronRunParams, jt as validateSessionsMessagesUnsubscribeParams, k as validateCronListParams, kt as validateSessionsListParams, l as validateAgentsFilesSetParams, lt as validateNodePendingDrainParams, m as validateChannelsStatusParams, mt as validatePollParams, n as validateAgentIdentityParams, nn as validateWizardStatusParams, nt as validateNodeListParams, o as validateAgentsDeleteParams, on as parseSessionLabel, ot as validateNodePairRequestParams, p as validateChannelsStartParams, q as validateExecApprovalsNodeSetParams, qt as validateToolsCatalogParams, r as validateAgentParams, rn as ErrorCodes, rt as validateNodePairApproveParams, s as validateAgentsFilesGetParams, st as validateNodePairVerifyParams, t as formatValidationErrors, tn as validateWizardStartParams, tt as validateNodeInvokeResultParams, u as validateAgentsListParams, ut as validateNodePendingEnqueueParams, w as validateConfigSchemaLookupResult, wt as validateSessionsCompactionGetParams, x as validateConfigGetParams, xt as validateSessionsAbortParams, y as validateCommandsListParams, z as validateDeviceTokenRevokeParams, zt as validateSkillsDetailParams } from "./protocol-Bcs0YWrz.js";
import { a as normalizeInputProvenance } from "./input-provenance-CNf_1qHV.js";
import { i as isNodeRoleMethod, n as authorizeOperatorScopesForMethod, o as ADMIN_SCOPE$1, u as TALK_SECRETS_SCOPE } from "./method-scopes-7zKnuhA9.js";
import { n as formatConfigIssueLines } from "./issue-format-zM6cvDu4.js";
import { n as pickBestEffortPrimaryLanIPv4 } from "./network-discovery-display-DvH-MNYk.js";
import { i as resolveAssistantAvatarUrl } from "./control-ui-shared-CP9duaRo.js";
...
import { B as resolveMemoryLightDreamingConfig, F as resolveMemoryDeepDreamingConfig, I as resolveMemoryDreamingConfig, L as resolveMemoryDreamingPluginConfig, N as isSameMemoryDreamingDay, V as resolveMemoryRemDreamingConfig, z as resolveMemoryDreamingWorkspaces } from "./dreaming-C4iELShs.js";
import "./plugins-BcqWcAy9.js";
import { s as getPluginCommandSpecs } from "./command-registration-CF50YQAH.js";
import { i as hasInternalHookListeners, m as triggerInternalHook } from "./internal-hooks-CpgiJgbB.js";
import { t as createEmptyPluginRegistry } from "./registry-empty-BzdJBxDW.js";
import { a as getActivePluginRegistry, d as pinActivePluginChannelRegistry, x as setActivePluginRegistry } from "./runtime-Cym-fqI8.js";
import { n as withPluginRuntimeGatewayRequestScope, t as getPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-Cc9jmc-3.js";
import { r as createPluginRuntimeLoaderLogger } from "./load-context-B77Zu07N.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-yYk0N-bh.js";
import { d as normalizeThinkLevel, u as normalizeReasoningLevel } from "./thinking-Bh-7MqXz.js";
import { C as parseModelRef, S as normalizeModelRef } from "./model-selection-cli-BCNxTSmc.js";
import { t as buildAllowedModelSet } from "./model-selection-B7RNWcLj.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-k9H_9vvf.js";
import { n as resolveAgentIdentity } from "./identity-CxDbUUP-.js";
import { o as updateSessionStore } from "./store-COeaE7A7.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey } from "./main-session-B78uK7Dt.js";
import { n as resolveMainSessionKeyFromConfig, t as extractDeliveryInfo } from "./sessions-THKm0e_w.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent } from "./paths-D6msg0S1.js";
import { n as mergeSessionEntry } from "./types-ASqeFakT.js";
import { n as readJsonFile, r as writeJsonAtomic, t as createAsyncLock } from "./json-files-DcOQMqKi.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, r as mergeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-j5hC5qb1.js";
import { t as loadSessionStore } from "./store-load-Bi019EcE.js";
import { n as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-fPT8BSrh.js";
import { t as canonicalizeSpawnedByForAgent } from "./session-store-key-BvvxupEc.js";
import { a as readSessionPreviewItemsFromTranscript, i as readSessionMessages } from "./session-utils.fs-DgRtLXgk.js";
import { a as resolveSessionTranscriptCandidates, t as archiveFileOnDisk } from "./session-transcript-files.fs-Bp5oGT4t.js";
import { a as loadGatewaySessionRow, d as resolveGatewayModelSupportsImages, f as resolveGatewaySessionStoreTarget, i as loadCombinedSessionStoreForGateway, l as resolveDeletedAgentIdFromSessionKey, m as resolveSessionModelRef, n as listAgentsForGateway, o as loadSessionEntry, r as listSessionsFromStore, s as migrateAndPruneGatewaySessionStoreKey, u as resolveFreshestSessionEntryFromStoreKeys } from "./session-utils-TWBJFzaE.js";
import { d as listSessionCompactionCheckpoints, u as getSessionCompactionCheckpoint } from "./model-context-tokens-BehT-A9e.js";
import { a as normalizeCronJobCreate, s as normalizeCronJobPatch } from "./openclaw-tools-BM64FZFo.js";
import { _ as listCoreToolSections, h as PROFILE_OPTIONS, v as resolveCoreToolProfiles } from "./tool-policy-4C90huEY.js";
import { n as getPluginToolMeta, r as resolvePluginTools } from "./tools-CjyAaC4m.js";
import { n as redactConfigSnapshot, r as restoreRedactedValues, t as redactConfigObject } from "./redact-snapshot-BakPiQfA.js";
import { C as synthesizeSpeech, S as setTtsProvider, b as setTtsEnabled, c as isTtsEnabled, f as resolveExplicitTtsOverrides, g as resolveTtsProviderOrder, h as resolveTtsPrefsPath, i as getResolvedSpeechProviderConfig, l as isTtsProviderConfigured, m as resolveTtsConfig, o as getTtsProvider, p as resolveTtsAutoMode, w as textToSpeech } from "./tts-CWnNX49f.js";
import "./auth-profiles-k8Wc2Eeh.js";
import { o as projectOutboundPayloadPlanForMirror, t as createOutboundPayloadPlan } from "./payloads-nIfLjbWq.js";
import { l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-CN4p9Z8t.js";
import { g as writeFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-CH-zulhg.js";
import { d as mergeExecApprovalsSocketDefaults, j as saveExecApprovals, o as ensureExecApprovals, p as normalizeExecApprovals, y as readExecApprovalsSnapshot } from "./exec-approvals-CFEClmo3.js";
import { a as prepareSecretsRuntimeSnapshot } from "./runtime-V2Yz6WBE.js";
import { i as parseAbsoluteTimeMs } from "./stagger-BQF4zDGf.js";
import { r as isInvalidCronSessionTargetIdError } from "./webhook-url-CLUaf-m2.js";
import { f as writeRestartSentinel, i as formatDoctorNonInteractiveHint } from "./restart-sentinel-ZznJ7MqL.js";
import { o as scheduleGatewaySigusr1Restart } from "./restart-BcbTn2CL.js";
import { o as listConfiguredAnnounceChannelIdsForConfig, r as resolveGatewayStartupPluginIds } from "./channel-plugin-ids-D2B9YLpe.js";
import { i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry, s as dispatchChannelMessageAction } from "./message-action-runner-BGDFqiwJ.js";
import { n as normalizePollInput } from "./polls-D0ChELjq.js";
import { t as deliverOutboundPayloads } from "./deliver-D1-Y-7aa.js";
import { n as resolveOutboundChannelPlugin } from "./channel-resolution-DTR-37Uw.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-8_D2Hsny.js";
import "./target-resolver-x7yFE66G.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-NIsk1Rw4.js";
import { i as resolveReplyToMode } from "./reply-threading-S29pX9Jx.js";
...
import { r as resolveOutboundTarget } from "./targets-Bj4z4KmE.js";
import { t as extractToolPayload } from "./tool-payload-B-tqV5sL.js";
import { i as setHeartbeatsEnabled } from "./heartbeat-wake-CrCSGuB0.js";
import { i as enqueueSystemEvent, o as isSystemEventContextChanged } from "./system-events-B-8iLjB8.js";
import { r as createRunningTaskRun } from "./detached-task-runtime-Cwd30X8h.js";
import { a as clearSessionQueues } from "./queue-Bsh8rsUi.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-OVlwmjAo.js";
import { a as isEmbeddedPiRunActive, f as waitForEmbeddedPiRunEnd, t as abortEmbeddedPiRun } from "./runs-BbW2coSD.js";
import { h as normalizeDiagnosticStabilityQuery, m as getDiagnosticStabilitySnapshot } from "./diagnostic-stability-bundle-Ca_aoqgv.js";
import { n as normalizeSpawnedRunMetadata, r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-DD2UtQHN.js";
import { t as bumpSkillsSnapshotVersion } from "./refresh-state-C1yA64vg.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-DEVw-slo.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-CxqgeaYc.js";
import { o as resolveMissingRequestedScope } from "./pairing-token-B-4nto3y.js";
import { d as listNodePairing, f as rejectNodePairing, g as verifyNodeToken, l as approveNodePairing, m as requestNodePairing, p as renamePairedNode, t as getRemoteSkillEligibility } from "./skills-remote-B7rYvoQE.js";
import { t as canExecRequestNode } from "./exec-defaults-sE75_gJ5.js";
import "./skills-C5C1PDgi.js";
import { n as getActiveMemorySearchManager } from "./memory-runtime-gqmPdRd6.js";
...
import { t as primeConfiguredBindingRegistry } from "./binding-registry-BFwnGqTr.js";
import { r as listPluginCommands } from "./commands-BwMa6V9t.js";
import { r as setGatewaySubagentRuntime } from "./runtime-DYp3IZCN.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-docomIhs.js";
import "./commands-registry-x2AHOYwB.js";
import { n as resolveSendPolicy } from "./send-policy-D5yeDZXf.js";
import { t as getChannelActivity } from "./channel-activity-BGZkBapG.js";
import { t as WizardCancelledError } from "./prompts-ZriG88mV.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-CHBqTQtt.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-A9BCntP4.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-BlBQjPec.js";
import { r as getLastHeartbeatEvent } from "./heartbeat-visibility-0SbliaMo.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-CCWnEwLe.js";
import { r as agentCommandFromIngress } from "./agent-command-BoeaZuDq.js";
import { n as getSpeechProvider, r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-DdJ6JQFc.js";
import { i as resolveNodeCommandAllowlist, n as isNodeCommandAllowed } from "./node-command-policy-VkQBk7G2.js";
import { t as formatForLog } from "./ws-log-Ui7Wa18F.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-CD6jwCU4.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-CifzhBU3.js";
import { a as getPairedDevice, c as listApprovedPairedDeviceRoles, d as rejectDevicePairing, f as removePairedDevice, g as summarizeDeviceTokens, h as rotateDeviceToken, i as formatDevicePairingForbiddenMessage, l as listDevicePairing, m as revokeDeviceToken, n as approveDevicePairing, o as getPendingDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-jHCJMfzR.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-Dpm0QAO_.js";
import { n as createOutboundSendDeps } from "./deps-DwAVwozU.js";
import "./agent-BYyek5Zi.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-kuX308TQ.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-U_N3AvW5.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-6a9nKL1s.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-Br-EMxKa.js";
import { t as loadProviderUsageSummary } from "./provider-usage-4xWaMrcx.js";
import { o as fetchClawHubSkillDetail } from "./clawhub-RXpU01PU.js";
import { a as loadSessionUsageTimeSeries, i as loadSessionLogs, n as loadCostUsageSummary, o as resolveExistingUsageSessionFile, r as loadSessionCostSummary, t as discoverAllSessions } from "./session-cost-usage-C919LdFZ.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-CSdCpe_l.js";
import { n as movePathToTrash } from "./browser-maintenance-C2ICyqLA.js";
import { a as performGatewaySessionReset } from "./session-reset-service-BaJixFR5.js";
import { t as buildChannelUiCatalog } from "./catalog-D8GEBZT7.js";
import { a as removeBackfillDiaryEntries, c as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeGroundedShortTermCandidates, r as previewGroundedRemMarkdown, s as repairDreamingArtifacts } from "./memory-core-bundled-runtime-DNPuVB_M.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-DJepOTLY.js";
import { t as readConfiguredLogTail } from "./log-tail-Bs9kWZU_.js";
import { n as purgeAgentSessionStoreEntries } from "./agents.command-shared-D3TmOSjT.js";
import { o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-r3SghYkr.js";
import { t as installSkill } from "./skills-install-DrQG9ic5.js";
import { m as normalizeUpdateChannel } from "./update-check-DTgzLYf5.js";
import "./status-B5YexwqL.js";
import { t as getStatusSummary } from "./status.summary-D_ichez1.js";
import { i as updateSkillsFromClawHub, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-jLMoZXQm.js";
import { d as waitForTerminalGatewayDedupe, i as chatHandlers, l as readTerminalSnapshotFromGatewayDedupe, u as setGatewayDedupeEntry } from "./chat-CiqiBisN.js";
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp-D0TKjfOh.js";
import { n as MediaOffloadError, r as parseMessageWithAttachments, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-CqqA6Wq4.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-j0EsIWsC.js";
import { t as runGatewayUpdate } from "./update-runner-BJKm386y.js";
import { t as buildChannelAccountSnapshot } from "./status-Dx4DRUd2.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-CCzBBboj.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-CX2MP4eu.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-DygyI7mB.js";
import "./heartbeat-runner-BDdF4j3B.js";
...
async function loadSessionSubagentReactivationRuntime() {
	return import("./session-subagent-reactivation.runtime-BXx67bUY.js");
}
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-CVwufaAx.js");
...
function loadSessionsRuntimeModule() {
	sessionsRuntimeModulePromise ??= import("./sessions.runtime-y0KWCspE.js");
...
//#endregion
export { startGatewayConfigReloader as C, pruneStaleControlPlaneBuckets as E, resolveGatewayReloadSettings as S, roleCanSkipDeviceIdentity as T, appendCronRunLog as _, coreGatewayHandlers as a, resolveCronDeliveryPlan as b, listSystemPresence as c, CANVAS_CAPABILITY_TTL_MS as d, buildCanvasScopedHostUrl as f, loadVoiceWakeConfig as g, formatError as h, setFallbackGatewayContextResolver as i, upsertPresence as l, normalizeCanvasScopedUrl as m, prepareGatewayPluginLoad as n, handleGatewayRequest as o, mintCanvasCapabilityToken as p, reloadDeferredGatewayPlugins as r, broadcastPresenceSnapshot as s, loadGatewayStartupPlugins as t, clearNodeWakeState as u, resolveCronRunLogPath as v, parseGatewayRole as w, resolveFailureDestination as x, resolveCronRunLogPruneOptions as y };
