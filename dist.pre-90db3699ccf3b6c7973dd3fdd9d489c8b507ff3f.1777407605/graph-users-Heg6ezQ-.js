...
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-BFk24XlL.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-LCM7RhsR.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-FZVeKWYJ.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("./jsonwebtoken-DLzlAGZ_.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-DeZ46qRc.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwt, { JwksClient }]) => ({
		jwt,
		JwksClient
	}));
