import { a as formatUncaughtError } from "./errors-CS5wW5eD.js";
...
import { A as hasFlag, D as getPositiveIntFlagValue, E as getFlagValue, L as isValueToken, T as getCommandPositionalsWithRootOptions, k as getVerboseFlag } from "./logger-DTX5koY3.js";
import { t as resolveCliArgvInvocation } from "./argv-invocation-cHYqVrRf.js";
import { a as parseCliContainerArgs, i as maybeRunCliInContainer, n as applyCliProfileEnv, r as parseCliProfileArgs, t as normalizeWindowsArgv } from "./windows-argv-B7UOV81C.js";
import { n as defaultRuntime } from "./runtime-Dy0KdPiM.js";
import { a as enableConsoleCapture } from "./subsystem-CJBoMDt5.js";
import { i as normalizeEnv, t as isTruthyEnvValue } from "./env-Bm9OFWXY.js";
import { _ as resolveStateDir } from "./paths-D92DjaZ-.js";
import { t as assertSupportedRuntime } from "./runtime-guard-DYXyo2C1.js";
import { t as resolveManifestCommandAliasOwner } from "./manifest-command-aliases.runtime-CkEeYhOp.js";
import { s as hasMemoryRuntime } from "./memory-state-By3bF34d.js";
import "./logging-CsdNOkNt.js";
import { i as initializeDebugProxyCapture, r as finalizeDebugProxyCapture } from "./runtime-nqJhayUi.js";
...
import { i as shouldSkipPluginCommandRegistration, n as shouldRegisterPrimaryCommandOnly } from "./command-registration-policy-Cl5a5bkx.js";
import { a as shouldEnsureCliPathForCommandPath, c as cliCommandCatalog, n as ensureCliExecutionBootstrap, o as resolveCliCommandPathPolicy, r as resolveCliExecutionStartupContext, s as matchesCommandPath, t as applyCliExecutionStartupPresentation } from "./command-execution-startup-CGuC0Lva.js";
import { n as maybeWarnAboutDebugProxyCoverage } from "./coverage-CWFSbB0d.js";
...
function loadConfigCli() {
	configCliPromise ??= import("./config-cli--LQj-qro.js");
	return configCliPromise;
}
function loadModelsList() {
	modelsListPromise ??= import("./list-NKdxqRLR.js");
...
const routedCommandDefinitions = {
	health: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { healthCommand } = await import("./health-DbOhNdBd.js");
	...
	status: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			if (args.json) {
				const { statusJsonCommand } = await import("./status-json-B6iG8ELp.js");
			...
			const { statusCommand } = await import("./status-D7Km41DY.js");
	...
	"gateway-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runDaemonStatus } = await import("./status-BvGmI33I.js");
	...
	sessions: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { sessionsCommand } = await import("./sessions-DhIufy8X.js");
	...
	"agents-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { agentsListCommand } = await import("./agents-CNjcT8mC.js");
	...
	"channels-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsListCommand } = await import("./list-DvY939Lp.js");
	...
	"channels-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsStatusCommand } = await import("./status-Cdk8KrsE.js");
...
async function prepareRoutedCommand(params) {
	...
	const { VERSION } = await import("./version-1fmuKOza.js");
...
async function closeCliMemoryManagers() {
	...
	try {
		const { closeActiveMemorySearchManagers } = await import("./memory-runtime-BVxrRCPb.js");
...
async function runCli(argv = process$1.argv) {
	...
	if (shouldLoadCliDotEnv()) {
		const { loadCliDotEnv } = await import("./dotenv-CSXTsV7G.js");
	...
	try {
		if (shouldUseRootHelpFastPath(normalizedArgv)) {
			const { outputPrecomputedRootHelpText } = await import("./root-help-metadata-D-aO_vLu.js");
			if (!outputPrecomputedRootHelpText()) {
				const { outputRootHelp } = await import("./root-help-CR_aMwoO.js");
		...
		const [{ buildProgram }, { runFatalErrorHooks }, { installUnhandledRejectionHandler }, { restoreTerminalState }] = await Promise.all([
			import("./program-D3Nk4cyy.js"),
			import("./fatal-error-hooks-C3vU2DxK.js"),
			import("./unhandled-rejections-D3VOucLR.js"),
			import("./restore-CW7bFcip.js")
		]);
		...
		if (primary && shouldRegisterPrimaryCommandOnly(parseArgv)) {
			const { getProgramContext } = await import("./program-context-DsGCB7pV.js");
			const ctx = getProgramContext(program);
			if (ctx) {
				const { registerCoreCliByName } = await import("./command-registry-DysWm2fM.js");
				await registerCoreCliByName(program, ctx, primary, parseArgv);
			}
			const { registerSubCliByName } = await import("./register.subclis-BB3Oh4Pf.js");
