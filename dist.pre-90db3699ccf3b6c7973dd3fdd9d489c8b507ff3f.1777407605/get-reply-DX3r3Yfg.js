...
import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, s as normalizeOptionalLowercaseString } from "./string-coerce-CjxCKZ6B.js";
import { b as truncateUtf16Safe } from "./utils-CB8xp0O4.js";
import { n as CHAT_CHANNEL_ORDER } from "./ids-BPsM98Uu.js";
...
import { n as normalizeAtHashSlug, s as normalizeStringEntries } from "./string-normalization-5F-0OqbT.js";
import { a as loadConfig } from "./io-CBRjt33P.js";
import { _ as isAcpSessionKey, b as isSubagentSessionKey, c as normalizeAgentId, l as normalizeMainKey, r as buildAgentMainSessionKey, x as parseAgentSessionKey } from "./session-key-Cn2QoOyX.js";
import { a as normalizeAnyChannelId } from "./registry-CGsqKAN1.js";
import { t as getLoadedChannelPluginById } from "./registry-loaded-DtXD7Ilc.js";
...
import { d as ensureAgentWorkspace, n as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-DGJIk8rw.js";
import { _ as resolveAgentConfig, b as resolveAgentWorkspaceDir, h as listAgentEntries, l as resolveAgentSkillsFilter, p as resolveSessionAgentId, y as resolveAgentDir } from "./agent-scope-D-T17Rdc.js";
import "./config-BjiV0z87.js";
import { d as resolveGatewayMessageChannel, r as isInternalMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-Bk_YHfQg.js";
import "./message-channel-core-DTA--Gjh.js";
import { i as isInterSessionInputProvenance } from "./input-provenance-CNf_1qHV.js";
import { f as resetRegisteredAgentHarnessSessions } from "./loader-708jrx4Y.js";
import "./plugins-BcqWcAy9.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-DuCZiaZE.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-CpgiJgbB.js";
import { g as requireActivePluginChannelRegistry, n as getActivePluginChannelRegistryVersion } from "./runtime-Cym-fqI8.js";
import { a as resolveSupportedThinkingLevel, d as normalizeThinkLevel, m as normalizeVerboseLevel, n as isThinkingLevelSupported, t as formatThinkingLevels } from "./thinking-Bh-7MqXz.js";
import { _ as resolveModelRefFromString } from "./model-selection-cli-BCNxTSmc.js";
import "./model-selection-B7RNWcLj.js";
import { _ as resolveGroupSessionKey, o as updateSessionStore, p as deriveSessionMetaPatch, u as resolveSessionStoreEntry } from "./store-COeaE7A7.js";
...
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-D6msg0S1.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-ASqeFakT.js";
...
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, n as deliveryContextKey, t as deliveryContextFromSession } from "./delivery-context.shared-j5hC5qb1.js";
import { o as resolveMaintenanceConfigFromInput, t as loadSessionStore } from "./store-load-Bi019EcE.js";
import { a as resolveAndPersistSessionFile } from "./transcript-DTxF1v8R.js";
import { n as parseSessionThreadInfoFast } from "./thread-info-ln-WiDwd.js";
import { o as getQueueSize, r as clearCommandLane } from "./command-queue-CGrlxFYE.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-CYuOTnyM.js";
import { n as applyOwnerOnlyToolPolicy } from "./tool-policy-4C90huEY.js";
import { o as isReasoningTagProvider } from "./session-transcript-repair-CCTG_cJr.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-DX5g1YuC.js";
...
import { f as fireAndForgetHook, n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-BNyqCYCV.js";
...
import { i as enqueueSystemEvent, l as removeSystemEvents } from "./system-events-B-8iLjB8.js";
import { t as resolveQueueSettings } from "./queue-Bsh8rsUi.js";
...
import { r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-DD2UtQHN.js";
...
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-cqGFEGHq.js";
import { t as hasControlCommand } from "./command-detection-Bvmzs6L5.js";
import "./commands-registry-x2AHOYwB.js";
import { t as resolveRunTypingPolicy } from "./typing-policy-PifFuQJg.js";
...
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-CW3I8HR8.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-C4SCO0eQ.js";
import { n as createTypingKeepaliveLoop, t as createTypingStartGuard } from "./typing-start-guard-CT0bLWx0.js";
import { t as resolveChannelModelOverride } from "./model-overrides-Cz5vfT-o.js";
import { t as normalizeGroupActivation } from "./group-activation-D2jH_N0s.js";
import { i as resolveTypingMode, r as resolveActiveRunQueueAction, t as cancelContinuationTimer } from "./agent-runner-JXXlJCYX.js";
import { r as getCliSessionBinding } from "./cli-session-GscASrM6.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-CX_SbH06.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-Dhc3nH3u.js";
import { n as buildSessionStartHookPayload, t as buildSessionEndHookPayload } from "./session-hooks-Bl_sp1Y7.js";
import { r as drainFormattedSystemEvents } from "./session-updates-96-SjCjM.js";
import { t as resolveDefaultModel } from "./directive-handling.defaults-aswEmyPR.js";
...
import { t as buildCommandContext } from "./commands-context-BPRhCwwA.js";
import { t as parseInlineDirectives } from "./directive-handling.parse-CdtBYc1c.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-Bc-HG9gf.js";
...
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-5LC_vubr.js";
...
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-8tewD0nM.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-DdU8BehR.js";
import { t as hasInboundMedia } from "./inbound-media-YXGxvVN3.js";
...
import { t as resolveResetPreservedSelection } from "./reset-preserved-selection-M4Y9AUBU.js";
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-CcJaHCb5.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-BY6ckYCy.js";
...
function loadCommandsStatus() {
	commandsStatusPromise ??= import("./commands-status.runtime-D-PHoQJD.js");
	return commandsStatusPromise;
}
function loadDirectiveLevels() {
	directiveLevelsPromise ??= import("./directive-handling.levels-1VUI6lbG.js");
	return directiveLevelsPromise;
}
function loadDirectiveImpl() {
	directiveImplPromise ??= import("./directive-handling.impl-CqMY0q92.js");
	return directiveImplPromise;
}
function loadDirectiveFastLane() {
	directiveFastLanePromise ??= import("./directive-handling.fast-lane-s9xcuNSP.js");
	return directiveFastLanePromise;
}
function loadDirectivePersist() {
	directivePersistPromise ??= import("./directive-handling.persist.runtime-Dft5hIq6.js");
...
function loadGroupsRuntime() {
	groupsRuntimePromise ??= import("./groups.runtime-CXNQ25xJ.js");
...
function loadCommandsRegistry() {
	commandsRegistryPromise ??= import("./commands-registry.runtime-C-a-CcGH.js");
	return commandsRegistryPromise;
}
function loadSkillCommands() {
	skillCommandsPromise ??= import("./skill-commands.runtime-Bmw5U3Z0.js");
...
function loadSkillCommandsRuntime() {
	skillCommandsRuntimePromise ??= import("./skill-commands.runtime-Bmw5U3Z0.js");
	return skillCommandsRuntimePromise;
}
function loadOpenClawToolsRuntime() {
	openClawToolsRuntimePromise ??= import("./openclaw-tools.runtime-BpMC-laZ.js");
	return openClawToolsRuntimePromise;
}
function loadAbortCutoffRuntime() {
	abortCutoffRuntimePromise ??= import("./abort-cutoff.runtime-Bt_nOF8B.js");
	return abortCutoffRuntimePromise;
}
function loadCommandsRuntime() {
	commandsRuntimePromise ??= import("./commands.runtime-DNiAby2v.js");
...
function loadSessionStoreRuntime$1() {
	sessionStoreRuntimePromise$1 ??= import("./store.runtime-BhJh0URF.js");
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded.runtime-VUXo_xBW.js");
	return piEmbeddedRuntimePromise;
}
function loadAgentRunnerRuntime() {
	agentRunnerRuntimePromise ??= import("./agent-runner.runtime-Dze0PCl4.js");
	return agentRunnerRuntimePromise;
}
function loadSessionUpdatesRuntime() {
	sessionUpdatesRuntimePromise ??= import("./session-updates.runtime-_68CtYtj.js");
...
function loadDeliverRuntime() {
	deliverRuntimePromise ??= import("./deliver-runtime-CXus64Fy.js");
...
function loadSessionForkRuntime() {
	sessionForkRuntimePromise ??= import("./session-fork.runtime-bE70Yy1w.js");
...
function loadSessionArchiveRuntime() {
	sessionArchiveRuntimePromise ??= import("./session-archive.runtime-BLZLFTUC.js");
...
function loadSessionResetModelRuntime() {
	sessionResetModelRuntimePromise ??= import("./session-reset-model.runtime-DFGKHl_8.js");
	return sessionResetModelRuntimePromise;
}
function loadStageSandboxMediaRuntime() {
	stageSandboxMediaRuntimePromise ??= import("./stage-sandbox-media.runtime-DvcBAmTn.js");
	return stageSandboxMediaRuntimePromise;
}
function loadMediaUnderstandingApplyRuntime() {
	mediaUnderstandingApplyRuntimePromise ??= import("./apply.runtime-C1Ow4XmJ.js");
	return mediaUnderstandingApplyRuntimePromise;
}
function loadLinkUnderstandingApplyRuntime() {
	linkUnderstandingApplyRuntimePromise ??= import("./apply.runtime-nXOYT4jb.js");
	return linkUnderstandingApplyRuntimePromise;
}
function loadCommandsCoreRuntime() {
	commandsCoreRuntimePromise ??= import("./commands-core.runtime-Ccr_1Yl7.js");
...
function loadHookRunnerGlobal() {
	hookRunnerGlobalPromise ??= import("./hook-runner-global-CxgQsGwp.js");
	return hookRunnerGlobalPromise;
}
function loadOriginRouting() {
	originRoutingPromise ??= import("./origin-routing-D_yWc9lx.js");
