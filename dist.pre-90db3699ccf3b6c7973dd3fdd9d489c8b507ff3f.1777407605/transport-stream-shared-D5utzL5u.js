import { d as resolveDebugProxySettings } from "./runtime-nqJhayUi.js";
import { a as mergeModelProviderRequestOverrides, c as resolveProviderRequestPolicyConfig, i as getModelProviderRequestTransport, n as buildProviderRequestDispatcherPolicy } from "./provider-request-config-COmDgAeZ.js";
...
function shouldBypassLongSdkRetry(response) {
	...
	return retryAfterSeconds !== void 0 && retryAfterSeconds > maxWaitSeconds;
}
